...
Gehen Sie zu **Messaging** > **Campaigns** und wählen Sie **Kampagne erstellen**, dann wählen Sie **API Campaigns**. Jetzt können Sie mit der Konfiguration Ihrer API-Kampagne fortfahren.

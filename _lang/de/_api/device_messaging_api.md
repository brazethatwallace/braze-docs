...
guide_top_text: "Verwenden Sie die Braze Device Messaging API, um Banner-Eigenschaften abzurufen und Banner-Impression- und Klick-Events zu melden, ohne ein Braze SDK or Software-Development-Kit zu integrieren. Die Device Messaging API unterstützt client- und serverseitige Integrationen und verwendet clientseitige Representational State Transfer-API-Schlüssel, die auf einen einzelnen Workspace beschränkt sind."
guide_top_alert: "Diese Seite befindet sich in der Beta-Phase. Features und Dokumentation für die Device Messaging API können sich ändern. Wenden Sie sich an Ihren Braze Account Manager:in, um Zugang anzufordern."

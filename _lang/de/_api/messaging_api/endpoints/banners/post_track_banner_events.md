...
layout: api_page
page_type: reference
description: "Verwenden Sie diesen Endpunkt, um Impression- und Klick-Ereignisse für Banner aufzuzeichnen."
hidden: true
---
...
| `events[].event_type` | Erforderlich | String | Der Ereignistyp. Mögliche Werte sind `impression` und `click`. | `impression` |

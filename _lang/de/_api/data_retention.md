...
Verhaltensbezogene Events können nicht aus einem Kundenprofil or Nutzerprofil gelöscht werden (angepasste Events, Sitzungen, Campaigns, Käufe). Um diese Events zu entfernen, müssen Sie das gesamte Kundenprofil or Nutzerprofil löschen.
...
### Interaktionsdaten von Campaigns und Canvase {#campaign-and-canvas-interactions-data}

...
Wenn Sie Fragen zu API-Limits haben, wenden Sie sich an Ihren geschäftskunden-Success-Manager oder eröffnen Sie ein [Support-Ticket]({{site.baseurl}}/braze_support).

{% alert tip %}
Sie können das [Dashboard zur API-Nutzung]({{site.baseurl}}/user_guide/analytics/dashboards/api_usage) verwenden, um den eingehenden Datenverkehr im Vergleich zu Ihren Rate-Limits anzuzeigen und zu vergleichen.
{% endalert %}

...
guide_featured_list:
  - name: "GET: Abo-Gruppenstatus der Nutzer:innen auflisten"
  ...
  - name: "GET: Nutzer:innen Abo-Gruppen auflisten"
    ...
    image: /assets/img/braze_icons/users-01.svg
  - name: "POST: Abo-Gruppenstatus der Nutzer:innen aktualisieren"
    link: /docs/api/endpoints/subscription_groups/post_update_user_subscription_group_status/
    image: /assets/img/braze_icons/user-plus-01.svg
  - name: "POST: Abo-Gruppenstatus der Nutzer:innen aktualisieren V2"

...
layout: api_page
page_type: reference
description: "Dieser Artikel beschreibt den Braze-Endpunkt „Katalog erstellen“."

---
{% api %}
# Katalog erstellen {#create-catalog}
{% apimethod post %}
/catalogs
{% endapimethod %}
...
Um diesen Endpunkt zu verwenden, benötigen Sie einen [API-Schlüssel]({{site.baseurl}}/api/basics#rest-api-key-permissions) mit der Berechtigung `catalogs.create`.
...
| `catalog-name-already-exists` | Ein Katalog mit diesem Namen existiert bereits. |
...
| `invalid-field-names` | Felder dürfen nur Buchstaben, Zahlen, Bindestriche und Unterstriche enthalten. |

---
nav_title: "GET: Abo-Status mit E-Mail-Adresse oder Telefonnummer auflisten"
article_title: "GET: Abo-Status mit E-Mail-Adresse oder Telefonnummer auflisten"
search_tag: Endpoint
page_order: 2
hidden: true
layout: api_page
page_type: reference
description: "Dieser Artikel beschreibt die Details zum Braze-Endpunkt „Abo-Status mit einer E-Mail-Adresse oder Telefonnummer auflisten“."

---
{% api %}
# Abo-Status mit einer E-Mail-Adresse oder Telefonnummer auflisten {#list-subscription-state-with-an-email-address-or-phone-number}
{% apimethod get %}
/users/subscription
{% endapimethod %}

...
layout: api_page
page_type: reference
description: "Dieser Artikel beschreibt die Details des Braze-Endpunkts „Hard Bounced E-Mail-Adressen entfernen“."

---
{% api %}
# Hard Bounced E-Mails entfernen {#remove-hard-bounced-emails}
{% apimethod post %}
/email/bounce/remove
{% endapimethod %}
...
Um diesen Endpunkt zu verwenden, benötigen Sie einen [API-Schlüssel]({{site.baseurl}}/api/basics#rest-api-key-permissions) mit der Berechtigung `email.bounce.remove`.

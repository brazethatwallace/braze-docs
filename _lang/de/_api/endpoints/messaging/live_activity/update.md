---
nav_title: "POST: Live-Aktivität Update or aktualisieren or aktualisieren"
article_title: "POST: Live-Aktivität Update or aktualisieren or aktualisieren"
search_tag: Endpoint
page_order: 1

layout: api_page
page_type: reference
description: "Dieser Artikel beschreibt Details zum Endpunkt „Live-Aktivität Update or aktualisieren or aktualisieren“."
---
{% api %}
# Live-Aktivität Update or aktualisieren or aktualisieren {#update-live-activity}
{% apimethod post %}
/messages/live_activity/Update or aktualisieren
{% endapimethod %}

> Verwenden Sie diesen Endpunkt, um die von Ihrer iOS-App angezeigten [Live-Aktivitäten]({{site.baseurl}}/developer_guide/live_notifications?sdktab=swift) zu Update or aktualisieren or aktualisieren und zu beenden. Dieser Endpunkt erfordert eine zusätzliche Einrichtung.

Nachdem Sie eine Live-Aktivität registriert haben, können Sie eine JSON-Nutzlast übergeben, um Ihren Apple-Push-Benachrichtigungsdienst (APNs) zu Update or aktualisieren or aktualisieren. Weitere Informationen finden Sie in der Apple-Dokumentation zum [Update or aktualisieren or aktualisieren Ihrer Live-Aktivität mit Push-Benachrichtigungs-Nutzlasten](https://developer.apple.com/documentation/activitykit/updating-and-ending-your-live-activity-with-activitykit-push-notifications).
...
- Registrierung or registrieren Sie eine Live-Aktivität [remote]({{site.baseurl}}/developer_guide/live_notifications?tab=remote&sdktab=swift) oder [lokal]({{site.baseurl}}/developer_guide/live_notifications?tab=local&sdktab=swift) mit dem Braze Swift SDK or Software-Development-Kit.

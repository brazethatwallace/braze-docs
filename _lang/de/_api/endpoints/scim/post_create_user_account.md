---
nav_title: "POST: Neues Dashboard-Nutzerkonto erstellen"
article_title: "POST: Neues Dashboard-Nutzerkonto erstellen"
...
{% api %}
# Neues Dashboard-Nutzerkonto erstellen {#create-new-dashboard-user-account}
{% apimethod post %}
/scim/v2/Users
{% endapimethod %}
...
Wenn eine Nutzer:in mit diesem `userName` oder dieser E-Mail-Adresse bereits in Braze existiert, antwortet der Endpunkt mit:

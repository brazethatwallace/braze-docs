# Anwendungsfall: Buchungserinnerung per E-Mail
...
- Nachrichten berücksichtigen den Opt-in- und Opt-out-Status von Nutzerprofilen gemäß der Kampagnen-Konfiguration.
...
Erstellen Sie die Erinnerungs-E-Mail, indem Sie die Schritte unter [E-Mail mit benutzerdefiniertem HTML erstellen]({{site.baseurl}}/user_guide/message_building_by_channel/email/html_editor/) befolgen. Verwenden Sie Liquid, um die Nachricht mit Daten aus dem von Ihnen erstellten angepassten Attribut („trips") zu personalisieren, wie in diesem Beispiel.
...
### Schritt 2c: Kampagne starten

Starten Sie die Kampagne für die Erinnerungs-E-Mail. Jedes Mal, wenn Braze das angepasste Attribut „trips" erhält, plant Braze eine Nachricht entsprechend den Daten, die im jeweiligen Buchungsobjekt enthalten sind.
...
Um die Buchungserinnerungen aus Schritt 1 und 2 auf Basis der aktuellsten Daten zu versenden, aktualisieren Sie abschließend die verschachtelten angepassten Attribute, um die Änderung oder Stornierung der Buchung widerzuspiegeln.

...
1. Gehen Sie zu **Templates** > **Content Blocks**. Wählen Sie <i class="fas fa-plus"></i> **Create Content Block** und dann **Drag-and-drop Content Block** aus.
...
8. Wählen Sie den Tab **Preview**, um zu sehen, wie Ihr Content-Block aussehen wird. Optional können Sie **Copy preview link** auswählen, um einen teilbaren Vorschau-Link zu generieren und zu kopieren, der zeigt, wie die E-Mail für einen zufälligen Nutzer aussehen wird. Der Link ist sieben Tage lang gültig und muss danach neu generiert werden.<br><br> ![Tab „Vorschau“ für den Drag-and-Drop-Content-Block-Composer.]({% image_buster /assets/img_archive/dnd_content_block_preview_link.png %})<br><br>
9. Wählen Sie **Launch Content Block**.

{% elsif include.location == "html" %}

1. Gehen Sie zu **Templates** > **Content Blocks**. Wählen Sie <i class="fas fa-plus"></i> **Create Content Block** und dann **HTML code editor** aus.

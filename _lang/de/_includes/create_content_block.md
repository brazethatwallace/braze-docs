...
1. Gehen Sie zu **Templates** > **Content Blocks**. Wählen Sie <i class="fas fa-plus"></i> **Content-Block erstellen** und dann **Drag-and-Drop-Content-Block** aus.
...
1. Gehen Sie zu **Templates** > **Content Blocks**. Wählen Sie <i class="fas fa-plus"></i> **Content-Block erstellen** und dann **HTML code editor** aus.

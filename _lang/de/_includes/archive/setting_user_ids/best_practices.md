...
| ---------------------- | -------------------------- |
| Nutzer:in wurde zuvor **nicht** identifiziert | Der anonyme Verlauf wird bei der Identifizierung mit dem Kundenprofil or Nutzerprofil **zusammengeführt**. |
| Nutzer:in **wurde** zuvor in der App oder über die API identifiziert | Der anonyme Verlauf wird bei der Identifizierung **nicht** mit dem Kundenprofil or Nutzerprofil zusammengeführt. |
...
- Ändern Sie die Nutzer-ID nicht, wenn sich ein:e Nutzer:in abmeldet, da dies das Gerät vom Kundenprofil or Nutzerprofil trennen kann.

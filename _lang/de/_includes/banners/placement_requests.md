...
Wenn Sie neuere Mindest-SDK-Versionen verwenden (SWIFT 13.1.0+, Android 38.0.0+, Web 6.1.0+, React Native 17.0.0+ und Flutter 15.0.0+), werden Aktualisierungsanfragen durch einen Token / Textbaustein-Bucket-Algorithmus gesteuert, um übermäßiges Polling zu verhindern:

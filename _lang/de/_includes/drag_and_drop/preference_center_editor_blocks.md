...
Bevor Sie Blöcke bearbeiten, fügen Sie Abo-Gruppen hinzu und konfigurieren Sie den **Smart Block** für Abos (siehe unten). Den vollständigen Einrichtungsablauf finden Sie unter [Ein E-Mail-Präferenzzentrum mit Drag-and-Drop erstellen]({{site.baseurl}}/user_guide/audience/subscription_preferences/preference_center/dnd_preference_center/).
...
Fügt einen klickbaren Button hinzu (zum Beispiel **Save** oder Navigation).
...
Fügt einen Template-Block hinzu, der Abo-Gruppen, optionale Steuerelemente für **Subscribe to all** / **Unsubscribe from all** sowie Beschreibungen auflistet. Konfigurieren Sie ihn, nachdem Sie Gruppen im Workflow des Präferenzzentrums hinzugefügt haben.

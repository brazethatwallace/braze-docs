...
| Klickverhalten | Bestimmt die Aktion, wenn Nutzer:innen auf das Bild klicken, z. B. die Nachricht schließen, eine Web-URL öffnen, einen Deeplink zu einer bestimmten Seite der App erstellen, zu einer anderen Seite navigieren oder eine [Push-Berechtigung anfordern]({{site.baseurl}}/user_guide/channels/push/best_practices/push_primer_messages/). |

...
| Klick-Verhalten | Bestimmt die Aktion, wenn Nutzer:innen den Button anklicken, z. B. die Nachricht schließen, eine Internet-URL öffnen, einen Deeplink zu einer bestimmten Seite der App erstellen, zu einer anderen Seite navigieren oder eine [Push-Berechtigung anfordern]({{site.baseurl}}/user_guide/channels/push/best_practices/push_primer_messages/). |

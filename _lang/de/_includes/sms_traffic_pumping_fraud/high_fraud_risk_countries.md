### Was sind Länder mit hohem Betrugsrisiko, und warum gibt es sie? {#what-are-high-fraud-risk-countries-and-why-do-they-exist}
...
{% if include.detail %}
Länder mit hohem Betrugsrisiko sind in der Allowlist für geografische Berechtigungen mit dem Tag **High Fraud Risk** gekennzeichnet. Braze aktualisiert diese Liste regelmäßig.
{% endif %}
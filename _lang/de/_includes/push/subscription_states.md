...
{% alert note %}
Der Push-Abo-Status einer Nutzer:in gilt für das gesamte Kundenprofil, das alle Geräte der Nutzer:in umfasst.
{% endalert %}
...
|---|---|
| `Subscribed` | Standard-Push-Abo-Status, wenn ein Kundenprofil in Braze erstellt wird. |

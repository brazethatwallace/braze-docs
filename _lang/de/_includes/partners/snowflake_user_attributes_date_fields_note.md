...
- `TIME` und `TIME_MS`: Stellen den Zeitpunkt dar, zu dem das Nutzerprofil-Update in Braze erfolgte (in Sekunden bzw. Millisekunden). Bei nachträglich aufgefüllten Daten entsprechen diese Werte dem Zeitpunkt der Auffüllung.

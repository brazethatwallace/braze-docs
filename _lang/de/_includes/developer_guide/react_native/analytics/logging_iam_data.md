...
## Methoden zur Protokollierung {#methods-for-logging}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Methoden zur Protokollierung" }

## Umgang mit Nachrichten-Daten {#handling-message-data}

In den meisten Fällen können Sie die Methode `Braze.addListener` verwenden, um Event-Listener zu Registrierung, die Daten aus In-App-Nachrichten verarbeiten.
...
{% endsubtab %}
{% subtab iOS %}
### Überschreiben des Standard-UI-Delegaten {#overriding-the-default-ui-delegate}
...
### Native Standard-UI überschreiben {#overriding-the-default-native-ui}

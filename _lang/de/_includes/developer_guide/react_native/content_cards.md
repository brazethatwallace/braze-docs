...
## Kartenmethoden {#reactnative_cards-methods}
...
{% alert important %}
Wenn Sie Ihre eigene Benutzeroberfläche zur Anzeige von Karten erstellen möchten, müssen Sie `logContentCardImpression` aufrufen, um Analytics für diese Karten zu erhalten. Dies gilt auch für Karten des Typs `control`, die nachverfolgt werden müssen, auch wenn sie Nutzer:innen nicht angezeigt werden.
{% endalert %}

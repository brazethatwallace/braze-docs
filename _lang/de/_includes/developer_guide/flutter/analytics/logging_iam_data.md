...
## Protokollierung von Nachrichten-Daten {#logging-message-data}
...
## Zugriff auf Nachrichten-Daten {#accessing-message-data}
...
### Auf In-App-Nachrichten-Daten im Dart-Layer lauschen {#listen-for-in-app-message-data-in-the-dart-layer}
...
### Callback für In-App-Nachrichten erneut abspielen (optional) {#replaying-the-callback-for-in-app-messages-optional}

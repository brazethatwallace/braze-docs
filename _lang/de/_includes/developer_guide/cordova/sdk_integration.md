...
| `is_firebase_messaging_service_on_new_token_registration_enabled` | Legt fest, ob das Braze SDK Token / Textbaustein automatisch in `com.google.firebase.messaging.FirebaseMessagingService.onNewToken` Registrierung soll.                                                       |

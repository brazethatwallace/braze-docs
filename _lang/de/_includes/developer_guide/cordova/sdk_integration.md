...
### 1. Schritt: Fügen Sie das SDK zu Ihrem Projekt hinzu {#step-1-add-the-sdk-to-your-project}
...
### 2. Schritt: Konfigurieren Sie Ihr Projekt {#step-2-configure-your-project}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="2. Schritt: Konfigurieren Sie Ihr Projekt" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Optionale Konfigurationen #optional" }

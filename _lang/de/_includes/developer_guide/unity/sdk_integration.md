## Über das Unity Braze SDK or Software-Development-Kit {#about-the-unity-braze-sdk}
...
## Integration des Unity SDK or Software-Development-Kit {#integrating-the-unity-sdk}

### Voraussetzungen {#prerequisites}

Bevor Sie beginnen, überprüfen Sie, ob Ihre Umgebung von der [neuesten Braze Unity SDK or Software-Development-Kit-Version](https://github.com/braze-inc/braze-unity-sdk/releases) unterstützt wird.
...
{% alert note %}
Ab Unity 2.6.0 benötigt das gebündelte Braze Android SDK or Software-Development-Kit-Artefakt [AndroidX](https://developer.android.com/jetpack/androidx)-Abhängigkeiten. Wenn Sie zuvor ein `jetified` unitypackage verwendet haben, können Sie bedenkenlos auf das entsprechende `unitypackage` umsteigen.
...
### Schritt 3: SDK or Software-Development-Kit konfigurieren {#step-3-configure-the-sdk}

{% tabs %}
{% tab Android %}
#### Schritt 3.1: `AndroidManifest.xml` konfigurieren {#step-31-configure-androidmanifestxml}

Konfigurieren Sie [`AndroidManifest.xml`](https://docs.unity3d.com/Manual/android-manifest.html), damit das Braze SDK or Software-Development-Kit ordnungsgemäß funktioniert. Wenn Ihre App keine `AndroidManifest.xml` hat, können Sie das folgende Template als Vorlage verwenden. Wenn Sie bereits eine `AndroidManifest.xml` haben, stellen Sie sicher, dass die folgenden fehlenden Abschnitte zu Ihrer bestehenden `AndroidManifest.xml` hinzugefügt werden.
...
{% alert important %}
Alle in Ihrer `AndroidManifest.xml`-Datei registrierten Activity-Klassen sollten vollständig in das Braze Android SDK or Software-Development-Kit integriert sein, da Ihre Analytics sonst nicht erfasst werden. Wenn Sie Ihre eigene Activity-Klasse hinzufügen, stellen Sie sicher, dass Sie [den Braze Unity-Player erweitern](#unity_extend-unity-player), um dies zu verhindern.
{% endalert %}

#### Schritt 3.2: `AndroidManifest.xml` mit Ihrem Paketnamen Update or aktualisieren or aktualisieren {#step-32-update-androidmanifestxml-with-your-package-name}
...
### Schritt 1: Repository Klon or klonen {#step-1-clone-the-repository}

Klon or klonen Sie in Ihrem Terminal das [Braze Unity SDK or Software-Development-Kit GitHub-Repository](https://github.com/braze-inc/braze-unity-sdk) und navigieren Sie dann zu diesem Ordner:
...
Um die Vorteile der automatisierten iOS-Integration des Braze Unity SDK or Software-Development-Kit zu nutzen, befolgen Sie diese Schritte für den Übergang von einer manuellen zu einer automatisierten Integration.
...
3. Geben Sie im Feld **SDK or Software-Development-Kit Log Level** den Wert „0“ ein.
...
1. Fügen Sie das Braze Android SDK or Software-Development-Kit als Abhängigkeit zu Ihrem Bibliotheks- oder Plugin-Projekt hinzu, wie in den [Anweisungen zur Braze Android SDK or Software-Development-Kit-Integration]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=android) beschrieben.

...
Diese angepassten Ansichten bieten intelligente Möglichkeiten für das Engagement Ihrer Kund:innen, indem sie verschiedene Arten von Inhalten anzeigen – darunter interaktive Benachrichtigungen, mit Nutzerdaten gefüllte Benachrichtigungen und sogar Push-Nachrichten, die Informationen wie Telefonnummern und E-Mail-Adressen erfassen können. Eines unserer bekannten Features bei Braze, [Push-Storys]({{site.baseurl}}/user_guide/message_building_by_channel/push/advanced_push_options/push_stories/), ist ein Paradebeispiel dafür, wie eine App-Erweiterung für Push-Benachrichtigungsinhalte aussehen kann!
...
1. Klicken Sie auf der Seite **Kampagnen** auf **Kampagne erstellen**, um eine neue Push-Benachrichtigungskampagne zu starten.

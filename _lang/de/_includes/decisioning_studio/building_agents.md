# Entwicklungsprozess von KI or künstliche Intelligenz-Entscheidungsagenten {#building-ai-decisioning-agents}
...
Ein KI or künstliche Intelligenz-Decisioning-Agent ist eine angepasste Konfiguration für die BrazeAI<sup>TM</sup>-Decisioning-Engine, die speziell auf ein bestimmtes Geschäftsziel zugeschnitten ist.
...
- Die Optionen für jede Dimension auswählen, z. B. E-Mail im Vergleich zu Kurzmitteilungsdienst or SMS oder tägliche im Vergleich zu wöchentlicher Häufigkeit.
...
Hier sind einige Beispiele für Agenten, die Sie mit BrazeAI Decisioning Studio™ erstellen können. Ihre KI or künstliche Intelligenz-Decisioning-Agenten lernen aus jeder Kundeninteraktion und wenden diese Insights auf die Aktionen des nächsten Tages an.
...
### Schritt 1: KI or künstliche Intelligenz Expert Services kontaktieren {#step-1-contact-ai-expert-services}

Das KI or künstliche Intelligenz Expert Services-Team arbeitet eng mit Ihnen zusammen, um Ihren Decisioning-Agenten zu planen, zu entwerfen und zu erstellen. Falls noch nicht geschehen, [kontaktieren Sie uns](https://www.braze.com/get-started/), um loszulegen.
...
Gemeinsam mit dem KI or künstliche Intelligenz Expert Services-Team definieren Sie:
...
Als Nächstes unterstützt Sie das KI or künstliche Intelligenz Expert Services-Team bei der Einrichtung Ihrer Customer-Engagement-Plattform. Decisioning Studio funktioniert am besten mit Braze, es werden jedoch auch verschiedene andere Plattformen unterstützt&#8212;wenden Sie sich an Ihr KI or künstliche Intelligenz Expert Services-Team für weitere Informationen.
...
Nach dem Start Ihres Agenten überwacht und optimiert Ihr KI or künstliche Intelligenz Expert Services-Team diesen weiterhin gemäß dem vereinbarten Design. Das Team hilft Ihnen außerdem bei Anpassungen, Erweiterungen oder Änderungen am Agenten, falls erforderlich.
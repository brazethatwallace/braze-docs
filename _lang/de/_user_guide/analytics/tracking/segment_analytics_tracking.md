...
Um die Segment-Daten für einen beliebigen angepassten Zeitraum visuell zu vergleichen, fügen Sie dem Diagramm Segmente hinzu oder entfernen Sie sie. Wählen Sie in der Dropdown-Liste **Breakdown** die Option **By Segment** und wählen Sie dann Ihre Segmente unter **Breakdown values** aus.

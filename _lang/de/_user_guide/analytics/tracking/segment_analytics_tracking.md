...
Sehen Sie sich Daten über [angepasste Events im Zeitverlauf für Segmente]({{site.baseurl}}/user_guide/data/activation/events/custom_events#analytics) an, indem Sie zu **Analytics** > **Custom Events Report** gehen.

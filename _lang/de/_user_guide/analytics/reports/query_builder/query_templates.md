...
| SMS-Fehlercodes | Dieser Bericht zeigt den Fehlertyp und die Anzahl der Fehler für jeden SMS-Fehlercode. <br><br>![Screenshot zu Mobilgeräte-Templates.]({% image_buster /assets/img_archive/sms_errors.png %}){: style="max-width:50%;"} |

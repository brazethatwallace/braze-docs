...
Um Ihre Daten zu angepassten Events zu exportieren, wählen Sie <i class="fas fa-bars" title="Chart-Kontextmenü"></i> im Diagramm **Performance Over Time** und wählen Sie Ihre Exportoption.

...
| KPI-Formel | Ersetzt die rohe Event-Anzahl durch eine berechnete Kennzahl, die aus einem Zähler (z. B. Anzahl angepasster Events) und einem Nenner (z. B. DAU, MAU oder Größe eines Analytics-fähigen Segments) besteht. Wenn Sie eine oder mehrere Formeln auswählen, stellt das Chart den Wert jeder Formel über den ausgewählten Zeitraum dar, sodass Sie normalisierte Performance vergleichen können (z. B. „Events pro aktivem/aktiver Nutzer:in“) anstatt des gesamten Event-Volumens. Falls für den ausgewählten Zeitraum und die Formeln keine Daten verfügbar sind, zeigt Braze eine Meldung „Keine Daten“ an – erweitern Sie den Zeitraum oder wählen Sie andere Formeln. Wählen Sie **Manage KPI formulas**, um Formeln zu erstellen oder zu bearbeiten. |

...
description: "Dieser Referenzartikel beschreibt, wie Sie den Dashboard-Builder verwenden, um Dashboards und Visualisierungen mit Berichten zu erstellen, die im Abfrage-Builder erstellt wurden."
page_type: reference
tool:
    - Reports
page_order: 6
...
- **Berichte**, die im Berichts-Builder erstellt wurden
- **Benutzerdefinierte Abfragen**, die im Abfrage-Builder erstellt wurden<br><br>![Fenster zur Auswahl Ihrer Datenquelle für Ihr Dashboard.]({% image_buster /assets/img/select_data_source.png %})<br><br>
...
{: start="4"}
4. Wählen Sie **+ Kachel hinzufügen** und dann einen der Berichte, die Sie im [Berichts-Builder (Neu)]({{site.baseurl}}/user_guide/analytics/reports/report_builder/) erstellt haben.
...
5. Wählen Sie das Stiftsymbol, um zu ändern, wie der Titel und der Chart-Typ in der Kachel angezeigt werden.
    - Sie können zwischen verschiedenen Chart-Typen unterhalb der Standardvisualisierung umschalten. Die aktuellen Optionen umfassen Balkendiagramme (horizontal oder vertikal) und Liniendiagramme (nur verfügbar, wenn Sie **Datum** als Drilldown-Option im Berichts-Builder-Setup ausgewählt haben).<br><br>![Umschalter für verschiedene Chart-Typen.]({% image_buster /assets/img/report_builder_types.png %})<br><br>
...
6. Wählen Sie **Speichern**, nachdem Sie die Visualisierung nach Ihren Wünschen angepasst haben.
7. Fügen Sie einen Namen, eine Beschreibung und einen Tag hinzu, damit Ihr Dashboard später leichter zu finden ist.
{% endtab %}
{% tab Custom Queries %}
{: start="4"}
4. Wählen Sie **+ Kachel hinzufügen** und dann eine Abfrage, die Sie im Abfrage-Builder ausgeführt haben.
5. Um zu bearbeiten, wie die Abfrageergebnisse in der Kachel angezeigt werden, wählen Sie das Stiftsymbol, um den Titel und den Chart-Typ zu ändern.
    - Sie können zwischen verschiedenen Chart-Typen unterhalb der Standardvisualisierung umschalten. Aktuelle Optionen umfassen Tabellen, Balkendiagramme (horizontal oder vertikal) und Liniendiagramme.<br><br>![Umschalter für verschiedene Chart-Typen.]({% image_buster /assets/img/query_builder_types.png %})<br><br>
        - Wenn Sie eine der Chart-Optionen wählen, verwenden Sie das **X-Achse**-Dropdown, um eine einzelne Spalte aus Ihren Abfrageergebnissen als X-Achse auszuwählen.
        - Verwenden Sie das **Y-Achse**-Dropdown, um auszuwählen, welche Metriken in Ihrer Visualisierung enthalten sein sollen. Standardmäßig werden alle Spalten aus Ihren Abfrageergebnissen angezeigt. Deaktivieren Sie daher die Spalten, die Sie nicht anzeigen möchten.<br><br>![Umschalter für verschiedene Chart-Typen.]({% image_buster /assets/img/query_builder_axis.png %})<br><br>
        - (Optional) Sie können das **Gruppierung**-Dropdown verwenden, um Ihre Abfrageergebnisse zu gruppieren. Wenn Sie beispielsweise eine Kampagnen-ID als Spaltenergebnis haben und alle Zeilen mit diesem Wert zusammenfassen möchten, verwenden Sie das **Gruppierung**-Dropdown.  
...
Löschen Sie eine Dashboard-Kachel, indem Sie **Kachel löschen** am unteren Rand der Kachel auswählen. **Diese Aktion kann nicht rückgängig gemacht werden.**
...
3. Wählen Sie **Dashboard ausführen**, um das jeweilige Dashboard zu laden.
...
#### Umsatz – Last-Touch-Attribution

Das Dashboard **Umsatz – Last-Touch-Attribution** bietet eine Übersicht über den Umsatz über Kampagnen, Canvases und Kanäle hinweg. Alle Umsatzdaten werden der zuletzt berührten Nachricht innerhalb des Attribution-Fensters zugeordnet.
...
| Metrik | Definition |
| --- | --- |
| Gesamter Last-Touch-Umsatz | Eine Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem Last-Touch-Event innerhalb des ausgewählten Datumsbereichs und Attribution-Fensters. |
| Gesamte Kauf-Conversions | Eine Anzahl aller Kampagnen- und Canvas-Umsatz-Events mit einem qualifizierenden Last-Touch-Event. |
| Durchschnittliche Tage bis zur Conversion | Die durchschnittliche Zeit zwischen allen Kampagnen- und Canvas-Kauf-Events mit einem qualifizierenden Last-Touch-Event. |
...
| Umsatz nach Land | Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem Last-Touch-Event, gruppiert nach Land. |
| Umsatz nach Kampagne | Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem qualifizierenden Last-Touch-Event, gruppiert nach Kampagne. |
| Umsatz nach Kampagnenvariante | Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem qualifizierenden Last-Touch-Event, gruppiert nach Kampagnenvariante. |
| Umsatz nach Canvas | Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem qualifizierenden Last-Touch-Event, gruppiert nach Canvas. |
| Umsatz nach Canvas-Variante | Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem qualifizierenden Last-Touch-Event, gruppiert nach Canvas-Variante. |
| Käufe pro Produkt | Eine Anzahl aller Käufe, gruppiert nach Produkt. |
| Umsatz nach Kanal | Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem qualifizierenden Last-Touch-Event, gruppiert nach Kanal. | 
| Umsatz-Zeitreihe | Summe aller Kampagnen- und Canvas-Umsatz-Events mit einem qualifizierenden Last-Touch-Event, gruppiert nach Tag in UTC. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }

#### Geräte und Mobilfunkanbieter
...
| Top-10-Kampagnen für Engagement-Metriken | Rangliste der Kampagnen mit den höchsten E-Mail-Engagement-Metriken (konfigurierbare Metrik für die Rangfolge).|
| Untere 10 Kampagnen für Engagement-Metriken | Rangliste der Kampagnen mit den niedrigsten E-Mail-Engagement-Metriken (konfigurierbare Metrik für die Rangfolge).|
...
| Top-10-Kampagnen für Kauf-Metriken | Rangliste der Kampagnen mit den höchsten Kauf-Conversion-Metriken aus E-Mail-Engagement (konfigurierbare Metrik für die Rangfolge).|
| Untere 10 Kampagnen für Kauf-Metriken | Rangliste der Kampagnen mit den niedrigsten Kauf-Conversion-Metriken aus E-Mail-Engagement (konfigurierbare Metrik für die Rangfolge).|
...
| Kampagnen konvertieren zu Sitzungen | Anzahl der eindeutigen Sitzungen, die gleichzeitig mit Kampagnen-Conversions stattfanden, gruppiert nach Kampagnen-ID und nach Sitzungsanzahl sortiert.|

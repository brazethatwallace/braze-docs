...
Sie können kürzlich bearbeitete oder erstellte Kampagnen, Canvases und Segmente erneut aufrufen. Jede Karte ist mit Tags versehen, die den Inhaltstyp (Kampagne, Canvas, Segment) und den Status (aktiv, Entwurf, archiviert, gestoppt) angeben.

{% alert note %}
Der Abschnitt **Dort weitermachen, wo Sie aufgehört haben** erscheint, nachdem Sie eine Kampagne, ein Canvas oder ein Segment bearbeitet oder erstellt haben.
{% endalert %}
...
Wählen Sie **Aufschlüsselung anzeigen** für jede Zeile der Performance-Übersicht, um den Wert jeder Statistik pro Tag für den angegebenen Zeitraum anzuzeigen.

![Aufklappen]({% image_buster /assets/img_archive/home_dashboard_breakdown.png %})

### Performance im Zeitverlauf

Der Graph **Performance im Zeitverlauf** zeigt den Wert jeder Statistik über den angegebenen Zeitraum für die ausgewählten Apps.
...
- In-App-Nachrichten
- KPI-Formeln
  - Wählen Sie **KPI-Formeln verwalten**, um eine Formel zu erstellen oder eine bestehende Formel zu bearbeiten.
- LINE

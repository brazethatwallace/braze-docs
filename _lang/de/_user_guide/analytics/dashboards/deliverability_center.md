...
Um auf das Deliverability Center zuzugreifen, benötigen Sie die [Legacy-Benutzerberechtigungen]({{site.baseurl}}/user_guide/administer/global/user_management/permissions/?sdktab=legacy%20permissions) „Access Campaigns, Canvases, Cards, Segments, Media Library" und „View Usage Data" oder die [granularen Berechtigungen]({{site.baseurl}}/user_guide/administer/global/user_management/permissions/?sdktab=granular%20permissions) im folgenden Dropdown für Ihren Workspace.

{% details Benutzerberechtigungen für das Deliverability Center %}
...
## Ihr Google Postmaster-Konto einrichten
...
### Ungültige oder abgelaufene Autorisierung
...
## Microsoft Smart Network Data Services (SNDS) einrichten

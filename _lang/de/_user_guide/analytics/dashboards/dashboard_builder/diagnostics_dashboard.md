...
Wählen Sie eine Zeile in der Tabelle aus, um das Detailpanel zu öffnen. Das Detailpanel bietet zusätzlichen Kontext zu diesem Ergebnis, und Ask Operator liefert Hinweise zur Fehlerbehebung, um Ihnen bei der Untersuchung des zugrunde liegenden Problems zu helfen.
...
| Abbruchergebnis | Erklärung |
| ---- | ---- |
| Doppelter Nutzerbezeichner | Mehrere Nutzer:innen mit einem übereinstimmenden Bezeichner (wie externe ID, E-Mail-Adresse, Telefonnummer) waren berechtigt, diese Nachricht zu erhalten. Um doppelte Sendungen an dieselbe/denselben Nutzer:in zu vermeiden, wurde diese Nachricht abgebrochen. |
...
Wenn ein:e Nutzer:in diese einzelne gebündelte Prüfung nicht besteht, wird er/sie sofort ausgeschlossen. Dieser gebündelte Ansatz ermöglicht es Braze, große Mengen an Nachrichten mit hoher Geschwindigkeit zu verarbeiten, und kann zu einer schnelleren, stabileren Performance Ihrer Campaigns und Canvases beitragen, indem die Verarbeitungslatenz pro Nachricht reduziert wird.

### Was bedeutet ein Abbruchgrund „Sonstige“? {#what-does-an-other-abort-outcome-mean}

Hierbei handelt es sich um Abbrüche, die in keine bestehende Dashboard-Kategorie fallen. Wenn Sie weiterhin einen großen Anteil an Abbrüchen mit „Sonstige“ feststellen, wenden Sie sich an den [Braze-Support]({{site.baseurl}}/braze_support) für weitere Unterstützung.

...
| Sprache                | Android, iOS, Web | Geräte- oder Browsersprache, abgeleitet von der Geräte-Locale.                                                           | Dieses Attribut wird verwendet, um Nachrichten in die bevorzugte Sprache der Nutzer:innen zu übersetzen. Es basiert auf der Geräte-Locale.                                                                                            |
...
| Zeitzone               | Android, iOS, Web | Geräte- oder Browserzeitzone                                                           | Dieses Attribut wird verwendet, um Nachrichten zur passenden Zeit gemäß der Ortszeit der jeweiligen Nutzer:innen zu senden.                                                   |
...
Um mehr über das Tracking von Eigenschaften auf Geräteebene (wie Mobilfunkanbieter, Zeitzone, Auflösung und andere) zu erfahren, lesen Sie die plattformspezifische Dokumentation: [Android]({{site.baseurl}}/developer_guide/storage?tab=android), [iOS]({{site.baseurl}}/developer_guide/storage?tab=swift), [Web]({{site.baseurl}}/developer_guide/storage#cookies).
...
|----------------------------|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Device Ad Tracking Enabled | Android, iOS | Auf iOS:<br>[`set(adTrackingEnabled:)`](https://braze-inc.github.io/braze-swift-sdk/documentation/brazekit/braze/set(adtrackingenabled:))<br><br>Auf Android:<br>[`Braze.setGoogleAdvertisingId()`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze/-i-braze/set-google-advertising-id.html) | Diese Eigenschaft erfordert zusätzliche Berechtigungen auf App-Ebene, die von der integrierenden Person erteilt werden müssen.                                                                                                                                                                                      |
| Device IDFA                | iOS          | Gerätebezeichner für Werbetreibende (Identifier for Advertisers, IDFA)                                                                                                                                                                                                                                                                                         | Dies erfordert das Ad Tracking Transparency Framework, das eine zusätzliche Datenschutzprüfung durch den App Store auslöst. Weitere Informationen finden Sie unter [`set(identifierForAdvertiser:)`](https://braze-inc.github.io/braze-swift-sdk/documentation/brazekit/braze/set(identifierforadvertiser:)) |
...
| Letzter bekannter Standort | Android, iOS | Dies ist der zuletzt bekannte GPS-Standort des Geräts der Nutzer:innen. Dieser wird bei Sitzungsbeginn aktualisiert und im Nutzerprofil gespeichert. | Dies erfordert, dass die Nutzer:innen Ihrer App die Standortberechtigung erteilen. |
...
{% alert important %}
Braze sperrt oder blockiert Nutzer:innen mit über 5.000.000 Sitzungen („Dummy-Nutzer:innen“) und nimmt deren SDK-Events nicht mehr auf. Weitere Informationen finden Sie unter <a href="/docs/user_archival#spam-blocking">Spam-Blocking</a>.
{% endalert %}
...
- **Nutzerliste im Dashboard erstellen:** Erstellen Sie ein Segment mit dem Filter **Entered Canvas Variation** und exportieren Sie das Segment als CSV-Datei. Siehe [Canvas-Fehlerbehebung]({{site.baseurl}}/user_guide/messaging/canvas/troubleshooting#user-didnt-enter-a-canvas).

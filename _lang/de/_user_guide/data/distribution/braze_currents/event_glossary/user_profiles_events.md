...
excerpt_separator: ""
page_type: glossary
description: "Dieses Glossar listet die Kundenprofil or Nutzerprofil-Updates auf, die Braze verfolgen und über Currents an ausgewählte Data Warehouses senden kann."
tool: Currents
search_rank: 7
---
...
{% details Erläuterung der Struktur von Kundenprofil or Nutzerprofil-Update or aktualisieren-Events %}

### Event-Struktur {#event-structure}

Diese Aufschlüsselung von Kundenverhalten- und Nutzer-Events zeigt, welche Art von Informationen in der Regel in einem Kundenprofil or Nutzerprofil-Update or aktualisieren-Event enthalten sind. Mit einem soliden Verständnis der Komponenten können Ihre Entwickler:innen und Ihr Business-Intelligence-Strategie-Team die eingehenden Currents-Event-Daten nutzen, um datengestützte Berichte und Charts zu erstellen und weitere wertvolle Datenmetriken auszuwerten.
...
Wenn ein:e Nutzer:in verwaist, d. h. das Kundenprofil or Nutzerprofil mit dem Profil eines/einer anderen Nutzer:in zusammengeführt wird
...
{% api %}
## Kundenprofil or Nutzerprofil-Update or aktualisieren-Events {#user-profile-update-events}
...
{% alert important %}
Das Kundenprofil or Nutzerprofil-Update or aktualisieren-Event befindet sich in der Beta-Phase. Wenden Sie sich an Ihren CSM or Customer-Success-Manager or Customer-Success-Manager:in oder Account Manager:in, um Zugang zu erhalten.
{% endalert %}

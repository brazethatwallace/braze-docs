...
excerpt_separator: ""
page_type: glossary
description: "Dieses Glossar listet die Kundenprofil-Updates auf, die Braze verfolgen und über Currents an ausgewählte Data Warehouses senden kann."
tool: Currents
search_rank: 7
---
...
{% details Erläuterung der Struktur von Kundenprofil-Update-Events %}

### Event-Struktur {#event-structure}

Diese Aufschlüsselung von Kundenverhalten- und Nutzer-Events zeigt, welche Art von Informationen in der Regel in einem Kundenprofil-Update-Event enthalten sind. Mit einem soliden Verständnis der Komponenten können Ihre Entwickler:innen und Ihr Business-Intelligence-Strategie-Team die eingehenden Currents-Event-Daten nutzen, um datengestützte Berichte und Charts zu erstellen und weitere wertvolle Datenmetriken auszuwerten.
...
Wenn ein:e Nutzer:in verwaist, d. h. das Kundenprofil mit dem Profil eines/einer anderen Nutzer:in zusammengeführt wird
...
{% api %}
## Kundenprofil-Update-Events {#user-profile-update-events}
...
{% alert important %}
Das Kundenprofil-Update-Event befindet sich in der Beta-Phase. Wenden Sie sich an Ihren CSM oder Account Manager:in, um Zugang zu erhalten.
{% endalert %}

...
### Enthält Currents Campaign-Tags oder Schlüssel-Wert-Paare? {#does-currents-include-campaign-tags-or-key-value-pairs}

Nein. Currents enthält keine Campaign-Tags oder Schlüssel-Wert-Paare auf Nachrichtenebene. Als Workaround können Sie einen Webhook-Kanal in der Campaign verwenden, um diese Informationen an Ihren eigenen Endpunkt zu senden, und dabei [Liquid]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/liquid/) nutzen, um die Tag- und Schlüssel-Wert-Paar-Daten als Template einzubinden.

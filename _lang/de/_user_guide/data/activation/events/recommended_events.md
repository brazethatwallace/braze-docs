...
{% alert important %}
Empfohlene Events befinden sich derzeit im Early Access. Kontaktieren Sie Ihren Braze-Customer-Success-Manager, wenn Sie an diesem Early Access teilnehmen möchten. <br><br>Wenn Sie den neuen [Shopify-Konnektor]({{site.baseurl}}/partners/ecommerce/shopify/multiple_stores/?tab=shopify%20connector) nutzen, werden diese empfohlenen Events automatisch über die Integration verfügbar sein.
{% endalert %}

## So funktioniert es

Braze wendet eine spezielle Validierung auf alle empfohlenen Events an, und einige empfohlene Events verfügen über spezielle Nachbearbeitungsaktionen. Für bestimmte branchenspezifische empfohlene Events kann Braze eine spezielle Behandlung unterstützen, wie z. B. neue aktionsbasierte Trigger für Kampagnen und Canvases.
...
### Kann ich weiterhin Kauf-Events verwenden, um Käufe zu protokollieren?

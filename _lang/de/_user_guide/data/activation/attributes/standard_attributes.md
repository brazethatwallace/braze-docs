...
Diese Felder erfassen demografische Daten, Kontaktdaten und Gebietsschemadaten Ihrer Nutzer:innen.

| Feld | Datentyp | Format und Hinweise |
|---|---|---|
| `first_name` | String | Der Vorname der/des Nutzer:in (zum Beispiel `Jane`). |
...
Diese Felder speichern Daten aus Social-Network-Integrationen.
...
Den vollständigen API-Vertrag finden Sie unter [Nutzerattribut-Objekt]({{site.baseurl}}/api/objects_filters/user_attributes_object).

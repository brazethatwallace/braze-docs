...
article_title: Artikelempfehlungen im Messaging verwenden
description: "Dieser Artikel beschreibt, wie Sie Artikelempfehlungen in Ihrer Nachricht verwenden können."
page_order: 1.2
---

# Artikelempfehlungen im Messaging verwenden {#use-item-recommendations-in-your-messaging}
...
### 1. Schritt: Liquid-Code hinzufügen {#step-1-add-liquid-code}
...
1. Wählen Sie in jedem Nachrichten-Editor, der Personalisierung unterstützt, <i class="fa-solid fa-circle-plus" style="color: #12aec5;" title="Add personalization"></i> aus, um das Personalisierungsfenster zu öffnen.
...
### 2. Schritt: Ein Bild referenzieren (optional) {#step-2-reference-an-image-optional}

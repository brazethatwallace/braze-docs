...
## Conversion-Wahrscheinlichkeit basierend auf Engagement-Umfragen bestimmen {#determine-conversion-likelihood-based-on-engagement-surveys}

{% apitags %}
Canvas agent
{% endapitags %}

Dieser Anwendungsfall beschreibt, wie ein Canvas-Agent dabei helfen kann, die Konversionsrate für kostenlose Abonnent:innen in einer App zu bestimmen. Der Agent kann das Nutzerverhalten analysieren und Nutzer:innen einem Segment für Abonnent:innen zuweisen, die wahrscheinlich konvertieren. Das Ziel ist es, Empfehlungen für verschiedene Bindungsstrategien zurückzugeben, um kostenlose Abonnent:innen in zahlende Abonnent:innen umzuwandeln.
...
- Angepasste Attribute:
    - Anzahl der Tage seit Beginn der kostenlosen Testphase
    - Anzahl der Flug- und Hotelsuchen während der kostenlosen Testphase
    - Anzahl der genutzten Premium-Features während der kostenlosen Testphase
- Kontextvariable für den Tag, an dem die App zuletzt geöffnet wurde
- **Agentenkontext**
    - **Gesamter Canvas-Kontext:** Übergibt alle zusätzlichen Kontextvariablen an den Agenten, die Sie nicht bereits in Ihren Agenten-Anweisungen definiert haben, falls sie hilfreich oder relevant sind
    - **Segmentzugehörigkeit:** Um zu prüfen, ob die Nutzerin oder der Nutzer im Segment „Has Valid Payment Method on File“ ist

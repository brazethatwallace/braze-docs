...
article_title: "Anwendungsfall: Abwanderung or Abwanderung, Churn or Abwanderung, churnen durch zeitnahe Inhalte verringern"
description: "Dieses Beispiel veranschaulicht, wie eine fiktive Marke Predictive Abwanderung or Abwanderung, Churn or Abwanderung, churnen einsetzt, um proaktiv die Abwanderung von Nutzer:innen zu reduzieren."
page_type: tutorial
---

# Anwendungsfall: Abwanderung or Abwanderung, Churn or Abwanderung, churnen durch zeitnahe erneute Interaktion mit Inhalten verringern {#use-case-reduce-churn-with-timely-content-re-engagement}

> Dieses Beispiel veranschaulicht, wie eine fiktive Marke Predictive Abwanderung or Abwanderung, Churn or Abwanderung, churnen einsetzt, um proaktiv die Abwanderung von Nutzer:innen zu reduzieren. Anstatt abzuwarten, bis es zu Abwanderung or Abwanderung, Churn or Abwanderung, churnen kommt, sollten Sie vorhersagen, welche Nutzer:innen gefährdet sind, und ihnen maßgeschneiderte Nachrichten zukommen lassen, solange sie noch aktiv sind.

Nehmen wir an, Camila ist CRM or Customer-Relationship-Management [-System] (CRM)-Manager:in:in bei MovieCanon, einer Streaming-Plattform für Independent-Filme, Dokumentationen und internationale Serien.

Das Team von Camila hat einen besorgniserregenden Trend festgestellt: Nutzer:innen führen eine Registrierung durch, streamen ein oder zwei Filme und verschwinden dann. In der Vergangenheit wurde versucht, eine Woche später eine allgemeine E-Mail mit dem Inhalt „Wir vermissen Sie“ zu versenden – jedoch mit einer Konversionsrate von nur 3 % war dies unzureichend und kam zu spät. Die meisten Nutzer:innen interagieren nicht erneut, und Abwanderung or Abwanderung, Churn or Abwanderung, churnen wird unvermeidlich.

Camila möchte dies ändern. Anstatt auf Abwanderung or Abwanderung, Churn or Abwanderung, churnen zu reagieren, nachdem er bereits eingetreten ist, nutzt sie Predictive Abwanderung or Abwanderung, Churn or Abwanderung, churnen, um Nutzer:innen zu identifizieren, die innerhalb der nächsten 14 Tage wahrscheinlich inaktiv werden – so hat ihr Team die Möglichkeit zu einer erneuten Interaktion mit diesen Personen, solange sie noch aktiv sind.

Dieses Tutorial führt Sie durch die Vorgehensweise von Camila:

- Erstellen eines Modells zur Abwanderung or Abwanderung, Churn or Abwanderung, churnen-Prognose auf Grundlage des Nutzerverhaltens
...
## 1. Schritt: Erstellen Sie ein Modell zur Abwanderung or Abwanderung, Churn or Abwanderung, churnen-Prognose {#step-1-create-a-churn-prediction-model}

Camila beginnt damit, das Ergebnis zu modellieren, das sie vermeiden möchte: dass Nutzer:innen inaktiv werden. Für MovieCanon bedeutet Abwanderung or Abwanderung, Churn or Abwanderung, churnen, dass innerhalb von 14 Tagen kein Stream gestartet wird – dies ist das Verhalten, das sie vorhersagen möchte.

1. Im Braze-Dashboard navigiert Camila zu **Analytics** > **Predictive Abwanderung or Abwanderung, Churn or Abwanderung, churnen**.
2. Sie erstellt eine neue Abwanderung or Abwanderung, Churn or Abwanderung, churnen-Prognose und benennt sie „Abwanderung or Abwanderung, Churn or Abwanderung, churnen-Risiko in zwei Wochen“.
3. Um Abwanderung or Abwanderung, Churn or Abwanderung, churnen zu definieren, wählt sie `do not` und das angepasste Event `stream_started`, das aktives Engagement anzeigt.
...
## 2. Schritt: Segmentieren Sie Nutzer:innen nach Abwanderung or Abwanderung, Churn or Abwanderung, churnen-Risiko {#step-2-segment-users-by-churn-risk}

Nach Abschluss des Trainings weist Braze jeder in Frage kommenden Nutzer:in einen [Abwanderung or Abwanderung, Churn or Abwanderung, churnen-Risiko-Score]({{site.baseurl}}/user_guide/brazeai/predictive_suite/predictive_churn/analytics#churn_score) zwischen 0 und 100 zu.
...
2. Sie erstellt ein [Segment]({{site.baseurl}}/user_guide/audience/segments/creating_a_segment) mithilfe des [Filters „Abwanderung or Abwanderung, Churn or Abwanderung, churnen Risk Score“]({{site.baseurl}}/user_guide/audience/segments/segmentation_filters#churn-risk-score) und wählt die von ihr erstellte Abwanderung or Abwanderung, Churn or Abwanderung, churnen-Prognose aus:
...
4. Camila wählt E-Mail als ihren primären Kanal – dieser bietet ihr die Möglichkeit, mehrere personalisierte Inhalte in einem visuell ansprechenden Format ohne allzu großen Druck hervorzuheben. Die E-Mail enthält:
   - Eine personalisierte Watchlist, die auf [KI or künstliche Intelligenz-Artikelempfehlungen]({{site.baseurl}}/user_guide/brazeai/item_recommendations) basiert und dynamisch aus dem Katalog von MovieCanon ausgewählt wird
...
Dank Predictive Abwanderung or Abwanderung, Churn or Abwanderung, churnen, intelligentem Timing und KI or künstliche Intelligenz-gestützter Personalisierung reagiert Camilas Team nicht nur auf Abwanderung or Abwanderung, Churn or Abwanderung, churnen – sie sind ihm einen Schritt voraus. Und ihre Campaign läuft diskret im Hintergrund und erreicht die richtigen Personen zur richtigen Zeit mit Inhalten, die für sie tatsächlich von Interesse sind.
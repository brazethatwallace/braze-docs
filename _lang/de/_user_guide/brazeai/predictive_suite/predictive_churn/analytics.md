...
# Predictive-Churn-Analytics {#predictive-churn-analytics}

> Nachdem Ihre Prognose erstellt und trainiert wurde, haben Sie Zugriff auf die Seite **Prediction Analytics**. Diese Seite hilft Ihnen bei der Entscheidung, welche Nutzer:innen Sie auf der Grundlage ihres _Churn-Risiko-Scores_ oder ihrer Kategorie ansprechen sollten.

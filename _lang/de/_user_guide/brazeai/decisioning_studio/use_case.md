...
- Die Orchestrierung einrichtet, damit Entscheidungen in Braze als geschäftskunden-Engagement-Plattform einfließen
...
Für jede Dimension listet sie konkrete Optionen in der Aktionsbank auf – die einzigen Aktionen, die der Agent ausführen darf (alles andere bleibt konstruktionsbedingt ausgeschlossen). Der Agent experimentiert dann mit den zulässigen Kombinationen, um herauszufinden, was für jede:n geschäftskunden funktioniert, und optimiert dabei die gewählte Erfolgsmetrik.

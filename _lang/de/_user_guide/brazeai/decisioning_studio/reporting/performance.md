...
- **Segments:** Alle angewendeten Segmente. Diese werden individuell mit Ihrem KI or künstliche Intelligenz Expert Services-Team konfiguriert.
...
Diese Verzögerungen werden für Ihren Anwendungsfall konfiguriert. Wenn Sie Ihr spezifisches Berichtsfenster verstehen möchten, wenden Sie sich an Ihre:n KI or künstliche Intelligenz Success Manager:in:in.

## KPI or Leistungskennzahl or Leistungskennzahlen-Karten {#kpi-cards}

Die KPI or Leistungskennzahl or Leistungskennzahlen-Karten auf der primären Seite des Berichts zeigen die für Ihren Anwendungsfall konfigurierten KPI or Leistungskennzahl or Leistungskennzahlen or Leistungskennzahl or Leistungskennzahlen, wie z. B.:

- Inkrementeller LTV or Lifetime-Value / Kund:in
- Conversions / Kund:in
- Abmeldungen / Kund:in

Jede Karte stellt die KPI or Leistungskennzahl or Leistungskennzahlen dar, die über den gesamten ausgewählten Datumsbereich berechnet wird. Dies ist ein Gesamtzeitraumwert, kein Tagesdurchschnitt. Wenn Sie beispielsweise „Inkrementeller LTV or Lifetime-Value / Kund:in = 3,192“ sehen, spiegelt das die Performance über das gesamte ausgewählte Fenster wider.
...
## KPI or Leistungskennzahl or Leistungskennzahlen-Trendchart {#kpi-trend-chart}

Verwenden Sie das Chart, um Trends im Zeitverlauf, Performance-Verschiebungen und Saisonalitäts- oder Timing-Effekte zu verstehen. Verwenden Sie die KPI or Leistungskennzahl or Leistungskennzahlen-Karte, um die Gesamtauswirkung über das gesamte Fenster zu verstehen. Das zentrale Chart zeigt dieselbe KPI or Leistungskennzahl or Leistungskennzahlen wie die obere Karte, aber pro Tag berechnet. Jeder Punkt stellt den KPI or Leistungskennzahl or Leistungskennzahlen-Wert dieses Tages dar. Wenn Sie den 7-Tage-Durchschnitt ausgewählt haben, spiegelt jeder Punkt einen gleitenden Durchschnitt wider, der die tägliche Volatilität glättet.
...
Das Chart und die KPI or Leistungskennzahl or Leistungskennzahlen-Karte sind darauf ausgelegt, unterschiedliche Dinge zu zeigen. Das Chart zeigt die tägliche Performance („Wie haben Sie an jedem Tag abgeschnitten?“). Die KPI or Leistungskennzahl or Leistungskennzahlen-Karte zeigt die Gesamtzeitraum-Performance („Wie haben Sie über den gesamten Zeitraum abgeschnitten?“). Bei Ratenmetriken beantworten sie unterschiedliche Fragen.
...
Das Chart zeigt beides. Die KPI or Leistungskennzahl or Leistungskennzahlen-Karte berechnet über beide Tage zusammen neu (12 Conversions / 110 Kund:innen = 10,9 %), nicht einen Durchschnitt von 10 % und 20 %.

## Uplift-Chart {#uplift-chart}

Das Uplift-Chart zeigt die prozentuale Differenz zwischen Ihren Vergleichsgruppen. Es wird berechnet als: **(Primäre Gruppe - Vergleichsgruppe) / Vergleichsgruppe**. Dies wird dynamisch basierend auf den KPI or Leistungskennzahl or Leistungskennzahlen-Chart-Werten berechnet.
...
{% alert important %}
Der Uplift wird nicht gespeichert. Er wird aus den KPI or Leistungskennzahl or Leistungskennzahlen-Ergebnissen berechnet. Wenn sich der Uplift ändert, liegt das daran, dass sich die zugrunde liegende KPI or Leistungskennzahl or Leistungskennzahlen geändert hat.
{% endalert %}
...
- Gesamter inkrementeller LTV or Lifetime-Value
- Gesamtzahl der Kund:innen
- Abgeleiteter KPI or Leistungskennzahl or Leistungskennzahlen-Wert

Dieser Abschnitt verdeutlicht die Beziehung zwischen den verschiedenen Ansichten:

- Die KPI or Leistungskennzahl or Leistungskennzahlen-Karte ist eine Berechnung auf Fensterebene.
- Das Chart ist eine tägliche Berechnung.
- Die Tabelle zeigt die zugrunde liegenden Gesamtwerte, die die KPI or Leistungskennzahl or Leistungskennzahlen bestimmen.
...
Der Treiberbaum zerlegt eine KPI or Leistungskennzahl or Leistungskennzahlen in ihre Komponententreiber. Zum Beispiel kann „Inkrementeller LTV or Lifetime-Value / Kund:in“ aufgeteilt werden in:
...
Treiberbäume verwenden dieselben KPI or Leistungskennzahl or Leistungskennzahlen-Definitionen wie der Representational State Transfer des Dashboards und führen keine neue Berechnungslogik ein. Sie helfen zu erklären, was die Performance antreibt. Wenn sich eine KPI or Leistungskennzahl or Leistungskennzahlen-Definition ändert, werden Charts, Karten, Uplift und Treiberbäume gemeinsam aktualisiert.
...
Wenn Sie Klarheit über Ihr spezifisches Berichtsfenster oder die Datenverfügbarkeitsregeln benötigen, wenden Sie sich an Ihre:n KI or künstliche Intelligenz Success Manager:in:in.
...
- **Ratenmetriken** (wie Konversionsrate, Umsatz pro Nutzer:in oder Klick, der or klicken-through-Rate) beantworten: „Wie effizient ist es passiert?“

Volumen und Rate erzählen unterschiedliche Geschichten. Eine Campaign kann ein höheres Volumen, aber eine geringere Effizienz erzielen – oder umgekehrt. Wenn Sie Ergebnisse interpretieren, prüfen Sie immer, welche Art von KPI or Leistungskennzahl or Leistungskennzahlen Sie betrachten.
...
Wenn Sie verstehen möchten, wie Eindeutigkeit in Ihrem Setup definiert wurde, wenden Sie sich an Ihre:n KI or künstliche Intelligenz Success Manager:in:in.

### Warum könnte dieser Bericht von einem anderen System abweichen? {#why-might-this-report-differ-from-another-system}

Wenn Ihr Performance-Bericht nicht mit einem anderen Dashboard übereinstimmt (z. B. einem E-Mail-Anbieter or ESP, Analytics-Tool oder internen BI-Bericht), bedeutet das nicht unbedingt, dass etwas falsch ist. Verschiedene Systeme wenden oft unterschiedliche Definitionen und Regeln an. Häufige Gründe sind:
...
- **Chart:** Zeigt die tägliche Performance. Jeder Punkt spiegelt die KPI or Leistungskennzahl or Leistungskennzahlen wider, die für diesen einzelnen Tag berechnet wurde.
- **Zusammenfassungskarte:** Zeigt die Gesamtzeitraum-Performance. Sie berechnet die KPI or Leistungskennzahl or Leistungskennzahlen über den gesamten ausgewählten Datumsbereich neu.
...
Wenn Ihr Ziel die Eindeutigkeit auf Fensterebene ist (eindeutige Personen über die gesamte Campaign oder das gesamte Quartal), ist das ein anderer Modellierungsansatz. Wenden Sie sich an Ihre:n KI or künstliche Intelligenz Success Manager:in:in für Hinweise zur Gestaltung.
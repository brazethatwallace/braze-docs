...
| **App-ID** | Der API-Schlüssel, der mit der App verknüpft ist, die Sie tracken möchten (zu finden unter **Settings** > **App Settings**). |
| **E-Mail-Anzeigename und -Adresse** | Die Absenderinformationen, die für Ihre Campaigns verwendet werden sollen (zu finden unter **Settings** > **Email Preferences**). |
...
Gehen Sie zu **Settings** > **API Keys** und erstellen Sie einen neuen Schlüssel mit den folgenden Berechtigungen:
...
![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_frequency_cap.png %})
...
![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_email_example_1.png %})
...
![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_braze_email_example_2.png %})
...
![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_push_example_1.png %})

![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_push_example_2.png %})

Das Ergebnis ist die folgende Nachricht:

![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_push_example_3.png %})
...
![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_sms_example_1.png %})

![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_sms_example_2.png %})

Das Ergebnis ist die folgende Nachricht:

![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_sms_example_3.png %})
...
![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_custom_example_2.png %})

Könnte verwendet werden, um eine E-Mail-Campaign zu optimieren, die so aussieht:

![Decisioning Pro Diagramm]({% image_buster /assets/img/decisioning_studio/decisioning_studio_custom_example_1.png %})

...
{% include copy_block.html content="Was bedeutet unsere x%-Stickiness, und welche 3 Möglichkeiten gibt es, sie mit Lifecycle-Messaging zu verbessern?" available="Home page" %}
...
{% include copy_block.html content="Wie können wir die Nutzung von Abfrage-Builder-Credits reduzieren, ohne die Berichtsabdeckung zu verlieren? Schlagen Sie 3 Taktiken vor." available="Query Builder" %}

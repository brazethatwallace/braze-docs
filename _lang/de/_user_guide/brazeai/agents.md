...
| [Canvas-Kontextvariablen]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/sources/context_variables/#how-context-variables-work) | Temporäre Datenstücke, die Sie innerhalb der Journey einer Nutzer:in durch einen bestimmten Canvas erstellen und verwenden können. |

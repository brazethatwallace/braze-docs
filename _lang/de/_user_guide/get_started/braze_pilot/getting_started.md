...
## 1. Schritt: Braze Pilot herunterladen {#step-1-download-braze-pilot}
...
## 2. Schritt: Allgemeine Geschäftsbedingungen akzeptieren {#step-2-accept-the-terms-and-conditions}
...
## 3. Schritt: Verbindung mit dem Braze SDK initialisieren {#step-3-initialize-the-connection-with-the-braze-sdk}
...
## 4. Schritt: Push-Berechtigungen erteilen {#step-4-allow-push-permissions}
...
## 5. Schritt: Braze-Messaging in Pilot erleben {#step-5-experience-braze-messaging-in-pilot}

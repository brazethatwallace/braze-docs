...
## 1. Schritt: Erstellen Sie Ihre Geschäftsobjekte in Braze
...
### Option 1: Verwenden Sie Kataloge für Konten und Opportunities
...
#### Übertragen Sie Ihre CRM-Felder
...
### Option 2: Verwenden Sie verbundene Quellen für Konten und Opportunities
...
### Schritt 2.2: Erstellen Sie eine Beziehung zwischen Nutzerprofilen und Ihren Geschäftsobjekten

{% tabs %}
{% tab Catalogs %}

#### Option 1: Bei Verwendung von Katalogen
...
2. Protokollieren Sie ein Event (z. B. `account_linked`), das die Konto-ID als Event-Eigenschaft enthält.
...
#### Option 2: Bei Verwendung verbundener Quellen

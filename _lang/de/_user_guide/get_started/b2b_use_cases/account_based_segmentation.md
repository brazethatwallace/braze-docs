...
## Kontobasierte B2B-Segmentierung einrichten

### Option 1: Wenn Sie Kataloge für Ihre Geschäftsobjekte verwenden

#### Grundlegende SQL-Template-Segmentierung
...
##### Leitlinien für Variablen bei B2B-Anwendungsfällen

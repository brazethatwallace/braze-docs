...
### 1. Schritt: Ein Canvas erstellen
...
### 2. Schritt: Entry-Kriterien festlegen
...
- Wählen Sie **Nutzer:innen erlauben, dieses Canvas erneut aufzurufen**.
- Wählen Sie **Festgelegtes Fenster**.
- Setzen Sie die Wiederzulassung auf „0" **Sekunden**.

![Abschnitt „Entry Controls" mit Auswahlmöglichkeiten für „Nutzer:innen erlauben, dieses Canvas erneut aufzurufen" in einem „Festgelegten Fenster" von 0 Sekunden.]({% image_buster /assets/img/b2b/entry_controls_simple.png %}){: style="max-width:80%;"}
...
Wählen Sie unter **Abo-Einstellungen** für **An diese Nutzer:innen senden:** die Option **alle Nutzer:innen, einschließlich abgemeldeter Nutzer:innen**. 
...
### 4. Schritt: Canvas erstellen

#### Schritt 4a: Einen Aktions-Pfad hinzufügen

Wählen Sie unter Ihrer Variante das Plus-Symbol und dann **Aktionspfade**.
...
#### Schritt 4c: Jede Gruppe mit den relevanten Events konfigurieren
...
Fügen Sie im Schritt **Zielgruppen** einen Filter ein, der Nutzer:innen ausschließt, deren Lead-Status bereits auf MQL oder darüber hinaus steht, z. B. „`lead_status` `is none of` `MQL`".

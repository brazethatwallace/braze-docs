...
# Produktportal ![Ressourcen-Menü im Braze-Dashboard]({% image_buster /assets/img/portal.png %}){: style="float:right;max-width:33%;margin-left:15px;margin-top:15px;"} {#product-portal-resources-menu-in-the-braze-dashboard-image_buster-assetsimgportalpng-stylefloatrightmax-width33margin-left15pxmargin-top15px}
...
| --- | --- |
| Kürzlich veröffentlicht | Neue Features, die wir quartalsweise veröffentlicht haben |
...
Braze erstellt die Produkt-Roadmap auf Basis vieler verschiedener Informationsquellen. Wir nutzen Daten unserer Kund:innen, des Marktes, der technologischen Landschaft, in der wir agieren, unserer Produktvision und Innovationsstrategie und mehr. Kund:innen-Input und -Feedback sind eine wichtige Komponente, aber nur eine von vielen.

Prioritäten und Zeitpläne können sich (und werden sich) basierend auf den neuesten verfügbaren Informationen ändern. Vor diesem Hintergrund empfehlen wir, Produkt-Feedback zeitnah einzureichen, damit das Produktteam über die Stimmung der Kund:innen und des Marktes informiert ist.

- **Das Einreichen von Produkt-Feedback garantiert**, dass unser Produktteam das Feedback prüft und berücksichtigt.
- **Das Einreichen von Produkt-Feedback garantiert nicht**, dass wir Maßnahmen ergreifen. Braze kann und möchte nicht auf jedes Produkt-Feedback reagieren.

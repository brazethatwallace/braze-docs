...
Für die Integration mit unserer API können Sie nach Bezeichnern suchen, die mit Segments, Campaigns, Content Cards und mehr verknüpft sind und auf die Sie über die externe Braze API zugreifen möchten. Alle Nachrichten sollten die [UTF-8](https://en.wikipedia.org/wiki/UTF-8)-Kodierung verwenden. Nachdem Sie einen Bezeichner ausgewählt haben, wird er unterhalb des Dropdown-Menüs angezeigt.

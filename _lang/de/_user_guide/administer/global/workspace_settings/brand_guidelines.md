...
### Schritt 3: Sprache definieren, die vermieden werden soll (optional)
...
### Schritt 4: Ihre Richtlinien testen
...
### Schritt 5: Ihre Richtlinien speichern
...
## Verwalten von Markenrichtlinien
...
## Verwenden von Markenrichtlinien

Öffnen Sie beim Verfassen einer Nachricht den [KI-Texterstellungsassistenten]({{site.baseurl}}/user_guide/brazeai/generative_ai/copywriting/) und wählen Sie Ihre Markenrichtlinie im Dropdown-Menü **Markenrichtlinien anwenden** aus. Wenn Sie eine bestimmte Markenrichtlinie als Standard festlegen, wird sie automatisch im Dropdown-Menü ausgewählt, aber Sie können eine andere Richtlinie wählen.

...
> Auf der Seite **Exportprotokoll** können Sie den Status von Exportaufträgen einsehen und laufende Exporte direkt von der Braze-Plattform aus abbrechen. <br><br> Derzeit unterstützt das Exportprotokoll nur Segmentexporte. Informationen über das Segmentierungs-Export-Tool finden Sie unter [Exportieren von Segmentdaten nach CSV]({{site.baseurl}}/user_guide/data/distribution/export_braze_data/segment_data_to_csv/).
...
## Stornieren eines ausstehenden Exports

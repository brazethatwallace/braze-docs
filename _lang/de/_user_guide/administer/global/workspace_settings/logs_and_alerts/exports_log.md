...
| API-Segment-Export | `POST /users/export/segment` | [POST: Nutzerprofil nach Segment exportieren]({{site.baseurl}}/api/endpoints/export/user_data/post_users_segment) |

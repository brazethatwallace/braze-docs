...
> Auf der Seite **Exportprotokoll** können Sie den Status von Exportaufträgen einsehen und laufende Exporte direkt von der Braze-Plattform aus abbrechen. <br><br> Derzeit unterstützt das Exportprotokoll nur Segmentexporte. Informationen über das Segmentexport-Tool finden Sie unter [Exportieren von Segmentdaten nach CSV]({{site.baseurl}}/user_guide/data/distribution/export_braze_data/segment_data_to_csv/).
...
## Stornieren eines ausstehenden Exports {#cancelling-a-pending-export}
...
## Freigabe eines bestimmten Exportprotokolls {#sharing-a-specific-export-log}

Geben Sie ein Exportprotokoll frei, indem Sie die **Export-ID** und dann **Protokoll teilen** auswählen.

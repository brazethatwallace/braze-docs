...
page_order: 3
description: "Dieser Referenzartikel beschreibt, wie Sie verschiedene Zeitzonen für Ihre Braze-Workspaces konfigurieren können, um Teams, die an verschiedenen geografischen Standorten tätig sind, mehr Kontrolle über den Zeitplan für Campaigns und Canvases zu ermöglichen."
toc_headers: h2
---

# Workspace-Zeitzonen {#workspace-time-zones}

> Mit Workspace-Zeitzonen können Administratoren spezifische Zeitzonen für einzelne Workspaces festlegen. Dadurch werden geplante Campaigns und Canvases (die weder die Ortszeit noch intelligentes Timing verwenden) entsprechend der für den Workspace festgelegten Zeitzone versendet und nicht entsprechend der übergeordneten Zeitzone des Unternehmens.
...
## Auswirkungen auf Campaigns und Canvases {#impact-on-campaigns-and-canvases}
...
- **Campaigns und Canvases mit Ortszeit und intelligentem Timing:** Campaigns und Canvases, die die Ortszeit der Nutzer:innen oder [intelligentes Timing]({{site.baseurl}}/user_guide/messaging/campaigns/schedule_your_campaign/scheduled_delivery#option-3-intelligent-timing) für die Zustellung verwenden, funktionieren weiterhin wie bisher und sind von Workspace-Zeitzonen nicht betroffen.
- **Geplante Campaigns und Canvases:** Alle geplanten Campaigns oder Canvases, die nicht die Ortszeit der Nutzer:innen oder intelligentes Timing für die Zustellung verwenden, werden basierend auf der ausgewählten Zeitzone des Workspace versendet.

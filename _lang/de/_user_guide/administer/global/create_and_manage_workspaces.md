...
### 1. Schritt: Einen Plan erstellen
...
### 2. Schritt: Ihren Workspace hinzufügen
...
{:start="3"}
3. Wählen Sie **Erstellen**. Es kann einige Sekunden dauern, bis Braze Ihren Workspace erstellt hat.
...
Sie werden zur Seite **App-Einstellungen** weitergeleitet, um Ihre App-Instanzen hinzuzufügen. Sie können diese Seite jederzeit über **Einstellungen** > **App-Einstellungen** aufrufen.

![Die Seite „App-Einstellungen“ für den Workspace „Upon Voyage US - Staging“ mit einem Button zum Hinzufügen einer App.]({% image_buster /assets/img/workspaces/workspace_empty_state.png %})

### 3. Schritt: Ihre App-Instanzen hinzufügen

Die verschiedenen Websites und Apps, die in einem Workspace zusammengefasst werden, bezeichnen wir als „App-Instanzen“.

1. Wählen Sie auf der Seite **App-Einstellungen** die Option **+ App hinzufügen**.
...
![Das Modal „Neue App zu Upon Voyage US - Staging hinzufügen“ mit Optionen zur Auswahl von App-Details.]({% image_buster /assets/img/workspaces/workspace_add_app.png %}){: style="max-width:60%" }

{:start="3"}
3. Wählen Sie **App hinzufügen**, um zu bestätigen.
...
Die auf der Seite „App-Einstellungen“ für eine bestimmte App angezeigte Live-SDK-Version ist die höchste App-Version mit mindestens 5 % Ihrer gesamten täglichen Sitzungen und mindestens 500 Sitzungen am Vortag.
...
### 4. Schritt: Bei Bedarf wiederholen
...
2. Fahren Sie mit der Maus über den Namen Ihres Workspace und wählen Sie <i class="image: /assets/img/braze_icons/pencil-01.svg" style="color: #0b8294;"></i>.
3. Geben Sie Ihrem Workspace einen neuen Namen und wählen Sie dann <i class="fa-solid fa-square-check" style="color: #0b8294;"></i> **Speichern**.
...
### Workspaces und App-Instanzen löschen

So löschen Sie Ihren Workspace oder Ihre App-Instanz:

1. Gehen Sie zu **Einstellungen** > **App-Einstellungen**.
2. Wählen Sie **Workspace löschen**, um den jeweiligen Workspace zu löschen, oder wählen Sie das Papierkorbsymbol neben der jeweiligen App-Instanz.
...
![Die Seite „App-Einstellungen“ mit einem Button zum Löschen eines Workspace und einem Papierkorbsymbol zum Löschen einer App.]({% image_buster /assets/img/workspaces/workspace_delete.png %})
...
2. Wählen Sie unter **Angesprochene Apps und Websites** die Option **Nutzer:innen aus bestimmten Apps**.
3. Wählen Sie im Dropdown **Bestimmte Apps** Ihre App oder Website aus.
...
Sie können dieses Segment dann zu Ihrer Nachricht hinzufügen und Ihre Zielgruppe bei Bedarf mit zusätzlichen Segments und Filtern weiter verfeinern.

#### Campaigns

Fügen Sie bei Campaigns Ihr Segment im Schritt **Zielgruppe** des Composers hinzu.

#### Canvas

Fügen Sie in Canvas Ihr Segment zu Ihren Nachrichtenschritten im Abschnitt **Zustellungsvalidierungen** hinzu. Zustellungsvalidierungen überprüfen doppelt, ob Ihre Zielgruppe Ihre Zustellungskriterien zum Zeitpunkt des Nachrichtenversands erfüllt. Denken Sie daran, Zustellungsvalidierungen für jeden Nachrichtenschritt festzulegen, um sicherzustellen, dass die Nachricht an die richtige App zugestellt wird. Eine Segmentierung auf Eingangsebene ist nicht erforderlich.

{% details Erweitern für Schritte im ursprünglichen Canvas-Workflow %}

Im ursprünglichen Canvas-Workflow fügen Sie Ihr Segment auf der Canvas-Komponentenebene im Abschnitt **Zielgruppe** hinzu. Eine Segmentierung auf Eingangsebene ist nicht erforderlich.

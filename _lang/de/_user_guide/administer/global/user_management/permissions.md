...
Um Admin-Berechtigungen zu gewähren oder zu entziehen, wählen Sie **This user is an admin** und dann **Update user**.
...
| Segments | Segments bearbeiten | Segments erstellen und aktualisieren. Nutzer:innen mit der Berechtigung „Segments bearbeiten“ müssen zusätzlich die Berechtigung „Segments anzeigen“ besitzen. |
...
| API-Nutzungsbenachrichtigungen | API-Nutzungsbenachrichtigungen bearbeiten | API-Nutzungsbenachrichtigungen erstellen und aktualisieren |

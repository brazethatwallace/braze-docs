...
4. Wählen Sie einen oder mehrere Gruppentypen, wie in der folgenden Tabelle aufgeführt.
...
1. Wählen Sie auf der Verwaltungsseite Ihrer internen Gruppe **Testnutzer:innen hinzufügen**.
...
Wenn Sie die Nachricht als zufällige:r Nutzer:in, angepasste:r Nutzer:in oder bestehende:r Nutzer:in in der Vorschau anzeigen, können Sie stattdessen diese Vorschauversion senden. Durch Deaktivieren des Kontrollkästchens wird die Nachricht basierend auf den Attributen jeder/jedes Nutzer:in gesendet, anstatt die Vorschauversion zu verwenden.

Wenn Sie einen IP-Pool zum Versenden einer E-Mail verwenden, wählen Sie über das verfügbare Dropdown-Menü aus, von welchem IP-Pool die E-Mail gesendet werden soll.

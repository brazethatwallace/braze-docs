...
2. Füllen Sie die folgenden Details aus (die sich im [Schritt **IdP-Konfiguration**](#accessing-scim-provisioning-settings) von Braze befinden), um eine angepasste App zu erstellen:
- App-Logo
- Single Sign-on URL

...
### 1. Schritt: Konfigurieren Sie die Braze-App {#step-1-configure-the-braze-app}
...
### 2. Schritt: OneLogin in Braze konfigurieren {#step-2-configure-onelogin-within-braze}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="2. Schritt: OneLogin in Braze konfigurieren" }

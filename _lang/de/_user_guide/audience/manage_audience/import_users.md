...
Die geschätzte Ausführungszeit für eine Datei mit 1.000.000 Zeilen beträgt etwa fünf Minuten. Weitere Informationen finden Sie unter [Nutzerattribut-CSV-zu-Braze-Import](https://www.braze.com/docs/user_guide/data/unification/cloud_ingestion).

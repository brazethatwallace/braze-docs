...
glossaries:
  ...
  - name: Braze Segment Extensions
    display_name: "Braze-Segmenterweiterungen"
  ...
  - name: Nested Custom Attributes
    display_name: "Verschachtelte angepasste Attribute"
  ...
  - name: Day of Recurring Event
    display_name: "Tag eines wiederkehrenden Events"
    ...
    tags:
      - Custom attribute
  - name: Custom Event
    display_name: "Angepasstes Event"
  ...
  - name: First Did Custom Event
    display_name: "Erstes angepasstes Event ausgeführt"
  ...
  - name: Last Did Custom Event
    display_name: "Letztes angepasstes Event ausgeführt"
  ...
  - name: Session Count For App
    display_name: "Sitzungsanzahl für App"
  ...
  - name: X Sessions In Last Y Days
    ...
    tags:
      - Sessions
  - name: First Used App
    display_name: "App erstmals verwendet"
  ...
  - name: First Used Specific App
    display_name: "Bestimmte App erstmals verwendet"
    ...
    tags:
      - Sessions
  - name: Last Used App
    display_name: "App zuletzt verwendet"
  ...
  - name: Last Used Specific App
    display_name: "Bestimmte App zuletzt verwendet"
  ...
  - name: Median Session Duration
    display_name: "Mediane Sitzungsdauer"
  ...
  - name: Last Received Message from Specific Campaign
    display_name: "Letzte Nachricht von bestimmter Campaign erhalten"
  ...
  - name: Last Received Message from Campaign or Canvas With Tag
    display_name: "Letzte Nachricht von Campaign oder Canvas mit Tag erhalten"
  ...
  - name: Has Never Received a Message from Campaign or Canvas Step
    display_name: "Hat nie eine Nachricht von Campaign oder Canvas-Schritt erhalten"
  ...
  - name: Last Received Email
    display_name: "Letzte E-Mail erhalten"
  ...
  - name: Last Received Push
    display_name: "Letzten Push erhalten"
  ...
  - name: Last In App Message Impression
    display_name: "Letzte In-App-Nachrichten-Impression"
  ...
  - name: Last Received SMS
    display_name: "Letzte SMS erhalten"
  ...
  - name: Last Received Webhook
    display_name: "Letzten Webhook erhalten"
  ...
  - name: Last Received WhatsApp
    display_name: "Letzte WhatsApp-Nachricht erhalten"
  ...
  - name: Live Activities Push to Start Registered for App
    display_name: "Live Activities Push-to-Start für App registriert"
  ...
  - name: Clicked Alias in Campaign
    display_name: "Alias in Campaign angeklickt"
  ...
  - name: Clicked Alias in Canvas Step
    display_name: "Alias in Canvas-Schritt angeklickt"
  ...
  - name: Clicked Alias in Any Campaign or Canvas Step
    display_name: "Alias in beliebiger Campaign oder Canvas-Schritt angeklickt"
  ...
  - name: Last Sent Specific SMS Inbound Keyword Category
    display_name: "Zuletzt bestimmte eingehende SMS-Keyword-Kategorie gesendet"
  ...
  - name: In Campaign Control Group
    display_name: "In Campaign-Kontrollgruppe"
  ...
  - name: In Canvas Control Group
    display_name: "In Canvas-Kontrollgruppe"
  ...
  - name: Last Enrolled in Any Control Group
    display_name: "Zuletzt in eine Kontrollgruppe aufgenommen"
  ...
  - name: Entered Canvas Variation
    display_name: "Canvas-Variante betreten"
  ...
  - name: Email Opt In Date
    display_name: "E-Mail-Opt-in-Datum"
  ...
  - name: Foreground Push Enabled
    display_name: "Vordergrund-Push aktiviert"
  ...
  - name: Foreground Push Enabled for App
    display_name: "Vordergrund-Push für App aktiviert"
  ...
  - name: Background or Foreground Push Enabled
    display_name: "Hintergrund- oder Vordergrund-Push aktiviert"
  ...
  - name: Push Opt In Date
    display_name: "Push-Opt-in-Datum"
  ...
  - name: Push Subscription Status
    display_name: "Push-Abo-Status"
    description: "Segmentiert Ihre Nutzer:innen nach ihrem <a href=\"/docs/user_guide/channels/push/push_setup/push_subscription_states#push-subscription-state\">Abo-Status</a> für Push."
    tags:
      - Channel subscription behavior
  - name: Push Unsubscribed Date
    display_name: "Push-Abmeldedatum"
  ...
  - name: X Product Purchased In Y Days
    display_name: "X Produkt in Y Tagen gekauft"
  ...
  - name: First Made Purchase
    display_name: "Erster Kauf getätigt"
  ...
  - name: First Purchase For App
    display_name: "Erster Kauf für App"
  ...
  - name: Last Made Purchase
    display_name: "Letzter Kauf getätigt"
  ...
  - name: Customer lifetime value (last 730 days)
    display_name: "Customer-Lifetime-Value (letzte 730 Tage)"
  ...
  - name: Total refund value (last 730 days)
    display_name: "Gesamter Erstattungswert (letzte 730 Tage)"
  ...
  - name: Total refund value
    display_name: "Gesamter Erstattungswert"
    description: "Segmentiert Ihre Nutzer:innen nach dem Gesamtwert der Erstattungen, die einem/einer Nutzer:in über die gesamte Lifetime gewährt wurden, basierend auf dem <a href=\"/docs/user_guide/data/activation/events/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Event</a> für erstattete Bestellungen (Workspaces, die keine E-Commerce-Events tracken, haben keine Daten für diesen Filter). Nutzer:innen werden für diesen Filter in Echtzeit ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze Account Manager, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Total revenue (last 730 days)
    display_name: "Gesamtumsatz (letzte 730 Tage)"
    ...
    tags:
      - eCommerce
  - name: Total revenue
    display_name: "Gesamtumsatz"
    description: "Segmentiert Ihre Nutzer:innen nach dem Gesamtumsatz aus den Bestellungen eines/einer Nutzer:in über die gesamte Lifetime, berechnet durch Subtraktion des Umsatzes des <a href=\"/docs/user_guide/data/activation/events/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Events</a> für erstattete Bestellungen vom Umsatz des E-Commerce-Events für aufgegebene Bestellungen (Workspaces, die keine E-Commerce-Events tracken, haben keine Daten für diesen Filter). Nutzer:innen werden für diesen Filter in Echtzeit ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze Account Manager, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Average order value (last 730 days)
    display_name: "Durchschnittlicher Bestellwert (letzte 730 Tage)"
  ...
  - name: Unformatted Phone Number
    display_name: "Unformatierte Telefonnummer"
  ...
  - name: Device OS Version Number
    display_name: "Geräte-Betriebssystem-Versionsnummer"
  ...
  - name: Provisionally Authorized on iOS
    display_name: "Vorläufig autorisiert auf iOS"
  ...
  - name: Amplitude Cohorts
    display_name: "Amplitude-Kohorten"
  ...
  - name: Hightouch Cohorts
    display_name: "Hightouch-Kohorten"
  ...
  - name: Mixpanel Cohorts
    display_name: "Mixpanel-Kohorten"
  ...
  - name: Tinyclues Cohorts
    display_name: "Tinyclues-Kohorten"
  ...
  - name: Install Attribution Ad
    display_name: "Install-Attribution – Anzeige"
  ...
  - name: Install Attribution Adgroup
    display_name: "Install-Attribution – Anzeigengruppe"
  ...
  - name: Install Attribution Source
    display_name: "Install-Attribution – Quelle"
    description: "Segmentiert Ihre Nutzer:innen nach der Quelle, der ihre Installation zugeordnet wurde."
    tags:
      - Install attribution
  - name: Churn Risk Category
    display_name: "Churn-Risiko-Kategorie"
    description: "Segmentiert Ihre Nutzer:innen nach der Churn-Risiko-Kategorie gemäß einer bestimmten Prognose."
    tags:
      - Intelligence and predictive
  - name: Churn Risk Score
    display_name: "Churn-Risiko-Score"
    description: "Segmentiert Ihre Nutzer:innen nach dem Churn-Risiko-Score gemäß einer bestimmten Prognose."
    tags:
      - Intelligence and predictive
  - name: Event Likelihood Category
    display_name: "Event-Wahrscheinlichkeitskategorie"
  ...
  - name: Intelligent Channel
    display_name: "Intelligenter Kanal"
  ...
  - name: Number of Facebook Friends Using App
    display_name: "Anzahl der Facebook-Freunde, die die App nutzen"
  ...
  - name: Number of Twitter Followers
    display_name: "Anzahl der Twitter-Follower"

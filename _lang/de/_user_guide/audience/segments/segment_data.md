...
Um einen Bericht aus einer Vorlage des [Abfrage-Builders]({{site.baseurl}}/user_guide/analytics/reports/query_builder) zu erstellen, navigieren Sie zum **Abfrage-Builder** und gehen Sie wie folgt vor:

...
![Beispiel für die Platzierung eines Content-Card-Modals.]({% image_buster /assets/img/segment/segment_extension_modal.png %}){: style="max-width:60%;"}

Wählen Sie als Datenquelle **CDI Data Tables** aus.

![Screenshot zu Schritt 2: Segment erstellen.]({% image_buster /assets/img/segment/cdi_data_tables.png %}){: style="max-width:60%;"}

...
Nutzen Sie Berichte im Dashboard, geplante Exporte oder [Currents]({{site.baseurl}}/user_guide/data/distribution/braze_currents), um Ereignisdaten an Ihr Data Warehouse oder Ihre BI-Tools zu streamen.

### Wo finde ich Definitionen für Braze-Metriken? {#where-can-i-find-definitions-for-braze-metrics}

Im [Glossar der Berichtsmetriken]({{site.baseurl}}/user_guide/analytics/metrics_glossary) finden Sie Definitionen gängiger Campaign- und Engagement-Metriken.
...
Katalogauswahlen können Katalogspalten anhand statischer oder Liquid-Werte filtern, einschließlich Array-Feldern in Katalogzeilen. Sie filtern jedoch keine Katalogzeile anhand von Werten, die in einem Kundenprofil-Array gespeichert sind. Um Inhalte anhand der Liste der Nutzer:innen zu personalisieren, geben Sie mit einer Auswahl eine breite Menge von Katalogartikeln zurück und verwenden dann Liquid, um nur die Zeilen beizubehalten, die mit dem Profil-Array übereinstimmen.
...
- Dieses Beispiel verwendet ein String-Array im Kundenprofil.

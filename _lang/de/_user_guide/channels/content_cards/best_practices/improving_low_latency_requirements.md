...
## Sendelogik „At First Impression“ verwenden {#use-at-first-impression-send-logic}
...
## Beachten Sie, dass der Canvas-Eingang Voraussetzung für den Empfang von Cards ist {#remember-that-canvas-entry-is-a-prerequisite-for-receiving-cards}

...
4. Wählen Sie, wann Braze die Zielgruppenberechtigung und Personalisierung für die Content-Card berechnet. Dies kann beim Eintritt in den Schritt oder bei der ersten Impression (empfohlen) erfolgen. Schritte mit Content-Cards können geplant oder aktionsbasiert sein.
...
## Schritt 2: Geben Sie Ihre Nachrichtentypen an
...
## Schritt 3: Content-Card verfassen
...
#### Wählen Sie einen Zustellungszeitplan oder Trigger
...
Für Content-Card-Kampagnen mit geplanter Zustellung können Sie festlegen, wann Braze die Zielgruppenberechtigung und Personalisierung für neue Content-Card-Kampagnen auswertet, indem Sie angeben, wann die Karte erstellt wird. Weitere Informationen finden Sie unter [Kartenerstellung]({{site.baseurl}}/card_creation).
...
### Payload- und Feed-Beschränkungen
...
### Re-Eligibility für Content-Cards verstehen
...
#### Wie Re-Eligibility berechnet wird
...
#### Die 30-Tage-Ablaufzeit und Re-Eligibility
...
#### Gestartete Karten aktualisieren
...
##### Option 2: Kampagne stoppen und neu starten
...
#### Karten länger als 30 Tage bestehen lassen

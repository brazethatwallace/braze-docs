...
3. Wählen Sie im Dropdown **Business portfolio** Ihr Unternehmensportfolio aus und klicken Sie dann auf **Next**. Dies stellt die Verbindung zu Ihrem WhatsApp Business-Konto her. Wenn Ihr erwartetes Unternehmensportfolio nicht angezeigt wird, überprüfen Sie Ihre Berechtigungen.<br><br>![Ein Fenster mit Feldern zur Eingabe Ihrer Unternehmensinformationen, einschließlich des Namens Ihres Unternehmensportfolios.]({% image_buster /assets/img/whatsapp/business_info.png %}){: style="max-width:50%;"}<br><br>

...
- **Zugang zum Meta Business Manager:** Die meisten Unternehmen verwenden den Meta Business Manager, um Facebook-Seiten, Anzeigen und zugehörige Geschäftsressourcen zu verwalten. Wenn Sie keinen Zugang haben, bitten Sie eine:n Administrator:in, Berechtigungen zu erteilen, oder erstellen Sie während der Anmeldung ein Business-Manager-Konto.
...
Nachdem Braze die eingebettete Meta-Anmeldung gestartet hat, melden Sie sich mit einem Meta-Konto an, das Zugriff auf den Business Manager Ihres Unternehmens hat. Meta hostet die Anmeldebildschirme; Braze hat keinen Einfluss auf deren Layout oder Beschriftungen.
...
2. **Ihr Unternehmensportfolio auswählen.** Verbinden Sie das Business-Manager-Portfolio, das Eigentümer des WhatsApp Business-Kontos sein soll. Wenn Sie das erwartete Portfolio nicht sehen, überprüfen Sie Ihre Meta-Berechtigungen.
...
Nach der eingebetteten Registrierung führt Braze die Einrichtungsschritte automatisch durch. Auf der Seite **WhatsApp Messaging Integration** werden möglicherweise Fortschrittsmeldungen wie **Sign-up flow completed, integration with WhatsApp in progress** angezeigt, während Braze Folgendes ausführt:

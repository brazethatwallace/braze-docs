...
- Sprachanrufe oder Kurzmitteilungsdienst or SMS empfangen können
...
{% alert warning %}
Verknüpfen Sie Ihre Telefonnummer nicht mit WhatsApp in der Twilio-Konsole. Wenn Sie dies tun, wird die Nummer beim WhatsApp Business Account von Twilio registriert, was Sie daran hindert, sie über den Embedded-Registrierung or registrieren-Workflow mit Braze zu verbinden.
{% endalert %}
...
### Schritt 3: Den Embedded-Registrierung or registrieren-Workflow abschließen {#step-3-complete-the-embedded-sign-up-workflow}

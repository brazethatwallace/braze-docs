...
- Ihr Meta Business Account ist verifiziert.
- Ihr bestehendes WhatsApp Business Account ist genehmigt.
- Ihr bestehendes WhatsApp Business Account verfügt über eine gültige Zahlungsmethode in den **Zahlungseinstellungen**.
- Für Ihre geschäftliche Telefonnummer ist die Zwei-Faktor-Verifizierung deaktiviert. Wenn Sie Eigentümer:in Ihres WhatsApp Business Accounts sind, können Sie die Zwei-Faktor-Verifizierung für die Nummer im WhatsApp Manager deaktivieren. Andernfalls müssen Sie Ihren Lösungsanbieter bitten, sie für Sie zu deaktivieren.

Informationen zur Migration Ihrer WhatsApp-Telefonnummer finden Sie in der Meta-Dokumentation unter [Telefonnummern zwischen WhatsApp Business Accounts über Embedded Signup migrieren](https://developers.facebook.com/docs/whatsapp/business-management-api/guides/migrate-phone-to-different-waba/).
...
2. Wählen Sie **Turn off two-step verification** aus und führen Sie die folgenden Schritte durch.<br><br>![WhatsApp Business Manager, geöffnet auf der Seite „Phone numbers“.]({% image_buster /assets/img/whatsapp/waba_manager.png %}){: style="max-width:80%;"} <br><br> Wenn Sie eine Telefonnummer in eine andere WhatsApp Business-Gruppe migrieren und Metas Embedded Signup erfordert, dass der Anzeigename übereinstimmt, notieren Sie sich den bestehenden Anzeigenamen auf der Seite **Phone Numbers**. Sie geben diesen Namen im nächsten Schritt ein.<br><br>![Die Seite „Phone Numbers“ im WhatsApp Business Manager mit dem Anzeigenamen „Braze“ neben einer Telefonnummer.]({% image_buster /assets/img/whatsapp/phone_numbers.png %}){: style="max-width:80%;"}<br><br>
3. Führen Sie den Embedded-Signup-Workflow von Meta bis zum Abschluss durch.

## Migration von einem anderen Business Solution Provider (BSP) {#migrate-from-another-business-solution-provider}

Wenn Ihre WhatsApp-Telefonnummer bei einem anderen BSP registriert ist, müssen Sie die Nummer zu einem mit Braze verbundenen WhatsApp Business Account migrieren, bevor Braze über diese Nummer senden kann.
...
- Überprüfen Sie Verträge und Abrechnungen mit Ihrem aktuellen Anbieter. Nachrichtenverläufe und Templates werden möglicherweise nicht automatisch übertragen.
- Deaktivieren Sie die Zwei-Faktor-Verifizierung für die Nummer gemäß den Anforderungen von Meta.
- Wenn Sie separate Nummern für Support und Marketing benötigen, lesen Sie [Integrationen, Daten und Reporting]({{site.baseurl}}/user_guide/channels/whatsapp/faq#integrations-data-and-reporting) in den WhatsApp-FAQ.
...
Braze empfiehlt nach Möglichkeit separate WhatsApp Business Accounts für Entwicklung und Produktion:

- Binden Sie Ihre Produktionstelefonnummer nicht an einen Sandbox- oder Entwicklungs-Workspace.
- Verwenden Sie ein dediziertes Test-WABA und eine Testtelefonnummer für Integrationstests.

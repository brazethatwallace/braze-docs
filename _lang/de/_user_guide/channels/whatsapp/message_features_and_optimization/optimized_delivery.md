...
2. Wählen Sie im Abschnitt **Optimize your sending with optimized delivery** die Option **Upgrade setting** aus, um den [Embedded-Registrierung-Workflow]({{site.baseurl}}/user_guide/channels/whatsapp/whatsapp_setup/embedded_signup) zu starten.
...
- **Braze-Currents:** Exportieren Sie Nachrichtenfehler-Ereignisse mithilfe von Braze-Currents. Sie können diese Daten dann verwenden, um ein angepasstes Attribut im Kundenprofil zu aktualisieren (z. B. `whatsapp_failed_last_msg: true`), das Sie als Filter für Ihre Retargeting-Campaign nutzen können.

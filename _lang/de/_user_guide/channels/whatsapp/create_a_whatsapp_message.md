...
1. Gehen Sie zur Seite **Campaigns** und klicken Sie auf <i class="fas fa-plus"></i> **Create Campaign**.
...
{% alert tip %}
Wenn alle Nachrichten in Ihrer Campaign ähnlich sind oder denselben Inhalt haben, verfassen Sie Ihre Nachricht, bevor Sie zusätzliche Varianten hinzufügen. Anschließend können Sie im Dropdown **Variante hinzufügen** die Option **Copy from Variant** wählen.
{% endalert %}
...
![Ein Hinweis mit dem Text: „Um zu testen, öffnen Sie zunächst ein Konversationsfenster, indem Sie eine WhatsApp-Nachricht an +1 217-582-9414 senden. Senden Sie dann Ihre Antwortnachricht an die:den Testnutzer:in.“]({% image_buster /assets/img/whatsapp/whatsapp_test_phone_number.png %}){: style="max-width:70%;"}
...
Erstellen Sie als Nächstes den Rest Ihrer Campaign. In den folgenden Abschnitten finden Sie weitere Details zur optimalen Nutzung unserer Tools zum Erstellen von WhatsApp-Nachrichten.

...
## Ads That Click to WhatsApp einrichten {#setting-up-ads-that-click-to-whatsapp}
...
{: start="2"}
2. Richten Sie in Braze ein aktionsbasiertes Canvas ein, bei dem die aktionsbasierte Option **Eingehende WhatsApp-Nachricht senden** lautet und der Nachrichtentext „IHR_TRIGGER_WORT“ ist. In diesem Beispiel verwendet eine Essenslieferungs-App „free delivery“.
...
Vergessen Sie nicht, auch jeden Rabattcode, jedes Angebot oder andere in der Anzeige versprochene Informationen bereitzustellen!

![WhatsApp-Nachrichten-Editor mit Button-Antworten „Ja“ und „Nein danke“.]({% image_buster /assets/img/whatsapp/quick_replies.png %})

![Canvas-Schritt mit einer „Opt-in“-Gruppe mit einem Trigger-Ereignis „Eingehende WhatsApp an Abo-Gruppe gesendet“ und einem Trigger-Wort „YES“.]({% image_buster /assets/img/whatsapp/opting_in_step.png %})
...
![Canvas, das den Workflow für das Senden von Ads That Click to WhatsApp zeigt, einschließlich drei Aktionspfaden: Opt-in, Opt-out und Alle anderen.]({% image_buster /assets/img/whatsapp/ads_that_click_canvas.png %})

## Hinweise {#considerations}

Konversationen, die über eine Ad That Clicks to WhatsApp gestartet werden, sind kostenlos, wenn die folgenden Bedingungen erfüllt sind:

- Wenn ein:e Nutzer:in Ihnen über einen [Free Entry Point](https://developers.facebook.com/docs/whatsapp/pricing#free-entry-point-conversations) eine Nachricht sendet, z. B. über eine Ad That Clicks to WhatsApp, öffnet sich ein 24-Stunden-[Kundenservice-Fenster](https://developers.facebook.com/docs/whatsapp/cloud-api/guides/send-messages#customer-service-windows), in dem Sie diesem/dieser Nutzer:in jede Art von Nachricht senden können.
...
- Antwortnachrichten sind kostenlos.
...
## Ihre Push-Nachricht verfassen {#compose-your-push-message}
...
## Payload-Größe von Push-Benachrichtigungen reduzieren {#reduce-push-notification-payload-size}
...
### Tipps zur Reduzierung der Payload-Größe {#tips-to-reduce-payload-size}
...
### Nutzererlaubnis einholen {#obtain-user-permission}
...
## Eine Sunset-Richtlinie für nicht reagierende Nutzer:innen implementieren {#implement-a-sunset-policy-for-unresponsive-users}
...
### Vorschriften für mobile Push-Benachrichtigungen in Apps {#mobile-push-regulations-for-apps}

...
Sobald diese Kanäle erstellt sind, müssen Ihre Entwickler:innen die zugehörigen Kanal-IDs an Ihr Marketing-Team weitergeben. Ihr Team sollte Ihre Kanalnamen und Kanal-IDs im Braze-Dashboard eingeben, um sie in Ihren Campaigns und Canvase zu verwenden.
...
## SDK or Software-Development-Kit-Standardkanal {#sdk-default-channel}

Android erfordert einen gültigen Kanal, um Push-Benachrichtigungen ab API-Level 26 (Android O) oder höher anzuzeigen. Das Braze Android SDK or Software-Development-Kit 2.1.0 enthält einen Standardkanal namens „General“, der erstellt und verwendet wird, wenn Sie keine zusätzlichen Kanäle im Dashboard angeben oder versuchen, an einen ungültigen Kanal zu senden. Sie können diese Bezeichnung im SDK or Software-Development-Kit umbenennen und eine Beschreibung des Kanals angeben. Wir empfehlen, dies in Betracht zu ziehen, um eine bessere Nutzererfahrung zu bieten.
...
Falls Braze eine ungültige Kanal-ID übermittelt wird (z. B. wenn Sie eine Kanal-ID angeben, die Ihre Entwickler:innen nicht im SDK or Software-Development-Kit erstellt haben), wird die Benachrichtigung über Ihren SDK or Software-Development-Kit-Standardkanal zugestellt. Daher empfehlen wir Ihnen dringend, Ihre Benachrichtigungskanäle während der Entwicklung im Braze-Dashboard zu testen.

Um das erwartete Verhalten für Kanäle besser zu verstehen, lesen Sie die folgende Tabelle:

| Szenario | Ergebnis |
| --- | --- |
| **Firma ABC** aktualisiert auf ein SDK or Software-Development-Kit, das Android O unterstützt<br>**Firma ABC** fügt dem Braze-Dashboard keine Kanäle hinzu<br>**Firma ABC** benennt ihren SDK or Software-Development-Kit-Standardkanal nicht um | Push-Benachrichtigungen, die an Android-O-Geräte gesendet werden, erstellen einen Kanal namens „General“ und Benachrichtigungen werden über den Kanal „General“ gesendet |
| **Firma XYZ** aktualisiert auf ein SDK or Software-Development-Kit, das Android O unterstützt<br>**Firma XYZ** fügt dem Braze-Dashboard keine Kanäle hinzu<br>**Firma XYZ** benennt ihren SDK or Software-Development-Kit-Standardkanal in „Marketing“ um | Push-Benachrichtigungen, die an Android-O-Geräte gesendet werden, erstellen einen Kanal namens „Marketing“ und Benachrichtigungen werden über den Kanal „Marketing“ gesendet |
| **Firma LMN** aktualisiert auf ein SDK or Software-Development-Kit, das Android O unterstützt<br>**Firma LMN** definiert zwei Kanäle in ihrem Anwendungscode: „Promotions“ und „Order Updates“<br>**Firma LMN** fügt die Kanal-IDs für „Promotions“ und „Order Updates“ dem Braze-Dashboard hinzu<br>**Firma LMN** legt „Promotions“ als Dashboard-Fallback-Kanal fest<br>**Firma LMN** benennt ihren SDK or Software-Development-Kit-Standardkanal in „Marketing“ um | Push-Benachrichtigungen, die an Android-O-Geräte gesendet werden, erstellen keinen Kanal<br><br>Sofern der Marketer nicht explizit angibt, dass Benachrichtigungen über den Kanal „Order Updates“ oder „Marketing“ gesendet werden sollen, werden alle Benachrichtigungen, die vor dem Hinzufügen der Kanäle zum Dashboard erstellt wurden, über den Kanal „Promotions“ gesendet<br><br>Der SDK or Software-Development-Kit-Standardkanal „Marketing“ wird nur erstellt und verwendet, wenn die Firma versucht, eine Benachrichtigung über eine ungültige Kanal-ID zu senden oder wenn er explizit ausgewählt wird |
| **Firma HIJ** aktualisiert auf Android O, aber nicht auf Braze Android SDK or Software-Development-Kit 2.1.0 oder höher | Benachrichtigungen, die an Nutzer:innen gesendet werden, die Android O oder höher verwenden, werden nicht angezeigt |
...
3. Wählen Sie **Manage Notification Channels** aus. Alle hier hinzugefügten Kanäle stehen global für alle Campaigns und Canvase zur Verfügung. Sie benötigen die [Berechtigungen]({{site.baseurl}}/user_guide/administer/global/user_management/permissions) „Manage Apps“ für Ihren Workspace, um Kanäle verwalten zu können.
...
Ihr Fallback-Kanal ist der Kanal, über den Braze versucht, Ihre Android-Nachricht zu senden, wenn Sie keinen Kanal für die Nachricht ausgewählt haben. Die einzigen Campaigns und Canvase, die Android-Nachrichten ohne Kanalauswahl enthalten, sind Campaigns und Canvase, die erstellt wurden, bevor Ihr Team Kanäle zum Braze-Dashboard hinzugefügt hat. Wenn Sie Ihren Fallback-Kanal ändern, wird die Änderung global auf alle Campaigns und Canvase ohne explizite Kanalauswahl angewendet.

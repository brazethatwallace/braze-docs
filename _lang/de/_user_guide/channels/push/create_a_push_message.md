...
{% alert tip %}
Wenn alle Nachrichten in Ihrer Campaign ähnlich sein oder denselben Inhalt haben werden, verfassen Sie Ihre Nachricht, bevor Sie zusätzliche Varianten hinzufügen. Sie können dann **Variante kopieren** aus dem Dropdown **Variante hinzufügen** wählen.
{% endalert %}
...
| Multichannel-Campaign | Wählen Sie **Messaging-Kanal hinzufügen**, um zusätzliche Push-Plattformen hinzuzufügen. Da die Plattformauswahl variantenspezifisch ist, können Sie das Nachrichten-Engagement pro Plattform testen. |
...
Wenn Nutzer:innen Ihre App auf mehreren Geräten installiert haben, wird Ihre Push-Nachricht standardmäßig an alle Geräte mit einem gültigen Push-Token gesendet. Bei Bedarf können Sie **Zuletzt verwendetes Gerät** auswählen.
...
Bei Bedarf können Sie das Push-Ziel auf **Zuletzt verwendetes Gerät** setzen.

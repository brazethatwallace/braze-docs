...
Wenn Ihre ungetrackte URL funktioniert, aber Ihre getrackte URL fehlschlägt, liegt möglicherweise eine Konfigurationslücke vor. Lesen Sie die Dokumentation Ihres jeweiligen ESP- und CDN-Anbieters. Detaillierte Anforderungen zur Zertifikatsbereitstellung finden Sie unter [SSL bei Braze]({{site.baseurl}}/user_guide/channels/email/email_setup/ssl).

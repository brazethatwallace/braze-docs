...
> IP-Warming ist die Praxis, E-Mail-Posteingangsanbieter daran zu gewöhnen, Nachrichten von Ihren dedizierten IP-Adressen zu empfangen. Es ist ein äußerst wichtiger Bestandteil des E-Mail-Versands bei jedem E-Mail-Anbieter (ESP) und eine Standardpraxis bei Braze, um sicherzustellen, dass Ihre Nachrichten ihre Zielposteingänge mit einer konstant hohen Rate erreichen.

IP-Warming soll Ihnen helfen, einen positiven Ruf bei Internet-Providern (ISPs) aufzubauen. Jedes Mal, wenn eine neue IP-Adresse zum Senden einer E-Mail verwendet wird, überwachen ISPs diese E-Mails programmatisch, um zu überprüfen, dass sie nicht zum Versenden von Spam an Nutzer:innen verwendet wird. Stellen Sie sich Ihren IP- und Domain-Ruf wie einen Kredit-Score vor – ISPs verwenden diesen Ruf, um zu bestimmen, ob Ihre E-Mail im Posteingang oder im Spam-Ordner landet. Ähnlich wie bei einem Kredit-Score braucht es Zeit, einen positiven Ruf aufzubauen, und noch länger, einen schlechten wiederherzustellen.
...
### Empfehlungen vor dem IP-Warming
...
Der konservative Zeitplan ist ein langsamerer, vorsichtigerer Ansatz, der hilft, einen starken Versandruf von Grund auf aufzubauen. Dies wird empfohlen, wenn Sie neu im E-Mail-Versand sind, von einer geteilten IP migrieren oder Zustellbarkeitsprobleme wie Drosselung oder Blocklisting durch einen Posteingangsanbieter erlebt haben.

...
Braze signiert die E-Mail mit Ihrem geheimen Private Key. Die ISPs überprüfen die Signatur anhand Ihres Public Keys, der in Ihrem angepassten DNS-Eintrag gespeichert ist. Keine zwei Signaturen sind exakt gleich, und nur Ihr Public Key kann die Signatur Ihres Private Keys erfolgreich verifizieren.
...
Die Schritte variieren je nach E-Mail-Client:

{% tabs %}
{% tab Gmail %}

1. Wählen Sie **Mehr** <i class="fa-solid fa-ellipsis"></i> in einer E-Mail-Nachricht aus.
...
2. Wählen Sie den Pfeil neben **Antworten** aus.
3. Wählen Sie **Nachrichtenquelle anzeigen** aus.
4. Überprüfen Sie, ob für **DMARC** der Status „PASS“ angezeigt wird.

{% endtab %}
{% tab Apple Mail %}

1. Öffnen Sie die E-Mail.
2. Wählen Sie **Darstellung** in der Menüleiste aus.
3. Wählen Sie **E-Mail** > **Originalinhalt** aus.
4. Überprüfen Sie, ob für **DMARC** der Status „PASS“ angezeigt wird.

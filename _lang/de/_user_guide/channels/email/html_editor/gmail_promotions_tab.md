...
page_order: 8
description: "Dieser Referenzartikel beschreibt, wie Sie Braze nutzen können, um die Gmail-Aktionskarte für Mobilgeräte aus Ihrer E-Mail-Kampagne zu erstellen."
channel:
  - email
toc_headers: h2
---
...
Leiten Sie zunächst Ihre Domains und Subdomains an das Outreach-Team für den Gmail-Tab „Aktionen" unter <a href="mailto:p-promo-outreach@google.com">p-promo-outreach@google.com</a> weiter, um auf die Allowlist von Gmail gesetzt zu werden. So können Sie alle Features nutzen, die Rich-Imagery anzeigen, wie z. B. das Produktkarussell für den Gmail-Tab „Aktionen".

## Die Karte mit Braze erstellen

Befolgen Sie diese Schritte, um eine Gmail-Aktionskarte für eine E-Mail-Kampagne zu erstellen. Beachten Sie, dass das Verlassen des Abschnitts **Content** im Editor die Felder und Informationen im Tab **Gmail Promotion** zurücksetzt. Schließen Sie die Einrichtung Ihrer Aktionskarte ab und kopieren Sie den generierten HTML-Code, damit Ihr HTML-Code nicht verloren geht.

### 1. Schritt: E-Mail-Kampagne erstellen

[Erstellen Sie zunächst Ihre E-Mail-Kampagne]({{site.baseurl}}/user_guide/channels/email/html_editor/) und wählen Sie den **HTML code editor** als Bearbeitungsmodus.

### 2. Schritt: Details zur Gmail-Aktionskarte hinzufügen

Gehen Sie als Nächstes zum Abschnitt **Content** des HTML-Editors und wählen Sie den Tab **Gmail Promotion**. Füllen Sie die Felder unter **Basic Information** aus und wählen Sie dann **Generate HTML Code**. Dadurch wird das Skript für Ihre Gmail-Aktionskarte im Abschnitt **Copy and Paste HTML code into `<Head>`** generiert.
...
### 5. Schritt: Mit dem Gmail-Vorschau-Tool testen
...
Gmail hat bessere Ergebnisse mit aussagekräftigen Bildern erzielt, die zum E-Mail-Inhalt passen. Gmail empfiehlt nicht, ein reines Textdesign zu verwenden, da dieser Bereich dafür konzipiert wurde, visuelle Sprache – die für E-Mail-Marketing entscheidend ist – in die Vorschau zu bringen. Verwenden Sie keine Bilder mit abgeschnittenem Text und wiederholen Sie keine Bilder in mehreren Kampagnen.
...
### Annotation in der Vorschau anzeigen
...
### Wie füge ich ein Absenderlogo hinzu?
...
### Warum zeigt meine Werbenachricht die Aktionskarte oder das Produktkarussell nicht im Posteingang der Endnutzer:innen an?
...
Aufgrund der Datenschutz- und Sicherheitsvorschriften von Google müssen E-Mails mit Annotationen breit versendet werden, damit die Annotation funktioniert. Es wird empfohlen, eine Kampagne zu starten und sie an mindestens 100 Empfänger:innen zu senden, damit Googles System sie als „Massenversand" erkennt. Bild-URLs dürfen nicht zwischen Empfänger:innen variieren.

### Wie werden Klicks auf eine Aktionskarte oder ein Produktkarussell getrackt?
...
### Warum sehe ich keine Annotationen in meinem Gmail-Tab „Aktionen"?

...
{% alert note %}
Die zufällige Person ist möglicherweise nicht Teil Ihrer Segmentierungskriterien. Die Segmentierung wird erst danach ausgewählt, sodass Braze zu diesem Zeitpunkt Ihre Zielgruppe nicht kennt.
{% endalert %}

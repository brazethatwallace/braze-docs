...
article_title: Apple Mail Privacy Protection für iOS 15
page_order: 1
description: "Dieser Referenzartikel behandelt das Apple Mail Privacy Protection Datenschutz-Update, wer davon betroffen ist, und einige nächste Schritte zur Vorbereitung auf dieses Feature."
channel:
  - email
...
## Was ist Apples Mail Privacy Protection Update?
...
Marken sollten damit rechnen, dass MPP zu Problemen bei E-Mail-Zustellbarkeitsmetriken sowie bei bestehenden Kampagnen und Canvases führt, die auf Basis dieser Metriken ausgelöst werden. Um die Auswirkungen auf die E-Mail-Zustellbarkeit zu verstehen, lesen Sie den Abschnitt [E-Mail-Reporting]({{site.baseurl}}/user_guide/channels/email/reporting/).

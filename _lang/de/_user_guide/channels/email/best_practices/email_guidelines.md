...
- Um ein E-Mail-Template sowohl für Mobilgeräte als auch für Desktop-Versionen zu verwenden, halten Sie die Breite unter 500 Pixeln.
- Bilder müssen kleiner als 5&nbsp;MB sein. Wir empfehlen die Verwendung von PNG, JPEG oder GIF für maximale Kompatibilität. Vermeiden Sie SVG und WebP, da viele große E-Mail-Clients diese noch nicht unterstützen.
...
Die E-Mail-Validierung erfolgt, wenn die E-Mail-Adresse einer Nutzer:in aktualisiert oder über die API, CSV-Upload, das SDK in Braze importiert oder im Dashboard geändert wird. Beachten Sie, dass Ihre E-Mail-Adressen keine Leerzeichen enthalten dürfen. Beim Senden über die API können Leerzeichen zu einem `400`-Fehler führen.

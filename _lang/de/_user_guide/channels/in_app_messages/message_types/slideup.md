...
Um einen Link in einem Slideup hinzuzufügen, geben Sie den Nachrichtentext im Feld **Body** ein und legen Sie das Ziel unter **On-Klick, der behavior** fest (zum Beispiel **Redirect to URL**). Wenn **On-Klick, der behavior** konfiguriert ist, löst ein Tippen auf eine beliebige Stelle der Nachricht – außer auf das Schließen-Steuerelement – diese Aktion aus.

...
Keyword- und Eingangs-Nachrichten-Ereignisse in Currents oder Ihrem Data Warehouse, wie z. B. Zeitstempel auf [`users.messages.sms.InboundReceive`]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events#sms-inbound-received-events) oder Abo-Gruppen-Statusänderungs-Ereignisse, sind die maßgebliche Quelle dafür, wann Braze das Opt-out erfasst hat.

...
Das Nutzerprofil zeigt den aktuellen Abo-Status an, enthält aber möglicherweise kein einzelnes Feld „SMS abgemeldet am“, es sei denn, Sie setzen ein [angepasstes Attribut]({{site.baseurl}}/user_guide/data/activation/attributes/custom_attributes) oder einen ähnlichen Mechanismus bei der Verarbeitung von Opt-outs.

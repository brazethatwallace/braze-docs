...
{% alert important %}
Alle Kund:innen, die derzeit US-Langcodes besitzen und/oder nutzen, um Nachrichten an US-Kund:innen zu senden, müssen ihre Langcodes für 10DLC Registrierung or registrieren. Wer dies nicht tut, muss mit einer starken Filterung aller Nachrichten rechnen. Dieser Antragsprozess dauert 4–6 Wochen.
{% endalert %}
...
- **Budgetfreundlich**: 10DLC ist eine großartige Option für Unternehmen, die mit dem Kurzmitteilungsdienst or SMS-Versand beginnen oder Kurzmitteilungsdienst or SMS in kleinen Mengen versenden möchten. Für Marken, die größere Nachrichtenvolumen von über 100.000 Nachrichten pro Tag versenden, empfehlen wir die Verwendung eines Shortcodes.
...
| Anbietergebühren | Gebühren, die von Mobilfunkanbietern für ausgehende Kurzmitteilungsdienst or SMS- und MMS-Nachrichten erhoben werden, die nach der 10DLC-Registrierung an Nutzer:innen gesendet werden. Ab dem 1. Oktober 2021 sind die Anbietergebühren für nicht registrierten Verkehr (Standard-Langcodes) höher als für registrierten Verkehr (10DLC). |
...
Die Campaign Registry (TCR) ist eine Drittanbieter-Agentur, die einen Reputationsalgorithmus verwendet, um bestimmte Kriterien in Bezug auf Ihr Unternehmen zu überprüfen und einen Vertrauens-Score zuzuweisen, der den Messaging-Durchsatz für jede Marke bestimmt. Dieser Vertrauens-Score wird zugewiesen, wenn sich Kund:innen für US-10DLC-Messaging Registrierung or registrieren. Je höher der Vertrauens-Score, desto besser die MPS or Messages pro Sekunde or Messages pro Sekunde (MPS or Messages pro Sekunde), die Sie erleben werden.

|     | Vertrauens-Score | AT&T | T-Mobile | Verizon |
| --- | ----------- | ---- | -------- | ------- |
| Hoch | 75–100 | 75 MPS or Messages pro Sekunde | 75 MPS or Messages pro Sekunde | 75 MPS or Messages pro Sekunde |
| Mittel | 50–74 | 40 MPS or Messages pro Sekunde | 40 MPS or Messages pro Sekunde | 40 MPS or Messages pro Sekunde |
| Niedrig | 1–49 | 4 MPS or Messages pro Sekunde | 4 MPS or Messages pro Sekunde | 4 MPS or Messages pro Sekunde |
...
Tägliche Limits reichen von 2.000 bis 200.000 Nachrichten, abhängig von Ihrem Vertrauens-Score der Marke, und gelten für alle Langcodes. Obwohl hohe Vertrauens-Scores einen Durchsatz von 60 MPS or Messages pro Sekunde or Messages pro Sekunde ermöglichen, gelten die vom Mobilfunkanbieter festgelegten täglichen Nachrichtenlimits weiterhin. Das bedeutet, dass Shortcodes die bessere Option wären, wenn die täglichen Spitzennachrichten einer Marke das auferlegte Tageslimit überschreiten.
...
| --- | ----------- | ---- | -------- | ------- |
| 75–100 | 225 MPS or Messages pro Sekunde | 75 MPS or Messages pro Sekunde | 75 MPS or Messages pro Sekunde | 75 MPS or Messages pro Sekunde |
| 50–74	 | 120 MPS or Messages pro Sekunde | 40 MPS or Messages pro Sekunde | 40 MPS or Messages pro Sekunde | 40 MPS or Messages pro Sekunde |
| 1–49 | 12 MPS or Messages pro Sekunde | 4 MPS or Messages pro Sekunde | 4 MPS or Messages pro Sekunde | 4 MPS or Messages pro Sekunde|
...
Kund:innen, die sich noch nicht für 10DLC registriert haben, müssen mit ihrem CSM or Customer-Success-Manager or Customer-Success-Manager:in zusammenarbeiten, um ihre Langcodes zu Registrierung or registrieren. **Wenn Kund:innen ihre Langcodes nicht Registrierung or registrieren, wird ab dem 1. Oktober 2021 jeder A2P-Sender, der Langcodes verwendet, eine starke Filterung aller Nachrichten erfahren.** Kontaktieren Sie Ihren CSM or Customer-Success-Manager or Customer-Success-Manager:in, um mit Ihrer 10DLC-Registrierung zu beginnen.
...
article_title: Kurzmitteilungsdienst or SMS-, MMS- und RCS-Absender
page_order: 2
description: "Dieser Artikel bietet eine Übersicht über die Codes und Absender, die für den Versand von Kurzmitteilungsdienst or SMS-, MMS- und RCS-Nachrichten verfügbar sind."
page_type: reference
...
{% multi_lang_include channels/Kurzmitteilungsdienst or SMS/short_and_long_codes.md %}

## MMS-spezifische Anforderungen {#mms-specific-requirements}

### MMS-Absenderanforderungen {#mms-sender-requirements}

> MMS und Kurzmitteilungsdienst or SMS sind beide an den Braze-Kurzmitteilungsdienst or SMS-Kanal gebunden. Um MMS in Ihrem Konto nutzen zu können, ist der Kauf von Kurzmitteilungsdienst or SMS erforderlich, sofern Sie noch keinen Zugang erworben haben. Bestehende Kurzmitteilungsdienst or SMS-Kund:innen können nach dem Kauf auf MMS zugreifen.
...
Das Senden von MMS an Nummern außerhalb der USA und Kanadas ist möglich, allerdings werden MMS-Nachrichten in eine Kurzmitteilungsdienst or SMS-Nachricht mit einem Link zum Medien-Asset umgewandelt.
...
Für Nutzer:innen, die ihre Shortcodes erhalten haben, bevor Braze MMS unterstützte, sind alle bestehenden Kund:innen mit US-Shortcodes berechtigt, MMS sofort zu aktivieren. Wenden Sie sich an Ihren CSM or Customer-Success-Manager or Customer-Success-Manager:in, wenn diese Situation auf Sie zutrifft und Sie MMS aktivieren möchten.

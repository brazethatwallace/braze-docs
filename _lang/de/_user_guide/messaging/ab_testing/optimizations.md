...
page_order: 1
page_type: reference
description: "Erfahren Sie, wie Sie die Gewinnervariante oder personalisierte Varianten beim Erstellen von multivariaten und A/B-Tests verwenden."
---

# A/B-Tests mit Gewinnervariante oder personalisierten Varianten optimieren

> Erfahren Sie, wie Sie die Gewinnervariante oder personalisierte Varianten beim Erstellen von multivariaten und A/B-Tests verwenden.

Wenn Sie für E-Mail-, Push-, Webhook-, SMS- und WhatsApp-Kampagnen, die für einen einmaligen Versand geplant sind, [einen A/B-Test erstellen]({{site.baseurl}}/user_guide/messaging/ab_testing/create_tests/), können Sie eine Optimierung auswählen. Es gibt zwei Optimierungsoptionen: **Gewinnervariante** und **Personalisierte Variante**.

![Optimierungsoptionen im Abschnitt A/B-Tests bei der Auswahl Ihrer Zielgruppe. Drei Optionen sind aufgelistet: Keine Optimierung, Gewinnervariante und Personalisierte Variante. Personalisierte Variante ist ausgewählt.]({% image_buster /assets/img_archive/ab_personalized_variant.png %})

Beide Optionen funktionieren, indem zunächst ein Test an einen Prozentsatz Ihres Zielsegments gesendet wird. Nach Abschluss des Tests erhalten die verbleibenden Nutzer:innen in Ihrer Zielgruppe entweder die leistungsstärkste Variante (Gewinnervariante) oder die Variante, mit der sie am wahrscheinlichsten interagieren werden (Personalisierte Variante).

{% alert tip %}
Optimierungen finden Sie im Schritt **Zielgruppe** der Kampagnenerstellung unter **A/B-Tests**.
{% endalert %}

## Gewinnervariante

Das Senden der Gewinnervariante ähnelt einem Standard-A/B-Test. Nutzer:innen in dieser Gruppe erhalten die Gewinnervariante, sobald der erste Test abgeschlossen ist.

...
{% alert important %} 
Dieses Feature befindet sich derzeit im Early Access. Kontaktieren Sie Ihren Braze-Kundenerfolgs- oder Account Manager, wenn Sie an der Teilnahme am Early Access interessiert sind.
{% endalert %}

## Eine Projektion durchführen

Fügen Sie bei der Kampagnenerstellung Ihre Nachrichtenvarianten und deren Betreffzeilen in den Editor ein. Wenn Sie bereit sind, gehen Sie zum Schritt **Zielgruppe** im Kampagnenerstellungsablauf. Wählen Sie im Panel **A/B-Tests** die Option **Run Projection** aus.
...
{% alert note %}
Für [Quick-Push-Kampagnen]({{site.baseurl}}/user_guide/channels/push/create_a_push_message/quick_push_messages/) werden A/B-Tests unterstützt, wenn Sie mehrere Plattformen auswählen.
{% endalert %}

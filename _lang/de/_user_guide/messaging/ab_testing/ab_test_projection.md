...
Die Betreffzeile, die unsere KI or künstliche Intelligenz als beste vorhersagt, wird mit dem Label **Projected Winner** hervorgehoben.
...
Dieses Feature lernt aus vergangenen A/B-Tests, die auf Braze durchgeführt wurden. Der tatsächliche Text Ihrer Nachrichten oder der Nachrichten anderer Braze-Kund:innen wird dem Modell niemals zur Verfügung gestellt. Wir extrahieren zunächst die übergeordneten Sprachmuster, die erfolgreiche Nachrichten in A/B-Tests vorhersagen. Anschließend stellen wir diese Muster unserer KI or künstliche Intelligenz zur Verfügung, um ihr beizubringen, welche sprachlichen Merkmale überlegene Betreffzeilen ausmachen.
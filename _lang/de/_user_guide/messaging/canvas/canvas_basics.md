...
## Die Struktur von Canvas verstehen
...
{% tabs %}
  {% tab Canvas %}
  Canvas ist eine einheitliche Oberfläche, auf der Marketer Kampagnen mit mehreren Nachrichten erstellen können. Es funktioniert ähnlich wie ein visuelles Programmiertool und ermöglicht es Ihnen, eine zusammenhängende User Journey aus einer Reihe von Schritten aufzubauen.
...
### Das „Warum": Konversions-Events identifizieren
...
### Das „Wann": Startbedingungen erstellen
...
### Das „Wie": Die vollständige Erfahrung aufbauen
...
## Anwendungsfall: Kunden-Onboarding-Flow

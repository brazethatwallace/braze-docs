...
## Eine Verzögerung erstellen {#create-a-delay}
...
##### Nutzer:innen verlassen den Canvas, wenn ein nachfolgender Verzögerungsschritt innerhalb des Zeitrahmens eines vorherigen Verzögerungsschritts liegt {#users-will-exit-if-a-subsequent-delay-step-is-within-a-prior-delay-steps-timeline}

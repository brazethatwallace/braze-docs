...
- Vermeiden Sie zu frühe Aktualisierungen. Jedes Mal, wenn Sie Änderungen veröffentlichen, setzt der Optimizer auf Null zurück. Wenn Sie aktualisieren, bevor der Schritt Zeit hatte zu erkennen, was funktioniert, verhindern Sie, dass er seine Erkenntnisse nutzen kann – und der Schritt bekommt nie die Chance, bedeutenden Traffic in Richtung der leistungsstärksten Kombinationen zu verschieben.
- Wenn Sie bereit sind zu aktualisieren, ist ein guter Ansatz, leistungsschwache Varianten zu deaktivieren und neue hinzuzufügen, die auf den Eigenschaften Ihrer Top-Performer aufbauen.

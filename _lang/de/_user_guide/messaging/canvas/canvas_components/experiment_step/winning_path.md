...
# Winning Path in Experimentpfaden

> Winning Path ist vergleichbar mit [Winning Variant]({{site.baseurl}}/user_guide/messaging/ab_testing/optimizations/) in Kampagnen und ermöglicht es Ihnen, Ihre A/B-Tests zu automatisieren.
...
### 1. Schritt: Einen Experiment-Pfad-Schritt hinzufügen
...
### 2. Schritt: Winning-Path-Einstellungen konfigurieren

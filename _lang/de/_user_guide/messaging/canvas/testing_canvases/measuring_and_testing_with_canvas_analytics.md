...
Wenn Sie auf der Seite **Canvas Details** nach unten scrollen, können Sie die Performance für jede Komponente sehen, z. B. wie viele Nutzer:innen eingetreten sind, zum nächsten Schritt weitergegangen sind oder den Canvas verlassen haben.
...
## Performance-Aufschlüsselung nach Variante
...
- **Gesamtumsatz:** Der Gesamtumsatz in Dollar von Canvas-Empfänger:innen innerhalb des festgelegten primären Konversionsfensters.
...
### Wie Conversions erfasst werden

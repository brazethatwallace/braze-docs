...
2. Bewegen Sie den Mauszeiger über die Campaign und wählen Sie <i class="fas fa-gear"></i> **Weitere Aktionen**.
...
2. Bewegen Sie den Mauszeiger über die Canvas-Zeile und wählen Sie <i class="fas fa-ellipsis-vertical"></i> **Weitere Aktionen**.
3. Wählen Sie **Duplizieren**.

...
- **Nachrichten werden gleichzeitig gesendet, wenn die Ruhezeiten enden.** Wenn bei einer großen Zielgruppe Nachrichten während der Ruhezeiten zurückgehalten werden, werden alle diese Nachrichten auf einmal gesendet, sobald das Fenster endet. Berücksichtigen Sie bei zeitkritischen Kampagnen, wie sich dies auf den Zustellungszeitpunkt auswirkt.

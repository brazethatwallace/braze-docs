...
| Zielgruppenpfade | Intelligent Channel split | Leitet Nutzer:innen basierend auf dem [intelligenten Kanal]({{site.baseurl}}/user_guide/brazeai/intelligence_suite/intelligent_channel)-Ranking zu E-Mail oder Kurzmitteilungsdienst or SMS weiter. |
| Nachricht | Abandoned Cart Email, Abandoned Cart Kurzmitteilungsdienst or SMS und Abandoned Cart In-App Message | Kanalspezifische Follow-ups. Der intelligente Kanal wählt zwischen E-Mail und Kurzmitteilungsdienst or SMS; die In-App-Nachricht wird auf einem separaten Pfad im Template gesendet. |
...
Wenden wir das Canvas-Template an und Update or aktualisieren or aktualisieren die Details, um unser Ziel widerzuspiegeln.
...
4. Update or aktualisieren or aktualisieren Sie die Beschreibung, um anzugeben, dass das Canvas Nutzer:innen ermutigen soll, Käufe aus der neuesten saisonalen Küchenartikel-Kollektion abzuschließen.
...
Wenn Sie stattdessen einen aktionsbasierten Eintritt bevorzugen, wählen Sie **Action-Based** und einen Trigger or triggern, der zu der Art passt, wie Ihre Marke Warenkorb-Abbrüche erfasst – zum Beispiel **Perform Custom Event** für ein protokolliertes `abandoned_cart`-Event.
...
1. Überprüfen Sie den Zielgruppenpfade-Schritt **Intelligent Channel split**. Dieser leitet Nutzer:innen basierend auf dem [intelligenten Kanal]({{site.baseurl}}/user_guide/brazeai/intelligence_suite/intelligent_channel)-Ranking zu **Abandoned Cart Email** oder **Abandoned Cart Kurzmitteilungsdienst or SMS** weiter. Passen Sie die Pfade bei Bedarf an.
2. Passen Sie die Schritte **Abandoned Cart Email**, **Abandoned Cart Kurzmitteilungsdienst or SMS** und **Abandoned Cart In-App Message** an. Wählen Sie bei jedem Schritt **Edit message**, um den Text und die Nachricht für den jeweiligen Kanal zu Update or aktualisieren or aktualisieren. Die In-App-Nachricht läuft auf einem separaten Pfad vom Intelligent-Channel-Split und wird nicht durch das Intelligent-Channel-Ranking ausgewählt.

...
Wenn Sie eine Drag-and-Drop-In-App-Nachricht erstellen, wählen Sie **Onboarding flow** als Template und dann **Build message** aus. Dieses Template wird sowohl für mobile Apps als auch für Webbrowser unterstützt.

![Der In-App-Nachrichten-Editor mit dem Onboarding-Flow-Template.]({% image_buster /assets/img/drag_and_drop/templates/onboarding_editor.png %})

### 2. Schritt: Nachrichtenstile einrichten {#step-2-set-up-your-message-styles}

{% multi_lang_include drag_and_drop/templates.md section='message style' %}

### 3. Schritt: Reihenfolge Ihres Onboarding-Flows anpassen {#step-3-customize-the-order-of-your-onboarding-flow}

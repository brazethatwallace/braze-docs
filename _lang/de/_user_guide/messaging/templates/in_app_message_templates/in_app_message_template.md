...
## Schritt 1: In-App-Nachricht-Templates öffnen {#step-1-open-in-app-message-templates}

Gehen Sie im Braze-Dashboard zu **Content** > **In-App Message**.

## Schritt 2: Erstellungsmethode wählen {#step-2-choose-how-to-create-a-template}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Schritt 2: Erstellungsmethode wählen" }

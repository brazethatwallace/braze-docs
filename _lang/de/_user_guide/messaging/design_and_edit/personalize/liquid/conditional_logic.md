...
Ein leerer Wert tritt auf, wenn das Attribut in einem Kundenprofil nicht gesetzt ist, mit einem Leerzeichen-String (` `) gesetzt ist oder als `false` gesetzt ist. Leere Werte sollten vor anderen Variablen geprüft werden, um einen Liquid-Verarbeitungsfehler zu vermeiden.

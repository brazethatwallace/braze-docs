...
Wenn Sie den folgenden Text in Ihre Nachricht einfügen: `{{${first_name}}}`, wird der Vorname der Nutzer:in (aus dem Kundenprofil abgerufen) beim Senden der Nachricht eingesetzt. Sie können dasselbe Format mit anderen Standardattributen verwenden.

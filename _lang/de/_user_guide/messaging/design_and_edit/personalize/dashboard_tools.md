...
---
# Dashboard-Tools für Personalisierung
...
## Vorformatierte Variablen und Standardwerte einfügen
...
![Ein GIF des Modals „Personalisierung hinzufügen", das zeigt, wie die Nutzer:in „fellow traveler" als Standardwert einfügt und das Modal den markierten Text „name" im Composer durch das Liquid-Snippet ersetzt.]({% image_buster /assets/img_archive/insert_var_shot.gif %})
...
#### Tutorial: Variablen zur Berechnung eines Guthabens verwenden

Berechnen wir das aktuelle Guthaben einer Nutzer:in, indem wir das Geschenkkarten-Guthaben und das Rewards-Guthaben addieren:

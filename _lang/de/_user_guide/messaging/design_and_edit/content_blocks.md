...
### Spezifikationen für Content-Blöcke
...
Im Drag-and-Drop-Editor können Sie einen Content-Block auch über das **Personalisierung**-Panel hinzufügen:
...
## Content-Blöcke in der Vorschau anzeigen
...
## Content-Blöcke aktualisieren und kopieren

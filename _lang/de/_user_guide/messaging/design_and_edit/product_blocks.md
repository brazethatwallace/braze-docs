...
# Drag-and-Drop-Produkt-Blöcke

> Der Drag-and-Drop-Editor ermöglicht es Ihnen, Produkt-Blöcke schnell hinzuzufügen und zu konfigurieren, um Produkte nahtlos in Ihren Nachrichten zu präsentieren – ganz ohne benutzerdefinierten Liquid-Code.
...
## Inhaltskonfiguration von Produkt-Blöcken
...
| Preis | Eigenschaft des empfohlenen E-Commerce-Events |
| Menge | Eigenschaft des empfohlenen E-Commerce-Events |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }

![Produktfelder für einen dynamischen Produkt-Block, unterteilt in Katalogdaten und Event-Daten]({% image_buster /assets/img/product_blocks/dynamic_fields.png %}){: style="max-width:50%;"}
...
#### Wie globale E-Mail-Stileinstellungen mit Produkt-Blöcken funktionieren
...
### 1. Schritt: E-Mail-Kampagne oder E-Mail-Canvas-Schritt erstellen

#### Dynamischer Produkt-Block

{% alert note %}
Dynamische Produkt-Blöcke erfordern [empfohlene E-Commerce-Events]({{site.baseurl}}/ecommerce_events/) und können nur innerhalb von [Canvases]({{site.baseurl}}/ecommerce_use_cases/) verwendet werden. Für Braze-Shopify-Nutzer:innen sind diese Events automatisch als Teil der Integration enthalten. Für Nicht-Shopify-Nutzer:innen müssen Sie mit Ihren Entwickler:innen zusammenarbeiten, um diese Events an Braze zu übergeben und sicherzustellen, dass der primäre Produktbezeichner innerhalb der Events als Katalog-Artikel-ID hinzugefügt wird.
{% endalert %}
...
Erstellen Sie eine Drag-and-Drop-E-Mail-Kampagne, ein aktionsbasiertes Canvas oder ein Template mit einem Drag-and-Drop-E-Mail-Nachrichten-Schritt.

### 2. Schritt: Produkt-Block hinzufügen
...
Wählen Sie den Produktkatalog aus, den Sie für die Personalisierung verwenden möchten. Stellen Sie sicher, dass er mit den Produkten aus den eingehenden Events übereinstimmt, die Sie ansprechen.
...
### 3. Schritt: Produktfelder konfigurieren
...
### 4. Schritt: Layout-Einstellungen konfigurieren
...
### 5. Schritt: Nachricht in der Vorschau anzeigen und testen

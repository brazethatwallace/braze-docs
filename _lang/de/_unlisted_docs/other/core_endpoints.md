...
Die Kern-API-Endpunkte von Braze sind spezifische Endpunkte in der REST API von Braze, die eine zulässige Ausfallzeit gemäß dem Service Level Agreement (SLA) eines Braze-Kontos haben. Weitere Informationen finden Sie in Ihrer SLA-Dokumentation oder wenden Sie sich an Ihren Account Manager.

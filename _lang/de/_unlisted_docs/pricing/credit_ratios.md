---
nav_title: WhatsApp-Credit-Verhältnisse
alias: "/credit_ratios/"
permalink: "/credits_whatsapp/"
hidden: true
---

# WhatsApp-Credit-Verhältnisse (vertraulich) {#whatsapp-credit-ratios-confidential}

> {% multi_lang_include whatsapp/about_credits.md content="h2" %}

## Tabelle der Credit-Verhältnisse {#credit-ratio-table}

{% details Zum Aufklappen klicken %}
<table class="credits-table" aria-label="Tabelle der Credit-Verhältnisse">
    <colgroup>
        <col span="3">
...
## Abrechnung nach Region {#billing-by-region}

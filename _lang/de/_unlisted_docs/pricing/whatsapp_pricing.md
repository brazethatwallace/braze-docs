...
- **Für Marketing-Nachrichten:** Die Tarife werden in Mexiko gesenkt, um sicherzustellen, dass die Preisgestaltung weiterhin die Nutzung fördert und ein gesundes Messaging-Ökosystem unterstützt.
...
Zusätzlich zu den bereits angekündigten Preisaktualisierungen im Juli führt Meta einige weitere Änderungen ein, die ebenfalls am 1. Juli 2025 in Kraft treten.

Hier eine kurze Zusammenfassung der bereits angekündigten Änderungen:
- Die WhatsApp-Preise werden von einem „pro Konversation“-Modell auf ein „pro Nachricht“-Modell umgestellt. **Die „pro Nachricht“-Tarife entsprechen den aktuellen „pro Konversation“-Tarifen.**
...
*Weitere Details zu diesen Änderungen finden Sie im früheren Beitrag vom 12. März weiter unten in diesem Artikel.*

Zusätzliche Änderungen zum 1. Juli (von Meta am 15. Mai angekündigt):
- Meta aktualisiert die Tarife für Utility- und Authentifizierungsnachrichten in mehreren Märkten im Rahmen fortlaufender Bemühungen, die Preise an alternative Kanäle anzugleichen.
    - Die Preise für Utility- und Authentifizierungs-Messaging sinken in allen Märkten außer Indonesien. In Indonesien steigen die Utility-Preise, während die Authentifizierungspreise sinken.
- Meta verfeinert die Definition von Utility basierend auf Nutzer:innen-Engagement und -Stimmung und ordnet dadurch bestimmte Anwendungsfälle der Utility-Kategorie zu bzw. daraus heraus. Siehe Metas neue [Utility-Template-Definition](https://developers.facebook.com/docs/whatsapp/pricing/updates-to-pricing#updates-to-template-category-guidelines).

Für die meisten Kund:innen treten diese Änderungen am 1. Juli automatisch in Kraft.

## Bevorstehende Preisänderungen bei WhatsApp im Juli 2025 {#upcoming-whatsapp-pricing-changes-in-july-2025}

*Zuletzt aktualisiert am 12. März 2025 (ursprünglich veröffentlicht am 13. Dezember 2024)*

WhatsApp nimmt ab dem 1. Juli 2025 zwei weitere Änderungen an der Preisgestaltung vor. Braze wird die Preise am selben Tag entsprechend anpassen. Eine Zusammenfassung der Änderungen und bewährte Vorgehensweisen zur Berücksichtigung dieser Änderungen finden Sie im folgenden Abschnitt.

### Änderung 1: Die WhatsApp-Preisgestaltung wechselt von einem „Pro-Konversation“-Modell zu einem „Pro-Nachricht“-Modell. {#update-1-whatsapp-pricing-will-shift-to-a-per-message-model-instead-of-a-per-conversation-model}
...
Diese Änderung gilt für Marketing-, Utility- und Authentifizierungs-Templates. Service-Konversationen sind seit dem 1. November 2024 kostenlos.

*Hinweis: Diese Änderung war ursprünglich für den 1. April, dann den 1. Mai und jetzt den **1. Juli** geplant.*

### Änderung 2: Utility-Templates, die innerhalb eines 24-Stunden-Kundenservice-Fensters gesendet werden, sind kostenlos. {#update-2-utility-templates-sent-during-a-24-hour-customer-service-window-will-be-free-of-charge}
...
Utility-Templates, die außerhalb eines 24-Stunden-Kundenservice-Fensters gesendet werden (z. B. Utility-Templates, die von einer Marke proaktiv für Kontoerinnerungen und Auftragsstatus-Updates gesendet werden), werden weiterhin berechnet.

Wir empfehlen die folgenden bewährten Vorgehensweisen, um diese Änderungen zu berücksichtigen und Ihr WhatsApp-Marketing-Budget optimal zu nutzen:

- Begrenzen Sie das Senden mehrerer Nachrichten-Templates desselben Typs (ohne Nutzer:innen-Antwort) im 24-Stunden-Zeitraum. So werden Ihnen nicht mehr Kosten berechnet als zuvor unter dem „Pro-Konversation“-Modell. Dies ist auch eine bewährte Vorgehensweise, um Ihren Kund:innen qualitativ hochwertige Erlebnisse zu bieten und Nachrichtenmüdigkeit zu vermeiden.
- Verwenden Sie [Antwortnachrichten]({{site.baseurl}}/user_guide/channels/whatsapp/create_a_whatsapp_message#response-messages), wenn Sie auf Nachrichten von Endnutzer:innen antworten. Antwortnachrichten sind kostenlos.
...
| - Nutzer:in sendet Nachricht an Marke <br>- Marke antwortet mit einer Antwortnachricht | Kostenlos <br> _Als Service-Konversation klassifiziert_ | Kostenlos <br> _Als Service-Konversation klassifiziert_ |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation"}

Wir empfehlen die folgenden bewährten Vorgehensweisen, um diese Änderungen zu berücksichtigen und Ihr WhatsApp-Marketing-Budget optimal zu nutzen:

- Begrenzen Sie das Senden mehrerer Nachrichten-Templates desselben Typs (ohne Nutzer:innen-Antwort) im 24-Stunden-Zeitraum. Dies verhindert, dass Ihnen mehr berechnet wird als zuvor unter dem „Pro-Konversation“-Modell. Dies ist auch eine bewährte Vorgehensweise, um Ihren Kund:innen qualitativ hochwertige Erlebnisse zu bieten und Nachrichtenmüdigkeit zu vermeiden.
- Verwenden Sie [Antwortnachrichten]({{site.baseurl}}/user_guide/channels/whatsapp/create_a_whatsapp_message#response-messages), wenn Sie auf Nachrichten von Endnutzer:innen antworten. Antwortnachrichten sind kostenlos.

*Hinweis: Diese Änderung war ursprünglich für den 1. April und jetzt den **1. Juli** geplant.*

## Preisänderungen bei WhatsApp von August 2024 bis November 2024 {#whatsapp-pricing-changes-from-august-2024-november-2024}
...
Marketing-Conversations ermöglichen es Ihnen, eine Vielzahl von Zielen zu erreichen – von der Steigerung der Bekanntheit über die Förderung von Verkäufen bis hin zum Retargeting von Kund:innen. Beispiele umfassen neue Produktankündigungen, gezielte Aktionen/Angebote und Campaigns für abgebrochene Einkäufe.

### Service-Conversations

Ab dem 1. November 2024 sind alle Service-Conversations kostenlos. Service-Conversations verbrauchen keine Message-Credits oder WhatsApp-Credits mehr. Diese Änderung tritt am selben Tag wie bei Meta in Kraft (1. November).

#### Was sind Service-Conversations? {#what-are-service-conversations}
...
- [Campaigns für nicht erkannte Antworten]({{site.baseurl}}/user_guide/channels/whatsapp/create_a_whatsapp_message#response-messages), bei denen Endnutzer:innen eine nicht erkannte Nachricht senden und die Marke mit einer allgemeinen Nachricht über [Antwort-Messaging]({{site.baseurl}}/user_guide/channels/whatsapp/create_a_whatsapp_message#response-messages) antwortet. Zum Beispiel sendet eine Endnutzer:in eine Nachricht ohne Schlüsselwort und die Marke antwortet mit „Wir konnten Ihre Nachricht nicht zuordnen. Bitte wenden Sie sich an den Kundensupport.“
- Unterhaltungen, die beginnen, wenn Endnutzer:innen der Marke ein beworbenes Schlüsselwort senden und die Marke mit einer [Antwortnachricht]({{site.baseurl}}/user_guide/channels/whatsapp/create_a_whatsapp_message#response-messages) antwortet. Häufige Beispiele sind das Opt-in für WhatsApp-Messaging oder die Teilnahme an einer bestimmten Aktion.

<br>

Detaillierte Informationen zur Senkung der Utility-Conversations finden Sie im folgenden Abschnitt:

| Abrechnungsregion                          | Prozentuale Senkung bei Utility |
|--------------------------------------------|--------------------------|
| Argentinien                                | 16,7 %                   |
| Brasilien                                  | 77,1 %                   |
| Chile                                      | 65,9 %                   |
...
| Pakistan                                   | 78,7 %                   |
| Peru                                       | 52,3 %                   |
| Restliches Afrika                          | 61,9 %                   |
| Restlicher asiatisch-pazifischer Raum      | 66,7 %                   |
| Restliches Mittel- und Osteuropa           | 43,0 %                   |
| Restliches Lateinamerika                   | 77,1 %                   |
| Restlicher Naher Osten                     | 20,7 %                   |
| Restliches Westeuropa                      | 28,6 %                   |
| Russland                                   | 16,1 %                   |
| Saudi-Arabien                              | 54,4 %                   |
| Südafrika                                  | 62,0 %                   |
| Spanien                                    | 47,4 %                   |

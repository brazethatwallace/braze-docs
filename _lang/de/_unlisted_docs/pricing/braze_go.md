...
- Sie können bis zu 20 aktive Canvase haben.
- Das gesamte Standard-Rate-Limit der Representational State Transfer API beträgt 50.000 pro Stunde und Workspace.
    - Für die Nutzung ohne Braze Go erfahren Sie mehr über [Representational State Transfer-API-Limits]({{site.baseurl}}/api/api_limits#rate-limits-by-request-type).
- Die Aufbewahrungsdauer für Interaktionsdaten von Campaigns und Canvase beträgt 2 Monate ohne Wiederherstellung.
...
{% alert note %}
Interaktionsdaten für Campaigns und Canvase unterscheiden sich von Snowflake-Daten und haben keinerlei Auswirkungen darauf.
{% endalert %}
...
- Braze kann außerdem eine Datenaufbewahrungsrichtlinie für Kundenprofil or Nutzerprofil-Ereignisse und Kaufdaten implementieren, die Ereignisse, Käufe oder beides entfernt, die älter als 1 Jahr sind und innerhalb von 1 Jahr nicht erneut durchgeführt wurden. Diese Daten wären jedoch weiterhin für 2 Jahre in SQL-Segmenterweiterungen verfügbar.

...
## Credit-Ratio-Tabelle für Message Credits – Lambda {#credit-ratio-table-for-message-credits-lambda}

{% details Zum Aufklappen klicken %}
<table class="credits-table" aria-label="Credit-Ratio-Tabelle für Message Credits – Lambda">
    <colgroup>
        <col span="3">
...
### Eigene (BYO) Kurzmitteilungsdienst or SMS-Konnektoren {#bring-your-own-byo-sms-connectors}

Braze ermöglicht es Kund:innen, Drittanbieter zu integrieren, um Kurzmitteilungsdienst or SMS-Nachrichten über das Modell „BYO Kurzmitteilungsdienst or SMS-Konnektor“ zu senden. Braze berechnet Nachrichtenguthaben für jede Nachricht, die über BYO Kurzmitteilungsdienst or SMS-Konnektoren von der Braze-Plattform gesendet wird.

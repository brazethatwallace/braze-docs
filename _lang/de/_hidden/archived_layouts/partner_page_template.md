...
|---|---|---|---|
| Representational State Transfer-API-Schlüssel des Braze-Workspace | Braze-Plattform | Seite **Einstellungen** > **API-Schlüssel** | Diese Beschreibung sollte erklären, was mit dem Representational State Transfer-API-Schlüssel des Workspace zu tun ist. |

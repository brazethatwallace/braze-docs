      ...
      $('#doc_form').submit(function(e) {
        ...
        $.ajax({
          ...
          $('#doc_thankyou_msg').fadeTo(800,0,function(){
              $(this).html('<h3>Vielen Dank für Ihre Einreichung!</h3> Jemand aus unserem Team wird sich bei Ihnen melden, falls wir Fragen haben. Um den Status Ihres Tickets einzusehen oder Kommentare hinzuzufügen, prüfen Sie Ihre E-Mail auf die Ticketbestätigung.').fadeTo(800,1);
          });
        }).fail(function() {
          $('#submit_progress').css('display','none');
          $('#submit_text').html('Anfrage senden');
          $('#ticket_submit_button').prop("disabled",false);
          alert('Beim Senden Ihrer Anfrage ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.');
        });
...
<div id="braze_internal" ><i class="fa-solid fa-lock"></i> Nur intern. Nicht an Kund:innen weitergeben.</div>
<div class="container-fluid" id="main-container">
      ...
      <div id="doc_div">
        <form id="doc_form">
          <div class="row">
            <div class="col">
              <h1 class="h1">Formular für Dokumentationsanfragen</h1>
              <p class="subhead">Alle Felder sind erforderlich, sofern nicht anders angegeben.</p>
          ...
          <div class="row">
            <div class="col">
              ...
              <div class="form-group">
                <label for="doc_due_date" id="doc_due_date_label">Fälligkeitsdatum (optional)</label>
                <div class="sublabel">Falls diese Anfrage zeitkritisch ist oder mit einem Feature-Release zusammenhängt, geben Sie bitte ein Fälligkeitsdatum ein.</div>
              ...
              <div class="form-group">
                ...
                <label for="doc_email" id="doc_email_label">E-Mail-Adresse</label>
                <div class="input-group">
                  <input type="email" class="form-control email-input" id="doc_email" maxlength="80" name="Email" placeholder="z. B. vorname.nachname@braze.com" required="required" value="" />
                  <i class="fa-solid fa-envelope email-icon"></i>
                  </div>
              </div>
              <div class="form-group" id="doc_request_div">
                <label for="doc_request" id="doc_request_label">Zusammenfassung der Anfrage</label>
                <div class="sublabel">Dies ist der Name für Ihr Ticket</div>
                <input type="text" name="Request_Subject" id="doc_request" maxlength="180" required="required" value="" placeholder="Geben Sie Ihre Anfrage ein" class="form-control" />
              </div>

              <div class="form-group" id="doc_request_url">
                <label for="doc_request" id="doc_request_url_label">Braze-URL</label>
                <input type="url" name="Request_Url" id="doc_request_url" maxlength="180" required="required" value="" placeholder="z. B. {{ site.homeurl }}{{ site.baseurl }}/" class="form-control" />
              </div>
              ...
              Bitte warten Sie nach dem Absenden bis zu zehn Sekunden, bis Ihre Anfrage verarbeitet wird.
              </div>
              ...
              <div id="submit_text"> Anfrage senden </div></button>

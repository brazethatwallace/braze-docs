...
Predictive Purchases geben Marketern ein leistungsstarkes Tool zur Identifizierung und zum Messaging von Nutzer:innen auf der Grundlage ihrer Kaufwahrscheinlichkeit. Wenn Sie eine Kaufprognose erstellen, trainiert Braze ein Modell des maschinellen Lernens mit Hilfe von [gradientenverstärkten Entscheidungsbäumen](https://en.wikipedia.org/wiki/Gradient_boosting), um aus früheren Käufen zu lernen und zukünftige Käufe vorherzusagen. Besuchen Sie unser Dokument [Predictive Purchases]({{site.baseurl}}/user_guide/brazeai/predictive_suite/predictive_events/), um mehr zu erfahren.
...
### Hightouch – Automatisierung von Arbeitsabläufen {#hightouch-workflow-automation}

Die Integration von Braze und [Hightouch]({{site.baseurl}}/partners/data_and_analytics/reverse_etl/hightouch/) erlaubt es Ihnen, bessere Campaigns auf Braze mit aktuellen Kundendaten aus Ihrem Data Warehouse zu erstellen. Sie möchten Ihren Kund:innen relevante, zeitnahe Interaktionen bieten, und dies hängt in hohem Maße davon ab, dass die Daten in Ihrem Braze-Konto genau und aktuell sind. Durch die automatische Synchronisierung von Kundendaten aus Ihrem Data Warehouse mit Braze müssen Sie sich nicht mehr um die Datenkonsistenz kümmern und können sich auf den Aufbau erstklassiger Kundenerlebnisse konzentrieren.

### Transcend – Datenschutz & Compliance {#transcend-data-privacy-compliance}

Die Partnerschaft von Braze und [Transcend]({{site.baseurl}}/partners/ecommerce/payments/transcend/) hilft Nutzer:innen bei der Automatisierung von Datenschutzanfragen durch Orchestrierung von Daten in Dutzenden von Datensystemen. Letztendlich hilft dies den Teams bei der Einhaltung von Vorschriften wie DSGVO und CCPA und gibt dem Einzelnen die Kontrolle über seine Daten.

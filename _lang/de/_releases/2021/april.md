...
In diesem detaillierten Leitfaden erfahren Sie, wie Sie Push-Benachrichtigungen mit App-Erweiterungen nutzen können, um das Beste aus Ihren Nachrichten herauszuholen. Darin enthalten sind drei speziell von unserem Team entwickelte Anwendungsfälle (interaktiver Push, Push zur Datenerfassung und fortschrittsbasierter Push), begleitende Code-Snippets und eine Anleitung zur Protokollierung von Analytics. Lesen Sie den [Leitfaden zur fortgeschrittenen Implementierung von iOS Push]({{site.baseurl}}/developer_guide/push_notifications/examples/?sdktab=swift), um mehr zu erfahren.

...
Wenn Sie ein Banner erstellen, können Sie es jetzt [mit dem HTML-Editor]({{site.baseurl}}/user_guide/channels/banners/create_a_banner#compose-a-banner) aufbauen. Der HTML-Editor eignet sich am besten für Teams, die bereits eigene HTML-Templates pflegen oder die volle Kontrolle über Markup und Styling für Banner wünschen. Sie können benutzerdefiniertes HTML direkt in den Editor schreiben oder einfügen.

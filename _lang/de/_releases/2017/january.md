...
## Neue Konversions-Events für E-Mail-Nachrichten {#new-conversion-events-for-email-messages}

Sie können jetzt ein Konversions-Event für „geöffnete E-Mail aus einer Campaign“ oder „angeklickte E-Mail aus einer Campaign“ angeben. Erfahren Sie mehr über die [Arten der Zustellung von Campaigns]({{site.baseurl}}/user_guide/messaging/campaigns/schedule_your_campaign/).

## CSV-Export mit Kontrollgruppe {#csv-export-with-control-group}

...
## Neuer Retargeting-Filter {#new-retargeting-filter}

Wir haben einen neuen Filter „Von Canvas konvertiert“ hinzugefügt, um nahtlosere Retargeting-Optionen zu bieten. Erfahren Sie mehr über die Verwendung von [Retargeting-Filtern]({{site.baseurl}}/user_guide/messaging/campaigns/ideas_and_strategies/retargeting_campaigns/#retarget-campaigns).

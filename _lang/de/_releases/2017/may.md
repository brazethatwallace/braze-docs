...
Jetzt sehen Sie nur noch die für Sie relevanten Statistiken in einer Tabelle am unteren Rand Ihres Dashboards auf den Seiten zum Campaign-Targeting und zu Segment-Details. So können Sie besser erkennen und verfolgen, wer Ihre Campaigns erhält und wie sie abschneiden. Erfahren Sie mehr über [Targeting und Engagement-Berichte]({{site.baseurl}}/user_guide/analytics/reports/configure_reporting).

## Neue Kontingent-Warnungen für IP-Warming {#new-quota-alerts-for-ip-warming}

Wir haben jetzt eine Warnmeldung, die Sie darüber informiert, wenn Sie Ihr Kontingent in Abhängigkeit von Ihrem IP-Warming-Zeitplan erreicht haben, sodass Sie nie vom Kurs abkommen. Erfahren Sie mehr über [IP-Warming]({{site.baseurl}}/user_guide/channels/email/best_practices).

## Canvas-Daten in Engagement-Berichten {#canvas-data-in-engagement-reports}

Canvas- und Campaign-Daten können jetzt gemeinsam im Engagement-Bericht exportiert werden, was Ihre Datenanalyse vereinfacht. Erfahren Sie mehr über [Engagement-Berichte]({{site.baseurl}}/user_guide/data_and_analytics/reporting/engagement_reports#engagement-reports).
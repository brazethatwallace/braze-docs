...
{% alert tip %}
Weitere Informationen zu den auf dieser Seite aufgeführten Updates erhalten Sie von Ihrem Account Manager:in oder [öffnen Sie ein Support-Ticket]({{site.baseurl}}/user_guide/administer/personal/braze_support). In unseren [SDK or Software-Development-Kit Changelogs]({{site.baseurl}}/developer_guide/changelogs) finden Sie weitere Informationen über unsere monatlichen SDK or Software-Development-Kit-Versionen, Verbesserungen und grundlegenden Änderungen.
{% endalert %}
...
Die Cloud-Datenaufnahme (CDI) kann jetzt Data-Warehouse-Daten direkt mit BrazeAI Decisioning Studio synchronisieren – für Kund:innen, die beide Produkte nutzen. So können Sie Daten über Ihren Braze-Workspace hinaus für Reinforcement Learning und KI or künstliche Intelligenz-Entscheidungsfindung einbringen, ohne angepasste ETL or Extract, Transform, Load-Jobs erstellen zu müssen. Diese Early-Access-Version unterstützt Snowflake-Quellen; weitere Data-Warehouse-Quellen folgen in Kürze.
...
#### Operator kann Canvase erstellen und bearbeiten {#operator-can-create-and-edit-canvases}
...
- **Nachverfolgen, welche Kombination jede:r Nutzer:in erhalten hat:** Ein neuer Liquid-Tag und die Sichtbarkeit im Kundenprofil or Nutzerprofil ermöglichen es Ihnen, nachzuverfolgen, welche Variantenkombination jede:r Nutzer:in erhalten hat – von Anfang bis Ende.
...
Während des Early Access ist der Debugger für Content Cards, E-Mail, In-App-Nachrichten, Push, Kurzmitteilungsdienst or SMS/MMS/RCS, Webhooks und WhatsApp verfügbar.
...
- **Templates beim Erstellen von Campaigns und Canvase erstellen:** Erstellen Sie ein neues WhatsApp-Template direkt im Composer, anstatt nur bestehende Templates aus Content auszuwählen.
- **Karussell-Antwortnachrichten:** Erstellen Sie Karussell-Layouts als Antwortnachrichten, nicht nur als ausgehende Templates.
- **Neue Template-Typen: Utility und Flow:** Der Template Builder unterstützt Utility-Templates und Flow-Templates, auch wenn Sie Templates aus Campaigns, Canvase oder der eigenständigen Content-Templates-Erfahrung erstellen.
...
Der Block [Abos verwalten]({{site.baseurl}}/user_guide/messaging/landing_pages/manage_subscriptions) ermöglicht es Nutzer:innen, E-Mail-Abo-Gruppen auf einer Landing-Page einzusehen, sich anzumelden und zu Update or aktualisieren or aktualisieren.
...
#### Amazon Bedrock – KI or künstliche Intelligenz-Modellanbieter {#amazon-bedrock-ai-model-provider}

[Amazon Bedrock](https://aws.amazon.com/bedrock/) ist ein vollständig verwalteter AWS-Service, der über eine einheitliche API Zugang zu Foundation-Modellen führender KI or künstliche Intelligenz-Unternehmen bietet, sodass Marken generative KI or künstliche Intelligenz-Anwendungen auf AWS erstellen und skalieren können.
...
Die folgenden SDK or Software-Development-Kit-Updates wurden veröffentlicht. Weitere Details finden Sie in den [SDK or Software-Development-Kit Changelogs]({{site.baseurl}}/developer_guide/changelogs).

#### Grundlegende SDK or Software-Development-Kit-Updates {#sdk-breaking-updates}

Die neuesten SDK or Software-Development-Kit-Updates wurden veröffentlicht. Grundlegende Updates sind im Abschnitt SDK or Software-Development-Kit-Updates aufgeführt; alle anderen Updates finden Sie in den entsprechenden SDK or Software-Development-Kit Changelogs.

- Unity SDK or Software-Development-Kit 12.0.0
    - Aktualisiert die native iOS-Bridge [von Braze Swift SDK or Software-Development-Kit 14.1.0 auf 18.0.0](https://github.com/braze-inc/braze-swift-sdk/compare/14.1.0...18.0.0#diff-06572a96a58dc510037d5efa622f9bec8519bc1beab13c9f251e97e657a9d4ed).
    - Aktualisiert die native Android-Bridge [von Braze Android SDK or Software-Development-Kit 42.2.0 auf 43.0.0](https://github.com/braze-inc/braze-android-sdk/compare/v42.2.0...v43.0.0#diff-06572a96a58dc510037d5efa622f9bec8519bc1beab13c9f251e97e657a9d4ed).
- Flutter SDK or Software-Development-Kit 22.0.0
    - Aktualisiert die native Android-Bridge [von Braze Android SDK or Software-Development-Kit 42.3.1 auf 43.0.0](https://github.com/braze-inc/braze-android-sdk/compare/v42.3.1...v43.0.0#diff-06572a96a58dc510037d5efa622f9bec8519bc1beab13c9f251e97e657a9d4ed).
    - Aktualisiert die native iOS-Bridge [von Braze Swift SDK or Software-Development-Kit 17.0.0 auf 18.0.0](https://github.com/braze-inc/braze-swift-sdk/compare/17.0.0...18.0.0#diff-06572a96a58dc510037d5efa622f9bec8519bc1beab13c9f251e97e657a9d4ed).
- Swift SDK or Software-Development-Kit 18.0.0-18.1.0
    - Benennt `Braze.Ecommerce.ProductViewedEvent.typeIdentifiers` in `type` auf Swift- und Objective-C-API-Oberflächen um.
    Benennt Live-Activities-Push-to-Start-Update or aktualisieren-Events auf `Braze.LiveActivities.UpdateEvent.ActivityType` um, die bei Verwendung von `Braze.LiveActivities.subscribeToStateUpdates(_:)` ausgegeben werden:
        - `pushToStartOptedOut` in `pushToStartUnregistered`
        - `pushToStartOptOutFlushed` in `pushToStartUnregisterFlushed`

#### Zusammenfassung der neuesten SDK or Software-Development-Kit-Features und -Fixes {#summary-of-recent-sdk-features-and-fixes}

- **Swift SDK or Software-Development-Kit v18.1.0:** Fügt Push-Token / Textbaustein-Logout-Methoden hinzu, zusätzlich zur bestehenden Push-Logout-Methode, um weitere Logout-Anwendungsfälle zu unterstützen. Aktualisiert außerdem den E-Commerce-Event-Typ.
- **Flutter SDK or Software-Development-Kit v22.0.0:** Aktualisiert die native Bridge, um Funktionalität vom Android und Swift SDK or Software-Development-Kit zu übernehmen.
- **Unity SDK or Software-Development-Kit v12.0.0:** Aktualisiert die native Bridge, um Funktionalität vom Android und Swift SDK or Software-Development-Kit zu übernehmen.

Weitere Details finden Sie in den [SDK or Software-Development-Kit Changelogs]({{site.baseurl}}/developer_guide/changelogs).
{% enddetails %}
...
Das [Messaging-Diagnostics-Dashboard]({{site.baseurl}}/user_guide/analytics/dashboards/dashboard_builder/diagnostics_dashboard) bietet eine Aufschlüsselung der Ergebnisse des Nachrichtenversands auf hoher Ebene, mit der Sie Trends erkennen und potenzielle Probleme in Ihrer Messaging-Konfiguration diagnostizieren können. Dieses Dashboard kann Ihnen helfen zu verstehen, warum Nachrichten aus Ihren Campaigns oder Canvase möglicherweise nicht wie erwartet gesendet wurden. Wenden Sie sich an Ihren CSM or Customer-Success-Manager or Customer-Success-Manager:in, um Zugang zu diesem Feature zu erhalten.

#### CSV-Mapper für angepasste Events {#csv-custom-events-mapper}

{% multi_lang_include release_type.md release="General availability" %}

Der [CSV-Import-Flow]({{site.baseurl}}/user_guide/audience/manage_audience/import_users/csv_import#about-csv-import) für angepasste Events enthält jetzt einen Mapper, mit dem Sie Event-Namen und Event-Eigenschafts-Header vor dem Import Braze-Feldern zuordnen können. Dieses Update or aktualisieren bringt das Erlebnis für angepasste Events in Einklang mit dem Flow für angepasste Attribute und reduziert die Notwendigkeit, Dateien vor dem Upload umzuformatieren. Der Flow umfasst das Hochladen einer CSV, das Zuordnen erforderlicher Felder und Events, das Zuordnen von Event-Eigenschaften und die Auswahl von Targeting-Präferenzen vor dem Import. Wenn Ihre Datei bereits dem erwarteten Format entspricht, können Sie den Flow ohne Zuordnungsänderungen durchlaufen.
...
#### Operator kann jetzt Einstellungsseiten für Sie Update or aktualisieren or aktualisieren {#operator-can-now-update-settings-pages-for-you}
...
#### Shopify Self-Service-SDK or Software-Development-Kit-Versions-Upgrade or upgraden {#shopify-self-serve-sdk-version-upgrade}

{% multi_lang_include release_type.md release="General availability" %}

Neue [Shopify]({{site.baseurl}}/partners/ecommerce/shopify)-Kund:innen werden während der Einrichtung mit den neuesten Braze Web SDK or Software-Development-Kit- und JavaScript SDK or Software-Development-Kit-Versionen bereitgestellt. Bestehende Kund:innen können ihre aktuelle SDK or Software-Development-Kit-Version in den Integrationseinstellungen einsehen, werden benachrichtigt, wenn eine neuere Version verfügbar ist, und können Upgrades selbstständig über die Integrationseinstellungen durchführen.
...
- Kurzmitteilungsdienst or SMS, MMS und RCS
- WhatsApp
- Push
- Content Cards
- LINE
...
Sie können Push-Zugangsdaten jetzt programmatisch mit dem [Endpunkt zur Aktualisierung von Push-Zugangsdaten]({{site.baseurl}}/api/endpoints/apps/post_update_push_credential) Update or aktualisieren or aktualisieren. Jede Anfrage aktualisiert eine App und eine Plattform (`apple`, `firebase`, `huawei` oder `kindle`) und akzeptiert Zugangsdaten-Payloads als Base64-kodierte Werte. Dies hilft Teams, große App-Portfolios und Richtlinien zur Rotation von Zugangsdaten zu verwalten, ohne auf manuelle Dashboard-Uploads angewiesen zu sein.
...
[Stayfilm](https://www.stayfilm.com/) ist eine Representational State Transfer API für automatisierte, personalisierte Videoproduktion im großen Maßstab. Die Plattform integriert Daten, Bilder, Text, Soundtracks, Narration und visuelle Effekte, um angepasste Videoinhalte für E-Commerce, Marktplätze, CRM or Customer-Relationship-Management [-System] (CRM)-Workflows und Marketingkampagnen zu generieren.

#### Validity – Daten und Analytics {#validity-data-and-analytics}

[Validity Everest](https://www.validity.com/everest/) ist eine E-Mail-Zustellbarkeitsplattform, die Ihnen hilft, die Posteingangsplatzierung zu messen und Ihre Sende-Reputation zu schützen. Die Integration von Braze und Validity synchronisiert Ihre Everest-Seed-Liste mit Braze, seedet automatisch qualifizierende Campaigns und Canvase und zieht Engagement-Metriken zurück in Validity Inbox, sodass Sie die seed-basierte Platzierung mit dem realen Abonnenten-Engagement vergleichen können.

### SDK or Software-Development-Kit

Die folgenden SDK or Software-Development-Kit-Updates wurden veröffentlicht. Weitere Details finden Sie in den [SDK or Software-Development-Kit Changelogs]({{site.baseurl}}/developer_guide/changelogs).

#### Grundlegende SDK or Software-Development-Kit-Updates

Die neuesten SDK or Software-Development-Kit-Updates wurden veröffentlicht. Grundlegende Updates sind im Abschnitt SDK or Software-Development-Kit-Updates aufgeführt; alle anderen Updates finden Sie in den entsprechenden SDK or Software-Development-Kit Changelogs.

- [Android SDK or Software-Development-Kit 43.0.0](https://github.com/braze-inc/braze-android-sdk/releases/tag/v43.0.0)
...
- [Swift SDK or Software-Development-Kit 17.0.0](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md)
    - Fügt zusätzliche Felder zu E-Commerce-Events hinzu.
    ...
    - Entfernt die veraltete Push-to-Start-Update or aktualisieren-API auf `Braze.LiveActivities`.
- [Web SDK or Software-Development-Kit 6.10.1](https://github.com/braze-inc/braze-web-sdk/blob/master/CHANGELOG.md)
    - Fügt `unregisterPush`- und Logout-Methoden hinzu.
    - Fügt zusätzliche Felder zu E-Commerce-Events hinzu.
...
- [Flutter SDK or Software-Development-Kit 21.0.0](https://github.com/braze-inc/braze-flutter-sdk/releases/tag/v21.0.0)
...
- [Expo SDK or Software-Development-Kit 5.2.0](https://github.com/braze-inc/braze-expo-plugin/releases/tag/v5.2.0)
    - Aktualisiert die Beispiel-App auf Expo SDK or Software-Development-Kit 56.
- [React Native SDK or Software-Development-Kit 22.0.0](https://www.npmjs.com/package/@braze/react-native-sdk/v/22.0.0)
...
Die eigenständigen BrazeAI-Assistenten, die im gesamten Dashboard zu finden sind, werden in [BrazeAI Operator]({{site.baseurl}}/user_guide/brazeai/operator) vereinheitlicht, wodurch Operator als einziger KI or künstliche Intelligenz-Assistent für marketer-orientierte generative KI or künstliche Intelligenz-Unterstützung im gesamten Dashboard etabliert wird. Die folgenden Assistenten werden jetzt über Operator geleitet:
...
Nachdem Ihr Canvas gestartet wurde, können Sie jetzt [einen Content-Optimizer-Schritt Update or aktualisieren or aktualisieren]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/content_optimizer_step#edit-a-launched-step), um:
...
[Convercus]({{site.baseurl}}/partners/data_and_analytics/loyalty/convercus) ist eine SaaS or Software-as-a-Service-Plattform für Kundenbindung und Gutscheine, die Marken und Einzelhändlern hilft, die Kundenfrequenz, den Warenkorbwert und die Wiederkaufraten durch Omnichannel-Kundenbindungsprogramme und personalisierte Gutscheinkampagnen zu steigern.

#### Copy Pastd – Nachrichtenorchestrierung – Templates {#copy-pastd-message-orchestration-templates}

[Copy Pastd]({{site.baseurl}}/partners/copy_pastd) Building Blocks ist ein Drag-and-Drop-E-Mail-Builder, der Liquid-gestützte Content Blocks und vollständige Templates direkt in Ihren Braze-Workspace pusht. Einmal gestalten, mit Braze synchronisieren und dieselben Komponenten über Campaigns, Canvase und getriggerte Flows hinweg wiederverwenden, ohne jedes Mal HTML neu erstellen zu müssen.

#### Databricks Mosaic – KI or künstliche Intelligenz-Modellanbieter {#databricks-mosaic-ai-model-providers}

[Databricks Mosaic]({{site.baseurl}}/partners/ai_model_providers/databricks_mosaic) ist die einheitliche Plattform von Databricks zum Erstellen, Bereitstellen und Verwalten von KI or künstliche Intelligenz- und Machine-Learning-Modellen im großen Maßstab auf der Databricks Data Intelligence Platform.

#### DinMo – Daten und Analytics – Reverse ETL or Extract, Transform, Load {#dinmo-data-and-analytics-reverse-etl}

[DinMo]({{site.baseurl}}/partners/dinmo) ist eine Composable Customer Data Platform (Customer Data Platform (CDP)), die Ihr Cloud Data Warehouse über Reverse ETL or Extract, Transform, Load or Extract, Transform, Load (ETL or Extract, Transform, Load) mit Braze verbindet. Marketing-Teams können Zielgruppensegmente aus Warehouse-Daten erstellen, Nutzerattribute und Events in Braze synchronisieren und Abo-Status aktuell halten – ohne CSV-Uploads oder Engineering-Support.

#### EmailShepherd – Nachrichtenorchestrierung – Templates {#emailshepherd-message-orchestration-templates}

[EmailShepherd]({{site.baseurl}}/partners/emailshepherd) ist eine agentische E-Mail-Erstellungsplattform, die auf Ihrem E-Mail-Design-System basiert und es Ihrem gesamten Marketing-Team – und KI or künstliche Intelligenz-Agenten – ermöglicht, markengerechte, produktionsreife E-Mails ohne Engpässe zu erstellen. Die Braze-Integration veröffentlicht genehmigte E-Mails direkt in Ihrem Braze-Workspace, sodass Marketer die E-Mail-Produktion in Braze skalieren können, ohne die Markenkonsistenz zu opfern.
...
{% multi_lang_include releases/SDK or Software-Development-Kit/2026_6_25_26_updates.md %}
...
Das [Push-Performance-Dashboard]({{site.baseurl}}/user_guide/analytics/dashboards/channel_performance?tab=push%20performance#push-performance-dashboard) bietet Ihnen eine einzige, kanalübergreifende Ansicht des Push-Engagements, einschließlich Sendungen, Bounces, Zustellungen sowie direkter, beeinflusster und gesamter Öffnungsraten über ein konfigurierbares Zeitfenster. Nutzen Sie es, um den allgemeinen Zustand Ihres Push-Kanals zu verstehen, ohne Daten aus einzelnen Campaigns oder Canvase zusammenfassen zu müssen.
...
Der [Berichts-Builder]({{site.baseurl}}/report_builder) unterstützt Banner als Kanal und RCS als Unterkategorie unter Kurzmitteilungsdienst or SMS, sodass Sie die Performance für beide direkt in Ihren angepassten Berichten neben jedem anderen Braze-Kanal messen können.

#### Event-Aktionen für `ecommerce.cart_updated` {#ecommercecart_updated-event-actions}

Das [`ecommerce.cart_updated`-Event]({{site.baseurl}}/user_guide/data/activation/events/recommended_events/?tab=ecommerce.cart_updated#code-examples) unterstützt die Aktionen `add` und `remove` neben `replace`, sodass Sie inkrementelle Warenkorbänderungen senden können, anstatt bei jedem Update or aktualisieren einen vollständigen Warenkorb-Snapshot zu senden.

### BrazeAI<sup>TM</sup>

#### Content Optimizer für Kurzmitteilungsdienst or SMS-, MMS- und RCS-Nachrichten {#content-optimizer-for-sms-mms-and-rcs-messages}

{% multi_lang_include release_type.md release="Beta" %}

Sie können den [Content Optimizer]({{site.baseurl}}/user_guide/brazeai/content_optimizer) verwenden, um Hooks, Textkörper und CTAs für Kurzmitteilungsdienst or SMS-, MMS- und RCS-Nachrichten zu optimieren. Content Optimizer hilft Ihnen, Nachrichteninhalte im großen Maßstab zu testen und zu optimieren, indem er KI or künstliche Intelligenz nutzt, um automatisch große Mengen an Inhaltsvarianten zu generieren und zu bewerten.
...
{% multi_lang_include releases/SDK or Software-Development-Kit/2026_5_28_26_updates.md %}
...
Sie können jetzt ein individuelles Kundenprofil or Nutzerprofil über **Import Users** erstellen, indem Sie **Quick User Add** auswählen und eine E-Mail-Adresse oder externe ID eingeben.
...
#### Null-Kopie-CDI-Synchronisierungen für Canvas-Trigger or triggern {#zero-copy-cdi-syncs-for-canvas-triggers}

{% multi_lang_include release_type.md release="General availability" %}

CDI unterstützt jetzt den Datentyp `Canvas triggers` für die Null-Kopie-Personalisierung. Sie können Canvase aus Warehouse- oder S3-Daten Trigger or triggern or triggern und Kontextfelder übergeben, ohne diese Felder auf Braze-Nutzerprofilen persistent zu speichern.
...
Der [Schritt „An Ziel senden“]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/send_to_destination) ermöglicht es Ihnen, Nutzer:innen von einem Canvas in ein anderes zu senden. Wenn Sie beispielsweise zwei Canvase haben, die Messaging für Werbeangebote teilen, können Sie „An Ziel senden“ verwenden, um diese Canvase zu verbinden.
...
Der [WhatsApp Template Builder]({{site.baseurl}}/user_guide/channels/whatsapp/message_features_and_optimization) ermöglicht es Ihnen, WhatsApp-Nachrichten-Templates direkt in Braze zu erstellen und einzureichen – ohne zwischen Braze und dem Meta Business Manager:in wechseln zu müssen. Nachdem Meta Ihr Template genehmigt hat, können Sie es in beliebig vielen Campaigns und Canvase verwenden.
...
[GRAVTY®](https://www.lji.io/) ist eine Enterprise-Kundenbindungsplattform von Loyalty Juggernaut Inc. (LJI), die es Marken in den Bereichen Einzelhandel, Reisen, Gastronomie (einschließlich Schnellrestaurants) und Finanzdienstleistungen ermöglicht, Programme der nächsten Generation zu entwerfen, zu verwalten und zu skalieren – und so messbares Wachstum bei Engagement, Bindung und Customer LTV or Lifetime-Value or Lifetime-Value durch personalisierte, datengestützte Erlebnisse zu erzielen.
...
Die Currents-Mixpanel-Integration unterstützt jetzt die EU- und Indien-Rechenzentren von Mixpanel. Wenn Sie eine Mixpanel-Integration konfigurieren, können Sie auswählen, an welche Mixpanel-Region Braze Ihre Daten sendet. Dieses Update or aktualisieren unterstützt die wachsende internationale Präsenz von Mixpanel für gemeinsame Kund:innen. Weitere Informationen finden Sie unter [Mixpanel]({{site.baseurl}}/partners/data_and_analytics/analytics/mixpanel).
...
[Denada]({{site.baseurl}}/partners/denada) ist eine KI or künstliche Intelligenz-gestützte Marketing-Kreativplattform, die es Fachexperten ermöglicht, markengerechte Marketingmaterialien durch natürliche Konversation zu erstellen. Mit Denada können Teams von der Ideenfindung bis zum fertigen E-Mail-Inhalt gelangen, ohne Design-Expertise zu benötigen.
...
Das [Messaging-Diagnose-Dashboard]({{site.baseurl}}/user_guide/analytics/dashboards/dashboard_builder/diagnostics_dashboard) bietet eine Aufschlüsselung der Ergebnisse des Nachrichtenversands auf hoher Ebene, mit der Sie Trends erkennen und potenzielle Probleme in Ihrer Messaging-Konfiguration diagnostizieren können. Dieses Dashboard kann Ihnen helfen zu verstehen, warum Nachrichten aus Ihren Campaigns oder Canvase möglicherweise nicht wie erwartet gesendet wurden.
...
[Anthropic]({{site.baseurl}}/partners/ai_model_providers/anthropic) ist ein KI or künstliche Intelligenz-Sicherheits- und Forschungsunternehmen, das Claude entwickelt, einen KI or künstliche Intelligenz-Assistenten der nächsten Generation, der hilfreich, ehrlich und sicher für eine Vielzahl von Sprachaufgaben konzipiert ist.
...
[Open Loyalty]({{site.baseurl}}/partners/data_and_analytics/loyalty/openloyalty) ist eine cloudbasierte Plattform für Kundenbindungsprogramme, mit der Sie Kundenbindungs- und Rewards-Programme erstellen und verwalten können. Die Integration von Braze und Open Loyalty synchronisiert Loyalitätsdaten – wie Punktestand, Tier-Änderungen und Ablaufwarnungen – direkt in Echtzeit mit Braze. Damit können Sie personalisierte Nachrichten (E-Mail, Push, Kurzmitteilungsdienst or SMS) Trigger or triggern or triggern, wenn sich der Treuestatus eines Nutzers bzw. einer Nutzerin ändert.

#### OpenAI – KI or künstliche Intelligenz-Modellanbieter {#openai-ai-model-provider}

[OpenAI]({{site.baseurl}}/partners/ai_model_providers/openai) entwickelt fortschrittliche KI or künstliche Intelligenz-Modelle wie GPT, die natürliches Sprachverständnis und -generierung ermöglichen und Marken befähigen, bedeutungsvolle Kundeninteraktionen aufzubauen und zu skalieren.
...
Mit der [Braze Audience Sync zu LinkedIn]({{site.baseurl}}/partners/canvas_audience_sync/linkedin_audience_sync) können Sie Nutzerdaten aus Ihrer Braze-Integration zu LinkedIn-Kundenlisten hinzufügen, um Anzeigen basierend auf Verhaltenstriggern, Segmentierung und mehr zuzustellen. Alle Kriterien, die Sie normalerweise zum Trigger or triggern or triggern einer Nachricht (z. B. Push, E-Mail, Kurzmitteilungsdienst or SMS und Webhook) in einem Braze-Canvas basierend auf Ihren Nutzerdaten verwenden, können jetzt eine Anzeige an diesen Nutzer bzw. diese Nutzerin in Ihren LinkedIn-Kundenlisten Trigger or triggern or triggern.
...
Die folgenden SDK or Software-Development-Kit-Updates wurden veröffentlicht. Swift SDK or Software-Development-Kit v14.0.1 behebt ein Problem mit der Handhabung von universellen Links. Android SDK or Software-Development-Kit v40.2.0 behebt ein potenzielles Speicherleck und behebt ein Problem mit mehreren geöffneten Sitzungen, wenn transparente Aktivitäten vorhanden sind. Expo SDK or Software-Development-Kit v3.2.0 fügt die Option `forwardUniversalLinks` hinzu (Standard: false), um die native Swift SDK or Software-Development-Kit-Handhabung von universellen Links zu konfigurieren.

#### Grundlegende SDK or Software-Development-Kit-Updates

Die neuesten SDK or Software-Development-Kit-Updates wurden veröffentlicht. Grundlegende Updates sind im Abschnitt SDK or Software-Development-Kit-Updates aufgeführt; alle anderen Updates finden Sie in den entsprechenden SDK or Software-Development-Kit Changelogs.

{% multi_lang_include releases/SDK or Software-Development-Kit/2026_2_5_26_updates.md %}

...
### 1. Schritt: Erstellen Sie ein Nexla-Konto {#step-1-create-a-nexla-account}
...
### 2. Schritt: Fügen Sie Ihre Quelle hinzu {#step-2-add-your-source}
...
### 3. Schritt: Transformieren (optional) {#step-3-transform-optional}

...
| Currents oder Snowflake Data Sharing | Currents oder Snowflake Data Sharing ist erforderlich, damit Eppo die Daten der Experimente analysieren kann. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="Voraussetzungen" }

## Integration

### 1. Schritt: Konfigurieren Sie Currents oder Snowflake Data Sharing in Braze {#step-1-configure-currents-or-snowflake-data-sharing-in-braze}
...
### 2. Schritt: Richten Sie Ihr Experiment in einer Braze-Kampagne oder einem Canvas ein {#step-2-set-up-your-experiment-in-a-braze-campaign-or-canvas}

Sie können in Ihren Campaigns und Canvases native Features für A/B-Tests verwenden. Mehr dazu erfahren Sie unter [Multivariate und A/B-Tests](https://www.braze.com/docs/user_guide/engagement_tools/testing/multivariant_testing#what-are-multivariate-and-ab-testing).

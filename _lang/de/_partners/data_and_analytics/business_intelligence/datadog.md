...
Die Integration von Braze und Datadog ermöglicht es Kund:innen, Braze-Daten in Datadog zu erfassen und Warnmeldungen zu den gesendeten Daten zu erstellen. Sie können beispielsweise eine Überwachung und einen Alarm einrichten, wenn Ihre wöchentliche Newsletter-Kampagne ein ungewöhnlich niedriges Nachrichtenvolumen versendet oder wenn ein Canvas-Schritt, der normalerweise nur wenige Nachrichten pro Tag versendet, plötzlich Tausende versendet.
...
### 1. Schritt: Datadog-Schlüssel generieren {#step-1-generate-datadog-key}
...
### 2. Schritt: Schlüssel zu Braze hinzufügen {#step-2-add-key-to-braze}

...
#### Schritt 2: Looker Develop einrichten {#step-2-set-up-looker-develop}
...
#### Schritt 3: Nutzerattribute in Tags festlegen {#step-3-set-user-attributes-in-tags}
...
#### Schritt 4: Looker-Aktion senden {#step-4-send-the-looker-action}

1. Klicken Sie innerhalb eines Looks, für den eine Dimension `braze_id` ausgewählt ist, auf das Einstellungsrad (<i class="fas fa-cog"></i>) in der Symbolleiste und wählen Sie **Send...**.
...
5. Wählen Sie unter **Advanced Options** die Option **Results in Table** oder **All Results** und dann **Send**.<br><br>![Looker-Sendedialog mit ausgewählter Braze-Aktion und erweiterten Optionen.]({% image_buster /assets/img/send-looker-action.png %})<br><br>Wenn der Export korrekt gesendet wurde, sollte `LOOKER_EXPORT` im Profil der Nutzer:innen als angepasstes Attribut mit dem Wert erscheinen, den Sie in der Aktion eingegeben haben.<br><br>![Braze-Nutzerprofil mit dem angepassten Attributwert LOOKER_EXPORT.]({% image_buster /assets/img/custom-attributes-looker.png %})

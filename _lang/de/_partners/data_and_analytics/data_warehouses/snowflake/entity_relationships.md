---
nav_title: "Entitätsbeziehungen"
article_title: Entitätsbeziehungen für Snowflake und Braze
page_order: 10
search_tag: Partner
---

# Entitätsbeziehungen für Snowflake und Braze {#entity-relationships-for-snowflake-and-braze}

> Dies ist die Liste der Entitätsbeziehungen zwischen Snowflake und Braze für jeden Messaging-Kanal.

{% alert important %}
Die Entitätsbeziehungsdiagramme heben gemeinsame Felder und Beziehungen zwischen Tabellen hervor und stellen keine vollständigen Tabellenschemata dar. Eine vollständige Liste der Felder finden Sie in den [einzelnen Tabellenschemata](/docs/assets/download_file/data-sharing-raw-table-schemas.txt).
{% endalert %}

{% sdktabs %}
{% sdktab Content Cards %}
## Beziehungsdiagramm {#relationship-diagram}

...
Navigieren Sie in Braze zu **Partnerintegrationen** > **Technologie-Partner** und wählen Sie **Kubit** aus. Hier finden Sie den REST-Endpunkt und können Ihren Datenimport-Schlüssel für Braze generieren.
...
Geben Sie den Datenimport-Schlüssel und den Braze-REST-Endpunkt an Ihren Kubit-Supportkontakt weiter. Dieser wird die Integration auf seiner Seite konfigurieren und Sie informieren, sobald die Integration aktiv ist.
...
Sobald Sie Ihre Kohorte gespeichert haben, können Sie sie nach Braze importieren, um sie in Braze-Segmenten zu verwenden. Diese Segmente können dann zur Erstellung gezielter E-Mail- oder Push-Campaigns und Canvases verwendet werden.
...
Nachdem Sie Kohorten nach Braze importiert haben, können Sie diese als Filter verwenden, um Braze-Segmente zu erstellen und sie in Braze-Campaigns oder Canvases einzubinden. Besuchen Sie unsere Dokumentation zu Segmenten, um mehr darüber zu erfahren, [wie Sie Braze-Segmente erstellen]({{site.baseurl}}/user_guide/engagement_tools/segments/creating_a_segment#step-4-add-filters-to-your-segment).

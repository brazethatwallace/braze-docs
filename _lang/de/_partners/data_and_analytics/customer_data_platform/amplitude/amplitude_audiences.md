...
![Amplitude Audiences Syncs-Seite mit ausgewähltem „Create Sync“.]({% image_buster /assets/img/amplitude11.png %})
...
![Amplitude-Sync-Einrichtungsschritt zur Auswahl einer Nutzereigenschaft für die Synchronisierung.]({% image_buster /assets/img/amplitude7.png %})

Wählen Sie als Nächstes ein Ziel aus, mit dem Sie Ihre Nutzereigenschaft synchronisieren möchten.

![Amplitude-Zielauswahl für die Synchronisierung von Eigenschaften mit Braze.]({% image_buster /assets/img/amplitude8.png %})
...
![Amplitude-Sync-Einrichtungsschritt zur Auswahl einer Berechnung für die Synchronisierung.]({% image_buster /assets/img/amplitude10.png %})

Wählen Sie als Nächstes ein Ziel aus, mit dem Sie Ihre Berechnung synchronisieren möchten.

![Amplitude-Zielauswahl für die Synchronisierung von Berechnungen mit Braze.]({% image_buster /assets/img/amplitude8.png %})

...
2. **Braze Append**-Modus: Aktualisiert ein Nutzerprofil, wenn diese Nutzer:in bereits in Braze existiert.
...
### 1. Schritt: Templates einrichten {#step-1-set-up-templates}
...
### 2. Schritt: Ausgehende Kanäle erstellen {#step-2-create-outbound-channels}
...
### 3. Schritt: Kanäle konfigurieren {#step-3-configure-the-channels}
...
### 4. Schritt: Braze-Komponenten in Redpoint Data Management einrichten {#step-4-set-up-braze-components-in-redpoint-data-management}

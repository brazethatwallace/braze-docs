...
![Lexer-Integrationsbildschirm mit Feldern für API-URL, API-Schlüssel, AWS-S3-Bucket-Details und Braze-Export-Segment-ID.]({% image_buster /assets/img/lexer/braze_integrate_screen.png %})
...
### Schritt 1: Aktivierung erstellen {#step-1-create-activation}
...
![Lexer-Activate-Workflow mit Auswahl des Aktivierungskanals, Zielgruppenerstellung und Aktivierungsdetails vor dem Senden einer Zielgruppe an Braze.]({% image_buster /assets/img/lexer/lexer.png %})

### Schritt 2: Aktivierung überprüfen {#step-2-verify-activation}
...
### Schritt 3: Erstellen Sie Ihr Braze-Segment {#step-3-create-your-braze-segment}

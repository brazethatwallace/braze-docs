...
{% alert note %}
Für die Aktion **Braze Send Event** müssen nur ein **Event-Name** und ein **Event-Zeitpunkt** angegeben werden, aber Sie sollten so viele Informationen wie möglich in das Feld für angepasste Eigenschaften eingeben. Weitere Details finden Sie unter [Event-Objekt]({{site.baseurl}}/api/objects_filters/event_object/).
{% endalert %}

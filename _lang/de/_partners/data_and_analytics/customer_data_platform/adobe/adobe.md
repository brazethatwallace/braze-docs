...
1. Wählen Sie im Schritt „Abbildung“ die Option **Add new mapping**.<br>![]({% image_buster /assets/img/adobe/braze-destination-mapping.png %}){: style="max-width:50%;"}<br><br>
...
3. Wählen Sie in dem Fenster die Adobe-Attribute aus, die Sie Ihren Braze-Attributen zuordnen möchten. <br>![]({% image_buster /assets/img/adobe/braze-destination-mapping-attributes.png %}){: style="max-width:70%;"}<br><br>Wählen Sie dann den Identitäts-Namensraum aus. Mit dieser Option können Sie einen Namensraum für die Plattformidentität auf einen Braze-Namensraum abbilden.<br>![]({% image_buster /assets/img/adobe/braze-destination-mapping-namespaces.png %}){: style="max-width:80%;"}<br> Wählen Sie Ihre Quellfelder aus und wählen Sie dann **Select**.<br><br>

...
Um Nutzer:innen-Attribute von Justuno mit Braze zu synchronisieren, müssen Sie diese Attribute in Braze erstellen, falls Sie dies nicht bereits getan haben. Gehen Sie dazu zu **Dateneinstellungen** > **Angepasste Attribute** und erstellen Sie dann Ihre angepassten Attribute. Eine vollständige Anleitung finden Sie unter [Angepasste Attribute in Braze verwalten]({{site.baseurl}}/user_guide/data/activation/attributes/custom_attributes/).
...
1. Gehen Sie zu **Zielgruppe** > **Abonnements**.

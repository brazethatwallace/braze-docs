...
### 1. Schritt: Erstellen Sie eine Lead-Ads-Campaign mit einem Sofortformular {#step-1-create-a-lead-ads-campaign-with-an-instant-form}
...
### 2. Schritt: Verbinden Sie Ihr Facebook-Konto mit Zapier {#step-2-connect-your-facebook-account-to-zapier}
...
Gehen Sie in Ihrem Facebook Business Manager im linken Menü auf **Integrations** > **Leads Access**. Wählen Sie Ihre Facebook-Seite aus und klicken Sie dann auf **CRMs**. Auf dem Tab „CRM“ wählen Sie **Assign CRMs** und fügen **Zapier** hinzu.
...
### 3. Schritt: Erstellen Sie Ihren Zap {#step-3-create-your-zap}
...
### 4. Schritt: Testen Sie Ihren Facebook-Lead-Ads-Zap {#step-4-test-your-facebook-lead-ads-zap}

...
| Braze-REST-API-Schlüssel für E-Mail-Templates | Ein API-Schlüssel mit den Berechtigungen `templates.email.create`, `templates.email.update` und `templates.email.list`.<br><br>Erstellen Sie den Schlüssel im Braze-Dashboard unter **Settings** > **API Keys**. |
| Braze-REST-API-Schlüssel für Content Blocks | Ein API-Schlüssel mit den Berechtigungen `content_blocks.create`, `content_blocks.update`, `content_blocks.info` und `content_blocks.list`.<br><br>Erstellen Sie den Schlüssel im Braze-Dashboard unter **Settings** > **API Keys**. |
...
### 1. Schritt: Building Blocks mit Braze verbinden {#step-1-connect-building-blocks-to-braze}
...
### 2. Schritt: Ihre Bibliothek mit Braze synchronisieren {#step-2-sync-your-library-to-braze}
...
### 1. Schritt: Ihr Stylesheet einrichten {#step-1-set-up-your-stylesheet}
...
### 2. Schritt: Connected-Content-Endpunkte aktivieren (optional) {#step-2-enable-connected-content-endpoints-optional}
...
### 3. Schritt: An Braze-Kataloge binden (optional) {#step-3-bind-to-braze-catalogs-optional}
...
### 4. Schritt: Ihre angepassten Braze-Attribute hinzufügen (optional) {#step-4-add-your-braze-custom-attributes-optional}
...
### 1. Schritt: Ein Template an Braze übertragen {#step-1-push-a-template-to-braze}

1. Öffnen Sie eine beliebige E-Mail im Building-Blocks-Builder.
2. Wählen Sie **Push to Braze** (oben rechts).
...
### 2. Schritt: Das Template in einer Campaign oder einem Canvas verwenden {#step-2-use-the-template-in-a-campaign-or-canvas}
...
### 3. Schritt: Content zentral aktualisieren {#step-3-update-content-centrally}
...
### 4. Schritt: Content-Pools erstellen {#step-4-build-content-pools}
...
### 5. Schritt: Smart-Blöcke verwenden, um Pool-Content in Ihren E-Mails zu rendern {#step-5-use-smart-blocks-to-render-pool-content-in-your-emails}

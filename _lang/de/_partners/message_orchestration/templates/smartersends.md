...
1. Gehen Sie in Braze zu **Settings** > **API Keys** und klicken Sie auf **Create New API Key**.
...
5. Klicken Sie auf **Save API Key**.
6. Kopieren Sie den API-Schlüssel mit den entsprechenden Berechtigungen und fügen Sie ihn in die Einstellungen des **Braze Email Service Provider** in SmarterSends ein.

### 2. Schritt: Eine Anwendungs-ID erstellen oder kopieren {#step-2-create-or-copy-an-application-id}

1. Gehen Sie in Ihrem Braze Workspace zu **Settings** > **App Settings**.

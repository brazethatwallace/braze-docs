...
Wählen Sie den erstellten Frame aus und fügen Sie Komponenten (Header, Content-Blöcke, CTAs und Footer) aus der **Assets**-Bibliothek des Plugins hinzu, um Ihre E-Mail zu strukturieren.

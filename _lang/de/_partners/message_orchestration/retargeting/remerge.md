...
| IDFA-Erfassung im Braze SDK or Software-Development-Kit aktivieren | Die IDFA-Erfassung ist im Braze SDK or Software-Development-Kit optional und standardmäßig deaktiviert. |
...
Um ein Remerge-Webhook-Template für zukünftige Campaigns oder Canvase zu erstellen, navigieren Sie in der Braze-Plattform zu **Content** > **Webhook**. Wählen Sie dann **Create webhook template** aus.

...
Um ein Jampp-Webhook-Template zu erstellen, das Sie in zukünftigen Campaigns oder Canvases verwenden können, navigieren Sie im Braze-Dashboard zu **Inhalt** > **Webhook**. Wählen Sie dann **Webhook-Template erstellen** aus.

...
| Shopify-Shop-Inhaber:in oder Mitarbeiter:innen-Berechtigungen | {::nomarkdown}<ul><li>Zugriff auf alle Einstellungen unter <b>Allgemein</b> und <b>Online Store</b>.</li><li> Zusätzliche Administrator-Berechtigungen:</li><ul><li>Bestellungen anzeigen</li><li>Kund:innen: Lesen/Schreiben</li><li>Kundenereignisse anzeigen (Web Pixels)</li><li>Einstellungen verwalten</li><li>Von Mitarbeiter:innen/Mitarbeitenden entwickelte Apps anzeigen</li><li>Apps und Kanäle verwalten/installieren</li><li>Angepasste Pixels verwalten/hinzufügen</li></ul></ul>{:/} |
...
1. Gehen Sie in Braze zu **Partnerintegrationen** > **Currents** > **+ Neu erstellen** > **Shopify Export**.
2. Geben Sie einen Integrationsnamen und eine Kontakt-E-Mail-Adresse an.
3. Wählen Sie im Abschnitt **Zugangsdaten** den Shopify-Shop aus, den Sie in [Schritt 1](#step-1-set-up-your-shopify-store) eingerichtet haben.

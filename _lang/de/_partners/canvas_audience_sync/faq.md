...
| Fehler | Grund | Lösung |
| --- | --- | --- |
| Ungültiges Token | Dies kann auftreten, wenn Sie Ihr Passwort für die Anmeldung bei einem bestimmten Anzeigennetzwerk geändert haben oder wenn Ihre Zugangsdaten abgelaufen sind. | Gehen Sie auf die jeweilige Partnerseite, um Ihr Konto zu trennen und wieder zu verbinden. |

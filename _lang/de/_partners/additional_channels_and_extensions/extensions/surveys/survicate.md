...
{: start="3"}
3. Richten Sie in Ihrer Braze-Kampagne die Schritte **Target** und **Assign** ein. Wenn Sie fertig sind, ist Ihre Kampagne startbereit. Im Schritt **Review** können Sie sehen, wie die Kampagne aussieht. Die Umfrage erscheint auf Ihrer Website an der Stelle, die im Survicate-Panel angegeben ist, wie in Schritt 1 beschrieben.

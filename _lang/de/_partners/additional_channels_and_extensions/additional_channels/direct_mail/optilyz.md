...
Um ein optilyz-Webhook-Template zu erstellen, das Sie in zukünftigen Campaigns oder Canvases verwenden können, navigieren Sie in der Braze-Plattform zu **Inhalt** > **Webhook**. Wählen Sie dann **Webhook-Template erstellen** aus.

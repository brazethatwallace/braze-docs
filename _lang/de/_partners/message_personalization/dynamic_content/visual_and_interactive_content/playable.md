...
Die Integration von Braze und Playable ermöglicht es Ihnen, Ihre besten Inhalte (hochwertige Videos) an Ihre beste Zielgruppe (E-Mail) zu liefern und so Ihre Click-through- und Post-Click-Metriken mit ansprechenden, hochwertigen Inhalten zu steigern, die automatisch im Posteingang abgespielt werden.
...
| Video-Inhalte | Laden Sie Videodateien zu Playable hoch oder geben Sie Video-URLs von Websites wie Facebook, Instagram, YouTube, X (ehemals Twitter), TikTok und weiteren an. |
...
Nach dem Hochladen generiert Playable einen Code, der – wenn er in Ihre Braze-Campaign eingefügt wird – das Video in Ihre E-Mail einbettet, sodass es beim Öffnen automatisch abgespielt wird. Wenn Ihre E-Mail geöffnet wird, liefern die Playable-Server die bestmögliche Version Ihres Videos – abhängig vom E-Mail-Client, Gerät, Bildschirmgröße und Netzwerkbedingungen.
...
Fügen Sie abschließend den Code in Ihre Braze-E-Mail-Campaign ein und fahren Sie dann mit dem Design, Testen und Veröffentlichen Ihrer E-Mail-Campaign fort.
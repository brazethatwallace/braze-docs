...
| Braze-REST-API-Schlüssel (optional) | Wenn Sie Catapult-Webhooks verwenden, benötigen Sie einen Braze-REST-API-Schlüssel mit den Nutzerdaten-Berechtigungen, die Ihr Anwendungsfall erfordert. Erstellen Sie den Schlüssel in Braze unter **Settings** > **APIs and Identifiers** > **API Keys**. |

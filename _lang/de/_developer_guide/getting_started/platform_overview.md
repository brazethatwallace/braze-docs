...
### Anpassbare Komponenten {#customizable-components}
...
{{site.baseurl}}/assets/img/getting-started/walk-example.png <br> Um über die Standardoptionen hinauszugehen, können Sie benutzerdefinierten Code schreiben, um das Aussehen eines Messaging-Kanals zu aktualisieren, damit er besser zu Ihrer Marke passt. So können Sie beispielsweise die Schriftart, die Schriftgröße und die Farben einer Komponente ändern. Marketer behalten direkt im Braze-Dashboard die Kontrolle über die Zielgruppe, den Inhalt, das On-Click-Verhalten und den Ablauf.
...
Braze ist für eine schnelle Integration konzipiert. Die durchschnittliche Amortisationszeit beträgt in unserem Kundenstamm sechs Wochen. Weitere Informationen zum Integrationsprozess finden Sie unter [Erste Schritte: Übersicht über die Integration]({{site.baseurl}}/developer_guide/getting_started/integration_overview).

## Ressourcen als Lesezeichen {#resources-to-bookmark}

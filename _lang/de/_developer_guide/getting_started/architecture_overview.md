...
![Diagramm, das zeigt, wie Braze Nutzeraktionen über verschiedene Messaging-Kanäle hinweg verfolgt.]({% image_buster /assets/img/getting-started/putting-it-all-together.png %})
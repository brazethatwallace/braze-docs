...
{% alert note %}
Das Braze SDK erfasst IDFA nicht automatisch. Apps können optional IDFA an Braze weitergeben, indem sie unser `ABKIDFADelegate`-Protokoll implementieren. Apps müssen das ausdrückliche Opt-in der Endnutzer:innen für das Tracking über das App-Tracking-Transparenz-Framework einholen, bevor sie IDFA an Braze weitergeben.
{% endalert %}

...
### Angepasstes Attribut mit einem Integer-Wert {#custom-attribute-with-an-integer-value}
...
## Einrichten von Nutzer-Abos {#setting-up-user-subscriptions}
...
### Einstellen von Push-Benachrichtigungs-Abos {#setting-push-notification-subscriptions}

...
article_title: SDK or Software-Development-Kit-Ersteinrichtung für MacOS
platform: MacOS
page_order: 0
page_type: reference
description: "Dieser Referenzartikel enthält Ressourcen für die Erstintegration des Braze SDK or Software-Development-Kit unter macOS."
search_rank: 1
noindex: true
---
...
> Dieser Referenzartikel beschreibt, wie Sie das Braze SDK or Software-Development-Kit für MacOS installieren.

Ab Version [3.32.0](https://github.com/Appboy/appboy-ios-sdk/releases/tag/3.32.0) unterstützt das Braze SDK or Software-Development-Kit macOS für Apps, die [Mac Catalyst](https://developer.apple.com/mac-catalyst/) verwenden, wenn die Integration über den Swift-Paketmanager erfolgt. Derzeit unterstützt das SDK or Software-Development-Kit Mac Catalyst nicht, wenn Sie CocoaPods oder Carthage verwenden.
...
Sobald Ihre App Catalyst unterstützt, folgen Sie [diesen Anweisungen zur Verwendung des Swift-Paketmanagers]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/sdk_integration?tab=swift%20package%20manager/), um das Braze SDK or Software-Development-Kit in Ihre App zu importieren.

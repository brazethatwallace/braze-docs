...
# .NET MAUI (Xamarin) SDK Repository-Leitfaden {#net-maui-xamarin-sdk-repository-guide}
...
| Name der Binding-Datei                     | Unterstützte Xamarin-Frameworks                           | Natives Braze-Framework                             | Braze Xamarin SDK-Version |
| ------------------------------------------ | --------------------------------------------------------- | --------------------------------------------------- | ------------------------- |
...
Das Braze SDK hat die Unterstützung für Xamarin & Xamarin.Forms ab Version `4.0.0` eingestellt und stattdessen Unterstützung für [.NET MAUI](https://learn.microsoft.com/en-us/dotnet/maui/what-is-maui) hinzugefügt.

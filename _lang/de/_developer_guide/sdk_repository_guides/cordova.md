...
- [Braze-Nutzer:innen-Handbuch]({{site.baseurl}}/user_guide/introduction)
- [Braze-Entwickler:innen-Leitfaden]({{site.baseurl}}/developer_guide/sdk_integration?sdktab=cordova)
...
Dieses SDK übernimmt zusätzlich die Anforderungen der zugrunde liegenden nativen Braze SDKs. Bitte beachten Sie auch die folgenden Listen:
...
{% alert warning %}
Fügen Sie das Braze Cordova SDK nur mit den unten beschriebenen Methoden hinzu. Versuchen Sie nicht, es auf andere Weise zu installieren, da dies zu einer Sicherheitslücke führen könnte.
{% endalert %}
``` text

...
### Beispiel: Szenarien der Inaktivität verstehen {#example-understanding-inactivity-scenarios}

Betrachten Sie das folgende Szenario:

1. Ein:e Nutzer:in öffnet Ihre Website, und das SDK startet eine Sitzung, indem es [`braze.openSession()`](https://js.appboycdn.com/web-sdk/latest/doc/modules/braze.html#opensession) aufruft.

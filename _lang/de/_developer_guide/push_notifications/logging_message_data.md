...
# Push-Analytics und Protokollierung angepasster Events {#push-analytics-and-custom-event-logging}
...
## Native Push-Analytics vs. Protokollierung angepasster Events {#native-push-analytics-vs-custom-event-logging}
...
## Angepasste Daten aus Push-Payloads protokollieren {#logging-custom-data-from-push-payloads}
...
## Protokollierung aus einer Notification Content Extension (Swift) {#logging-from-a-notification-content-extension-swift}
...
### 1. Schritt: App-Gruppen in Xcode konfigurieren {#step-1-configure-app-groups-in-xcode}
...
### 2. Schritt: Auswählen, was protokolliert werden soll {#step-2-choose-what-to-log}
...
#### RemoteStorage-Hilfsdatei {#remotestorage-helper-file}
...
#### UserAttribute-Hilfsdatei {#userattribute-helper-file}
...
#### EventName-Dictionary-Hilfsdatei {#eventname-dictionary-helper-file}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Ergebnisse analysieren" }
...
## Weiterführende Referenzen {#related-references}

...
Sie müssen die Endpunkt-URL abrufen, die mit Ihrer spezifischen Braze-Instanz verknüpft ist. Weitere Informationen finden Sie unter [Braze-API-Endpunkte]({{site.baseurl}}/api/basics#endpoints).
...
### 3. Schritt: Ihren BrazeAI Decisioning Studio™ CSM kontaktieren {#step-3-contact-your-brazeai-decisioning-studio-customer-success-manager}

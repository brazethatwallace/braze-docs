...
Obwohl es sich nicht um ein natives Feature handelt, wird die Android-TV-Push-Integration durch die Nutzung des Braze Android SDK und Firebase Cloud Messaging ermöglicht, um ein Push-Token / Textbaustein für Android TV zu Registrierung. Sie müssen jedoch eine UI erstellen, um den Benachrichtigungs-Payload nach dem Empfang anzuzeigen.

...
Auf Android oder in anderen JVM-basierten Umgebungen sehen Sie beispielsweise:
...
2. Vergleichen Sie das Verhalten in verschiedenen Netzwerken.
   - Testen Sie in einem anderen Netzwerk (z. B. mobile Daten statt Unternehmens-WLAN).
...
3. Validieren Sie Ihre Vertrauenskonfiguration.
   ...
   - Wenn Ihre Umgebung angepasste Zertifizierungsstellen verwendet, bestätigen Sie, dass diese Zertifikate korrekt verteilt werden.

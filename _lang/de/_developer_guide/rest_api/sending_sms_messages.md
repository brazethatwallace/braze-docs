...
# Versenden von SMS-Nachrichten über die REST API {#sending-sms-messages-using-the-rest-api}
...
2. Bestätigen Sie, dass die SMS-Nachricht auf Ihrem Telefon zugestellt wurde.

...
page_order: 8.9
page_type: reference
description: "이 참조 문서에서는 Braze iOS SDK에서 캡처한 기기 수준의 등록정보를 설명합니다."
...
자동으로 수집되는 기기 등록정보에 대한 자세한 내용은 [SDK 데이터 수집]({{site.baseurl}}/user_guide/data/unification/user_data/sdk_data_collection)을 참조하세요.
...
guide_top_text: "Content Cards와 Content Cards가 위치한 피드를 사용자 지정하는 작업은 통합 프로세스 중에 수행해야 합니다. 개발자는 사용자 지정하기 전에 마케팅 팀과 협력하여 브랜드 요구 사항에 가장 적합한 사용자 지정 방식을 결정해야 합니다. Braze에서는 관련 노력 수준과 제공되는 유연성에 따라 기어가기, 걷기, 달리기의 세 가지 사용자 지정 방식을 강조합니다. 사용 설명서에서 이러한 <a href='/docs/user_guide/message_building_by_channel/content_cards/customize#customization-approaches'>사용자 지정 방식</a> 에 대해 자세히 알아보세요."
description: "이 랜딩 페이지에서는 커스텀 스타일, 피드 사용자 지정, 클릭 처리, 열람 및 미열람 표시기 등과 같은 Braze iOS SDK Content Cards 사용자 지정 옵션을 다룹니다."

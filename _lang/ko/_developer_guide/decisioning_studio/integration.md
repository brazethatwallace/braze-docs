...
## Decisioning Studio 통합 {#integrating-decisioning-studio}

### 1단계: 엔드포인트 URL 가져오기 {#step-1-get-your-endpoint-url}

특정 Braze 인스턴스와 연결된 엔드포인트 URL을 가져와야 합니다. 자세한 내용은 [Braze API 엔드포인트]({{site.baseurl}}/api/basics#endpoints)를 참조하세요.

...
!["End Session" 버튼이 표시된 디버깅 세션.]({% image_buster /assets/img/sdk_debugger/close_debugging_session.png %}){: style="max-width:85%;"}
...
![세션 종료 후 "Export Logs" 및 "Copy Session ID"가 표시된 디버깅 페이지.]({% image_buster /assets/img/sdk_debugger/copy_id_and_export_logs.png %})
...
# Cordova SDK 리포지토리 가이드 {#cordova-sdk-repository-guide}
...
- [Braze 개발자 가이드](https://www.braze.com/docs/developer_guide/sdk_integration/?sdktab=cordova)
...
이 SDK는 기본 Braze 네이티브 SDK의 요구 사항도 상속합니다. 아래 링크된 요구 사항 목록도 반드시 준수하세요.
...
{% alert warning %}
**SDK 설치**에 안내된 `cordova plugin add` 명령어로만 Braze Cordova SDK를 추가하세요. 다른 방법으로 설치를 시도하면 보안 위반이 발생할 수 있습니다.
{% endalert %}
``` text

...
# Flutter SDK 리포지토리 가이드 {#flutter-sdk-repository-guide}

## Braze Flutter SDK 소개 {#about-the-braze-flutter-sdk}

Braze Flutter SDK는 Braze 메시징, 분석 및 사용자 인게이지먼트 기능을 애플리케이션에 통합하는 데 도움을 줍니다.

시작하려면 다음 리소스를 참조하세요:

- [Braze 사용자 가이드](https://www.braze.com/docs/user_guide/introduction/)
- [Braze 개발자 가이드](https://www.braze.com/docs/developer_guide/sdk_integration/?sdktab=flutter)

## 빠른 시작 {#quickstart}

다음 스니펫은 앱에 Braze Flutter SDK를 추가하는 데 필요한 최소 구성을 보여줍니다.
...
고급 통합 옵션에 대한 자세한 내용은 [Braze 개발자 가이드](https://www.braze.com/docs/developer_guide/sdk_integration/?sdktab=flutter)를 참조하세요.

## 버전 지원 {#version-support}

다음 표는 Braze Flutter SDK에서 사용하는 도구의 최소 지원 버전을 나열합니다.
...
이 SDK는 기본 Braze 네이티브 SDK의 요구 사항도 상속합니다. 자세한 내용은 [braze-inc/braze-android-sdk](https://github.com/braze-inc/braze-android-sdk) 및 [braze-inc/braze-swift-sdk](https://github.com/braze-inc/braze-swift-sdk)를 참조하세요.

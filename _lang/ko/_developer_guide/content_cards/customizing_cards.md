...
page_order: 0.1
nav_title: 카드 커스터마이즈
description: "Braze SDK의 Content Cards 커스터마이즈에 대해 알아보세요."
layout: dev_guide

guide_top_header: "Content Cards 커스터마이즈"
guide_top_text: "> Braze SDK의 Content Cards 커스터마이즈에 대해 알아보세요."

guide_featured_title: "이 섹션의 문서"
guide_featured_list:
- name: Content Cards 스타일 커스터마이즈
  link: /docs/developer_guide/content_cards/customizing_cards/style
  image: /assets/img/braze_icons/edit-03.svg
- name: Content Cards의 동작 커스터마이즈

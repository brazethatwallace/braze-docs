---
nav_title: 독립 소프트웨어 제공업체 파트너
layout: dev_guide
page_order: 9
hidden: true

guide_top_header: "독립 소프트웨어 제공업체 파트너"
guide_top_text: "다음 문서는 Braze 플랫폼과의 시장 통합을 개발할 때 참조할 수 있도록 Alloys 독립 소프트웨어 제공업체 파트너에게 제공됩니다. 시작하려면 해당 파트너 통합 문서를 참조하세요!"

guide_featured_title: "파트너 설명서"
guide_featured_list:
- name: API 파트너 통합

...
# The Trade Desk로 오디언스 동기화 {#audience-sync-to-the-trade-desk}
...
### 1단계: The Trade Desk 계정 연결 {#step-1-connect-the-trade-desk-account}
...
#### 여러 The Trade Desk 계정 연결(선택 사항) {#connect-multiple-the-trade-desk-accounts-optional}

첫 번째 The Trade Desk 계정을 연결한 후, The Trade Desk 파트너 페이지에서 **Connect more advertisers**를 선택하고 각 계정의 **Advertiser ID name**과 **Advertiser ID**를 입력하여 추가 광고주 계정을 추가할 수 있습니다.

### 2단계: The Trade Desk와 오디언스 동기화 단계 추가 {#step-2-add-an-audience-sync-step-with-the-trade-desk}

Canvas에 구성요소를 추가하고 **Audience Sync**를 선택합니다. 그런 다음 오디언스 동기화 파트너로 **The Trade Desk**를 선택합니다.
...
### 3단계: 동기화 설정 {#step-3-set-up-your-sync}
...
{: start="3"}
3. **Add Users to Audience** 또는 **Remove Users from Audience** 동작을 선택합니다.

![오디언스에 사용자를 추가하는 오디언스 동기화 설정.]({% image_buster /assets/img/audience_sync/trade_desk/audience_sync_step2.png %}){: style="max-width:90%;"}

{: start="4"}
4. 매칭할 필드를 선택합니다: **Email**, **Phone** 또는 **Mobile Advertiser ID**.

{% alert note %}
EU 지역으로 설정된 The Trade Desk의 오디언스에 동기화하는 경우, The Trade Desk에서 전화번호를 지원하지 않습니다. EU 지역에서의 전화번호 지원에 대해서는 The Trade Desk에 문의하세요.
{% endalert %}

### 4단계: Canvas 시작 {#step-4-launch-your-canvas}

The Trade Desk로의 오디언스 동기화를 구성한 후 Canvas를 시작할 준비가 되었습니다! 새 오디언스가 생성되고, 오디언스 동기화 단계를 통과하는 사용자가 The Trade Desk의 이 오디언스에 전달됩니다. Canvas에 후속 구성요소가 포함되어 있으면 사용자는 사용자 여정의 다음 단계로 진행합니다.

## 자주 묻는 질문 {#frequently-asked-questions}

### The Trade Desk에서 오디언스 크기가 채워지는 데 얼마나 걸리나요? {#how-long-will-it-take-for-the-audience-sizes-to-populate-in-the-trade-desk}

최대 24시간이 소요될 수 있습니다.

### 광고 계정 내에서 The Trade Desk가 채우는 최소 오디언스 크기는 얼마인가요? {#what-is-the-minimum-audience-size-for-the-trade-desk-to-populate-within-your-ad-account}
...
### The Trade Desk에서 지원할 수 있는 오디언스 수는 얼마나 되나요? {#how-many-audiences-can-the-trade-desk-support}

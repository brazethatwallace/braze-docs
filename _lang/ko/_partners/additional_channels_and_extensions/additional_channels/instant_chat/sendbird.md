...
1. Braze 대시보드에서 **설정 > 설정 관리 > 커스텀 이벤트**로 이동하고 **+ Add Custom Event**를 클릭합니다.
2. 커스텀 이벤트를 생성한 후 **Manage Properties**를 클릭하고 "status"라는 이름의 등록정보를 추가한 다음 등록정보 유형으로 "String"을 선택합니다.

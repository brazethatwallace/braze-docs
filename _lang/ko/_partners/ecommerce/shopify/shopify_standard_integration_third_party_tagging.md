...
- **타사 도구와 Shopify 커넥터 간의 일관된 SDK 버전:** 신규 고객은 설정 중 최신 SDK 버전으로 프로비저닝됩니다. 타사 도구는 Braze 통합 설정에서 구성된 것과 동일한 SDK 버전을 사용해야 합니다. 기존 고객은 새 버전이 제공되면 알림을 받으며, 통합 설정에서 직접 업그레이드할 수 있습니다.
...
2. **설정** > **앱 설정**으로 이동하여 **Shopify** 웹 앱을 선택한 다음 **웹용 Shopify API 키**를 복사합니다.

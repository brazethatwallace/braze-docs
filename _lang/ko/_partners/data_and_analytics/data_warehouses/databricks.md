...
설정 방법은 [Databricks Delta Sharing]({{site.baseurl}}/delta_sharing/)을 참조하세요.
...
공유를 구성하고 공유 데이터를 쿼리할 준비가 되면 [Databricks Delta Sharing]({{site.baseurl}}/delta_sharing/)으로 이동하세요.
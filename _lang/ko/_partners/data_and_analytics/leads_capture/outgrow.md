...
- **향상된 사용자 경험**: 사용자 인사이트를 활용하여 더 관련성 높은 경험을 만들어 만족도, 리텐션, 생애주기 가치를 높일 수 있습니다.
...
Outgrow에서 인터랙티브 콘텐츠의 응답(예: 퀴즈 결과, 커스텀 세그먼트 또는 참여 점수)을 Braze 커스텀 속성에 매핑할 수 있습니다.
...
2. **캠페인 생성**을 선택하고 캠페인 유형(이메일, 푸시, 인앱 메시지 등)을 선택합니다.

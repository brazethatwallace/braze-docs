...
참고로, Kubit 분석에 통합할 수 있는 모든 [Braze 필드](/docs/assets/download_file/data-sharing-raw-table-schemas.txt)가 여기에 나와 있습니다. 이 단계의 세부 사항은 고객마다 다르며 특별한 구성이 필요합니다. 자세한 내용은 Kubit 계정 매니저 또는 [support@kubit.ai](support@kubit.ai)에 문의하세요.
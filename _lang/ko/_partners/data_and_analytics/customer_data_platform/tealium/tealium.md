...
- Tealium 오디언스를 [AudienceStream]({{site.baseurl}}/partners/data_and_analytics/customer_data_platform/tealium/tealium_audience_stream)을 통해 Braze에 동기화하여 Braze Campaign(캠페인) 및 Canvases를 개인화하거나 Segments를 구축하는 데 사용할 수 있습니다.

...
- **Braze export segment ID**: Lexer로 내보내려는 모든 사용자를 포함하여 Braze에서 생성한 세그먼트의 ID입니다. Lexer로 내보내지 않으려는 사용자가 있는 경우 Braze에서 생성한 세그먼트에서 해당 사용자를 제외할 수 있습니다. 세그먼트 식별자를 찾으려면 Braze에서 원하는 세그먼트를 클릭하고 **세그먼트 API 식별자**를 찾으세요.

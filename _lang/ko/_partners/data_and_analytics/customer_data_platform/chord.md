...
데이터가 흐르기 시작하면, Braze에서 고객 프로필 또는 이벤트 도구를 열어 이벤트와 속성이 예상대로 도착하는지 확인합니다.

### 2단계: 오디언스 및 여정 구축 {#step-2-build-audiences-and-journeys}

동기화된 이벤트와 속성을 [Segments]({{site.baseurl}}/user_guide/audience/segments/creating_a_segment), [Canvases]({{site.baseurl}}/user_guide/messaging/canvas/create_a_canvas), Campaigns에서 활용하여 매장 행동 기반으로 소비자를 타겟팅합니다.

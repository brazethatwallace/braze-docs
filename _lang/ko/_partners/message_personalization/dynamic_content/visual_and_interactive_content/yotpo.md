...
> [Yotpo](https://www.yotpo.com/)는 선도적인 이커머스 마케팅 플랫폼으로, 수천 개의 혁신적인 브랜드가 소비자 직접 판매(D2C) 성장을 가속화할 수 있도록 돕습니다. Yotpo의 단일 플랫폼 접근 방식은 리뷰, 로열티, 단문 메시지 서비스 마케팅 등을 위한 데이터 중심 솔루션을 통합하여 브랜드가 더 스마트하고 전환율이 높은 고객 경험을 만들 수 있도록 지원합니다.

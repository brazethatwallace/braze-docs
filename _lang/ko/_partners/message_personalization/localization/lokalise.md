...
Braze와 Lokalise의 통합은 연결된 콘텐츠를 사용하여 사용자 언어 설정을 기반으로 번역된 콘텐츠를 Braze Campaign에 쉽게 삽입할 수 있도록 합니다.
...
| Lokalise 번역 프로젝트 | 이 통합을 설정하기 전에 Lokalise 번역 프로젝트를 만들어야 합니다. |
...
### 1단계: 사용자 언어 구성 {#step-1-configuring-user-languages}
...
{% endalert %}
### 2단계: Lokalise에서 번역 준비 {#step-2-preparing-your-translations-on-lokalise}
...
### 3단계: Lokalise에서 Braze 앱 구성하기 {#step-3-configuring-the-braze-app-on-lokalise}
...
### 4단계: Braze Campaign에서 번역 사용 {#step-4-using-translations-in-braze-campaign}
...
네, 물론입니다. 이 플래그를 추가하는 방법은 Braze 문서를 참조하세요.

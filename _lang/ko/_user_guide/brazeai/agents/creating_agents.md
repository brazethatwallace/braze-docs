...
2. **에이전트 생성**을 선택합니다.
3. Canvas 에이전트 또는 카탈로그 에이전트 중 하나를 선택합니다.
...
**출력** 섹션에서 기본 스키마 또는 고급 스키마로 에이전트의 [출력]({{site.baseurl}}/user_guide/brazeai/agents/reference/#outputs)을 구성하고 정의할 수 있습니다.
...
### 6단계: 에이전트 사용 {#step-6-use-your-agent}

...
guide_top_text: "BrazeAI<sup>TM</sup> 생성형 AI 기능은 Braze 대시보드에 내장된 통합 AI 어시스턴트인 <a href=\"{{site.baseurl}}/user_guide/brazeai/operator/\">BrazeAI Operator™</a> 를 통해 이용할 수 있습니다. 카피, 이미지, Liquid, HTML 이메일 템플릿을 생성하거나 콘텐츠를 검토하세요. 이미 작업하고 있는 화면에서 모두 가능합니다."
description: "BrazeAI<sup>TM</sup> 생성형 AI 기능은 Braze 대시보드에 내장된 통합 AI 어시스턴트인 BrazeAI Operator™를 통해 이용할 수 있습니다."

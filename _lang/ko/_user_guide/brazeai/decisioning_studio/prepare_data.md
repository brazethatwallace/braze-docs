---
nav_title: 데이터 준비
article_title: 데이터 준비
layout: dev_guide
guide_top_header: "데이터 준비"
guide_top_text: "고품질 데이터는 효과적인 Decisioning Studio 에이전트의 기반입니다. 이 문서에서는 데이터를 평가하고, 웨어하우스 및 이벤트 소스를 연결하고, 핵심 자산과 기능을 정의하고, 스냅샷과 이벤트 스트림 중 선택하고, Braze 외부 ID를 정렬하고, 에이전트를 설계하고 시작하기 전에 과거 데이터를 백필하는 방법을 설명합니다."
page_order: 2
page_type: landing
description: "이 랜딩 페이지에서는 데이터 원칙, 필수 자산, 스냅샷과 이벤트 스트림 비교, 아이덴티티, 피처 엔지니어링, 데이터 소스 연결 등 BrazeAI Decisioning Studio를 위한 데이터 준비 방법을 다룹니다."

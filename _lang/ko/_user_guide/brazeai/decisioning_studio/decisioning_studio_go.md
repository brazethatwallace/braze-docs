...
{% alert important %}
2026년 중반에 Decisioning Studio™ Go의 새 버전이 Braze 대시보드에서 셀프 서비스로 출시될 예정입니다. 다음 문서는 레거시 버전에 해당하며, 해당 버전은 향후 지원이 중단될 예정입니다.
{% endalert %}

## Decisioning Studio Go 소개 {#about-decisioning-studio-go}

Decisioning Studio Go는 제한된 액션 뱅크를 갖춘 셀프 서비스 크리에이티브 구성, 참여 기반 고객 기능만 지원, 클릭 최적화를 포함하며, 다음 고객 참여 플랫폼(CEP)과만 호환됩니다:

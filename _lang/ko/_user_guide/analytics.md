...
guide_top_header: "분석"
guide_top_text: "Braze는 캠페인 성과를 측정하고, 사용자 참여를 추적하며, 데이터 중심의 의사결정을 내릴 수 있는 포괄적인 측정기준 및 보고 도구를 제공합니다. 또한 대량의 세분화된 고객 데이터를 자체 BI 플랫폼에서 활용할 수 있는 데이터 스트리밍 내보내기 도구인 <a href='/docs/user_guide/data/distribution/braze_currents'>Currents</a>를 통해 분석을 보완할 수 있습니다."

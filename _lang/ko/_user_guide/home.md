...
user_top_text: "마케터와 관리자가 Braze를 시작하는 데 필요한 모든 것을 배우고, 의미 있는 데이터 중심 고객 상호작용을 설계하는 방법을 알아볼 수 있습니다."
description: "사용자 가이드 랜딩 페이지입니다. 마케터와 관리자가 Braze를 시작하는 데 필요한 모든 것을 배우고, 의미 있는 데이터 중심 고객 상호작용을 설계하는 방법을 알아볼 수 있습니다."
...
user_menu_list:
  - name: 회사 사용자 관리
    ...
    description: Braze 사용자를 추가하고 관련 회사 사용자 설정을 관리하세요
  - name: 계정에 액세스하기

...
전환 이벤트는 사용자 행동을 참여 시점에 귀속시킵니다. Braze가 여러 전환을 처리하는 방식에 대해 다음 사항을 참고하세요:
...
- Canvases의 경우, 전환 추적은 개별 메시지 타이밍이 아닌 사용자가 Canvas에 진입할 때 시작되는 최종 전환 기한을 기준으로 작동합니다. Braze는 Canvas 내 메시지 사이의 지연 기간 중에도 전환을 집계합니다.

...
- **방법 1:** 복제된 Canvas에서 Canvas 빌더의 **진입 오디언스** 부분을 편집하여 테스트 사용자만 Canvas에 적격하도록 설정합니다. **이메일 주소** 테스트 필터를 추가하여 자신의 이메일 주소를 테스트 사용자로 입력할 수도 있습니다. 아래 예시에서는 3일 이내에 앱을 처음 사용한 두 명의 테스트 사용자로 Canvas를 제한했습니다.

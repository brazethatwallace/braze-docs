...
guide_top_text: "캔버스를 시작한 후에는 데이터가 들어오는 것을 지켜볼 차례입니다. 변경이 필요하거나 캔버스를 아카이브해야 하는 경우, 다음 문서를 참고하세요."

page_type: landing
description: "이 랜딩 페이지에는 아카이브, 복제, 시작 후 변경 등 캔버스 관리에 대한 문서가 포함되어 있습니다."
tool: Canvas

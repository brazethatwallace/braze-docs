...
3. <i class="fas fa-ellipsis-vertical"></i> **추가 작업**을 클릭하고 **Canvas Flow로 복제**를 선택합니다.

![설명된 프로세스의 흐름 다이어그램.]({% image_buster /assets/img_archive/clone_to_v2_workflow.png %}){: style="max-width:25%;"}

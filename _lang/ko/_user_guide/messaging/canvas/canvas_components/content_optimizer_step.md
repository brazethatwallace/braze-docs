...
변경 사항을 게시하면 최적화 프로그램이 초기화되고 모든 활성 배리언트 및 조합에 대해 처음부터 트래픽을 재할당하기 시작합니다. 편집 이전의 과거 데이터는 유지되며 **Content Analytics** 탭에서 확인할 수 있습니다.
...
- 업데이트할 준비가 되면 성과가 낮은 배리언트를 비활성화하고 최고 성과 배리언트의 특성을 기반으로 새 배리언트를 추가하는 것이 권장됩니다.

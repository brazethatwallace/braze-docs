...
1. **콘텐츠 블록 세부 정보** 섹션에서 **콘텐츠 블록 Liquid 태그**를 복사합니다.
2. 콘텐츠 블록 Liquid 태그를 메시지에 삽입합니다. Liquid를 입력하기 시작하면 태그가 자동으로 채워질 수도 있습니다.

드래그 앤 드롭 편집기에서는 **개인화** 패널을 통해 콘텐츠 블록을 추가할 수도 있습니다:
...
콘텐츠 블록을 업데이트하면 Liquid를 통해 콘텐츠 블록이 삽입된 모든 메시지에서 업데이트됩니다. 드래그 앤 드롭 편집기의 **행** 아래 **Content Blocks** 드롭다운을 사용하여 가져온 콘텐츠 블록은 모든 메시지에서 업데이트되지 않습니다.

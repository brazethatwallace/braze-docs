...
미디어 라이브러리에 업로드된 비디오는 WhatsApp 메시지에서만 사용할 수 있습니다. 자세한 내용은 [WhatsApp 메시지 만들기]({{site.baseurl}}/user_guide/channels/whatsapp/create_a_whatsapp_message#outbound-messages)를 참조하세요.
...
Braze는 Modal 인앱 메시지 아이콘에 [Font Awesome v4.3.0](https://fontawesome.com/v4.7.0/cheatsheet/) 사용을 지원합니다.
...
| iOS 알림 센터 | 160자 | 130자 |
| iOS 배너 알림 | 80자 | 65자 |
| Android 잠금 화면 | 49자 | 해당 없음 |
| Android 알림 서랍 | 597자 | 해당 없음 |

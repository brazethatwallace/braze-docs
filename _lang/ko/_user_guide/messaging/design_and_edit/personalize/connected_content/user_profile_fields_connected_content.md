...
page_order: 3
description: "이 문서에서는 연결된 콘텐츠 호출에 고객 프로필을 가져오는 방법과 Liquid 템플릿 관련 모범 사례를 다룹니다."
toc_headers: h2
---

# 연결된 콘텐츠 호출에서 고객 프로필 데이터 가져오기

> 이 페이지에서는 연결된 콘텐츠 호출에 고객 프로필을 가져오는 방법과 Liquid 템플릿 관련 모범 사례를 다룹니다.
...
## 연결된 콘텐츠 호출에서의 Liquid 템플릿

개인화를 위해 Braze는 해당 필드를 Liquid에 전달하기 전에 고객 프로필 필드를 먼저 가져옵니다. 따라서 연결된 콘텐츠의 응답에 고객 프로필 필드가 포함된 경우, 사전에 정의되어 있어야 합니다.
...
### JSON 형식을 깨뜨릴 수 있는 Liquid 태그에 `json_escape` 사용하기

...
- **메시지 활동 로그**에서 사용 가능한 구체적인 세부 정보를 오류 메시지에서 확인합니다. 웹훅의 경우 Braze 홈 페이지의 **Performance Over Time** 섹션으로 이동하여 웹훅 통계를 선택합니다. 여기에서 오류가 발생한 시점을 나타내는 타임스탬프를 찾을 수 있습니다.

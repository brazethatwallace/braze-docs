...
page_order: 2.5
description: "이 문서에서는 발송 속도를 최적화하기 위해 동일한 워크스페이스 내의 여러 캠페인 또는 메시지에서 연결된 콘텐츠 응답을 캐시하는 방법을 다룹니다."
---
...
5. 공급자 기반 채널의 경우, 렌더링된 메시지가 채널 공급자에게 전송된 후 사용자에게 전달됩니다. 콘텐츠 카드와 같은 SDK 전달 채널의 경우, 렌더링된 콘텐츠가 Braze SDK에 동기화되며 첫 번째 노출 또는 표시 시점에 생성되어 사용자에게 표시됩니다.

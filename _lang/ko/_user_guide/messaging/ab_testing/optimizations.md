---
nav_title: 최적화
article_title: 위닝 배리언트 또는 개인화된 배리언트로 A/B 테스트 최적화
page_order: 1
page_type: reference
description: "다변량 및 A/B 테스트를 생성할 때 위닝 배리언트 또는 개인화된 배리언트를 사용하는 방법을 알아보세요."
---
...
1회 발송으로 스케줄된 이메일, 푸시, 웹훅, SMS, WhatsApp 캠페인에 대해 [A/B 테스트를 생성]({{site.baseurl}}/user_guide/messaging/ab_testing/create_tests/)할 때 최적화를 선택할 수 있습니다. 최적화 옵션은 **위닝 배리언트**와 **개인화된 배리언트** 두 가지가 있습니다.
...
1. **개인화된 배리언트**를 선택한 다음, 캠페인 오디언스 중 개인화된 배리언트 그룹에 할당할 비율을 지정합니다.
2. 다음 추가 설정을 구성합니다.

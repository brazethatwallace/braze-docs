...
![새 고객을 등록하고 이메일로 할인 코드를 보내는 양식 블록.]({% image_buster /assets/img/landing_pages/form.png %}){: style="max-width:70%;"}
...
랜딩 페이지에 [양식](#form-blocks)이 포함된 경우, 확인 경험으로 사용할 두 번째 랜딩 페이지를 만드세요. 이 페이지는 양식 제출 후 사용자에게 감사를 표하거나 다음 단계를 안내해야 합니다.

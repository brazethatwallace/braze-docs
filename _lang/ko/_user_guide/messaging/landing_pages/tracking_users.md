...
{% alert tip %}
외부 채널에 페이지 URL을 삽입하여 리드 생성에 랜딩 페이지를 활용할 수도 있습니다. 랜딩 페이지를 생성한 후 **Landing Page Details**로 이동하여 랜딩 페이지의 고유 URL을 확인하세요.
{% endalert %}
...
Braze는 랜딩 페이지의 URL을 사용하여 고유한 Liquid 태그를 생성합니다. 현재 페이지 URL을 변경하려면 **Messaging** > **Landing Pages**로 이동한 다음 랜딩 페이지를 여세요. **page URL** 아래에서 새 페이지 URL을 입력할 수 있습니다.
...
**Messaging** > **Campaigns**로 이동한 다음 Campaign을 선택하세요. 메시지 편집기에서 **Personalization**을 선택합니다.

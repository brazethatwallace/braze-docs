...
guide_top_text: "마케팅은 예술적 감각과 전문 도구가 필요한 과학입니다. 캔버스를 사용하면 엄밀함과 예술성을 결합하여 각 고객에게 의미 있고, 관련성 높으며, 매력적인 경험을 만들 수 있습니다. <br> <br> 캔버스는 마케터가 여러 메시지로 캠페인을 구성할 수 있는 통합 인터페이스입니다. 비주얼 프로그래밍 도구와 비슷하게, 일련의 단계로 이루어진 일관된 사용자 여정을 구축할 수 있습니다.<br> <br> 다음 문서에서는 캔버스 설정 방법을 안내하여 뛰어난 고객 경험을 구축할 수 있도록 도와드립니다. <a href='https://learning.braze.com/canvas-course'>캔버스 Braze 학습 과정</a>도 확인해 보세요!"
search_rank: 3
page_type: landing
tool: Canvas
description: "이 랜딩 페이지에는 캔버스 관련 문서가 모여 있습니다. 여기에서 캔버스 구축, 캔버스 구성요소 사용, 캔버스 관리 및 테스트, 다양한 아이디어와 전략 적용에 대한 리소스를 찾을 수 있습니다."

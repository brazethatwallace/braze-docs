...
page_order: 5
page_type: reference
description: "이 문서에서는 BRAZE 캔버스 템플릿을 사용하여 강력한 초기 도입을 촉진하고 사용자와의 지속적인 관계를 장려하는 온보딩 여정을 만드는 방법을 설명합니다."
tool: Canvas
---
...
이 문서에서는 사용자 라이프사이클의 고려 단계를 위한 **온보딩** 템플릿의 사용 사례를 안내하여 신규 사용자를 위한 원활한 온보딩 여정을 만드는 방법을 설명합니다. 이 문서를 마치면 이 BRAZE 캔버스 템플릿을 신규 사용자를 위한 개인화된 메시지로 커스터마이즈할 수 있게 됩니다.

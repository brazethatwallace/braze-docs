...
guide_top_text: "캠페인을 시작한 후에는 편안하게 데이터가 수집되는 것을 지켜보세요. 캠페인을 변경하거나, 알림을 설정하거나, 캠페인을 아카이브해야 하는 경우 다음 문서를 참고하세요."
page_order: 3

tool: Campaigns
page_type: landing
description: "캠페인 관리에 대한 랜딩 페이지입니다. 여기에서 캠페인 승인, 복제, 알림, 아카이브, 시작 후 캠페인 변경 등에 대한 문서를 찾을 수 있습니다."

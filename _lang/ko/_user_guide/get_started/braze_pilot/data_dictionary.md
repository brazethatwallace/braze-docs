---
nav_title: 데이터 사전
article_title: Braze Pilot용 데이터 사전
page_order: 3
page_type: reference
...
## 데이터 접근 방식 {#the-approach-to-data}

해당 앱은 가상의 브랜드가 대표하는 업계에서 흔히 볼 수 있는 커스텀 속성과 이벤트를 기록합니다. 이러한 속성을 활용하여 다양한 일반적인 사용 사례에 대한 데모를 구현할 수 있습니다.
일반적으로 모든 이벤트와 속성에는 해당 데이터를 담당하는 앱 시뮬레이션에 대응하는 짧은 코드가 접두사로 붙습니다. 예를 들면 다음과 같습니다.

- Steppington 앱 시뮬레이션에 의해 기록된 모든 데이터에는 `st_` 접두사가 붙습니다.
- PantsLabyrinth 앱 시뮬레이션에 의해 기록된 모든 데이터에는 `pl_` 접두사가 붙습니다.
- MovieCanon 앱 시뮬레이션에 의해 기록된 모든 데이터에는 `mc_` 접두사가 붙습니다.

## 기록된 이벤트 및 속성 목록 {#list-of-logged-events-and-attributes}
  ...
  <caption>기록된 이벤트 및 속성 목록</caption>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>이벤트</td>
            <td></td>
            <td>사용자가 PantsLabyrinth 앱에 진입할 때</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>이벤트</td>
            <td></td>
            <td>사용자가 Steppington 앱에 진입할 때</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>사용자가 Steppington+ 탭을 방문할 때(피처 플래그로 활성화된 경우)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>이벤트</td>
            <td></td>
            <td>사용자가 <strong>Start Free Trial</strong> 버튼을 선택할 때</td>
        </tr>
        <tr>

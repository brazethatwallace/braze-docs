...
> [OneLogin](https://www.onelogin.com/)은 사용자 ID 관리를 위한 종합적인 솔루션을 제공하는 클라우드 ID 플랫폼입니다. OneLogin은 SAML 2.0을 사용하는 클라우드 및 온프레미스 애플리케이션과 통합되어 SSO(싱글 사인온), 사용자 프로비저닝, 멀티팩터 인증 등을 지원합니다.
...
5. Braze는 SAML 어설션을 [특정 형식]({{site.baseurl}}/user_guide/administer/global/saml_single_sign_on/saml_sso_setup#configure-your-identity-provider)으로 수신해야 합니다. **Parameters** 아래에 Braze에서 지원하는 속성이 미리 채워져 있어야 합니다. 올바른지 확인하세요.![OneLogin의 Braze SAML 매개변수.]({% image_buster /assets/img/onelogin_5.jpg %})<br><br>

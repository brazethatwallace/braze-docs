...
5. Braze는 SAML 어설션을 [특정 형식]({{site.baseurl}}/user_guide/administer/global/saml_single_sign_on/saml_sso_setup/#configure-your-identity-provider)으로 수신해야 합니다. **매개변수** 아래에 Braze에서 지원하는 속성이 미리 채워져 있어야 합니다. 올바른지 확인하세요.![OneLogin의 Braze SAML 매개변수.]({% image_buster /assets/img/onelogin_5.jpg %})<br><br>
6. **SSO** 탭에서 Braze 대시보드 설정에 필요한 **인증서** 및 **SAML 2.0 엔드포인트(HTTP)**를 복사합니다.![OneLogin의 Braze 앱 SSO 탭에서 복사할 인증서.]({% image_buster /assets/img/onelogin_6.jpg %})

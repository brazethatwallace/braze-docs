...
3. 하나 이상의 응답 코드를 선택하고 [경보 임계값](#api-usage-alert-thresholds)을 지정하여 경보 기준을 정의하세요.
4. 완료되면 **알림 활성화**를 토글하세요.
    ![API 사용량 경고의 예시로서, 'Track users' 엔드포인트가 1시간 내에 100% 증가할 때 알림을 전송합니다.]({% image_buster /assets/img/api_usage_alerts/api_usage_alerts1.png %})
    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          ...
          <li><strong>퍼센트 증가</strong> 또는 <strong>퍼센트 감소</strong>: 이전 시간 창 대비 요청의 백분율 변화를 비교합니다.</li>
          <li><strong>이상</strong> 또는 <strong>이하</strong>: 시간 창 내의 요청 수를 계산합니다.</li>
        </ul>
      </td>
    </tr>
    <tr>
...
![경보 기준이 충족되면 선택한 이메일로 알림이 전송됩니다.]({% image_buster /assets/img/api_usage_alerts/api_usage_alerts2.png %})

...
> 다국어 기능을 사용하면 단일 메시지 내에서 [번역 태그]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/localization/locales_in_messages/)를 사용하여 다양한 언어와 위치의 사용자를 타겟팅할 수 있습니다.

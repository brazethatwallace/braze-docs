...
시드 그룹은 API 캠페인에서는 사용할 수 없지만, Campaign에서 API 트리거 항목을 사용하여 시드 그룹을 포함할 수 있습니다. 전달 가능성 측정기준을 측정하고 이메일 콘텐츠의 기록을 보관 및 아카이브 목적으로 유지하는 데 사용합니다.
...
- 고객 프로필의 **Campaign 수신** 목록을 업데이트하지 않습니다.

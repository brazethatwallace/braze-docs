...
시드 그룹은 API Campaign에서는 사용할 수 없지만, Campaign에서 API 트리거 항목을 사용하여 시드 그룹을 포함할 수 있습니다. 전달 가능성 측정기준을 측정하고 이메일 콘텐츠의 기록을 보관 및 아카이브 목적으로 유지하는 데 사용합니다.

내부 그룹을 생성하고 시드 그룹으로 사용하도록 태그한 후, Campaign 편집기의 **타겟 오디언스** 단계 또는 Canvas의 **발송 설정** 단계에서 선택합니다.

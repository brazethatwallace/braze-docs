...
1. 워크스페이스 드롭다운을 선택한 다음 <i class="fa-solid fa-square-plus" style="color: #0b8294;"></i> **워크스페이스 생성**을 선택합니다.
...
이 필드는 Braze SDK를 앱이나 웹사이트에 통합한 후에 나타납니다. 해당 플랫폼에 더 새로운 버전의 Braze SDK가 있는 경우 "새 버전 사용 가능" 태그와 함께 여기에 표시됩니다.
...
1. **설정** > **앱 설정**으로 이동합니다.
2. 워크스페이스 이름 위에 마우스를 올리고 <i class="image: /assets/img/braze_icons/pencil-01.svg" style="color: #0b8294;"></i>을 선택합니다.
3. 워크스페이스에 새 이름을 지정한 다음 <i class="fa-solid fa-square-check" style="color: #0b8294;"></i> **저장**을 선택합니다.
...
### 업데이트된 앱을 출시할 때 새 워크스페이스를 생성해야 하나요?

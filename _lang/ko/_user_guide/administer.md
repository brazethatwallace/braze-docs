...
guide_top_header: "관리"
guide_top_text: "워크스페이스, 사용자 권한, 보안, 청구를 포함하여 Braze 대시보드를 설정하고 관리하세요. 개인 설정은 개별 계정 액세스 및 환경설정을 다루며, 글로벌 설정은 전체 회사 또는 워크스페이스에 영향을 미칩니다.<br><br>이 섹션에 포함된 주제와 문서 외에도, 사용자 액세스 관리 방법과 대시보드 유지 관리 모범 사례를 다루는 <a href='https://learning.braze.com/admin-dashboard-management/'>관리자 및 대시보드 관리</a> Braze 학습 과정을 확인해 보세요."
description: "워크스페이스, 사용자 권한, 보안, 청구를 포함하여 Braze 대시보드를 설정하고 관리하세요."

guide_featured_title: "빠른 링크"
guide_featured_list:
- name: 사용자 추가

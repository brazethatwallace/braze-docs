...
guide_top_text: "캠페인과 캔버스 전반에서 메시징을 생성, 관리, 최적화하세요. 메시징 기본 사항을 배우고, 콘텐츠를 개인화하고, A/B 테스트를 설정하고, 랜딩 페이지를 구축하여 커뮤니케이션을 확장하세요."

page_type: landing
description: "Braze에서 캠페인과 캔버스 전반의 메시징을 생성, 관리, 최적화하세요."

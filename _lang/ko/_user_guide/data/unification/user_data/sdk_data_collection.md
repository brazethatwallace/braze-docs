...
| 클릭한 카드 | 숫자 |
| 마지막으로 수신한 메시지 | 시간 |
| 마지막으로 받은 이메일 Campaign | 시간 |
| 마지막으로 받은 푸시 Campaign | 시간 |
| 피드백 항목 수 | 숫자 |
| 지난 Y일 동안의 세션 수 | 숫자와 시간 |
| Campaign에서 메시지를 수신함 | 부울. 이 필터는 이전 Campaign을 수신했는지 여부에 따라 사용자를 타겟팅합니다. |
...
| 기기 로캘 | Android, iOS, 웹 | 기기의 기본 로캘 | 이 속성은 사용자의 선호 언어로 메시지를 번역하는 데 사용됩니다. |
| 최신 기기 로캘 | Android, iOS, 웹 | 기기의 가장 최근 기본 로캘 | 이 속성은 사용자의 기기 설정에서 가져오며 메시지를 사용자가 선호하는 언어로 번역하는 데 사용됩니다. `Most Recent Location` 속성과는 독립적입니다. |

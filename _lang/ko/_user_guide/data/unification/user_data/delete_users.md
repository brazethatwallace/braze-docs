...
사용자를 삭제하려면 관리자이거나 **사용자 삭제** 권한이 있어야 합니다. 사용자 삭제 기록을 보려면 관리자이거나 **사용자 삭제 기록 보기** 권한이 있어야 합니다. 다음 권한이 사용자 삭제 및 삭제 기록을 제어합니다:

| 권한 | 설명 |
|------------|-------------|
| 사용자 삭제 | 사용자를 개별적으로 또는 대량으로 영구 삭제합니다. |
| 사용자 삭제 기록 보기 | 사용자 삭제 기록을 조회합니다. |

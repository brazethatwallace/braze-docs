...
### 소비를 최소화하기 위해 새로운 또는 업데이트된 속성만 작성 {#only-write-new-or-updated-attributes-to-minimize-consumption}
...
### 점진적 업데이트 수행 {#make-incremental-updates}
...
### 다른 테이블에서 JSON 문자열 생성 {#create-a-json-string-from-another-table}
...
### 데이터 웨어하우스 쿼리 시간 초과 방지 {#avoid-timeouts-for-data-warehouse-queries}

...
`_merge_objects` 매개변수와 `$update` 연산자를 사용하여 배열 내 특정 객체의 값을 업데이트합니다. 단순 [중첩 고객 속성]({{site.baseurl}}/nested_custom_attribute_support/#api-request-body) 객체에 대한 업데이트와 유사하게, 이는 딥 머지를 수행합니다.

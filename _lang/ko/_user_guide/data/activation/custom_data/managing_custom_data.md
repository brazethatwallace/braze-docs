...
개발 팀이 해당 커스텀 데이터를 통합하기 전에 커스텀 데이터를 사용하여 Campaign 및 Segment를 설정하고 싶은 경우가 있을 수 있습니다. Braze에서는 이러한 데이터가 추적되기 전에 대시보드에서 커스텀 이벤트 및 속성을 미리 채워서 드롭다운 및 Campaign 생성 프로세스의 일부로 사용할 수 있도록 합니다.

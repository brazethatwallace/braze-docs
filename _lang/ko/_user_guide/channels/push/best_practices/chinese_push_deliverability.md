...
메시지의 효과를 더욱 높이려면, 열리지 않은 푸시 알림의 정보를 단문 메시지 서비스, WhatsApp, LINE 등의 앱 외부 채널과 인앱 메시지 및 Content Cards 등의 인앱 채널을 통해 다시 전달하세요. 사용자가 다음에 앱을 열 때 놓쳤을 수 있는 내용을 확인할 수 있습니다.
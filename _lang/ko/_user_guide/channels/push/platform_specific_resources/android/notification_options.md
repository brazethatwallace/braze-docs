...
![Android 푸시 Campaign을 생성한 후 작성 탭 상단에서 Notification Channel 드롭다운을 확인하세요.]({% image_buster /assets/img_archive/notification_channel_dropdown.png %}){: style="max-width:60%;"}
...
![Notification Channel 드롭다운 메뉴에서 Manage Notification Channel을 클릭하고 필수 필드를 입력하여 알림 채널에 알림 ID를 추가하세요. 알림 채널은 Braze 플랫폼에서 사용하기 전에 앱에서 먼저 정의해야 합니다.]({% image_buster /assets/img_archive/notification_channels.png %}){: style="max-width:80%;" }
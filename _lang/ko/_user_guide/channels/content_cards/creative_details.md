...
클래식 카드는 표준 메시징 및 알림에 적합하며, 아이콘을 사용하여 메시지를 시각적으로 분류할 수도 있습니다. 이미지는 선택 사항이지만, 반드시 1:1 비율이어야 합니다.

![권장 세부 정보가 포함된 클래식 카드 이미지와 클래식 카드 예시]({% image_buster /assets/img/content_card_classic.png %}){: width="1358" height="2871" style="max-width:45%;border:0;"}

| 카드 기능 | 세부 정보 |
| --- | ---|
| 헤더 텍스트 | 18px; 볼드체 <br> 한 줄의 텍스트가 이상적입니다. <br> Liquid를 사용하여 메시지를 개인화할 수 있습니다. |
| 메시지 텍스트 | 13px; 보통 굵기 <br> 두 줄에서 네 줄의 텍스트가 이상적입니다. <br> Liquid를 사용하여 메시지를 개인화할 수 있습니다. |
| 링크 텍스트 | 선택 사항. <br> 13&nbsp;px <br> 웹 페이지 링크 또는 앱 내 딥링크. |
| 이미지 | 선택 사항. <br> 반드시 1:1 비율이어야 합니다. <br> 60 x 60&nbsp;px의 이미지 품질을 권장합니다. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="Content Cards 유형" }

{% endtab %}
{% tab 캡션 이미지 %}

캡션 이미지 카드는 대규모 세일이나 새로운 앱 기능과 같은 중요한 콘텐츠를 강조하고 관심을 끌기에 좋은 방법입니다.

![권장 세부 정보가 포함된 캡션 이미지 카드 이미지와 캡션 이미지 카드 예시]({% image_buster /assets/img/content_card_captioned.png %}){: width="2880" height="2877" style="max-width:90%;border:0;"}
...
| 메시지 텍스트 | 13px; 보통 굵기 <br> 두 줄에서 네 줄의 텍스트가 이상적입니다. <br> Liquid를 사용하여 메시지를 개인화할 수 있습니다. |
| 링크 텍스트 | 선택 사항. <br> 13&nbsp;px <br> 웹 페이지 링크 또는 앱 내 딥링크. |
| 이미지 | 4:3 비율을 권장합니다. <br> 최소 너비 600&nbsp;px.  <br> 고해상도 PNG, JPEG 및 GIF를 지원합니다. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="Content Cards 유형" }

{% endtab %}
{% tab 이미지 전용 %}

더 창의적인 제어를 원한다면 이미지 전용 카드가 적합합니다. 원하는 도구를 사용하여 이미지를 만들고 이 카드 유형에 업로드하세요.

![권장 세부 정보가 포함된 이미지 전용 Content Cards 이미지와 이미지 전용 예시]({% image_buster /assets/img/content_card_banner.png %}){: width="1358" height="2871" style="max-width:45%;border:0;"}

| 카드 기능 | 세부 정보 |
| --- | ---|
| 링크 카드 | 선택 사항. <br> 13&nbsp;px <br> 클릭 시 웹 페이지 링크 또는 앱 내 딥링크로 이동합니다. |
| 이미지 | 모든 종횡비를 지원합니다. <br> 최소 너비 600&nbsp;px.  <br> 고해상도 PNG, JPEG 및 GIF를 지원합니다. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="Content Cards 유형" }
...
![카드의 스와이프 또는 닫기 해제 동작을 보여주는 이미지]({% image_buster /assets/img/dismissal-cc.png %}){: width="1800" height="504"}

사용자가 모든 카드를 해제했거나 새로운 업데이트를 푸시하지 않은 경우, 사용자의 피드는 일반적으로 다음과 같이 표시됩니다:

![빈 Content Cards 피드 이미지]({% image_buster /assets/img/empty-cc.png %}){: width="832" height="1478" style="max-width:45%"}

...
Campaign을 발송하기 전에 항상 인앱 메시지를 테스트하여 최종 메시지가 사용자 관점에서 어떻게 보이는지 시각적으로 확인하는 것이 중요합니다.
...
- **커스텀 사용자:** 사용자를 커스텀할 수 있습니다. Braze가 사용 가능한 모든 속성 및 이벤트에 대한 입력 필드를 제공합니다. 미리보기 이메일에서 확인하고 싶은 정보를 입력하세요.

...
이 옵션이 활성화되면 색상 선택기를 사용하거나 기존 [색상 프로필]({{site.baseurl}}/user_guide/messaging/templates/in_app_message_templates/in_app_message_template#color-profile)을 선택하여 기존 다크 또는 라이트 테마를 재사용함으로써 인앱 메시지의 다크 테마 색상을 선택할 수 있습니다.
...
2. **템플릿 생성**을 선택하고 드롭다운에서 [색상 프로필]({{site.baseurl}}/user_guide/messaging/templates/in_app_message_templates/in_app_message_template#color-profile)을 선택합니다.

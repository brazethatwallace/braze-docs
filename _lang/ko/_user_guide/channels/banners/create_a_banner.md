...
6. 배너의 만료를 설정합니다. 단계가 사용 가능해진 후 일정 기간이 지나거나 특정 날짜와 시간에 만료되도록 설정할 수 있습니다. 최대 만료 기간은 단계가 사용자에게 사용 가능해진 후 31일입니다.
...
| 필드 | 설명 | 예시 |
|-------|-------------|---------|
| 속성정보 유형 | 속성정보의 데이터 유형입니다. 지원되는 유형에는 문자열, 부울, 숫자, 타임스탬프, 이미지 URL 및 JSON 오브젝트가 포함됩니다. | 문자열 |
| 속성정보 키 | 속성정보의 고유 식별자입니다. 이 키는 SDK에서 속성정보에 액세스하는 데 사용됩니다. | `color` |
| 값 | 속성정보에 할당된 값입니다. 선택한 속성정보 유형과 일치해야 합니다. | `#FF0000` |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="커스텀 속성정보 추가" }

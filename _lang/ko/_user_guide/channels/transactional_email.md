...
| 비밀번호 재설정 | 고객이 계정 자격 증명을 재설정할 수 있도록 안전하고 시간 제한이 있는 링크를 전달합니다. |
| 배송 알림 | 주문이 발송되었음을 고객에게 알리며, 추적 정보와 예상 배송일을 포함합니다. |
| 계정 알림 | 결제 실패, 가입 변경, 보안 알림 등 중요한 계정 관련 알림을 발송합니다. |
...
- 스케줄 기반 또는 행동 기반 트리거가 아닌 API 호출에 의해 트리거됩니다

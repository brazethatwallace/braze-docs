...
description: "이 랜딩 페이지에는 Braze 이메일 캠페인을 구축할 때 Apple Mail과 관련된 참조 문서가 포함되어 있습니다."
guide_top_text: "Apple Mail을 사용하는 수신자에게 이메일을 발송할 때 유의해야 할 사항이 있습니다. Apple Private Relay 관련 세부 정보와 이메일 제공업체를 적절히 설정하는 방법 등을 확인하세요."
channel:
  - email

...
Microsoft는 무료 이메일 도메인(Hotmail, Live, MSN, Outlook)으로의 전달에 문제가 있는 발신자를 차단 해제하는 경우가 거의 없습니다. 대신 해당 도메인으로의 발송량을 적극적으로 줄이고 최근에 참여한 연락처에만 발송하세요. 참여한 수신자의 핵심 그룹을 식별할 수 없는 경우, 해당 도메인으로의 발송을 완전히 중단하세요.

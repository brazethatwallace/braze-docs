...
- Meta의 출시 예정일은 2026년 6월입니다

### 2025년 11월: [WhatsApp용 마케팅 메시지 API](https://developers.facebook.com/documentation/business-messaging/whatsapp/marketing-messages/overview/) (이전 Marketing Messages Lite API) {#november-2025-marketing-messages-api-for-whatsapphttpsdevelopersfacebookcomdocumentationbusiness-messagingwhatsappmarketing-messagesoverview-formerly-marketing-messages-lite-api}
*최종 업데이트: 2026년 3월*
...
- 현재는 정부/대형 Meta 광고주, 직접 광고주 또는 Braze와 같은 BSP를 통해서만 가능합니다(주당 최대 5건)
- 새로운 필수 조건: 비즈니스 인증, 2단계 인증, 승인된 표시 이름, 주목도
- 도움이 필요하시면 고객 성공 매니저에게 문의하세요

### 2025년 10월: 지역별 요금 인하 {#october-2025-regional-pricing-rate-cuts}
*최종 업데이트: 2026년 3월*
...
- 더 높은 제한에 더 빠르게 접근 가능합니다(6시간 이내)
- 위험: "무제한" 번호가 없는 비즈니스는 총 제한이 감소할 수 있습니다

### 2025년 7월 1일: 요금 체계 개편 {#july-1-2025-pricing-overhaul}
*최종 업데이트: 2026년 3월*

- 대화당 과금이 메시지당 과금으로 대체되었습니다
- 24시간 서비스 기간 내에 발송된 유틸리티 메시지가 무료가 되었습니다
- 여러 시장에서 유틸리티/인증 요금이 업데이트되었으며, 새로운 볼륨 티어가 도입되었습니다
- 유틸리티 템플릿 잘못된 분류에 대한 새로운 규칙—비즈니스는 템플릿 거부 및 제출 제한에 직면할 수 있습니다

### 2025년 4월: 미국 전화번호로의 마케팅 메시지 일시 중지 {#april-2025-pause-of-marketing-messages-to-us-phone-numbers}
*최종 업데이트: 2025년 8월*

Meta는 미국 전화번호(국가 코드 `+1`과 미국 지역 코드로 구성된 번호)를 가진 WhatsApp 사용자에게 모든 마케팅 템플릿 메시지의 전달을 일시 중지합니다. 이 일시 중지가 해제되는 현재 예정된 날짜는 없습니다.

미국 전화번호를 가진 WhatsApp 사용자에게 템플릿을 발송하려는 모든 시도는 오류 `131049`를 반환합니다.

### 2025년 3월: 템플릿 카테고리 오용 제한 {#march-2025-template-category-misuse-restrictions}
*최종 업데이트: 2026년 3월*

- Meta는 유틸리티/마케팅 분류를 오용하는 비즈니스에 대한 제재를 도입했습니다
- 7~30일간의 템플릿 생성 및 카테고리 검토 제한이 발생할 수 있습니다

### 2025년 3월: 사용자별 마케팅 템플릿 메시지 제한 {#march-2025-per-user-marketing-template-message-limits}
*최종 업데이트: 2025년 8월*

Meta는 특정 기간 동안 사용자가 모든 비즈니스로부터 수신할 수 있는 마케팅 템플릿 메시지 수를 제한하며, 읽힐 가능성이 낮은 메시지부터 적용합니다.
...
Meta는 미국에서 WhatsApp 생태계의 건전성을 유지하기 위해 이 업데이트를 진행한다고 알려왔습니다. 미국에서 WhatsApp은 빠르게 성장하고 있지만 아직 초기 단계에 있습니다(예: 마케팅 메시지의 참여율이 다른 지역보다 낮음). Meta는 미국 시장이 마케팅 메시지를 재개할 준비가 되었는지 계속 평가할 예정입니다.

미국 지역 코드를 가진 전화번호로의 마케팅 메시지 전달은 WhatsApp에 의해 거부되며 오류 코드 131049를 반환합니다.
...
1. 사용자가 전화번호를 제공한 경우.
2. 사용자가 WhatsApp에 한정되지 않은 일반 메시징에 대한 옵트인 동의를 제공한 경우.

비즈니스는 옵트인을 받을 때 모든 현지 법률을 준수하고 아래 요구 사항을 따라야 합니다:

- 비즈니스는 사용자가 해당 비즈니스로부터 커뮤니케이션을 수신하는 데 옵트인한다는 것을 명확히 명시해야 합니다
- 비즈니스는 사용자가 메시지를 수신하기로 옵트인하는 비즈니스 이름을 명확히 명시해야 합니다
- 비즈니스는 관련 법률을 준수해야 합니다

WhatsApp이 정책을 완화했지만, Braze는 최상의 고객 경험과 참여율을 위해 WhatsApp 채널에 특화된 옵트인을 수집할 것을 여전히 권장합니다. 항상 그렇듯이, 귀사의 브랜드에 적합한 방법에 대해 법무팀과 상의하세요.
...
### 2024년 11월: WhatsApp, 읽기율을 포함하도록 품질 기반 계정 제재 확대 {#november-2024-whatsapp-expanding-quality-based-account-enforcements-to-include-read-rates}
*최종 업데이트: 2024년 12월*

WhatsApp은 플랫폼에서 스팸과 유사한 행동을 줄이는 등 고객에게 양질의 경험을 제공할 수 있도록 비즈니스를 돕는 새로운 방법에 지속적으로 투자하고 있습니다.

11월 22일부터 WhatsApp은 읽기율이 극도로 낮은 WhatsApp 비즈니스 계정(WABA)에 대한 기존 계정 수준 품질 제재를 확대하기 시작했습니다. 이 변경은 전 세계적으로 적용됩니다.

계정의 읽기율이 크게 떨어지면(예: 계정에서 발송한 대부분의 메시지가 읽히지 않는 경우), 해당 계정에 메시징 차단이 적용됩니다. 대규모로 지속적으로 낮은 읽기율이 유지되면 차단의 심각도가 증가합니다.

계정의 읽기율이 극도로 낮은 경우, 다음 조치가 취해집니다:

- 해당 계정은 비즈니스가 시작하는 메시지 발송이 차단됩니다. 고객이 시작한 메시지에는 여전히 응답할 수 있습니다. 이 초기 차단은 "소프트 잠금"이며, 계정 품질에서 확인 버튼을 선택하여 메시징을 다시 시작할 수 있습니다.
- 소프트 잠금 후에도 읽기율이 계속 떨어지거나 낮은 상태를 유지하면, 비즈니스는 점진적으로 강화되는 제재 조치에 직면할 수 있습니다(예: 며칠간의 메시징 제한).
- 비즈니스는 적용된 제한이 해제될 때까지 기다려야 메시징을 다시 시작할 수 있습니다. 반복적인 소프트 잠금 후에도 읽기율이 계속 낮은 상태를 유지하면, 해당 계정은 최종적으로 서비스에서 제외됩니다.

#### 이러한 경고 및 제재에 대한 최신 정보를 받는 방법 {#how-to-stay-updated-on-these-warnings-and-enforcements}

기존 플랫폼 제재와 마찬가지로, 비즈니스는 이러한 조치에 대해 알림을 받으며 WhatsApp Business Manager의 계정 품질 페이지를 사용하여 확인할 수 있습니다. 제재 알림 이메일은 해당 정보를 기반으로 발송되므로, WhatsApp Business Manager에 모든 필요한 관리자의 올바른 연락처 정보가 등록되어 있는지 확인하세요.

심각한 스팸 위반에 대한 알림은 다음과 같이 전달됩니다:

- WhatsApp Business Manager 알림 센터에 표시
- WhatsApp Manager에 배너로 표시
- WhatsApp Business Manager에 설정된 모든 관리자에게 이메일로 발송

### 2024년 5월: 튀르키예에서 Cloud API 서비스 개시 {#may-2024-cloud-api-going-live-in-trkiye}
*최종 업데이트: 2024년 5월*

Meta는 이제 Cloud API 비즈니스에 튀르키예에서의 비즈니스 메시징 접근을 제공합니다. 이전에는 터키의 비즈니스가 WhatsApp Cloud API를 사용할 수 있었지만, 터키 번호를 가진 WhatsApp 사용자는 Cloud API를 통해 발송된 메시지를 보내거나 받을 수 없었습니다.

Meta는 사용자가 Meta가 호스팅하는 비즈니스와 채팅할 때 항상 이를 명확히 알리며, 모든 사용자는 비즈니스 메시징을 진행하기 위해 관련 WhatsApp 서비스 약관 및 개인정보 보호정책에 동의해야 합니다. 터키에서의 2021년 서비스 약관 및 개인정보 보호정책 업데이트는 일시 중지되었다가 현재 적용되고 있습니다. 이는 개인정보 보호에 대한 Meta의 약속을 변경하지 않습니다—개인 대화는 종단 간 암호화로 계속 보호되어 본인과 의도된 수신자만 볼 수 있습니다. 이 업데이트를 통해 터키 사용자는 원하는 경우 선택적 비즈니스 기능에 접근할 수 있으며, WhatsApp의 작동 방식에 대한 더 많은 투명성을 제공합니다.

Cloud API 비즈니스는 이제 터키 번호를 가진 WhatsApp 사용자와 대화를 시작할 수 있으며, 기존의 오류 코드 131026 대신 "발송됨" 대화로 웹훅을 반환합니다.

비즈니스 메시지가 "전달됨" 또는 "읽음"이 되려면 사용자가 WhatsApp 약관에 동의해야 합니다. 메시지가 전달되지 않으면 비즈니스에 요금이 부과되지 않습니다.

Cloud API 비즈니스로부터 메시지를 수신하거나 발송하려는 사용자에게는 WhatsApp 업데이트를 수락할 때까지 Cloud API 비즈니스에 메시지를 보낼 수 없다는 인앱 알림이 표시됩니다. 또한, 앱을 등록하거나 재등록하는 사용자에게는 WhatsApp 업데이트를 수락하라는 메시지가 표시됩니다.
...
Meta는 WhatsApp 플랫폼에서 고품질 사용자 경험을 유지하고 마케팅 템플릿 메시지 참여를 극대화하기 위한 새로운 접근 방식을 도입하고 있습니다. 2024년 5월 23일부터, 특정 기간 동안 각 개별 사용자가 상호작용하는 모든 비즈니스로부터 수신할 수 있는 마케팅 템플릿 메시지 수를 제한하며, 읽힐 가능성이 낮은 소수의 대화부터 적용합니다. 이 제한은 해당 사용자가 어떤 비즈니스로부터든 이미 수신한 마케팅 템플릿 메시지 수를 기반으로 결정되며, 귀사의 브랜드에 특정된 것이 아닙니다. 그러나 이는 귀사의 마케팅 템플릿 메시지 전달 가능성에 영향을 미칠 수 있습니다.

이 제한은 일반적으로 새로운 마케팅 대화를 시작하는 마케팅 템플릿 메시지에만 적용됩니다. 귀사의 브랜드와 WhatsApp 사용자 간에 이미 마케팅 대화가 열려 있는 경우, 해당 사용자에게 발송된 마케팅 템플릿 메시지는 영향을 받지 않습니다.

제한으로 인해 특정 사용자에게 마케팅 템플릿 메시지가 전달되지 않는 경우, Cloud API는 오류 코드 131026을 반환합니다. 그러나 이 오류 코드는 메시지 미전달을 초래할 수 있는 광범위한 문제를 포함하며, 개인정보 보호를 위해 Meta는 실제로 제한으로 인해 메시지가 전달되지 않았는지 여부를 공개하지 않습니다. 미전달 사유에 대한 설명과 근본 원인을 파악하기 위해 할 수 있는 조치에 대해서는 Cloud API의 [문제 해결 문서](https://developers.facebook.com/docs/whatsapp/cloud-api/support#troubleshooting)를 참조하세요.

이러한 오류 코드를 수신하고 제한 때문이라고 의심되는 경우, 템플릿 메시지를 즉시 재발송하지 마세요. 이는 또 다른 오류 응답만 초래합니다.

이 전달 가능성 업데이트에 대한 자세한 정보와 전달 가능성 모니터링 방법 및 WhatsApp 마케팅 메시징에 대한 기타 모범 사례에 대해서는 최근 [블로그 게시물](https://www.braze.com/resources/articles/meta-introduces-deliverability-updates-for-whatsapp?utm_campaign=fy25-q2-global-customer-customer-meta-deliverability-updates-for-whatsapp&utm_medium=email-cdb&utm_source=braze&utm_content=blog-meta-deliverability-updates-for-wa-blog)을 참조하세요.

### 2024년 4월: 유틸리티 템플릿에 대한 템플릿 페이싱 {#april-2024-template-pacing-for-utility-templates}
*최종 업데이트: 2024년 4월*

작년에 WhatsApp은 비즈니스가 템플릿의 참여도를 높이고 가치 있는 사용자 경험을 만들 수 있도록 돕는 새로운 방법으로 마케팅 메시지에 대한 템플릿 페이싱을 도입했습니다. 4월 30일부터 템플릿 페이싱이 유틸리티 메시지로 확대됩니다. 사용자 피드백으로 인해 계정의 유틸리티 템플릿이 일시 중지되면, 이후 7일간 생성되는 새로운 유틸리티 템플릿에 페이싱이 적용됩니다.

### 2024년 4월: 읽기율이 마케팅 템플릿의 품질 등급에 영향 {#april-2024-read-rates-will-affect-quality-rating-for-marketing-templates}
*최종 업데이트: 2024년 3월*

WhatsApp은 인도 소비자를 시작으로 더 가치 있는 경험을 만들고 비즈니스의 마케팅 대화 참여를 극대화하기 위한 새로운 접근 방식을 테스트하고 있습니다. 여기에는 특정 기간 동안 사용자가 어떤 비즈니스로부터든 수신하는 마케팅 대화 수를 제한하는 것이 포함될 수 있으며, 읽힐 가능성이 낮은 소수의 대화부터 적용됩니다. 메시지가 전달되지 않으면 Braze에서 오류 코드를 수신합니다.

WhatsApp은 차단 및 신고와 같은 기존 측정기준과 함께 마케팅 템플릿의 품질 등급에 읽기율을 고려하기 시작합니다. WhatsApp은 2024년 4월 1일부터 볼륨을 확대하기 전에 비즈니스가 참여도가 가장 낮은 템플릿을 개선할 시간을 주기 위해 읽기율이 낮은 마케팅 메시지 Campaign(캠페인)을 일시적으로 중지할 수 있습니다.

### 2024년 2월: 마케팅 대화 실험 {#february-2024-marketing-conversations-experimentation}
*최종 업데이트: 2024년 2월*

2024년 2월 6일부터 WhatsApp은 인도 소비자를 시작으로 더 가치 있는 경험을 만들고 귀사 브랜드의 마케팅 대화에 대한 고객 참여를 극대화하기 위한 새로운 접근 방식을 테스트하고 있습니다. 여기에는 특정 기간 동안 사용자가 귀사 브랜드로부터 수신하는 마케팅 대화 수를 제한하는 것이 포함될 수 있으며, 읽힐 가능성이 낮은 소수의 대화부터 적용됩니다.

### 2023년 10월: 템플릿 페이싱 {#october-2023-template-pacing}
*최종 업데이트: 2023년 10월*

2023년 10월 12일부터 WhatsApp은 마케팅 메시지에 대해 "템플릿 페이싱"이라는 개념을 도입합니다. 전체 Campaign(캠페인) 오디언스에게 메시지를 동시에 발송하는 대신, "템플릿 페이싱"은 먼저 소규모 사용자 하위 집합에 메시지를 전달하여 Campaign 수신자로부터 실시간 피드백을 수집한 후 나머지 메시지를 발송합니다.

"페이스 제한"(처음 발송되는 메시지의 하위 집합)은 템플릿에 따라 다릅니다. 초기 발송 후, WhatsApp은 나머지 메시지를 최대 30분간 보류합니다. 이 보류 기간 동안 고객 피드백을 기반으로 템플릿의 품질을 평가합니다. 피드백이 긍정적이어서 고품질 템플릿으로 판단되면 나머지 메시지를 전달합니다. 피드백이 부정적이면 미전달된 나머지 메시지를 삭제하여 더 많은 고객으로부터의 추가 부정적 피드백을 방지하고 잠재적인 품질 제재 문제(예: 전화번호 품질 등급 영향)를 피하는 데 도움을 줍니다.

WhatsApp은 템플릿 페이싱에서 템플릿 품질을 평가할 때 템플릿 일시 중지와 동일한 시스템을 사용합니다. 따라서 템플릿 페이싱 중 미전달된 메시지(저품질 템플릿으로 인한)는 더 큰 규모에서 일시 중지되었을 메시지와 동일합니다.

궁극적으로 이 업데이트는 더 빠른 피드백 루프(템플릿 일시 중지의 수 시간 또는 수일 대비 30분)를 제공하여 템플릿을 조정하고 더 나은 고객 경험을 제공할 수 있게 합니다.
...
2023년 6월 14일부터 Meta는 마케팅 메시지가 소비자 경험과 참여에 미치는 영향을 평가하기 위해 WhatsApp 플랫폼에 새로운 실험 방식을 도입합니다. 이 실험은 Braze와 함께 WhatsApp Business API에서 발송하는 마케팅 메시지에 영향을 미칠 수 있습니다.
...
실험에서 Meta는 WhatsApp 소비자의 약 1%를 무작위로 참가자로 선정합니다. 선정된 경우, 다음 중 하나가 해당되지 않는 한 Meta는 이 소비자에게 마케팅 메시지 템플릿을 전달하지 않습니다:

- 소비자가 지난 24시간 이내에 귀사에 응답한 경우
- 기존 마케팅 대화가 열려 있는 경우

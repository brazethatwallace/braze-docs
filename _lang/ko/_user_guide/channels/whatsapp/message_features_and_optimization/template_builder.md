...
**콘텐츠** > **WhatsApp**으로 이동한 다음 **새 템플릿 생성**을 선택합니다.
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="2단계: 템플릿 설정 구성" }
...
**제출**을 선택하여 Meta에 템플릿을 검토 요청합니다. 검토는 보통 몇 분 내에 완료되지만 최대 24시간이 걸릴 수 있습니다. 템플릿이 제출되면 **WhatsApp 템플릿** 페이지에 표시되며, **WhatsApp 템플릿** 페이지를 새로고침하면 상태가 업데이트됩니다.

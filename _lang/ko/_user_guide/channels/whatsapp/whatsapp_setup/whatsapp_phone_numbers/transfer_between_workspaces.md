...
3. 구독 그룹의 상태 위에 마우스를 올리고 <i class="fa-solid fa-box-archive"></i> **아카이브**를 선택합니다. 이렇게 하면 구독 그룹이 비활성으로 표시되지만 삭제되지는 않습니다.
...
3. **Create new subscription group and phone number** 옵션을 선택합니다.

...
| 템플릿 메시지 | 소비됨 | 마케팅, 유틸리티, 인증 및 한정 시간 오퍼 템플릿은 발송당 청구됩니다. |
| 서비스 창 내 유틸리티 템플릿 | Meta에 의해 소비되지 않음 | Meta는 사용자 시작 메시지 후 24시간 이내에 발송된 유틸리티 템플릿에 대해 요금을 부과하지 않습니다. Action Credit 소비는 계약에 따릅니다. |

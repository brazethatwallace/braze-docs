...
최근에 편집하거나 생성한 캠페인, 캔버스, 세그먼트를 다시 확인할 수 있습니다. 각 카드에는 콘텐츠 유형(캠페인, 캔버스, 세그먼트)과 상태(활성, 초안, 아카이브됨, 중지됨)를 나타내는 태그가 함께 표시됩니다.

{% alert note %}
**이전 작업 이어서 하기** 섹션은 캠페인, 캔버스 또는 세그먼트를 편집하거나 생성한 후에 표시됩니다.
{% endalert %}

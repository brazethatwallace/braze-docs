...
*사용자 고착도* 값은 특정 기간의 DAU 대비 MAU 비율입니다. 본질적으로 사용자 고착도는 MAU 중 매일 다시 방문하는 비율을 측정합니다.
...
*일일 세션*은 특정 날에 기록된 세션 수입니다. 이 값을 DAU 수와 비교하면 사용자가 최소 한 번의 세션을 기록한 날에 앱을 열거나 웹사이트를 방문하는 횟수를 파악할 수 있습니다.

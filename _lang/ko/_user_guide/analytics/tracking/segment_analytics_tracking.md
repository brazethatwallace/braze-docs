...
**Analytics** > **Revenue Report**로 이동하여 [이 Segment의 시간 경과에 따른 매출 및 구매]({{site.baseurl}}/user_guide/analytics/reports/revenue_report) 데이터를 확인합니다.
...
그래프 범례에서 Segment 이름을 선택하여 해당 Segment의 측정기준 표시 여부를 켜거나 끌 수 있습니다.
...
**Analytics** > **Custom events report**로 이동하여 [Segments의 시간 경과에 따른 커스텀 이벤트]({{site.baseurl}}/user_guide/data/activation/events/custom_events#analytics) 데이터를 확인합니다.

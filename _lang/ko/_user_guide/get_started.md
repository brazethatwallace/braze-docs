...
- **데이터 인프라 정교성:** Braze SDK만 구현하거나 이미 고객 데이터 플랫폼(CDP)을 사용하고 있다면 30일 만에 모든 설정을 완료할 수 있습니다. 최신 CDP를 사용하면 과정을 더 빠르게 진행할 수 있습니다. 하지만 Braze와 연결해야 할 백엔드 시스템, 도구 또는 데이터베이스가 많은 경우 시간이 더 오래 걸리고 설정을 완료하기 위해 더 많은 전담 리소스가 필요할 수 있습니다.

...
guide_top_text: "이메일 환경설정 센터를 생성하면 사용자가 이메일 Campaign 및 뉴스레터에 대한 알림 환경설정을 쉽게 관리할 수 있습니다. 다음 문서를 확인하여 <a href='/docs/api/endpoints/preference_center'>Braze 환경설정 센터 API</a> 또는 드래그 앤 드롭 편집기를 통해 환경설정 센터를 생성하고 관리하는 방법을 알아보세요."

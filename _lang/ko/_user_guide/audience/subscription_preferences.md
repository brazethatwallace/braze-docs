---
nav_title: 구독 환경설정
article_title: 구독 환경설정
page_order: 5
layout: dev_guide
guide_top_header: "구독 환경설정"
guide_top_text: "메시징 채널에 대한 사용자의 옵트인 및 옵트아웃 방식을 관리합니다. 채널 전반의 <a href='/docs/user_guide/audience/subscription_preferences/subscription_status'>구독 상태</a> 를 확인한 다음, 환경설정 센터를 사용하여 사용자가 이메일 커뮤니케이션 환경설정을 직접 제어할 수 있도록 합니다."

page_type: landing
description: "이 섹션에서는 환경설정 센터 및 구독 관리를 포함한 Braze의 구독 환경설정에 대해 다룹니다."

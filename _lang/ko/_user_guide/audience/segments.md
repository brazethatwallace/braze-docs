...
tool: Segments
page_type: landing
description: "이 랜딩 페이지에서는 대시보드 Campaigns 내 세분화에 대한 문서를 다룹니다. 여기에서 세그먼트 설정, 필터, 퍼널, 인사이트, 확장 등에 대한 정보를 확인할 수 있습니다."
...
## Braze 세그먼트 소개 {#about-braze-segments}

Braze에서 세그먼트는 사용자 속성, 사용자 동작, 커스텀 이벤트 등 여러분이 정의한 특정 기준에 맞는 동적 사용자 그룹입니다. 세그먼트를 다른 세그먼트 안에 중첩하고 추가 기능을 적용하여 기준을 세밀하게 조정할 수 있으며, 오디언스 범위를 좁혀 적합한 사용자에게 고도로 개인화된 매력적인 콘텐츠를 전송할 수 있습니다.

사용자를 타겟팅하기 위해 원하는 만큼 세그먼트를 생성할 수 있습니다. 세그먼트 기능과 세분화 필터의 다양한 조합을 탐색하여 사용자 데이터를 활용하는 창의적인 방법을 발견하고, 사용자에게 관련성 높은 메시지를 전송하여 참여를 높이는 새로운 방법을 찾아보세요.

아래 활용 사례를 통해 Braze 세그먼트가 사용자 타겟팅에 어떻게 도움이 되는지 간략히 살펴보세요.

### 활용 사례 {#use-cases}

- **환영 메시지:** 신규 사용자를 세분화하여 앱을 소개하는 온보딩 이메일이나 인앱 메시지를 전송할 수 있습니다.
- **로열티 보상:** 구매 빈도, 가입 기념일 또는 기타 마일스톤을 기준으로 사용자를 세분화하고, 가장 충성도 높은 사용자에게 독점 혜택이나 보상을 전송할 수 있습니다.
...
#### 세그먼트 확장 활용 사례 {#segment-extension-use-cases}

[세그먼트 확장]({{site.baseurl}}/user_guide/audience/segments/segment_extension/)을 사용하면 고객 프로필의 전체 기간 동안 저장된 커스텀 이벤트 또는 구매 동작을 기반으로 세그먼트를 더욱 세밀하게 조정할 수 있습니다.

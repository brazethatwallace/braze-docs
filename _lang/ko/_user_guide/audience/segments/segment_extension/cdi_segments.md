...
![콘텐츠 카드 모달 배치 예시.]({% image_buster /assets/img/segment/segment_extension_modal.png %}){: style="max-width:60%;"}

데이터 소스로 **CDI Data Tables**를 선택합니다.

![2단계: 세그먼트 생성 관련 스크린샷.]({% image_buster /assets/img/segment/cdi_data_tables.png %}){: style="max-width:60%;"}

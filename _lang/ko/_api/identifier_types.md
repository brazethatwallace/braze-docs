...
Braze의 앱 식별자는 SDK를 통합할 때 사용되며, REST API 호출에서 특정 앱을 참조하는 데에도 사용됩니다. `app_id`를 사용하면 특정 앱에 대해 발생한 커스텀 이벤트의 데이터를 가져오거나, 앱 삭제 통계, 신규 사용자 통계, DAU 통계, 세션 시작 통계를 조회하는 등 다양한 작업을 수행할 수 있습니다.

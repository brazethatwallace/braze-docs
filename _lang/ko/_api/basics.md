...
1. Braze에 로그인하고 **Settings** > **APIs and Identifiers** > **API Keys**로 이동합니다.
2. 기존 API 키를 선택하거나 **Create API Key**를 선택하여 새 키를 만듭니다.
...
1. **Settings** > **APIs and Identifiers**로 이동합니다.
2. **Create API Key**를 선택합니다.
...
API 키 권한은 특정 API 호출에 대한 액세스를 제한하기 위해 사용자 또는 그룹에 할당할 수 있는 권한입니다. API 키 권한 목록을 보려면 **Settings** > **APIs and Identifiers**로 이동하여 API 키를 선택하세요.
...
기존 REST API 키의 세부 정보를 보거나 삭제하려면 **Settings** > **APIs and Identifiers** > **API Keys** 탭으로 이동하세요. 생성한 후에는 REST API 키를 편집할 수 없습니다.

**API Keys** 탭에는 각 키에 대한 다음 정보가 포함됩니다:

| 필드        | 설명                                                                                                         |
| ------------ | :------------------------------------------------------------------------------------------------------------------ |
| API Key Name | 생성 시 키에 부여된 이름입니다.                                                                            |
| Identifier   | API 키입니다.                                                                                                        |

...
article_title: "POST: 유효하지 않은 전화번호 제거"
search_tag: Endpoint
page_order: 2
layout: api_page
page_type: reference
...
이 엔드포인트를 사용하려면 `sms.invalid_phone_numbers.remove` 권한이 있는 [API 키]({{site.baseurl}}/api/basics#rest-api-key-permissions)가 필요합니다.

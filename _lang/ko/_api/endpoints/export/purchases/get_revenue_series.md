...
---
{% api %}
# 시간별 매출 데이터 내보내기 {#export-revenue-data-by-time}
{% apimethod get %}
...
이 엔드포인트를 사용하려면 `purchases.revenue_series` 권한이 있는 [API 키]({{site.baseurl}}/api/basics#rest-api-key-permissions)가 필요합니다.

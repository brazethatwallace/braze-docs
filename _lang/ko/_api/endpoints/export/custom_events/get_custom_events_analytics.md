...
---
{% api %}
# 사용자 지정 이벤트 분석 내보내기 {#export-custom-events-analytics}
{% apimethod get %}
/events/data_series
{% endapimethod %}
...
| `segment_id` | 선택 사항 | 문자열 | [세그먼트 API 식별자]({{site.baseurl}}/api/identifier_types/)를 참조하세요. 이벤트 분석을 반환할 분석 활성화 세그먼트를 나타내는 Segment ID입니다. |

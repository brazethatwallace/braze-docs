...
이 엔드포인트로 메시지를 보내려면 [API 트리거 Campaign]({{site.baseurl}}/user_guide/messaging/campaigns/schedule_your_campaign/api_triggered_delivery/)을 만들 때 생성한 [Campaign ID]({{site.baseurl}}/api/identifier_types/)가 있어야 합니다.

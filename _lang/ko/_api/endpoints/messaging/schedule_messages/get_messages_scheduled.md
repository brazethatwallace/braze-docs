---
nav_title: "GET: 예정된 Campaigns 및 Canvases 목록 보기"
article_title: "GET: 예정된 Campaigns 및 Canvases 목록 보기"
search_tag: Endpoint
page_order: 0
layout: api_page
page_type: reference
description: "이 문서에서는 예정된 Campaigns 및 Canvases 목록 보기 Braze 엔드포인트에 대한 자세한 내용을 설명합니다."

---
{% api %}
# 예정된 Campaigns 및 Canvases 목록 보기 {#list-upcoming-scheduled-campaigns-and-canvases}
{% apimethod get %}
...
| 매개변수 | 필수 | 데이터 유형 | 설명 |
| --------- | -------- | --------- | ----------- |
| `end_time` | 필수 | [ISO-8601](https://en.wikipedia.org/wiki/ISO_8601) 형식의 문자열 | 예정된 Campaigns 및 Canvases를 검색할 범위의 종료일입니다. 이는 API에서 UTC 시간 기준 자정으로 처리됩니다. |

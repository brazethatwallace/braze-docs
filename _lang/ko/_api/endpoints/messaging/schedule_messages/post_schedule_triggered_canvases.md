---
nav_title: "POST: API 트리거 Canvases 예약하기"
article_title: "POST: API 트리거 Canvases 예약하기"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
description: "이 문서에서는 API 트리거 Canvases 예약하기 Braze 엔드포인트에 대한 자세한 내용을 설명합니다."
...
> 이 엔드포인트를 사용하면 API 트리거 전달을 통해 Canvas 메시지를 예약하여 메시지 전송을 트리거할 동작을 결정할 수 있습니다.

Canvas의 첫 번째 단계에서 전송되는 메시지에 템플릿으로 적용될 `context`를 전달할 수 있습니다.

...
layout: api_page
page_type: reference
description: "이 문서에서는 이메일 주소 또는 전화번호를 기준으로 구독 상태를 삭제하는 Braze 엔드포인트에 대해 자세히 설명합니다."

---

{% api %}
# 이메일 주소 또는 전화번호로 구독 상태 삭제하기 {#delete-subscription-state-by-email-address-or-phone-number}
{% apimethod delete %}
/users/subscription
{% endapimethod %}

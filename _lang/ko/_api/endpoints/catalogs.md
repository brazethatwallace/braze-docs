...
guide_top_text: "Braze 카탈로그 엔드포인트를 사용하여 카탈로그 및 카탈로그 항목 세부 정보를 추가, 편집 및 관리할 수 있습니다. 카탈로그를 대량으로 변경하려면 비동기 카탈로그 엔드포인트를 사용하세요. <br><br> 카탈로그 생성에 대한 안내가 필요하신가요? <a href='/docs/user_guide/personalization_and_dynamic_content/catalog'>카탈로그 생성 및 사용</a> 문서를 확인하세요."
...
guide_menu_title2: "비동기 카탈로그 항목 엔드포인트"
guide_menu_list2:
  - name: "DELETE: 여러 카탈로그 항목 삭제 엔드포인트"
...
guide_menu_title3: "동기 카탈로그 항목 엔드포인트"
guide_menu_list3:
...
guide_menu_title4: "비동기 카탈로그 필드 엔드포인트"
guide_menu_list4:
...
guide_menu_title5: "비동기 카탈로그 선택 엔드포인트"
guide_menu_list5:
  - name: "POST: 카탈로그 선택 항목 생성"

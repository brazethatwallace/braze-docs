...
guide_top_text: "구독 그룹 REST API를 사용하여 Braze 워크스페이스에 저장된 구독 그룹을 프로그래밍 방식으로 관리할 수 있습니다. 이는 이메일 및 SMS 구독 그룹 모두에 적용됩니다.<br><br> 대시보드에서 그룹을 생성하고 관리하는 방법에 대한 안내는 <a href='/docs/user_guide/audience/subscription_preferences/subscription_groups'>구독 그룹</a> 을 참조하세요."

...
guide_top_text: "Braze 사용자 데이터 엔드포인트를 사용하면 모바일 앱 외부에서 수신되는 사용자 데이터를 기록하여 사용자 정보를 추적할 수 있습니다. 이 API를 사용하여 테스트 또는 기타 목적으로 사용자를 삭제할 수도 있습니다. <br> <br> 모든 API 엔드포인트의 데이터 페이로드 제한은 4&nbsp;MB입니다. 4&nbsp;MB를 초과하는 데이터를 게시하려고 하면 HTTP 413 Request Entity Too Large 오류와 함께 실패합니다. <br> <br> 이 섹션의 예시에는 https://rest.iad-01.braze.com URL이 포함되어 있지만, 다른 엔드포인트 URL을 사용해야 할 수도 있습니다(예: Braze EU 데이터 센터에서 호스팅되거나 전용 Braze 설치를 사용하는 경우). 다른 엔드포인트 URL을 사용해야 하는 경우 Braze 고객 성공 매니저가 안내해 드립니다."

...
| 카테고리 | 포함 항목 | API 참조 |
| --- | --- | --- |
| 캠페인 | 성과 분석, 캠페인 세부 정보, 캠페인 목록, 발송 분석 | [캠페인 엔드포인트]({{site.baseurl}}/api/endpoints/export/campaigns/get_campaign_analytics/) |
| 캔버스 | 데이터 시리즈 분석, 분석 요약, Canvas 세부 정보, Canvas 목록 | [캔버스 엔드포인트]({{site.baseurl}}/api/endpoints/export/canvas/get_canvas_analytics/) |
| 세그먼트 | 세그먼트 목록, 세그먼트 분석, 세그먼트 세부 정보 | [세그먼트 엔드포인트]({{site.baseurl}}/api/endpoints/export/segments/get_segment/) |
...
| 카테고리 | 메서드 | 엔드포인트 |
| --- | --- | --- |
| 캠페인 | GET | [Campaign 분석]({{site.baseurl}}/api/endpoints/export/campaigns/get_campaign_analytics/) |
| 캠페인 | GET | [Campaign 세부 정보]({{site.baseurl}}/api/endpoints/export/campaigns/get_campaign_details/) |
| 캠페인 | GET | [Campaign 목록]({{site.baseurl}}/api/endpoints/export/campaigns/get_campaigns/) |
| 캠페인 | GET | [발송 분석]({{site.baseurl}}/api/endpoints/export/campaigns/get_send_analytics/) |
| 캔버스 | GET | [Canvas 데이터 시리즈 분석]({{site.baseurl}}/api/endpoints/export/canvas/get_canvas_analytics/) |
| 캔버스 | GET | [Canvas 분석 요약]({{site.baseurl}}/api/endpoints/export/canvas/get_canvas_analytics_summary/) |
| 캔버스 | GET | [Canvas 세부 정보]({{site.baseurl}}/api/endpoints/export/canvas/get_canvas_details/) |
| 캔버스 | GET | [Canvas 목록]({{site.baseurl}}/api/endpoints/export/canvas/get_canvases/) |
...
| KPI | GET | [날짜별 일일 신규 사용자 KPI]({{site.baseurl}}/api/endpoints/export/kpi/get_kpi_daily_new_users_date/) |
| KPI | GET | [날짜별 일일 활성 사용자 KPI]({{site.baseurl}}/api/endpoints/export/kpi/get_kpi_dau_date/) |
| KPI | GET | [지난 30일간 월간 활성 사용자 KPI]({{site.baseurl}}/api/endpoints/export/kpi/get_kpi_mau_30_days/) |
| KPI | GET | [날짜별 제거 KPI]({{site.baseurl}}/api/endpoints/export/kpi/get_kpi_uninstalls_date/) |
...
| 구매 | GET | [시간별 매출 데이터]({{site.baseurl}}/api/endpoints/export/purchases/get_revenue_series/) |
| 세그먼트 | GET | [세그먼트 목록]({{site.baseurl}}/api/endpoints/export/segments/get_segment/) |
| 세그먼트 | GET | [세그먼트 분석]({{site.baseurl}}/api/endpoints/export/segments/get_segment_analytics/) |
| 세그먼트 | GET | [세그먼트 세부 정보]({{site.baseurl}}/api/endpoints/export/segments/get_segment_details/) |
...
| 사용자 데이터 | POST | [세그먼트별 사용자 데이터]({{site.baseurl}}/api/endpoints/export/user_data/post_users_segment/) |

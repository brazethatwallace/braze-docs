---
nav_title: "POST: 새 대시보드 사용자 계정 생성"
article_title: "POST: 새 대시보드 사용자 계정 생성"
alias: /post_create_user_account/
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
description: "이 문서에서는 새 대시보드 사용자 계정 생성 Braze 엔드포인트에 대한 자세한 내용을 설명합니다."

---

{% api %}
# 새 대시보드 사용자 계정 생성 {#create-new-dashboard-user-account}
{% apimethod post %}
/scim/v2/Users
{% endapimethod %}

> 이 엔드포인트를 사용하여 이메일, 이름과 성, 권한(회사, 워크스페이스, 팀 수준에서 권한 설정)을 지정하여 새 대시보드 사용자 계정을 생성합니다.
...
해당 `userName` 또는 이메일 주소를 가진 사용자가 이미 Braze에 존재하는 경우, 엔드포인트는 다음과 같이 응답합니다:

...
# Braze 핵심 API 엔드포인트 {#braze-core-api-endpoints}
...
Braze의 API 핵심 엔드포인트는 Braze REST API 내의 특정 엔드포인트로, Braze 계정의 서비스 수준 계약(SLA)에 따라 허용된 중단 시간이 적용됩니다. 자세한 내용은 SLA 설명서를 참조하거나 계정 매니저에게 문의하세요.

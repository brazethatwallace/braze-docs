...
<b>RCS:</b> 전달된 메시지 세그먼트, 전달된 발송 횟수 <br>
<b>LINE:</b> 발송 횟수<br>
<b>KakaoTalk:</b> 발송 횟수<br>
...
## 메시지 크레딧 - Theta 크레딧 비율 표 {#credit-ratio-table-for-message-credits-theta}

{% details 클릭하여 펼치기 %}
<table class="credits-table" aria-label="메시지 크레딧 - Theta 크레딧 비율 표">
    <colgroup>
        <col span="3">
...
웹훅은 2024년 12월 9일부터 메시지 크레딧에 포함되었습니다. Braze는 Braze 플랫폼에서 전송된 모든 웹훅에 대해 메시지 크레딧을 청구합니다. 기본적으로 계약에는 구독 기간의 각 기간당 십만 건의 웹훅이 포함됩니다. 추가 웹훅은 주문서에 따라 청구됩니다.

...
# WhatsApp 크레딧 비율 (기밀) {#whatsapp-credit-ratios-confidential}

> {% multi_lang_include whatsapp/about_credits.md content="h2" %}

## 크레딧 비율 표 {#credit-ratio-table}

{% details 클릭하여 펼치기 %}
<table class="credits-table" aria-label="크레딧 비율 표">
    <colgroup>
        <col span="3">

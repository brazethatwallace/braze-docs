...
| **1회 발송당 크레딧** | 1회 발송을 수행하는 데 필요한 정확한 메시지 크레딧 수<br> (발송당 크레딧 = 크레딧 비율 x 대상 배수) |
...
RCS는 SMS와 MMS의 차세대 버전입니다. SMS와 같은 직접적이고 높은 참여도의 채널 장점을 제공하면서, 현대 소비자가 기대하는 리치 콘텐츠(이미지, 동영상, 문서), 인증 및 브랜드 발송, 추천 답변 및 동작과 같은 인터랙티브 기능 등 더 풍부한 기능을 갖추고 있습니다.

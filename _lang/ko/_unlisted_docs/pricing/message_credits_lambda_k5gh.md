...
> 메시지 크레딧은 Braze의 네이티브 Agent Console, 단문 메시지 서비스, MMS, RCS, WhatsApp, LINE 오퍼링을 위한 Braze의 교차 제품 패키징 구조입니다. 메시지 크레딧은 Braze 메시징 채널과 특정 인공지능 기능을 활용할 때 유연하고 투명한 경험을 제공합니다. 크레딧을 통해 이 페이지의 표에 제시된 모든 채널에 접근할 수 있습니다.

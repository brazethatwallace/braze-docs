...
| 매개변수 | 필수 | 데이터 유형 | 설명 |
|---|---|---|---|
| `campaign_id` | 필수 | 문자열 | [Campaign API 식별자](https://www.braze.com/docs/api/identifier_types/#campaign-api-identifier)를 참조하세요. |
...
| 오류 | 문제 해결 |
| --- | --- |
| `Missing/Invalid Campaign ID` | Campaign API ID는 API 식별자여야 합니다. [Campaign 목록 내보내기 엔드포인트](https://www.braze.com/docs/api/endpoints/export/campaigns/get_campaigns/)를 사용하거나 대시보드에 로그인하여 확인할 수 있습니다. |
| `Missing/Invalid Message Variant ID` | 메시지 배리언트 API ID는 API 식별자여야 합니다. [Campaign 세부 정보 내보내기 엔드포인트](https://www.braze.com/docs/api/endpoints/export/campaigns/get_campaign_details/)를 사용하거나 대시보드에 로그인하여 확인할 수 있습니다. |

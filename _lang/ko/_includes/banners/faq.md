...
사용자가 새 세션을 시작하거나 동작을 수행한 후 배너를 새로고침하면, Braze가 자격 여부를 평가합니다. "구매" Segment에 해당하면 높은 우선순위의 배너가 표시됩니다.


## 사용자가 배너를 수동으로 닫을 수 있나요? {#can-users-manually-dismiss-a-banner}

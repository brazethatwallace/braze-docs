...
### 단축 URL은 얼마 동안 유효하나요? {#how-long-do-shortened-urls-remain-valid}
...
### 링크를 단축하려면 Braze SDK를 설치해야 하나요? {#does-the-braze-sdk-need-to-be-installed-in-order-to-shorten-links}

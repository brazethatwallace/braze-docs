...
| `blocked_media_url` | 보안 정책에 의해 미디어 URL이 차단되었습니다. |
| `invalid_media_url` | 미디어 URL이 유효하지 않거나 확인할 수 없습니다. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="콘텐츠 및 렌더링 미디어 URL" }
...
| `http_timeout` | 응답을 받기 전에 HTTP 요청이 시간 초과되었습니다. |
| `missing_hostname` | 요청 URL에 호스트 이름이 없습니다. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="콘텐츠 및 렌더링 HTTP와 SSL" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="이메일" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="푸시" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="인앱 메시지" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="웹훅" }

...
| `clickAction` | 버튼 클릭 동작 유형입니다. 유형은 `URI` 및 `NONE`입니다. |
| `dismissType` | 메시지 닫기 유형입니다. 두 가지 유형은 `SWIPE` 및 `AUTO_DISMISS`입니다. |
| `messageType` | SDK에서 지원하는 인앱 메시지 유형입니다. 네 가지 유형은 `SLIDEUP`, `MODAL`, `FULL` 및 `HTML_FULL`입니다. |
...
인앱 메시지 모델에 대한 전체 참조는 [Android](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/index.html) 및 [iOS](https://braze-inc.github.io/braze-swift-sdk/documentation/brazekit/braze/inappmessage) 설명서를 참조하세요.
...
버튼 모델에 대한 전체 참조는 [Android](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-message-button/index.html) 및 [iOS](https://braze-inc.github.io/braze-swift-sdk/documentation/brazekit/braze/inappmessage/button) 설명서를 참조하세요.
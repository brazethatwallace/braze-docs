...
다음 예시에서는 음악 스트리밍 앱에서 사용자가 노래를 들을 때 다양한 이벤트를 기록하려고 합니다. Android용 Google Tag 매니저를 사용하여 어떤 서드파티 업체 or 위탁 업체 or 타사 공급업체가 이 이벤트를 수신할지 제어하고, Braze 전용 태그를 생성할 수 있습니다.

...
[BrazeAI Decisioning Studio™](https://www.braze.com/product/brazeai-decisioning-studio/)는 A/B 테스트를 모든 것을 개인화하는 의사결정 에이전트로 대체하며, 모든 측정기준을 극대화합니다. 클릭이 아닌 매출을 유도하세요&#8212;Decisioning Studio를 통해 모든 비즈니스 측정기준을 최적화할 수 있습니다.

BrazeAI<sup>TM</sup> 의사결정 에이전트는 모든 고객에게 최적의 동작을 자동으로 발견합니다. BrazeAI<sup>TM</sup>는 퍼스트파티 데이터를 사용하여 교차 판매, 업셀, 재구매, 유지, 갱신, 추천, 재유치 등 다양한 사용 사례에 대해 모든 비즈니스 KPI or 핵심 성과 지표(KPI) or KPI or 핵심 성과 지표(KPI) or KPI or 핵심 성과 지표(KPI) or KPI or 핵심 성과 지표(KPI) or 핵심 성과 지표(KPI or 핵심 성과 지표(KPI))를 극대화할 수 있습니다.


자세한 내용을 알아보거나 Decisioning Studio를 시작하려면 Braze에 [상담을 예약하세요](https://www.braze.com/get-started/).

![Decisioning Studio 피드백 루프 개요]({% image_buster /assets/img/decisioning_studio/decisioniong_studio_feedback_loop.png %})
...
- **모든 측정기준을 극대화하세요:** 클릭 수가 곧 매출을 의미하지는 않습니다. BrazeAI<sup>TM</sup>를 사용하여 매출, 이익, 고객 생애주기 가치 또는 기타 비즈니스 KPI or 핵심 성과 지표(KPI) or KPI or 핵심 성과 지표(KPI) or KPI or 핵심 성과 지표(KPI) or KPI or 핵심 성과 지표(KPI) or 핵심 성과 지표(KPI or 핵심 성과 지표(KPI))를 극대화하는 오퍼나 인센티브를 선택하세요.
...
BrazeAI Decisioning Studio™를 사용하면 비즈니스 측정기준을 최적화하는 의사결정 에이전트를 설계하고 배포할 수 있습니다.
...
두 가지 모두 BrazeAI<sup>TM</sup>에 의해 구동되지만, 의사결정 에이전트와 Braze 에이전트는 마케팅 스택에서 서로 다른 목적을 수행합니다.

**의사결정 에이전트**는 Campaign의 전략적 오케스트레이터입니다. Campaign 수준에서 운영되며, 매출, 전환 또는 ARPU와 같은 비즈니스 측정기준을 극대화하기 위해 오퍼, 채널, 타이밍, 빈도와 같은 차원에서 지속적으로 실험을 수행합니다. 의사결정 에이전트는 재유치, 교차 판매 또는 갱신과 같은 전체 사용 사례를 관리하며, 시간이 지남에 따라 각 개별 고객에게 가장 적합한 동작 조합을 학습합니다.

**Braze 에이전트**는 개별 캔버스 단계 또는 카탈로그 필드 내에 존재하는 AI 기반 도우미입니다. 대규모 언어 모델(LLM)을 사용하여 콘텐츠(개인화된 제목란이나 메시지 카피 등)를 생성하고, 고객 컨텍스트에 따라 라우팅 결정을 내리거나, 동적으로 생성된 값으로 카탈로그를 풍부하게 만듭니다. Braze 에이전트는 Campaign 내 특정 터치포인트에 창의성과 개인화를 가져오는 데 뛰어납니다.

이렇게 생각해 보세요: 의사결정 에이전트는 전체 Campaign 전략을 오케스트레이션하는 지휘자이고, Braze 에이전트는 고객 여정의 각 순간에 창의성과 뉘앙스를 더하는 연주자입니다. 이 둘을 함께 사용할 수 있습니다. 의사결정 에이전트가 각 고객에게 최적의 오퍼와 채널을 결정하게 한 다음, Braze 에이전트를 사용하여 해당 특정 메시지에 대한 개인화된 카피를 생성합니다.

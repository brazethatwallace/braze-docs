...
BrazeAI<sup>TM</sup> 의사결정 에이전트는 모든 고객에게 최적의 동작을 자동으로 발견합니다. BrazeAI<sup>TM</sup>는 퍼스트파티 데이터를 사용하여 교차 판매, 업셀, 재구매, 유지, 갱신, 추천, 재유치 등 다양한 사용 사례에 대해 모든 비즈니스 핵심 성과 지표(KPI)를 극대화할 수 있습니다.
...
- **모든 측정기준을 극대화하세요:** 클릭 수가 곧 매출을 의미하지는 않습니다. BrazeAI<sup>TM</sup>를 사용하여 매출, 이익, CLV 또는 기타 비즈니스 핵심 성과 지표(KPI)를 극대화하는 오퍼나 인센티브를 선택하세요.

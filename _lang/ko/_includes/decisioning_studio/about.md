...
BrazeAI<sup>TM</sup> 의사결정 에이전트는 모든 고객에게 최적의 동작을 자동으로 발견합니다. BrazeAI<sup>TM</sup>는 퍼스트파티 데이터를 사용하여 교차 판매, 업셀, 재구매, 유지, 갱신, 추천, 재유치 등 다양한 사용 사례에 대해 모든 비즈니스 KPI를 극대화할 수 있습니다.

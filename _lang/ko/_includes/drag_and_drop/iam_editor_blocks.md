## 인앱 메시지 편집기 블록 사용 {#using-in-app-message-editor-blocks}

편집기 블록은 인앱 메시지의 **Build** 섹션 아래에 위치합니다. 사용하려면 편집기 블록을 열 안으로 드래그하세요. 열 너비에 맞게 자동으로 조정됩니다. 각 편집기 블록에는 패딩에 대한 세분화된 제어와 같은 자체 설정이 있습니다. 오른쪽 패널은 선택한 콘텐츠 요소의 등록정보 패널로 자동 전환됩니다.

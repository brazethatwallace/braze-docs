...
guide_top_header: "FA 아이콘을 사용한 다중 섹션 랜딩 페이지"
guide_top_text: "다중 섹션 랜딩 페이지는 일반적으로 주제별로 섹션 내 페이지를 구분하여 큰 섹션을 구성하는 데 유용합니다. 이 특정 템플릿은 'dev_guide' 레이아웃 yaml 매개변수('layout: dev_guide')를 사용하며, 페이지 하단에 추가 정보를 넣을 수는 없지만 여러 섹션의 버튼을 배치할 수 있습니다."

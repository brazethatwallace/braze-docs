...
# 규정 준수 설명서 {#compliance-documentation}
...
### 웹훅 채널 사용 조건 {#webhooks-channel-use-terms}
...
### 웹훅 채널 사용 조건의 예외 {#exceptions-to-the-webhook-channel-use-terms}
...
### 자체 WhatsApp 커넥터(BYO WhatsApp Connector) {#bring-your-own-byo-whatsapp-connector}

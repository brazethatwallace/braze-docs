...
[개인화된 배리언트]({{site.baseurl}}/user_guide/messaging/ab_testing/optimizations/)를 사용하여 타겟 Segment의 각 사용자에게 참여 가능성이 가장 높은 배리언트를 보내세요.

## Canvas 테스트 {#testing-canvases}
Canvas를 만든 후에는 오디언스 규모나 세분화 필터 수와 같은 세부 사항에 따라 시작하기 전에 수행해야 할 몇 가지 점검 사항이 있습니다. 팁은 [테스트 Canvases 보내기]({{site.baseurl}}/user_guide/messaging/canvas/testing_canvases/sending_test_canvases/)에서 확인하세요.

## Liquid 5
기존 회사 사용자의 경우, Liquid 5가 정식으로 제공됩니다. [Liquid 5의 새로운 기능]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid/#whats-new-with-liquid-5)에 대해 자세히 알아보세요.
...
- [React Native SDK v1.38.0–v1.38.1](https://github.com/braze-inc/braze-expo-plugin/blob/main/CHANGELOG.md)
	...
	- 이제 Braze React Native Android SDK는 컴파일 시 Kotlin을 직접 사용해야 합니다.

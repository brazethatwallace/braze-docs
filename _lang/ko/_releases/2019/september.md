...
## Canvas 체인지로그 {#canvas-changelogs}

계정에서 Canvas 작업을 하는 사람에 대한 세부 정보가 더 궁금하셨나요? 더 이상 궁금해하지 마세요! 이제 Canvas 체인지로그에 액세스할 수 있습니다.

![Canvas 체인지로그]({% image_buster /assets/img/canvas-changelog1.png %})
![Canvas 체인지로그]({% image_buster /assets/img/canvas-changelog2.png %})
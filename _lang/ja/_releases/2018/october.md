...
**キャンペーン分析**に移動して、オーディエンスの正確な統計を計算できます。**ターゲットオーディエンス** セクションのフッターにある [**Calculate Exact Stats (正確な統計を計算)**] をクリックすると、正確なオーディエンス統計が入力されます。計算する前にキャンペーンを保存する必要があります（下書きキャンペーンは下書きとして保存されます）。

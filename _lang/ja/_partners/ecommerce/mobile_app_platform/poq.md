...
PoqとBrazeの統合により、ネイティブモバイルアプリ体験をBrazeのカスタマーエンゲージメントプラットフォームに接続できます。BrazeのiOSおよびAndroid SDKを使用して、BrazeはPoqを搭載したアプリに直接統合され、モバイルでのセグメンテーション、パーソナライゼーション、ターゲットCampaign配信が可能になります。
...
| 分析とイベントトラッキング | Poqはカスタマージャーニー全体をカバーする包括的なアプリイベントセットをBrazeに送信します。このデータにより、Brazeでのセグメンテーション、Campaignトリガー、パーソナライゼーションが可能になります。 |

...
> [Okendo](https://okendo.io/)は、アドボカシーの育成、口コミの拡大、生涯価値の最大化のためのツールを提供する統合カスタマーマーケティングプラットフォームであり、より迅速で効率的な成長のために顧客を動員します。
...
OkendoはユーザープロファイルデータをBrazeのカスタム属性として送信し、オーディエンスSegmentsの作成に利用できます。例としては次のようなものがあります:

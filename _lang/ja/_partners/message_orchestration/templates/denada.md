...
BrazeとDenadaのインテグレーションにより、Denadaで作成したメールテンプレートを、Brazeメディアライブラリへの画像の自動アップロードを含め、Brazeに直接エクスポートできます。これにより、クリエイティブなアイデア出しからキャンペーン実行までのプロセスが効率化されます。
...
アップロードされたDenadaのメールは、Brazeの**テンプレートとメディア** > **メールテンプレート**で確認できます。Brazeのキャンペーンやキャンバスですぐに使用できます。

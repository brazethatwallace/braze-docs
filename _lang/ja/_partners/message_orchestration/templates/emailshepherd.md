...
- **エージェント型Campaign作成を活用する:** AIエージェントがメールデザインシステムのガードレール内で構築するため、作成されたCampaignsはブランドに沿っており、すぐに送信できます。
...
Brazeで、エクスポートされたメールを**コンテンツ** > **メール**で確認できます。これらのテンプレートはBrazeのCampaignsやCanvasesで使用できます。

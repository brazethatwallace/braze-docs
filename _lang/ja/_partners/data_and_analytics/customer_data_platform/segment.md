...
guide_top_text: "セグメントは、企業が顧客を第一に考えるための顧客データ・インフラを提供している。セグメント の活用により、ファーストパーティの顧客データを収集、一元化でき、メール、Web、広告、POS、モバイルを含め、200以上のツールに接続できます。セグメント の活用により、ユーザーの共通の理解を得て自社データを有効化し、パーソナライズされたカスタマーファーストの体験を提供できます。"
description: "このランディングページは、顧客データプラットフォームである セグメント に関するあらゆる情報のホームページです。"

---
nav_title: セグメント for Currents
article_title: セグメント for Currents
page_order: 2
alias: /partners/segment_for_currents/
description: "このリファレンス記事では、Braze Currentsと、マーケティングスタック内のソース間で情報を収集しルーティングする顧客データプラットフォームであるセグメントとの連携について概説します。"
page_type: partner
tool: Currents
search_tag: Partner
...
### ステップ 1:セグメントライトキーの取得 {#step-1-obtain-segment-write-key}

セグメントダッシュボードで、セグメントソースを選択します。次に、**設定** > **APIキー**に移動します。ここで**セグメント Write Key**を確認できます。
...
2. **+ Create New Current** > **セグメントデータのエクスポート**をクリックします。

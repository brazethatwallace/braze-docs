...
BrazeとSimon AIの統合を使用して、高度なオーディエンスを構築し、リアルタイムかつノーコードのオーケストレーションのためにBrazeに同期できます。この統合により、Simon AIのID解決、顧客データ統合、AI駆動のセグメンテーションを活用して、よりパーソナライズされた効果的なBraze キャンペーンを下流で実行できます。

  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <ul>
          <li>ユーザーのセグメント化、Campaignのトリガー</li>
          <li>メッセージのパーソナライズ</li>
        </ul>
      </td>
      <td>
...
- AIRで報酬を発行するためのCampaignをBrazeで設定する

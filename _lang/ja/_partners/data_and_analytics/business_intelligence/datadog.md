...
BrazeとDatadogの統合により、顧客はDatadogでBrazeデータを収集し、送信するデータに関するアラートを作成できます。たとえば、毎週のニュースレターCampaignで送信されるメッセージの量が異常に少ない場合や、通常は1日に数通しか送信しないキャンバスステップが数千通を送信し始めた場合に、モニターとアラートを設定できます。

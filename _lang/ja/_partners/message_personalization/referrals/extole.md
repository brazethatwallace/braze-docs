...
- 紹介プログラムやエンゲージメントプログラムのカスタムイベントを使用して、Braze CampaignやCanvasをトリガーする
- Extoleを使用したプログラムのデータを使用して、カスタムSegment、ダッシュボード、レポートを作成する
...
デフォルトでは、Extoleは`FULFILLED`状態のリワードイベントをBrazeに送信します。このため、Braze CampaignまたはCanvasを通じてリワード通知をトリガーできます。その他のリワード状態については、以下の表を参照してください。

...
BrazeとCataBoomの連携を使用して、パーソナライズされたゲームリンクをメッセージに追加できます。ユーザー識別子と属性をCatapult キャンペーンとBrazeの間でリアルタイムに受け渡すことができます。そのデータを使用して、パーソナライズされたキャンペーン、トリガー、フォローアップジャーニーを実行できます。

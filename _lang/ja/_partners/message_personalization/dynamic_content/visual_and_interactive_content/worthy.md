...
Worthyメッセージクリエーターで**Export**をクリックし、**Braze**を選択して、パーソナライズされたメッセージをBraze キャンペーンで使用するためにエクスポートします。エクスポートされたコンテンツを、Braze キャンペーンエディターの**HTML + Asset Zip**の下にあるHTMLテキストボックスにコピーします。

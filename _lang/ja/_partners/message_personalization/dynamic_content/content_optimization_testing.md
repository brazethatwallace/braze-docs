...
article_title: "コンテンツの最適化とテスト"
page_type: landing
description: "コンテンツの最適化とテストに関するテクノロジーパートナー連携をご覧ください。"
layout: dev_guide
search_tag: Partner

guide_top_header: "コンテンツの最適化とテスト"
guide_top_text: "コンテンツの最適化とテストに関するテクノロジーパートナー連携をご覧ください。Brazeテクノロジーパートナーの完全な検索・フィルター可能なリストについては、<a href='https://marketplace.braze.com/t/type/technology-partner'>Braze Marketplace</a> をご覧ください。"

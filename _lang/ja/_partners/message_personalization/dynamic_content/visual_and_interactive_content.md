...
article_title: ビジュアルコンテンツとインタラクティブコンテンツパートナー
page_type: landing
description: "このランディングページでは、メッセージパーソナライゼーション向けのビジュアルコンテンツとインタラクティブコンテンツを提供するBrazeテクノロジーパートナーを紹介しています。"
layout: partner_page
search_tag: Partner

partner_top_header: "ビジュアルコンテンツとインタラクティブコンテンツ"

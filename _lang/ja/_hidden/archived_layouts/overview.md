...
セレクターレイアウトの典型的な例は、[SDK変更ログ](https://www.braze.com/docs/developer_guide/changelogs)ページ、または[アプリ内メッセージクリエイティブ詳細ページ](https://www.braze.com/docs/user_guide/message_building_by_channel/in-app_messages/creative_details/)です。

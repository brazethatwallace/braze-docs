...
### オプション1:アカウントと案件のカタログを使用する {#option-1-use-catalogs-for-accounts-and-opportunities}
...
### ステップ2.2:ユーザープロファイルとビジネスオブジェクト間の関係を作成する {#step-22-create-a-relationship-between-user-profiles-and-your-business-objects}

...
article_title: "はじめに: ユーザーとSegments"
page_order: 2
page_type: reference
description: "この記事では、ユーザーとSegmentsの概要を示し、その意義と、オーディエンスをエンゲージするためにどのように活用できるかについて概説します。"

---

# はじめに: ユーザーとSegments {#get-started-users-and-segments}

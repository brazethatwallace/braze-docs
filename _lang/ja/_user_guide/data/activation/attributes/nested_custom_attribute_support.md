...
![パーソナライゼーションタイプが「階層化カスタム属性」、トップレベル属性が「preferences」、属性キーが「neighborhood_office」に設定されたパーソナライゼーションを追加モーダル。結果のタグのLiquidプレビューが表示されています。]({% image_buster /assets/img_archive/nca_personalization.png %}){: style="max-width:70%" }

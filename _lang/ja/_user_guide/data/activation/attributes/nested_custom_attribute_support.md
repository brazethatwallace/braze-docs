...
3. プロファイルにすでに階層化カスタム属性を持つ既存のユーザーで**プレビュー＆テスト**を使用して、値が期待どおりにレンダリングされることを確認します。
...
2. 階層化カスタム属性を検索します。
3. 属性の**属性名**列で、<i class="fas fa-plus" aria-label="スキーマを管理"></i> **スキーマを管理**を選択してスキーマを管理します。

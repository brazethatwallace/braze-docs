...
サポートされているカタログのデータタイプ、説明、各データタイプの作成・更新方法（CSV vs API および CDI）、フォーマットと例については、[データタイプ]({{site.baseurl}}/user_guide/data/activation/custom_data/data_types/#catalog-data-types)を参照してください。

...
guide_top_text: "カタログトリガーは、カタログデータの変更に基づいて自動的に送信される通知です。手動でCampaignを設定することなく、顧客が関心を持つアイテムが再入荷したり、価格が下がったりしたときに通知を送ることができます。"

page_type: landing
description: "再入荷アラートや値下げ通知など、カタログデータの変更によってトリガーされる自動通知を設定します。"

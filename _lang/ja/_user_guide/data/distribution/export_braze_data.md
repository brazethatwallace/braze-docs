...
guide_menu_title2: Currents によるデータのエクスポート
guide_menu_description2: "Braze Currents を使用したデータのエクスポートを活用したいですか？Currents ツールは、エンゲージメントイベントのリアルタイムデータストリームであり、Braze プラットフォームから最も堅牢かつ詳細なエクスポートを提供します。詳しくは以下の記事をご覧ください。"
guide_menu_list2:
  - name: Braze Currents

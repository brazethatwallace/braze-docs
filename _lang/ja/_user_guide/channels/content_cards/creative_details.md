...
![画像のみのContent Cardの推奨詳細と画像のみの例の画像]({% image_buster /assets/img/content_card_banner.png %}){: style="max-width:45%;border:0;"}
...
![空のContent Cardsフィードの画像]({% image_buster /assets/img/empty-cc.png %}){: style="max-width:45%"}

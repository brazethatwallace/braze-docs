...
SMSとRCSのサブスクリプショングループが別々の場合、1ステップのCanvasを使用してユーザーをSMSからRCSに移行できます。
...
Canvasにユーザーの更新ステップを追加します。ステップ内で**Advanced JSON Editor**を開き、以下を入力します（ユニークユーザー識別子フィールドには、`braze_id`フィールドの使用をお勧めします）。
...
Canvasのテストが正常に完了したら、ユーザーのサブセットに対してCanvasを起動しましょう。

---
nav_title: コンプライアンスと配信
article_title: コンプライアンスと配信
page_order: 4
layout: dev_guide
guide_top_header: "コンプライアンスと配信"
guide_top_text: "SMS、MMS、RCSメッセージが規制に準拠し、配信性とユーザーの信頼に関するベストプラクティスに従っていることを確認してください。"
page_type: landing
description: "SMS、MMS、RCSメッセージングのコンプライアンスと配信性を管理します。法律と規制、オプトイン、地理的権限などが含まれます。"
channel:
  - SMS
  - MMS
  - RCS

...
**目標：**顧客満足度を測定し、低いスコアを付けたユーザーに奪還キャンペーンを送信する。
...
ユーザーがアンケートを送信すると、選択した値がカスタム属性として記録されます。その後、オーディエンスフィルターを使用してフォローアップキャンペーンを作成できます。たとえば、`customer_satisfaction`属性が「1」または「2」のユーザーに奪還メッセージをターゲティングできます。

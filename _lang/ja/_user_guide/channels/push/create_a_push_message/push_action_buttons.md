...
- [クイックプッシュCampaign]({{site.baseurl}}/quick_push/)の場合、**Settings**タブで各プラットフォームごとにアクションボタンを個別に設定できます。
...
1. 標準Campaignの場合は**Compose**タブで、クイックプッシュの場合は**Settings**タブでアクションボタンを有効にします。

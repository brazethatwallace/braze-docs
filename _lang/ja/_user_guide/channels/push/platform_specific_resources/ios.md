...
channel: push
platform: iOS
description: "このランディングページでは、BrazeのiOSプッシュに特化したすべての情報を一覧で紹介しています。"

guide_top_header: "iOSプッシュオプション"
guide_top_text: "以下の記事では、BrazeのiOSプッシュに特化したすべての情報を紹介しています。"

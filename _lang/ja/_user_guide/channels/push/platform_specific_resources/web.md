...
Webプッシュは、スマートフォンのアプリプッシュ通知と同じように機能します。Webプッシュの作成について詳しくは、[プッシュ通知を作成する]({{site.baseurl}}/user_guide/channels/push/create_a_push_message/#creating-a-push-message)をご覧ください。

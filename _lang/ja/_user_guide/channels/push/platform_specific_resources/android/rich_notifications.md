...
[キャンペーンの作成]({{site.baseurl}}/user_guide/channels/push/create_a_push_message#create-a-push-message)の手順に従って、Android向けのプッシュ通知を作成します。リッチコンテンツを含まないプッシュ通知の設定と同じコンポーザーを使用します。

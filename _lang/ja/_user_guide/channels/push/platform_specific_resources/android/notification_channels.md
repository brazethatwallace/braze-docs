...
繰り返しになりますが、Android Oへのターゲティングをスムーズに移行するために、開発チームと連携することをお勧めします。
...
3. **Manage Notification Channels**を選択します。ここで追加されたチャネルは、すべてのキャンペーンとキャンバスでグローバルに利用可能になります。チャネルを管理するには、ワークスペースの「Manage Apps」[権限]({{site.baseurl}}/user_guide/administer/global/user_management/permissions)が必要です。

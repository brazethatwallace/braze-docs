...
アーカイブされた購読グループは編集できず、セグメントフィルターやユーザーSettingsセンターに表示されなくなります。メール、Campaign、またはCanvasのセグメントフィルターとして使用されているグループをアーカイブしようとすると、そのグループのすべての使用箇所を削除するまでアーカイブを防止するエラーメッセージが表示されます。

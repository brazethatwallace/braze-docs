...
[アクションパス]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/action_paths/)のキャンバスステップまたはアクションベースのキャンペーンを作成します。**WhatsAppインバウンドメッセージを送信**トリガーと**Flowに応答**条件を選択し、該当するFlowまたは**任意のFlow**を選択します。

...
WhatsAppは、ブロックやレポートなどの従来の指標に加えて、マーケティングテンプレートの品質評価の一部として既読率を考慮し始めます。WhatsAppは、2024年4月1日から、既読率が低いマーケティングメッセージCampaignsを一時的に停止し、ビジネスがボリュームを拡大する前にエンゲージメントが最も低いテンプレートを改善する時間を提供する場合があります。
...
2023年10月12日から、WhatsAppはマーケティングメッセージに「テンプレートペーシング」という概念を導入しています。Campaignのオーディエンス全体に同時にメッセージを送信する代わりに、「テンプレートペーシング」では最初にユーザーの小さなサブセットにメッセージを配信し、Campaign受信者からのリアルタイムフィードバックを収集してから残りのメッセージを送信します。

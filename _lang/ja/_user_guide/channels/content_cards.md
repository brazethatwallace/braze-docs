...
- **一元化されたレポート:** コンテンツカードの分析はBrazeで追跡されるため、すべてのCampaignsのインサイトを一箇所で確認できます。
...
- ロイヤルティ登録CampaignsでContent Cardsを使用すると、コンバージョンが**5倍**向上します。[^1]
...
{% alert tip %}
さらにインスピレーションを得るには、[コンテンツカードインスピレーションガイド](https://www.braze.com/resources/reports-and-guides/content-cards-inspiration-guide)を参照してください。紹介プログラム、新製品の発売、サブスクリプションの更新など、20以上のカスタマイズ可能なCampaignsが含まれています。
{% endalert %}

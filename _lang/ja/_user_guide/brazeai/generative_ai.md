...
guide_top_text: "BrazeAI<sup>TM</sup>の生成AI機能は、Brazeダッシュボードに組み込まれた統合AIアシスタントである<a href=\"{{site.baseurl}}/user_guide/brazeai/operator/\">BrazeAI Operator™</a> を通じて利用できます。コピー、画像、Liquid、HTMLメールテンプレートの生成やコンテンツのレビューを、普段作業している画面からそのまま行えます。"
description: "BrazeAI<sup>TM</sup>の生成AI機能は、Brazeダッシュボードに組み込まれた統合AIアシスタントであるBrazeAI Operator™を通じて利用できます。"

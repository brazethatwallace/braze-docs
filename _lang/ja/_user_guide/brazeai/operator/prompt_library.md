...
{% include copy_block.html content="How much Attributed Revenue and Conversions did campaigns generate for users excluded by our caps in the last 30 days (7-day window)?" available="セグメントエクステンションs" %}
...
{% include copy_block.html content="Which セグメントエクステンションs are active but haven't been processed recently, and are they safe to archive for free slots?" available="セグメントエクステンションs" %}

...
{% alert tip %}
ステップバイステップのウォークスルーについては、Braze Learningコースをご覧ください：[Crafting Personalized Experiences with AI](https://learning.braze.com/ai-item-recommendations-use-case/1996254)。
{% endalert %}
...
### ステップ1：Liquidコードの追加 {#step-1-add-liquid-code}
...
メッセージ作成画面の**パーソナライゼーションを追加**セクションからLiquidを生成できます。
...
2. **パーソナライゼーションタイプ**で、**Item Recommendation**を選択します。
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="ステップ1：Liquidコードの追加" }
...
### ステップ2：画像を参照する（オプション） {#step-2-reference-an-image-optional}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="ステップ2：画像を参照する（オプション）" }

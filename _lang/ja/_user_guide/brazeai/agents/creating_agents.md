...
2. **Canvasステップエージェント**または**カタログエージェント**を選択します。
...
### Canvasステップエージェントテンプレート {#canvas-step-agent-templates}
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Canvasステップエージェントテンプレート" }

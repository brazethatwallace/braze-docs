...
article_title: プライバシーポータル
page_order: 9
layout: dev_guide
search_rank: 3
guide_top_header: "Braze プライバシーポータル"
guide_top_text: "> Braze プライバシーポータルへようこそ。ここでは、Braze がどのように顧客データの適切な管理を支援し、重要な点として、貴社のビジネスに関連するデータ保護規則を遵守するための対策を講じることができるかについて、さまざまな有益な情報をご覧いただけます。適用されるデータ保護法および規制を遵守して Braze サービスをご利用いただく際に役立つ情報およびドキュメントへのリンクをまとめています。"
guide_top_text2: "<h4>顧客の役割</h4><br>Braze を使用する場合、Braze の顧客は、どのデータを収集し Braze サービスと共有するかを決定するデータ管理者です。Braze サービスに関して、Braze は顧客の指示に基づいて個人データを処理するデータ処理者です。顧客は、自身に適用されるデータ保護法および規制に従って Braze サービスを使用する責任を負います。"
guide_top_text3: "<h4>コンプライアンスにおけるパートナー</h4><br>優れたパートナーとして、当社はデータ保護に関する最新の動向やプラクティスを常に把握しています。たとえば、EU および英国の一般データ保護規則（「GDPR」）、カリフォルニア州プライバシー権法により改正されたカリフォルニア州消費者プライバシー法（「CCPA」）、およびその他の米国州プライバシー法に対応するデータ処理に関する追記を提供しています。<br><br>Braze サービスには、エンドユーザーの同意管理、「販売または共有の拒否」リクエストの処理、削除リクエストなどの消費者の権利行使を可能にする機能が含まれています。"
...
- name: デフォルトおよび最小の SDK データ収集
  ...
  image: /assets/img/braze_icons/settings-01.svg
- name: キャンバスオーディエンス同期のデータプライバシーに関する考慮事項
...
{% alert important %}
**法的免責事項**<br>
ここに記載されている情報は教育目的でのみ提供されており、法的助言として解釈されるべきものではありません。Braze は、すべてのお客様に対し、データ保護法および規制に準拠した Braze の使用について、お客様自身の法的助言を求めることを推奨します。
{% endalert %}
...
- **REST API エンドポイント：**メッセージの送信、キャンペーンの作成、データのエクスポートなどのアクション。
...
API と統合するために、Braze外部 API からアクセスしたいセグメント、キャンペーン、Content Cardsなどに関連する識別子を検索できます。すべてのメッセージは [UTF-8](https://en.wikipedia.org/wiki/UTF-8) エンコーディングに従う必要があります。いずれかを選択すると、ドロップダウンメニューの下に識別子が表示されます。

...
- **REST API エンドポイント：**メッセージの送信、Campaigns の作成、データのエクスポートなどのアクション。
...
API と統合するために、Braze 外部 API からアクセスしたい Segments、Campaigns、Content Cards などに関連する識別子を検索できます。すべてのメッセージは [UTF-8](https://en.wikipedia.org/wiki/UTF-8) エンコーディングに従う必要があります。いずれかを選択すると、ドロップダウンメニューの下に識別子が表示されます。

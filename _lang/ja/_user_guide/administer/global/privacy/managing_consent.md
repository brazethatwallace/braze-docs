...
- **チーム:**真のガバナンスを実現するために、[Braze のチーム]({{site.baseurl}}/user_guide/administer/global/user_management/teams/)を使用します。そして、すべてのユーザープロファイルに、同意ステータス、同意日、またはその両方を示すカスタム属性を追加します。次に、すべてのキャンペーンとキャンバスをその指定チームに移行し、ダッシュボードのユーザー権限を適宜調整する必要があります。

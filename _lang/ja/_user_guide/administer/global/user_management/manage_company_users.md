...
{% alert tip %}
ユーザーのプロファイルに記載されている部署によって、Brazeから受信するコミュニケーションの種類が決まります。これにより、各ユーザーはBrazeの使用方法に関連するコミュニケーションやアラートのみを受信できます。
{% endalert %}
...
ユーザーを削除するには、**設定** > **会社ユーザー**に移動し、ユーザー名を見つけて、<i class="fa fa-trash-can"></i> **ユーザーを削除**を選択します。

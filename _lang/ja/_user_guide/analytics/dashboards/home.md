...
- **CSVアップロード**: CSVでアップロードされたユーザーは、`date_of_first_session`または`date_of_last_session`が指定されている場合、またはその後セッションを記録した場合にのみカウントされます。
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="MAU計算例" }

...
page_order: 4
page_type: reference
description: "このリファレンス記事では、CampaignとCanvasを複製する方法について説明します。"
tool:
    - Campaigns
    - Canvas
---
...
2. Campaignにカーソルを合わせ、<i class="fas fa-gear"></i> **その他のアクション**を選択します。
3. **複製**を選択します。
{% endtab %}
...
1. **メッセージング** > **Canvas** に移動します。
2. Canvasの行にカーソルを合わせ、<i class="fas fa-ellipsis-vertical"></i> **その他のアクション**を選択します。
3. **複製**を選択します。

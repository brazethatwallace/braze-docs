...
CampaignまたはCanvasをステータスでフィルタリングするには、**All Statuses**を選択し、ステータスを選びます。
...
| 下書き | CampaignおよびCanvasの下書きは保存されていますが、起動されていません。編集を続けて送信を開始するには、Brazeダッシュボードで**Messaging**に移動し、**Canvas**または**Campaigns**を選択して下書きを選びます。 |

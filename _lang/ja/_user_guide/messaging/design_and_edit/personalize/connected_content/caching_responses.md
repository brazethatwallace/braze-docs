...
- コネクテッドコンテンツのキャッシュはURLとワークスペースに基づいています。コネクテッドコンテンツの呼び出しが同一のURLに対するものであれば、キャンペーンやキャンバス間でキャッシュを共有できます。
- キャッシュはユニークなURLに基づいており、ユーザーIDやキャンペーンには基づいていません。つまり、URLが同じであれば、コネクテッドコンテンツ呼び出しのキャッシュされたバージョンが、ワークスペース内の複数のユーザーやキャンペーンで使用される場合があります。

...
guide_top_text: "マーケティングは、アーティストのセンスと専門的なツールを必要とする科学です。キャンバスを使えば、厳密さと創造性を組み合わせて、各顧客にとって意味のある、関連性が高く、魅力的なエクスペリエンスを作り出すことができます。キャンバスは、マーケターが複数のメッセージを含むキャンペーンを作成するための統合インターフェイスです。ビジュアルジャーニービルダーとして、一連のステップからまとまりのあるユーザーフローを構築できます。このセクションの記事では、キャンバスの作成、構築、テスト、最適化について順を追って説明します。<a href='https://learning.braze.com/canvas-course'>キャンバスBraze Learningコース</a> もぜひご覧ください！"
search_rank: 3
page_type: landing
tool: Canvas

...
{% alert note %}
レンダリングはデバイスのOSとプッシュクライアントに依存します。公開前に配置を確認するために、自分のデバイスに[テストメッセージ]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/sending_test_messages)を送信してください。
{% endalert %}

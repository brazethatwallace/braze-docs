...
まだ保存していない場合は、**Save as draft**を選択します。ページのカスタマイズを開始するには、**Edit landing page**を選択します。ドラッグ＆ドロップエディターにデフォルトテンプレートがプリロードされ、ユースケースに合わせてカスタマイズできます。
...
ランディングページテンプレートを使用して、次のキャンペーン用のテンプレートを作成できます。これらのテンプレートは、ランディングページエディターとダッシュボードの**Templates**セクション（**Templates** > **Landing Page Templates**）の両方からアクセスおよび管理できます。ランディングページテンプレートには名前が必須で、説明はオプションです。

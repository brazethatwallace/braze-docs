---
nav_title: アプリ内メッセージテンプレート
article_title: アプリ内メッセージテンプレート
page_order: 4
layout: dev_guide
guide_top_header: "アプリ内メッセージテンプレート"
guide_top_text: "アプリ内メッセージテンプレートは、**Templates** > **In-App Message Templates**から作成・管理できます。ドラッグ＆ドロップエディターからレイアウトを保存したり、従来のエディター用のカラープロファイルやCSSテンプレートを作成したりできます。また、Brazeのビルトインテンプレートを使用してすばやく開始することもできます。"
description: "テンプレートの作成方法、Brazeテンプレート、従来のエディター用のカラープロファイルとCSSテンプレートなど、Brazeのアプリ内メッセージテンプレートについて説明します。"

guide_featured_title: "セクション記事"
guide_featured_list:
  - name: アプリ内メッセージテンプレートの作成
    link: /docs/user_guide/messaging/templates/in_app_message_templates/in_app_message_template
    image: /assets/img/braze_icons/brush-02.svg

guide_menu_title: "Brazeテンプレート"
guide_menu_list:
  - name: オンボーディングフロー
    link: /docs/user_guide/messaging/templates/in_app_message_templates/onboarding
    image: /assets/img/braze_icons/flag-01.svg
  - name: "SMS、RCS、WhatsApp登録フォーム"

...
- アクティブなCampaignsは、中断なくアーカイブされたテンプレートを引き続き使用します。
- 下書きのCampaignsは、アーカイブされたテンプレートのコンテンツを保持し、編集および起動できます。
- アーカイブされたテンプレートを編集するには、まずアーカイブを解除する必要があります。同様に、アーカイブされたテンプレートをCampaignに使用するには、まずテンプレートのアーカイブを解除する必要があります。

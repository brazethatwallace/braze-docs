...
guide_top_text: "メールのユーザー設定センターを作成すると、ユーザーがメールキャンペーンやニュースレターの通知設定を簡単に管理できるようになります。以下の記事を参照して、<a href='/docs/api/endpoints/preference_center/'>Brazeユーザー設定センターAPI</a> またはドラッグ＆ドロップエディターを使用してユーザー設定センターを作成・管理する方法をご確認ください。"

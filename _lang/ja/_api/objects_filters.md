...
page_order: 1.5
description: "このランディングページには、Braze APIコールで使用されるBraze APIオブジェクトとフィルターが一覧表示されています。"
...
### メッセージングオブジェクト {#messaging-objects}
  ...
  - [Webオブジェクト]({{site.baseurl}}/api/objects_filters/messaging/web_objects)
  - [Webhookオブジェクト]({{site.baseurl}}/api/objects_filters/messaging/webhook_object)

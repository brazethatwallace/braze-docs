...
**メッセージング** > **Campaigns**に移動して**キャンペーンを作成**を選択し、**API Campaigns**を選択します。これで、APIキャンペーンの設定に進むことができます。
...
1. メッセージを送信した後にCampaignsページで結果を見つけられるように、わかりやすいタイトルを追加します。
...
4. **Save Campaign**をクリックすると、APIキャンペーンを開始する準備が整います。

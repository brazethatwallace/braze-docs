...
Brazeで**Settings**に移動し、**Setup and Testing**で**SDK Debugger**を選択します。
...
### ステップ5: 再現ステップを完了する {#step-5-complete-the-reproduction-steps}
...
### ステップ7: セッションを共有またはエクスポートする（オプション） {#step-7-share-or-export-your-session-optional}

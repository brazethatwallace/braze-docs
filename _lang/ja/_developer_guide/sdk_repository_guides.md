---
nav_title: リポジトリガイド
article_title: リポジトリガイド
page_order: 5.6
description: "Braze SDKのパブリックREADMEファイルから毎週同期されるミラーリポジトリガイドをご覧ください。"
toc_headers: h2
---

# リポジトリガイド {#repository-guides}

> これらのページは、Braze SDKリポジトリのパブリックREADMEファイルをミラーリングしたものです。自動化により毎週同期され、各ページからサンプルプロジェクトや追加のコンテキストを含むソースリポジトリにリンクしています。

## 利用可能なリポジトリガイド {#available-repository-guides}

以下のリポジトリガイドからプラットフォーム別にお選びください。

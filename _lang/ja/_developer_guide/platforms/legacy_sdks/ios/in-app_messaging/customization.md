...
guide_top_text: "Brazeのアプリ内メッセージタイプはすべて、メッセージ、画像、<a href='http://fortawesome.github.io/Font-Awesome/'>Font Awesome</a> アイコン、クリックアクション、分析、編集可能なスタイル、カスタム表示オプション、カスタム配信オプションなど、高度なカスタマイズが可能です。<a href='/docs/user_guide/message_building_by_channel/in-app_messages/create/'>ダッシュボード内</a> からアプリ内メッセージごとに複数のオプションを設定できます。さらに、Brazeはさまざまなユースケースとニーズを満たすために、複数レベルの高度なカスタマイズを提供しています。"
description: "このランディングページでは、デリゲートの設定、向きのカスタマイズ、カスタム表示処理など、Braze iOS SDKのアプリ内メッセージカスタマイズオプションについて説明します。"

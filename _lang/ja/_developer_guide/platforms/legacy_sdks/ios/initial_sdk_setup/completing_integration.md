...
## ステップ 1:アプリデリゲートを更新する {#step-1-update-your-app-delegate}
...
## ステップ 2:データクラスターを指定する {#step-2-specify-your-data-cluster}
...
## Appboy.sharedInstance()とSwiftのnullability {#appboysharedinstance-and-swift-nullability}

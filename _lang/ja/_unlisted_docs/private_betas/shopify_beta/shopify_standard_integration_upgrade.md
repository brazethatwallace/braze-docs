...
連携を通じて利用可能な新しいeコマースCanvasテンプレートと製品パーソナライゼーション用の事前定義されたHTMLブロックの完全なリストについては、[Canvasユーザージャーニーの作成]({{site.baseurl}}using_shopify_with_braze#create-your-canvas-user-journeys)を参照してください。
...
- **アクティブなCanvases、Campaigns、Segments：**正常に機能していることを確認します。

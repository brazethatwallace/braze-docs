...
![A caixa de diálogo "Add a new container" no Xcode para configurar um grupo de app, com um campo de texto pré-preenchido com "group.".]({% image_buster /assets/img/ios/push_story/add_app_groups.png %})

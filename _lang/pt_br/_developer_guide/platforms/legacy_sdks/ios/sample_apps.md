...
Vários aplicativos de teste estão disponíveis no [repositório GitHub do SDK para iOS](https://github.com/appboy/appboy-ios-sdk). Siga estas instruções para compilar e executar nossos aplicativos de teste.

1. Crie um novo [espaço de trabalho]({{site.baseurl}}/user_guide/get_started/workspaces) e anote a chave de API do identificador do app.
2. Insira sua chave de API no campo apropriado no arquivo `AppDelegate.m`.

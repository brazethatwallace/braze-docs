...
### O Appboy iOS SDK 4.7.0 chegou ao fim de vida útil? {#is-appboy-ios-sdk-470-end-of-life}
...
### Qual é a versão mínima do Swift SDK para suporte em produção? {#what-is-the-minimum-swift-sdk-version-for-production-support}
...
### BrazeKitCompat e BrazeUICompat são compatíveis para uso em produção no Swift SDK 17.x? {#are-brazekitcompat-and-brazeuicompat-supported-for-production-use-on-swift-sdk-17x}
...
### Posso atrasar a inicialização do SDK até depois do consentimento do usuário? {#can-i-delay-sdk-initialization-until-after-user-consent}
...
### Qual é a versão mínima do Swift SDK necessária para a inicialização atrasada? {#what-is-the-minimum-swift-sdk-version-required-for-delayed-initialization}
...
### O que acontece com os eventos recebidos antes da inicialização do SDK? {#what-happens-to-events-received-before-the-sdk-is-initialized}

...
![Uma mensagem no app que desliza da parte inferior da tela do telefone exibindo "Humans are complicated. Custom engagement shouldn't be." Em segundo plano, está a mesma mensagem no app exibida no canto inferior de uma página da web.]({% image_buster /assets/img/slideup-behavior.gif %}){: style="border:0px;"}
...
![Uma mensagem modal no app no centro da tela do telefone exibindo "Humans are complicated. Custom engagement shouldn't be." No plano de fundo está a mesma mensagem no app exibida no centro de uma página da web.]({% image_buster /assets/img/modal-behavior.gif %}){: style="border:0px;"}
...
![Uma mensagem no app em tela inteira exibida em toda a tela do telefone, que diz: "Humans are complicated. Custom engagement shouldn't be." Em segundo plano está a mesma mensagem no app exibida em grande parte no centro de uma página da web.]({% image_buster /assets/img/full-screen-behavior.gif %}){: style="border:0px;"}

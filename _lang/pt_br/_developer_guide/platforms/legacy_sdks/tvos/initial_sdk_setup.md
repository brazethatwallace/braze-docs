...
![Novo espaço de trabalho do projeto Xcode criado pelo CocoaPods. Use esse espaço de trabalho do Xcode em vez do seu projeto do Xcode.]({% image_buster /assets/img_archive/podsworkspace.png %})

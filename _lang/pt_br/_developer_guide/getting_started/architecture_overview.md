...
Seu anúncio de produto foi enviado a todos os clientes que gostaram de um item semelhante no seu app. Você definiu esses dados como um evento personalizado. O SDK fez o rastreamento desse evento e segmentou sua base de usuários de acordo. A Braze orquestrou a melhor hora do dia para enviar esse anúncio e personalizou o anúncio chamando Mel pelo nome preferido dela.

Quando Mel abre o anúncio, ela adiciona seu novo produto à lista de desejos. A Braze rastreia automaticamente que ela clicou no e-mail. O SDK rastreia que ela colocou seu novo produto na lista de desejos. Cada vez que eles se engajam com a sua marca, você e seus usuários aprendem mais um sobre o outro.

![Diagrama mostrando como a Braze rastreia ações de usuários em diferentes canais de envio de mensagens.]({% image_buster /assets/img/getting-started/putting-it-all-together.png %})
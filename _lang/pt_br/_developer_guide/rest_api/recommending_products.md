...
## Etapa 2: Recuperar metadados de produtos {#step-2-retrieve-product-metadata}
...
#### Criar modelos de itens usando a recomendação do usuário {#template-items-using-a-users-recommendation}
...
### Opção B: Conteúdo conectado {#option-b-connected-content}
...
4. No dashboard da Braze, acesse a página de resultados da Campaign ou do Canvas e confirme que o envio foi registrado.

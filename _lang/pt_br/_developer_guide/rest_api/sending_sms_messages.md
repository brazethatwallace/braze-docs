...
article_title: Envio de mensagens SMS usando a REST API
page_order: 2
page_type: reference
description: "Este artigo de referência explica como enviar mensagens SMS usando a REST API da Braze e uma Campanha da API."
channel:
  - SMS
---

# Envio de mensagens SMS usando a REST API {#sending-sms-messages-using-the-rest-api}
...
1. Envie uma solicitação de API conforme descrito na [Etapa 2](#step-2-send-an-sms-message-using-the-api), usando seu próprio ID de usuário como destinatário.

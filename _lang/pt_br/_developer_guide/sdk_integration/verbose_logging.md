...
description: "Aprenda como ativar o registro detalhado para o SDK or kit de desenvolvimento de software da Braze, coletar logs para solução de problemas e compartilhá-los com o suporte da Braze."
---

# Registro detalhado

> O registro detalhado fornece informações detalhadas e de baixo nível do SDK or kit de desenvolvimento de software da Braze, permitindo que você veja como o SDK or kit de desenvolvimento de software é inicializado, se comunica com os servidores e processa canais de mensagens como push, mensagens no app e Cartões de Conteúdo.

Quando algo não está funcionando como esperado—como uma notificação por push não chegando, uma mensagem no app não sendo exibida ou dados de usuários não sincronizando—os logs detalhados ajudam você a identificar a causa raiz. Em vez de adivinhar, você pode ver exatamente o que o SDK or kit de desenvolvimento de software está fazendo em cada etapa.

{% alert tip %}
Se você quiser depurar sem ativar o registro detalhado manualmente, pode usar o [Depurador de SDK or kit de desenvolvimento de software]({{site.baseurl}}/developer_guide/sdk_integration/debugging) para criar sessões de depuração diretamente no dashboard da Braze.
{% endalert %}
...
- **Verificar a inicialização do SDK or kit de desenvolvimento de software**: Confirme se o SDK or kit de desenvolvimento de software inicia corretamente com a chave de API or interface de programação do aplicativo (API) e o endpoint corretos.
...
- **Depurar links profundos**: Verifique se o SDK or kit de desenvolvimento de software recebe e abre links profundos de push, mensagens no app ou Cartões de Conteúdo.
- **Validar rastreamento de sessões**: Confirme se as sessões começam e terminam como esperado.
- **Diagnosticar problemas de conectividade**: Inspecione as requisições e respostas de rede entre o SDK or kit de desenvolvimento de software e os servidores da Braze.
...
Ative o registro detalhado antes de qualquer outra chamada de SDK or kit de desenvolvimento de software no seu `Application.onCreate()` método para capturar a saída mais completa.
...
Para detalhes completos, veja [registro do SDK or kit de desenvolvimento de software Android]({{site.baseurl}}/developer_guide/sdk_integration#android_enabling-logs).
...
O nível `.debug` é o mais detalhado e é recomendado para solução de problemas. Para detalhes completos, veja [registro do SDK or kit de desenvolvimento de software Swift]({{site.baseurl}}/developer_guide/sdk_integration#swift_log-levels).

{% endtab %}
{% tab Web %}

Adicione `?brazeLogging=true` como um parâmetro de URL, ou ative o registro durante a inicialização do SDK or kit de desenvolvimento de software:
...
Os registros aparecem na aba **Console** das ferramentas de desenvolvedor do seu navegador. Para detalhes completos, veja [registro do SDK or kit de desenvolvimento de software Web]({{site.baseurl}}/developer_guide/sdk_integration#web_logging).
...
3. No campo **Nível de Registro do SDK or kit de desenvolvimento de software**, insira `0`.

{% endtab %}
{% tab React Native %}

Defina o nível de registro durante a configuração do SDK or kit de desenvolvimento de software:
...
3. Filtre por `V/Braze` ou `D/Braze` para isolar a saída do Braze SDK or kit de desenvolvimento de software.
...
4. **Versão do SDK or kit de desenvolvimento de software**: A versão do SDK or kit de desenvolvimento de software do Braze que você está usando.

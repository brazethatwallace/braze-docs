...
1. Confirme o endpoint de SDK e o acesso à rede.
   - Verifique se você está usando o [endpoint de SDK]({{site.baseurl}}/user_guide/administer/personal/sdk_endpoints) correto para o seu espaço de trabalho.
...
3. Valide a configuração de confiança.
   - Confirme se os certificados raiz e intermediários necessários estão instalados e são confiáveis no ambiente de execução onde o SDK está rodando.

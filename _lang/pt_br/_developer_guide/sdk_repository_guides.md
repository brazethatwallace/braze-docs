---
nav_title: Guias de repositório
article_title: Guias de repositório
page_order: 5.6
description: "Leia guias de repositório espelhados, sincronizados semanalmente a partir dos arquivos README públicos do SDK da Braze."
toc_headers: h2
---

# Guias de repositório {#repository-guides}

> Estas páginas espelham os arquivos README públicos dos repositórios do SDK da Braze. Elas são sincronizadas semanalmente por meio de automação, e cada página contém um link para o repositório de origem com projetos de exemplo e contexto adicional.

## Guias de repositório disponíveis {#available-repository-guides}

Escolha entre os seguintes guias de repositório por plataforma:

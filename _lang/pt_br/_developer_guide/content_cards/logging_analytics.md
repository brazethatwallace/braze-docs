...
Se os Content Cards aparecem corretamente no seu app, mas você não recebe nenhuma análise de dados de forma consistente (destinatários únicos, impressões, cliques etc.), provavelmente trata-se de um problema de integração de SDK.

...
Agora você pode colocar endereços de e-mail [em uma lista de proibições]({{site.baseurl}}/api/endpoints/email/post_blacklist) por meio da API da Braze. A inclusão de um endereço de e-mail na lista de proibições cancelará a inscrição do usuário no e-mail e o marcará como hard bounce.

...
As empresas podem usar o Okta para controlar o acesso à Braze e permitir ou forçar seus usuários da empresa a fazer login usando as credenciais do Okta. Para obter acesso a esse novo produto, entre em contato com seu gerente de sucesso do cliente, gerente de conta ou abra um [tíquete de suporte]({{site.baseurl}}/braze_support/).

...
Adicionamos um novo evento "Performed Conversion" e um filtro "In Canvas Control" para melhorar as opções de redirecionamento. Saiba mais sobre o uso de [filtros de redirecionamento]({{site.baseurl}}/user_guide/messaging/campaigns/ideas_and_strategies/retargeting_campaigns).
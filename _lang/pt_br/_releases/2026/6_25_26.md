...
Ao criar um agente no **Console do agente**, você pode optar por criar um agente personalizado ou selecionar uma opção em **Criar um agente com o Operator** para usar o BrazeAI Operator e aplicar um modelo inicial. O Operator pode pré-configurar instruções, campos de saída e contexto para os seguintes modelos iniciais do Console do agente.
...
- Configurar casos de uso pré-definidos com o Operator pelo menu suspenso do botão **Criar agente**.
...
Para um rastreamento de cliques mais granular para Banners, você pode [atribuir um identificador personalizado]({{site.baseurl}}/user_guide/channels/banners/create_a_banner/#step-32-define-on-click-behavior-optional) a cada elemento interativo usando o campo **Identificador para relatório** no painel de propriedades.

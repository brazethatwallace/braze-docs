...
## Atualização no endpoint de exportação de usuários por Segment {#update-to-export-users-by-segment-endpoint}

A partir de dezembro de 2021, as seguintes alterações entrarão em vigor para o [endpoint Exportar usuários por Segment]({{site.baseurl}}/api/endpoints/export/user_data/post_users_segment/):

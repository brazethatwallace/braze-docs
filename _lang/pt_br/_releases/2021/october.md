...
- Não utilizada em nenhuma campanha, Canvas ou segmento ativo
- Não utilizada em nenhuma campanha, Canvas ou segmento inativo (rascunho, interrompido ou arquivado)
...
A [Shopify]({{site.baseurl}}/partners/shopify) é uma empresa de comércio global líder que fornece ferramentas confiáveis para abrir, expandir, comercializar e gerenciar um negócio de varejo de qualquer tamanho. Juntas, a integração da Braze com a Shopify permite que as marcas conectem sua loja Shopify perfeitamente com a Braze para passar webhooks selecionados da Shopify para a Braze. Aproveite as estratégias de mensagens integradas entre canais da Braze e o Canvas para redirecionar seus usuários com mensagens de checkout abandonado e incentivar os clientes a concluir sua compra, ou redirecionar os usuários com base em suas compras anteriores.
...
Após [configurar o servidor MCP do Braze]{% if include.section == "user" %}({{site.baseurl}}/user_guide/brazeai/mcp_server/setup/){% elsif include.section == "developer" %}({{site.baseurl}}/developer_guide/mcp_server/setup/){% endif %}, você pode interagir com a Braze usando linguagem natural. Veja alguns exemplos para começar.
...
### Relatório em vários espaços de trabalho {#report-across-multiple-workspaces}
...
### Resumo semanal da integridade de Campaigns {#summarize-weekly-campaign-health}

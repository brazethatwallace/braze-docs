...
## Integração do Decisioning Studio {#integrating-decision-studio}
...
Fale com o seu CSM do BrazeAI Decisioning Studio™ e peça para ativar o BrazeAI Decisioning Studio™. A equipe usará sua chave de API da Braze e a URL do endpoint para concluir a configuração da sua integração.

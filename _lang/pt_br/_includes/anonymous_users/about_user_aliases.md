...
- Usar a API or interface de programação do aplicativo (API) Braze para registrar eventos e atributos associados a usuários anônimos
...
{% alert tip %}
Para um guia completo, veja [SDK or kit de desenvolvimento de software Braze: Definindo um alias de usuário]({{site.baseurl}}/developer_guide/analytics/setting_user_ids/#setting-a-user-id).
{% endalert %}
{% endif %}
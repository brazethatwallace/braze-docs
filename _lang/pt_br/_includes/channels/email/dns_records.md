...
| Google Cloud DNS | [Início rápido: configurar registros DNS para um nome de domínio com o Cloud DNS](https://docs.cloud.google.com/dns/docs/set-up-dns-records-domain-name) |

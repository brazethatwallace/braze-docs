...
| URL do dashboard | Endpoint REST or transferir estado representacional | endpoint de SDK or kit de desenvolvimento de software or endpoint do SDK or kit de desenvolvimento de software |
| --- | --- | --- |
...
| Instância | URL | Endpoint REST or transferir estado representacional | endpoint de SDK or kit de desenvolvimento de software or endpoint do SDK or kit de desenvolvimento de software |
| --- | --- | --- | --- |

...
| Arquivar Campaigns | `archive_campaigns` |
| Ver Canvas | `view_canvases` |
| Editar Canvas | `edit_canvases` |
| Arquivar Canvas | `archive_canvases` |
| Ver regras do limite de frequência | `view_frequency_caps` |
| Editar regras do limite de frequência | `edit_frequency_caps` |
...
| Arquivar Content Blocks | `archive_content_blocks` |
| Ver Feature Flags | `view_feature_flags` |
...
| Arquivar Segments | `archive_segments` |
...
| Lançar Content Blocks | `launch_content_blocks` |

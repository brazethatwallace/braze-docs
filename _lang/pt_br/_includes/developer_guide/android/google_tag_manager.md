...
Após o Google Tag Manager ser instalado em seu aplicativo, adicione um provedor de tag personalizado para chamar métodos do SDK or kit de desenvolvimento de software da Braze com base nas tags que você configurou dentro do Google Tag Manager.
...
Este exemplo destaca uma das muitas maneiras de estruturar seu provedor de tag personalizado. Especificamente, mostra como determinar qual método do SDK or kit de desenvolvimento de software da Braze chamar com base no par chave-valor `actionType` enviado pela Tag do GTM.

...
Gere um certificado do serviço de Notificações por Push da Apple (APNs) e faça upload dele no dashboard da Braze. Para obter um passo a passo completo, consulte [Como fazer upload de seu certificado de APNs]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/push_notifications/integration/#step-1-upload-your-apns-certificate).

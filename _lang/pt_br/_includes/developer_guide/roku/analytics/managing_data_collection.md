...
- A seção de ID do usuário está vazia, então o SDK assume o padrão de um usuário anônimo (uma string vazia `""`).
...
Este recurso ainda não é compatível com o Roku SDK.
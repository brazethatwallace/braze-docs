...
| `CUSTOM_API_ENDPOINT` | Um endpoint de API personalizado. Esse endpoint é usado para rotear os dados da sua instância da Braze para o grupo de apps correto no seu dashboard da Braze. |

...
![Guia Engajamento do perfil de usuário da Braze exibindo o changelog de registro de push.]({% image_buster /assets/img_archive/push_changelog.gif %}){: style="max-width:50%;" }

...
| Prioridade | Descrição/Utilização pretendida | Valor de `priority` (para mensagens de API) |
|----------|--------------------------|-------------------------------------|

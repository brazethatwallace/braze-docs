...
O modelo de mensagem no app está disponível no SDK do React Native. A Braze tem quatro tipos de mensagem no app que compartilham o mesmo modelo de dados: **slideup**, **modal**, **full** e **HTML full**.

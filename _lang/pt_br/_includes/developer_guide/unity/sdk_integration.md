...
## Integração do SDK do Unity

### Pré-requisitos

Antes de começar, verifique se seu ambiente é compatível com a [versão mais recente do Braze Unity SDK](https://github.com/braze-inc/braze-unity-sdk/releases).
...
- `Appboy.unitypackage`
    - Esse pacote reúne os SDKs da Braze para Android e iOS e a dependência [SDWebImage](https://github.com/SDWebImage/SDWebImage) para o SDK do iOS, que é necessária para o funcionamento adequado dos recursos de mensagem no app e Cartões de conteúdo da Braze no iOS. O framework SDWebImage é usado para baixar e exibir imagens, inclusive GIFs. Se você pretende utilizar toda a funcionalidade da Braze, baixe e importe esse pacote.
...
2. `Appboy.unitypackage` com `SDWebImage`
  - Essa opção de integração agrupa os SDKs da Braze para Android e iOS e a dependência [SDWebImage](https://github.com/SDWebImage/SDWebImage) para o SDK do iOS, que é necessária para o funcionamento adequado da mensagem no app e dos recursos de Cartões de conteúdo da Braze no iOS. O framework `SDWebImage` é usado para baixar e exibir imagens, inclusive GIFs. Se você pretende utilizar toda a funcionalidade da Braze, baixe e importe esse pacote.
...
{% tabs %}
{% tab Android %}
#### Etapa 3.1: Configurar o `AndroidManifest.xml`
...
No seu terminal, clone o [repositório do Braze Unity SDK no GitHub](https://github.com/braze-inc/braze-unity-sdk) e, em seguida, navegue até essa pasta:
...
### Etapa 3: Importar pacote no Unity
...
3. No campo **SDK Log Level**, insira o valor "0".
...
1. Adicione o Braze Android SDK como uma dependência da sua biblioteca ou projeto de plug-in, conforme descrito nas [instruções de integração do Braze Android SDK]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=android).

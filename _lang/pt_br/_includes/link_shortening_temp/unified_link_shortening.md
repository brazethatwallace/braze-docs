...
O encurtamento de links pode ser ativado no [nível da variante de mensagem]({{site.baseurl}}/user_guide/messaging/ab_testing/create_tests/#step-1-create-your-campaign) tanto em Campanhas quanto em Canvas. Quando o encurtamento de links está ativado, os cliques geram um [evento de clique de SMS]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events/) enviado pelo Currents.
...
Certifique-se de salvar a Campanha ou Canvas antes de enviar uma mensagem de teste para receber uma representação da URL encurtada que é enviada na sua mensagem. Se a Campanha ou Canvas não for salva antes de um envio de teste, o envio de teste incluirá uma URL de espaço reservado.
...
Quando o encurtamento de links está ativado, a tabela **Performance de SMS/MMS/RCS** inclui uma coluna intitulada **Total de Cliques** que mostra uma contagem de eventos de clique por variante e uma taxa de cliques associada. Para mais informações sobre métricas, consulte [Performance de mensagens]({{site.baseurl}}/user_guide/channels/sms_mms_and_rcs/reporting/).

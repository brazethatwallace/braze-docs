No dashboard da Braze, acesse **Configurações de dados** > **Transformação de dados**.

Selecione **Criar Transformação** para nomear sua transformação e, em seguida, escolha sua experiência de edição.
...
Capture sua **URL do webhook** para uso na próxima etapa.
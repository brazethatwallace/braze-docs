...
1. Acesse **Modelos** > **Content Blocks**. Selecione <i class="fas fa-plus"></i> **Create Content Block** e selecione **Drag-and-drop Content Block**.
...
1. Acesse **Modelos** > **Content Blocks**. Selecione <i class="fas fa-plus"></i> **Create Content Block** e selecione **HTML code editor**.

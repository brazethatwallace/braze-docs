...
{% if include.SDK or kit de desenvolvimento de software == "iOS" %}
...
{% elsif include.SDK or kit de desenvolvimento de software == "Android" %}
...
{% elsif include.SDK or kit de desenvolvimento de software == "Web" %}
...
{% case include.SDK or kit de desenvolvimento de software %}
  {% when "iOS" %}

...
Recomendamos incluir em sua mensagem uma linguagem de aceitação e links para a política de privacidade e os termos e condições da sua marca. Certifique-se de trabalhar com sua equipe jurídica para desenvolver uma linguagem adaptada à sua marca específica.
...
### Verificação de aceitação dupla {#double-opt-in-verification}

Para ter certeza de que quem se inscreveu na sua lista realmente quis se inscrever e forneceu o endereço de e-mail correto, recomendamos obter uma segunda confirmação de quem se inscreveu por meio do formulário de inscrição de e-mail, enviando um fluxo de [aceitação dupla](https://www.braze.com/resources/articles/embracing-the-email-double-opt-in).

Uma das maneiras de configurar isso é por meio do Canvas:

1. Crie um Canvas baseado em ação e configure-o para disparar quando um usuário adicionar um endereço de e-mail à Braze. Certifique-se de permitir o direcionamento de usuários que são novos na plataforma (por exemplo, usando um Segment sem filtros no Canvas).
...
5. Configure a outra jornada para sair do Canvas depois que a janela expirar.

{% endif %}

{% if include.section == "reporting" %}

Após o lançamento da sua Campaign, é possível analisar os resultados em tempo real para ver quantos usuários se engajaram com ela. Para ver quantos usuários aceitaram o grupo de inscrições, é possível [criar um Segment]({{site.baseurl}}/user_guide/audience/segments/creating_a_segment) de usuários que se inscreveram no grupo de inscrições filtrando os usuários que receberam a mensagem no app e enviaram o formulário.

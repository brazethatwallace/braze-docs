...
| Comportamento ao clicar | Determina a ação quando o usuário clica na imagem, como fechar a mensagem, abrir uma URL da web, fazer deep linking para uma página específica do app, ir para outra página ou [solicitar permissão de push]({{site.baseurl}}/user_guide/channels/push/best_practices/push_primer_messages/). |

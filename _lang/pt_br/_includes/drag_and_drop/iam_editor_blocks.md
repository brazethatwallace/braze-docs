...
Campo de texto multilinha para fluxos no estilo de pesquisa. Se você não encontrar esse bloco, entre em contato com o [suporte da Braze]({{site.baseurl}}/user_guide/administer/personal/braze_support) ou com seu CSM da Braze.

...
![Uma notificação informando que "As atualizações programadas foram desativadas para essa extensão porque ela não é usada em nenhuma campanha, Canvas ou segmento ativo. A extensão de segmento foi desativada em 23 de fevereiro de 2025 às 12:00 AM."]({% image_buster /assets/img/segment/segment_extension_disabled.png %})

...
Se estiver explicando um conceito técnico, indique isso aqui e mostre um exemplo de código.
...
| Variável | Descrição |
| -------- | ----------- |
| Título da página | Você pode dar qualquer título à sua página. Isso é obrigatório. |

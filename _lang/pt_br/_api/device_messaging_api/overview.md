...
article_title: Visão geral da API de envio de mensagens para dispositivos
page_order: 0
page_type: reference
description: "Saiba mais sobre a API de envio de mensagens para dispositivos da Braze e seus recursos em acesso antecipado."
hidden: true
---

# Visão geral da API de envio de mensagens para dispositivos {#device-messaging-api-overview}

A API de envio de mensagens para dispositivos da Braze é um conjunto de endpoints REST para integrar os recursos de envio de mensagens da Braze sem um SDK da Braze. Você pode chamar esses endpoints a partir de aplicações cliente ou servidor.

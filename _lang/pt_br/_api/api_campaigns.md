...
2. Selecione **Add Message** e adicione os tipos de mensagens que serão incluídos na sua campanha da API. Isso permitirá que você gere um `campaign_id` e um ID de variação de mensagem, que é diferente para cada canal incluído.
...
4. Selecione **Save Campaign** e você estará pronto para iniciar sua campanha da API!

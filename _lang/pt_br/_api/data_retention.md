...
## Retenção de dados gerenciada pelos clientes por meio do dashboard ou API da Braze {#data-retention-handled-by-customers-through-brazes-dashboard-or-api}
...
- Excluir perfis de usuário usando o [endpoint de API para exclusão de usuário]({{site.baseurl}}/api/endpoints/user_data/post_user_delete) da Braze
- Excluir (anular) ou alterar atributos em perfis de usuário usando o [endpoint de API para rastreamento de usuário]({{site.baseurl}}/api/endpoints/user_data/post_user_track) da Braze

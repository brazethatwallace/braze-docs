...
| Parâmetro | Obrigatório | Tipo de dados | Descrição |
|---|---|---|---|
| `items` | Obrigatório | Vetor | Um vetor que contém objetos de item. Os objetos de item devem conter um `id` referenciando os itens que a Braze deve excluir. São permitidos até 50 objetos de item por solicitação. |

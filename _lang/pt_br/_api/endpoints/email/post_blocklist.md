...
| -----------|----------| --------|------- |
| `email` | Obrigatório | String ou matriz | Endereço de e-mail em string para adicionar à lista de bloqueio, ou uma matriz de até 50 endereços de e-mail para adicionar à lista de bloqueio. |

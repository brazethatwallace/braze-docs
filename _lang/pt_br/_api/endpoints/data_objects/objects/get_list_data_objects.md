---
nav_title: "GET: Listar objetos de dados"
article_title: "GET: Listar objetos de dados"
search_tag: Endpoint
page_order: 1
layout: api_page
page_type: reference
description: "Este artigo descreve os detalhes do endpoint Listar objetos de dados."
---
{% API or interface de programação do aplicativo (API) %}
# Listar objetos de dados {#list-data-objects}
{% apimethod get %}
/data_objects/objects/{type_name}
{% endapimethod %}

> Use este endpoint para listar objetos de um tipo de objeto de dados específico.
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Parâmetros de caminho para listar objetos de dados" }

## Parâmetros de consulta {#query-parameters}

A tabela a seguir lista e descreve os parâmetros de consulta do endpoint `/data_objects/objects/{type_name}`.
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Parâmetros de consulta para listar objetos de dados" }
...
Este exemplo lista os registros de `account` que correspondem ao termo de busca `acct`, retornando a primeira página de resultados.
...
| Parâmetro | Obrigatório | Tipo de dados | Descrição |
|---|---|---|---|
| `items` | Obrigatório | Array | Lista de registros de objetos de dados |
| `items[].type_name` | Obrigatório | String | Nome de máquina do tipo de objeto de dados |
| `items[].external_id` | Obrigatório | String | Identificador do objeto de dados |
...
| `limit` | Obrigatório | Inteiro | Tamanho da página utilizado pela solicitação |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Parâmetros da resposta para listar objetos de dados" }
...
| `403` | A chave de API or interface de programação do aplicativo (API) não tem permissão ou a solicitação está bloqueada pela lista de permissões | Confirme que a chave possui a permissão `data_objects.read` e que o IP de origem está na lista de permissões da chave, se configurada. |
| `429` | Limite de frequência excedido | Tente novamente após `X-RateLimit-Reset` e reduza a frequência das solicitações. |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Erros ao listar objetos de dados" }
{% endapi %}
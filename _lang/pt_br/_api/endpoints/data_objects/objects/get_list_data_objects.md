...
| `403` | A chave de API não tem permissão ou a solicitação está bloqueada pela lista de permissões | Confirme que a chave possui a permissão `data_objects.read` e que o IP de origem está na lista de permissões da chave, se configurada. |

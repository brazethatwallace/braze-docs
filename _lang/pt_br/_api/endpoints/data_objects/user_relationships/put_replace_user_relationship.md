...
| Parâmetro | Obrigatório | Tipo de dados | Descrição |
|---|---|---|---|
| `braze_id` | Obrigatório | String | ID do usuário Braze |
...
Este exemplo substitui os atributos do relacionamento `account_user` entre o usuário e `acct-123`, sobrescrevendo quaisquer atributos armazenados anteriormente nele.
...
| `user_relationship.user.braze_id` | Obrigatório | String | Identificador do usuário Braze |

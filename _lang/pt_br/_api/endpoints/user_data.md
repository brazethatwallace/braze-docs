...
guide_top_text: "Os endpoints de dados de usuários da Braze permitem rastrear informações sobre seus usuários por meio do registro de dados que vêm de fora do seu app móvel. Também é possível usar essa API para excluir usuários para testes ou outros fins. <br> <br> Todos os endpoints da API têm um limite de carga útil de dados de 4&nbsp;MB. As tentativas de enviar mais dados do que 4&nbsp;MB falharão com uma mensagem HTTP 413 Request Entity Too Large. <br> <br> Os exemplos nesta seção contêm a URL https://rest.iad-01.braze.com, mas talvez seja necessário usar uma URL de endpoint diferente (por exemplo, se você estiver hospedado no data center da Braze EU ou tiver uma instalação dedicada da Braze). Seu gerente de sucesso do cliente da Braze informará se for necessário usar uma URL de endpoint diferente."

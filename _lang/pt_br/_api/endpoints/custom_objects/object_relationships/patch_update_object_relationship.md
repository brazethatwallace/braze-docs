...
Para usar este endpoint, você precisará de uma [chave de API]({{site.baseurl}}/api/basics#rest-api-key-permissions) com a permissão `custom_objects.object_relationships.update`.
...
### Exemplo de carga útil de requisição {#sample-request-payload}
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Erros de atualização de relacionamento de objeto" }
{% endapi %}
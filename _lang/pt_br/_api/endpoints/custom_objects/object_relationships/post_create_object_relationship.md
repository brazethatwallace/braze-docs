...
Para usar este endpoint, você precisa de uma [chave de API]({{site.baseurl}}/api/basics#rest-api-key-permissions) com a permissão `custom_objects.object_relationships.create`.
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Parâmetros da resposta de criação de relacionamento de objeto" }
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Erros de criação de relacionamento de objeto" }
{% endapi %}
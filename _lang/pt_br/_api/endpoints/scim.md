...
guide_featured_list:
  ...
  - name: "GET: Procurar uma conta de usuário de dashboard existente"
...
1. Baixe o relatório de eventos de segurança em **Configurações** > **Configurações de administrador** > **Configurações de segurança** > **Security Event Download**.

...
{% alert note %}
Para clientes que fizeram a integração com a Braze em 22 de agosto de 2024 ou após essa data, o parâmetro de solicitação `fields_to_export` é obrigatório.
{% endalert %}

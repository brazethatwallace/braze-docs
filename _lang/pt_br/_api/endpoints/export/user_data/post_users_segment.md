...
## Exemplo de solicitação para exportar todos os atributos personalizados {#example-request-to-export-all-custom-attributes}
```
...
## Exemplo de solicitação para exportar atributos personalizados específicos {#example-request-to-export-specific-custom-attributes}
```
curl --location --request POST 'https://rest.iad-01.braze.com/users/export/segment' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer YOUR-REST-API-KEY' \
...
| `last_coordinates`    | Matriz de floats | O local mais recente do dispositivo do usuário, formatado como `[longitude, latitude]`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |

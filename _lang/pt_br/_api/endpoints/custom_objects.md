...
layout: dev_guide
page_type: landing
description: "Esta landing page lista os endpoints de objetos personalizados da Braze."
needs_mermaid: true

guide_top_header: "Endpoints de objetos personalizados"
guide_top_text: "Use esses endpoints para listar tipos de objetos personalizados, gerenciar registros de objetos personalizados e gerenciar relacionamentos entre objetos e usuários."
guide_top_alert: "Objetos personalizados está atualmente em acesso antecipado. Seu espaço de trabalho precisa estar ativado para que as permissões de chave de API de objetos personalizados apareçam em **Configurações** > **Chaves de API**."
...
guide_featured_list:
  ...
  - name: "GET: Obter tipo de objeto personalizado"
...
guide_menu_title3: "Endpoints de relacionamentos de usuário"
guide_menu_list3:
...
- Para hosts de endpoints, consulte a [visão geral da API da Braze]({{site.baseurl}}/api/basics#endpoints).
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Grupos de permissões de objetos personalizados" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Limites de frequência padrão de objetos personalizados" }
...
### Assimetria de caminhos para relacionamentos de usuário {#path-asymmetry-for-user-relationships}
...
## Paginação e atualização dos dados {#pagination-and-data-freshness}

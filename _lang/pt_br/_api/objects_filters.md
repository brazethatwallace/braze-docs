...
- [Objeto de contexto do Canvas]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/context)
...
- [Objeto de destinatários]({{site.baseurl}}/api/objects_filters/recipient_object)
...
- [Objeto de cronograma]({{site.baseurl}}/api/objects_filters/schedule_object)
- [Objeto de seleção de catálogo]({{site.baseurl}}/api/objects_filters/catalog_selection_object)

### Objetos de envio de mensagens {#messaging-objects}
  ...
  - [Objeto de cartão de conteúdo]({{site.baseurl}}/api/objects_filters/messaging/content_cards_object)

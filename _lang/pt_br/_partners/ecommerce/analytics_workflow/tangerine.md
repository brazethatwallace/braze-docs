...
description: "Este artigo descreve a parceria entre a Braze e a Tangerine Store360, uma plataforma omnicanal que conecta lojas físicas com lojas on-line para proporcionar experiências superiores na loja para consumidores e colaboradores. Por meio dessa integração, os dados brutos de campanhas e impressões da Braze estão disponíveis no Store360 via Snowflake Secure Data Sharing, e as marcas podem medir como suas campanhas afetam o engajamento e o tráfego na loja."
...
A integração entre a Braze e a Tangerine permite integrar dados brutos de campanhas e impressões da Braze ao Store360 por meio do Snowflake Secure Data Sharing. As marcas agora podem medir o impacto dessas campanhas nas visitas às lojas físicas e no engajamento na loja.
...
### Analisar o impacto da campanha na visita à loja física {#analyze-campaign-impact-on-physical-store-visit}

As marcas usam a Braze para enviar mensagens de campanha aos consumidores para aumentar as visitas às lojas. Durante a campanha, o Store360 captura visitas de usuários de apps móveis identificados por ID de usuário.

Usando o recurso de análise do Store360 Insight, as marcas podem visualizar os detalhes do impacto da campanha, desde mensagens enviadas e lidas (dados da Braze) até quem e quantos destinatários visitaram as lojas físicas (dados do Store360).
...
Há uma política de retenção de dois anos para seus dados da Braze no compartilhamento de dados do Snowflake.

### Tempo de espera para preencher os dados de eventos da Braze {#time-lag-in-populating-braze-event-data}

Os eventos da Braze são processados com tecnologia de streaming e estão disponíveis em tempo quase real. De modo geral, os eventos são disponibilizados em até 30 minutos após sua ocorrência.
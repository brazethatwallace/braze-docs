...
{: .reset-br-td-1 .reset-br-td-2 aria-label="Eventos da Shopify rastreados" }
{% endraw %}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Atributos personalizados compatíveis da Shopify" }

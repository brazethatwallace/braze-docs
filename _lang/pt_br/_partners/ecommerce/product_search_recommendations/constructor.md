...
Trabalhe com sua equipe de integração do Constructor para concluir o processo de integração. Certifique-se de que os dados comportamentais do seu site ou de outras fontes de dados relevantes estejam disponíveis para ativar recomendações de produtos personalizadas. Sua equipe de integração do Constructor também ajudará a configurar os trechos de HTML necessários para uso nas mensagens da Braze.
...
| Entrada | Descrição |
|-------------|-------------|
| `item_id` | Representa o item semente. Necessário para estratégias baseadas em item-item, como alternativas, complementares e pacotes. Por exemplo, o primeiro item em um e-mail é o item semente, com itens subsequentes como alternativas. |

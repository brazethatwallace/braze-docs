...
### Etapa 3: Escreva o código de transformação para aceitar os eventos da Olo escolhidos {#step-3-write-transformation-code-to-accept-your-chosen-olo-events}
...
## Transformação multi-evento {#multi-event-transformation}

...
Esta seção descreve quatro integrações diferentes: aquisição de e-mail, aquisição de SMS, atributos personalizados e webhooks. A integração escolhida dependerá da sua ativação da Quikly e do caso de uso.

...
| Endpoint REST or transferir estado representacional da Braze | Certifique-se de saber a [URL do seu endpoint REST or transferir estado representacional]({{site.baseurl}}/api/basics#api-definitions). Seu endpoint de API or interface de programação do aplicativo (API) corresponde à URL do dashboard da sua instância da Braze. <br><br> Por exemplo, se a URL do seu dashboard é `https://dashboard-03.braze.com`, seu endpoint será `dashboard-03`. |
| Chave da API or interface de programação do aplicativo (API) REST or transferir estado representacional da Braze | Certifique-se de ter uma chave da API or interface de programação do aplicativo (API) REST or transferir estado representacional da Braze com permissões `users.track`. <br><br> Ela pode ser criada no dashboard da Braze em **Configurações** > **Chaves de API or interface de programação do aplicativo (API)**. |

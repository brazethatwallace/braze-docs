...
| Talon.One chave de API | Em Talon.One, em **Configurações** > **Configurações do desenvolvedor**, crie uma chave de API de terceiros da Braze para a integração. |
...
1. Visite a [documentação do site Talon.One](https://docs.talon.one/docs/dev/technology-partners/braze) para obter orientação sobre como configurar sua integração, como usar o endpoint de API de cupons da Talon.One e onde encontrar os modelos de Conteúdo conectado necessários para suas mensagens na Braze.

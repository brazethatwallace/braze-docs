...
# Retenção de dados Snowflake {#snowflake-data-retention}
...
- Descarregar seus dados para um stage
...
## Eventos isentos da política de retenção de dois anos {#events-exempted-from-the-two-year-retention-policy}
...
## Copiando todos os dados para outro banco de dados Snowflake {#copying-all-data-to-another-snowflake-database}
...
{: start="2"}
2. Execute um dos comandos a seguir na sua conta do Snowflake para executar o procedimento.
...
## Descarregando dados para o stage {#unloading-data-to-stage}

Você pode reter dados não anonimizados descarregando dados do esquema compartilhado `BRAZE_RAW_EVENTS` para um stage. Para fazer isso, siga estas etapas:

1. Crie o procedimento `UNLOAD_BRAZE_SHARE`, que será usado para copiar todos os dados compartilhados pela Braze para o stage especificado.
...
{: start="2"}
2. Execute um dos comandos a seguir para executar o procedimento.

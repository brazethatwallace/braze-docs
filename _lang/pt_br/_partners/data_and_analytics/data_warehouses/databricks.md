...
{% alert important %}
O Databricks Delta Sharing com a Braze está em **beta fechado**. A disponibilidade, as regiões compatíveis e o comportamento do produto podem mudar. Entre em contato com o seu gerente de sucesso do cliente da Braze para participar ou confirmar se esse recurso está ativado para o seu espaço de trabalho.
{% endalert %}
...
Para instruções de configuração, consulte [Databricks Delta Sharing]({{site.baseurl}}/partners/data_and_analytics/data_warehouses/databricks/delta_sharing/).
...
Quando estiver pronto para configurar o compartilhamento e consultar dados compartilhados, prossiga para [Databricks Delta Sharing]({{site.baseurl}}/partners/data_and_analytics/data_warehouses/databricks/delta_sharing/).
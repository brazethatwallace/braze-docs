...
* [Live Push User Activity](https://docs.oracle.com/en/cloud/saas/marketing/crowdtwist-develop/Developers/LivePushUserActivity.html): Inclui dados de conclusões de atividades de usuários.

* [Live Push User Redemption](https://docs.oracle.com/en/cloud/saas/marketing/crowdtwist-develop/Developers/LivePushUserRedemption.html): Inclui dados de resgates de recompensas de usuários.
...
Depois de modificar o modelo a seu gosto, você deve validar se ele está funcionando corretamente. No editor de transformação, selecione **Validate** para gerar uma prévia na seção **Output** e confirmar se a Braze aceitará a solicitação mapeada para o destino escolhido.

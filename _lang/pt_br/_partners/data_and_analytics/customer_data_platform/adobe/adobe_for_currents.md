...
description: "Este artigo de referência descreve a parceria entre Braze Currents e Adobe, uma plataforma de dados do cliente que permite que as marcas conectem e mapeiem seus dados da Adobe (atributos personalizados e Segments) para a Braze em tempo real."
page_type: partner
tool: Currents
search_tag: Partner
---
...
> A [Adobe](https://www.adobe.com/) é uma plataforma de dados do cliente que permite que as marcas conectem e mapeiem seus dados da Adobe (atributos personalizados e Segments) para a Braze em tempo real.

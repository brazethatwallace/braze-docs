...
A integração entre a Braze e o RudderStack oferece uma integração de SDK or kit de desenvolvimento de software nativo para seus aplicativos Android, iOS e web e uma integração de servidor para servidor de seus serviços de back-end.
...
| Chave da API or interface de programação do aplicativo (API) REST or transferir estado representacional da Braze | Uma chave da API or interface de programação do aplicativo (API) REST or transferir estado representacional da Braze com as permissões `users.track`, `users.identify`, `users.delete` e `users.alias.new`.<br><br>Ela pode ser criada no dashboard da Braze em **Configurações** > **Chaves de API or interface de programação do aplicativo (API)**. |
...
No destino da Braze, forneça a chave do app, a chave da API or interface de programação do aplicativo (API) REST or transferir estado representacional da Braze, o cluster de dados e a opção de SDK or kit de desenvolvimento de software nativo (somente modo de dispositivo). A opção de SDK or kit de desenvolvimento de software nativo usará o SDK or kit de desenvolvimento de software nativo da Braze para enviar eventos se estiver ativada.
...
- [Servidor para servidor / modo de nuvem](#cloud-mode)**:** O SDK or kit de desenvolvimento de software da Braze envia os dados do evento diretamente para o RudderStack, que então os transforma e encaminha para a Braze.
...
Com esse modo, você pode enviar seus eventos para a Braze usando o SDK or kit de desenvolvimento de software da Braze configurado no seu website ou app móvel.

Configure os mapeamentos para o SDK or kit de desenvolvimento de software do RudderStack na sua plataforma no repositório GitHub da Braze, conforme descrito em [métodos compatíveis](#supported-methods):
...
Nesse modo, o SDK or kit de desenvolvimento de software envia os dados do evento diretamente para o servidor do RudderStack. O RudderStack então transforma esses dados e os encaminha para o destino desejado. Essa transformação é feita no backend do RudderStack usando o módulo transformer do RudderStack.
...
{% alert note %}
Os SDKs do lado do servidor do RudderStack (Java, Python, Node.js, Go, Ruby) suportam apenas o modo de nuvem. Isso porque seus SDKs do lado do servidor operam no backend do RudderStack e não conseguem carregar nenhum SDK or kit de desenvolvimento de software específico da Braze.
{% endalert %}
...
1. Inicializa o SDK or kit de desenvolvimento de software da Braze.
...
3. Envia os eventos gerados automaticamente (mensagens no app, notificações por push que requerem o SDK or kit de desenvolvimento de software da Braze) pelo modo de dispositivo.
...
- **Show Braze logs**: Essa configuração é aplicável somente ao usar o [SDK or kit de desenvolvimento de software JavaScript](https://www.rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/) como fonte. Ative-a para exibir os logs da Braze para seus usuários.
...
Você pode excluir um usuário na Braze usando a regulação [Suppression with Delete](https://www.rudderstack.com/docs/api/data-regulation-api/#adding-a-suppression-with-delete-regulation) da [API or interface de programação do aplicativo (API) de Regulação de Dados](https://www.rudderstack.com/docs/api/data-regulation-api/) do RudderStack.

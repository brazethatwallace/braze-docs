...
| ------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Chave de API | Encontrada no dashboard da Braze em **Settings** > **API Keys**.<br><br>Se você estiver usando a navegação antiga, pode encontrar as chaves de API em **Developer Console** > **API Settings**. |

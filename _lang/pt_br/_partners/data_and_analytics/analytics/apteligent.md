...
description: "Este artigo de referência descreve a parceria entre a Braze e a Apteligent, um aplicativo móvel que detalha os relatórios de falhas, permitindo o registro de dados críticos na sua solução da Braze existente."
page_type: partner
search_tag: Partner
...
> A [Apteligent](https://www.vmware.com/products/workspace-one/intelligence-consumer-apps.html) é uma plataforma de desempenho de aplicativos móveis que fornece ferramentas e insights para desenvolvedores e gerentes de produtos.

_Essa integração é mantida pela Apteligent._

## Sobre a integração {#about-the-integration}

A integração entre a Braze e a Apteligent fornece relatórios detalhados de falhas no iOS, permitindo o registro de dados críticos na sua solução da Braze existente, além de segmentar, entender e engajar os usuários que sofreram falhas no aplicativo.
...
### Etapa 1: Registre um observador {#step-1-register-an-observer}

Primeiro, você deve registrar um observador. Faça isso antes de inicializar a Apteligent.
...
Depois de concluído, você poderá aproveitar o poder da segmentação da Braze e da análise de dados de engajamento usando as informações sobre falhas encontradas na plataforma Apteligent.
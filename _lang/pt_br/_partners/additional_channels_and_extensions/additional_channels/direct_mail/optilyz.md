...
Use a integração de webhook entre a optilyz e a Braze para enviar mala direta a seus clientes, como cartas, cartões postais e self-mailers.
...
![Os cabeçalhos de solicitação e o método HTTP mostrados no construtor de webhooks da Braze.]({% image_buster /assets/img/optilyz/optilyz_settings.png %}){: style="max-width:50%"}
...
![Diferentes campos de teste disponíveis na guia de teste do construtor de webhooks da Braze.]({% image_buster /assets/img/optilyz/optilyz_testing.png %})

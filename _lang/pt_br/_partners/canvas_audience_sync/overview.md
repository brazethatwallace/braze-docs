...
| Destino | Tempo para o destino corresponder aos membros do público | Limite de frequência | Semelhante ou actalike | Dicas |
| --- | --- | --- | --- | --- |
| [Criteo]({{site.baseurl}}/partners/canvas_audience_sync/criteo_audience_sync) | Até 24 horas | 250.000 solicitações por minuto. Em lote a cada 5 segundos com nova tentativa automática. | Sim | {::nomarkdown}<ul><li>A Criteo suporta até 1.000 públicos de anúncios.</li><li>O tamanho mínimo do público é 500, e o recomendado é acima de 20.000.</li></ul>{:/} |
...
| [Google Ads ou YouTube]({{site.baseurl}}/partners/canvas_audience_sync/google_audience_sync) | Entre 6 e 12 horas | Em lote a cada 5 segundos com nova tentativa automática baseada no feedback do Google | Não | {::nomarkdown}<ul><li><b>Correspondência com o cliente:</b> Use o anúncio no celular, o endereço de e-mail ou o número de telefone.</li><li>O público do Google exige pelo menos 5.000 usuários para começar a veicular anúncios.</li><li>O tamanho do público será mostrado como zero até que haja pelo menos 1.000 usuários.</li></ul>{:/} |
...
<sup>Quando o limite de frequência for atingido, a Braze tentará novamente as sincronizações por 13 horas.</sup>

...
2. Clique em **Share** no canto superior direito do editor e selecione **Braze**. Se a Braze não estiver listada, abra **See more** e role até **More options** para encontrar a Braze.
...
![Modelo de e-mail na Braze aberto a partir do Canva, com informações de envio e pré-visualização.]({% image_buster /assets/img/canva_integration/braze-email-template-from-canva.png %})
...
Antes de iniciar a integração, certifique-se de ter a campanha desejada e os segmentos de usuários criados na Braze. Quando concluído, na plataforma WSC Sports, selecione o vídeo desejado e, nas configurações de envio, selecione o segmento de usuário da Braze e o ID da campanha que deseja usar. Por fim, escolha o horário em que deseja que a mensagem push seja enviada.

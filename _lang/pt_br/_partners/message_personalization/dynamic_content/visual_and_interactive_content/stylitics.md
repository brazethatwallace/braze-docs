...
- E-mails de navegação abandonada
...
Você e seu ESP criarão um modelo de e-mail HTML para inserir dados e pacotes da Stylitics. Aqui estão algumas melhores práticas e recomendações.
- Exibir de 2 a 4 pacotes no e-mail para o item mais caro ou primeiro item a preço cheio que o usuário comprou ou com o qual interagiu
- Chame vários `item_numbers` e mostre as primeiras respostas do pacote
- Tenha uma opção de fallback se não houver pacotes disponíveis para o item
	...
	- Mostre pacotes para o próximo item que o usuário visualizou
- Exiba imagens do pacote e uma lista de títulos de produtos e imagens em miniatura para garantir que o usuário tenha cliques claros

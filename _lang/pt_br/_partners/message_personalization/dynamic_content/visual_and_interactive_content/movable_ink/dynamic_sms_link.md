...
> Com a prévia dinâmica de link para SMS da Movable Ink, você aproveita a imersão do MMS pelo mesmo custo do SMS. Isso permite usar a Braze e a Movable Ink para oferecer experiências de mensagens ricas, personalizadas e econômicas.
...
2. No dashboard da Braze, acesse **Campaigns** e configure uma nova campanha de SMS/MMS no menu suspenso **Criar campanha**.
...
Depois que os usuários carregarem a prévia do link, uma imagem personalizada será renderizada com a possibilidade de direcionar para o seu site, app ou landing page.

...
description: "Este artigo de referência descreve a parceria entre a Braze e a Movable Ink, uma plataforma de software baseada em nuvem que oferece aos profissionais de marketing digital uma maneira de criar experiências visuais atraentes e exclusivas que cativam os clientes."
page_type: partner
search_tag: Partner
...
> A [Movable Ink](https://www.movableink.com/) é uma plataforma de software baseada em nuvem que oferece aos profissionais de marketing digital uma maneira de criar experiências visuais atraentes e exclusivas que cativam os clientes. A plataforma da Movable Ink oferece opções de personalização valiosas que podem ser facilmente inseridas nas suas campanhas.
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3  .reset-td-br-4 aria-label="Funcionalidades suportadas da Movable Ink" }
...
Para saber mais sobre como usar a plataforma Movable Ink, visite o [centro de suporte da Movable Ink](https://support.movableink.com/)
...
{% tabs local %}
{% tab Email %}
Na plataforma da Braze, cole sua tag criativa no corpo do seu e-mail.![Criador de e-mail da Braze com uma tag criativa da Movable Ink inserida no corpo da mensagem.]({% image_buster /assets/img/movable_ink/web2.png %}){: style="max-width:90%"}<br><br>

{% endtab %}
{% tab Push notification %}

1. Na plataforma da Braze:
	- Push para Android: cole a URL nos campos **Push Icon Image** e **Expanded Notification Image**.<br>![Configurações de push Android da Braze mostrando campos de URL de imagem para conteúdo da Movable Ink.]({% image_buster /assets/img/movable_ink/android.png %}){: style="max-width:60%"}<br><br>
	- Push para iOS: cole a URL no campo de link **Media** e indique o formato de arquivo em uso.<br>![Campo de mídia do criador de push iOS da Braze preenchido com uma URL da Movable Ink.]({% image_buster /assets/img/movable_ink/ios.png %}){: style="max-width:60%"}<br><br>
	- Push para a web: cole a URL nos campos **Push Icon Image** e **Large Notification Image**.<br>![Editor de web push da Braze com campos de URL de ícone e imagem grande.]({% image_buster /assets/img/movable_ink/web.png %}){: style="max-width:60%"}<br><br>
...
1. Na plataforma da Braze, cole a URL no campo **Rich Notification Media**.![Campo de mídia de notificação Rich da Braze com uma URL de imagem da Movable Ink.]({% image_buster /assets/img/movable_ink/image.png %}){: style="max-width:60%"}<br><br>
...
1. Na plataforma da Braze, cole a URL no campo **Rich Notification Media**.![Campo de mídia de Content Card da Braze com uma URL de imagem da Movable Ink.]({% image_buster /assets/img/movable_ink/image.png %}){: style="max-width:60%"}<br><br>

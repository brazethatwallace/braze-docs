...
A integração entre a Braze e a Playable permite que você entregue seu melhor conteúdo (vídeo de alta qualidade) ao seu melhor público (e-mail), aumentando suas métricas de cliques e pós-clique com conteúdo de vídeo de alta qualidade que é reproduzido automaticamente na caixa de entrada.
...
### Etapa 1: Adicione seu vídeo ao Playable {#step-1-add-your-video-to-playable}
...
### Etapa 2: Copie o código de incorporação do Playable {#step-2-copy-the-embed-code-from-playable}

Após o upload do vídeo, o Playable gera um código que, quando inserido na sua Campaign da Braze, incorpora o vídeo no seu e-mail para reprodução automática ao ser aberto. Quando o e-mail é aberto, os servidores do Playable entregam a melhor versão possível do seu vídeo, dependendo do cliente de e-mail, dispositivo, tamanho da tela e condições de rede.
...
Cole o código na sua Campaign de e-mail da Braze e continue a projetar, testar e publicar sua Campaign de e-mail.
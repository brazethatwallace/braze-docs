...
![Captura de tela relacionada a usuários e segmentos.]({% image_buster /assets/img/getting_started/user_profile.png %})
...
Campaigns e Canvas são as formas de enviar mensagens aos seus usuários.

As Campaigns são ideais para mensagens individuais enviadas a um segmento específico de público em vários canais. Você pode usar qualquer um dos nossos canais de envio de mensagens compatíveis na sua Campaign (e-mail, push, In-App Messages, SMS e muito mais).
...
- **Nível de complexidade da migração de Campaigns:** O tempo necessário para migrar Campaigns depende de quantas você tem, de quão personalizadas elas são e dos seus recursos. Se você tiver menos de dez Campaigns para migrar, levará menos de 60 dias. Mas se tiver mais de 100 Campaigns, será mais complicado. Uma pessoa migrando 100 Campaigns é bem diferente de 10 pessoas migrando 100.

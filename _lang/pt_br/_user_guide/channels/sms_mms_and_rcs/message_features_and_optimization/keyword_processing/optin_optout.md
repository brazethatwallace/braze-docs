...
## Visão geral das palavras-chave {#keyword-overview}

A Braze processará automaticamente as seguintes palavras-chave e atualizará o estado do grupo de inscrições para o número de telefone em todas as solicitações recebidas. Observe que essas palavras-chave e respostas padrão também podem ser personalizadas.

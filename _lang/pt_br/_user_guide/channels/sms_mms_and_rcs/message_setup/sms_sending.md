...
{% alert tip %}
Quer aprender a criar uma Campaign de SMS? Confira nosso guia passo a passo sobre [Criando uma mensagem SMS, MMS ou RCS]({{site.baseurl}}/user_guide/channels/sms_mms_and_rcs/create).
{% endalert %}

...
As mensagens SMS usam codificação GSM-7 ou UCS-2 e são cobradas por Segment de mensagem. Para regras de codificação, tamanhos de Segment e a calculadora de segmentos, consulte [Calculadoras de cobrança de SMS e RCS]({{site.baseurl}}/user_guide/channels/sms_mms_and_rcs/billing_calculator).

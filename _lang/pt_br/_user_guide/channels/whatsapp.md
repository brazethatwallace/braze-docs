...
channel:
  - WhatsApp
search_rank: 3
description: "Alcance clientes com mensagens personalizadas no WhatsApp para suporte, notificações e campanhas promocionais por meio da Braze."
alias: /whatsapp/
---

# WhatsApp

> O WhatsApp é uma plataforma de envio de mensagens ponto a ponto usada em todo o mundo para comunicação comercial baseada em conversas. Com o canal WhatsApp na Braze, você envia mensagens de suporte, notificações e campanhas promocionais em conversas encadeadas que os usuários já utilizam todos os dias. Este hub abrange a configuração do WhatsApp, tipos de mensagem, modelos, gerenciamento de inscrições e relatórios. Comece pela [Configuração do WhatsApp]({{site.baseurl}}/user_guide/channels/whatsapp/whatsapp_setup) para conectar suas contas Meta Business e WhatsApp Business e, em seguida, crie sua primeira mensagem baseada em modelo. Consulte [Aceitações e cancelamentos]({{site.baseurl}}/user_guide/channels/whatsapp/message_processing/opt_ins_and_opt_outs) antes de enviar mensagens promocionais para novos usuários.

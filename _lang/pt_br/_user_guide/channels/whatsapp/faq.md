...
Você precisa ter o número de telefone do usuário final no perfil da Braze para enviar mensagens a ele.
...
Se você acredita que a Meta sinalizou incorretamente seu modelo, use o link de revisão no e-mail do WhatsApp para solicitar uma reanálise. A equipe do WhatsApp Business analisa a decisão e a reverte se apropriado.
...
O aviso "Mensagem Incompleta" aparece quando os espaços de variáveis obrigatórios do modelo não estão preenchidos com valores válidos no criador.

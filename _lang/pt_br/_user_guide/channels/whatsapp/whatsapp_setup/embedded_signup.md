...
3. No menu suspenso **Business portfolio**, selecione seu portfólio de negócios e depois selecione **Next**. Isso se conecta à sua conta do WhatsApp Business. Se você não encontrar o portfólio de negócios esperado, verifique suas permissões.<br><br>![Uma janela com campos para inserir as informações do seu negócio, incluindo o nome do portfólio de negócios.]({% image_buster /assets/img/whatsapp/business_info.png %}){: style="max-width:50%;"}<br><br>
...
6. Insira seu número de telefone e escolha **Text message** ou **Phone call**. Esse número deve seguir todos os requisitos de qualquer número de telefone do WhatsApp, incluindo não estar registrado em nenhuma outra conta do WhatsApp. <br><br>![Campos para adicionar um número de telefone.]({% image_buster /assets/img/whatsapp/add_phone_number.png %}){: style="max-width:50%;"}<br><br>

---
nav_title: Modal
article_title: Mensagens no app modais
page_order: 2
channel:
  - in-app messages
tool:
  - Media
description: "Este artigo de referência aborda os requisitos de mensagem e design das mensagens no app modais."

---

# Mensagens no app modais {#modal-in-app-messages}
...
Em um tablet ou navegador de desktop, uma mensagem no app modal ainda ficará centralizada na tela do app, conforme mostrado na captura de tela a seguir.

![Mensagem no app modal como apareceria em uma tela grande. Assim como nas telas de celular, a mensagem fica centralizada na tela.]({% image_buster /assets/img/modal-large-viewport.png %}){: style="max-width: 800px; border: none;"}
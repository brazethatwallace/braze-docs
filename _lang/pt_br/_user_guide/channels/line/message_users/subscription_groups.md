...
## Definir o grupo de inscrições LINE de um usuário {#set-a-users-line-subscription-group}

O LINE gerencia o status de inscrição dos usuários. A Braze processa os eventos de seguir e deixar de seguir que atualizam o status de inscrição.

{% alert important %}
Grupos de inscrições LINE não podem ser movidos entre espaços de trabalho. Se você reintegrar um canal LINE em outro espaço de trabalho após arquivar seu grupo de inscrições, a Braze cria um novo grupo de inscrições no espaço de trabalho de destino — o original permanece no primeiro espaço de trabalho.
{% endalert %}
...
- **Arquivamento permanente:** Se você reintegrar o canal do LINE em um espaço de trabalho diferente após arquivar seu grupo de inscrições, o grupo de inscrições original será arquivado permanentemente e não poderá ser desarquivado pelo dashboard.

Para etapas de reintegração de canal, consulte [Configuração do LINE]({{site.baseurl}}/user_guide/channels/line/line_setup#re-integrate-a-line-channel-in-another-workspace).
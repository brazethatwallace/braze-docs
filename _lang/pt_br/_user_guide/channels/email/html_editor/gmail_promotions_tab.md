...
### Etapa 3: Personalizar o cartão de promoção do Gmail
...
### Etapa 4: Gerar e colar o código HTML
...
### Etapa 5: Testar usando a ferramenta de pré-visualização do Gmail
...
- O e-mail está chegando em **Promoções**? Os cartões só se aplicam lá.
...
### Seguir as diretrizes de imagem
...
### Como adiciono um logotipo do remetente?
...
Observe que as anotações não são renderizadas na guia **Principal** ou em qualquer outra guia no app do Gmail para dispositivos móveis. As anotações não serão exibidas após um usuário abrir um e-mail ou se você estiver usando o tipo de anotação `DiscountOffer` e a data e hora já tiverem expirado.

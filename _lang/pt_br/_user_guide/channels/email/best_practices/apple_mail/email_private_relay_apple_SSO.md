...
- O endereço deve ser formatado como: `bounces+<YOUR_UID>@<YOUR_WHITELABELED_SUBDOMAIN_AND_DOMAIN>` (por exemplo: `bounces+1234567@braze.online.docs.com`).

Se o endereço "De" desejado for um endereço `abmail`, inclua isso no seu subdomínio. Por exemplo, use `abmail.docs.braze.com` em vez de `docs.braze.com`.
...
4. Crie seu registro A para apontar para seu CDN ou hospedagem de arquivos.

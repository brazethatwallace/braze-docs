---
nav_title: Entregabilidade de e-mail
article_title: Melhorar a entregabilidade de e-mail
page_order: 6
page_type: reference
description: "Este artigo de referência explica por que e-mails de marketing podem chegar à pasta de spam e como padrões de envio, conteúdo da mensagem e comportamento do destinatário afetam o posicionamento na caixa de entrada."
channel: email
...
- **Colete dados de assinantes de alta qualidade.** Reúna endereços válidos, use opt-in voluntário com linguagem clara e considere opt-in confirmado ou serviços de validação para que os assinantes saibam exatamente o que estão assinando. Projete o fluxo de inscrição para ser claro e resistente a inscrições fraudulentas.
- **Defina e respeite as expectativas sobre conteúdo e frequência.** Evite enviar produtos ou cadências com os quais o assinante não concordou.
- **Envie e-mails que os assinantes queiram abrir e interagir.** Pergunte-se qual valor cada envio oferece antes de programá-lo.
- **Priorize destinatários que fizeram opt-in ou interagiram recentemente** (como usuários que registraram aberturas, cliques e atividade no site). Evite enviar repetidamente para endereços inativos.
- **Separe e-mails transacionais de e-mails de marketing.** Muitos provedores de acesso à internet (ISPs) tratam e-mails transacionais de forma diferente dos de marketing. Separe os dois quando fizer sentido. Por exemplo, endereços de e-mail de remetente distintos podem ser suficientes em alguns casos.

...
- Para usar um modelo de e-mail tanto para versões mobile quanto desktop, mantenha a largura abaixo de 500 pixels.
...
A validação de e-mail acontece quando o endereço de e-mail de um usuário é atualizado ou importado para a Braze pela API, upload de CSV, SDK, ou modificado no dashboard. Os endereços de e-mail não podem conter espaços em branco. Se enviados pela API, espaços em branco podem resultar em um erro `400`.

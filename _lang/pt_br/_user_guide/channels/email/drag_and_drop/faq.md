...
As fontes personalizadas são carregadas na prévia do editor quando um bloco **Text** na mensagem faz referência à fonte. Se a prévia ainda mostrar uma fonte de fallback após você configurar uma fonte personalizada nas configurações do **editor de arrastar e soltar**, adicione um bloco **Text** que use essa fonte para que o editor a carregue na prévia. Confirme que o compartilhamento de recursos entre origens (CORS) está ativado no arquivo da sua fonte. Verifique novamente em **prévia and Test** e nos clientes de e-mail de destino antes de enviar. Para ver as etapas de configuração, consulte [Fonte personalizada]({{site.baseurl}}/user_guide/channels/email/customize/email_global_style_settings#custom-font).

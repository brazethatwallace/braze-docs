...
## Transição para o Android O {#transitioning-to-android-o}
...
1. Abra qualquer Campaign ou Canvas que inclua um push para Android e clique em **Edit Campaign**.
...
5. Insira o nome e o ID do canal de notificação que você deseja adicionar.<br><br>![]({% image_buster /assets/img_archive/Enter_Channel.png %})<br><br>
...
3. Selecione **Manage Notification Channels** após expandir as opções de canal de notificação. <br><br>![]({% image_buster /assets/img_archive/Change_Fallback.png %}){: style="max-width:80%;"}<br><br>

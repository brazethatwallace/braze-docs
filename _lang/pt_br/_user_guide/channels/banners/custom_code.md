...
Se você usar HTML personalizado no design do seu Banner, o SDK da Braze não pode anexar automaticamente ouvintes de cliques a elementos dentro do seu código personalizado. Você deve chamar explicitamente `brazeBridge.logClick()` para qualquer elemento clicável (links, botões e similares) que você deseja rastrear na análise de dados da campanha.

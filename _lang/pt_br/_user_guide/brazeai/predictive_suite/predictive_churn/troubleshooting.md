...
description: "Este artigo de referência aborda algumas etapas de solução de problemas e considerações a ter em mente ao usar o Predictive Churn."
page_order: 3
...
## Erros potenciais {#potential-errors}

### Não há dados suficientes para treinar {#not-enough-data-to-train}
...
### Problemas com o tamanho da população de previsão {#problems-with-prediction-audience-size}
...
### O tamanho da população de previsão é muito grande {#prediction-audience-size-is-too-big}

...
## Etapa 3: Filtrar sua população de previsão {#step-3-filter-your-prediction-audience}
...
Para obter uma lista de exemplos de definições de população de previsão, confira nossos exemplos de definições na seção a seguir sobre [Exemplos de definições de churn](#sample-definitions).
...
## Exemplos de definições de churn e população de previsão {#sample-definitions}
...
Para as definições de churn que descrevemos, pode haver algumas definições de população de previsão correspondentes:<br>

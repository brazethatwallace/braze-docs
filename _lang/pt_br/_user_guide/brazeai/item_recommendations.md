...
{% tabs local %}
{% tab Maior probabilidade de compra %}
...
- Recomendações de itens de IA
- Catálogo de itens relevantes
- Um objeto de compra, um evento de pedido realizado ou qualquer evento personalizado
{% enddetails %}
...
- Recomendações de itens de IA
- Catálogo de itens relevantes
- Um objeto de compra, evento de pedido realizado ou qualquer evento personalizado para uma interação de engajamento
{% enddetails %}
...
- Recomendações de itens de IA
- Catálogo de itens relevantes
- Um método para rastrear compras (seja um objeto de compra, um evento de pedido realizado ou um evento personalizado)
{% enddetails %}
...
{% tabs local %}
{% tab Novos itens %}
Esse cenário não depende diretamente das ações do usuário, mas sim dos dados do catálogo. É possível filtrar novos itens com base na data de adição ao catálogo e promovê-los por meio de Campaigns ou Canvas direcionados sem a necessidade de treinar um modelo de recomendação.
...
- **Programas de fidelidade:** Destacar os produtos que maximizariam os pontos de fidelidade ou as recompensas de um cliente com base em seu saldo de pontos atual.
...
### O que faz com que os itens "Mais populares" sejam misturados às recomendações de outros modelos? {#what-causes-most-popular-items-to-be-mixed-into-other-models-recommendations}
...
### Como evitar itens duplicados em várias seções de recomendação? {#how-do-i-prevent-duplicate-items-across-multiple-recommendation-sections}
...
### As recomendações existentes treinam semanalmente após a atualização para Item Recommendations Pro? {#do-existing-recommendations-train-weekly-after-upgrading-to-item-recommendations-pro}

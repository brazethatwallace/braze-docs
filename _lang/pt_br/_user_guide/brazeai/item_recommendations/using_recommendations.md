...
# Use recomendações de itens no seu envio de mensagens {#use-item-recommendations-in-your-messaging}
...
### Etapa 1: Adicione código Liquid {#step-1-add-liquid-code}
...
### Etapa 2: Referencie uma imagem (opcional) {#step-2-reference-an-image-optional}

...
### Qual é a diferença entre agentes de Canvas e agentes de catálogo?
...
### Posso usar instruções condicionais de Liquid nas instruções do agente?
...
### Os agentes podem acessar dados de usuários além dos atributos ou valores Liquid específicos que eu passo para eles?

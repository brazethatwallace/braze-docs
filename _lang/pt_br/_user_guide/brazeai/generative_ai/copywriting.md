...
# Gerar texto com BrazeAI {#generate-copy-with-brazeai}
...
## Gerando texto {#generating-copy}

### Etapa 1: Abrir o redator de IA {#step-1-launch-ai-copywriter}

No seu criador de mensagens, selecione <i class="fa-solid fa-wand-magic-sparkles"></i> **Abrir AI Copywriter**.

No editor de arrastar e soltar para mensagens no app, selecione um bloco de texto e selecione <i class="fa-solid fa-wand-magic-sparkles" title="AI Copywriter"></i> **AI Copywriter** na barra de ferramentas do bloco.

### Etapa 2: Insira os detalhes {#step-2-enter-the-details}
...
### Etapa 3: Personalize ainda mais (opcional) {#step-3-customize-it-further-optional}
...
- **Referenciar dados de campanhas anteriores**: Quando ativado, as notificações por push anteriores enviadas por meio das suas Campaigns ou etapas do Canvas são usadas como referência estilística para gerar seu novo texto. Para saber mais, consulte [Usando dados de campanhas anteriores](#past-campaign-data).
...
### Etapa 4: Gere seu texto {#step-4-generate-your-copy}

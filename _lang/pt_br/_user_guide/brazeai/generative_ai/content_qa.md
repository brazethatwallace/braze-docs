...
Na guia **Test** para SMS, push Android, push iOS e mensagens no app tradicionais, selecione **Review with Operator** para revisar seu conteúdo antes do envio. O Operator verifica erros de ortografia e gramática, tom inadequado ou fora da marca, linguagem ofensiva e código solto ou Liquid não renderizado. Ele sinaliza cada problema com o texto específico e uma correção sugerida, ou confirma que o conteúdo está limpo.

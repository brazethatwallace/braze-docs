...
# Agentes da Braze no Console do agente
...
{% alert important %}
São necessários créditos de envio de mensagens para acessar e usar os Braze Agents. Se você não tem créditos de mensagens no momento e deseja usar os Braze Agents, entre em contato com seu gerente de conta para saber as próximas etapas.
{% endalert %}
...
### Quando usar os agentes da Braze em comparação com outros recursos do BrazeAI

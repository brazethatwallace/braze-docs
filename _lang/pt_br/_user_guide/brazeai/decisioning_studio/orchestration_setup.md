...
![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_frequency_cap.png %})
...
![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_email_example_1.png %})
...
![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_braze_email_example_2.png %})
...
![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_push_example_1.png %})

![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_push_example_2.png %})

Resultando na seguinte mensagem:

![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_push_example_3.png %})
...
![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_sms_example_1.png %})

![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_sms_example_2.png %})

Resultando na seguinte mensagem:

![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_sms_example_3.png %})
...
![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_custom_example_2.png %})

Pode ser usado para otimizar uma Campaign de e-mail com a seguinte aparência:

![Diagrama do Decisioning Pro]({% image_buster /assets/img/decisioning_studio/decisioning_studio_custom_example_1.png %})

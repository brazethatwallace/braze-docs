...
3. Copie e cole o **Nome de exibição do remetente** no portal do BrazeAI Decisioning Studio™ Go como **Nome de exibição do e-mail**.
4. Copie e cole o endereço de e-mail associado no portal do BrazeAI Decisioning Studio™ Go como **Endereço de e-mail do remetente**, que combina a parte local e o domínio.
...
3. Copie e cole a **chave de API** no portal do BrazeAI Decisioning Studio™ Go.
...
3. Para o tipo da campanha, selecione **Campanha da API**.
...
{: start="5"}
5. Para o canal de envio de mensagens, selecione **E-mail**.
...
{: start="6"}
6. Em **Opções adicionais**, marque a caixa de seleção **Permitir que os usuários se tornem re-elegíveis para receber a campanha**.
7. Para o tempo de re-elegibilidade, insira **1** e selecione **Horas** no menu suspenso.
...
1. Na sua campanha da API, copie o **ID da campanha**. Em seguida, acesse o portal do BrazeAI Decisioning Studio™ Go e cole o **ID da campanha**.
...
{: start="2"}
2. Copie o **ID de variação de mensagem**. Em seguida, acesse o portal do BrazeAI Decisioning Studio™ Go e cole o **ID de variação de mensagem**.
...
3. Acesse **Apps** em **Ferramentas da plataforma** na navegação do painel lateral e selecione **Pacotes instalados**.
...
3. Arraste e solte um nó **Programar** como a **Fonte inicial**.

!["Programar" como a fonte inicial de uma jornada.]({% image_buster /assets/img/decisioning_studio_go/query14.png %})

{: start="4"}
4. No nó **Programar**, selecione **Configurar**.
...
8. Selecione **Concluído** para salvar o agendamento.
...
1. Arraste e solte uma **Consulta SQL** no canvas.
...
{: start="5"}
5. Selecione **Próximo**.
6. No portal do BrazeAI Decisioning Studio™ Go, localize a consulta SQL de dados do sistema em **Recursos de consulta de assinantes**.
...
{: start="8"}
8. No portal do BrazeAI Decisioning Studio™ Go, na seção **Recursos a usar**, localize a chave externa da extensão de dados alvo. Em seguida, cole-a na barra de pesquisa para buscar.

![Uma chave externa colada na barra de pesquisa]({% image_buster /assets/img/decisioning_studio_go/query9.png %})

{: start="9"}
9. Selecione a extensão de dados que corresponde à chave externa pesquisada. O nome da extensão de dados alvo também é fornecido no portal do BrazeAI Decisioning Studio™ Go para referência cruzada. A **Extensão de dados** para a consulta de assinantes deve terminar com o sufixo `BASE_AUDIENCE_DATA`.
...
{: start="5"}
5. Selecione **Próximo**.
6. No portal do BrazeAI Decisioning Studio™ Go, localize a consulta SQL de dados do sistema em **Recursos de consulta de engajamento**.
7. Copie e cole a consulta na caixa de texto e selecione **Próximo**.
...
3. Para o tipo de jornada, selecione **Jornada de múltiplas etapas** e selecione **Criar**.
...
1. Para a fonte de entrada, arraste **Evento de API** para o Journey Builder.

!["Evento de API" selecionado como a fonte de entrada.]({% image_buster /assets/img/decisioning_studio_go/journey2.png %})

{: start="2"}
2. No **Evento de API**, selecione **Criar um evento**.

![A opção "criar um evento" no evento de API.]({% image_buster /assets/img/decisioning_studio_go/journey3.png %})

{: start="3"}
3. Selecione **Selecionar extensão de dados**. Localize e selecione a extensão de dados na qual o BrazeAI Decisioning Studio™ Go gravará as recomendações.
4. Selecione **Resumo** para salvar suas alterações.
5. Selecione **Concluído** para salvar o evento de API.
...
{: start="5"}
5. Insira o ID do modelo do seu primeiro modelo de e-mail e selecione **Concluído**.
6. Selecione **Resumo** para salvar esta jornada.
...
1. Arraste um nó de **E-mail** para cada jornada da **Divisão de decisão**.
2. Selecione **E-mail** e escolha o modelo apropriado para cada jornada (ou seja, o modelo cujo valor de ID corresponda à lógica da sua divisão de decisão).

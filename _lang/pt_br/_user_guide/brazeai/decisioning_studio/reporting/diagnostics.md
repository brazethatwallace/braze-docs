...
# Relatório de diagnósticos {#diagnostics-report}
...
O relatório de diagnósticos de entrada monitora a integridade dos seus Data Feeds no BrazeAI<sup>TM</sup>. Ele rastreia informações como contagem de arquivos, tamanhos e volumes de linhas para cada ativo, ajudando você a confirmar que os dados estão fluindo conforme esperado e a solucionar problemas antes que afetem seus agentes ou Campaigns.

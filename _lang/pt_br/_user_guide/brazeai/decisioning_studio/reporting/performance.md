...
## Como o relatório é construído {#how-the-report-is-built}
...
## Intervalo de datas e grupos de comparação {#date-range-and-comparison-groups}
...
![Relatório de performance mostrando os grupos de comparação, agregação, Segments e filtros de eventos da linha do tempo no topo, junto com o seletor de intervalo de datas no canto superior direito.]({% image_buster /assets/img/decisioning_studio/reporting_performance_date_range.png %})
...
## Tabela agregada {#aggregate-table}
...
### O que significa "único" (ou "distinto")? {#what-does-unique-or-distinct-mean}
...
### Por que o número no gráfico não corresponde ao cartão de resumo? {#why-doesnt-the-number-in-the-chart-match-the-summary-card}

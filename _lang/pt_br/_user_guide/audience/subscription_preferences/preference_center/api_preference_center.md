...
### Ambos os links de cancelamento de inscrição e as centrais de preferências de e-mail são obrigatórios para o envio? {#are-both-unsubscribe-links-and-email-preference-centers-required-for-sending}

...
{% alert note %}
Os eventos de compra devem estar ativados para usar Segments SQL RFM, pois o valor monetário dos seus usuários é determinado pela receita gerada por meio dos eventos de compra da Braze.
{% endalert %}
...
![Modal com a opção de criar um Segment de catálogo para eventos, compras ou Segments RFM.]({% image_buster /assets/img/segment/select_rfm_segment.png %}){: style="max-width:80%" }
...
{: start="5"}
5. Execute uma pré-visualização e salve seu Segment.

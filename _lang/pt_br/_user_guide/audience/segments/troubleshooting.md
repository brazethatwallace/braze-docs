...
- Segments que são apenas listas de IDs de usuários ou e-mails (que frequentemente usam um filtro regex) podem ser convertidos em uma [importação de CSV]({{site.baseurl}}/user_guide/audience/manage_audience/import_users/csv_import) e simplificados em um único filtro baseado em CSV.

...
glossaries:
  - name: Segment Membership
    display_name: "Associação a segmento"
  ...
  - name: Braze Segment Extensions
    display_name: "Extensões de segmento da Braze"
  ...
  - name: Created At
    ...
    tags:
      - Other Filters
  - name: Created From
    display_name: "Criado a partir de"
  ...
  - name: Nested Custom Attributes
    display_name: "Atributos personalizados aninhados"
  ...
  - name: Day of Recurring Event
    display_name: "Dia de evento recorrente"
    ...
    tags:
      - Custom attribute
  - name: Custom Event
    display_name: "Evento personalizado"
  ...
  - name: First Did Custom Event
    display_name: "Primeiro evento personalizado realizado"
  ...
  - name: Last Did Custom Event
    display_name: "Último evento personalizado realizado"
  ...
  - name: X Custom Event In Y Days
    display_name: "X eventos personalizados em Y dias"
  ...
  - name: X Custom Event Property In Y Days
    display_name: "X propriedades de evento personalizado em Y dias"
    ...
    tags:
      - Custom events
  - name: Email Address
    display_name: "Endereço de e-mail"
  ...
  - name: "Random Bucket #"
    ...
    tags:
      - Other Filters
  - name: Session Count
    display_name: "Contagem de sessões"
  ...
  - name: Session Count For App
    display_name: "Contagem de sessões por app"
  ...
  - name: X Sessions In Last Y Days
    display_name: "X sessões nos últimos Y dias"
    ...
    tags:
      - Sessions
  - name: First Used App
    display_name: "Primeiro uso do app"
  ...
  - name: First Used Specific App
    display_name: "Primeiro uso de app específico"
    ...
    tags:
      - Sessions
  - name: Last Used App
    display_name: "Último uso do app"
  ...
  - name: Last Used Specific App
    display_name: "Último uso de app específico"
  ...
  - name: Received Campaign Variant
    display_name: "Recebeu variante de Campaign"
  ...
  - name: Received Message from Canvas Step
    display_name: "Recebeu mensagem de etapa do Canvas"
  ...
  - name: Last Received Message from Specific Canvas Step
    display_name: "Última mensagem recebida de etapa específica do Canvas"
  ...
  - name: Last Received Message from Specific Campaign
    display_name: "Última mensagem recebida de Campaign específica"
  ...
  - name: Received Message from Campaign or Canvas with Tag
    display_name: "Recebeu mensagem de Campaign ou Canvas com tag"
  ...
  - name: Last Received Message from Campaign or Canvas With Tag
    display_name: "Última mensagem recebida de Campaign ou Canvas com tag"
  ...
  - name: Has Never Received a Message from Campaign or Canvas Step
    display_name: "Nunca recebeu mensagem de Campaign ou etapa do Canvas"
  ...
  - name: Last Received Email
    display_name: "Último e-mail recebido"
  ...
  - name: Last Received Push
    display_name: "Último push recebido"
  ...
  - name: Last Received Webhook
    display_name: "Último webhook recebido"
  ...
  - name: Last Received WhatsApp
    display_name: "Último WhatsApp recebido"
  ...
  - name: Live Activities Push to Start Registered for App
    display_name: "Live Activities Push to Start registrado para app"
  ...
  - name: Clicked/Opened Campaign
    display_name: "Clicou/Abriu Campaign"
  ...
  - name: Clicked/Opened Campaign or Canvas With Tag
    display_name: "Clicou/Abriu Campaign ou Canvas com tag"
  ...
  - name: Clicked/Opened Step
    display_name: "Clicou/Abriu etapa"
  ...
  - name: Clicked Alias in Campaign
    display_name: "Clicou em alias na Campaign"
  ...
  - name: Clicked Alias in Canvas Step
    display_name: "Clicou em alias na etapa do Canvas"
  ...
  - name: Clicked Alias in Any Campaign or Canvas Step
    display_name: "Clicou em alias em qualquer Campaign ou etapa do Canvas"
  ...
  - name: Last Sent Specific SMS Inbound Keyword Category
    display_name: "Última categoria de palavra-chave de SMS de entrada enviada"
  ...
  - name: Converted From Campaign
    display_name: "Converteu a partir de Campaign"
  ...
  - name: Converted From Canvas
    display_name: "Converteu a partir de Canvas"
  ...
  - name: In Campaign Control Group
    display_name: "No grupo de controle de Campaign"
  ...
  - name: In Canvas Control Group
    display_name: "No grupo de controle do Canvas"
  ...
  - name: Last Enrolled in Any Control Group
    display_name: "Última inscrição em qualquer grupo de controle"
  ...
  - name: Entered Canvas Variation
    display_name: "Entrou em variação do Canvas"
  ...
  - name: Last Received Any Message
    display_name: "Última mensagem recebida"
  ...
  - name: Last Engaged With Message
    display_name: "Última interação com mensagem"
  ...
  - name: Subscription Group
    display_name: "Grupo de inscrições"
  ...
  - name: Email Available
    display_name: "E-mail disponível"
  ...
  - name: Foreground Push Enabled
    display_name: "Push em primeiro plano ativado"
  ...
  - name: Foreground Push Enabled for App
    display_name: "Push em primeiro plano ativado para app"
  ...
  - name: Background or Foreground Push Enabled
    display_name: "Push em segundo plano ou primeiro plano ativado"
  ...
  - name: X Purchase Property In Y Days
    display_name: "X propriedade de compra em Y dias"
  ...
  - name: Last order placed (last 730 days)
    display_name: "Último pedido realizado (últimos 730 dias)"
  ...
  - name: Total orders count (last 730 days)
    display_name: "Contagem total de pedidos (últimos 730 dias)"
  ...
  - name: Total orders count
    display_name: "Contagem total de pedidos"
  ...
  - name: Total canceled orders count (last 730 days)
    display_name: "Contagem total de pedidos cancelados (últimos 730 dias)"
  ...
  - name: Customer lifetime value (last 730 days)
    display_name: "Valor do tempo de vida do cliente (últimos 730 dias)"
  ...
  - name: Total refund value (last 730 days)
    display_name: "Valor total de reembolsos (últimos 730 dias)"
  ...
  - name: Total refund value
    display_name: "Valor total de reembolsos"
  ...
  - name: Total revenue (last 730 days)
    display_name: "Receita total (últimos 730 dias)"
  ...
  - name: Average order value (last 730 days)
    display_name: "Valor médio do pedido (últimos 730 dias)"
  ...
  - name: Unformatted Phone Number
    display_name: "Número de telefone não formatado"
  ...
  - name: Most Recent App Version Name
    display_name: "Nome da versão mais recente do app"
  ...
  - name: Most Recent App Version Number
    display_name: "Número da versão mais recente do app"
  ...
  - name: Device OS Version Number
    display_name: "Número da versão do SO do dispositivo"
  ...
  - name: Most Recent Device Locale
    display_name: "Localidade mais recente do dispositivo"
  ...
  - name: Amplitude Cohorts
    display_name: "Coortes do Amplitude"
  ...
  - name: Hightouch Cohorts
    display_name: "Coortes do Hightouch"
  ...
  - name: Mixpanel Cohorts
    display_name: "Coortes do Mixpanel"
  ...
  - name: Segment Cohorts
    display_name: "Coortes do Segment"
  ...
  - name: Tinyclues Cohorts
    display_name: "Coortes do Tinyclues"
  ...
  - name: Install Attribution Campaign
    display_name: "Campaign de atribuição de instalação"
  ...
  - name: Event Likelihood Category
    display_name: "Categoria de probabilidade de evento"
  ...
  - name: Event Likelihood Score
    display_name: "Pontuação de probabilidade de evento"

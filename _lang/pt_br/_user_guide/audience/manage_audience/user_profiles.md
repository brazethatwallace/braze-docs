...
| Atribuição de instalação | Informações sobre como e quando um usuário instalou seu app. Saiba mais sobre [entender as instalações dos usuários]({{site.baseurl}}/user_guide/messaging/campaigns/ideas_and_strategies/install_attribution). |
...
- **In-App Messages:** A Braze registra um envio quando a Campaign é lançada.
...
Os seguintes eventos de engajamento com mensagem estão disponíveis para e-mail, SMS, push, In-App Messages, Content Cards e webhooks. Para saber mais sobre como eventos específicos são rastreados, consulte o [Glossário de eventos de engajamento com mensagem]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events).
...
Eventos de interrupção não estão disponíveis atualmente para In-App Messages e Content Cards.

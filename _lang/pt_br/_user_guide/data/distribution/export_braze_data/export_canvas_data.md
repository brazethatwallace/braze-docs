...
- **Criar uma lista de usuários no dashboard:** Crie um Segment com o filtro **Entered Canvas Variation** e exporte o Segment para CSV. Consulte [Solução de problemas do Canvas]({{site.baseurl}}/user_guide/messaging/canvas/troubleshooting#user-didnt-enter-the-canvas).

{% alert note %}
Se você não tem o Currents integrado e precisa de todos os registros de data e hora de entradas históricas, entre em contato com seu CSM da Braze.
{% endalert %}

...
## Armazenamento de data warehouse {#data-warehouse-storage}
O armazenamento de data warehouse oferece uma fonte de coleta para todas as informações transmitidas pelo Currents. Esses parceiros podem atuar como armazéns (para armazenamento de arquivos simples) ou ser usados para alimentar ferramentas de business intelligence e algoritmos de machine learning, obter insights sobre o desempenho de marketing e muito mais.

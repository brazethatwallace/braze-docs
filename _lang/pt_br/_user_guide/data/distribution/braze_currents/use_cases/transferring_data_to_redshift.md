...
Se você ainda não fez isso, siga a [documentação da AWS](http://docs.aws.amazon.com/redshift/latest/gsg/rs-gsg-create-an-iam-role.html) para criar uma função que possa executar comandos `COPY` nos seus arquivos no S3.

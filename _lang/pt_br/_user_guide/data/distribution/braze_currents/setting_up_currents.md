...
| Chave de API ou token do parceiro | Geralmente encontrado no dashboard do parceiro. | Copie e cole no campo designado na Braze. | A Braze tem um campo designado para isso na página de integrações do parceiro. Precisamos disso para mapear para onde enviamos seus dados. **Mantenha suas chaves ou tokens de parceiro atualizados; credenciais inválidas podem desativar seu conector e causar perda de eventos.**

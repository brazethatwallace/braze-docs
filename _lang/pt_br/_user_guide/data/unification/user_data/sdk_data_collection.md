...
| Última Campaign de e-mail recebida                   | Horário                                                                 |
| Última Campaign de push recebida                    | Horário                                                                 |
| Número de itens de feedback                       | Número                                                               |
| Número de sessões nos últimos Y dias          | Número e tempo                                                      |
| Mensagem recebida da Campaign                 | Booleano. Esse filtro direciona os usuários com base no fato de terem recebido uma Campaign anterior. |
...
| Local do dispositivo           | Android, iOS, Web | O local padrão do dispositivo                                                   | Esse atributo é usado para traduzir mensagens para o idioma preferido do usuário.                                                                                            |
| Local mais recente do dispositivo           | Android, iOS, Web | O local padrão mais recente do dispositivo                                                   | Esse atributo vem das configurações do dispositivo do usuário e é usado para traduzir mensagens para o idioma preferido do usuário. É independente do atributo `Most Recent Location`.                                                                                            |

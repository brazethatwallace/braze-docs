...
![Uma opção para testar a conexão com uma pré-visualização de dados.]({% image_buster /assets/img/cloud_ingestion/s3_ingestion_4.png %})
...
### Tratando erros inesperados de arquivos {#handling-unexpected-file-errors}

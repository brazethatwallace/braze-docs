...
page_order: 1
page_type: reference
description: "Este artigo descreve como enviar dados JSON aninhados como propriedades de eventos personalizados e compras, e como usar esses objetos aninhados no envio de mensagens."
---
...
2. Na sua campanha ou Canvas, acesse **Pré-visualização e teste**.
...
1. Crie uma campanha ou etapa do Canvas que tenha como alvo apenas seus usuários teste e seja disparada pelo (ou referencie o) evento personalizado com propriedades aninhadas.

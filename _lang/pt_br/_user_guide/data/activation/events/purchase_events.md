...
page_order: 3
page_type: reference
description: "Este artigo de referência descreve eventos e propriedades de compra, seu uso, segmentação, onde visualizar análises de dados relevantes e mais."
search_rank: 3
---
...
Você pode registrar compras enviando um [objeto de compra]({{site.baseurl}}/api/objects_filters/purchase_object/) pelo [endpoint `/users/track`]({{site.baseurl}}/api/endpoints/user_data/post_user_track/), ou usando uma das nossas bibliotecas de SDK listadas abaixo.

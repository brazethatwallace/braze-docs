...
{% alert important %}
Os eventos recomendados estão atualmente em acesso antecipado. Entre em contato com seu gerente de sucesso do cliente da Braze se tiver interesse em participar desse acesso antecipado. <br><br>Se você está utilizando o novo [conector do Shopify]({{site.baseurl}}/partners/ecommerce/shopify/multiple_stores/?tab=shopify%20connector), esses eventos recomendados estarão automaticamente disponíveis por meio da integração.
{% endalert %}

## Como funciona

A Braze aplica validação especial a todos os eventos recomendados, e alguns eventos recomendados possuem ações especiais de pós-processamento. Para determinados eventos recomendados do setor, a Braze pode oferecer tratamento especial, como novos gatilhos baseados em ação para campanhas e Canvas.

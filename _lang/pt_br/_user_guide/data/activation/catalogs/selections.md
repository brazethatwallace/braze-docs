...
page_order: 5
description: "Este artigo de referência aborda como criar e usar seleções com seus catálogos para fazer referência a dados em suas campanhas da Braze."
---
...
Depois de criar um catálogo, você pode fazer referência adicional aos dados do catálogo incorporando seleções em suas campanhas ou recomendações da Braze.

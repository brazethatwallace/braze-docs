...
## Bloqueando dados personalizados
...
### Bloqueando atributos personalizados, eventos personalizados e produtos

{% alert important %}
Quando um evento ou atributo é bloqueado, qualquer segmento, campanha ou Canvas que use esse evento ou atributo é arquivado.
{% endalert %}
...
### Considerações sobre o bloqueio
...
## Excluindo dados personalizados

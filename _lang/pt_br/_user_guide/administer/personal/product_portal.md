...
# Portal do produto ![Menu de recursos no dashboard da Braze]({% image_buster /assets/img/portal.png %}){: style="float:right;max-width:33%;margin-left:15px;margin-top:15px;"} {#product-portal-resources-menu-in-the-braze-dashboard-imagebuster-assetsimgportalpng-stylefloatrightmax-width33margin-left15pxmargin-top15px}
...
## O que há no portal {#whats-in-the-portal}

| Seção | Descrição |
| --- | --- |
| Lançados recentemente | Novos recursos que lançamos por trimestre |
...
A Braze constrói o roadmap de produto com base em diversas fontes de informação. Utilizamos dados dos nossos clientes, do mercado, do cenário tecnológico em que operamos, da nossa visão de produto e estratégia de inovação, entre outros. A contribuição e o feedback dos clientes são um componente importante, mas são apenas um componente.

Prioridades e cronogramas podem (e mudam) com base nas informações mais recentes disponíveis para a equipe. Com isso em mente, é sempre recomendável enviar feedback de produto de forma oportuna para que a equipe de produto esteja ciente do sentimento dos clientes e do mercado.

- **Enviar feedback de produto é uma garantia** de que nossa equipe de produto revisará e considerará o feedback.
- **Enviar feedback de produto não é uma garantia** de que tomaremos alguma ação. A Braze não pode e não deseja agir com base em todo feedback de produto.

## Dicas para enviar feedback de produto {#tips-for-submitting-product-feedback}

Quanto mais informação e contexto, melhor! Inclua links para Campaigns, Canvas ou Segments — tudo que ajude na descrição. Estruturamos o feedback de produto com base nas seguintes perguntas:

- Qual problema você está tentando resolver?
- Quais são alguns casos de uso específicos?

...
page_order: 4
description: "Esta página vai ajudar você a localizar o Portal de Suporte da Braze para enviar feedback sobre produtos da Braze. Esta página só estará acessível para clientes da Braze."
alias: /braze_support/
page_type: reference
search_rank: 7
---

# [![Curso do Braze Learning]({% image_buster /assets/img/bl_icon3.png %})](https://learning.braze.com/the-braze-support-portal/){: style="float:right;width:120px;border:0;" class="noimgborder"}Suporte da Braze {#braze-learning-course-imagebuster-assetsimgblicon3png-httpslearningbrazecomthe-braze-support-portal-stylefloatrightwidth120pxborder0-classnoimgborderbraze-support}
...
![O menu suspenso "Support" com a opção de obter ajuda.]({% image_buster /assets/img_archive/get_help.png %}){: style="max-width:60%;"}
...
## Visualizar casos da sua empresa {#view-cases-from-your-company}

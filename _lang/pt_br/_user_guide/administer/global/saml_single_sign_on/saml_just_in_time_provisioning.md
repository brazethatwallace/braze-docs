...
## Configurando o provisionamento just-in-time com SAML (JITP) {#setting-up-saml-just-in-time-provisioning-jitp}
...
### Como desativo o JITP com SAML? {#how-do-i-disable-saml-jitp}

Após configurar o JITP, você deve [entrar em contato com o Suporte]({{site.baseurl}}/braze_support) para desativá-lo.

## Solução de problemas {#troubleshooting}

### O botão de login único não aparece com o Microsoft Entra ID {#single-sign-button-doesnt-appear-with-microsoft-entra-id}

...
- Os filtros de segmentação no formato "Fez X antes/depois de `Date`" terão o horário ajustado, pois a data inicial agora será localizada no fuso horário padrão do seu espaço de trabalho (por exemplo, horário do Pacífico).
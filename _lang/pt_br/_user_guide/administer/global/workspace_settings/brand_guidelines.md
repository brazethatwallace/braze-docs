...
page_order: 1
page_type: reference
description: "Este artigo de referência descreve como criar, gerenciar e adicionar diretrizes da marca como contexto para o Operator e os agentes."
---
...
Na página **Brand Guidelines**, selecione **Create new**. Se você quiser que essa diretriz da marca seja o padrão do espaço de trabalho, selecione **Use as default brand guideline**. Você pode ter um padrão por espaço de trabalho.
...
Aqui estão algumas características a considerar:
...
| Traços de personalidade  | Características humanas que descrevem o caráter da sua marca.                        | Nossa marca é amigável, acessível e sempre positiva.               |
...
| Diferenciação            | Qualidades únicas que diferenciam sua marca dos concorrentes.                        | Nos destacamos por oferecer um atendimento personalizado que vai além. |
| Voz da marca             | O tom e estilo de comunicação que sua marca utiliza.                                  | Nossa voz é casual, mas informativa, garantindo clareza sem ser formal demais. |
...
![A janela "Create brand guideline" com campos para inserir nome, descrição, personalidade, exclusões e tom.]({% image_buster /assets/img/guidelines_create.png %})

### Etapa 4: Testar suas diretrizes {#step-4-test-your-guidelines}

Teste suas diretrizes para ver como elas funcionam. Expanda **Test your guidelines** para gerar textos de exemplo e ajuste conforme necessário.
...
No painel de chat do Operator, selecione <i class="fa-regular fa-plus"></i>&nbsp;**Adicionar contexto para o Operator** e, em seguida, escolha uma ou mais diretrizes em **Brand guidelines**. O Operator aplica as diretrizes selecionadas ao texto gerado, modelos e imagens. Por padrão, nada é selecionado.
...
Ao configurar um agente, selecione as diretrizes da marca em [Adicionar contexto]({{site.baseurl}}/user_guide/brazeai/agents/creating_agents#add-resources) para que o agente siga essa voz e estilo. O Agent Console seleciona o padrão do espaço de trabalho para você.

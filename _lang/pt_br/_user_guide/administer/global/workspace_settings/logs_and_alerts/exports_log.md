...
## Compartilhamento de um registro de exportação específico {#sharing-a-specific-export-log}

Compartilhe um registro de exportação selecionando o **ID de exportação** e, em seguida, **Compartilhar registro**.

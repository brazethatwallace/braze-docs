...
> A página **Início** no dashboard fornece métricas essenciais para você acompanhar e entender a performance do seu app ou site, além de oferecer uma visão geral de alto nível da sua base de usuários.
...
Você pode revisitar campanhas, Canvas e segmentos editados ou criados recentemente. Cada cartão é acompanhado de tags que indicam o tipo de conteúdo (campanha, Canvas, segmento) e o status (ativo, rascunho, arquivado, parado).

{% alert note %}
A seção **Continue de onde parou** aparece depois que você edita ou cria uma campanha, Canvas ou segmento.
{% endalert %}
...
Selecione **Mostrar detalhamento** para cada linha das estatísticas da visão geral de performance para visualizar o valor de cada estatística por dia no intervalo de datas especificado.

![Expandir]({% image_buster /assets/img_archive/home_dashboard_breakdown.png %})

### Performance ao longo do tempo

O gráfico **Performance ao longo do tempo** mostra o valor de cada estatística no intervalo de datas especificado para os apps selecionados.

![O gráfico Performance ao longo do tempo mostrando estatísticas de novos usuários ao longo de 30 dias.]({% image_buster /assets/img/dashboards/performance_over_time.png %})

Você pode visualizar estatísticas para:
- Banners
- Cartões de conteúdo
- Usuários ativos diários
  - (Opcional) Detalhamento por segmento
- E-mail
- Mensagens no app
- Fórmulas de KPI
...
- Push
  - (Opcional) Detalhamento por segmento
- Sessões
  - (Opcional) Detalhamento por segmento ou versão do app
- Sessões por hora
- Sessões por MAU
- SMS
- Stickiness

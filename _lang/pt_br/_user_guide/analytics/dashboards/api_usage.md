...
> O dashboard de uso da API permite monitorar o tráfego de entrada da API REST na Braze para entender as tendências de uso das nossas APIs REST e solucionar possíveis problemas.
...
O dashboard padrão exibe todas as solicitações de entrada da API REST para o seu espaço de trabalho nas últimas 24 horas. Dependendo do seu caso de uso, você pode ajustar os controles do dashboard para filtrar ou agrupar o tráfego e também configurar o intervalo de tempo do dashboard.
...
Selecione **Filtros** para aplicar filtros e restringir a visualização do tráfego da API REST para o seu espaço de trabalho, incluindo:

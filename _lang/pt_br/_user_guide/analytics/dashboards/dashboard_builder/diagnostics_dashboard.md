...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Limite de taxa e temporização" }
...
- **Critérios de público:** Menos usuários do que o esperado podem ter atendido aos critérios de público (por exemplo, não estavam no Segment ou não tinham os atributos necessários) quando a campanha ou o Canvas foi lançado.

...
2. Selecione **Segment breakdowns** para a métrica, o que filtra os modelos para aqueles em que as métricas incluem detalhamentos por Segment or segmento, que são:
- Métricas de desempenho de e-mail por Segment or segmento or segmento
- Métricas de engajamento de e-mail para variantes ou etapas, por Segment or segmento or segmento
- Compras e receita por Segment or segmento or segmento
- Compras e receita para variantes ou etapas, por Segment or segmento or segmento
- Desempenho de push por Segment or segmento or segmento

![A página de detalhamento por Segment or segmento or segmento contém um editor SQL, um painel lateral com guias para Variáveis, Tabelas de dados disponíveis, Histórico de consultas e o Criador de consultas com IA, além de uma seção de resultados.]({% image_buster /assets/img_archive/segment_breakdown.png %})
...
Seus resultados mostrarão métricas de engajamento de e-mail por Segment or segmento or segmento para as Campaigns ou Canvas que você selecionou. Se você não selecionou Campaigns ou Canvas específicas, seu relatório mostrará as métricas de e-mail para cada Segment or segmento or segmento em todas as Campaigns e Canvas de e-mail dentro do período do relatório.
...
Para visualizar o desempenho de e-mail detalhado por Segment or segmento or segmento no nível de variante de Campaign, variante de Canvas ou etapa do Canvas, primeiro escolha um relatório no nível de variante ou etapa (são relatórios que possuem "for variants or steps" no título) e, em seguida, use a guia **Variáveis** para especificar o seguinte:
...
Seus resultados mostrarão métricas de engajamento de e-mail por Segment or segmento or segmento para as variantes ou etapas selecionadas.
...
Para visualizar métricas de compra e receita detalhadas por Segment or segmento or segmento para uma Campaign ou Canvas específica, use a guia [Variáveis](#variables) para especificar o seguinte:
...
Por exemplo, digamos que um Segment or segmento or segmento contém 10 usuários e cinco deles fizeram uma compra após receber seu e-mail. Se um desses cinco fez uma compra após clicar no seu e-mail, sua "taxa de compras únicas após recebimento" seria de 50% e sua "taxa de compras únicas após clique" seria de 10%.
...
Seus resultados mostrarão métricas de compra por Segment or segmento or segmento para as Campaigns ou Canvas selecionadas. Se você não selecionou Campaigns ou Canvas específicas, seu relatório mostrará as métricas de compra para cada Segment or segmento or segmento em todas as Campaigns ou Canvas de e-mail dentro do período do relatório.
...
Para visualizar métricas de compra e receita detalhadas por Segment or segmento or segmento para uma variante de Campaign, variante de Canvas ou etapa do Canvas específica, use a guia [Variáveis](#variables) para especificar o seguinte:
...
Seus resultados mostrarão métricas de compra por Segment or segmento or segmento para as variantes ou etapas selecionadas.

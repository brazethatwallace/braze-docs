...
<span class="calculation-line">Cálculo: (Body Clicks) / (Impressões)</span>
...
<span class="calculation-line">Cálculo: (Button 1 Clicks) / (Impressões)</span>
...
<span class="calculation-line">Cálculo: (Button 2 Clicks) / (Impressões)</span>

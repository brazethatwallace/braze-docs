...
glossaries:
  ...
  - name: Anonymous users
    description: "Quando um perfil de usuário é reconhecido por meio do SDK, um perfil de usuário anônimo é criado com o <a href=\"/docs/api/basics#user-ids\">ID de usuário da Braze</a> associado."
  - name: API campaigns
  ...
  - name: Endpoint
    description: "Uma extremidade de um canal de comunicação, também conhecida como <a href=\"/docs/api/endpoints\">endpoint</a> de API, é usada na API de envio de mensagens da Braze para enviar e agendar mensagens."
  ...
  - name: Push token
    description: "Um token por push é uma chave exclusiva, criada e atribuída pela Apple ou pelo Google para criar uma conexão entre um app e um dispositivo iOS, Android ou web. <a href=\"/docs/api/objects_filters/user_attributes_object#migrate-push-tokens\">A migração de token por push</a> é a importação dessas chaves já geradas para a Braze."

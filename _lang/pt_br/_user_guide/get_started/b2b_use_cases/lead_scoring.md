...
#### Etapa 3b: Definir reelegibilidade do Canvas
...
#### Etapa 4d: Adicionar etapas de Atualização de usuário
...
#### Etapa 2b: Agendar envios de webhook
...
Selecione **Lançamento** e veja o status do seu lead mudar no Salesforce à medida que seus clientes ultrapassam o limite de pontuação de lead MQL.
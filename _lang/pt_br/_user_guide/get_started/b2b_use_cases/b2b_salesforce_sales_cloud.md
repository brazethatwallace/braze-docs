...
1. Parte de uma [campanha de novo usuário](#new-lead) que cria um lead no Salesforce
...
#### Adição da etapa do Canvas para verificar os usuários que ultrapassaram o limite de MQL

...
## Etapa 3: Inicialize a conexão com o SDK da Braze
...
## Etapa 4: Permita as notificações push
...
## Etapa 5: Experimente o envio de mensagens da Braze no Pilot
...
Para mais informações sobre como configurar campanhas e Canvas na Braze, consulte [Primeiros passos: Campanhas e Canvas]({{site.baseurl}}/user_guide/get_started/campaigns_and_canvases/).
...
article_title: Práticas recomendadas para Campanhas
page_order: 0
description: "Este artigo apresenta práticas recomendadas para criar e personalizar suas campanhas."
tool: Campaign
...
- **Trigger (Disparar)** suas mensagens com entrega [baseada em ação]({{site.baseurl}}/user_guide/messaging/campaigns/schedule_your_campaign/triggered_delivery#action-based-delivery) ou [disparada por API]({{site.baseurl}}/user_guide/messaging/campaigns/schedule_your_campaign/api_triggered_delivery/).
...
Se seu objetivo é atrair os usuários para uma nova funcionalidade ou versão do app, use uma estratégia multicanal com foco em canais no app. [Mensagens no app]({{site.baseurl}}/in-app_messages/) e [Cartões de conteúdo]({{site.baseurl}}/user_guide/channels/content_cards/) geralmente são menos intrusivos caso o usuário não queira atualizar imediatamente.
...
![Um exemplo de segmento que direciona usuários avançados de um app.]({% image_buster /assets/img_archive/ratings_power_users.png %})

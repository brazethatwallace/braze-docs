...
## Etapa 1: Identificando seus principais usuários
...
![Captura de tela do construtor de segmentos com filtros para definir os principais usuários do app.]({% image_buster /assets/img_archive/define_top_users.png %} "Defina seus principais usuários")
...
### Faça seus usuários se sentirem valorizados
...
![Uma campanha na etapa Redigir com uma notificação Rich para iOS que diz: "Obrigado novamente por comprar conosco! Para mostrar nossa gratidão, estamos oferecendo frete grátis na sua próxima compra".]({% image_buster /assets/img/congratulations_push.jpg %})

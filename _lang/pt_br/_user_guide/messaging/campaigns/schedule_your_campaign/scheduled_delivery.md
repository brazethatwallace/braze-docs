...
## Opção 1: Enviar assim que a campaign for lançada {#option-1-send-as-soon-as-the-campaign-is-launched}
...
![As opções de agendamento baseadas em horário para enviar uma Campaign em um horário designado.]({% image_buster /assets/img_archive/schedule_designated.png %})

...
## Opção 1: Enviar assim que a campanha for lançada
...
## Opção 2: Enviar em um horário designado
...
## Avaliação de critérios de público com postergações

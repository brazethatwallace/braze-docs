...
guide_top_text: "Saiba mais sobre como criar sua campanha ideal com esses casos de uso e outras ideias."
page_order: 5

tool: Campaigns
page_type: landing
description: "Esta landing page reúne ideias e estratégias de campanhas. Aqui, você encontra artigos sobre temas como localização, redirecionamento, práticas recomendadas e muito mais."
...
guide_featured_list:
  ...
  - name: Recuperando usuários inativos
    ...
    image: /assets/img/braze_icons/users-01.svg
  - name: Campanha de atribuição da instalação
    link: /docs/user_guide/messaging/campaigns/ideas_and_strategies/install_attribution
    image: /assets/img/braze_icons/pie-chart-01.svg
  - name: Divulgação de funcionalidades e nova versão do app
  ...
  - name: Campanhas de redirecionamento
    ...
    image: /assets/img/braze_icons/target-04.svg
  - name: Automatizar registro no Zoom

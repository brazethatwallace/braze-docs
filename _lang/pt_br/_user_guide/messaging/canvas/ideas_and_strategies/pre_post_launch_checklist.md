...
# Checklist de pré e pós-lançamento
...
### Revise as configurações de fuso horário
...
### Considere usar expressões regulares nos filtros de público
...
### Identifique configurações de entrada e condições de corrida
...
### Verifique as propriedades de entrada do Canvas e as propriedades de evento
...
### Revise as etapas de Mensagem para avanço de usuários
...
## O que considerar após o lançamento
...
### Volumes de envio suspeitos entre jornadas

...
Para ver uma lista de filtros de eCommerce e suas definições, consulte [Filtros de Segment or segmento]({{site.baseurl}}/user_guide/audience/segments/segmentation_filters) e selecione a categoria de pesquisa "eCommerce".

![Menu suspenso de filtros de Segment or segmento or segmento com filtros "eCommerce".]({% image_buster /assets/img_archive/ecommerce_filters.png %}){: style="max-width:50%"}
...
Para segmentar por propriedades de evento aninhadas, você pode usar as [extensões de Segment or segmento or segmento]({{site.baseurl}}/user_guide/audience/segments/segment_extension#why-use-segment-extensions). Por exemplo, você pode usar extensões de Segment or segmento or segmento para encontrar quem comprou o produto "SKU-123" nos últimos 90 dias.

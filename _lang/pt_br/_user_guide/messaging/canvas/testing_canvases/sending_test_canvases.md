...
## Etapa 2: Identifique os usuários teste
...
### Identifique as etapas do seu Canvas
...
Se algum conteúdo for repetido no seu framework de testes (por exemplo, Liquid complexo para filtrar usuários em diferentes etapas do Canvas), tente salvar esse conteúdo repetido como um [bloco de conteúdo]({{site.baseurl}}/user_guide/messaging/design_and_edit/content_blocks/). Assim, você poderá incluir o bloco de conteúdo nas etapas individuais do Canvas.

### Use o Postman e o endpoint de rastreamento de usuários
...
#### Testando múltiplas ramificações

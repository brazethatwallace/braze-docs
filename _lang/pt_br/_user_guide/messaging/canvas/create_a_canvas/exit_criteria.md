...
## Configurando critérios de saída
...
### Usando segmentos e filtros

Você também pode adicionar segmentos e filtros nos critérios de saída. Isso significa que os usuários que correspondem ao segmento e ao filtro sairão do Canvas e não receberão mais nenhuma mensagem.
...
### Tendo o mesmo evento de saída e evento de conversão

...
Após lançar uma etapa de Content Cards no Canvas, você pode começar a analisar diversas métricas para essa etapa. Essas métricas incluem o número de mensagens enviadas, destinatários únicos, taxas de conversão, receita total e muito mais.

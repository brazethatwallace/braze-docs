...
### Etapa 1: Adicionar uma etapa de Jornadas do experimento {#step-1-add-an-experiment-path-step}
...
Finalize a configuração do seu Canvas conforme necessário e lance-o. Quando o primeiro usuário entrar no experimento, você pode verificar o Canvas para acompanhar a análise de dados à medida que chegam e [rastrear o desempenho do seu experimento]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/experiment_step#tracking-performance).

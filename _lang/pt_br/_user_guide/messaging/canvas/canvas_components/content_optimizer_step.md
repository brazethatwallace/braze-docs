...
page_order: 5
description: "A etapa do agente Otimizador de conteúdo permite configurar e testar múltiplas versões de componentes de conteúdo em uma única etapa. Ela ajuda você a experimentar variações de conteúdo e otimiza automaticamente em direção às combinações com melhor performance ao longo do tempo."
page_type: reference

---

# Etapa do agente Otimizador de conteúdo

> A etapa do agente Otimizador de conteúdo permite configurar e testar múltiplas versões de componentes de conteúdo em uma única etapa. Ela ajuda você a experimentar variações de conteúdo e otimiza automaticamente em direção às combinações com melhor performance ao longo do tempo. Para uma introdução, consulte [Otimizador de conteúdo]({{site.baseurl}}/user_guide/brazeai/content_optimizer/).
...
### Etapa 2: Criar sua mensagem base
...
Componentes de conteúdo são os elementos individuais da sua mensagem que você deseja testar, como diferentes linhas de assunto ou títulos. Esses componentes permitem gerar múltiplas versões de uma mensagem e otimizar automaticamente com base na performance ao longo do tempo.
...
Para cada componente selecionado, defina um conjunto de versões alternativas desse conteúdo (variantes). Use variantes claras e distintas que difiram em tom, estrutura ou conteúdo. Isso ajuda o Otimizador de conteúdo a identificar as melhores performances de forma mais eficaz. Você pode:
...
#### Etapa 4.2: Adicionar Liquid à sua mensagem
...
Conforme o Canvas é executado, o agente combina e alterna variantes entre componentes para gerar diferentes combinações de conteúdo. Com o tempo, as combinações com melhor performance são priorizadas para entrega, ajudando você a melhorar a performance sem intervenção manual.

#### Referências de Liquid
...
### Etapa 5: Selecionar evento de otimização

O evento de otimização determina como o agente Otimizador de conteúdo avalia a performance e distribui o tráfego para as combinações de conteúdo ao longo do tempo.
...
Para e-mail, você pode otimizar para um dos seguintes eventos. O agente usa aberturas e cliques registrados dentro de 7 dias após o envio de uma mensagem para direcionar a entrega para combinações de conteúdo com melhor performance.
...
### Por que a análise de dados da etapa difere da análise geral

Razões pelas quais a análise de dados na etapa do Otimizador de conteúdo difere da seção **Análise de dados** incluem:

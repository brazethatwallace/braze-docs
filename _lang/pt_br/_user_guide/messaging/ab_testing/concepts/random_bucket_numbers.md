...
### Quando usar números de bucket aleatórios
...
## Criar segmentos usando números de bucket aleatórios
...
### Reentrada aleatória de público usando números de bucket aleatórios
...
5. Lance sua campanha e monitore a performance de cada bucket. Você pode analisar métricas como taxas de engajamento e taxas de conversão para determinar a eficácia da reentrada aleatória de público no seu caso de uso.
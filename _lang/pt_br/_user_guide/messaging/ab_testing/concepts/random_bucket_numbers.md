...
3. Na seção **Público-alvo** da sua Campaign ou Canvas, especifique as configurações de bucket aleatório. Isso permite que a Braze atribua automaticamente os usuários aos buckets apropriados com base nas porcentagens definidas.

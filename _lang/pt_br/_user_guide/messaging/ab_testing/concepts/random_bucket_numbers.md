...
Ao [criar um Segment]({{site.baseurl}}/user_guide/audience/segments/creating_a_segment), adicione o filtro "Random Bucket #". Em seguida, especifique um número ou intervalo de números para incluir no seu Segment.

![Um filtro de Segment para números de bucket aleatórios não superiores a "3000".]({% image_buster /assets/img_archive/random_buckets_filterexample.png %})
...
- Os números de bucket de 0 a 2499 correspondem ao Segment de controle
- Os números de bucket de 2500 a 4999 correspondem ao Segment que receberá a variante 1
- Os números de bucket de 5000 a 7499 correspondem ao Segment que receberá a variante 2
- Os números de bucket de 7500 a 9999 correspondem ao Segment que receberá a variante 3

Dependendo de quantos segmentos você deseja e da distribuição de usuários em cada Segment, seu plano pode ser diferente.

Para cada um dos seus segmentos de número de bucket aleatório, incluindo o grupo de controle, ative o [rastreamento de análise de dados]({{site.baseurl}}/user_guide/analytics/tracking/segment_analytics_tracking). Ao avaliar o sucesso das variantes em relação ao grupo de controle, você pode acessar a página de [eventos personalizados]({{site.baseurl}}/user_guide/analytics/reports/custom_events_report) e verificar com que frequência cada Segment concluiu determinados eventos personalizados.
...
1. [Crie seu Segment]({{site.baseurl}}/user_guide/audience/segments/creating_a_segment).
...
4. Configure uma lógica que permita que os usuários reentrem no Segment. Por exemplo, você pode permitir que os usuários reentrem no Segment se não interagiram com um app por 15 dias.

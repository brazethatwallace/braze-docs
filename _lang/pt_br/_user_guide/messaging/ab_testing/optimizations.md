...
article_title: Otimize os testes A/B com Variante Vencedora ou Variantes Personalizadas
page_order: 1
page_type: reference
...
Ao [criar um teste A/B]({{site.baseurl}}/user_guide/messaging/ab_testing/create_tests/) para Campaigns de e-mail, push, webhook, SMS e WhatsApp programadas para envio único, você pode selecionar uma otimização. Existem duas opções de otimização: **Variante Vencedora** e **Variante Personalizada**.

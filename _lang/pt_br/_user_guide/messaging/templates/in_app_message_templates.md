---
nav_title: Modelos de mensagens no app
article_title: Modelos de mensagens no app
page_order: 4
layout: dev_guide
guide_top_header: "Modelos de mensagens no app"
guide_top_text: "Crie e gerencie modelos de mensagens no app em **Modelos** > **Modelos de mensagens no app**. Salve disposições do editor de arrastar e soltar ou crie perfis de cores e modelos CSS para o editor tradicional. Você também pode começar a partir de um modelo pré-criado da Braze."
description: "Saiba mais sobre os modelos de mensagens no app na Braze, incluindo como criar modelos, modelos da Braze e perfis de cores e modelos CSS para o editor tradicional."

guide_featured_title: "Artigos da seção"
guide_featured_list:
  - name: Criar um modelo de mensagem no app
    link: /docs/user_guide/messaging/templates/in_app_message_templates/in_app_message_template
    image: /assets/img/braze_icons/brush-02.svg

guide_menu_title: "Modelos da Braze"
guide_menu_list:
  ...
  - name: Promoção sazonal com imagem

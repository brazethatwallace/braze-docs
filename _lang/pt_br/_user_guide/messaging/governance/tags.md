...
page_order: 10
page_type: reference
description: "Este artigo de referência aborda tags para Campaigns, Canvas, segmentos e dados personalizados no dashboard da Braze."
tool:
  - Campaigns
  - Canvas
---
...
Você também pode adicionar tags a várias Campaigns, Canvas ou Segments selecionando múltiplos engajamentos e clicando em <span style="font-size: 14px;margin-bottom: .5rem;height: 16px;width: 16px;" class="fas fa-tag" ></span>**Tag As**.

![Adicionando tags a várias Campaigns ao mesmo tempo.]({% image_buster /assets/img_archive/tags_apply_multiple.gif %})

{% alert important %}
Quando você usa tags em massa para aplicar uma nova tag a várias Campaigns que já possuem tags diferentes, cada Campaign selecionada recebe a nova tag, e quaisquer tags presentes em uma Campaign são aplicadas a todas as outras Campaigns selecionadas, mesmo que essas tags não estivessem originalmente associadas a elas.
{% endalert %}
...
As tags ficam visíveis na lista de Campaigns, Canvas ou Segments, junto com tags adicionais para rótulos de status como **Archived** e **Draft**. Para filtrar por uma tag, selecione o nome da tag na lista de tags.

![Tags na lista de Campaigns.]({% image_buster /assets/img_archive/tags_grid.png %})

...
Por padrão, a configuração do fluxo de aprovação está desativada para Campaigns e Canvas. Para ativar esse recurso, acesse **Settings** > **Approval Workflow** e selecione o botão de alternância aplicável:

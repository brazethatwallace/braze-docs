...
Alguns canais criam uma cópia otimizada da imagem quando a mensagem é configurada, resultando em uma URL separada. Substituir o ativo original da biblioteca de mídia não atualiza o que os consumidores veem nas mensagens criadas usando esses canais, incluindo mensagens no app, Content Cards, notificações por push e banners.

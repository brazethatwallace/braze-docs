...
### Existem limites de armazenamento para imagens na Biblioteca de mídia?
...
### Existem datas de expiração para ativos enviados?
...
### Posso recortar todos os tipos de imagem?

Não, a Biblioteca de mídia não oferece suporte ao recorte de imagens GIF.

### Como faço para recortar uma imagem existente?
...
### Minha imagem fica expirando quando tento fazer upload. O que posso fazer?
...
### Vejo um "Erro inesperado" ao fazer upload de uma imagem, mesmo ela tendo menos de 5 MB e estando em um formato compatível. Qual é o problema?
...
### Por que não consigo fazer upload de qualquer imagem nos criadores de push?

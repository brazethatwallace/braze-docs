...
### Especificações dos blocos de conteúdo
...
1. Acesse a guia **Linhas** no editor e selecione **Blocos de conteúdo**.
...
1. Copie a **Liquid tag do bloco de conteúdo** na seção **Informações do bloco de conteúdo**.
...
3. Selecione **Blocos de conteúdo** no menu suspenso **Tipo de personalização**.
4. Selecione o nome do seu bloco de conteúdo no campo **Atributo**.
...
- As propriedades de eventos do Canvas são suportadas apenas em um Canvas. Se você referenciar um bloco de conteúdo com propriedades de entrada do Canvas em uma campanha, ele não será preenchido.

## Pré-visualizar blocos de conteúdo

Após adicionar um bloco de conteúdo em uma campanha ou Canvas ativo, você pode pré-visualizá-lo na Biblioteca de blocos de conteúdo passando o cursor sobre o bloco de conteúdo e selecionando o ícone <i class="fa fa-eye preview-icon"></i> **Pré-visualização**.
...
## Atualizar e copiar blocos de conteúdo

Se você optar por atualizar um bloco de conteúdo, ele será atualizado em todas as mensagens onde foi inserido via Liquid. Se o bloco de conteúdo foi importado usando o menu suspenso **Blocos de conteúdo** em **Linhas** no editor de arrastar e soltar, ele não será atualizado em todas as mensagens.
...
Após fazer edições em um bloco de conteúdo, você pode salvar e lançar o bloco de conteúdo atualizado selecionando **Lançar bloco de conteúdo**. Ou você pode selecionar **Mais** > **Duplicar** para criar uma cópia do seu bloco de conteúdo.

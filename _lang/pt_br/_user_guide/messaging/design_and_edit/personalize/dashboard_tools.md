...
# Ferramentas do dashboard para personalização
...
## Adicionar Personalização em criadores e configurações
...
- **Etapas de Campanha e Canvas** para canais que suportam Liquid no corpo ou nos cabeçalhos (por exemplo, e-mail, push, SMS, mensagens no app, Cartões de conteúdo e webhooks).
...
## Inserir variáveis pré-formatadas e valores padrão
...
#### Tutorial: usando variáveis para calcular um saldo

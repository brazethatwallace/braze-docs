---
nav_title: Usar APIs públicas
article_title: APIs públicas para Conteúdo conectado
page_order: 10
description: "Este artigo apresenta uma lista de APIs disponíveis publicamente que podem ser usadas com Conteúdo conectado."
---

# Usar APIs públicas para Conteúdo conectado {#use-public-apis-for-connected-content}
...
{% alert note %}
APIs públicas podem estar sujeitas a restrições de uso e limite de taxa. Leia a documentação das APIs e entre em contato com os provedores sobre o uso pretendido.
{% endalert %}

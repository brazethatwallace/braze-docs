...
# Puxar dados do perfil do usuário em chamadas de conteúdo conectado {#pull-user-profile-data-in-connected-content-calls}
...
## Modelagem Liquid em chamadas de conteúdo conectado {#liquid-templating-in-connected-content-calls}
...
### Use `json_escape` com tags Liquid que possam quebrar o formato JSON {#use-jsonescape-with-liquid-tags-that-could-break-the-json-format}

...
Como o Connected Content depende do recebimento de dados de APIs, uma API or interface de programação do aplicativo (API) pode ficar temporariamente indisponível enquanto a Braze faz a chamada. Nesse caso, a Braze oferece suporte a uma lógica de novas tentativas para reenviar a requisição usando backoff exponencial.

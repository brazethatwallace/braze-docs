...
Use seleções para agrupar itens do catálogo por filtros que você definir. Por exemplo, crie uma seleção de itens abaixo de $20 ou itens em uma categoria específica e, em seguida, faça referência ao conjunto filtrado em suas mensagens.

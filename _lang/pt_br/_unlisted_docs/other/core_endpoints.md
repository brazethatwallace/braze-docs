...
Os endpoints principais da API da Braze são endpoints específicos na REST API da Braze que possuem um tempo de inatividade permitido de acordo com o Acordo de Nível de Serviço (SLA) de uma conta da Braze. Para saber mais, consulte a documentação do seu SLA ou entre em contato com o gerente da sua conta.

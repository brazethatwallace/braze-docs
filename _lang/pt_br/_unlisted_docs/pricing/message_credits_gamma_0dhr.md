---
nav_title: Créditos de mensagem - Gamma
...
## Tabela de proporção de créditos para Message Credits - Gamma {#credit-ratio-table-for-message-credits-gamma}

{% details Clique para expandir %}
<table class="credits-table" aria-label="Tabela de proporção de créditos para Message Credits - Gamma">
    <colgroup>
        <col span="3">

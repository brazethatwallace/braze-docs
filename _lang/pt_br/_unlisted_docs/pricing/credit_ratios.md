---
nav_title: Proporções de créditos do WhatsApp
alias: "/credit_ratios/"
permalink: "/credits_whatsapp/"
hidden: true
---

# Proporções de créditos do WhatsApp (Confidencial) {#whatsapp-credit-ratios-confidential}

> {% multi_lang_include whatsapp/about_credits.md content="h2" %}

## Tabela de proporção de créditos {#credit-ratio-table}

{% details Clique para expandir %}
<table class="credits-table" aria-label="Tabela de proporção de créditos">
    <colgroup>
        <col span="3">
...
## Cobrança por região {#billing-by-region}

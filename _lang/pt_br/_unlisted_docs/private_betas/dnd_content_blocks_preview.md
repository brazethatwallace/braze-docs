---
nav_title: Pré-visualização de Content Blocks no editor de arrastar e soltar
...
Para pré-visualizar seus Content Blocks, acesse a seção **Conteúdo** > **Design and Build**. Selecione a guia **Rows** e selecione **Content Blocks** no menu suspenso. Aqui, você pode ver seus Content Blocks de arrastar e soltar exibidos como apareceriam na sua campanha de e-mail.
...
![A guia Rows na seção Conteúdo do editor de arrastar e soltar, mostrando a opção Content Blocks selecionada. Há duas pré-visualizações de Content Blocks disponíveis para uso como cabeçalho de e-mail para MyDealz e ArtNight.][1]{: style="max-width:50%" }

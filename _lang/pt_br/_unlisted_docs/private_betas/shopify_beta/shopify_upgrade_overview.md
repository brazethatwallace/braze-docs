...
Para mais detalhes sobre sincronização de usuários e gerenciamento de IDs, consulte [Dados de usuários e sincronização](https://braze.com/docs/partners/message_orchestration/channel_extensions/ecommerce/shopify/shopify_overview/#user-and-data-syncing).

...
6. Selecione métricas em **Columns** > **Customize Metrics** e defina o intervalo de datas em **Report content**.
7. Se você adicionou um detalhamento de **Campaigns and Canvases**, adicione as Campaigns e Canvas a serem incluídos no relatório.
8. Clique em **Save and run**.

Para o fluxo completo do Report Builder, consulte [Criando um relatório]({{site.baseurl}}/user_guide/analytics/reports/report_builder#creating-a-report).
...
4. Selecione métricas em **Columns** > **Customize Metrics** e defina o intervalo de datas em **Report content**.
5. Adicione as Campaigns ou Canvas a serem incluídos no relatório.
...
As seguintes combinações de **Rows** e **Drilldown** são compatíveis para relatórios por Segment:

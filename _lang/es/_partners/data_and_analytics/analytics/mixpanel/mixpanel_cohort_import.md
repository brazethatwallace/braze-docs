...
3. En el mensaje que aparece, introduce la clave de importación de datos de Braze y el punto de conexión REST.
...
En Braze, para crear un segmento de estos usuarios, ve a **Audience** > **Segments**, asigna un nombre a tu segmento y selecciona **Mixpanel_Cohorts** como filtro. A continuación, utiliza la opción "includes" y elige la cohorte que creaste en Mixpanel.

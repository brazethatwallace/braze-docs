...
description: "Este artículo de referencia describe la asociación entre Braze Currents y Treasure Data, una plataforma de datos de clientes empresariales que te permite escribir resultados de trabajos directamente en Braze."
page_type: partner
tool: Currents
...
La integración de Braze y Treasure Data te permite controlar fácilmente el flujo de información entre ambos sistemas. Con Currents, también puedes conectar los datos a Treasure Data para que sean procesables en todo el stack de crecimiento.
...
### Paso 1: Configurar la API Postback de Treasure Data con Braze {#step-1-setup-treasure-data-postback-api-with-braze}

Puedes encontrar instrucciones para crear una API Postback en el [sitio web de Treasure Data](https://docs.treasuredata.com/display/public/PD/Postback+API). Braze enviará directamente los eventos actualizados a Treasure Data en tiempo real, a excepción de la ingesta a través del recopilador de eventos. Una vez completado, Treasure Data proporcionará una URL de origen de datos que deberás copiar para utilizarla en el siguiente paso.

### Paso 2: Crear un Current {#step-2-create-current}

En Braze, ve a **Currents** > **+ Create Current** > **Treasure Data Export**. Proporciona un nombre de integración, un correo electrónico de contacto y tu URL de Treasure Data. A continuación, selecciona lo que deseas rastrear de la lista de eventos disponibles y haz clic en **Launch Current**.

Todos los eventos enviados a Treasure Data incluirán el `external_user_id` del usuario. En este momento, Braze no envía datos de eventos a Treasure Data para los usuarios que no han configurado su `external_user_id`.
...
#### Ejemplo de valor de campo de evento {#example-event-field-value}
```json
{
    "events": [
        {
...
#### Ejemplo de vista ingestada {#example-of-the-ingested-view}

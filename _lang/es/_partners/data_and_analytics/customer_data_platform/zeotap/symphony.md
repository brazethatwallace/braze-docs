...
Los datos fluirán de Zeotap a Braze utilizando el [punto de conexión `/users/track`]({{site.baseurl}}/api/endpoints/user_data/post_user_track/). Los siguientes puntos resumen el flujo de datos:
...
Varios atributos se encuentran en diferentes secciones del dashboard de usuario en Braze.

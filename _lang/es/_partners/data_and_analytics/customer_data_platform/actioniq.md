...
- Actualizar los perfiles de usuario en Braze con la información de pertenencia a la audiencia y cualquier atributo directamente desde ActionIQ
- Reenviar los eventos rastreados por ActionIQ a Braze en tiempo real para desencadenar campañas personalizadas y específicas
- Entregar campañas desencadenadas por API en Braze directamente desde puntos de intervención en un recorrido de ActionIQ
...
### Pertenencia a la audiencia {#audience-membership}

Esta integración se utiliza para sincronizar la pertenencia a la audiencia de ActionIQ con Braze mediante la creación de atributos personalizados que indican si un perfil de Braze forma parte de un segmento. Cada audiencia de ActionIQ corresponde a un único atributo booleano personalizado.
...
1. En Braze, navega hasta **Segments**.
2. Crea un nuevo segmento.
3. Selecciona **Custom Attributes** como filtro.
4. Desde aquí, elige el atributo personalizado de ActionIQ.
5. Una vez creado el segmento, puedes seleccionarlo como filtro de audiencia al crear una Campaign o Canvas.
...
Puedes configurar la plataforma ActionIQ para recibir información de eventos a través de su servicio de ingesta de streaming. Esta opción de integración reenvía estos eventos a Braze para que los especialistas en marketing los utilicen para la orquestación o para desencadenar campañas de marketing. La integración de eventos puede enviar atributos adicionales de ActionIQ como parte de las propiedades en la carga útil del evento.
...
- Marca de tiempo
- Propiedades del evento, que se rellenan con cualquier atributo adicional en la configuración de exportación

### Campañas desencadenadas {#triggered-campaigns}

Esta integración desencadenará una campaña en Braze para todos los usuarios de un segmento de ActionIQ. Después de haber configurado el contenido de tu campaña, las pruebas multivariante y las reglas de reelegibilidad, puedes desencadenarla desde cualquier punto de intervención del recorrido de ActionIQ añadiendo el ID de campaña de Braze a tu configuración de exportación.

Opcionalmente, puedes incluir cualquier otro atributo de ActionIQ en tu exportación para rellenar el contenido de tu campaña. Se envían con el objeto `trigger_properties`.

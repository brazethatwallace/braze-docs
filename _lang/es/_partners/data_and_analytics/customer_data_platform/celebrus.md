...
| Configuración del SDK or kit de desarrollo de software de Braze (opcional) | Cuando utilices el conector Celebrus para el SDK or kit de desarrollo de software de Braze, debes pasar el punto final de SDK or kit de desarrollo de software y la clave de API de SDK or kit de desarrollo de software. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="Requisitos previos" }

## Implementación {#implementation}
Después de instalar tu implementación de Celebrus, utiliza los conectores de Celebrus para Braze para integrar los datos de Celebrus en Braze. Hay dos elementos en la integración de Celebrus para Braze: el SDK or kit de desarrollo de software de Braze y los atributos personalizados de Braze. Puedes desplegar cualquiera de los dos, o ambos, en función de cómo utilices Braze y de los ejemplos que necesites.

Si aún no tienes implementado el SDK or kit de desarrollo de software de Braze en tu canal web, puedes utilizar Celebrus para desplegar el SDK or kit de desarrollo de software de Braze. Celebrus añadirá el SDK or kit de desarrollo de software de Braze a las páginas web y configurará la identidad de Braze para el visitante web utilizando el gráfico de identidad de Celebrus. Los atributos de los clientes pueden sincronizarse con Braze mediante ingesta de datos en la nube (CDI). Esto requiere un almacén de datos compatible con Braze CDI, así como la configuración del CDI en Braze.

### Conector Celebrus para el SDK or kit de desarrollo de software de Braze {#celebrus-connector-for-braze-sdk}

El conector Celebrus para el SDK or kit de desarrollo de software de Braze proporciona datos de canal de alto nivel de aplicaciones web y móviles para Braze. En el SDK or kit de desarrollo de software de Braze, el `System Identity` de Celebrus del gráfico de identidad de Celebrus se utilizará como identificador para la integración de Braze. Se admiten otros identificadores para sincronizar atributos personalizados a través del conector Celebrus para atributos personalizados de Braze.

El conector despliega y configura el SDK or kit de desarrollo de software de Braze en tu canal, por lo que tendrás que configurar algunos ajustes en la transmisión de datos del SDK or kit de desarrollo de software de Braze y proporcionar los valores de estos tres ajustes:
...
{% alert important %}
El conector Celebrus para el SDK or kit de desarrollo de software de Braze insertará e inicializará el SDK or kit de desarrollo de software de Braze para identificar al usuario y añadir el identificador al gráfico de identidad de Celebrus. Este conector no registrará datos en el perfil de usuario ni desencadenará otros métodos del SDK or kit de desarrollo de software de Braze. <br><br>Puedes llamar a los métodos que desees directamente dentro de tu base de código para registrar datos a través del [SDK or kit de desarrollo de software de Braze]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=web) o aprovechar otras características compatibles con el SDK or kit de desarrollo de software de Braze.
{% endalert%}

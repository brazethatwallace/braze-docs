...
|---|---|
| Cuenta de Datadog | Se necesita una cuenta de Datadog para beneficiarse de esta asociación. |
...
En el panel de Braze, ve a **Integraciones de socios** > **Socios tecnológicos** y busca **Datadog**. En la página del partner de Datadog, proporciona la clave de API de Datadog. Esto creará una conexión que permitirá a Braze enviar datos a Datadog.

...
| Clave de API REST de Braze | Una clave de API REST de Braze con los permisos enumerados en la siguiente sección.<br><br> Se puede crear en el dashboard de Braze desde **Settings** > **API Keys**. |
...
Para completar la integración, debes proporcionar tu clave de API REST y [la URL del punto de conexión REST]({{site.baseurl}}/developer_guide/rest_api/basics/#endpoints) a tu equipo de operaciones de actionable.me. A continuación, actionable.me establecerá la conexión y se pondrá en contacto contigo una vez finalizada la configuración para empezar a compartir información.

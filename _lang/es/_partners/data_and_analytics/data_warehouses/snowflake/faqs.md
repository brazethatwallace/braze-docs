...
Puede que hayas utilizado un ID de cuenta de Snowflake incorrecto al crear tu recurso compartido de datos. El ID de cuenta del panel de uso compartido de datos debe coincidir con la salida de `CURRENT_ACCOUNT()` de tu cuenta de Snowflake.

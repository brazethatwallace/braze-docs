...
Para obtener instrucciones de configuración, consulta [Databricks Delta Sharing]({{site.baseurl}}/delta_sharing/).
...
Cuando estés listo para configurar el uso compartido y consultar los datos compartidos, continúa con [Databricks Delta Sharing]({{site.baseurl}}/delta_sharing/).
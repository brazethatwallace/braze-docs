...
La integración de Braze y Google Cloud Storage te permite transmitir datos de Currents a Google Cloud Storage. Posteriormente, puedes utilizar un proceso ETL or extraer, transformar, cargar (ETL or extraer, transformar, cargar or extraer, transformar, cargar) para transferir tus datos a otras ubicaciones, como Google BigQuery.

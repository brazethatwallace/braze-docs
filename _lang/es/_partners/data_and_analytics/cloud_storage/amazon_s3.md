...
| Currents | Para exportar datos de vuelta a Amazon S3, necesitas tener [Braze Currents]({{site.baseurl}}/user_guide/data/distribution/braze_currents) configurado para tu cuenta. Currents no es obligatorio si solo estás configurando el archivado de mensajes. |
...
{% alert note %}
Currents no es compatible con contenedores que tengan [Object Lock](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lock.html) configurado.
{% endalert %}
...
![Pantalla de creación de política de AWS IAM con las opciones de política para la integración con S3.]({% image_buster /assets/img_archive/S3_CreatePolicy.png %})
...
### Paso 5: Vincular Braze con AWS {#secret-key-5}
...
![Página de credenciales del partner tecnológico Amazon S3 en Braze con las acciones de probar y guardar.]({{site.baseurl}}/assets/img/s3_tech_partners.png)
...
### Paso 1: Crear la política {#role-arn-1}
...
![Página de políticas de IAM en AWS con el botón Crear política seleccionado.]({{site.baseurl}}/assets/img/create_policy_1_list.png)
...
![Paso de revisión de la política en IAM de AWS con campos para nombre y descripción de la política.]({{site.baseurl}}/assets/img/create_policy_3_name.png)

![Lista de políticas de IAM en AWS mostrando la política de S3 recién creada.]({{site.baseurl}}/assets/img/create_policy_4_created.png)

### Paso 2: Crear el rol {#role-arn-2}

Dentro de la misma sección IAM de la consola, selecciona **Roles** > **Create Role**.

![Página de roles de IAM en AWS con el botón Create Role seleccionado.]({{site.baseurl}}/assets/img/create_role_1_list.png)
...
### Paso 3: Adjuntar la política {#role-arn-3}
...
![Página de detalles del rol de IAM en AWS para el rol recién creado.]({{site.baseurl}}/assets/img/create_role_5_created.png)

Toma nota del **Role ARN** en la parte superior de la página de resumen del rol.

![Resumen del rol de IAM en AWS mostrando el valor del ARN del rol.]({{site.baseurl}}/assets/img/create_role_6_summary.png)
...
![Pantalla de configuración de Amazon S3 en Braze Currents con los campos de ARN del rol de AWS y contenedor.]({{site.baseurl}}/assets/img/currents-role-arn.png)
...
![Página del partner tecnológico Amazon S3 en Braze con las credenciales de ARN del rol de AWS seleccionadas.]({{site.baseurl}}/assets/img/data-export-role-arn.png)
...
Actualiza tu política de IAM para que el usuario o rol de integración pueda llamar a `s3:GetObject` en el contenedor de S3 y la ruta de objetos configurada en tu integración de Braze. Para más problemas de exportación, consulta [Solución de problemas de exportación]({{site.baseurl}}/user_guide/data/distribution/export_braze_data/export_troubleshooting).
...
## Varios conectores {#multiple-connectors}
...
Confirma que creaste una política con los permisos correctos, tal como se describe en [Integración de Amazon S3](#integration) (usa la política de **Dashboard Data Export** para tu método de autenticación).

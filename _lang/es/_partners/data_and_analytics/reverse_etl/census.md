...
En la ventana que aparece, asigna un nombre a esta conexión e indica la URL de tu punto de conexión de Braze y la clave de API REST de Braze (y, opcionalmente, tu clave de importación de datos para sincronizar cohortes).
...
2. En el compositor, selecciona el modelo de datos fuente de tu almacén de datos.<br><br>

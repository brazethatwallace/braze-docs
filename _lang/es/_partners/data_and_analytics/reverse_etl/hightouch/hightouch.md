...
3. Proporciona tu punto de conexión REST de Braze (excluyendo "https://rest.") y tu clave de API REST de Braze.<br><br>![]({% image_buster /assets/img/hightouch/hightouch_braze_setup.png %})

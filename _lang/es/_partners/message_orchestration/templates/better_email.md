...
Cuando reexportas un correo electrónico, Better Email actualiza la plantilla existente de Braze en lugar de crear un duplicado, de modo que tu biblioteca de plantillas se mantiene limpia.
...
Better Email está diseñado para equipos de marketing que desean administrar correos electrónicos a través de un sistema de diseño y exportarlos a Braze sin trabajo manual de HTML. Considera Better Email si:

- Mantienes una gran biblioteca de plantillas de correo electrónico y necesitas consistencia en todas ellas
- Quieres aplicar directrices de marca a través de un sistema de diseño de correo electrónico compartido
- Colaboras entre equipos —diseñadores, especialistas en marketing y desarrolladores— en la producción de correos electrónicos
- Usas Braze para la ejecución de campañas y quieres eliminar el cuello de botella en la transferencia entre diseño y despliegue
...
### Sincronizar campos de destinatario desde Braze (opcional) {#sync-recipient-fields-from-braze-optional}
...
5. Selecciona **Sync from** junto a tu integración.
...
Para más ayuda, [ponte en contacto con el soporte de Better Email](mailto:support@better.email).

## Usa la integración {#use-the-integration}

Encuentra tus plantillas exportadas de Better Email en Braze en **Plantillas y medios** > **Plantillas de correo electrónico**. Úsalas en cualquier campaña o Canvas de Braze.
...
> [Mailizio](https://mailizio.com/) es una plataforma de creación y gestión de correo electrónico que facilita el diseño de contenidos reutilizables y seguros para la marca mediante un editor visual intuitivo. Con la integración de Mailizio en Braze, puedes exportar tus Content Blocks y plantillas de correo electrónico y, a continuación, generar automáticamente mensajes dentro de la aplicación a partir de esos mismos activos, lo que permite un despliegue de campañas rápido y totalmente controlado.

_Esta integración está mantenida por Mailizio._

## Sobre la integración {#about-the-integration}

La integración de Mailizio y Braze te permite diseñar plantillas de correo electrónico dinámicas utilizando el editor de Mailizio, aprovechar las variables de Liquid utilizadas en tus configuraciones de Braze y enviarlas a Braze para una ejecución de campañas optimizada.

## Casos de uso {#use-cases}

- Envía plantillas de correo electrónico listas para usar directamente a Braze para campañas y mensajes transaccionales.
- Construye módulos de contenido reutilizables (cabeceras, pies de página, promociones y más) para agilizar la producción en múltiples campañas y canales.
...
### Paso 1: Crear un correo electrónico en Mailizio {#step-1-create-an-email-in-mailizio}

En Mailizio, utiliza el editor de arrastrar y soltar para crear un correo electrónico que refleje la identidad de tu marca y luego haz clic en **Save** para conservar tu trabajo.

![Captura de pantalla del editor de arrastrar y soltar]({% image_buster /assets/img/mailizio/screenshot_1.png %})

### Paso 2: Exportar tu plantilla de correo electrónico a Braze {#step-2-export-your-email-template-to-braze}

Cuando estés listo, haz clic en **Export Newsletter**. En la ventana emergente, selecciona **Braze-email** y confirma la exportación.

Si actualizas tu contenido más tarde, vuelve a exportarlo desde Mailizio para actualizarlo en Braze.

![Captura de pantalla del modal de exportación]({% image_buster /assets/img/mailizio/screenshot_2.png %})

{% alert important %}
Puedes crear y exportar Content Blocks del mismo modo utilizando el editor de **Module** de Mailizio.
{% endalert %}

## Uso {#usage}

Encuentra tu plantilla de Mailizio cargada en la sección **Templates & Media > Email Templates** de tu cuenta de Braze. Ya puedes utilizar esta plantilla de correo electrónico para empezar a enviar mensajes atractivos a tus clientes.
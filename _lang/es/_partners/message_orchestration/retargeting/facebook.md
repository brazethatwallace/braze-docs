...
> La integración de Braze y Facebook te permite exportar manualmente tus Segments de Braze a Facebook para crear públicos personalizados de Facebook. Se trata de una exportación de audiencia única y estática, y solo crea nuevos públicos personalizados de Facebook.
...
{% alert note %}
Si estás participando en las pruebas de las cuentas de Meta Work en versión beta, asegúrate de desconectar y volver a conectar tu cuenta a la [página de socio de Facebook]({{site.baseurl}}/partners/canvas_steps/facebook_audience_sync/#step-1-connect-to-facebook).
{% endalert %}
...
- El tamaño del público personalizado. [Más información.](https://marketingland.com/exclusive-facebook-will-no-longer-show-audience-reach-estimates-for-custom-audiences-after-vulnerability-detected-236923)
{% endalert %}

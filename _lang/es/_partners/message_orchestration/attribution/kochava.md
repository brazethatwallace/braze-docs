...
| SDK or kit de desarrollo de software de Kochava | Además del SDK or kit de desarrollo de software de Braze necesario, debes instalar el [SDK or kit de desarrollo de software de Kochava](https://support.kochava.com/sdk-integration/). |
...
[Añade un postback](https://support.kochava.com/campaign-management/create-a-kochava-certified-postback) en tu dashboard de Kochava. Se te pedirá la clave de importación de datos y el punto de conexión REST or transferencia de estado representacional que encontraste en el dashboard de Braze.
...
{% tab iOS %}
Para iOS, tanto Braze como Kochava recopilan automáticamente el IDFV de forma nativa a través de nuestras integraciones de SDK or kit de desarrollo de software. Puede utilizarse como identificador del dispositivo. Puedes incluir el IDFV en tus enlaces de seguimiento de clics de Kochava utilizando la siguiente lógica de Liquid:

...
4. Copia la clave de API y el punto de conexión REST. Usarás estos valores en Linkrunner en el siguiente paso; trata la clave como un secreto y no la compartas públicamente.

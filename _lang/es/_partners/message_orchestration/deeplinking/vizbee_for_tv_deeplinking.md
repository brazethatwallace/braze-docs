...
> [Vizbee](https://vizbee.tv/) permite que todos los teléfonos inteligentes y Smart TV de tu hogar funcionen juntos como un único dispositivo integrado para ofrecer una gran experiencia de usuario. Vizbee te ayuda a utilizar los canales de marketing de aplicaciones móviles existentes, como notificaciones, vínculos profundos y correos electrónicos, para captar e interactuar fácilmente con los espectadores en todos los dispositivos de TV Conectada (CTV) (como Roku, FireTV, Samsung TV, LG TV, etc.).
...
- Programar una notificación móvil dirigida a usuarios específicos que, al tocarla, puede dar lugar a la visualización en la aplicación móvil o invocar fácilmente la reproducción en un dispositivo de streaming o televisor cercano.
- Programar una campaña de marketing por correo electrónico dirigida a usuarios objetivo que, al tocarla, puede dar como resultado la instalación automática de la aplicación de CTV y el inicio de sesión del usuario en un dispositivo de CTV como Roku o FireTV.

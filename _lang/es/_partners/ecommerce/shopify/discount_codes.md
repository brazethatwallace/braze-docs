...
## Generación de códigos de descuento únicos {#generating-unique-discount-codes}
...
Si quieres que los usuarios reciban un único código de descuento sin importar cuántas veces se haga referencia al código de descuento en Campaigns o Canvas, crea un paso de [User Update]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/user_update) directamente antes del primer paso de mensaje que asigne el código de descuento a un atributo personalizado, como "Promo Code".
...
En el paso de User Update, haz lo siguiente para cada campo:
...
Cuando un código de descuento es referenciado por múltiples pasos en el mismo Canvas o por Campaigns separadas, un usuario elegible recibirá múltiples códigos promocionales únicos (un código por cada paso en Canvas o Campaign).

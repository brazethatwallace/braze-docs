...
Los productos sincronizados con un catálogo de Braze contribuirán a tu [límite de catálogo]({{site.baseurl}}/user_guide/data/activation/catalogs/create/#tiers).
...
### Paso 3: Sincronización en curso {#step-3-sync-in-progress}

Recibirás una notificación en el dashboard y tu estado se mostrará como "En curso" para indicar que se está iniciando la sincronización inicial. Ten en cuenta que el tiempo que tarde en finalizar la sincronización dependerá de cuántos productos y variantes tenga que sincronizar Braze desde Shopify. Durante este tiempo, puedes salir de esta página y esperar a recibir una notificación en el dashboard o un correo electrónico que te avise cuando se haya completado.
...
### Paso 4: Sincronización completada {#step-4-sync-completed}

Recibirás una notificación en el dashboard y un correo electrónico cuando la sincronización se haya realizado correctamente. La página del socio de Shopify también actualizará el estado en los catálogos de Shopify a "Sincronizando". Puedes ver tus productos haciendo clic en el nombre del catálogo en la página del socio de Shopify.
...
## Casos de uso de reposición de existencias y bajada de precios {#back-in-stock-and-price-drop-use-cases}

Para configurar las notificaciones de reposición de existencias, sigue los pasos que se [indican aquí]({{site.baseurl}}/user_guide/data/activation/catalogs/catalog_triggers/back_in_stock_notifications/).

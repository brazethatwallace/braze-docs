...
Una integración de partner basada en la característica de Transformación de datos podría ser una plantilla de código de transformación compartida con los clientes a través de documentación pública.

Para los clientes mutuos, se vería algo así:

1. Inician sesión en tu plataforma y configuran webhooks.
...
7. Una vez habilitada, pueden verificar a través de la herramienta de búsqueda de usuarios de Braze que el perfil de usuario se actualiza en función del webhook y editar el código de transformación según lo deseen.

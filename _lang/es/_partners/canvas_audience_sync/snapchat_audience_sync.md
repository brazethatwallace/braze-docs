...
Selecciona **Snapchat** como socio de Audience Sync deseado.
...
Puedes desconectar y volver a conectar tu cuenta de Snapchat en la página del socio de Snapchat. Confirma con el administrador de tu Snapchat Business Manager que tienes los permisos adecuados para la cuenta publicitaria con la que deseas sincronizar.

### ¿Por qué no se puede lanzar mi Canvas? {#why-is-my-canvas-not-allowed-to-launch}

Asegúrate de que tu cuenta de anuncios de Snapchat se conecta correctamente a Braze en la página del socio de Snapchat. Comprueba que has seleccionado una cuenta publicitaria, introducido un nombre para la nueva audiencia y seleccionado los campos que coinciden.
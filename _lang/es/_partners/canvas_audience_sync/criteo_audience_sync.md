...
En el dashboard de Braze, ve a **Integraciones de socios** > **Socios tecnológicos** y selecciona **Criteo**. En Exportar audiencia de Criteo, selecciona **Connect Criteo**.
...
Solo tienes que desconectar y volver a conectar tu cuenta de Criteo en la página del socio de Criteo. Asegúrate con tu administrador de Criteo de que dispones de los permisos adecuados para la cuenta publicitaria con la que deseas sincronizar.

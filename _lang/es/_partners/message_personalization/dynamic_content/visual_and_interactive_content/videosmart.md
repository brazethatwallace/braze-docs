...
Sigue estos pasos para habilitar el **VideoSmart Content Block** y usarlo en un correo electrónico.
...
Inserta el **VideoSmart Content Block** en tu correo electrónico donde quieras que aparezca el contenido de video.
...
### Paso 4: Sobrescribe la campaña y los datos de registro (opcional) {#step-4-override-campaign-and-record-data-optional}

Si tu Content Block admite valores predeterminados, puedes usarlo sin establecer ninguna variable.

Si necesitas elegir una campaña específica de VideoSmart, pasar campos de personalización personalizados, o ambas cosas, establece las siguientes variables Liquid antes de renderizar el Content Block:
...
### Paso 5: Usa las variables generadas por la plantilla del VideoSmart Content Block {#step-5-use-the-variables-generated-by-videosmarts-content-block-template}
...
### Las variables de la plantilla del VideoSmart Content Block no generan la salida esperada {#videosmarts-content-block-template-variables-not-generating-expected-output}

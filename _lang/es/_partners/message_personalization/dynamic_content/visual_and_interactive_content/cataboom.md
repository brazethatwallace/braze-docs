...
Crea tu experiencia de juego en la plataforma Catapult. Los siguientes pasos muestran una configuración sencilla de ruleta que usa la API Request Unique URL en la página **Link Configuration**. CataBoom ofrece más de 200 opciones de juego, incluyendo mecánicas basadas en el azar, mecánicas basadas en habilidad y utilidades como tarjetas de sellos y coleccionar y ganar. Puedes seguir un flujo similar para otros tipos de juego. Para más información sobre CataBoom y Catapult, consulta [el sitio web de CataBoom](https://www.cataboom.com).
...
![Página Link Configuration de CataBoom con Request Unique URL API habilitada y la URL de la API visible.]({% image_buster /assets/img/cataboom/link_configuration.png %})
...
Puedes pasar un Account ID para cada jugador para el seguimiento, límites de jugadas, webhooks y otros comportamientos específicos del jugador. Otros sistemas suelen llamar al Account ID como member ID, player ID, loyalty ID o un nombre similar.
...
![Página Creative de CataBoom con acciones de descarga y carga de gráficos y una vista previa del juego.]({% image_buster /assets/img/cataboom/creative.png %})
...
Las siguientes capturas de pantalla muestran **Prize Options** en el resumen de la campaña y una configuración sencilla de probabilidades con un 50 % de probabilidad de ganar en el nivel 1.
...
Este ejemplo muestra cómo crear una **tarjeta de contenido** que usa la Request Unique URL de la página **Link Configuration**.

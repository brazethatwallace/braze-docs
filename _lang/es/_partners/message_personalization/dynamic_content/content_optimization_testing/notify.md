...
Utilizando el endpoint `/campaigns/trigger/send`, la IA de Notify desencadena la Campaign de Braze creada en el [paso 1](#step-1-create-your-campaign) para enviarla a los usuarios en el momento en que se considere más probable su participación.
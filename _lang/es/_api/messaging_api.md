---
nav_title: API de mensajería de dispositivo
article_title: API de mensajería de dispositivo
search_tag: Endpoint
page_order: 2.2
layout: dev_guide
permalink: /api/device_messaging_api
description: "Esta página de destino presenta la API de mensajería de dispositivo de Braze."
page_type: landing
hidden: true
guide_top_header: "API de mensajería de dispositivo"
guide_top_text: "Usa la API de mensajería de dispositivo de Braze para recuperar propiedades de Banner y reportar eventos de impresión y clic de Banner sin integrar un SDK de Braze. La API de mensajería de dispositivo admite integraciones del lado del cliente y del lado del servidor, y utiliza claves de API REST del lado del cliente con alcance a un único espacio de trabajo."
...
guide_featured_list:
  - name: "Resumen de la API de mensajería de dispositivo"
...
guide_menu_list:
  ...
  - name: "POST: Rastrear eventos de análisis de Banner"
...
{% alert important %}
Esta página está en versión beta. Las características y la documentación de la API de mensajería de dispositivo están sujetas a cambios.
{% endalert %}
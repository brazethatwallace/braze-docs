...
4. Selecciona **Save Campaign** para comenzar tu Campaign de API.
...
Para añadir archivos adjuntos a los correos electrónicos de Campaigns de API, incluye un array `attachments` en el [objeto de correo electrónico]({{site.baseurl}}/api/objects_filters/messaging/email_object). Puedes hacer referencia a una plantilla de correo electrónico creada en el editor de arrastrar y soltar o en el editor HTML proporcionando su `email_template_id` en el objeto de correo electrónico, y luego añadir archivos adjuntos a través de la llamada a la API.

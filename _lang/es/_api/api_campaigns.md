...
3. Opcionalmente, puedes añadir un evento de conversión para rastrear las conversiones de los usuarios en una acción o meta específica de la Campaign.
...
## Añadir cancelación de suscripción con un clic en lista a Campaigns de API {#add-one-click-list-unsubscribe-to-api-campaigns}

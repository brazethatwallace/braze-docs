...
| Sesiones | Datos de series temporales de sesiones de aplicación | [Punto de conexión de sesiones]({{site.baseurl}}/api/endpoints/export/sessions/get_sessions_analytics) |
...
| Atributos personalizados | Nombres de atributos | [Punto de conexión de atributos personalizados]({{site.baseurl}}/api/endpoints/export/custom_attributes/get_custom_attributes) |
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Qué puedes exportar" }
...
| Categoría | Método | Punto de conexión |
| --- | --- | --- |
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Puntos finales de exportación" }

...
{% alert important %}
Data Objects se encuentra actualmente en acceso anticipado. Tu espacio de trabajo debe estar habilitado antes de que los permisos de clave de API de Data Objects aparezcan en **Configuración** > **Claves de API**.
{% endalert %}

## Requisitos previos {#prerequisites}

Para usar este endpoint, necesitas una [clave de API]({{site.baseurl}}/api/basics#rest-api-key-permissions) con el permiso `data_objects.object_relationships.update`.

## Límite de velocidad {#rate-limit}

Este endpoint se encuentra en el contenedor de escritura de Data Objects con un límite predeterminado de 50 solicitudes por minuto.
...
Este ejemplo reemplaza la relación `subaccount` entre `acct-123` y `acct-456`, sobrescribiendo cualquier atributo almacenado previamente en ella.

...
La siguiente tabla enumera y describe los parámetros de ruta del endpoint `/data_objects/types/{type_name}/object_relationship_types`.

| Parámetro | Obligatorio | Tipo de datos | Descripción |
|---|---|---|---|
| `type_name` | Obligatorio | Cadena | Nombre de máquina del tipo de objeto de datos |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Parámetros de ruta de listar tipos de relación de objetos" }

## Parámetros de consulta {#query-parameters}

La siguiente tabla enumera y describe los parámetros de consulta del endpoint `/data_objects/types/{type_name}/object_relationship_types`.
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Parámetros de consulta de listar tipos de relación de objetos" }
...
Este ejemplo lista los tipos de relación de objetos disponibles para el tipo `account` cuando `account` es el origen de la relación.
...
`related_type_name` es el tipo en el otro lado de la relación para el `anchor` seleccionado.
...
| Parámetro | Obligatorio | Tipo de datos | Descripción |
|---|---|---|---|
| `items` | Obligatorio | Arreglo | Lista de tipos de relación de objetos disponibles |
| `items[].from_type_name` | Obligatorio | Cadena | Nombre del tipo de objeto de datos de origen |
| `items[].to_type_name` | Obligatorio | Cadena | Nombre del tipo de objeto de datos de destino |
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Parámetros de respuesta de listar tipos de relación de objetos" }

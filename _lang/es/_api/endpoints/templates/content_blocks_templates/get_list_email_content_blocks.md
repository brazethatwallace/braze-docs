...
| --- | --- |
| `Modified after time is invalid` | La fecha proporcionada no es válida o no se puede analizar. Reformatea este valor como una cadena en formato ISO 8601 (`yyyy-mm-ddThh:mm:ss.ffffff`). |
| `Modified before time is invalid` | La fecha proporcionada no es válida o no se puede analizar. Reformatea este valor como una cadena en formato ISO 8601 (`yyyy-mm-ddThh:mm:ss.ffffff`). |

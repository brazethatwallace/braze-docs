...
{% alert note %}
Si te interesa utilizar este punto de conexión con [los grupos de suscripción de LINE]({{site.baseurl}}/user_guide/channels/line/message_users/subscription_groups/), ponte en contacto con tu administrador del éxito del cliente.
{% endalert %}
...
## SMS y WhatsApp {#sms-and-whatsapp}

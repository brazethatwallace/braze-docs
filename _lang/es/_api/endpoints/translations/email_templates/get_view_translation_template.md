...
{% api %}
# Ver todas las traducciones y configuraciones regionales de una plantilla de correo electrónico {#view-all-translations-and-locales-for-an-email-template}
{% apimethod get %}

...
|---|---|---|---|
| `id` | Obligatorio | Cadena | El ID de recurso del usuario. Este parámetro lo devuelven los métodos `POST` `/scim/v2/Users/` o `GET`  `/scim/v2/Users?filter=userName eq "user@test.com"`. |

...
layout: api_page
page_type: reference
description: "En este artículo se describen los detalles del punto de conexión Eliminar selección de catálogo de Braze."
...
> Utiliza este punto de conexión para eliminar una selección de catálogo.

## Requisitos previos {#prerequisites}

Para utilizar este punto de conexión, necesitarás una [clave de API]({{site.baseurl}}/api/basics#rest-api-key) con el permiso `catalogs.delete_selection`.

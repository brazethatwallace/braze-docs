...
layout: api_page
page_type: reference
description: "En este artículo se describen los detalles del punto de conexión Exportar usuarios activos diarios de Braze."
...
> Utiliza este punto de conexión para recuperar una serie diaria del número total de usuarios activos únicos en cada fecha.
...
Para utilizar este punto de conexión, necesitarás una [clave de API]({{site.baseurl}}/api/basics#rest-api-key/) con el permiso `kpi.dau.data_series`.

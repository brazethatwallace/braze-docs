...
---
{% api %}
# Exportar cantidad de compras {#export-number-of-purchases}
{% apimethod get %}
...
| `unit` | Opcional | Cadena | Unidad de tiempo entre puntos de datos. Puede ser día u hora; el valor predeterminado es día. |

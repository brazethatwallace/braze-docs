...
article_title: "Envía mensajes inmediatamente utilizando solo la API"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
...
{% alert important %}
Al utilizar este endpoint para campañas de API, el destinatario debe existir previamente en Braze para que la solicitud se realice correctamente. Esto se aplica al especificar usuarios en los parámetros `external_user_ids` o `user_aliases`.
{% endalert %}
...
### Opción 2: Usar una campaña desencadenada por API o Canvas {#option-2-use-an-api-triggered-campaign-or-canvas}

---
nav_title: "DELETE: Eliminar clave de autenticación SDK or kit de desarrollo de software"
article_title: "DELETE: Eliminar clave de autenticación SDK or kit de desarrollo de software"
search_tag: Endpoint
page_order: 3
layout: api_page
page_type: reference
description: "Este artículo describe los detalles del endpoint de Braze para eliminar una clave de autenticación SDK or kit de desarrollo de software."
---

{% api %}
# Eliminar clave de autenticación SDK or kit de desarrollo de software {#delete-sdk-authentication-key}
{% apimethod delete %}
/app_group/sdk_authentication/delete
{% endapimethod %}

> Utiliza este endpoint para eliminar una clave de autenticación SDK or kit de desarrollo de software de tu aplicación.
...
| `key_id` | Obligatorio | Cadena | El ID de la clave de autenticación SDK or kit de desarrollo de software que se va a eliminar. |
...
| --------- | --------- | ----------- |
| `keys` | Matriz | Matriz de objetos de clave de autenticación SDK or kit de desarrollo de software restantes. |
...
- La clave de autenticación SDK or kit de desarrollo de software principal no se puede eliminar.

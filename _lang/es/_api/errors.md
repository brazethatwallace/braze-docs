...
Braze devuelve HTTP 400 cuando el cuerpo de la solicitud no es un JSON válido. Esto se aplica a los endpoints REST or transferencia de estado representacional que aceptan un cuerpo JSON, como POST, PUT y PATCH.

...
La API de mensajería de dispositivos de Braze es un conjunto de endpoints REST para integrar las capacidades de mensajería de Braze sin un SDK de Braze. Puedes llamar a estos endpoints desde aplicaciones de cliente o servidor.

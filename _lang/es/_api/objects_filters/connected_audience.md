...
En cada caso, una sola campaña o definición de mensaje solo de API maneja todas las variaciones. Tu backend determina los valores de filtro y los pasa en la solicitud de API, por lo que no necesitas crear un segmento o una campaña separada para cada producto, programa, equipo o ubicación.

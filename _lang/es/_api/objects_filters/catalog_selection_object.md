...
| `value`    | Obligatoria | Varía (cadena, número, booleano, tiempo)     | El valor con el que comparar. Debe coincidir con el tipo de datos del campo del catálogo subyacente (por ejemplo, cadena, número, booleano, tiempo). |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 role="presentation" }

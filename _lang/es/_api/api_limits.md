...
Si tienes preguntas sobre los límites de API, contacta a tu administrador de éxito de cliente o abre un [ticket de soporte]({{site.baseurl}}/user_guide/administer/personal/braze_support).

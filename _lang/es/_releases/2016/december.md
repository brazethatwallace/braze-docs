...
Los encabezados de correo electrónico añaden la configuración explícita de encabezados de correo electrónico a través del punto de conexión de envío. Consulta [Prácticas recomendadas de correo electrónico]({{site.baseurl}}/user_guide/channels/email/best_practices/) para obtener más información sobre el envío de correo electrónico con Braze.

## Actualizaciones de Canvas {#canvas-updates}

...
Ahora tienes la opción de abrir URL web en un navegador web externo para mensajes push, mensajes dentro de la aplicación y en el navegador, y tarjetas de News Feed. La acción "Vínculo profundo a la aplicación" ahora también es compatible con los vínculos profundos HTTP/HTTPS. Si utilizas un socio como Branch o Universal Links de Apple, necesitarás personalizar el SDK. Más información sobre [vinculación en profundidad]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/actions_and_media_urls/#what-is-deep-linking).

## Nuevo evento "Conversión realizada" en Canvas {#new-performed-conversion-event-canvas}

Hemos añadido un nuevo evento "Conversión realizada" y un filtro "En control de Canvas" para mejorar las opciones de reorientación. Más información sobre el uso de [filtros de reorientación]({{site.baseurl}}/user_guide/messaging/campaigns/ideas_and_strategies/retargeting_campaigns/#retarget-campaigns).
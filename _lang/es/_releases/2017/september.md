...
## Nueva funcionalidad para los informes de interacción {#new-functionality-for-engagement-reports}
...
- Programa un informe de interacción que se envíe a uno o varios destinatarios de forma periódica, y
- Añade campañas y Canvas a tu informe basándote en sus etiquetas.

## Actualizaciones de la página de perfil de usuario {#updates-to-user-profile-page}

Se ha actualizado [la página de perfil de usuario]({{site.baseurl}}/user_guide/audience/manage_audience/user_profiles/#using-user-search).

...
### Endpoints de ingesta de datos en la nube (CDI) de Braze {#braze-cloud-data-ingestion-cdi-endpoints}

{% multi_lang_include release_type.md release="General availability" %}

Utiliza los endpoints de CDI de Braze para:
...
### Soporte de ingesta de datos en la nube (CDI) de Braze para Databricks {#braze-cloud-data-ingestion-cdi-support-for-databricks}

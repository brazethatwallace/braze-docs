...
- [Unity SDK 5.0.0](https://github.com/braze-inc/braze-unity-sdk/blob/master/CHANGELOG.md)
    - Actualizado el puente nativo de iOS del Braze Swift SDK de 6.1.0 a 7.4.0.
    ...
    - Actualizado el puente nativo de Android del Braze Android SDK de 27.0.1 a 29.0.1.

...
### Acortamiento automático de enlaces para mensajería SMS {#automatic-link-shortening-for-sms-messaging}
...
- [Swift SDK 9.0.0](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md)
    - Elimina los dominios predeterminados de seguimiento de privacidad del manifiesto de privacidad de BrazeKit.
        - Si utilizas las [características de seguimiento de datos]({{site.baseurl}}/developer_guide/analytics/managing_data_collection/?sdktab=swift#swift_privacy-manifest) de Braze, tendrás que añadir manualmente tu punto de conexión de seguimiento al manifiesto de privacidad de tu aplicación.
...
- [Xamarin SDK versión 4.0.3](https://github.com/braze-inc/braze-xamarin-sdk/blob/master/CHANGELOG.md#403)
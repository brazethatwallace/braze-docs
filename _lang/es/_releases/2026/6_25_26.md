...
- Asistirte en cada paso individual del asistente de creación de Campaign, con visibilidad completa de lo que estás trabajando y la capacidad de cambiar las entradas del formulario en la página.
- Navegar al paso correcto del asistente para comenzar a actuar, ya sea que empieces desde una Campaign abierta o desde la página **Campaigns**.
...
- [Swift SDK 15.0.0](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md)
    ...
    - Elimina la capacidad de controlar si el SDK impide mostrar In-App Messages a diferentes usuarios en ciertos casos extremos.
...
- [Android SDK 42.3.1](https://github.com/braze-inc/braze-android-sdk/blob/master/CHANGELOG.md#4231)
    ...
    - Incluye correcciones de errores de In-App Messages en HTML.

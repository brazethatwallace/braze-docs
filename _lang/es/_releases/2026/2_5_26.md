...
[Content Optimizer]({{site.baseurl}}/user_guide/brazeai/content_optimizer/) es un paso en Canvas de pruebas de contenido continuo y de alta variabilidad que ofrece una optimización automatizada de la interacción. Utilizando una interfaz de arrastrar y soltar similar al paso de mensaje, puedes definir los componentes que quieres probar, generar variantes utilizando IA (o introducirlas manualmente) y utilizar etiquetas de Liquid para mapear estos componentes al contenido de tu mensaje.
...
Se han publicado las siguientes actualizaciones del SDK. Las actualizaciones de ruptura se enumeran a continuación; todas las demás actualizaciones se pueden encontrar consultando los correspondientes registros de cambios del SDK.

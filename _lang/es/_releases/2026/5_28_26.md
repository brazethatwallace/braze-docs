...
Usa las [zonas horarias del espacio de trabajo]({{site.baseurl}}/user_guide/administer/global/admin_settings/workspace_time_zone/) para definir zonas horarias específicas para espacios de trabajo individuales. Esto hace que las Campaigns y los Canvas programados (que no usen hora local o Intelligent Timing) se envíen según la zona horaria designada del espacio de trabajo, en lugar de la zona horaria general de la empresa.

Las zonas horarias del espacio de trabajo para el envío de mensajes se están implementando gradualmente, por lo que es posible que aún no veas esta configuración en tu dashboard.
...
Se han publicado las siguientes actualizaciones del SDK. Las actualizaciones de cambios importantes se enumeran a continuación; todas las demás actualizaciones se pueden encontrar consultando los registros de cambios correspondientes del SDK.
...
- [Segment Swift 8.0.0](https://github.com/braze-inc/braze-segment-swift/blob/main/CHANGELOG.md#800)
    ...
    - Añade soporte para Autenticación SDK.
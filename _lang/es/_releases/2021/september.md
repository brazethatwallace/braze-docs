...
iOS 15 introdujo nuevas características de notificación para ayudar a los usuarios a mantenerse concentrados y evitar interrupciones frecuentes a lo largo del día. Nos complace ofrecer compatibilidad con estas nuevas características, incluidos [los niveles de interrupción y las puntuaciones de relevancia]({{site.baseurl}}/user_guide/channels/push/platform_specific_resources/ios/notification_options/).

...
## Lanzamiento del 23 de julio de 2026
...
#### El almacenamiento gratuito de catálogos ahora admite hasta 500 MB
...
#### Operator ahora puede actualizar las páginas de configuración por ti
...
#### Alcance de audiencia por equipos
...
#### Escala de valoración en encuestas para mensajes dentro de la aplicación y páginas de destino
...
#### Plantillas de oferta por tiempo limitado de WhatsApp
...
#### Actualización autoservicio de la versión del SDK de Shopify
...
#### Reemplazar un archivo en la biblioteca multimedia

{% multi_lang_include release_type.md release="General availability" %}

Ahora puedes [reemplazar el archivo de un activo existente en la biblioteca multimedia]({{site.baseurl}}/user_guide/messaging/design_and_edit/media_library#replace-a-file) manteniendo estables su URL e ID de activo. Dado que la URL no cambia, cualquier Campaign, Canvas, Content Block o plantilla que haga referencia a ese activo refleja automáticamente el archivo actualizado, por lo que no tienes que volver a subirlo ni volver a vincularlo manualmente en todos los lugares donde se usa.

#### Vista de cuadrícula para la biblioteca multimedia
...
#### Compatibilidad de vista previa compartible para más canales
...
#### Stayfilm - Contenido visual e interactivo
...
## Lanzamiento del 25 de junio de 2026

### Datos e informes

#### Actualización del nombre de la métrica para Content Cards y Banners
...
#### Exclusiones de puntos de datos
...
#### El Centro de capacidad de entrega muestra datos de Microsoft SNDS para clientes de Amazon SES
...
#### Asistentes unificados de BrazeAI en Operator
...
#### Compatibilidad de Operator con la creación y edición de campañas
...
#### Compatibilidad de Operator con Content Blocks
...
#### Plantillas de la Consola de Agente creadas con Operator
...
#### Mejoras en la Consola de Agente
...
#### Editar un paso del Optimizador de contenidos ya lanzado
...
#### Descartes de usuario para Banners
...
#### Seguimiento de clics personalizado para Banners
...
#### Selección de variantes de BrazeAI<sup>TM</sup>
...
#### Resultados del envío de prueba de WhatsApp
...
#### Convercus - Datos y análisis - Fidelización
...
#### Copy Pastd - Orquestación de mensajes - Plantillas
...
#### Databricks Mosaic - Proveedores de modelos de IA
...
#### DinMo - Datos y análisis - ETL inverso
...
#### EmailShepherd - Orquestación de mensajes - Plantillas
...
#### Talkable - Personalización de mensajes - Referidos
...
## Lanzamiento del 28 de mayo de 2026

### Datos e informes

#### Dashboard de rendimiento de push
...
#### Campos de geolocalización en selecciones de catálogo
...
#### Banner y RCS para el generador de informes
...
#### Acciones del evento `ecommerce.cart_updated`
...
#### Optimizador de contenidos para mensajes SMS, MMS y RCS
...
#### Zonas horarias del espacio de trabajo
...
#### Estados de suscripción SMS huérfanos
...
#### Chord - Plataforma de datos de los clientes
...
## Lanzamiento del 30 de abril de 2026

### Datos e informes

#### Adición rápida de usuario para la creación de perfiles individuales
...
#### Sincronizaciones CDI sin copia para desencadenantes de Canvas
...
#### Nuevas actualizaciones de Currents para Banner y WhatsApp
...
#### Componente de Canvas Enviar a destino
...
#### Comportamiento de avance de validación de entrega para pasos de mensaje
...
#### Etiquetas de producto, metacampos y colecciones de Shopify
...
#### GRAVITY - Datos y análisis - Fidelización
...
## Lanzamiento del 2 de abril de 2026

### Datos e informes

#### Nuevos campos del canal Banner en eventos de Currents y Datashare
...
#### Compatibilidad con los centros de datos de Mixpanel en la UE e India para Currents
...
#### Fuentes y sincronizaciones reutilizables de Ingesta de datos en la nube (CDI)
...
#### Enviar tickets de soporte desde BrazeAI Operator<sup>TM</sup>
...
#### CataBoom - Personalización de mensajes - Contenido visual e interactivo
...
#### Denada - Orquestación de mensajes - Plantillas
...
#### Poq - Comercio electrónico - Plataforma de aplicaciones móviles
...
#### The Trade Desk – Sincronización de audiencias en Canvas
...
#### Conecta tu entorno de desarrollo integrado (IDE) al MCP de Docs
...
## Lanzamiento del 5 de marzo de 2026
...
#### Campos de Campaign y Canvas para Snowflake Data Share
...
#### Validación previa a la importación y reporte de errores de CSV
...
#### Limitación de velocidad basada en canal
...
#### Traducir locales en Content Blocks
...
#### Algolia - Búsqueda y recomendaciones
...
#### Open Loyalty - Datos y análisis - Fidelización
...
## Lanzamiento del 5 de febrero de 2026
...
#### Configurar la anchura de los Content Blocks de arrastrar y soltar
...
#### Usa el calentamiento de IP automatizado
...
#### Oracle Crowdtwist - Datos y análisis
...
#### Eventos de la Consola de Agente para destinos de almacenamiento y Datashare
...
#### Nuevos eventos "Retry" para canales individuales
...
#### Añadir el nuevo campo 'time_ms' al evento TokenStateChange
...
## Lanzamiento del 8 de enero de 2026
...
#### Límites de velocidad basados en canal

...
## Mensajes dentro de la aplicación - Generación 3 {#in-app-messages-generation-3}
...
- Espaciado refinado
- Un nuevo activo de cierre `x`
- Comportamiento receptivo mejorado para todos los tipos de mensajes, para que se ajusten mejor a los viewports
- Bordes de botones para crear contrastes personalizados entre botones

Nuestros [nuevos mensajes dentro de la aplicación]({{site.baseurl}}/user_guide/channels/in_app_messages/) harán que tus interacciones con el usuario pasen de ser buenas a ser increíbles.
...
## Actualización del archivado de Content Blocks {#content-blocks-archive-update}

Ahora puedes archivar y desarchivar [Content Blocks]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/#archiving-content-blocks).

## Incorporación del socio Inkit {#inkit-partner-addition}

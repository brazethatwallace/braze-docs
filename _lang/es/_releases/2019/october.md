...
El ID de API de un Content Block se mostrará ahora en la página del Content Block seleccionado en el panel. Además, mostraremos dónde se están utilizando los Content Blocks.
...
Ahora puedes [utilizar una solicitud de API]({{site.baseurl}}/api/objects_filters/user_attributes_object) con cualquier campo del objeto de atributos; esto creará o actualizará un atributo con ese nombre y el valor proporcionado en el perfil de usuario especificado.
...
Utiliza las [API REST de grupo de suscripción]({{site.baseurl}}/api/endpoints/subscription_groups/) para gestionar de forma programática los grupos de suscripción que hayas almacenado en el panel de Braze en la página **Grupo de suscripción**.

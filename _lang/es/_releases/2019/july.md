...
Para establecer un valor `null` para la dirección "responder a" de un mensaje de correo electrónico de Braze, ve a **Administrar configuración** en la navegación y, a continuación, a la pestaña **Configuración del correo electrónico**. Desplázate hasta la sección **Outbound Email Settings** y selecciona **Exclude "Reply-To" and send replies to "From"** como dirección predeterminada.

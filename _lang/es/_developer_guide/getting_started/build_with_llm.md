...
Guarda la configuración y reinicia Cursor. Tu asistente de IA ahora puede acceder a la documentación de Braze a través de Context7 cuando incluyes `use context7` en tus prompts.
{% endtab %}

{% tab Claude %}
En Claude Desktop, ve a **Settings** > **Developer** > **Edit Config** y, a continuación, añade lo siguiente a tu archivo `claude_desktop_config.json`:
...
{% tab VS Code %}
Añade lo siguiente a tu archivo `settings.json` o `.vscode/mcp.json` de VS Code:
...
#### Registro de eventos personalizados con propiedades {#logging-custom-events-with-properties}
...
#### Gestión de mensajes dentro de la aplicación {#handling-in-app-messages}
...
#### Seguimiento de eventos personalizados y compras {#tracking-custom-events-and-purchases}
...
#### Registro para notificaciones push web {#registering-for-web-push}
...
#### Gestión de atributos de usuario {#managing-user-attributes}
...
## Documentación en texto sin formato {#plain-text-documentation}

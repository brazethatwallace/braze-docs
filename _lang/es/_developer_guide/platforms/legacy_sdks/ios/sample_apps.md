...
Las notificaciones push para la aplicación de prueba de iOS requieren configuración adicional. Consulta nuestra [integración push en iOS]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration) para más detalles.
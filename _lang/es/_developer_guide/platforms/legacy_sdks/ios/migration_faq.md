...
article_title: Preguntas frecuentes sobre la migración del SDK de iOS
platform: iOS
page_order: 12
description: "Esta página responde a las preguntas más frecuentes sobre la migración del SDK de Appboy para iOS (Objective-C) al SDK Swift de Braze."
noindex: true
---

# Preguntas frecuentes sobre la migración del SDK de iOS {#ios-sdk-migration-faq}

> Esta página responde a las preguntas más frecuentes sobre la migración del SDK de Appboy para iOS heredado (también conocido como el SDK de Objective-C) al SDK Swift de Braze.

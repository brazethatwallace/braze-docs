...
Empieza por configurar el [delegado de mensajes dentro de la aplicación](#in-app-message-controller-delegate) en tu aplicación. A continuación, implementa el siguiente método delegado para desactivar el mensaje predeterminado de revisión de la App Store:
...
- El comportamiento al hacer clic configurado como "Vínculo profundo dentro de la aplicación", utilizando el vínculo profundo `{YOUR-APP-SCHEME}:appstore-review`.

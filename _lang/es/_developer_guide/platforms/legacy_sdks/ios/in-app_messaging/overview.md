...
platform: iOS
page_order: 0
description: "En este artículo de referencia se cubren los tipos de mensajería dentro de la aplicación de iOS, los comportamientos esperados y varios casos de uso."
channel:
  - in-app messages
search_rank: 4
noindex: true
...
## Tipos de mensajes dentro de la aplicación {#in-app-message-types}
...
### Comportamientos esperados por tipos de mensajes {#expected-behaviors-by-message-types}

Así es como tus usuarios ven uno de nuestros tipos predeterminados de mensajes dentro de la aplicación al abrirlo.

...
## Utiliza notificaciones push silenciosas para desencadenar el trabajo en segundo plano {#use-silent-push-notifications-to-trigger-background-work}
...
## Limitaciones de las notificaciones silenciosas de iOS {#ios-silent-notifications-limitations}

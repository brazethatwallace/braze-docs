...
article_title: Compatibilidad con Smart TV para el SDK Web de Braze
platform: Web
page_order: 30
...
## Configuración del SDK Web de Braze {#configuring-the-web-braze-sdk}
...
Todos los mismos métodos del SDK Web para análisis se pueden utilizar en las Smart TV. Para obtener una guía completa sobre cómo realizar el seguimiento de eventos personalizados, atributos personalizados y mucho más, consulta [Análisis]({{site.baseurl}}/developer_guide/analytics/tracking_sessions?tab=web).

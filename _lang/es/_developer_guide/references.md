...
## Creación de una aplicación de ejemplo {#building-a-sample-app}

{% tabs %}
{% tab android %}
### Compilar "Droidboy" {#building-droidboy}
...
### Compilar "Hello Braze" {#building-hello-braze}
...
![Captura de pantalla relacionada con la compilación de "Hello Braze".]({% image_buster /assets/img_archive/hello_appboy.png %})<br><br>
...
{% tab swift %}
### Compilar las aplicaciones de prueba de Swift {#building-swift-test-apps}

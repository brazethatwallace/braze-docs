---
nav_title: SDK or kit de desarrollo de software web
article_title: Guía del repositorio del SDK or kit de desarrollo de software web
page_order: 1
description: "Referencia del README del SDK or kit de desarrollo de software web de Braze reflejada desde GitHub."
---

<!-- BEGIN GENERATED README CONTENT -->
# Guía del repositorio del SDK or kit de desarrollo de software web {#web-sdk-repository-guide}

## Acerca del SDK or kit de desarrollo de software web de Braze {#about-the-braze-web-sdk}

El SDK or kit de desarrollo de software web de Braze te permite integrar la plataforma de interacción con los clientes de Braze directamente en tus aplicaciones web. Creado con TypeScript y diseñado para el desarrollo web moderno, este SDK or kit de desarrollo de software proporciona herramientas completas para la gestión de usuarios, mensajería, análisis y conmutadores de características.
...
Ya sea que estés creando una aplicación de página única, un sitio de comercio electrónico o una plataforma de contenido, el SDK or kit de desarrollo de software web de Braze proporciona las herramientas que necesitas para crear experiencias de usuario personalizadas y atractivas que impulsen el crecimiento y la retención.

## Requisitos previos {#prerequisites}

Antes de integrar el SDK or kit de desarrollo de software de Web Braze, necesitarás:
...
- **Endpoint del SDK or kit de desarrollo de software**: La URL del endpoint de tu SDK or kit de desarrollo de software de Braze (por ejemplo, `sdk.iad-01.braze.com`)
...
2. **Endpoint del SDK or kit de desarrollo de software**: Se encuentra en **Configuración** > **Autenticación del SDK or kit de desarrollo de software** > **Endpoints**
...
El siguiente fragmento de código muestra la configuración mínima necesaria para inicializar el SDK or kit de desarrollo de software de Web de Braze.
...
|--------|------|---------|-------------|
| `baseUrl` | `string` | **Obligatorio** | Esta opción es obligatoria para configurar el SDK or kit de desarrollo de software de Braze para Web y que utilice el endpoint adecuado para tu integración, por ejemplo: `braze.initialize('YOUR-API-KEY-HERE', { baseUrl: 'sdk.iad-03.braze.com' })` |
...
| `inAppMessageZIndex` | `number` | `999999` | De forma predeterminada, el SDK or kit de desarrollo de software de Braze mostrará los In-App Messages con un z-index de 999999. Proporciona un valor para esta opción para anular ese predeterminado. |
...
| `contentSecurityNonce` | `string` | `undefined` | Si proporcionas un valor para esta opción, el SDK or kit de desarrollo de software de Braze agregará el nonce a cualquier elemento `<script>` y `<style>` creado por el SDK or kit de desarrollo de software. Esto se puede utilizar para permitir que el SDK or kit de desarrollo de software de Braze funcione con la política de seguridad de contenido de tu sitio web. Ten en cuenta que, además de establecer este nonce, es posible que también necesites permitir la carga de FontAwesome, lo cual puedes hacer agregando `use.fontawesome.com` a la lista de permitidos de tu política de seguridad de contenido o usando la opción `doNotLoadFontAwesome` y cargándolo manualmente. |
| `noCookies` | `boolean` | `false` | De forma predeterminada, el SDK or kit de desarrollo de software de Braze para Web utiliza cookies. Para desactivar el uso de cookies, establece esta opción en true. Ten en cuenta que desactivar las cookies puede afectar la capacidad del SDK or kit de desarrollo de software para recordar las identidades de los usuarios entre sesiones. |
...
| `enableSdkAuthentication` | `boolean` | `false` | Establece en true para habilitar la característica de autenticación del SDK or kit de desarrollo de software. Para obtener más información sobre la autenticación del SDK or kit de desarrollo de software, consulta nuestra documentación del producto. |
...
| `localization` | `string` | `undefined` | Si proporcionas un valor para esta opción, el SDK or kit de desarrollo de software de Braze intentará mostrar los mensajes dentro de la aplicación y las tarjetas de contenido en esa configuración regional. |
...
| `devicePropertyAllowlist` | `string[]` | `undefined` | De forma predeterminada, el SDK or kit de desarrollo de software de Braze detecta y recopila automáticamente todas las propiedades del dispositivo en DeviceProperties. Para anular este comportamiento, proporciona un array de DeviceProperties. Para desactivar el envío de todas las propiedades a los servidores de Braze, proporciona un array vacío. Ten en cuenta que sin algunas propiedades, no todas las características funcionarán correctamente. Por ejemplo, sin la zona horaria, la entrega en zona horaria local no funcionará. |
...
#### Comprobar el estado del SDK or kit de desarrollo de software {#check-sdk-status}
...
#### Habilitar/deshabilitar el SDK or kit de desarrollo de software {#enabledisable-sdk}
...
#### Destruir el SDK or kit de desarrollo de software {#destroy-sdk}
...
#### Autenticación del SDK or kit de desarrollo de software {#sdk-authentication}
...
Si utilizas un framework de renderizado del lado del servidor (SSR) como Next.js, es posible que encuentres errores porque el SDK or kit de desarrollo de software está diseñado para ejecutarse en un entorno de navegador. Puedes resolver estos problemas importando el SDK or kit de desarrollo de software de forma dinámica.

Puedes conservar las ventajas del tree-shaking al hacerlo exportando las partes del SDK or kit de desarrollo de software que necesitas en un archivo separado y luego importando dinámicamente ese archivo en tu componente.
...
Alternativamente, si utilizas webpack para empaquetar tu aplicación, puedes aprovechar sus comentarios mágicos para importar dinámicamente solo las partes del SDK or kit de desarrollo de software que necesitas.
...
Si utilizas Vite y ves una advertencia sobre dependencias circulares o `Uncaught TypeError: Class extends value undefined is not a constructor or null`, es posible que necesites excluir el SDK or kit de desarrollo de software de Braze de su descubrimiento de dependencias:
...
Si tu sitio utiliza RequireJS u otro cargador de módulos AMD, pero prefieres cargar el SDK or kit de desarrollo de software Web de Braze a través del CDN, puedes cargar una versión de la biblioteca que no incluye compatibilidad con AMD. Esta versión de la biblioteca se puede cargar desde la ubicación del CDN: `https://js.appboycdn.com/web-sdk/6.3/braze.no-amd.min.js`
...
- **Acceso global**: el SDK or kit de desarrollo de software está disponible como `window.braze` cuando se carga a través del CDN
...
La siguiente tabla describe las distribuciones disponibles del SDK or kit de desarrollo de software Web de Braze.

| Nombre | Descripción | npm | URL de CDN
| ---- | ----------- | --- | -------
| Full | SDK or kit de desarrollo de software completo con interfaz de usuario. Al usar la versión npm, los empaquetadores de JavaScript eliminan el código no utilizado, incluido el código de la interfaz de usuario. | `@braze/web-sdk` | https://js.appboycdn.com/web-sdk/6.11/braze.min.js
| Core | Contiene el SDK or kit de desarrollo de software sin interfaz de usuario. Implementa tu propia interfaz de usuario para In-App Messages y Content Cards al usar esta versión del SDK or kit de desarrollo de software. Usa la biblioteca completa para la mayoría de las integraciones, ya que proporciona elementos de interfaz de usuario personalizables a través de CSS. | N/A | https://js.appboycdn.com/web-sdk/6.11/braze.core.min.js
| No-AMD | Contiene el SDK or kit de desarrollo de software completo sin compatibilidad con AMD. Esto es útil si tu sitio usa RequireJS u otro cargador de módulos AMD, pero prefieres cargar el SDK or kit de desarrollo de software a través de la CDN. | N/A | https://js.appboycdn.com/web-sdk/6.11/braze.no-amd.min.js
...
- [Documentación del SDK or kit de desarrollo de software](https://js.appboycdn.com/web-sdk/latest/doc/modules/braze.html)

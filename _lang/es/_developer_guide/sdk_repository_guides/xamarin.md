---
nav_title: SDK or kit de desarrollo de software .NET MAUI (Xamarin)
article_title: Guía del repositorio del SDK or kit de desarrollo de software .NET MAUI (Xamarin)
page_order: 10
description: "Referencia del README del SDK or kit de desarrollo de software .NET MAUI (Xamarin) de Braze reflejada desde GitHub."
---

<!-- BEGIN GENERATED README CONTENT -->
# Guía del repositorio del SDK or kit de desarrollo de software .NET MAUI (Xamarin) {#net-maui-xamarin-sdk-repository-guide}

## Acerca del SDK or kit de desarrollo de software de Braze .NET MAUI (Xamarin) {#about-the-braze-net-maui-xamarin-sdk}

El SDK or kit de desarrollo de software de Braze .NET MAUI (Xamarin) te ayuda a integrar las funciones de mensajería, análisis y participación de usuarios de Braze en tu aplicación.
...
- `libs`: Los enlaces DLL compilados para los SDK or kit de desarrollo de software de Braze.
...
| Nombre del archivo de enlace               | Frameworks de Xamarin compatibles                         | Framework nativo de Braze                           | Versión del SDK or kit de desarrollo de software Xamarin de Braze |
| ------------------------------------------ | --------------------------------------------------------- | --------------------------------------------------- | ------------------------- |
| `BrazeAndroidBinding.sln`                  | .NET 9+                                                   | Android SDK or kit de desarrollo de software 43.1.1+                                 | 10.0.0+                   |
| `AppboyPlatform.XamarinAndroidBinding.sln` | Xamarin.Android,<br/>Xamarin.Forms,<br/>.NET 5 y anteriores | Android SDK or kit de desarrollo de software 23.3.0 y anteriores                     | 1.26.0 y anteriores       |
| `BrazeiOSBinding.sln`                      | .NET 9+                                                   | Swift SDK or kit de desarrollo de software 18.2.0+                                   | 10.0.0+                   |
...
El SDK or kit de desarrollo de software de Braze dejó de ser compatible con Xamarin y Xamarin.Forms a partir de la versión `4.0.0` y añadió compatibilidad con [.NET MAUI](https://learn.microsoft.com/en-us/dotnet/maui/what-is-maui).

...
guide_top_text: "> Estos son tutoriales de mensajes dentro de la aplicación para el SDK or kit de desarrollo de software de Braze que incluyen código desplazable paso a paso. Para ver la lista completa, consulta <a href='/docs/developer_guide/tutorials'>los tutoriales de Braze SDK or kit de desarrollo de software</a>."

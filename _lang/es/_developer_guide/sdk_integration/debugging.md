...
En Braze, ve a **Settings** y, en **Setup and Testing**, selecciona **SDK Debugger**.

![La sección "Setup and Testing" con "SDK Debugger" resaltado.]({% image_buster /assets/img/sdk_debugger/select_sdk_debugger.png %})

Selecciona **Create debugging session**.
...
Busca a un usuario utilizando su dirección de correo electrónico, `external_id`, alias de usuario o token de notificaciones push. Cuando estés listo para iniciar la sesión, selecciona **Select User**.
...
Cuando hayas terminado con los pasos de reproducción, selecciona **End Session** > **Close**.

![La sesión de depuración muestra el botón "End Session".]({% image_buster /assets/img/sdk_debugger/close_debugging_session.png %}){: style="max-width:85%;"}
...
Después de la sesión, puedes exportar tus registros de sesión como archivo CSV. Además, otras personas pueden utilizar tu **Session ID** para buscar tu sesión de depuración, por lo que no necesitas enviarles tus registros directamente.

![La página de depuración con "Export Logs" y "Copy Session ID" que se muestra después de la sesión.]({% image_buster /assets/img/sdk_debugger/copy_id_and_export_logs.png %})
...
## Objeto de push de Windows Phone 8 {#windows-phone-8-push-object}
...
Consulta el [catálogo de plantillas de notificación](https://msdn.microsoft.com/en-us/library/windows/apps/hh761494.aspx) de Windows Universal para obtener detalles sobre las opciones de `push_type`.
...
Para más información sobre el uso del parámetro `extra_launch_string` para la [vinculación en profundidad]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/actions_and_media_urls#what-is-deep-linking), consulta [Vinculación en profundidad con Windows Universal.]({{site.baseurl}}/hidden/archive_docs/windows_universal/push_notifications#step-5-deep-linking-from-push-into-your-app)
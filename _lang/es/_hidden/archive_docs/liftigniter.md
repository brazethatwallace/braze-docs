...
| Integración de API de LiftIgniter | Debes [integrar](https://support.liftigniter.com/support/solutions/articles/30000024667-api-integration-overview) LiftIgniter en tu sitio o aplicación para poder extraer recomendaciones de allí. |
...
Una vez que hayas colocado este mensaje en el cuerpo del creador de mensajes, podrás previsualizar tu mensaje. Incluso puedes incorporar imágenes, como se muestra en el siguiente ejemplo:

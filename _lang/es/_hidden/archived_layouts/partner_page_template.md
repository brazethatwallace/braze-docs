...
|---|---|---|---|
| Clave de API REST del espacio de trabajo de Braze | Plataforma Braze | Página **Configuración** > **Clave de API** | Esta descripción debería indicarte qué hacer con la clave de API REST del espacio de trabajo. |

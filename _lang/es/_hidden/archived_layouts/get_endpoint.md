---
nav_title: "GET: [Nombre del punto de conexión]"
article_title: "Ejemplo de diseño: GET: [Nombre del punto de conexión]"
search_tag: Endpoint
page_order: 1
excerpt_separator: ""
layout: api_page
page_type: reference
description: "En este artículo se describen el uso y los parámetros del punto de conexión Get [nombre del punto de conexión] de Braze."
...
Utiliza este punto de conexión para obtener una lista de los números de teléfono que se han considerado "no válidos" en un periodo de tiempo determinado.

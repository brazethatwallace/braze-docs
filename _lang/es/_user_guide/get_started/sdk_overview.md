...
> El SDK de Braze recopila datos de sesión, identifica a los usuarios y registra las compras y los eventos personalizados a través de tu sitio web o aplicación. También puedes utilizar el SDK para interactuar con los usuarios enviando **In-App Messages** y notificaciones push directamente desde el dashboard de Braze.
...
* Potencia las notificaciones push, los **In-App Messages** y los canales de mensajería de Content Cards
...
Utiliza el SDK para redactar y enviar **In-App Messages** directamente. Puedes elegir mensajes de deslizamiento hacia arriba, modales o a pantalla completa en función de la estrategia de tu Campaign. Para obtener más información sobre la composición, consulta [Crear **In-App Messages**]({{site.baseurl}}/user_guide/channels/in_app_messages/traditional/).
...
Por defecto, una Campaign que contenga **In-App Messages** se enviará a todas las versiones de la aplicación en ese espacio de trabajo. Por ejemplo, el mensaje se enviará tanto a usuarios web como de móvil. Para enviar **In-App Messages** solo a web o móvil, tendrás que segmentar tu Campaign en consecuencia, lo que se admite por defecto a través del SDK de Braze.
...
Esto te permitirá dirigirte a los usuarios en función de su comportamiento de forma inteligente. Si quisieras dirigirte a usuarios web para animarles a descargar tu aplicación móvil, crearías este segmento como tu audiencia objetivo. Si quisieras enviar una Campaign de mensajería que incluya **In-App Messages** en móvil, pero no en web, tendrías que desmarcar el icono de tu sitio web en tu segmento.

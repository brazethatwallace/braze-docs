...
Por defecto, una Campaign que contenga mensajes dentro de la aplicación se enviará a todas las versiones de la aplicación en ese espacio de trabajo. Por ejemplo, el mensaje se enviará tanto a usuarios web como de móvil. Para enviar un mensaje dentro de la aplicación exclusivamente a web o móvil, tendrás que segmentar tu Campaign en consecuencia, lo que se admite por defecto a través del SDK de Braze.
...
Esto te permitirá dirigirte a los usuarios en función de su comportamiento de forma inteligente. Si quisieras dirigirte a usuarios web para animarles a descargar tu aplicación móvil, crearías este segmento como tu audiencia objetivo. Si quisieras enviar una campaña de mensajería que incluya un mensaje móvil dentro de la aplicación, pero no un mensaje web, tendrías que desmarcar el icono de tu sitio web en tu segmento.

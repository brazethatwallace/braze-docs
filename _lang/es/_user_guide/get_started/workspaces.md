...
{% alert note %}
Para saber cómo difieren los MAU or usuarios activos al mes al ver todas las aplicaciones en comparación con una sola aplicación, consulta [MAU or usuarios activos al mes or usuarios activos al mes]({{site.baseurl}}/user_guide/analytics/dashboards/home#monthly-active-users).
{% endalert %}

...
El dashboard está organizado en cuatro secciones por canal: **Email**, **Notificación push**, **Content Card** y **SMS**:
...
La muestra se pondera para reflejar la población del mundo real. Se aplican pesos a los subgrupos para corregir cualquier desequilibrio residual del muestreo, lo que da como resultado referencias finales que son representativas e imparciales.
...
- **Privacidad:** Todas las referencias son agregadas y desidentificadas para proteger la información de los usuarios.
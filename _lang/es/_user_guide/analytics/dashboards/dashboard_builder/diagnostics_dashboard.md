...
| --- | --- |
| Tarjetas de contenido | La tarjeta fue enviada y es elegible para ser vista. |
...
Puedes acceder al dashboard de diagnóstico yendo a **Análisis** > **Generador de dashboards** y seleccionando **Diagnóstico de mensajería** de la lista de dashboards creados por Braze.

Para ejecutar el dashboard y ver tus datos:

1. Elige **Campañas** o **Canvas** como fuente para los informes de tu dashboard. 
2. Selecciona una o más campañas o Canvas.
3. Selecciona **Ejecutar dashboard** para cargar los datos de los filtros seleccionados.

![Ejemplo de diagnóstico de campañas y Canvas del 25 al 31 de mayo de 2025 para una campaña de serie de bienvenida.]({% image_buster /assets/img/campaign_canvas_dashboard_example.png %}){: style="max-width:90%;"}
...
- **Total de cancelaciones:** El recuento total de mensajes que fueron cancelados. Esto incluye miembros de la audiencia de Canvas que no entraron al Canvas o salieron del Canvas porque experimentaron un fallo en un paso o cumplieron los criterios de salida al realizar un evento de salida.
- **Envíos de mensajes:** El recuento total de mensajes que Braze procesó y envió con éxito. 
...
| Cancelación por horas tranquilas | Las horas tranquilas estaban habilitadas para la campaña o el paso en Canvas con la alternativa configurada como **Cancelar mensaje**. El usuario desencadenó la campaña o entró al paso de mensaje del Canvas durante las horas tranquilas, por lo que el mensaje fue cancelado. Sin embargo, esto no hace que el usuario salga del Canvas. |
...
| El usuario no está habilitado para Tarjetas de contenido | El usuario no ha utilizado ninguna aplicación que incluya esta tarjeta de contenido. |
...
### ¿Por qué la suma de *Total de cancelaciones* y *Envíos de mensajes* es menor que el tamaño esperado de mi audiencia?
...
### ¿Por qué la suma de *Total de cancelaciones* y *Envíos de mensajes* es mayor que la audiencia de una campaña y Canvas?

...
## Acerca del dashboard de uso de la API
...
Selecciona **Filtros** para aplicar filtros que limiten la vista del tráfico de la API REST de tu espacio de trabajo, incluyendo:

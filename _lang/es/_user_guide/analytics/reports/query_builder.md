...
Las consultas devuelven datos de los últimos 60 días. Si usas Currents o [Snowflake Data Sharing]({{site.baseurl}}/partners/data_and_analytics/data_warehouses/snowflake), es posible que puedas consultar hasta dos años de datos, que es el tiempo que se retienen tus datos en Snowflake. Para más detalles sobre la retención extendida de datos, contacta a tu CSM or administrador de éxito de cliente or administrador de éxito de cliente.

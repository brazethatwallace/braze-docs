...
Para ver este informe desde el dashboard, ve a **Análisis** > **Informe de eventos personalizados**. Selecciona los eventos personalizados que deseas analizar y luego selecciona **Aplicar** para generar el gráfico.
...
Para exportar los datos de tus eventos personalizados, selecciona <i class="fas fa-bars" title="Menú contextual del gráfico"></i> en el gráfico de **Rendimiento a lo largo del tiempo** y selecciona tu opción de exportación.

...
| Desglosar eventos personalizados por | Controla cómo se agrupa la serie temporal del evento personalizado seleccionado. De forma predeterminada, el gráfico muestra la tendencia agregada general por fecha. Cambia a **Custom Events by Hour** para ver patrones intradía, o a **Custom Events per MAU or usuarios activos al mes** para normalizar el volumen de eventos respecto a tu recuento de MAU or usuarios activos al mes or usuarios activos al mes. |

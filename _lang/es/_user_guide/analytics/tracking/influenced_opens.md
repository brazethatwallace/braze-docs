...
> Cuando un usuario selecciona una notificación push y es dirigido a tu aplicación, Braze lo registra como una Direct Opens. Cuando los usuarios no seleccionan la notificación pero aún así pueden verse influidos por la notificación push, Braze lo registra como una Influenced Opens. Esto proporciona un mayor nivel de detalle sobre el efecto de tus Campaigns push.
...
Esto difiere de establecer las aperturas de aplicaciones como un evento de conversión para una Campaign push. Para las conversiones, todas las aperturas dentro de la ventana de conversión se atribuirán a la Campaign. Las Influenced Opens configuran una ventana de tiempo y un crédito de atribución basados en el comportamiento de un usuario individual.

## Ver las Influenced Opens de una Campaign {#viewing-a-campaigns-influenced-opens}

Las Influenced Opens se suman a las Direct Opens de una Campaign para obtener un número de aperturas totales. Esto se muestra en la página **Campaign Analytics** de una Campaign push. Las aperturas totales y las Direct Opens se muestran en las secciones de rendimiento de los mensajes y **Historical Performance**. Las Influenced Opens son la diferencia entre las dos medidas.

![Estadísticas de Influenced Opens en la página de detalles de una Campaign]({% image_buster /assets/img_archive/Influenced_Opens2.png %})

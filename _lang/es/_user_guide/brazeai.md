...
guide_featured_list:
  ...
  - name: Optimizar con BrazeAI<sup>TM</sup>
...
| Optimizar qué contenido del mensaje (como el asunto o el CTA) tiene mejor rendimiento con el tiempo | [Optimizador de contenidos]({{site.baseurl}}/user_guide/brazeai/content_optimizer) (correo electrónico, notificaciones push o servicio de mensajes cortos/MMS/RCS) u [Optimizar con BrazeAI<sup>TM</sup>]({{site.baseurl}}/user_guide/brazeai/intelligence_suite/variant_selection) |

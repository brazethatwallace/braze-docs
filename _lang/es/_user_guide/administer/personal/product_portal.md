...
| Sección | Descripción |
| --- | --- |
| Lanzados recientemente | Nuevas características que hemos lanzado por trimestre |
...
Braze construye la hoja de ruta del producto basándose en muchas fuentes de información diferentes. Tomamos datos de nuestros clientes, el mercado, el panorama tecnológico en el que operamos, nuestra visión de producto y estrategia de innovación, y más. Los comentarios y opiniones de los clientes son un componente importante, pero son solo un componente.

Las prioridades y los plazos pueden cambiar (y cambian) en función de la información más reciente disponible para el equipo. Con esto en mente, siempre se recomienda enviar comentarios sobre el producto de manera oportuna para que el equipo de producto esté al tanto del sentimiento de los clientes y del mercado.

- **Enviar comentarios sobre el producto es una garantía** de que nuestro equipo de producto revisará y considerará los comentarios.
- **Enviar comentarios sobre el producto no es una garantía** de que tomaremos acción. Braze no puede ni quiere actuar sobre todos los comentarios de producto.

## Consejos para enviar comentarios sobre el producto {#tips-for-submitting-product-feedback}

¡Cuanta más información y contexto, mejor! Incluye enlaces a campañas, Canvas o segmentos, todo lo que ayude a la descripción. Estructuramos los comentarios sobre el producto en función de las siguientes preguntas:

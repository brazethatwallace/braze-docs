...
| Requisito | Detalles |
|---|---|
| Dominio de Braze | Necesitarás tu dominio de Braze para configurar Braze en OneLogin. Si tu instancia es `US-01`, deberás introducir la URL de tu panel en el panel de OneLogin. <br><br> Por ejemplo, si la URL de tu panel es `https://dashboard-01.braze.com`, tienes que introducir `dashboard-01.braze.com`.  |
...
6. Copia el **Certificate** y el **SAML 2.0 Endpoint (HTTP)** necesarios para configurar el panel de Braze desde la pestaña **SSO**.![Certificados a copiar desde la pestaña SSO de la aplicación Braze en OneLogin.]({% image_buster /assets/img/onelogin_6.jpg %})

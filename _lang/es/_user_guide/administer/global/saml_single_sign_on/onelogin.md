...
| Requisito | Detalles |
|---|---|
| Dominio Braze | Necesitarás tu dominio Braze para configurar Braze en OneLogin. Si tu instancia es `US-01`, deberás introducir la URL de tu dashboard en el dashboard de OneLogin. <br><br> Por ejemplo, si la URL de tu dashboard es `https://dashboard-01.braze.com`, tienes que introducir `dashboard-01.braze.com`.  |

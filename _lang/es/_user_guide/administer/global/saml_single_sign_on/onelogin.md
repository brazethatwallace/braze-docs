...
| Clave de API RelayState | Para habilitar el inicio de sesión de IdP, ve a **Settings** > **API Keys** y crea una clave de API con permisos `sso.saml.login`. |
...
Después de que tu director de cuentas haya habilitado SAML SSO para tu cuenta, ve a **Settings** > **Admin Settings** > **Security Settings** y activa la sección SAML SSO a **ON**.

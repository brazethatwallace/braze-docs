...
| Requisito | Detalles |
|---|---|
| SAML inicio de sesión único | Configurado y probado antes de habilitar JITP. Consulta [Configuración de SAML inicio de sesión único]({{site.baseurl}}/user_guide/administer/global/saml_single_sign_on/saml_sso_setup). |
...
6. En la configuración de tu proveedor de inicio de sesión único, añade a todos los usuarios que necesiten acceso a Braze en el directorio de tu proveedor de inicio de sesión único.
...
### El usuario no fue aprovisionado en el primer inicio de sesión con inicio de sesión único {#user-was-not-provisioned-on-first-sso-sign-in}

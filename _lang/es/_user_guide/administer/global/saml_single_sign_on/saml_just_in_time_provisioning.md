...
## Configuración del aprovisionamiento SAML justo a tiempo (JITP) {#setting-up-saml-just-in-time-provisioning-jitp}
...
### El botón de inicio de sesión único no aparece con Microsoft Entra ID {#single-sign-button-doesnt-appear-with-microsoft-entra-id}

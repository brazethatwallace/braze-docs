...
article_title: Gestionar el consentimiento
page_order: 1
page_type: reference
...
- **Equipos:** Utiliza los [equipos de Braze]({{site.baseurl}}/user_guide/administer/global/user_management/teams) para una verdadera gobernanza. Se trata de añadir un atributo personalizado a todos los perfiles de usuario para indicar su estado de consentimiento, la fecha de consentimiento o ambos. A continuación, debes migrar todas las campañas y Canvas al equipo designado y ajustar los permisos de usuario en el dashboard en consecuencia.
- **Atributo del perfil de usuario:** Añade un atributo de consentimiento a todos los perfiles de usuario. Este atributo indicará si un usuario ha dado su consentimiento o no. En el futuro, podrás incluir un segmento de usuarios que hayan dado su consentimiento (por ejemplo, `consent = true`) en todas tus campañas y Canvas.

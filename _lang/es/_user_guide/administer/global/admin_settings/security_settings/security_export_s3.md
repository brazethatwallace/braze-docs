...
1. En Braze, ve a **Settings** > **Company Settings** > **Admin Settings** > **Security Settings** y desplázate hasta la sección **Security Event Download**.
...
![Botón "Save changes".]({% image_buster /assets/img/security_export/save_changes_button.png %}){: style="max-width:50%;"}
...
3. Toma nota de los identificadores, la ID de cuenta de Braze y el ID externo de Braze necesarios para crear tu rol.
...
{: start="2"}
2. En Braze, ve a **Settings** > **Company Settings** > **Admin Settings** > **Security Settings** y desplázate hasta la sección **Security Event Download**.
...
![Botón "Save changes".]({% image_buster /assets/img/security_export/save_changes_button.png %}){: style="max-width:40%;"}

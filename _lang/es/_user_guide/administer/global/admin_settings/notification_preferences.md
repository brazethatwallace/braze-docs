...
| Errores de contenido conectado | Notifica a los destinatarios cuando un endpoint de contenido conectado tiene errores. | Correo electrónico |
| Errores de push | Notifica a los destinatarios cuando un endpoint push tiene errores. | Correo electrónico, Webhook |
...
| Errores de webhook | Notifica a los destinatarios cuando un endpoint de webhook tiene errores. | Correo electrónico |

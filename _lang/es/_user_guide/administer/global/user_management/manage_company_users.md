...
{% alert tip %}
El departamento indicado en el perfil de un usuario determina qué tipos de comunicaciones recibe de Braze. Esto es para que todos reciban únicamente las comunicaciones y alertas que son relevantes para la forma en que utilizan Braze.
{% endalert %}

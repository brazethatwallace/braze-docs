...
Los roles permiten una mayor estructura al agrupar tus permisos personalizados individuales con controles de acceso al espacio de trabajo. Esto es especialmente útil si tienes muchas marcas o espacios de trabajo regionales en un solo panel. Con los roles, puedes añadir usuarios del panel a los espacios de trabajo correctos y otorgarles directamente los permisos asociados. Para crear un rol, ve a **Configuración** > **Gestión de usuarios** > **Roles** y selecciona **Crear rol**. Para una descripción de cada permiso, consulta [Lista de permisos]({{site.baseurl}}/user_guide/administer/global/user_management/permissions#list-of-permissions).
...
Puedes encontrar dificultades al intentar guardar permisos en el panel de Braze, especialmente al añadir o eliminar usuarios de un espacio de trabajo, o al añadirlos a un equipo. El botón **Guardar/Actualizar usuarios** puede aparecer atenuado si los permisos del usuario son idénticos a los que ya tiene a nivel de espacio de trabajo. Esta restricción existe porque no tiene sentido tener un equipo si todos los usuarios poseen los mismos permisos que todo el espacio de trabajo.
...
Los usuarios limitados tienen permisos específicos que les permiten gestionar ciertos aspectos del panel de Braze, pero con restricciones en comparación con los administradores de empresa y los administradores de espacio de trabajo.
...
Ten en cuenta los siguientes comportamientos al asignar acceso al panel:
...
| Páginas de destino | View Landing Pages | Ver páginas de destino |
| Páginas de destino | Publish Landing Pages | Activar un borrador de página de destino |
| Páginas de destino | Edit Landing Page Drafts | Crear y guardar borradores de páginas de destino |
...
| Usuarios | View User Profiles (PII Redacted) | Ver perfiles de usuario de manera compatible con PII. Los usuarios con este permiso no pueden guardar ni lanzar Campaigns que hagan referencia a atributos personalizados marcados como PII a menos que también tengan el permiso "View Custom Attributes Marked as PII". |
...
| Eliminar usuarios | Delete Users | Eliminar permanentemente usuarios del panel de forma individual o masiva |
...
| Plantillas de páginas de destino | View Landing Page Templates | Ver plantillas de páginas de destino |
| Plantillas de páginas de destino | Archive Landing Page Template | Mover plantillas de páginas de destino al archivo |
| Plantillas de páginas de destino | Edit Landing Page Templates | Crear y actualizar plantillas de páginas de destino |
...
| Partners tecnológicos | Edit Technology Partners | Crear y actualizar partners tecnológicos |
...
| Catálogos | Export Catalogs | Descargar catálogos del panel |
| Catálogos | Edit Catalogs | Crear y actualizar catálogos y selecciones |
| Ingesta de datos en la nube | Edit Cloud Data Ingestion | Crear, actualizar y eliminar fuentes y sincronizaciones |
| Atributos personalizados | View Custom Attributes | Ver atributos personalizados e informe de uso |
| Atributos personalizados | Export Custom Attributes | Descargar atributos personalizados del panel |
| Atributos personalizados | Delete Custom Attributes | Eliminar permanentemente atributos personalizados |
| Atributos personalizados | Blocklist Custom Attributes | Añadir atributos personalizados a una lista de bloqueo que restringe su uso en el panel |
...
| Eventos personalizados | Export Custom Events | Descargar eventos personalizados del panel |
| PII | View PII | Ver PII |
| Eventos personalizados | Delete Custom Events | Eliminar permanentemente eventos personalizados |
| Eventos personalizados | Blocklist Custom Events | Añadir eventos personalizados a una lista de bloqueo que restringe su uso en el panel |
| Eventos personalizados | Edit Custom Events | Crear y actualizar eventos personalizados |
| Productos | View Products | Ver productos |
| Productos | Blocklist Products | Añadir productos a una lista de bloqueo que restringe su uso en el panel |
...
| Datos de uso de API | View API Usage Dashboard | Ver el panel de uso de API |
...
| Configuración de Audience Sync | View Audience Sync Settings | Ver toda la configuración de los partners de Audience Sync conectados |
| Usuarios del panel | Edit Dashboard Users | Ver, crear y editar usuarios de la empresa |
...
| Informes del panel | View Dashboard Reports | Ver informes sin realizar cambios |
| Informes del panel | Delete Dashboard Reports | Eliminar permanentemente informes |
| Informes del panel | Edit Dashboard Reports | Crear y actualizar informes |
...
| Códigos promocionales | Export Promotion Codes | Descargar una lista de códigos promocionales del panel |

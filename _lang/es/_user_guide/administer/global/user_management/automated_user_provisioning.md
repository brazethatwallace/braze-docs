...
1. En el panel de Braze, ve a **Configuración** > **Configuración de administrador** > **Aprovisionamiento SCIM** y, a continuación, selecciona **Configurar integración SCIM**.
...
## Paso 1: Configurar los ajustes de SCIM

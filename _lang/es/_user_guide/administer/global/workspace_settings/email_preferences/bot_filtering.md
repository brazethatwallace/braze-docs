...
## Métricas afectadas por los clics de los bots
...
Ve a **Configuración** > **Preferencias de correo electrónico**. Luego, selecciona **Quitar clics de bots**. Esta configuración se aplica a nivel del espacio de trabajo.
...
## Campos en eventos de clic de correo electrónico para Currents y Snowflake
...
### ¿Cómo afectará el filtrado de bots al rendimiento de mi Campaign?
...
### ¿El filtrado de bots evitará que los bots que hacen clic en el enlace de cancelación de suscripción de Braze cancelen la suscripción?

No. Todas las solicitudes de cancelación de suscripción seguirán procesándose.

### ¿Se consideran las aperturas de máquina en el filtrado de clics de bots?

...
1. Ve a **Configuración** > **Administrar configuración** > **Configuración de push**.
...
1. Ve a **Configuración** > **Administrar configuración** > **Configuración de push**.
2. En la sección de prioridad de FCM, selecciona "Normal" o "Alta" como configuración predeterminada.
3. Selecciona **Guardar** para aplicar tus cambios.

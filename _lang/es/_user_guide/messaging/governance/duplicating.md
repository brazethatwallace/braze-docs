...
page_order: 4
page_type: reference
description: "Este artículo de referencia explica cómo duplicar tus Campaigns y Canvas."
tool:
    - Campaigns
    - Canvas
---

# Duplicar Campaigns y Canvas {#duplicate-campaigns-and-canvases}

> Puedes duplicar Campaigns y Canvas preexistentes para seguir iterando y construyendo a partir de tus estrategias exitosas. Duplicar Campaigns y Canvas ayuda a minimizar el tiempo que dedicarías a reconfigurar los detalles de entrega y los segmentos de audiencia.

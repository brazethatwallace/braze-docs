...
Para filtrar tus campañas o Canvas por estado, selecciona **All Statuses** y luego elige un estado.

![El desplegable "All Statuses" en el dashboard de Braze.]({% image_buster /assets/img/messaging_fundamentals/filter-by-status.png %}){: style="max-width:70%;"}
...
| Borrador | Los borradores de campañas y Canvas están guardados pero no lanzados. Para continuar editando y comenzar a enviar, puedes seleccionar el borrador yendo a **Messaging** en el dashboard de Braze y seleccionando **Canvas** o **Campaigns**. |
...
| Detenido | Las campañas y Canvas detenidos están en pausa, pero aún puedes editarlos. Para reanudar un Canvas, ve al paso **Summary** del constructor de Canvas y selecciona **Resume Canvas**. Para campañas, selecciona el menú <i class="fas fa-ellipsis-vertical"></i> y luego **Resume**. Para más información, consulta [Comportamiento de Canvas detenido](#stopped-canvas-behavior). |
...
Para reanudar el Canvas, ve al paso **Summary** del constructor de Canvas y selecciona **Resume Canvas**. Cuando se reactive, cualquier mensaje previamente detenido se enviará según lo planificado&#8212;siempre que el horario planificado no haya pasado ya.

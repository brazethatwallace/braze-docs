...
{% alert note %}
- A nivel mundial, al menos 2200 millones de personas tienen una deficiencia visual de cerca o de lejos (ver [OMS](https://www.who.int/news-room/fact-sheets/detail/blindness-and-visual-impairment))
- Alrededor de 1 de cada 12 hombres y 1 de cada 200 mujeres tienen algún grado de deficiencia en la visión del color, un estimado de 300 millones de personas en el mundo (ver [NHS](https://www.nhs.uk/conditions/colour-vision-deficiency/))
{% endalert %}
...
- Aproximadamente el 15 % de los adultos estadounidenses (37,5 millones) de 18 años o más reportan alguna dificultad auditiva (ver [NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-hearing))
{% endalert %}
...
{% alert note %}
Casi 2 millones de personas en EE. UU. viven con pérdida de extremidades (ver [Amputee Coalition](https://www.amputee-coalition.org/limb-loss-resource-center/resources-filtered/resources-by-topic/limb-loss-statistics/limb-loss-statistics/#1))
{% endalert %}
...
- Aproximadamente el 10-20 % de la población mundial se considera neurodivergente (ver [Deloitte](https://www2.deloitte.com/us/en/insights/topics/talent/neurodiversity-in-the-workplace.html))
- Alrededor de 1 de cada 100 niños tiene autismo en todo el mundo (ver [OMS](https://www.who.int/news-room/fact-sheets/detail/autism-spectrum-disorders))
{% endalert %}
...
| In-App Messages (arrastrar y soltar) | Cuando eliges un idioma en **Accesibilidad**, Braze añade ese idioma al HTML externo del mensaje para que los lectores de pantalla traten todo el mensaje como ese idioma. Con los mensajes multilingües activados, los mensajes nuevos pueden usar de forma predeterminada los idiomas de tu configuración regional. La **vista previa** podría no mostrar ningún idioma hasta que elijas uno en **Configuración**. |
...
- **Usa un tamaño de objetivo táctil adecuado.** Apunta a un tamaño mínimo de objetivo táctil de 44 x 44 píxeles. Esto se alinea con las directrices de WCAG 2.2 para [objetivos táctiles](https://www.w3.org/WAI/WCAG22/Understanding/target-size-minimum.html) y los estándares comunes de usabilidad móvil.
...
- [Limítate al contexto relevante, sin jerga de marketing extra](#tip-5)
...
<table role="presentation" class="reset-td-br-1 reset-td-br-2">
  ...
  <tbody>
    <tr>
      ...
      <td>"Zapatillas para correr que son extremadamente cómodas y perfectas para tu estilo de vida activo en un vibrante tono de rojo." (Demasiado largo y lleno de relleno promocional)</td>
    </tr>
    <tr>
      <td>"Cuatro portátiles en un soporte de exhibición"</td>
...
<table role="presentation" class="reset-td-br-1 reset-td-br-2">
  ...
  <tbody>
    <tr>
      <td>"Banner que dice 'Rebajas de verano: 50 % de descuento en todo el traje de baño.'"</td>
      <td>"Banner promocionando una rebaja." (No menciona el descuento real)</td>
    </tr>
    <tr>
...
<table role="presentation" class="reset-td-br-1 reset-td-br-2">
  ...
  <tbody>
    ...
    <tr>
      <td>"Conjunto de patio trasero con cuatro sillas y una mesa de cristal"</td>
    ...
    <tr>
      <td>"Teléfono móvil mostrando una aplicación de pronóstico del tiempo con 75 °F en pantalla"</td>
      <td>"Experimenta innovaciones en tiempo real en el seguimiento del clima que cambian las reglas del juego" (No refleja lo que se muestra visualmente)</td>
    </tr>
  </tbody>
</table>
...
<table role="presentation" class="reset-td-br-1 reset-td-br-2">
  ...
  <tbody>
    ...
    <tr>
      <td>"Registrarse en la lista de correo"</td>
...
{% alert note %}
Al usar el editor de correo electrónico de arrastrar y soltar, establece el idioma desde la pestaña **Configuración** cuando ese control esté disponible. Los correos electrónicos de plantilla completa y los de solo Content Blocks pueden usar valores predeterminados diferentes para el idioma de accesibilidad; consulta [Idioma de accesibilidad](#accessibility-language). Los demás canales también se cubren en esa sección.
{% endalert %}
...
### Lo que las pruebas automatizadas pueden y no pueden detectar {#what-automated-testing-can-and-cant-catch}

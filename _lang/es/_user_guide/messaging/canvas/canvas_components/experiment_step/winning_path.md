...
### Paso 1: Añade un paso de recorrido de experimentos {#step-1-add-an-experiment-path-step}
...
### Paso 2: Configura los ajustes de la ruta ganadora {#step-2-configure-winning-path-settings}
...
### Paso 4: Añade tus rutas y lanza el Canvas {#step-4-add-your-paths-and-launch-the-canvas}

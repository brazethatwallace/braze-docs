...
## Crear una ruta de experimentos {#creating-an-experiment-path}
...
También puedes elegir si los usuarios del grupo de control deben continuar por el Canvas o salir después de la ventana de seguimiento de conversión para el **Control Group Behavior**. Opcionalmente, puedes añadir una descripción para explicar a otros qué pretende probar esta ruta de experimentos o incluir información adicional que pueda ser útil anotar.

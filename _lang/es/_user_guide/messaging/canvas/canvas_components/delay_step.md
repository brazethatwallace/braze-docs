...
Cuando seleccionas **días naturales** como unidad y habilitas **A una hora específica** (por ejemplo, **1 día natural a las 9 AM**), Canvas calcula primero la fecha del calendario objetivo y luego aplica la hora programada. Por ejemplo, si un paso de Canvas se envía a las 9 PM del lunes y el paso de retraso está configurado como **1 día natural a las 9 AM**, el siguiente paso se envía a las 9 AM del martes. Canvas calcula lunes + 1 día natural = martes, y luego aplica la hora de las 9 AM.

Por el contrario, cuando seleccionas **días** como unidad sin **A una hora específica** (por ejemplo, **Después de 1 día**), Canvas espera un periodo completo de 24 horas desde el momento en que el usuario entra en el paso de retraso. Por ejemplo, si un paso se envía a las 9:35 AM del 13 de octubre y el paso de retraso es **Después de 1 día**, el siguiente paso se envía a las 9:35 AM del 14 de octubre.
...
Si añades un componente de demora a tu Canvas y no hay pasos posteriores, cualquier usuario que llegue al último paso avanza automáticamente fuera del Canvas. Esto es así incluso si el tiempo del paso de demora aún no se ha alcanzado. Esto significa que los usuarios que ya han llegado al paso de demora no reciben ningún mensaje que añadas después de este paso. Sin embargo, si un usuario no ha llegado al paso de demora y se añade un mensaje, recibirá ese mensaje.

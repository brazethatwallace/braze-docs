...
## Crear una demora {#create-a-delay}
...
#### Demoras extendidas {#extended-delays}
...
## Tipos de demora temporal {#time-delay-types}
...
##### Los usuarios saldrán si un paso de demora posterior está dentro del plazo de un paso de demora anterior {#users-will-exit-if-a-subsequent-delay-step-is-within-a-prior-delay-steps-timeline}

...
3. Revisa el registro de mensajería de un usuario yendo a **Audiencia** > **Buscar usuarios**, abriendo el perfil y seleccionando **Messaging History** (últimos 30 días).

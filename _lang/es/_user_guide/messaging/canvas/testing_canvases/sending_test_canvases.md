...
# Enviar Canvas de prueba {#send-test-canvases}
...
## Paso 1: Crea tu plan de pruebas {#step-1-create-your-test-plan}
...
## Paso 4: Lanza tu prueba {#step-4-launch-your-test}
...
### Identifica los pasos de tu Canvas {#identify-your-canvas-steps}
...
### Aprovecha los Content Blocks {#leverage-content-blocks}

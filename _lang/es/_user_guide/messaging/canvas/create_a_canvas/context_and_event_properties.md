...
- Cuando un paso de Rutas de Acción contiene un desencadenante "Sent an servicio de mensajes cortos Inbound Message" o "Sent a WhatsApp Inbound Message", los pasos posteriores del Canvas pueden incluir una propiedad Liquid de servicio de mensajes cortos o WhatsApp. Esto refleja cómo funcionan las propiedades del evento en los Canvas. De esta forma, puedes aprovechar tus mensajes para guardar y hacer referencia a datos propios en los perfiles de usuario y la mensajería conversacional.

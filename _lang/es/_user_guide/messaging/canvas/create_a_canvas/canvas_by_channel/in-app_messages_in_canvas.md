...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Caducidad de mensajes dentro de la aplicación" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Pasos con múltiples canales" }

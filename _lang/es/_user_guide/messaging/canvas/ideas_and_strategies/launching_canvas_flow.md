...
### Revisar los filtros de audiencia de entrada {#review-entry-audience-filters}
...
### Verificar la disponibilidad de los usuarios {#check-user-availability}
...
### Confirmar que realizaron el evento personalizado o la compra como prerrequisito {#confirm-that-they-performed-the-prerequisite-custom-event-or-purchase}

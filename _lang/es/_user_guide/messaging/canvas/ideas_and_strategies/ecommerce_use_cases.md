...
2. Selecciona **Create Canvas** > **Use a Canvas Template**.
3. Examina la pestaña **Braze templates** para encontrar la plantilla que quieras usar. Puedes previsualizar una plantilla seleccionando su nombre.
4. Selecciona **Apply Template** para la plantilla que quieras usar.<br><br>![Página de "Canvas templates" abierta en la pestaña "Braze templates" que muestra una lista de plantillas usadas recientemente y plantillas de Braze seleccionables.]({% image_buster /assets/img_archive/apply_template.png %}){: style="max-width:80%;"}
...
![Tabla de detalles de conversiones con Campaigns y Canvas, y las estadísticas de conversión asociadas.]({% image_buster /assets/img_archive/conversion_details_table.png %})

...
# Lista de verificación previa y posterior al lanzamiento

> Este artículo proporciona una guía de aspectos a verificar antes y después de lanzar un Canvas.

## Aspectos a considerar antes del lanzamiento
...
### Considera usar expresiones regulares para los filtros de audiencia
...
### Verifica las propiedades de entrada de Canvas y las propiedades del evento
...
### Revisa los pasos de Mensaje para el avance de usuarios
...
## Aspectos a considerar después del lanzamiento

...
Cuando se crea un perfil de usuario en Braze, a ese usuario se le asigna automáticamente un número de contenedor aleatorio entre 0 y 9999 (inclusive). Puedes usar estos segmentos para probar la efectividad de múltiples campañas o Canvas en grupos de usuarios a lo largo del tiempo.
...
### Cuándo usar números de contenedor aleatorio

Si quieres realizar pruebas a largo plazo sobre la efectividad de múltiples campañas o Canvas a lo largo del tiempo, puedes usar números de contenedor aleatorio para segmentar a tus usuarios.
...
## Crear segmentos usando números de contenedor aleatorio
...
### Reingreso aleatorio de audiencia usando números de contenedor aleatorio

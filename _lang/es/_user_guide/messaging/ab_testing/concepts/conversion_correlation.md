...
page_type: reference
description: "Este artículo de referencia explica el análisis de correlación de conversión en la página de análisis de campañas."
tool: 
  - Reports
...
> El análisis de correlación de conversión en la página de **análisis de campañas** te ofrece información sobre qué atributos y comportamientos de los usuarios ayudan o perjudican los resultados que has establecido para las campañas. 
...
![Panel de correlación de conversión que muestra un ejemplo con "Seleccionar un evento de conversión" configurado como "Evento de conversión primaria - A" con la configuración del evento como "Realizó una compra en 12 horas (cualquier producto)".]({% image_buster /assets/img/convcorr.png %})
...
- Campañas y Canvas recibidos en los últimos 30 días (distintos de la campaña que se está evaluando actualmente)
...
## ¿Cuándo puedo consultar este análisis?
...
## Cómo comprueba Braze la significancia

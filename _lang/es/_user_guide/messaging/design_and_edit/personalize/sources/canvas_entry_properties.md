...
{% alert important %}
Las propiedades de entrada persistentes forman parte del flujo de trabajo original de propiedades de entrada de Canvas. Para el editor de Canvas actualizado, consulta [Propiedades de contexto y evento]({{site.baseurl}}/user_guide/messaging/canvas/create_a_canvas/context_and_event_properties).
{% endalert %}

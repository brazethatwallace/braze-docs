...
{% alert important %}
Los códigos promocionales están disponibles en Campaigns de mensajes dentro de la aplicación como característica de acceso anticipado, pero no se pueden enviar en mensajes dentro de la aplicación en Canvas.
{% endalert %}
...
Los códigos promocionales son compatibles con correo electrónico, push móvil, notificación push web, Content Cards, webhook, SMS y WhatsApp. Las Campaigns de mensajes dentro de la aplicación son compatibles con los códigos promocionales como característica de acceso anticipado. Las Campaigns de correo electrónico transaccional de Braze y los mensajes dentro de la aplicación en Canvas no son compatibles con los códigos promocionales.
...
- **Descontinuar la lista completa:** Deja de usar la lista actual en cualquier Campaign, Canvas o plantilla. Luego carga los códigos correctos en una nueva lista y cambia todos tus mensajes para que usen la nueva lista.
- **Agotar los códigos incorrectos:** Crea una Campaign que envíe códigos de la lista incorrecta a un usuario de marcador de posición hasta que se agoten todos los códigos incorrectos. Después, vuelve a cargar los códigos correctos en la misma lista, excluyendo los incorrectos.

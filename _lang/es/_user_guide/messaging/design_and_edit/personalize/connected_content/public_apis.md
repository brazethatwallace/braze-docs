...
{% alert note %}
Las API públicas pueden estar sujetas a restricciones de uso y límites de velocidad. Asegúrate de leer la documentación de las API y contactar a los proveedores de API sobre el uso que pretendes darles.
{% endalert %}

## Noticias e información {#news-and-information}
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Finanzas" }

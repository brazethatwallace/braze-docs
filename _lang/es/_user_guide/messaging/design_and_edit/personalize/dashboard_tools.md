...
- **Pasos de Campaign y Canvas** para canales que admiten Liquid en el cuerpo o los encabezados (por ejemplo, correo electrónico, push, servicio de mensajes cortos, mensajes dentro de la aplicación, Content Cards y webhooks).

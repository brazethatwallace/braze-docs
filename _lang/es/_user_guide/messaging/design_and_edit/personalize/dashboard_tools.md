...
# Herramientas del dashboard para personalización
...
## Añadir personalización en compositores y configuración

La herramienta **Añadir personalización** aparece junto a los campos de texto con plantillas en todo el dashboard, incluyendo:

- **Pasos de campaña y Canvas** para canales que admiten Liquid en el cuerpo o los encabezados (por ejemplo, correo electrónico, push, SMS, mensajes dentro de la aplicación, tarjetas de contenido y webhooks).
...
## Insertar variables preformateadas y valores predeterminados
...
#### Tutorial: usar variables para calcular un saldo

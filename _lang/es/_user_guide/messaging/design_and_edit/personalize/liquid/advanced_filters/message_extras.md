...
Se genera un `dispatch_id` y se proporciona en tus eventos de envío, que puede usarse como identificador único para vincularlo a eventos específicos de clic, apertura o entrega. Podrás usar y consultar este campo en Currents o Snowflake. Obtén más información sobre el [comportamiento de `dispatch_id`]({{site.baseurl}}/help/help_articles/data/dispatch_id/).

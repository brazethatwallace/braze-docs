...
# Flujo de incorporación {#onboarding-flow}
...
Al crear un mensaje dentro de la aplicación de arrastrar y soltar, selecciona **Onboarding flow** como plantilla y luego selecciona **Build message**. Esta plantilla es compatible tanto con aplicaciones móviles como con navegadores web.
...
### Paso 3: Personaliza el orden de tu flujo de incorporación {#step-3-customize-the-order-of-your-onboarding-flow}

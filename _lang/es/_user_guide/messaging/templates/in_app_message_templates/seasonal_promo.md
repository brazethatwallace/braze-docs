...
# Promoción de temporada con imagen de fondo {#seasonal-promotion-with-background-image}

> Usa el editor de arrastrar y soltar de mensajes dentro de la aplicación para promocionar una oferta o descuento de temporada e impulsar la interacción de los usuarios.

{% multi_lang_include drag_and_drop/templates.md section='SDK requirements' %}

## Creando una promoción de temporada con una imagen de fondo {#creating-a-seasonal-promotion-with-a-background-image}

### Paso 1: Elige tu plantilla {#step-1-choose-your-template}

Al crear un mensaje dentro de la aplicación de arrastrar y soltar, selecciona **Seasonal promotion with background image** como plantilla y luego selecciona **Build message**. Esta plantilla es compatible tanto con aplicaciones móviles como con navegadores web.
...
Para comenzar a crear tu promoción de temporada, selecciona el componente de botón en el editor. Luego, usa el menú lateral para seleccionar a dónde se dirigen los usuarios cuando seleccionan el botón. La configuración predeterminada de la plantilla es cerrar el mensaje, pero puedes elegir navegar a una página específica en tu aplicación (como el producto que estás promocionando).

...
Para duplicar varias plantillas, selecciona la casilla de verificación junto al nombre de la plantilla. Primero, selecciona las plantillas y luego selecciona **Duplicate**.
...
Para archivar una plantilla individual, selecciona <i class="fas fa-ellipsis-v"></i> **More options** en la pantalla de la cuadrícula de plantillas y selecciona **Archive**. Cuando se archiva una plantilla, ten en cuenta los siguientes escenarios:
...
Para archivar varias plantillas, selecciona la casilla de verificación junto a cada plantilla que desees archivar. Después de seleccionar varias plantillas, selecciona **Archive**. Puedes encontrar tus plantillas archivadas seleccionando **Archived** en **Show** en la cuadrícula de plantillas.

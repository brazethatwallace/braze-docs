...
Puedes ver las plantillas de correo electrónico en **Plantillas** > **Plantillas de correo electrónico**, filtrando por estado, tipo, etiquetas, el usuario que la creó, o buscando por nombre de plantilla. Necesitas el permiso **Access Campaigns, Canvases, Cards, Content Blocks, Feature Flags, Segments, Media Library, Locations, Promotion Codes, and Preference Centers** (o el permiso granular equivalente, como **View Email Templates**) para ver estas plantillas. Para más detalles, consulta [Permisos de usuario]({{site.baseurl}}/user_guide/administer/global/user_management/permissions/).
...
1. Selecciona el Content Block o la fila en el cuerpo del correo electrónico en la que deseas comentar.

...
Si tu objetivo es atraer a tus usuarios hacia una nueva característica o versión de la aplicación, utiliza una estrategia multicanal con enfoque en canales dentro de la aplicación. Los [mensajes dentro de la aplicación]({{site.baseurl}}/in-app_messages/) y las [tarjetas de contenido]({{site.baseurl}}/user_guide/channels/content_cards/) son generalmente menos intrusivos si un usuario no desea actualizar de inmediato.

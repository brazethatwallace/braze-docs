...
# Conocimiento de características y nueva versión de la aplicación
...
Los SDK de Braze rastrean automáticamente la versión más reciente de la aplicación de un usuario. Estas versiones se pueden usar en filtros y segmentos para determinar qué usuarios deben recibir un mensaje o campaña.

![El panel de opciones de segmentación en el paso Usuarios objetivo del flujo de trabajo de creación de campañas. La sección Filtros adicionales incluye el siguiente filtro "Most Recent App Version Number for Android Stopwatch (Android) is below 3.7.0 (134.0.0.0)".]({% image_buster /assets/img_archive/new_app_version.png %}){: style="max-width:90%;"}

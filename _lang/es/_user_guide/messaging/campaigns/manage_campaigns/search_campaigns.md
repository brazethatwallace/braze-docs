...
page_order: 10
page_type: reference
description: "Este artículo describe las distintas formas en que puedes buscar campañas en la página de lista de campañas."
tool:
  - Campaigns
...
Hay varias formas de buscar campañas en la página de lista de campañas seleccionando:
...
Puedes usar la barra de búsqueda para introducir palabras clave y frases relacionadas con el nombre de tu campaña. Para hacer una búsqueda exacta, usa comillas ("") alrededor de tu frase de búsqueda. Por ejemplo, para buscar específicamente campañas de prueba de webhook, introduce `"webhook test"` en la barra de búsqueda.
...
- Quién editó la campaña por última vez
- Horario de entrada
- Segmento objetivo
- Equipos
- Campañas con datos de interacción expirados

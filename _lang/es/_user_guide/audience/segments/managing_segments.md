...
El número de actualizaciones a los segmentos realizadas por otros miembros de tu equipo se rastrea mediante la métrica *Changes Since Last Viewed* en la página de resumen del segmento. Selecciona **Changes Since Last Viewed** para ver un registro de cambios de las actualizaciones al nombre, descripción y audiencia objetivo del segmento. Para cada actualización, puedes ver quién realizó la actualización y cuándo. Puedes usar este registro de cambios para auditar los cambios en tu segmento.

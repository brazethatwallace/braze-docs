...
[AGENTCONSOLE_RAWLLMREQUEST_SHARED](#AGENTCONSOLE_RAWLLMREQUEST_SHARED) | Información sin procesar de cada llamada LLM (**solo Snowflake Data Sharing**)
...
[USER_CUSTOM_ATTRIBUTES_VIEW_SHARED](#USER_CUSTOM_ATTRIBUTES_VIEW_SHARED) | Instantánea periódica de los atributos personalizados del perfil por usuario
[USER_DEFAULT_ATTRIBUTES_HISTORY_VIEW_SHARED](#USER_DEFAULT_ATTRIBUTES_HISTORY_VIEW_SHARED) | Atributos predeterminados del perfil históricos con rangos de fechas vigentes
[USER_DEFAULT_ATTRIBUTES_VIEW_SHARED](#USER_DEFAULT_ATTRIBUTES_VIEW_SHARED) | Instantánea periódica de los atributos predeterminados del perfil por usuario
[USER_LATEST_STATE_DEFAULT_ATTRIBUTES_VIEW_SHARED](#USER_LATEST_STATE_DEFAULT_ATTRIBUTES_VIEW_SHARED) | Atributos predeterminados del perfil por usuario en tiempo casi real
[USER_CUSTOM_ATTRIBUTES_HISTORY_VIEW_SHARED](#USER_CUSTOM_ATTRIBUTES_HISTORY_VIEW_SHARED) | Atributos personalizados del perfil históricos con rangos de fechas vigentes (**solo Snowflake Data Sharing**)
[USER_LATEST_STATE_CUSTOM_ATTRIBUTE_VIEW_SHARED](#USER_LATEST_STATE_CUSTOM_ATTRIBUTE_VIEW_SHARED) | Atributos personalizados del perfil por usuario en tiempo casi real (**solo Snowflake Data Sharing**)
[USER_DEFAULT_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED](#USER_DEFAULT_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED) | Atributos predeterminados del perfil históricos sin procesar, sin fecha de fin (**solo Snowflake Data Sharing**)
[USER_CUSTOM_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED](#USER_CUSTOM_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED) | Atributos personalizados del perfil históricos sin procesar, sin fecha de fin (**solo Snowflake Data Sharing**)
[CATALOGS_ITEMS_SHARED](#CATALOGS_ITEMS_SHARED) | Elementos del catálogo que no se han eliminado
...
[USERS_BEHAVIORS_INSTALLATTRIBUTION_SHARED](#USERS_BEHAVIORS_INSTALLATTRIBUTION_SHARED) | Cuando un usuario instala una aplicación y se atribuye a un partner
...
[USERS_BEHAVIORS_GEOFENCE_RECORDEVENT_SHARED](#USERS_BEHAVIORS_GEOFENCE_RECORDEVENT_SHARED) | Cuando un usuario activa un área de geovalla (por ejemplo, cuando entra o sale de una geovalla). Este evento se recibió a través del endpoint dedicado de geovallas y, por lo tanto, se recibe en tiempo real en cuanto el dispositivo del usuario detecta que ha activado una geovalla. <br><br>Además, debido a los límites de velocidad en el endpoint de geovallas, es posible que algunos eventos de geovalla no se reflejen como un RecordEvent. Sin embargo, todos los eventos de geovalla están representados como DataEvent (aunque potencialmente con cierto retraso debido al agrupamiento).
...
[USERS_CAMPAIGNS_CONVERSION_SHARED](#USERS_CAMPAIGNS_CONVERSION_SHARED) | Cuando un usuario convierte en una Campaign
...
[USERS_CAMPAIGNS_FREQUENCYCAP_SHARED](#USERS_CAMPAIGNS_FREQUENCYCAP_SHARED) | Cuando un usuario alcanza el límite de frecuencia en una Campaign
...
[USERS_CANVAS_CONVERSION_SHARED](#USERS_CANVAS_CONVERSION_SHARED) | Cuando un usuario convierte en un evento de conversión de Canvas
...
[USERS_CANVAS_EXPERIMENTSTEP_CONVERSION_SHARED](#USERS_CANVAS_EXPERIMENTSTEP_CONVERSION_SHARED) | Cuando un usuario convierte en un paso de experimento en Canvas
...
[USERS_CANVAS_FREQUENCYCAP_SHARED](#USERS_CANVAS_FREQUENCYCAP_SHARED) | Cuando un usuario alcanza el límite de frecuencia en un paso en Canvas
...
[USERS_CANVAS_COSTEP_CONVERSION_SHARED](#USERS_CANVAS_COSTEP_CONVERSION_SHARED) | Eventos de conversión para el paso de optimización de contenido en Canvas
[USERS_CANVAS_COSTEP_SEND_SHARED](#USERS_CANVAS_COSTEP_SEND_SHARED) | Los envíos del Canvas para el paso de optimización de contenido en Canvas
[USERS_MESSAGES_BANNER_ABORT_SHARED](#USERS_MESSAGES_BANNER_ABORT_SHARED) | Un mensaje de banner programado originalmente fue cancelado por alguna razón
...
[USERS_MESSAGES_CONTENTCARD_ABORT_SHARED](#USERS_MESSAGES_CONTENTCARD_ABORT_SHARED) | Un mensaje de Content Card programado originalmente fue cancelado por alguna razón.
...
[USERS_MESSAGES_EMAIL_ABORT_SHARED](#USERS_MESSAGES_EMAIL_ABORT_SHARED) | Un mensaje de correo electrónico programado originalmente fue cancelado por alguna razón.
...
[USERS_MESSAGES_EMAIL_MARKASSPAM_SHARED](#USERS_MESSAGES_EMAIL_MARKASSPAM_SHARED) | Cuando un correo electrónico es marcado como correo no deseado
...
[USERS_MESSAGES_EMAIL_RETRY_SHARED](#USERS_MESSAGES_EMAIL_RETRY_SHARED) | Cuando un mensaje de correo electrónico se reintenta tras haber sido despriorizado o haber alcanzado el límite de frecuencia (**solo Snowflake Data Sharing**)
...
[USERS_MESSAGES_INAPPMESSAGE_ABORT_SHARED](#USERS_MESSAGES_INAPPMESSAGE_ABORT_SHARED) | Un mensaje dentro de la aplicación programado originalmente fue cancelado por alguna razón.
...
[USERS_MESSAGES_LINE_ABORT_SHARED](#USERS_MESSAGES_LINE_ABORT_SHARED) | Cuando un mensaje de LINE programado no puede entregarse, antes de enviarlo a LINE
...
[USERS_MESSAGES_LINE_RETRY_SHARED](#USERS_MESSAGES_LINE_RETRY_SHARED) | Cuando un mensaje de LINE se reintenta tras haber sido despriorizado o haber alcanzado el límite de frecuencia (**solo Snowflake Data Sharing**)
...
[USERS_MESSAGES_NEWSFEEDCARD_ABORT_SHARED](#USERS_MESSAGES_NEWSFEEDCARD_ABORT_SHARED) | Un mensaje de tarjeta de News Feed programado originalmente fue cancelado por alguna razón
...
[USERS_MESSAGES_PUSHNOTIFICATION_ABORT_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_ABORT_SHARED) | Un mensaje de notificación push programado originalmente fue cancelado por alguna razón.
...
[USERS_MESSAGES_PUSHNOTIFICATION_OPEN_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_OPEN_SHARED) | Cuando un usuario abre una notificación push o hace clic en un botón de notificación push (incluyendo un botón CERRAR que NO abre la aplicación). <br><br> Las acciones de botón push tienen múltiples resultados. Las acciones No, Decline y Cancel son "clics", y las acciones Accept son "aperturas". Ambas se representan en esta tabla, pero se pueden distinguir en la columna **BUTTON_ACTION_TYPE**. Por ejemplo, se puede usar una consulta para agrupar por un `BUTTON_ACTION_TYPE` que no sea No, Decline o Cancel.
...
[USERS_MESSAGES_RCS_SEND_SHARED](#USERS_MESSAGES_RCS_SEND_SHARED) | Cuando un mensaje RCS sale de los sistemas de Braze hacia los partners de entrega de último tramo
[USERS_MESSAGES_SMS_ABORT_SHARED](#USERS_MESSAGES_SMS_ABORT_SHARED) | Un mensaje SMS programado originalmente fue cancelado por alguna razón.
...
[USERS_MESSAGES_SMS_RETRY_SHARED](#USERS_MESSAGES_SMS_RETRY_SHARED) | Cuando un mensaje SMS se reintenta tras haber sido despriorizado o haber alcanzado el límite de frecuencia (**solo Snowflake Data Sharing**)
[USERS_MESSAGES_WEBHOOK_ABORT_SHARED](#USERS_MESSAGES_WEBHOOK_ABORT_SHARED) | Un mensaje de webhook programado originalmente fue cancelado por alguna razón
...
[USERS_MESSAGES_WEBHOOK_RETRY_SHARED](#USERS_MESSAGES_WEBHOOK_RETRY_SHARED) | Cuando un mensaje de webhook se reintenta tras haber sido despriorizado o haber alcanzado el límite de frecuencia (**solo Snowflake Data Sharing**)
[USERS_MESSAGES_WHATSAPP_ABORT_SHARED](#USERS_MESSAGES_WHATSAPP_ABORT_SHARED) | Un mensaje de WhatsApp programado originalmente fue cancelado por alguna razón
...
[USERS_MESSAGES_WHATSAPP_RETRY_SHARED](#USERS_MESSAGES_WHATSAPP_RETRY_SHARED) | Cuando un mensaje de WhatsApp se reintenta tras haber sido despriorizado o haber alcanzado el límite de frecuencia (**solo Snowflake Data Sharing**)
[USERS_MESSAGES_BANNER_DISMISS_SHARED](#USERS_MESSAGES_BANNER_DISMISS_SHARED) | Cuando un usuario descarta un banner.
[USERS_MESSAGES_LANDINGPAGE_CLICK_SHARED](#USERS_MESSAGES_LANDINGPAGE_CLICK_SHARED) | Este evento se produce cuando un usuario final hace clic en elementos seleccionados y campos de formulario en una página de destino
[USERS_MESSAGES_LANDINGPAGE_FORMSUBMISSION_SHARED](#USERS_MESSAGES_LANDINGPAGE_FORMSUBMISSION_SHARED) | Este evento se produce cuando un usuario final completa un formulario en una página de destino y hace clic en el botón para enviar la información
[USERS_MESSAGES_LANDINGPAGE_IMPRESSION_SHARED](#USERS_MESSAGES_LANDINGPAGE_IMPRESSION_SHARED) | Este evento se produce cuando el navegador de un usuario final carga y muestra una página de destino
[USERS_MESSAGES_PUSHNOTIFICATION_RETRY_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_RETRY_SHARED) | Este evento se produce cuando un mensaje es despriorizado o alcanza el límite de frecuencia y se reintentará más tarde dentro de la ventana de reintento configurada. Solo está disponible para clientes beta de priorización de mensajes
[USERS_MESSAGES_SURVEY_RESPONSE_SHARED](#USERS_MESSAGES_SURVEY_RESPONSE_SHARED) | Respuestas de cuestionarios enviadas por usuarios finales
...
[USERS_PROFILE_UPDATE_SHARED](#USERS_PROFILE_UPDATE_SHARED) | Mensaje que representa las actualizaciones de perfil de un usuario
[SNAPSHOTS_APP_SHARED](#SNAPSHOTS_APP_SHARED) | Instantáneas de la aplicación (**solo Snowflake Data Sharing**)
[SNAPSHOTS_CAMPAIGN_MESSAGE_VARIATION_SHARED](#SNAPSHOTS_CAMPAIGN_MESSAGE_VARIATION_SHARED) | Instantáneas de variación de mensaje de Campaign (**solo Snowflake Data Sharing**)
...
[CONTENTOPTIMIZER_COMPONENTSTORE_SHARED](#CONTENTOPTIMIZER_COMPONENTSTORE_SHARED) | Actualizaciones del almacén de componentes
...
`canvas_name` | `string` | Nombre del Canvas
`canvas_variation_name` | `string` | Nombre de la variación de Canvas que recibió este usuario
`canvas_step_name` | `string` | Nombre del paso en Canvas
`error` | `string` | Nombre del error
`thinking_level` | `string` | El nivel de pensamiento/razonamiento utilizado para la solicitud
...
`app_id` | `string` | ID BSON de la aplicación
`update_source` | `string` | Origen de la actualización del perfil
`time` | `int` | Marca de tiempo UNIX en segundos de la actualización del perfil
`archived` | `boolean` | Si el perfil de usuario está archivado
`sf_updated_at` | `timestamp` | Cuándo se actualizó esta fila en Snowflake
`first_name` | `string` | [PII] Nombre
`last_name` | `string` | [PII] Apellido
...
`app_api_id` | `null,`&nbsp;`string` | ID de API de la aplicación en la que ocurrió esta acción
...
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externo del usuario
`app_group_api_id` | `null,`&nbsp;`string` | ID de API del espacio de trabajo al que pertenece este usuario
`app_api_id` | `null,`&nbsp;`string` | ID de API de la aplicación en la que ocurrió la compra
...
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externo del usuario
`app_group_api_id` | `null,`&nbsp;`string` | ID de API del espacio de trabajo al que pertenece este usuario
`app_api_id` | `null,`&nbsp;`string` | ID de API de la aplicación en la que ocurrió esta sesión
...
`os_version` | `null,`&nbsp;`string` | Versión del sistema operativo del dispositivo
`device_model` | `null,`&nbsp;`string` | Modelo del dispositivo
`event_type` | `string` | Tipo de evento de geovalla que se activó (por ejemplo, 'enter' o 'exit')
`location_set_id` | `string` | ID del conjunto de ubicaciones de la geovalla que se activó
`geofence_id` | `string` | ID de la geovalla que se activó
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
...
`device_id` | `null,`&nbsp;`string` | ID del dispositivo en el que ocurrió el evento
`sdk_version` | `null,`&nbsp;`string` | Versión del SDK de Braze en uso durante el evento
`ios_push_token_apns_gateway` | `null, int` | Gateway APN del token de notificaciones push; solo se aplica a tokens push de iOS: 1 para desarrollo, 2 para producción
...
`id` | `string` | ID globalmente único para este evento
`time` | `int` | Marca de tiempo UNIX en la que ocurrió el evento
`time_ms` | `int` | Tiempo en milisegundos en que ocurrió el evento
`user_id` | `string` | ID de usuario de Braze del usuario que realizó este evento
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externo del usuario
`sdk_version` | `null,`&nbsp;`string` | Versión del SDK de Braze en uso durante el evento
`platform` | `null,`&nbsp;`string` | Plataforma del dispositivo
...
`push_token_foreground_push_disabled` | `null, boolean` | Indicador de push en primer plano deshabilitado del token de notificaciones push
`push_token_device_id` | `null,`&nbsp;`string` | ID de dispositivo del token de notificaciones push
`push_token_provisionally_opted_in` | `null, boolean` | Indicador de adhesión provisional del token de notificaciones push
`ios_push_token_apns_gateway` | `null, int` | Gateway APN del token de notificaciones push; solo se aplica a tokens push de iOS: 1 para desarrollo, 2 para producción
`web_push_token_public_key` | `null,`&nbsp;`string` | Clave pública del token de notificaciones push; solo se aplica a tokens push web
`web_push_token_user_auth` | `null,`&nbsp;`string` | Autenticación de usuario del token de notificaciones push; solo se aplica a tokens push web
`web_push_token_vapid_public_key` | `null,`&nbsp;`string` | Clave pública VAPID del token de notificaciones push; solo se aplica a tokens push web
`push_token_state_change_type` | `null,`&nbsp;`string` | Descripción del tipo de cambio de estado del token de notificaciones push
`app_group_api_id` | `null,`&nbsp;`string` | ID de API del grupo de aplicaciones al que pertenece este usuario
`app_api_id` | `null,`&nbsp;`string` | ID de API de la aplicación en la que ocurrió este evento
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
...
`campaign_id` | `null,`&nbsp;`string` | ID interno de Braze de la Campaign a la que pertenece este evento
...
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`channel_identifier` | `null,`&nbsp;`string` | [PII] Identificador del usuario en el canal para el que es el evento
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la Campaign
`message_variation_name` | `string` | Nombre de la variante del mensaje
`canvas_name` | `string` | Nombre del Canvas
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`canvas_step_name` | `string` | Nombre del paso en Canvas
...
`message_variation_name` | `string` | Nombre de la variante del mensaje
`conversion_behavior` | `string` | Cadena codificada en JSON que describe el comportamiento de conversión
...
`timezone` | `null,`&nbsp;`string` | Zona horaria del usuario
`language` | `null,`&nbsp;`string` | [PII] Idioma del usuario
`revenue` | `long` | Cantidad de ingresos en USD en centavos generada
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que Snowpipe recogió este evento
...
| `canvas_variation_api_id`              | `string`,&nbsp;`null`    | ID de API de la variación de Canvas a la que pertenece este evento                                                            |
...
| `is_canvas_entry`                      | `boolean`,&nbsp;`null`   | Si se trata de una entrada al primer paso de un Canvas        |
| `exit_reason`                          | `string`,&nbsp;`null`    | Si se trata de una salida, el motivo por el que el usuario salió del Canvas durante el paso                  |
| `canvas_entry_id`                      | `string`,&nbsp;`null`    | Identificador único de esta instancia de un usuario en un Canvas  |
...
| `sf_created_at`                        | `timestamp`,&nbsp;`null` | Momento en que el evento fue recogido por el Snowpipe                                                                   |
| `canvas_name` | `string` | Nombre del Canvas |
| `canvas_variation_name` | `string` | Nombre de la variación de Canvas que recibió este usuario |
| `canvas_step_name` | `string` | Nombre del paso en Canvas |
...
| `canvas_variation_api_id`              | `string`,&nbsp;`null`    | ID de API de la variación de Canvas a la que pertenece este evento                                                            |
| `canvas_step_api_id`                   | `string`,&nbsp;`null`    | ID de API del paso en Canvas al que pertenece este evento                                                                 |
| `canvas_step_message_variation_api_id` | `string`,&nbsp;`null`    | ID de API de la variación de mensaje del paso en Canvas que recibió este usuario                                                  |
...
| `canvas_variation_name` | `string` | Nombre de la variación de Canvas que recibió este usuario |
| `canvas_step_name` | `string` | Nombre del paso en Canvas |
| `conversion_behavior` | `string` | Cadena con codificación JSON que describe el comportamiento de conversión |
...
| `conversion_behavior_index` | `int`,&nbsp;`null`       | Tipo de evento de conversión que realizó el usuario, donde "0" es una conversión primaria y "1" es una conversión secundaria |
| `sf_created_at`             | `timestamp`,&nbsp;`null` | Momento en que el evento fue recogido por el Snowpipe                                                                   |
| `experiment_split_api_id` | `string`,&nbsp;`null` | ID de API de la división del experimento en la que se inscribió el usuario |
| `canvas_name` | `string` | Nombre del Canvas |
| `canvas_variation_name` | `string` | Nombre de la variación de Canvas que recibió este usuario |
| `canvas_step_name` | `string` | Nombre del paso en Canvas |
| `experiment_split_name` | `string` | Nombre de la división del experimento |
| `conversion_behavior` | `string` | Cadena con codificación JSON que describe el comportamiento de conversión |
...
| `in_control_group`        | `boolean`,&nbsp;`null`   | Verdadero si el usuario fue inscrito en el grupo de control                   |
| `sf_created_at`           | `timestamp`,&nbsp;`null` | Momento en que el evento fue recogido por el Snowpipe                        |
| `experiment_split_api_id` | `string` | ID de API de la división del experimento en la que se inscribió el usuario |
| `canvas_name` | `string` | Nombre del Canvas |
| `canvas_variation_name` | `string` | Nombre de la variación de Canvas que recibió este usuario |
| `canvas_step_name` | `string` | Nombre del paso en Canvas |
| `experiment_split_name` | `string` | Nombre de la división del experimento |
...
| `timezone`                             | `string`,&nbsp;`null`    | Zona horaria del usuario                                                 |
| `language`                             | `string`,&nbsp;`null`    | [PII] Idioma del usuario                                           |
| `revenue`                              | `int`,&nbsp;`null`       | Cantidad de ingresos generados en USD, expresados en centavos               |
| `sf_created_at`                        | `timestamp`,&nbsp;`null` | Momento en que el evento fue recogido por el Snowpipe                        |
| `app_api_id` | `string`,&nbsp;`null` | ID de API de la aplicación en la que ocurrió este evento |
...
Campo | Tipo | Descripción
------|------|------------
`app_group_api_id` | `string` | ID de API del grupo de aplicaciones al que pertenece este usuario
`app_group_id` | `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`external_user_id` | `string` | [PII] ID externo del usuario
`id` | `string` | ID único global de este evento
`time` | `int` | Marca de tiempo UNIX en la que ocurrió el evento
`user_id` | `string` | [PII] ID de usuario de Braze del usuario que realizó este evento
`dispatch_id` | `string` | ID del envío al que pertenece este mensaje
`channel` | `string` | Canal al que pertenece este evento
`conversion_type` | `string` | El tipo de conversión (apertura o clic)
`combination_token` | `string` | Combinación de componentes asignada
`sf_created_at` | `timestamp` | Momento en que el evento fue recogido por el Snowpipe
...
`dispatch_id` | `string` | ID del envío al que pertenece este mensaje
`channel` | `string` | Canal al que pertenece este evento
`canvas_id` | `string` | ID BSON del Canvas al que pertenece este evento
`canvas_variation_api_id` | `string` | ID de API de la variación de Canvas a la que pertenece este evento
`content_optimizer_step_id` | `string` | ID interno del paso de CO
`combination_token` | `string` | Combinación de componentes asignada
`sf_created_at` | `timestamp` | Momento en que el evento fue recogido por el Snowpipe
...
`ad_tracking_enabled` | `null, boolean` | Si el seguimiento de publicidad está habilitado en el dispositivo
`abort_type` | `null,`&nbsp;`string` | Tipo de cancelación. Para ver la lista de valores, consulta [Tipos de cancelación](#abort-types).
...
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la Campaign
`message_variation_name` | `string` | Nombre de la variante de mensaje
`canvas_id` | `string` | ID BSON del Canvas al que pertenece este evento
`canvas_name` | `string` | Nombre del Canvas
`canvas_step_name` | `string` | Nombre del paso en Canvas
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`canvas_api_id` | `string` | ID de API del Canvas al que pertenece este evento
`canvas_step_api_id` | `string` | ID de API del paso en Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `string` | ID de API de la variante de mensaje del paso en Canvas que recibió este usuario
`canvas_variation_api_id` | `string` | ID de API de la variante de Canvas a la que pertenece este evento
...
`canvas_variation_api_id` | `string` | ID de API de la variante de Canvas a la que pertenece este evento
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`is_unique` | `boolean` | Si este evento se consideró único en 7 días cuando fue procesado
...
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante de Canvas a la que pertenece este evento
`canvas_step_api_id` | `null,`&nbsp;`string` | ID de API del paso en Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante de mensaje del paso en Canvas que recibió este usuario
`gender` | `null,`&nbsp;`string` | [PII] Género del usuario
`country` | `null,`&nbsp;`string` | [PII] País del usuario
`timezone` | `null,`&nbsp;`string` | Zona horaria del usuario
`language` | `null,`&nbsp;`string` | [PII] Idioma del usuario
...
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`canvas_step_name` | `string` | Nombre del paso en Canvas
`message_extras` | `string` | [PII] Cadena JSON de los pares clave-valor etiquetados durante el renderizado de Liquid
...
`user_id` | `string` | ID de Braze del usuario que realizó este evento
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externo del usuario
`device_id` | `null,`&nbsp;`string` | `device_id` vinculado a este usuario si es anónimo
`app_group_api_id` | `null,`&nbsp;`string` | ID de API del espacio de trabajo al que pertenece este usuario
`time` | `int` | Marca de tiempo Unix en la que ocurrió el evento
`dispatch_id` | `null,`&nbsp;`string` | ID del envío al que pertenece este mensaje
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
...
`user_agent` | `null,`&nbsp;`string` | Agente de usuario en el que se produjo el clic
`ip_pool` | `null,`&nbsp;`string` | Pool de IP desde el que se realizó el envío de correo electrónico
...
`esp` | `null,`&nbsp;`string` | ESP relacionado con el evento (SparkPost, SendGrid o Amazon SES)
`from_domain` | `null,`&nbsp;`string` | Dominio de envío del correo electrónico
`is_amp` | `null, boolean` | Indica que se trata de un evento de páginas móviles aceleradas
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`is_suspected_bot_click` | `null, boolean` | Si este evento se procesó como un evento de bot
`suspected_bot_click_reason` | `null, object` | Por qué este evento se clasificó como bot
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue captado por Snowpipe
`campaign_name` | `string` | Nombre de la Campaign
`message_variation_name` | `string` | Nombre de la variante del mensaje
`canvas_name` | `string` | Nombre del Canvas
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`canvas_step_name` | `string` | Nombre del paso en Canvas
`send_time` | `int` | Hora del evento de envío correspondiente
`has_url_parameters` | `boolean` | Si la URL clicada contenía parámetros de consulta
`link_aliasing_enabled` | `boolean` | Si el aliasing de enlaces estaba habilitado para el espacio de trabajo cuando se procesó este clic
...
`sending_ip` | `null,`&nbsp;`string` | Dirección IP desde la que se realizó el envío de correo electrónico
`timezone` | `null,`&nbsp;`string` | Zona horaria del usuario
`deferral_reason` | `null,`&nbsp;`string` | [PII] El código de razón SMTP y el mensaje descriptivo recibidos para este evento de aplazamiento
...
`ip_pool` | `null,`&nbsp;`string` | Pool de IP desde el que se realizó el envío de correo electrónico
`machine_open` | `null,`&nbsp;`string` | Se rellena con 'true' si el evento de apertura se activa sin interacción del usuario, por ejemplo, por un dispositivo Apple con la protección de la privacidad en los correos electrónicos habilitada. El valor puede cambiar con el tiempo para ofrecer mayor granularidad.
`esp` | `null,`&nbsp;`string` | ESP relacionado con el evento (SparkPost, SendGrid o Amazon SES)
`from_domain` | `null,`&nbsp;`string` | Dominio de envío del correo electrónico
`is_amp` | `null, boolean` | Indica que se trata de un evento de páginas móviles aceleradas
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
...
`sending_ip` | `null,`&nbsp;`string` | Dirección IP desde la que se realizó el envío de correo electrónico
`ip_pool` | `null,`&nbsp;`string` | Pool de IP desde el que se realizó el envío de correo electrónico
`bounce_reason` | `null,`&nbsp;`string` | [PII] El código de razón SMTP y el mensaje descriptivo recibidos para este evento de rebote
`esp` | `null,`&nbsp;`string` | ESP relacionado con el evento (SparkPost, SendGrid o Amazon SES)
`from_domain` | `null,`&nbsp;`string` | Dominio de envío del correo electrónico
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue captado por Snowpipe
...
Este evento ocurre cuando un mensaje es despriorizado o limitado por frecuencia y se reintenta más tarde dentro de la ventana de reintentos configurada.
...
`retry_log` | `null,`&nbsp;`string` | Mensaje del registro que describe los detalles del reintento
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
`dispatch_id` | `null,`&nbsp;`string` | ID del envío al que pertenece este mensaje
`campaign_id` | `null,`&nbsp;`string` | ID BSON de la Campaign a la que pertenece este evento
`campaign_api_id` | `null,`&nbsp;`string` | ID de API de la Campaign a la que pertenece este evento
...
`time` | `int` | Marca de tiempo UNIX en la que ocurrió el evento
`gender` | `null,`&nbsp;`string` | [PII] Género del usuario
`browser` | `null,`&nbsp;`string` | Navegador del dispositivo, extraído del agente de usuario, en el que se produjo la apertura
`carrier` | `null,`&nbsp;`string` | Operador del dispositivo
`country` | `null,`&nbsp;`string` | [PII] País del usuario
`device_model` | `null,`&nbsp;`string` | Modelo del dispositivo
`language` | `null,`&nbsp;`string` | [PII] Idioma del usuario
...
`carrier` | `null,`&nbsp;`string` | Operador del dispositivo
`browser` | `null,`&nbsp;`string` | Navegador del dispositivo
`version` | `string` | Versión del mensaje dentro de la aplicación, heredado o activado
`ad_id` | `null,`&nbsp;`string` | [PII] Identificador de publicidad
`ad_id_type` | `null,`&nbsp;`string` | Uno de `ios_idfa`, `google_ad_id`, `windows_ad_id` o `roku_ad_id`
`ad_tracking_enabled` | `null, boolean` | Si el seguimiento de publicidad está habilitado para el dispositivo
`abort_type` | `null,`&nbsp;`string` | Tipo de cancelación. Para obtener una lista de valores, consulta [Tipos de cancelación](#abort-types).
`abort_log` | `null,`&nbsp;`string` | [PII] Mensaje del registro que describe los detalles de la cancelación (máximo 2000 caracteres)
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue captado por Snowpipe
`campaign_name` | `string` | Nombre de la Campaign
`message_variation_name` | `string` | Nombre de la variante del mensaje
...
`browser` | `null,`&nbsp;`string` | Navegador del dispositivo
`version` | `string` | Versión del mensaje dentro de la aplicación, heredado o activado
`button_id` | `null,`&nbsp;`string` | ID del botón clicado, si este clic representa un clic en un botón
`ad_id` | `null,`&nbsp;`string` | [PII] Identificador de publicidad
`ad_id_type` | `null,`&nbsp;`string` | Uno de `ios_idfa`, `google_ad_id`, `windows_ad_id` o `roku_ad_id`
`ad_tracking_enabled` | `null, boolean` | Si el seguimiento de publicidad está habilitado para el dispositivo
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
...
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`message_extras` | `null,`&nbsp;`string` | [PII] Una cadena JSON de los pares clave-valor etiquetados durante el renderizado de Liquid
`locale_key` | `null,`&nbsp;`string` | [PII] La clave correspondiente a las traducciones (por ejemplo, 'en-us') utilizada para redactar este mensaje (nulo para el predeterminado).
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue captado por Snowpipe
`dispatch_id` | `string` | ID del envío al que pertenece este mensaje
`campaign_name` | `string` | Nombre de la Campaign
`message_variation_name` | `string` | Nombre de la variante del mensaje
...
`time` | `int` | Marca de tiempo UNIX en la que ocurrió el evento
`user_id` | `string` | ID de Braze del usuario que realizó este evento
`abort_log` | `null,`&nbsp;`string` | [PII] Mensaje del registro que describe los detalles de la cancelación (hasta 128 caracteres)
`abort_type` | `null,`&nbsp;`string` | Tipo de cancelación. Para obtener una lista de valores, consulta [Tipos de cancelación](#abort-types).
`campaign_api_id` | `null,`&nbsp;`string` | ID de API de la Campaign a la que pertenece este evento
`canvas_step_api_id` | `null,`&nbsp;`string` | ID de API del paso en Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del mensaje del paso en Canvas que recibió este usuario
`device_id` | `null,`&nbsp;`string` | ID del dispositivo en el que ocurrió el evento
`dispatch_id` | `null,`&nbsp;`string` | ID del envío al que pertenece este mensaje
`line_channel_id` | `null,`&nbsp;`string` | ID del canal LINE al que se envió o desde el que se recibió el mensaje
`line_channel_name` | `null,`&nbsp;`string` | Nombre del canal LINE al que se envió o desde el que se recibió el mensaje
`message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del mensaje que recibió este usuario
`native_line_id` | `null,`&nbsp;`string` | [PII] ID de LINE del usuario desde el que se envió o recibió el mensaje
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
`subscription_group_api_id` | `string` | ID de API del grupo de suscripción
`timezone` | `null,`&nbsp;`string` | Zona horaria del usuario
`campaign_name` | `null,`&nbsp;`string` | Nombre de la Campaign
`canvas_step_name` | `null,`&nbsp;`string` | Nombre del paso en Canvas
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante de Canvas a la que pertenece este evento
`canvas_api_id` | `null,`&nbsp;`string` | ID de API del Canvas al que pertenece este evento
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue captado por Snowpipe
`message_extras` | `string` | [PII] Una cadena JSON de los pares clave-valor etiquetados durante el renderizado de Liquid
...
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
`is_suspected_bot_click` | `null, boolean` | Si este evento se procesó como un evento de bot
`short_url` | `null,`&nbsp;`string` | URL acortada que se clicó
`url` | `null,`&nbsp;`string` | URL en la que el usuario hizo clic
`user_agent` | `null,`&nbsp;`string` | Agente de usuario en el que se produjo el informe de correo no deseado
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue captado por Snowpipe
...
`line_channel_id` | `null,`&nbsp;`string` | ID del canal LINE al que se envió o desde el que se recibió el mensaje
`line_channel_name` | `null,`&nbsp;`string` | Nombre del canal LINE al que se envió o desde el que se recibió el mensaje
`media_id` | `null,`&nbsp;`string` | ID generado por LINE que puede usarse para recuperar multimedia entrante de LINE
...
Este evento ocurre cuando un mensaje se desprioriza o se limita por frecuencia y se reintenta más tarde dentro de la ventana de reintento configurada.
...
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante de mensaje del paso en Canvas que recibió este usuario
`device_id` | `null,`&nbsp;`string` | ID del dispositivo en el que ocurrió el evento
`line_channel_id` | `null,`&nbsp;`string` | ID del canal de LINE al que se envió o del que se recibió el mensaje
`line_channel_name` | `null,`&nbsp;`string` | Nombre del canal de LINE al que se envió o del que se recibió el mensaje
`native_line_id` | `null,`&nbsp;`string` | [PII] ID de LINE del usuario desde el que se envió o recibió el mensaje
...
`dispatch_id` | `null,`&nbsp;`string` | ID del despacho al que pertenece este mensaje
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
`campaign_id` | `null,`&nbsp;`string` | ID de Braze de uso interno de la Campaign a la que pertenece este evento
`campaign_api_id` | `null,`&nbsp;`string` | ID de API de la Campaign a la que pertenece este evento
`message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del mensaje que recibió este usuario
...
`ad_tracking_enabled` | `null, boolean` | Si el seguimiento está habilitado o no para publicidad
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante de mensaje
...
`carrier` | `null,`&nbsp;`string` | Operador del dispositivo
`browser` | `null,`&nbsp;`string` | Navegador del dispositivo
`button_string` | `null,`&nbsp;`string` | Identificador (button_string) del botón de la notificación push que se pulsó. null si no se originó a partir de un clic en un botón
`button_action_type` | `null,`&nbsp;`string` | Tipo de acción del botón de la notificación push. Uno de [URI, DEEP_LINK, NONE, CLOSE]. null si no se originó a partir de un clic en un botón
...
`user_id` | `string` | ID de Braze del usuario que realizó este evento
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externo del usuario
`push_token` | `null,`&nbsp;`string` | Token push al que se intentó realizar la entrega
`device_id` | `null,`&nbsp;`string` | `device_id` al que se intentó realizar la entrega
`app_group_api_id` | `null,`&nbsp;`string` | ID de API del espacio de trabajo al que pertenece este usuario
`time` | `int` | Marca de tiempo Unix en la que ocurrió el evento
`app_api_id` | `null,`&nbsp;`string` | ID de API de la aplicación en la que ocurrió este evento
...
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`canvas_api_id` | `string` | ID de API del Canvas al que pertenece este evento
`message_extras` | `string` | [PII] Cadena JSON de los pares clave-valor etiquetados durante el renderizado Liquid
...
`message_variation_name` | `null,`&nbsp;`string` | Nombre de la variante de mensaje
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
`short_url` | `null,`&nbsp;`string` | URL acortada que fue clicada
...
`canvas_step_api_id` | `null,`&nbsp;`string` | ID de API del paso en Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante de mensaje del paso en Canvas que recibió este usuario
`interaction_type` | `null,`&nbsp;`string` | El tipo de interacción que generó el clic. Valores de cadena de ejemplo: Text URL, Reply, OpenURL
`element_label` | `null,`&nbsp;`string` | Detalles opcionales sobre el elemento clicado, como el texto de una respuesta sugerida o un botón
`element_type` | `null,`&nbsp;`string` | Especifica si un interaction_type que es común entre sugerencias y botones provino de una sugerencia o un botón. Ejemplos: Suggestion, Button
`campaign_api_id` | `null,`&nbsp;`string` | ID de API de la campaña a la que pertenece este evento
`url` | `null,`&nbsp;`string` | URL en la que el usuario hizo clic
`subscription_group_api_id` | `string` | ID de API del grupo de suscripción
`canvas_variation_name` | `null,`&nbsp;`string` | Nombre de la variante de Canvas que recibió este usuario
...
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante de mensaje del paso en Canvas que recibió este usuario
`campaign_api_id` | `null,`&nbsp;`string` | ID de API de la campaña a la que pertenece este evento
`from_rcs_sender` | `null,`&nbsp;`string` | El ID de remitente RCS o nombre del agente utilizado para enviar el mensaje
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`canvas_api_id` | `string` | ID de API del Canvas al que pertenece este evento
...
`canvas_step_name` | `null,`&nbsp;`string` | Nombre del paso en Canvas
`canvas_variation_name` | `null,`&nbsp;`string` | Nombre de la variante de Canvas que recibió este usuario
`category` | `null,`&nbsp;`string` | Nombre de la categoría de palabras clave, solo se rellena para mensajes de respuesta automática: 'opt-in', 'opt-out', 'help' o un valor personalizado
`device_id` | `null,`&nbsp;`string` | ID del dispositivo en el que ocurrió el evento
`dispatch_id` | `null,`&nbsp;`string` | ID del envío al que pertenece este mensaje
`from_rcs_sender` | `null,`&nbsp;`string` | El ID de remitente RCS o nombre del agente utilizado para enviar el mensaje
`message_extras` | `null,`&nbsp;`string` | Cadena JSON de los pares clave-valor etiquetados durante el renderizado Liquid
`message_variation_name` | `null,`&nbsp;`string` | Nombre de la variante de mensaje
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
`subscription_group_api_id` | `string` | ID de API del grupo de suscripción
`to_phone_number` | `null,`&nbsp;`string` | [PII] Número de teléfono del usuario que recibe el mensaje en formato e.164 (por ejemplo, +14155552671)
...
`time` | `int` | Marca de tiempo UNIX en la que ocurrió el evento
`user_id` | `string` | [PII] ID de usuario de Braze del usuario que realizó este evento
`app_api_id` | `string` | ID de API de la aplicación en la que ocurrió este evento
`campaign_id` | `string` | ID BSON de la campaña a la que pertenece este evento
`campaign_api_id` | `string` | ID de API de la campaña a la que pertenece este evento
`message_variation_api_id` | `string` | ID de API de la variante de mensaje que recibió este usuario
`gender` | `string` | [PII] Género del usuario
`country` | `string` | [PII] País del usuario
`TIME_ZONE` | `string` | Zona horaria del usuario
`language` | `string` | [PII] Idioma del usuario
`device_id` | `string` | ID del dispositivo en el que ocurrió el evento
`sdk_version` | `string` | Versión del SDK de Braze en uso durante el evento
`platform` | `string` | Plataforma del dispositivo
`os_version` | `string` | Versión del sistema operativo del dispositivo
`device_model` | `string` | Modelo del dispositivo
`resolution` | `string` | Resolución del dispositivo
`carrier` | `string` | Operador del dispositivo
`browser` | `string` | Navegador del dispositivo, extraído del user_agent, en el que ocurrió la apertura
`button_id` | `string` | ID del botón clicado, si este clic representa un clic en un botón
`ad_id_type` | `string` | Uno de ['ios_idfa', 'google_ad_id', 'windows_ad_id', 'roku_ad_id']
`ad_tracking_enabled` | `boolean` | Si el seguimiento de publicidad está habilitado para el dispositivo
`banner_placement_id` | `string` | ID de ubicación de banner especificado por el cliente
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante de mensaje
`canvas_api_id` | `string` | ID de API del Canvas al que pertenece este evento
`canvas_step_api_id` | `string` | ID de API del paso en Canvas al que pertenece este evento
...
`canvas_variation_api_id` | `string` | ID de API de la variante de Canvas a la que pertenece este evento
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`ad_id` | `string` | [PII] Identificador de publicidad
`is_unique` | `boolean` | Si este evento fue considerado único en 7 días cuando fue procesado
`sf_created_at` | `timestamp` | Momento en que este evento fue recogido por Snowpipe
...
`time` | `int` | Marca de tiempo UNIX en la que ocurrió el evento
`user_id` | `string` | [PII] ID de usuario de Braze del usuario que realizó este evento
`target` | `string` | ID de seguimiento configurado para el elemento que fue clicado
`landing_page_api_id` | `string` | ID de API de la página de destino a la que pertenece este evento
`landing_page_name` | `string` | Nombre de la página de destino
`sf_created_at` | `timestamp` | Momento en que este evento fue recogido por Snowpipe
...
`user_id` | `string` | [PII] ID de usuario de Braze del usuario que realizó este evento
`landing_page_api_id` | `string` | ID de API de la página de destino a la que pertenece este evento
`liquid_enabled` | `boolean` | Un booleano que indica si la página de destino contiene Liquid y fue procesada a través del pipeline de renderizado Liquid.
`landing_page_name` | `string` | Nombre de la página de destino
`sf_created_at` | `timestamp` | Momento en que este evento fue recogido por Snowpipe
...
`app_api_id` | `string` | ID de API de la aplicación en la que ocurrió este evento
`dispatch_id` | `string` | ID del envío al que pertenece este mensaje
`send_id` | `string` | ID de envío del mensaje al que pertenece este mensaje
`campaign_id` | `string` | ID BSON de la campaña a la que pertenece este evento
`campaign_api_id` | `string` | ID de API de la campaña a la que pertenece este evento
`message_variation_api_id` | `string` | ID de API de la variante de mensaje que recibió este usuario
`canvas_id` | `string` | ID BSON del Canvas al que pertenece este evento
...
`language` | `string` | [PII] Idioma del usuario
`platform` | `string` | Plataforma del dispositivo
`retry_type` | `string` | Tipo de reintento
`retry_log` | `string` | Mensaje de registro que describe los detalles del reintento
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante de mensaje
`canvas_name` | `string` | Nombre del Canvas
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
...
`time` | `int` | Marca de tiempo UNIX en la que ocurrió el evento
`user_id` | `string` | [PII] ID de usuario de Braze del usuario que realizó este evento
`survey_id` | `string` | UUID del cuestionario al que pertenece esta respuesta.
`question_id` | `string` | UUID de la pregunta a la que pertenece esta respuesta.
`message_extras` | `string` | [PII] Cadena JSON de los pares clave-valor etiquetados durante el renderizado Liquid
`gender` | `string` | [PII] Género del usuario
`country` | `string` | [PII] País del usuario
`TIME_ZONE` | `string` | Zona horaria del usuario
`device_id` | `string` | [PII] ID del dispositivo en el que ocurrió el evento
`sdk_version` | `string` | Versión del SDK de Braze en uso durante el evento
`platform` | `string` | Plataforma del dispositivo
`os_version` | `string` | Versión del sistema operativo del dispositivo
`device_model` | `string` | Modelo del dispositivo
...
`ad_id_type` | `string` | Uno de ['ios_idfa', 'google_ad_id', 'windows_ad_id', 'roku_ad_id']
`ad_tracking_enabled` | `boolean` | Si el seguimiento de publicidad está habilitado para el dispositivo
`answer_single_string` | `string` | [PII] La respuesta sin procesar cuando response_type es single_string
`answer_single_boolean` | `boolean` | [PII] La respuesta sin procesar cuando response_type es single_boolean
`answer_type` | `string` | Tipo de respuesta del evento, uno de ['single_int', 'single_string', 'single_boolean']
`answer_long_string` | `string` | [PII] La respuesta sin procesar cuando response_type es free_form_text
`survey_session_id` | `string` | Identificador único para agrupar todas las respuestas de una misma sesión de cuestionario
`landing_page_api_id` | `string` | ID de API de la página de destino a la que pertenece este evento
`campaign_api_id` | `string` | ID de API de la campaña a la que pertenece este evento
`message_variation_api_id` | `string` | ID de API de la variante de mensaje que recibió este usuario
`canvas_api_id` | `string` | ID de API del Canvas al que pertenece este evento
...
`canvas_step_api_id` | `string` | ID de API del paso en Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `string` | ID de API de la variante de mensaje del paso en Canvas que recibió este usuario
`answer_multiple_strings` | `string` | [PII] La respuesta sin procesar cuando answer_type es multiple_string.
`survey_completion_status` | `string` | Uno de ['completed', 'incomplete']
`response_id` | `string` | Identificador único que representa la respuesta
`campaign_name` | `string` | Nombre de la campaña
`canvas_name` | `string` | Nombre del Canvas
`canvas_step_name` | `string` | Nombre del paso en Canvas
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`message_variation_name` | `string` | Nombre de la variante de mensaje
`app_api_id` | `string` | ID de API de la aplicación en la que ocurrió este evento
`question_reporting_id` | `string` | El identificador de informes para la pregunta del cuestionario
`landing_page_name` | `string` | Nombre de la página de destino
`answer_single_number` | `float` | [PII] La respuesta sin procesar cuando answer_type es single_number
`sf_created_at` | `timestamp` | Momento en que este evento fue recogido por Snowpipe
...
{% alert note %}
Para las tablas compartidas `USERS_MESSAGES_SMS_*` (incluyendo [`USERS_MESSAGES_SMS_REJECTION_SHARED`](#USERS_MESSAGES_SMS_REJECTION_SHARED), [`USERS_MESSAGES_SMS_DELIVERY_SHARED`](#USERS_MESSAGES_SMS_DELIVERY_SHARED) y [`USERS_MESSAGES_SMS_DELIVERYFAILURE_SHARED`](#USERS_MESSAGES_SMS_DELIVERYFAILURE_SHARED)), Braze escribe una fila solo cuando el perfil de usuario de Braze aún existe en el espacio de trabajo en el momento en que se procesa el evento para Snowflake Data Sharing y Currents. Si ese usuario fue eliminado antes de que se complete el procesamiento, el evento no aparece en Snowflake ni en tu exportación de Currents, incluso cuando las métricas de SMS del espacio de trabajo en el panel aún reflejan los conteos agregados de la ruta de informes de Braze. Para el comportamiento correspondiente de Currents, consulta [Eventos de rechazo de SMS]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events#sms-rejection-events) y los tipos de eventos de SMS relacionados en el mismo glosario.
{% endalert %}
...
`abort_type` | `null,`&nbsp;`string` | Tipo de cancelación. Para obtener una lista de valores, consulta [Tipos de cancelación](#abort-types).
`abort_log` | `null,`&nbsp;`string` | [PII] Mensaje del registro que describe los detalles de la cancelación (máximo de 2.000 caracteres)
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante del mensaje
`canvas_name` | `string` | Nombre del Canvas
`canvas_variation_name` | `string` | Nombre de la variante del Canvas que recibió este usuario
`canvas_step_name` | `string` | Nombre del paso en Canvas
`message_extras` | `string` | [PII] Cadena JSON de los pares clave-valor etiquetados durante la representación de Liquid
...
`subscription_group_api_id` | `null,`&nbsp;`string` | ID externo del grupo de suscripción
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`is_sms_fallback` | `null, boolean` | Indica si se intentó un respaldo SMS para este mensaje RCS rechazado. Está vinculado/emparejado con el evento de entrega de SMS
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante del mensaje
`canvas_name` | `string` | Nombre del Canvas
...
`subscription_group_api_id` | `null,`&nbsp;`string` | ID externo del grupo de suscripción
`error` | `null,`&nbsp;`string` | Nombre del error
`provider_error_code` | `null,`&nbsp;`string` | Código de error del proveedor del servicio SMS
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`is_sms_fallback` | `null, boolean` | Indica si se intentó un respaldo SMS para este mensaje RCS rechazado. Está vinculado/emparejado con el evento de entrega de SMS
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la campaña
...
`subscription_group_id` | `null,`&nbsp;`string` | ID del grupo de suscripción al que se dirige este mensaje SMS
`subscription_group_api_id` | `null,`&nbsp;`string` | ID de API del grupo de suscripción al que se dirige este mensaje SMS
...
`campaign_id` | `null,`&nbsp;`string` | ID de Braze de uso interno de la campaña a la que pertenece este evento
`campaign_api_id` | `null,`&nbsp;`string` | ID de API de la campaña a la que pertenece este evento
`message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del mensaje al que pertenece este evento
`canvas_id` | `null,`&nbsp;`string` | ID de Braze de uso interno del Canvas al que pertenece este evento
`canvas_api_id` | `null,`&nbsp;`string` | ID de API del Canvas al que pertenece este evento
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del Canvas al que pertenece este evento
`canvas_step_api_id` | `null,`&nbsp;`string` | ID de API del paso en Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del mensaje del paso en Canvas al que pertenece este evento
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante del mensaje
...
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`message_extras` | `null,`&nbsp;`string` | [PII] Cadena JSON de los pares clave-valor etiquetados durante la representación de Liquid
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante del mensaje
`canvas_name` | `string` | Nombre del Canvas
...
------|------|------------
`id` | `string` | ID único global de este evento
`user_id` | `null,`&nbsp;`string` | ID de Braze del usuario al que se dirige short_url, nulo si short_url no utilizó seguimiento de clics de usuario
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externo del usuario al que se dirige short_url si existe, nulo si short_url no utilizó seguimiento de clics de usuario
...
`timezone` | `null,`&nbsp;`string` | Zona horaria del usuario
`campaign_id` | `null,`&nbsp;`string` | ID de Braze de la campaña para la que se generó short_url, nulo si no proviene de una campaña
`campaign_api_id` | `null,`&nbsp;`string` | ID de API de la campaña para la que se generó short_url, nulo si no proviene de una campaña
`message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del mensaje para la que se generó short_url, nulo si no proviene de una campaña
`canvas_id` | `null,`&nbsp;`string` | ID de Braze del Canvas para el que se generó short_url, nulo si no proviene de un Canvas
`canvas_api_id` | `null,`&nbsp;`string` | ID de API del Canvas para el que se generó short_url, nulo si no proviene de un Canvas
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del Canvas para la que se generó short_url, nulo si no proviene de un Canvas
`canvas_step_api_id` | `null,`&nbsp;`string` | ID de API del paso en Canvas para el que se generó short_url, nulo si no proviene de un Canvas
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID de API de la variante del mensaje del paso en Canvas para la que se generó short_url, nulo si no proviene de un Canvas
...
`app_group_id` | `null,`&nbsp;`string` | ID BSON del grupo de aplicaciones al que pertenece este usuario
`is_suspected_bot_click` | `null, boolean` | Si este evento fue procesado como un evento de bot
`suspected_bot_click_reason` | `null, object` | Razón por la que este evento fue clasificado como bot
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`campaign_name` | `string` | Nombre de la campaña
`message_variation_name` | `string` | Nombre de la variante del mensaje
`canvas_name` | `string` | Nombre del Canvas
...
`canvas_name` | `null,`&nbsp;`string` | Nombre del Canvas
`canvas_variation_name` | `null,`&nbsp;`string` | Nombre de la variante del Canvas que recibió este usuario
`canvas_step_name` | `null,`&nbsp;`string` | Nombre del paso en Canvas
`gender` | `null,`&nbsp;`string` | [PII] Género del usuario
`country` | `null,`&nbsp;`string` | [PII] País del usuario
`timezone` | `null,`&nbsp;`string` | Zona horaria del usuario
...
`canvas_variation_name` | `string` | Nombre de la variante de Canvas que recibió este usuario
`canvas_step_name` | `string` | Nombre del paso en Canvas
`bsuid` | `string` | El ID de usuario con ámbito de negocio de WhatsApp del usuario del que se recibió el mensaje.
`message_extras` | `string` | [PII] Una cadena JSON de los pares clave-valor etiquetados durante el renderizado de Liquid
...
`sf_created_at` | `timestamp`,&nbsp;`null` | Momento en que este evento fue recogido por Snowpipe
`send_id` | `null,`&nbsp;`string` | ID de envío del mensaje al que pertenece este mensaje
`flow_id` | `null,`&nbsp;`string` | El ID único del Flow en WhatsApp Manager. Presente si el usuario está respondiendo a un WhatsApp Flow.
...
`user_id` | `string` | [PII] ID de usuario de Braze del usuario que realizó este evento
`app_api_id` | `string` | ID de API de la aplicación en la que ocurrió este evento
`update_source` | `string` | Origen de esta actualización
`archived` | `boolean` | Cuando se establece como True, indica que este usuario fue archivado en Braze
`first_name` | `string` | [PII] Nombre del usuario
`last_name` | `string` | [PII] Apellido del usuario
`email_address` | `string` | [PII] Dirección de correo electrónico del usuario
`gender` | `string` | [PII] Género del usuario
`phone_number` | `string` | [PII] Número de teléfono del usuario en formato e.164 (por ejemplo +14155552671)
`dob` | `string` | [PII] Fecha de nacimiento del usuario en formato "AAAA-MM-DD"
`TIME_ZONE` | `string` | Zona horaria del usuario
`home_city` | `string` | [PII] Ciudad de residencia del usuario
`country` | `string` | [PII] País del usuario
`language` | `string` | [PII] Idioma del usuario
`custom_attributes` | `string` | Cadena JSON válida de los atributos personalizados actualizados
`sf_created_at` | `timestamp` | Momento en que este evento fue recogido por el Snowpipe
...
`content_optimizer_step_id` | `string` | ID interno del paso de CO
`combination_token` | `string` | Combinación de componentes asignada
`content` | `string` | Carga útil del contenido renderizado en formato JSON
`is_active` | `boolean` | Si el token de combinación se usa activamente para la entrega
`sf_created_at` | `timestamp` | Momento en que este evento fue recogido por Snowpipe

...
- Los centros de preferencias de arrastrar y soltar no se pueden eliminar desde el panel. Para quitar uno, primero elimina su etiqueta de Liquid de cualquier campaña de correo electrónico o paso en Canvas, y luego ponte en contacto con [soporte de Braze]({{site.baseurl}}/support_contact).

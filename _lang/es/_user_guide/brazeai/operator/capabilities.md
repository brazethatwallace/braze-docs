...
| --- | --- | --- |
| AI Copywriter | Generaba textos de marketing a partir de un nombre o descripción de producto | Un nuevo icono **Ask Operator** en los compositores de SMS, push, correo electrónico HTML y Canvas |
| AI Liquid Assistant | Generaba Liquid para personalización | Un nuevo icono **Ask Operator** en los compositores de SMS, push, correo electrónico HTML y Canvas |

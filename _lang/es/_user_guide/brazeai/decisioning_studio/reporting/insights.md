...
# Informe de información {#insights-report}

> La sección de información te muestra cómo se generan las distintas opciones de recomendación en tu banco de acciones, como la selección de bloques. Hay dos informes de información diferentes: **Agent preferences** y **SHAPs**.

{% tabs local %}
{% tab agent preferences %}
El informe **Agent preferences** te ayuda a identificar tendencias estacionales y evaluar la relevancia de las opciones en el banco de acciones, orientando decisiones informadas para actualizaciones.
...
| Campo | Descripción |
|-------|-------------|
| Dimensión | El atributo utilizado para organizar los resultados, como canal, Campaign o plataforma. |
...
| Segment | El [Segment de audiencia]({{site.baseurl}}/user_guide/audience/segments/) que creaste en Braze. |

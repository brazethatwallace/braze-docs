...
## Cómo se construye el informe {#how-the-report-is-built}
...
### ¿Por qué el número en el gráfico no coincide con la tarjeta de resumen? {#why-doesnt-the-number-in-the-chart-match-the-summary-card}
...
### ¿Cuál es el enfoque recomendado para conteos "únicos"? {#whats-the-recommended-approach-for-unique-counts}

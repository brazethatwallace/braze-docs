...
- **Un ID de almacén de datos o sistema de registro** (a veces llamado "ID canónico" o "ID físico"): la fuente de verdad para métricas como el valor de duración del ciclo de vida, devoluciones y fidelización. Reside en tu almacén de datos o ERP.

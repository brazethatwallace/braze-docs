...
Durante la configuración, puedes aplicar las reglas de limitación de frecuencia de tu espacio de trabajo al agente y elegir si los envíos del agente cuentan para el límite de frecuencia global de cada usuario. Tu CSM or administrador de éxito de cliente or administrador de éxito de cliente o consultor de soluciones puede ayudarte a decidir el enfoque adecuado para tu programa según cómo estén configurados los límites de frecuencia en tu espacio de trabajo.
...
Contacta a tu CSM or administrador de éxito de cliente or administrador de éxito de cliente o consultor de soluciones de Braze para obtener ayuda con la configuración, la revisión del rendimiento o el diseño del programa.
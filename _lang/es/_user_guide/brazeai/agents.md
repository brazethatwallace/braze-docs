...
| Contexto | Datos que se transmiten al agente en tiempo de ejecución, independientemente de dónde se implemente, como campos de perfil de usuario o filas de catálogo. Esta entrada proporciona la información que el agente utiliza para generar resultados. |
...
El LLM proporcionado por Braze para los agentes de Braze, identificado como «Auto», utiliza modelos Google Gemini. Google conserva las Entradas y Resultados enviados a través de Braze durante 55 días, tras los cuales los datos se eliminan.

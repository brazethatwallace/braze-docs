...
- Crea un mensaje personalizado que se desencadena cuando un usuario termina de ver algo
...
4. Selecciona **Do not recommend items users have previously interacted with** para que los usuarios no reciban recomendaciones de algo que ya hayan visto.
...
6. Camila vincula la recomendación al evento personalizado `Watched Content`, que realiza un seguimiento de las visualizaciones completadas, y establece **Property Name** como el título del contenido.

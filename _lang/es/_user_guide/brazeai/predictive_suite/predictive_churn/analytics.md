...
description: "Este artículo de referencia cubre los distintos componentes incluidos en la página Análisis de predicciones de abandono y cómo pueden utilizarse para tomar decisiones basadas en la información."
page_order: 1.5

---

# Análisis predictivo del abandono de clientes {#predictive-churn-analytics}

...
### ¿Cuál es la diferencia entre los agentes de Canvas y los agentes de catálogo?
...
### ¿Cuáles son los beneficios de usar el modelo Auto frente al modelo propio (BYO)?
...
### ¿Dónde puedo ver mi uso actual de agentes?
...
### ¿Pueden los agentes acceder a datos de usuario más allá de los atributos o valores de Liquid específicos que les paso?

No. Los agentes solo reciben los puntos de datos de usuario específicos que se les pasan mediante Liquid, así como los [recursos]({{site.baseurl}}/user_guide/brazeai/agents/creating_agents/#add-resources) añadidos al contexto del agente. Los agentes no pueden buscar en los perfiles de los usuarios atributos que el especialista en marketing no haya configurado para que los busquen.
...
### ¿Qué puede causar que un agente personalizado agote el tiempo de espera con frecuencia?
...
### ¿La Consola de Agente cumple con el RGPD/CCPA?
...
### ¿La Consola de Agente cumple con HIPAA?

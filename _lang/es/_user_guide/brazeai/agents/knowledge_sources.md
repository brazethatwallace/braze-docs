...
> Las fuentes de conocimiento ayudan a tus agentes de IA a interpretar los datos del catálogo y recuperar la información adecuada para cumplir tus objetivos. Para una introducción a Braze Agents, consulta [Braze Agents]({{site.baseurl}}/user_guide/brazeai/agents). Para añadir conocimiento a un agente, consulta [Crear agentes personalizados]({{site.baseurl}}/user_guide/brazeai/agents/creating_agents#add-resources).
...
5. (opcional) Añade una descripción para indicar qué contiene la fuente de conocimiento.
...
![Una fuente de conocimiento "nyc_restaurants" que hace referencia al catálogo "nyc_restaurants".]({% image_buster /assets/img/ai_agent/knowledge_source_example.png %})

También puedes crear una fuente de conocimiento mientras construyes un agente yendo a la sección **Instrucciones** de tu agente. Selecciona **Añadir conocimiento** > **Crear fuente de conocimiento**.

## Usar una fuente de conocimiento en tu agente de IA {#use-a-knowledge-source-in-your-ai-agent}

Puedes gestionar las fuentes de conocimiento desde la sección **Fuentes de conocimiento**. Aquí puedes ver detalles como qué fuentes de conocimiento están activas y cuándo se sincronizaron por última vez. Ten en cuenta que el nombre de la fuente de conocimiento coincide con el nombre del catálogo utilizado como origen.

Para usar una fuente de conocimiento en tu agente de IA:

1. Ve a la sección **Instrucciones** de tu agente.
2. Selecciona **+ Contexto de agente** > **Añadir conocimiento**.
...
Convertir un catálogo en una fuente de conocimiento ayuda a Braze Agents a comprender el verdadero significado detrás de las palabras y frases del catálogo, de modo que los agentes puedan encontrar datos significativos de forma más eficaz para generar mejores resultados.

...
> Genera textos de marketing para mensajes SMS, push y Canvas usando Operator. Describe un producto o una Campaign, incluye un tono si es necesario, y Operator redactará un texto que puedes revisar e insertar directamente en tu creador de mensajes.

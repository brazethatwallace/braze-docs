...
# Genera directrices de marca con BrazeAI
...
![Menú desplegable para "Aplicar directrices de marca" expandido con el botón "Crear una directriz de marca" en primer plano.]({% image_buster /assets/img/ai_copywriter/create_brand_guideline_button.png %}){:style="max-width:75%"}
...
5. Si quieres que esta sea la directriz de marca predeterminada para el espacio de trabajo actual, marca **Usar como directriz de marca predeterminada**.
...
Pon a prueba tus directrices para ver cómo funcionan. Expande **Prueba tus directrices** para generar un texto de ejemplo y ajústalo según sea necesario.

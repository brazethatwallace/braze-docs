...
- [Privacidad de datos y seguridad]({{site.baseurl}}/user_guide/brazeai/operator/data_privacy_security/): Revisa el cumplimiento de HIPAA, la retención de datos y las directrices de minimización de PII
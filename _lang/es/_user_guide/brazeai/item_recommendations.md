...
2. Configura el **Tipo** a **AI Personalized**.
...
- Recomendaciones de artículos de IA
- Catálogo de elementos relevantes
- Un objeto de compra o cualquier evento personalizado para una interacción
{% enddetails %}
...
{% tabs local %}
{% tab New items %}
Este escenario no se basa directamente en las acciones del usuario, sino en los datos del catálogo. Puedes filtrar los artículos nuevos en función de su fecha de incorporación al catálogo y promocionarlos mediante campañas dirigidas o Canvas sin necesidad de entrenar un modelo de recomendación.
...
### ¿Qué hace que los artículos "Most popular" se mezclen con las recomendaciones de otros modelos?
...
### ¿Cómo puedo evitar artículos duplicados en varias secciones de recomendaciones?
...
### ¿Las recomendaciones existentes se entrenan semanalmente después de actualizar a Item Recommendations Pro?

...
{% alert tip %}
Si todos los mensajes de tu campaña van a ser similares o tener el mismo contenido, redacta tu mensaje antes de añadir variantes adicionales. Luego puedes seleccionar **Copiar de variante** en el menú desplegable **Añadir variante**.
{% endalert %}
...
Cuando un usuario descarta un Banner, no vuelve a aparecer para ese usuario, incluso si aún cumple con los criterios de segmentación de la campaña.
...
Cuando un usuario descarta un Banner de esta manera, no vuelve a aparecer para ese usuario, incluso si aún cumple con los criterios de segmentación de la campaña.
...
1. En **Públicos objetivo**, elige segmentos o filtros para delimitar tu audiencia. Recibes automáticamente una vista previa de la población aproximada del segmento. La membresía exacta del segmento se calcula antes de que se envíe el mensaje.
...
Para controlar la reelegibilidad en los pasos de Banner de Canvas, usa la configuración de reentrada de Canvas. Para más información, consulta [Reelegibilidad para campañas y Canvas]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/re_eligibility).

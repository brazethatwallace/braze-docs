...
De forma predeterminada, el tiempo de vida está configurado en 28 días, que es el máximo. Puedes reducir el TTL predeterminado para todos los nuevos mensajes push de Android desde **Settings** > **Workspace Settings** > **Push Settings**, o puedes configurar el número de días por mensaje en la pestaña **Settings** al redactar una notificación push de Android.

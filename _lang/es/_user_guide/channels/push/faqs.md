...
Cuando se reasigna un token de notificaciones push, el cambio se refleja en el **Push Changelog** del perfil de usuario. Puedes encontrarlo en la pestaña **Engagement** del perfil de usuario.

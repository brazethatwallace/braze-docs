...
## ¿Puedo guardar mi correo electrónico de arrastrar y soltar como plantilla después de crearlo dentro de mi Campaign o Canvas? {#can-i-save-my-drag-and-drop-email-as-a-template-after-i-build-it-within-my-campaign-or-canvas}

No. No puedes guardar un correo electrónico de arrastrar y soltar desde una Campaign o Canvas como una **plantilla de correo electrónico** de arrastrar y soltar en **Templates** > **Email Templates**. Recrea el diseño en **Templates** > **Email Templates**, o la próxima vez comienza desde una plantilla guardada. Para obtener instrucciones, consulta [Crear una plantilla de correo electrónico]({{site.baseurl}}/user_guide/messaging/templates/email_templates/email_template).
...
2. Revisa la configuración del **Drag-and-Drop Email Editor** en busca de fuentes personalizadas que puedan no cargarse en todos los clientes.
...
Si estás usando un Content Block, el bloque puede tener su propia configuración de color de fuente. Selecciona el bloque de texto dentro del Content Block y borra cualquier anulación local de **Font color** para que tu color hexadecimal del estilo global o de párrafo pueda aplicarse.
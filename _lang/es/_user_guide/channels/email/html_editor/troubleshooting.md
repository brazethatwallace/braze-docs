...
| El editor se comporta de forma extraña en Chrome | [Conflictos con extensiones](#extension-conflicts) |
...
| Espacio en blanco o líneas después de las imágenes en correos electrónicos de prueba | [Espacio en blanco debajo de las imágenes](#white-space-under-images) |
...
Usa este flujo de trabajo cuando la representación del correo electrónico HTML o el comportamiento del editor no coincide con lo que esperas. Empieza en el paso 1.
...
4. Descarta [conflictos con extensiones del navegador](#extension-conflicts) si el propio editor presenta un comportamiento incorrecto.

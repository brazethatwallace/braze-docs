...
## Consideraciones antes de importar {#considerations-before-importing}

{% multi_lang_include alerts/important_alerts.md alert='Email via SMS' %}

### Valida tus listas de correo electrónico {#validate-your-email-lists}
...
### Identifica a tus usuarios comprometidos {#identify-your-engaged-users}
...
### Evita las listas de supresión {#avoid-suppression-lists}

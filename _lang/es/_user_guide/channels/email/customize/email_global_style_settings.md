...
1. En la sección **Nombre de fuente predeterminada** de **Estilos básicos**, selecciona **Añadir una fuente personalizada**.
2. En el campo **Nombre de fuente**, introduce el mismo nombre de fuente que aparece en tu archivo de origen de fuente personalizada. Asegúrate de que el nombre esté correctamente escrito en mayúsculas y con los espacios adecuados.
3. Introduce la URL correspondiente en el campo **URL de fuente**.
...
Opcionalmente, puedes anular el estilo predeterminado del tema de tu editor de arrastrar y soltar. Selecciona **Anular estilo predeterminado** para aplicar tu elección de estilos de título. Esto puede incluir configurar una fuente y un color de enlace diferentes.

## Estilos de párrafo

Para establecer un estilo de párrafo predeterminado, ve a **Estilos de párrafo**, introduce el **Tamaño de fuente** y selecciona **Color de fuente** para elegir un color de fuente. También puedes ajustar el estilo del bloque para el texto del cuerpo editando los valores de **Relleno superior**, **Relleno derecho**, **Relleno inferior** y **Relleno izquierdo**. Esto se aplicará al espaciado alrededor de las cuatro áreas que rodean el bloque de párrafo.
...
Al añadir listas a tu mensajería, la sección **Estilos de lista** crea consistencia en cómo se estilizan tus listas. Esto incluye detalles como:
...
Puedes configurar el **Tipo de lista** como numerada o con viñetas. El **Tipo de estilo de lista** proporciona personalización adicional para el estilo de tus listas. Por ejemplo, puedes configurar los tipos de lista para que siempre tengan viñetas y que cada viñeta sea un cuadrado.

![Configuración de estilos de lista para una lista con viñetas.]({% image_buster /assets/img_archive/dnd_list_styling.png %})

## Estilos de botón

En la sección **Estilos de botón**, puedes editar los siguientes estilos predeterminados para el botón:
- Color de fondo
- Tamaño de fuente
- Color de fuente
- Radio del borde
...
Al igual que con todas las demás secciones de estilos, puedes ajustar el estilo del bloque editando los valores de **Relleno superior**, **Relleno derecho**, **Relleno inferior** y **Relleno izquierdo**.

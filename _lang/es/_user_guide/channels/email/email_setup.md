...
article_title: Configuración de correo electrónico
layout: dev_guide
page_order: 0
...
- name: "Consentimiento y recopilación de direcciones"
...
|---|---|---|
| Una IP dedicada (protocolo de Internet) | Una IP dedicada es una dirección de Internet única proporcionada exclusivamente a una sola cuenta de alojamiento. | Braze te proporciona IP dedicadas para garantizar el control de la reputación de tu remitente de correo electrónico. El equipo de incorporación de Braze se encargará de configurarlo por ti.|
...
## Correos electrónicos transaccionales legalmente obligatorios

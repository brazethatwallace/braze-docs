...
# Informes de tarjetas de contenido
...
## Cuándo se registran los envíos

El momento en que se registra un evento _Enviado_ para las tarjetas de contenido depende del tipo de entrega y de la configuración de **Creación de tarjeta**.

### Entrega planificada

Para las tarjetas de contenido planificadas, el momento del evento _Enviado_ depende de la configuración de **Creación de tarjeta**:
...
Para las tarjetas de contenido basadas en acciones, el envío se registra poco después de que el usuario realice la acción desencadenante, cuando la tarjeta se escribe en su fuente. Esto ocurre independientemente de si el usuario ha visto la tarjeta.

### Filtros de Campañas recibidas y reorientación

Independientemente del tipo de entrega o de la configuración de **Creación de tarjeta**, una campaña de tarjeta de contenido aparece en el perfil del usuario en **Campañas recibidas** solo después de que haya visto la tarjeta en la aplicación. Los filtros de reorientación **Último mensaje recibido** y **Última campaña recibida** se actualizan en el momento de la visualización por la misma razón.

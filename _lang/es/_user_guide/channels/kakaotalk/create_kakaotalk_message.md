...
{% subtabs %}
{% subtab Imagen estrecha %}

#### Imagen estrecha {#narrow-image}

Un mensaje de imagen estrecha presenta una imagen ligeramente más alta y estrecha, con opciones de texto y botones más amplias.

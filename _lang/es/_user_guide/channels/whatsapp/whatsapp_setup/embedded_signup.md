...
3. En el desplegable **Business portfolio**, selecciona tu portafolio de empresa y luego selecciona **Next**. Esto se conecta a tu cuenta de WhatsApp Business, así que si no ves el portafolio de empresa esperado, verifica tus permisos.<br><br>![Una ventana con campos para introducir la información de tu empresa, incluido el nombre del portafolio de empresa.]({% image_buster /assets/img/whatsapp/business_info.png %}){: style="max-width:50%;"}<br><br>
...
6. Introduce tu número de teléfono y elige **Text message** o **Phone call**. Este número debe cumplir con todos los requisitos de cualquier número de teléfono de WhatsApp, incluido no estar registrado en ninguna otra cuenta de WhatsApp. <br><br>![Campos para añadir un número de teléfono.]({% image_buster /assets/img/whatsapp/add_phone_number.png %}){: style="max-width:50%;"}<br><br>

...
2. Ve a **Audience** > **Subscription Group Management** y busca el grupo de suscripción asociado al número de teléfono de WhatsApp que deseas mover.
3. Pasa el cursor sobre el estado del grupo de suscripción y selecciona <i class="fa-solid fa-box-archive"></i> **Archive**, lo que marcará el grupo de suscripción como inactivo pero no lo eliminará.

![Botón "Archive" que aparece al pasar el cursor sobre el estado "Active" de un grupo de suscripción.]({% image_buster /assets/img/whatsapp/archive_subscription_group.png %}){: style="max-width:70%;"}
...
2. Ve a **Partner Integrations** > **Technology Partners** > **WhatsApp**, luego desplázate hasta la sección **WhatsApp Messaging Integration**.
3. Selecciona la opción **Create new subscription group and phone number**.

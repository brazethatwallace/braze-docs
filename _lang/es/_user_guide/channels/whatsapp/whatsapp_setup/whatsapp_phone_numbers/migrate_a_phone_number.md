...
- Tu número de teléfono de empresa tiene la verificación en dos pasos desactivada. Si eres propietario de tu cuenta de WhatsApp Business, puedes desactivar la verificación en dos pasos en el número desde el WhatsApp Administrador. De lo contrario, debes pedirle a tu proveedor de solución que la desactive por ti.
...
1. En el WhatsApp Administrador, selecciona la cuenta de WhatsApp Business (WABA) asociada a tu número de teléfono y luego ve a **Account tools** > **Phone numbers**.

...
4. En la pestaña **Configuración**, especifica tu **Método HTTP** y los **Encabezados de solicitud** según lo requiera el punto de conexión.
...
- **URL del webhook:** Tu [URL del punto de conexión REST]({{site.baseurl}}/user_guide/administer/personal/sdk_endpoints) seguida de `/canvas/trigger/send`. Por ejemplo, para la instancia `US-06`, la URL sería `https://rest.iad-06.braze.com/canvas/trigger/send`.

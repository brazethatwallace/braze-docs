...
Los clientes pueden enviar MMS con códigos largos. Para hacerlo, debes asegurarte de que tus códigos largos tengan MMS habilitado. Esto se puede hacer inicialmente durante la configuración o posteriormente desde tu cuenta.
...
| Tamaño&nbsp;del&nbsp;archivo | Manejo del operador |
| --- | --- |

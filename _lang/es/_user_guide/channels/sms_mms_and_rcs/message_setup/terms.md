...
glossaries:
  ...
  - name: Mandatory Keyword HELP
    ...
    description: Para cada programa que se crea en la plataforma SMS Campaign Administrador, se debe proporcionar contenido para esta palabra clave y debe cumplir con las mejores prácticas y el cumplimiento del operador por país o región en la que se envía y recibe el tráfico de SMS. En la mayoría de los casos, este contenido debe incluir una breve explicación del programa de SMS y cómo cancelar la suscripción.

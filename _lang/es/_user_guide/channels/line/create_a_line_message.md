...
2. Selecciona **LINE** o, para campañas dirigidas a múltiples canales, selecciona **Multichannel Campaign**.
...
Puedes especificar controles de entrega, como permitir que los usuarios vuelvan a ser [elegibles]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/re_eligibility/#campaigns) para recibir la campaña, o activar reglas de [limitación de frecuencia]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/frequency_capping/#frequency-capping). Para la entrega basada en acciones, también puedes establecer la duración de la campaña y las [horas tranquilas]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/delivery_and_entry_types/#quiet-hours).
...
Si aún no lo has hecho, completa las secciones restantes de tu Canvas. Para más detalles sobre cómo construir el resto de tu Canvas, usar pruebas multivariante e Intelligent Selection, y más, consulta [Crear un Canvas]({{site.baseurl}}/user_guide/messaging/canvas/create_a_canvas/).

...
Para crear y gestionar atributos personalizados en el dashboard, ve a **Data Settings** > **Custom Attributes**.

![Cuatro atributos personalizados que son booleanos.]({% image_buster /assets/img/export_custom_attributes.png %})

La columna **Last updated** muestra la última vez que se editó el atributo personalizado, como la última vez que se configuró como lista de bloqueo o activo.
...
Puedes añadir una descripción a un atributo personalizado después de crearlo si tienes el [permiso de usuario]({{site.baseurl}}/user_guide/administer/global/user_management/permissions/) `Manage Events, Attributes, Purchases`. Selecciona **Edit description** para el atributo personalizado e introduce lo que desees, como una nota para tu equipo.
...
Para exportar la lista de atributos personalizados como un archivo CSV, selecciona **Export all** en la parte superior de la página. Se generará el archivo CSV y se te enviará un enlace de descarga por correo electrónico.

## Cambiar el tipo de atributo personalizado {#change-custom-attribute-type}

### Requisitos previos {#prerequisites}

El atributo personalizado no debe estar actualmente en uso en ninguna Campaign, Canvas ni ningún segmento activo. Si intentas cambiar el tipo de datos mientras el atributo aún está referenciado, el dashboard mostrará un error y bloqueará el cambio.
...
2. Elimina el atributo de todos los filtros de segmentos, Campaigns y Canvas.
3. Ve a **Data Settings** > **Custom Attributes** (o **Custom Events**), busca el atributo y actualízalo al tipo de datos deseado.
...
5. Vuelve a aplicar el atributo a los segmentos, Campaigns y Canvas relevantes, y luego reactiva cualquier Campaign o Canvas detenido.
...
- **Los filtros no se actualizan automáticamente.** Los segmentos y filtros de Campaigns que hacen referencia al atributo modificado no se actualizan retroactivamente. Debes eliminarlos y volver a añadirlos después del cambio.

## Ver informes de uso {#view-usage-reports}

El informe de uso muestra todos los Canvas, Campaigns y segmentos que utilizan un atributo personalizado específico. Esta lista no incluye usos de Liquid.

...
# Notificaciones de bajada de precios {#price-drop-notifications}
...
## Uso de las notificaciones de bajada de precio en Canvas {#using-price-drop-notifications-in-a-canvas}

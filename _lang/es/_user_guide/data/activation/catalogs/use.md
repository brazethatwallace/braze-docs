...
- Coloca el cursor sobre la fila del catálogo en la sección **Catalogs**. A continuación, selecciona el botón **Export catalog**.
- Selecciona tu catálogo. A continuación, selecciona el botón **Export catalog** en la pestaña **Preview** del catálogo.
...
No estás limitado a un solo elemento por mensaje. Utiliza el modal **Add Personalization** para añadir hasta tres elementos del catálogo a la vez. Para añadir más, selecciona de nuevo **Add Personalization** en el compositor y selecciona los elementos adicionales del catálogo y la información que deseas mostrar.
...
Utilizando plantillas de Liquid, puedes extraer dinámicamente los ID de la lista de deseos y utilizarlos en tu mensaje. Para ello, [asigna una variable]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/liquid/using_liquid/#assigning-variables) a tu atributo personalizado y, a continuación, utiliza el modal **Add Personalization** para extraer un elemento específico de la matriz. Las variables a las que se hace referencia como ID de elemento del catálogo deben escribirse entre llaves para que se puedan referenciar correctamente, como por ejemplo `{{result}}`.

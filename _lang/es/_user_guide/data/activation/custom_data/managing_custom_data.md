...
> Esta página explica cómo rellenar previamente datos personalizados en tus campañas y Segments, gestionar eventos y atributos personalizados y sus propiedades, y configurar tipos de datos. Para bloquear y eliminar datos personalizados, consulta [Bloquear datos personalizados]({{site.baseurl}}/user_guide/data/activation/custom_data/blocklist_custom_data/).

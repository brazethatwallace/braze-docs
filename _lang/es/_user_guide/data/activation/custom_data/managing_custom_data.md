...
## Rellenar previamente datos personalizados
...
## Detección de tipos de datos entre entornos

Braze detecta automáticamente el tipo de datos de un atributo personalizado basándose en el primer valor que recibe. Si tu entorno de desarrollo envía primero un valor numérico como `100`, el atributo se almacena como número. Si el primer valor de tu entorno de producción llega como cadena (como `"100"` entre comillas), el atributo se almacena como cadena.

Para evitar esto, asegúrate de que tu integración envíe tipos de datos consistentes en todos los entornos. Si ya se ha establecido el tipo incorrecto, puedes forzar el tipo de datos correcto en **Configuración de datos** > **Atributos personalizados** usando el [desplegable de tipo de datos](#forcing-data-type-comparisons).
...
### Datos existentes después de un cambio de tipo

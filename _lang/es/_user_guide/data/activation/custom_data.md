...
### Atributos personalizados: quiénes son tus usuarios
...
### Eventos personalizados: qué hacen tus usuarios
...
- **Análisis:** Los eventos potencian la segmentación, los informes y el análisis para que puedas medir la interacción y optimizar tu mensajería.
...
## Gestionar la integridad de tus datos
...
### Detección y cambios de tipo de datos
...
### Lista de bloqueo y eliminación
...
- **Lista de bloqueo:** Esto impide que Braze recopile nuevos datos para ese objeto. Evita que los datos aparezcan en filtros o gráficos, pero mantiene los datos existentes en los perfiles.
- **Eliminación:** Esto elimina permanentemente los datos de todos los perfiles de usuario. Debes incluir un objeto de datos en la lista de bloqueo durante 7 días antes de que sea elegible para su eliminación.

Para más información, consulta [Gestionar datos personalizados]({{site.baseurl}}/user_guide/data/activation/custom_data/managing_custom_data/) y [Lista de bloqueo de datos personalizados]({{site.baseurl}}/user_guide/data/activation/custom_data/blocklist_custom_data/).
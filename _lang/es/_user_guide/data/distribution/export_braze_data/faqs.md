...
### ¿Qué ocurre si configuras las credenciales de S3 en el dashboard pero no seleccionas "Convertir en destino predeterminado de exportación de datos"?

La casilla de verificación **Convertir en destino predeterminado de exportación de datos** influye en si las exportaciones van a S3 o a Azure, suponiendo que hayas añadido credenciales para ambos.
...
### ¿Por qué veo duplicados cuando exporto usuarios por segmento a través de la REST API?
...
### ¿Cómo abro informes CSV en Excel?

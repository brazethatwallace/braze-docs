...
page_order: 2
page_type: reference
description: "En este artículo de referencia se explica cómo exportar datos de resultados de Campaigns individuales, multicanal o multivariantes. El artículo también explica cómo exportar los datos de usuario de los destinatarios."
tool:
  - Campaigns
  - Reports
...
> En la página **Campaigns** del dashboard, selecciona la campaña que quieras ver y desplázate hasta los gráficos históricos de rendimiento, que se pueden exportar.<br><br>En esta página se explica cómo exportar datos de resultados de Campaigns individuales, multicanal y multivariantes, y cómo exportar datos de usuario de los destinatarios.

## Campaigns multicanal

Para las Campaigns multicanal, los datos que se pueden exportar dependen de los canales de mensajería que hayas utilizado. Aquí tienes una lista de todos los datos que se pueden exportar de una campaña que haya utilizado push de iOS, push de Android, correo electrónico y mensajes dentro de la aplicación:
...
## Campaigns multivariantes

Para las Campaigns multivariantes, que utilizan un solo canal de mensajería, puedes exportar datos que muestren el rendimiento de cada variante en los análisis del canal de mensajería específico a lo largo del tiempo. Puedes ver estos datos agrupados por estadística o agrupados por variante de mensaje.

Los resultados de las Campaigns push contienen gráficos para los siguientes análisis:
...
Los resultados de las Campaigns de correo electrónico contienen gráficos para los siguientes análisis:
...
Los resultados de las Campaigns de mensajes dentro de la aplicación contienen gráficos para los siguientes análisis:

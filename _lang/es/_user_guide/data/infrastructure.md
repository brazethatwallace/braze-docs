---
nav_title: Infraestructura
article_title: Infraestructura de datos
page_order: 3.5
layout: dev_guide

guide_top_header: "Infraestructura de datos"
guide_top_text: "La infraestructura de datos de Braze incluye centros de datos que ayudan a minimizar la latencia, que es el tiempo que tardan los datos en viajar entre el servidor y el usuario. Esto permite que nuestros servicios sean fiables y escalables. Esto también incluye el cifrado a nivel de campo para ayudar a proteger los datos sensibles y minimizar la información de identificación personal (PII) compartida en Braze."

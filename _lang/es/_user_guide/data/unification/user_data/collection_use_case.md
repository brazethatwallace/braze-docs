...
El objetivo de StyleRyde es sencillo: quieren que los usuarios soliciten viajes en taxi a través de su aplicación.
...
3. StyleRyde necesita que los usuarios intenten solicitar un taxi.
4. StyleRyde necesita estar disponible cuando los usuarios solicitan un taxi.
...
3. Enviar disculpas y crédito promocional a los usuarios que tuvieron Unsuccessful Taxi Hails, que no fueron seguidos por un Successful Taxi Hail dentro de un período de tiempo determinado.
4. Enviar promociones a los usuarios más activos con muchos Successful Taxi Hails para agradecerles su fidelización.

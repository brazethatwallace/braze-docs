...
#### Riesgo de utilizar un correo electrónico o un correo con hash como ID externo {#risk-of-using-an-email-or-hashed-email-as-an-external-id}
...
### Qué ocurre cuando identificas a usuarios anónimos {#what-happens-when-you-identify-anonymous-users}
...
### Comportamiento de los alias en los perfiles de usuario anónimos {#behavior-of-aliases-on-anonymous-user-profiles}

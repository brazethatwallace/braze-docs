...
## Tabla de ratio de créditos para créditos de mensaje - Sigma {#credit-ratio-table-for-message-credits-sigma}
...
- La facturación de RCS se centra en dos tipos de mensaje diferentes (con distinciones para EE. UU.):

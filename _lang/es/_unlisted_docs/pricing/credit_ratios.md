---
nav_title: Ratios de créditos de WhatsApp
alias: "/credit_ratios/"
permalink: "/credits_whatsapp/"
hidden: true
---

# Ratios de créditos de WhatsApp (confidencial) {#whatsapp-credit-ratios-confidential}

> {% multi_lang_include whatsapp/about_credits.md content="h2" %}

## Tabla de ratios de créditos {#credit-ratio-table}

{% details Haz clic para expandir %}
<table class="credits-table" aria-label="Tabla de ratios de créditos">
    <colgroup>
        <col span="3">
...
## Facturación por región {#billing-by-region}

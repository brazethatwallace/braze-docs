...
## Tabla de ratio de créditos para Message Credits - Theta {#credit-ratio-table-for-message-credits-theta}

{% details Haz clic para expandir %}
<table class="credits-table" aria-label="Tabla de ratio de créditos para Message Credits - Theta">
    <colgroup>
        <col span="3">
...
Braze cobrará Message Credits por las invocaciones de la Consola de Agente enviadas desde la plataforma Braze. Se registra una invocación cuando un agente inicia una llamada a un LLM. De forma predeterminada, tu contrato incluye diez mil invocaciones por cada período de tu plazo de suscripción.

...
## Tabla de ratios de créditos para Message Credits - Theta {#credit-ratio-table-for-message-credits-theta}

{% details Haz clic para expandir %}
<table class="credits-table" aria-label="Tabla de ratios de créditos para Message Credits - Theta">
    <colgroup>
        <col span="3">

...
## Tabla de ratios de créditos para créditos de mensaje - Theta {#credit-ratio-table-for-message-credits-theta}

{% details Haz clic para expandir %}
<table class="credits-table" aria-label="Tabla de ratios de créditos para créditos de mensaje - Theta">
    <colgroup>
        <col span="3">
...
- La facturación de RCS se basa en dos tipos de mensaje diferentes (con distinciones para EE. UU.):
    ...
    - **RCS enriquecido (solo EE. UU.):** Solo texto, puede incluir sugerencias/botones limitados (quickReply, dialPhone, openURL sin webview), segmentado cada 160 bytes UTF-8

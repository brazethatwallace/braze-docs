...
Si se actualiza alguna funcionalidad descrita en este artículo, se reflejará en este artículo y se indicará en nuestras [notas de la versión]({{site.baseurl}}/help/release_notes#most-recent-braze-release-notes).
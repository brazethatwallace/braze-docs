...
La entrega en tiempo real cambia cuándo llega un mensaje al dispositivo. El comportamiento de visualización se mantiene igual: el mensaje espera a su evento desencadenante antes de aparecer.

### Qué significa esto para tus campañas {#what-this-means-for-your-campaigns}

| Escenario | Sin entrega en tiempo real | Con entrega en tiempo real |
| --- | --- | --- |
| Un usuario se vuelve elegible para una campaña de mensajes dentro de la aplicación a mitad de sesión | El mensaje llega en el siguiente inicio de sesión | El mensaje llega durante la sesión actual |
...
Braze está desarrollando activamente esta característica, y tus comentarios influyen en lo que se lanza en la disponibilidad general. Envía a tu director de cuentas tus observaciones sobre los tiempos de entrega, cualquier cosa que se haya comportado de manera diferente a lo esperado y los escenarios que te gustaría que la entrega en tiempo real cubra a continuación.
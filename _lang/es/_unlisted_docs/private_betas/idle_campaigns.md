...
> Este artículo de referencia explica el estado inactivo de Campaigns y Canvas y responde preguntas frecuentes.
...
De forma continua, las Campaigns inactivas que cumplan los siguientes criterios serán detenidas:
...
De forma continua, los Canvas inactivos que cumplan los siguientes criterios serán detenidos:
...
- Un Canvas sin fecha de finalización no ha ingresado usuarios ni ha sido editado en más de 12 meses y su duración máxima
...
| Canvas sin fechas de finalización que no han enviado mensajes en un año                                                      | Envía un mensaje o realiza cualquier edición al Canvas |
| Canvas con fechas de finalización y envíos únicos | Planifica un envío futuro |
| Canvas que no han enviado un mensaje en 11 meses | Envía un mensaje o realiza cualquier edición al Canvas |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
...
- Si el Canvas fue creado antes de 2021, los datos pueden haber sido eliminados permanentemente según la política anterior.

## Preguntas frecuentes {#frequently-asked-questions}

#### ¿A qué Campaigns o Canvas se aplica esto? {#what-campaigns-or-canvases-does-this-apply-to}

Esto se aplicará a las Campaigns y Canvas que ya cumplan con los criterios mencionados anteriormente, y a las Campaigns y Canvas que cumplan con los criterios en el futuro.

#### ¿Cómo sé si una Campaign o un Canvas está inactivo? {#how-do-i-know-if-a-campaign-or-canvas-is-idle}

Las Campaigns y Canvas inactivos se mostrarán en las páginas de lista de Campaigns y Canvas bajo la categoría **Inactivos**. La fecha en la que la Campaign o el Canvas se detendrá aparece como una columna en la lista.

![El filtro "Inactivos" en la página "Campaigns".][1]{: style="max-width:60%;"}
...
#### ¿Por qué veo Campaigns inactivas en mi lista de Campaigns cuando apliqué un filtro para mostrar solo Campaigns activas? {#why-am-i-seeing-idle-campaigns-displayed-in-my-campaigns-list-when-i-applied-a-filter-to-show-active-campaigns-only}

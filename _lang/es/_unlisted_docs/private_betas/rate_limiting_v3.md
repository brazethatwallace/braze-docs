...
- Los límites de velocidad para Campaigns multicanal (no Canvas ni Campaigns push) reflejarán el [comportamiento no actualizado de los límites de velocidad para Campaigns multicanal]({{site.baseurl}}/user_guide/engagement_tools/campaigns/building_campaigns/rate-limiting/#delivery-speed-rate-limiting). Recomendamos evitar la creación de Campaigns multicanal con límites de velocidad mientras formes parte de esta etapa de acceso anticipado.
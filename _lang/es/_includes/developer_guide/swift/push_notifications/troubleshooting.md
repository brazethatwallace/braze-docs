...
![Pestaña Interacción del perfil de usuario de Braze que muestra el registro de cambios de registro push.]({% image_buster /assets/img_archive/push_changelog.gif %}){: style="max-width:50%;" }

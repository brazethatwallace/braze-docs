...
| `enableSdkAuthentication`                     | boolean | Si se habilita la característica de [Autenticación SDK](https://www.braze.com/docs/developer_guide/platform_wide/sdk_authentication#sdk-authentication).      |

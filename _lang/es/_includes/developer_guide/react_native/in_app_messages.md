...
| `header` | El encabezado del mensaje. |
| `uri` | La URI asociada a la acción de clic del botón. |
| `imageUrl` | La URL de la imagen del mensaje. |
| `zippedAssetsUrl` | Los activos comprimidos preparados para mostrar contenido HTML. |
| `useWebView` | Indica si la acción de clic del botón debe redirigirse utilizando una vista web. |
...
| `id` | El ID del botón en el mensaje. |
| `toString()` | El botón como representación de cadena. |

...
![Configuración de etiquetas en Google Tag Manager de una etiqueta HTML personalizada que muestra la fuente de Content Cards.]({% image_buster /assets/img/web-gtm/gtm_content_cards.png %})
{% endtab %}

...
{% alert note %}
Esta integración automática no debe utilizarse con un archivo `braze.xml` creado manualmente, ya que los valores de configuración pueden entrar en conflicto durante la construcción del proyecto. Si necesitas un `braze.xml` manual, desactiva la integración automática.
{% endalert %}
{% endtab %}

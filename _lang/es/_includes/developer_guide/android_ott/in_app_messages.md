...
El SDK or kit de desarrollo de software de Braze para Android admite de forma nativa la visualización de mensajes dentro de la aplicación en dispositivos OTT como Android TV o Fire Stick. Sin embargo, hay algunas diferencias clave entre los mensajes nativos de Android y los mensajes dentro de la aplicación OTT. Para dispositivos OTT:

## Integración del SDK de .NET MAUI {#integrating-the-net-maui-sdk}
...
{% tab ios %}
{% alert important %}
Los bindings de iOS para .NET MAUI SDK versión 4.0.0 y posteriores utilizan el [SDK Braze SWIFT](https://github.com/braze-inc/braze-swift-sdk/), mientras que las versiones anteriores utilizan el [SDK AppboyKit heredado](https://github.com/Appboy/Appboy-ios-sdk).
{% endalert %}
...
{% tabs %}
{% tab android %}
#### Paso 2.1: Configura el SDK de Braze en Braze.xml {#step-21-configure-the-braze-sdk-in-brazexml}
...
{% tabs %}
{% tab android %}
Ahora puedes iniciar tu aplicación y ver las sesiones que se registran en el panel de Braze (junto con la información del dispositivo y otros análisis). Para profundizar en las mejores prácticas para la integración básica del SDK, consulta las [instrucciones de integración de Android]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=android).
{% endtab %}

{% tab ios %}
Ahora puedes iniciar tu aplicación y ver las sesiones que se registran en el panel de Braze. Para profundizar en las mejores prácticas para la integración básica del SDK, consulta las [instrucciones de integración de iOS]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=swift).

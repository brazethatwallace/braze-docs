...
1. Selecciona **Iniciar generador SQL con IA** después de crear un [segmento SQL]({{site.baseurl}}/user_guide/engagement_tools/segments/sql_segments/) utilizando la actualización completa o incremental.

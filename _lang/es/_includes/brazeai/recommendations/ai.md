...
## Características de IA específicas del plan {#plan-specific-ai-features}
...
<sup>1. Es la frecuencia con la que se actualizan las recomendaciones de elementos específicas del usuario (solo AI Personalizado y Más reciente). Más popular y Tendencias son recomendaciones globales que se actualizan cuando el modelo se vuelve a entrenar. Por ejemplo, si un usuario compra un elemento recomendado basándose en las recomendaciones de elementos de IA, sus elementos recomendados se actualizarán según esta frecuencia.</sup><br>

...
| URL del panel | Endpoint REST or transferencia de estado representacional | Punto final de SDK or kit de desarrollo de software |
| --- | --- | --- |
...
| Instancia | URL | Endpoint REST or transferencia de estado representacional | Punto final de SDK or kit de desarrollo de software |
|---|---|---|---|

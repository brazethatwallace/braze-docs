...
|Especialistas en marketing|"Acceder a campañas, Canvas, tarjetas, conmutadores de características, segmentos, biblioteca multimedia y centros de preferencias" <br> "Administrar activos de biblioteca de medios"|
...
----------- | ----------- | ---------
| Especialista en marketing - Marcas de moda | {::nomarkdown}[DEV] Marca de moda, [QA] Marca de moda, [PROD] Marca de moda {:/} | "Acceder a campañas, Canvas, tarjetas, conmutadores de características, segmentos, biblioteca multimedia y centro de preferencias"<br>"Administrar activos de biblioteca de medios" |
| Especialista en marketing - Marcas de cuidado de la piel | {::nomarkdown}[DEV] Marca de cuidado de la piel, [QA] Marca de cuidado de la piel, [PROD] Marca de cuidado de la piel {:/} | "Acceder a campañas, Canvas, tarjetas, conmutadores de características, segmentos, biblioteca multimedia y centros de preferencias" <br>"Administrar activos de biblioteca de medios" |
...
| Permiso básico de solo lectura | Para acceder a determinadas partes del dashboard, como la página de socios tecnológicos, los usuarios deben tener un permiso básico de solo lectura. Esto incluye tener habilitada la opción "Administrar integraciones externas", junto con permisos para acceder a campañas, Canvas, tarjetas, segmentos y biblioteca multimedia. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
...
|Espacio de trabajo|Acceder a campañas, Canvas, tarjetas, bloques de contenido, conmutadores de características, segmentos, biblioteca multimedia, ubicaciones, códigos promocionales y centros de preferencias|Permite a los usuarios ver las métricas de rendimiento de las campañas y los Canvas, crear y duplicar borradores de campañas y Canvas, editar borradores y plantillas de campañas y Canvas, ver borradores de segmentos, plantillas y medios, crear plantillas, cargar medios, crear o actualizar listas de códigos promocionales, ver informes de interacción y ver la configuración de mensajes globales en el dashboard. Sin embargo, los usuarios con este permiso no pueden pausar ni editar los contenidos en vivo existentes.<br><br> Cuando este permiso se configura como un [permiso de equipo]({{site.baseurl}}/user_guide/administrative/app_settings/manage_your_braze_users/teams/), si alguna campaña o Canvas en el [informe de interacción]({{site.baseurl}}/user_guide/analytics/reporting/engagement_reports/) está fuera de los equipos asignados al usuario o no tiene equipos asignados, el informe se oculta para el usuario.|
...
|Espacio de trabajo|Editar segmentos|Permite a los usuarios crear y editar segmentos. Puedes seguir creando campañas con segmentos y filtros existentes sin este permiso. Necesitas este permiso para generar un segmento a partir de los usuarios de un CSV o para reorientar el grupo de usuarios del CSV.|
|Espacio de trabajo|Exportar datos de usuario|Permite a los usuarios exportar sus datos de usuario desde segmentos, campañas y Canvas. Este permiso incluye información sensible del usuario como nombres, direcciones de correo electrónico y otra información de identificación personal (PII) recopilada. Para exportar archivos CSV desde el dashboard, debes tener este permiso y el permiso "Ver PII".|
...
|Espacio de trabajo|Administrar activos de biblioteca de medios|Permite a los usuarios añadir, editar y eliminar activos de la biblioteca de medios.|
|Espacio de trabajo|Administrar grupos de suscripción|Permite a los usuarios crear y gestionar grupos de suscripción.|
|Espacio de trabajo|Gestionar etiquetas|Permite a los usuarios editar o eliminar etiquetas (en **Gestión de etiquetas**). No necesitas este permiso para añadir etiquetas a campañas o segmentos.|
...
|Espacio de trabajo|Enviar campañas, Canvas|Permite a los usuarios editar, archivar y detener campañas y Canvas, crear campañas y lanzar Canvas. |
|Espacio de trabajo|Ver datos de facturación|Permite a los usuarios ver las suscripciones y la facturación.|
|Espacio de trabajo|Ver integración de Currents|Permite a los usuarios ver toda la información sobre una conexión de Currents, excluyendo las credenciales. Por defecto, a los usuarios que tienen asignado el permiso "Acceder a campañas, Canvas, tarjetas, bloques de contenido, conmutadores de características, segmentos, biblioteca multimedia, ubicaciones, códigos promocionales y centros de preferencias" también se les asigna este permiso.|

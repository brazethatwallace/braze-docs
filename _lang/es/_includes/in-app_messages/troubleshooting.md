...
{% if include.SDK or kit de desarrollo de software == "iOS" %}
...
{% elsif include.SDK or kit de desarrollo de software == "Android" %}
...
{% elsif include.SDK or kit de desarrollo de software == "Web" %}
...
{% case include.SDK or kit de desarrollo de software %}
  {% when "iOS" %}

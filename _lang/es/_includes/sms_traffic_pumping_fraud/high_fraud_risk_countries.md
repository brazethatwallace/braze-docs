### ¿Qué son los países de alto riesgo de fraude y por qué existen? {#what-are-high-fraud-risk-countries-and-why-do-they-exist}
...
{% if include.detail %}
Los países de alto riesgo de fraude se identifican en la lista de permisos de Geographic Permissions con una etiqueta de **High Fraud Risk**. Braze la actualiza periódicamente.
{% endif %}
...
## ¿Qué es BrazeAI Decisioning Studio™? {#what-is-brazeai-decisioning-studio}
...
![Resumen del ciclo de retroalimentación de Decisioning Studio]({% image_buster /assets/img/decisioning_studio/decisioniong_studio_feedback_loop.png %})
...
## Acerca de Decisioning Studio {#about-decisioning-studio}

### Cómo funciona {#how-it-works}

BrazeAI Decisioning Studio™ te permite diseñar e implementar agentes de decisión que optimizan cualquier métrica empresarial.

Para configurar Decisioning Studio, deberás:
- Conectar orígenes de datos que indiquen al agente cómo reacciona un cliente ante sus decisiones.
- Configurar la orquestación para llevar a cabo las acciones del agente de decisión.
...
Aunque ambos funcionan con BrazeAI<sup>TM</sup>, los agentes de decisión y los Braze Agents tienen diferentes funciones en tu conjunto de herramientas de marketing.

**Los agentes de decisión** son los coordinadores estratégicos de tus campañas. Operan a nivel de campaña, realizando continuamente experimentos en diferentes dimensiones, como la oferta, el canal, el momento y la frecuencia, con el fin de maximizar métricas empresariales como los ingresos, las conversiones o el ARPU. Un agente de decisión administra un caso de uso completo, como la recuperación de clientes, la venta cruzada o la renovación, aprendiendo con el tiempo qué combinación de acciones funciona mejor para cada cliente individual.

**Los Braze Agents** son asistentes basados en inteligencia artificial que se encuentran dentro de pasos individuales de Canvas o campos del catálogo. Utilizan modelos de lenguaje grandes (LLM) para generar contenido (como líneas del asunto personalizadas o textos de mensajes), tomar decisiones de enrutamiento basadas en el contexto del cliente o enriquecer tus catálogos con valores generados de manera dinámica. Los Braze Agents destacan por aportar creatividad y personalización a puntos de intervención específicos dentro de tu campaña.

Piénsalo de esta manera: un agente de decisión es el director que coordina toda tu estrategia de campaña, mientras que los Braze Agents son los músicos que añaden creatividad y matices a cada momento individual del recorrido del cliente. Puedes utilizarlos juntos: deja que un agente de decisión determine la oferta y el canal óptimos para cada cliente y, a continuación, utiliza un Braze Agent para generar un texto personalizado para ese mensaje específico.
...
En esta guía, primero aprenderás qué son los agentes de decisión y cómo funcionan. A continuación, configurarás Decisioning Studio Go de autoservicio, seguido de Decisioning Studio Pro con servicios integrales. Por último, revisarás los informes y la información para comprender el rendimiento de tus agentes de decisión.

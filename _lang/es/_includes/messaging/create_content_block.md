...
2. Arrastra y suelta los [bloques de editor]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks) para construir un Content Block de arrastrar y soltar.
3. Arrastra y suelta un bloque de formato de la pestaña **Filas** en el editor para crear el diseño de tu Content Block. <br><br> ![Compositor de Content Blocks de arrastrar y soltar.]({% image_buster /assets/img_archive/dnd_content_block_composer.png %})<br><br>
...
2. Introduce tu HTML en la pestaña **HTML** o construye tu Content Block en la pestaña **Clásico**. <br><br> ![Compositor del editor de código HTML.]({% image_buster /assets/img_archive/html_content_block_composer.png %})<br><br>

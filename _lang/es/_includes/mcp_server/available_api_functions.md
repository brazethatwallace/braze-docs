...
| Función | Punto de conexión | Descripción |
|----------|----------|-------------|
| `get_send_data_series` | [`/sends/data_series`]({{site.baseurl}}/api/endpoints/export/campaigns/get_send_analytics/) | Análisis diarios de los envíos de campañas con seguimiento. |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation"}

...
Ce sujet doit expliquer un aspect spécifique du concept, par exemple, comment un certain type d'étape de Canvas est utilisé avec un canal. Pour savoir comment procéder en situation réelle, consultez [ce lien vers le tutoriel]().
...
| My First Heading | Nous recommandons de le mettre en majuscules. Ce champ est facultatif. |

    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      $('#doc_form').submit(function(e) {
        ...
        $.ajax({
          ...
          $('#submit_text').html('Envoyer la demande');
          $('#ticket_submit_button').prop("disabled",false);
          alert('Un problème est survenu lors de l\u2019envoi de votre demande. Veuillez réessayer.');
        });
        ...
        <form id="doc_form">
          <div class="row">
            <div class="col">
              ...
              <p class="subhead">Tous les champs sont requis, sauf indication contraire.</p>
          ...
          <div class="row">
            <div class="col">
              ...
              <option value="urgent">Urgent : je signale un problème sur Braze Docs ou j'ai une mise à jour hautement prioritaire</option>
              <option value="feature">Fonctionnalité : j'ai une nouvelle fonctionnalité ou un nouveau comportement pour une fonctionnalité existante</option>
              <option value="suggestion" selected="selected">Suggestion : j'ai une amélioration à proposer ou j'ai besoin d'une clarification pour un article</option>
              </select>
              ...
              <div class="form-group">
                <label for="doc_due_date" id="doc_due_date_label">Date d'échéance (facultatif)</label>
                <div class="sublabel">Si cette demande est urgente ou liée à la sortie d'une fonctionnalité, veuillez indiquer une date d'échéance.</div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="email" class="form-control email-input" id="doc_email" maxlength="80" name="Email" placeholder="ex. : prenom.nom@braze.com" required="required" value="" />
              ...
              <div class="form-group" id="doc_request_url">
                <label for="doc_request" id="doc_request_url_label">URL Braze</label>
                <input type="url" name="Request_Url" id="doc_request_url" maxlength="180" required="required" value="" placeholder="ex. : {{ site.homeurl }}{{ site.baseurl }}/" class="form-control" />
              </div>

              <div class="form-group">

                <label for="doc_description" id="doc_description_label" style="margin-bottom:6px;line-height:1.2;">Description</label>
                <div class="sublabel" style="margin-bottom:6px;">Fournissez autant de détails que possible sur la mise à jour demandée.</div>
              ...
              <div class="form-group" id="resource_urls">
                <label for="resource_urls" id="resource_urls_label">URL des ressources</label>
                 <div class="sublabel" style="margin-bottom:6px;">Incluez les URL provenant de Confluence, Productboard, Google Docs, Jira ou de toute autre ressource relative à cette fonctionnalité.</div>
              ...
              <div class="form-check">
                ...
                <span></span> J'ai vérifié ces informations auprès de l'équipe produit concernée
              </label>
              </div>
              </div>
              <div class="inline_text">
              Veuillez patienter jusqu'à dix secondes après l'envoi pour que votre demande soit traitée.
              </div>
              ...
              <div id="submit_text"> Envoyer la demande </div></button>

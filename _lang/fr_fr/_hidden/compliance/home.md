...
# Documentation de conformité {#compliance-documentation}
...
Vous pouvez vous abonner pour recevoir les mises à jour de notre documentation (y compris la documentation de conformité) via le [dépôt GitHub de Braze](https://github.com/braze-inc/release-notes).
...
### Normes et bonnes pratiques industrielles applicables {#applicable-industry-standards-and-best-practices}
...
### Clauses de non-responsabilité {#disclaimers}
...
### Conditions d'utilisation du canal webhooks {#webhooks-channel-use-terms}
...
### Exceptions aux conditions d'utilisation du canal webhooks {#exceptions-to-the-webhook-channel-use-terms}
...
### Fournisseurs de LLM en tant que sous-traitants ou fournisseurs tiers {#llm-providers-as-sub-processors-or-third-party-providers}

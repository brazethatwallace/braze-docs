...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Liens profonds avec schéma personnalisé" }
...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Ouvrir l'URL web dans l'application" }

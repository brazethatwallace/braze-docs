...
{% alert warning %}
Ajoutez le SDK Braze Cordova uniquement en utilisant les méthodes décrites ci-dessous. N'essayez pas de l'installer par d'autres moyens, car cela pourrait entraîner une faille de sécurité.
{% endalert %}
``` text

...
- **Notifications push** : invites de permission, enregistrement de jetons, écouteurs de payload (voir **Notifications push**)
...
1. Installez le package npm depuis **Installation**.

...
| --- | --- |
| Clé REST API de Braze | Une clé disposant de l'autorisation `users.track` et, si vous gérez les catalogues via l'API, des autorisations de catalogues correspondantes. Pour en créer une, accédez à **Paramètres** > **Clés API**. |
...
#### Recommander un article spécifique du catalogue {#recommend-a-specific-catalog-item}
...
#### Recommander plusieurs articles du catalogue {#recommend-multiple-catalog-items}
...
#### Créer un modèle d'articles à partir de la recommandation d'un utilisateur {#template-items-using-a-users-recommendation}

...
## Ajouter des propriétés de métadonnées {#adding-metadata-properties}
...
Plusieurs propriétés peuvent être enregistrées chaque fois qu'un événement personnalisé est consigné.

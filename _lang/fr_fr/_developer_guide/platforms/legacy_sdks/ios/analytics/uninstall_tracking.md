...
2. Sur la page **Paramètres**, ajoutez la clé `appboy_uninstall_tracking` avec la valeur correspondante `true` et cochez **Add Content-Available Flag**.<br><br>
3. Utilisez la page **Prévisualisation** pour vous envoyer une notification push de test de suivi des désinstallations.<br><br>

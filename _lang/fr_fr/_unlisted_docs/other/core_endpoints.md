---
nav_title: Endpoints principaux
permalink: "/core_endpoints/"
hidden: true
layout: dev_guide
---

# Endpoints principaux de l'API Braze {#braze-core-api-endpoints}
...
Les endpoints principaux de l'API Braze sont des endpoints spécifiques de la REST API de Braze qui disposent d'un temps d'arrêt autorisé conformément à l'accord de niveau de service (SLA) d'un compte Braze. Pour plus d'informations, consultez votre documentation SLA ou contactez votre gestionnaire de compte.

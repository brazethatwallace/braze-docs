...
- Braze ne transmet pas et ne stocke pas les événements personnalisés en tant que points de donnée dans Braze pour un maximum de 12 emplacements/noms d'événements par déploiement du SDK.

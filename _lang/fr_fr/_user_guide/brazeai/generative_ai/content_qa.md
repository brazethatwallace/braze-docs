...
article_title: Assurance qualité du contenu avec l'intelligence artificielle
page_order: 4
...
# Assurance qualité du contenu avec BrazeAI {#content-qa-with-brazeai}
...
| Prise en charge multilingue | Bien qu'il ne soit pas officiellement pris en charge par OpenAI, GPT peut comprendre [plusieurs langues](https://openai.com/research/gpt-4#:~:text=GPT%2D4%203%2Dshot%20accuracy%20on%20MMLU%20across%20languages). Gardez à l'esprit que Braze ne transmet aucune information sur la langue ou la locale de votre texte lorsqu'il est envoyé à OpenAI, de sorte que vos résultats peuvent varier en fonction de la langue dans laquelle vous écrivez. |
{: .reset-td-br-1 .reset-td-br-2 aria-label="Supported features" }

## Utiliser BrazeAI<sup>TM</sup> pour l'assurance qualité du contenu {#using-brazeaitm-to-qa-content}

{% alert note %}
Cette fonctionnalité n'est actuellement disponible que pour les SMS, les notifications push Android, les notifications push iOS et les messages in-app traditionnels.
{% endalert %}

1. Après avoir rédigé une notification push mobile, un SMS ou un message in-app traditionnel, accédez à l'onglet **Test**.
2. Recherchez la section **Content QA with AI**.
3. Cliquez sur **Test Content**.

![Section « Content QA with AI » de l'onglet « Test ».]({% image_buster /assets/img/content_qa_ai.png %})
...
- **Relisez votre message :** bien que le vérificateur de contenu puisse aider à identifier les erreurs, une relecture manuelle de votre contenu reste essentielle. Les suggestions générées par l'intelligence artificielle constituent un guide utile, mais faites preuve de discernement pour garantir l'exactitude de votre texte.
...
- **Vérifiez minutieusement le langage offensant signalé :** la détection du langage offensant est conçue pour être robuste, mais il peut arriver qu'elle signale certains faux positifs. Examinez attentivement les sections signalées et apportez les modifications nécessaires.

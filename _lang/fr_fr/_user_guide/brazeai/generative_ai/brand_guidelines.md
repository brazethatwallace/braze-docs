...
# Générer des directives de marque avec BrazeAI
...
1. Dans votre compositeur de messages, recherchez et sélectionnez <i class="fa-solid fa-wand-magic-sparkles" title="AI Copywriter"></i> pour [ouvrir l'assistant de rédaction de l'intelligence artificielle]({{site.baseurl}}/user_guide/brazeai/generative_ai/copywriting/#access).
...
4. Pour la rubrique **Dans quels cas utiliserez-vous ces directives de marque ?**, ajoutez des détails afin d'aider vos collègues (et vous à l'avenir) à comprendre le contexte d'utilisation de cette directive.
...
## Modifier les directives existantes

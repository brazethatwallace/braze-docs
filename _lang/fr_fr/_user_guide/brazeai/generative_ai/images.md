...
3. Sélectionnez **Generate Images**. La génération des images peut prendre environ une minute.
4. Sélectionnez <i class="fas fa-download" title="Ajouter image à la bibliothèque multimédia"></i> sur les images que vous souhaitez ajouter à votre bibliothèque multimédia.

![Fenêtre modale du générateur d'images par intelligence artificielle dans la bibliothèque multimédia.]({% image_buster /assets/img_archive/media_library_dalle.png %}){: style="max-width:75%"}

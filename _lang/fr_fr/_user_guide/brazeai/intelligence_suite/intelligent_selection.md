...
{% tabs %}
{% tab Campaign %}
La sélection intelligente peut être ajoutée à n'importe quelle campagne multi-envoi dans l'étape **Target Audiences** du compositeur de campagne de Braze. Les campagnes qui n'envoient qu'une seule fois ne peuvent pas bénéficier de cette fonctionnalité.
...
La sélection intelligente ne sera pas disponible si vous n'avez pas encore ajouté d'événements de conversion à votre Canvas ou si votre campagne est composée d'une seule variante.
{% endtab %}
{% endtabs %}

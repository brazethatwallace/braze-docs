...
page_order: 1
page_type: reference
description: "Cet article de référence décrit les étapes pour créer une transformation à l'aide de la Transformation des données Braze."
---
...
{% tabs %}
{% tab Débutant - Suivre les utilisateurs %}
...
{% endtab %}
{% tab Débutant - Mettre à jour les éléments du catalogue %}
...
{% endtab %}
{% tab Avancé - Suivre les utilisateurs %}
...
## Étape 5 : Surveiller votre transformation {#step-5-monitor-your-transformation}

...
## Mise en place des intégrations d'entrepôts de données {#setting-up-data-warehouse-integrations}

Les intégrations d'Ingestion de données cloud nécessitent une configuration côté Braze et dans votre instance d'entrepôt de données. Suivez ces étapes pour configurer l'intégration :
...
#### Étape 1.2 : Définir le rôle et les autorisations de la base de données {#step-12-set-up-the-role-and-database-permissions}
...
#### Étape 1.3 : Configurer l'entrepôt et donner accès au rôle Braze {#step-13-set-up-the-warehouse-and-give-access-to-braze-role}
...
#### Étape 1.5 : Autoriser les IP de Braze dans la politique réseau de Snowflake (facultatif) {#step-15-allow-braze-ips-in-snowflake-network-policy-optional}
...
#### Étape 1.2 : Créer un utilisateur et accorder les autorisations {#step-12-create-user-and-grant-permissions}
...
#### Étape 1.3 : Autoriser l'accès aux IP de Braze {#step-13-allow-access-to-braze-ips}
...
#### Étape 1.2 : Créer un compte de service et accorder les autorisations {#step-12-create-a-service-account-and-grant-permissions}
...
3. Saisissez un commentaire pour identifier ce jeton, par exemple « Braze CDI », et définissez la durée de vie du jeton sur illimitée en laissant la case Lifetime (days) vide.
...
#### Étape 1.6 : Autoriser les IP de Braze dans le pare-feu (facultatif) {#step-16-allow-braze-ips-in-firewall-optional}

...
- **Créer une liste d'utilisateurs dans le tableau de bord :** Créez un segment avec un filtre **Entered Canvas Variation**, puis exportez le segment en CSV. Consultez la [résolution des problèmes de Canvas]({{site.baseurl}}/user_guide/messaging/canvas/troubleshooting#user-didnt-enter-a-canvas).

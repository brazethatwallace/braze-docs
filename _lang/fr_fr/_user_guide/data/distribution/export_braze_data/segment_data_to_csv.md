...
page_order: 4
page_type: reference
description: "Cet article de référence explique comment exporter les données d'un segment au format CSV."

---

# Exporter les données de segment au format CSV
...
![Section Détails du segment avec le menu déroulant Données utilisateur affichant les options d'exportation.]({% image_buster /assets/img_archive/csvexport.png %})

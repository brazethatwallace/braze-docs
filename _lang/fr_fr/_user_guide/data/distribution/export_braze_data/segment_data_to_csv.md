...
{: .reset-td-br-1 .reset-td-br-2 aria-label="Exporter les données utilisateur en CSV" }
...
| user_aliases                | Alias de l'utilisateur, le cas échéant |
{: .reset-td-br-1 .reset-td-br-2 aria-label="Exporter les adresses e-mail en CSV" }

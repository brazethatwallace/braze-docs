...
# [![Cours d'apprentissage Braze]({% image_buster /assets/img/bl_icon3.png %})](https://learning.braze.com/currents-the-basics-2/){: style="float:right;width:120px;border:0;" class="noimgborder"} Configurer Currents
...
Si nécessaire, vous pouvez en savoir plus sur nos événements dans notre article sur la [sémantique de distribution des événements]({{site.baseurl}}/user_guide/data/distribution/braze_currents/setting_up_currents/event_delivery_semantics/).

### Étape 5 : Configurez les transformations de champs

...
- Les données existantes ne seront pas disponibles tant que l'événement n'est pas débloqué.
- Cet événement n'apparaîtra pas dans les filtres ni les graphiques.

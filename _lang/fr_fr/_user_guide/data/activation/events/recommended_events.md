...
### Les événements recommandés sont-ils identiques aux événements personnalisés ? {#are-recommended-events-the-same-as-custom-events}
...
### Puis-je personnaliser le nom des événements recommandés ? {#can-i-customize-the-name-of-the-recommended-events}
...
### Puis-je toujours utiliser les événements d'achat pour enregistrer des achats ? {#can-i-still-use-purchase-events-to-log-purchases}

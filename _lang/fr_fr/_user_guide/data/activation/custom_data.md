...
### Attributs personnalisés : qui sont vos utilisateurs
...
### Événements personnalisés : ce que font vos utilisateurs
...
### Détection et modification des types de données
...
### Liste de blocage et suppression
...
Pour en savoir plus, consultez [Gérer les données personnalisées]({{site.baseurl}}/user_guide/data/activation/custom_data/managing_custom_data/) et [Liste de blocage des données personnalisées]({{site.baseurl}}/user_guide/data/activation/custom_data/blocklist_custom_data/).
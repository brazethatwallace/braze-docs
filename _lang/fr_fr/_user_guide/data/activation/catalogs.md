...
description: "Cette page d'accueil est dédiée aux catalogues. Utilisez les catalogues et les ensembles filtrés pour exploiter des données non liées aux utilisateurs dans vos campagnes Braze afin d'envoyer des messages personnalisés."
...
## Comment les catalogues et Liquid fonctionnent ensemble

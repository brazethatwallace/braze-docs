...
![Exemple de diagnostic de campagne et Canvas du 25 au 31 mai 2025 pour une campagne de série de bienvenue.]({% image_buster /assets/img/campaign_canvas_dashboard_example.png %}){: style="max-width:90%;"}
...
### Ventilation des résultats des messages
...
#### Éligibilité de l'utilisateur et profil
...
| L'utilisateur n'est pas éligible pour l'étape | L'utilisateur est sorti du Canvas parce qu'il ne satisfaisait pas les [validations de distribution]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/message_step/#delivery-validations) définies pour l'étape Message ou parce qu'il faisait partie d'une [liste de suppression]({{site.baseurl}}/user_guide/audience/suppression_lists/). |
...
| L'utilisateur n'est pas activé pour les cartes de contenu | L'utilisateur n'a utilisé aucune application incluant cette carte de contenu. |
...
### Pourquoi la somme de *Total Aborts* et *Message Sends* est-elle inférieure à la taille d'audience attendue ?
...
### Pourquoi la somme de *Total Aborts* et *Message Sends* est-elle supérieure à l'audience d'une campagne ou d'un Canvas ?

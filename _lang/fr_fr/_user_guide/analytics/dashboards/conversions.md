...
1. Accédez à **Analytique** > **Conversions**.
...
{:start="8"}
8. Sélectionnez **Créer** pour générer le rapport.
...
1. Lors de la configuration de votre rapport, activez **Utiliser des événements personnalisés**.
...
{% alert note %}
Si vous sélectionnez un événement personnalisé, le menu déroulant **Événement de conversion** ne s'affichera pas sur la page et vous devrez relancer le rapport pour consulter les conversions d'autres événements personnalisés.
{% endalert %}
...
Par défaut, toutes les campagnes et tous les Canvas sélectionnés sont affichés. Pour désélectionner une campagne ou un Canvas, cliquez sur le nom de la campagne ou du Canvas que vous souhaitez exclure. Pour obtenir des détails supplémentaires sur un événement d'engagement, survolez la barre correspondante.
...
### Pourquoi mes conversions de campagne ou de Canvas sont-elles faibles ?

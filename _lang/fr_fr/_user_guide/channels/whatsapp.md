...
La disponibilité de WhatsApp dépend de votre forfait Braze. Contactez votre gestionnaire de compte ou votre gestionnaire du succès des clients pour commencer.
...
| --- | --- |
| Support client | Activez des conversations bidirectionnelles en temps réel pour traiter les demandes, résoudre les problèmes et fournir une assistance personnalisée. |
...
| Campaigns promotionnelles | Atteignez vos clients avec des promotions ciblées, des lancements de produits et des offres personnalisées grâce à des messages enrichis en contenu multimédia. |
| Conversations bidirectionnelles | Renforcez les relations avec une communication interactive qui permet aux clients de répondre, de poser des questions et de donner leur avis. |
...
### Les utilisateurs doivent-ils s'abonner pour recevoir des messages WhatsApp ? {#do-users-need-to-opt-in-to-whatsapp-messages}

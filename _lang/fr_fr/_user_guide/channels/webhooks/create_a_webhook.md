...
Après avoir terminé la création de votre dernière campagne ou Canvas, vérifiez ses détails, testez-la, puis envoyez-la !
...
#### 403 Forbidden et liste d'autorisation d'IP {#403-forbidden-and-ip-allowlisting}
...
{% alert important %}
Si vous effectuez un webhook de Braze à Braze et que vous utilisez la liste d'autorisation, vous devez ajouter toutes les IP suivantes à la liste d'autorisation, y compris `127.0.0.1`.
{% endalert %}

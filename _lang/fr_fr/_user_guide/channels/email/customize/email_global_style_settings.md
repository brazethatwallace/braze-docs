...
## Largeur des blocs de contenu {#content-block-width}

Ce paramètre sera préconfiguré pour tous les futurs blocs de contenu. Les blocs de contenu existants ne seront pas mis à jour. Vous pouvez définir tous les blocs de contenu à 100 %, en respectant la largeur à l'endroit où un bloc de contenu est inséré, ou définir une valeur spécifique en pixels.

Nous recommandons de faire correspondre la largeur des blocs de contenu à la largeur du modèle d'e-mail.

![Largeur des blocs de contenu définie à 600 px.]({% image_buster /assets/img_archive/dnd_content_block_width_update.png %})
---
nav_title: Politiques de désengagement
article_title: Politiques de désengagement pour l'e-mail
page_order: 8
page_type: reference
description: "Cet article présente les bonnes pratiques relatives aux politiques de désengagement et explique dans quelles situations il est préférable de cesser d'envoyer des messages aux utilisateurs inactifs."
channel: email

---

# Politiques de désengagement

> Même s'il peut être tentant d'envoyer des campagnes au plus grand nombre d'utilisateurs possible, il existe des situations où il est en réalité avantageux de cesser d'envoyer des messages aux utilisateurs inactifs.

Pour les e-mails, votre adresse IP d'envoi possède un score de réputation qui prend en compte l'engagement, les signalements de courrier indésirable, les mises en liste de blocage, et bien d'autres facteurs. Vous pouvez utiliser des outils comme [Sender Score](https://www.senderscore.org/) ou le [Smart Network Data Service d'Outlook](https://postmaster.live.com/snds/) pour surveiller votre score de réputation. Si votre score de réputation est régulièrement bas, les ISP et les filtres de messagerie peuvent automatiquement classer vos e-mails dans le dossier spam ou dans un dossier de faible priorité pour tous les destinataires, y compris ceux qui sont engagés. Mettre en place une politique de désengagement permet de s'assurer que vos e-mails sont envoyés uniquement aux destinataires actifs.

Les filtres de segmentation vous aident à éviter que vos messages ne soient perçus comme du spam en vous permettant de mettre facilement en œuvre des politiques de désengagement pour les e-mails, les notifications push et les notifications in-app. Voici quelques éléments à prendre en compte lors de la création d'une politique de désengagement :

- Qu'est-ce qui définit un utilisateur « inactif » ?

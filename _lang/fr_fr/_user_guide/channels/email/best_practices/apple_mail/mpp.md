...
page_order: 1
description: "Cet article de référence couvre la mise à jour de la protection de la confidentialité dans Apple Mail, les personnes concernées et les prochaines étapes pour se préparer à cette fonctionnalité."
channel:
  - email
...
> Cet article couvre la protection de la confidentialité dans Apple Mail (MPP), les personnes concernées et comment se préparer à son impact sur les indicateurs de livrabilité des e-mails.

## Qu'est-ce que la mise à jour de la protection de la confidentialité dans Apple Mail ?

La protection de la confidentialité dans Apple Mail (MPP) est une mise à jour de confidentialité disponible pour les utilisateurs de l'application Apple Mail sur iOS 15, iPadOS 15, macOS Monterey et watchOS 8, publiée à la mi-septembre 2021. Pour les utilisateurs qui activent la MPP (ce que la plupart des utilisateurs feront selon nos prévisions), les e-mails seront désormais préchargés via des serveurs proxy, mettant en cache les images et limitant la capacité à exploiter les pixels de suivi pour des indicateurs tels que le [suivi des ouvertures]({{site.baseurl}}/user_guide/administer/global/workspace_settings/email_preferences/#changing-location-of-tracking-pixel).

Les marques doivent s'attendre à ce que la MPP entraîne des problèmes concernant les indicateurs de livrabilité des e-mails et des difficultés avec les campagnes et Canvas existants qui se déclenchent en fonction de ces indicateurs. Pour comprendre l'impact sur la livrabilité des e-mails, consultez la section [Rapports e-mail]({{site.baseurl}}/user_guide/channels/email/reporting/).
...
- Élaborer un plan de réponse ciblé à la MPP qui aborde les ajustements d'automatisation sur la plateforme Braze, renforce les bonnes pratiques de livrabilité et développe un ensemble plus large d'indicateurs pour mesurer les performances.

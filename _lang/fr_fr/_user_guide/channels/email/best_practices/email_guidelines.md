...
> Lorsque vous créez votre campagne e-mail, il est important de garder à l'esprit la manière dont vos messages sont reçus par vos différents utilisateurs et fournisseurs de services d'e-mail marketing or e-mailing (fournisseur de services d'e-mailing).
...
- Évitez d'utiliser JavaScript, car il ne fonctionne avec aucun fournisseur de services d'e-mail marketing or e-mailing.

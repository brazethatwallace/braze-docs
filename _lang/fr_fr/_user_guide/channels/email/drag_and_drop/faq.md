...
### Est-il possible de créer des calques dans l'éditeur ? Puis-je ajouter une image d'arrière-plan, superposer une image et ajouter une couche de texte par-dessus ?
...
### Puis-je enregistrer mon e-mail par glisser-déposer en tant que modèle après l'avoir créé dans ma campagne ou mon Canvas ?
...
Non, l'éditeur par glisser-déposer ne prend pas en charge l'ajout de pièces jointes à vos e-mails.
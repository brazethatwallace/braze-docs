...
glossaries:
  ...
  - name: Smart Network Data Services (SNDS)
    description: Proposé par Windows en direct or en ligne/en production/instantané Hotmail, SNDS fournit des données aux expéditeurs basées sur les e-mails réellement envoyés aux abonnés Hotmail. Les indicateurs rapportés incluent les plaintes, les résultats du filtre SmartScreen et les détections de pièges à spam.

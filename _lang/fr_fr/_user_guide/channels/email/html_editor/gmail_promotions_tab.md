...
1. Activez le basculeur **Offre de réduction**.
2. Pour **Offre**, saisissez un court résumé de la réduction. Par exemple : « -20 % ».
...
1. Activez le basculeur **Carte d'offre**.
2. Pour **Offre**, saisissez un court résumé de la réduction. Par exemple : « -20 % sur toutes les chaussures ».
...
-  **URL de la page de l'offre :** L'URL de la page d'atterrissage spécifique à l'offre. Cela crée un bouton « Acheter maintenant » (ou similaire). Nous recommandons de fournir cette URL pour votre carte d'offre.
- **URL de la page d'accueil du marchand :** L'URL de votre page d'accueil principale. Utilisez ce champ uniquement si une URL de page d'offre spécifique n'est pas disponible.
...
1. Activez le basculeur **Cartes de promotion**.
...
4. Pour **URL cible**, ajoutez le lien de votre promotion.
...
{% alert tip %}
Pour l'éditeur par glisser-déposer, copiez et collez le code HTML généré dans la section des [balises head personnalisées]({{site.baseurl}}/user_guide/channels/email/drag_and_drop/#custom-head-tags) sous **Paramètres d'envoi**.
{% endalert %}
...
### Respecter les directives relatives aux images
...
### Comment ajouter un logo d'expéditeur ?
...
### Pourquoi ne vois-je pas les annotations dans mon onglet Promotions de Gmail ?

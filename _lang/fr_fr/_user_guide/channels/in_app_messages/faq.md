...
4. Le Liquid de deux des messages in-app contient des règles qui excluent Sam de la réception du message (par exemple, son attribut personnalisé de score n'étant pas assez élevé).

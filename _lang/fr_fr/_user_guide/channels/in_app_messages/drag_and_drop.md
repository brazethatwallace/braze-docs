...
Créez un nouveau message in-app ou une étape Canvas, puis sélectionnez **Éditeur par glisser-déposer** comme expérience d'édition.
...
Vous pouvez prévisualiser les messages depuis l'onglet **Aperçu et test**, comme si vous étiez un utilisateur. Vous pouvez sélectionner un utilisateur spécifique, un utilisateur aléatoire ou créer un utilisateur personnalisé :

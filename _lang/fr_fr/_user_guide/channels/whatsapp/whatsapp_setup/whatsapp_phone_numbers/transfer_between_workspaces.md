...
2. Accédez à **Audience** > **Subscription Group Management** et trouvez le groupe d'abonnement associé au numéro de téléphone WhatsApp que vous souhaitez déplacer.
3. Survolez l'état du groupe d'abonnement et sélectionnez <i class="fa-solid fa-box-archive"></i> **Archive**, ce qui marquera le groupe d'abonnement comme inactif sans le supprimer.

![Le bouton « Archive » apparaît au survol de l'état « Active » d'un groupe d'abonnement.]({% image_buster /assets/img/whatsapp/archive_subscription_group.png %}){: style="max-width:70%;"}
...
2. Accédez à **Partner Integrations** > **Technology Partners** > **WhatsApp**, puis faites défiler jusqu'à la section **WhatsApp Messaging Integration**.

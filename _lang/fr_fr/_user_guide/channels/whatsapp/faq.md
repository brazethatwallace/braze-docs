...
#### Dois-je utiliser un numéro de téléphone spécifique à un pays pour envoyer des messages vers certains pays ? {#do-i-need-to-use-a-country-specific-phone-number-to-send-to-certain-countries}
Non. Avec WhatsApp, tout numéro de téléphone pris en charge peut envoyer des messages aux utilisateurs finaux dans n'importe quel pays pris en charge.
...
#### Braze prend-il en charge les cas d'utilisation de support client comme les chatbots et le chat assisté par un humain pour WhatsApp ? {#does-braze-support-customer-support-use-cases-like-chatbots-and-human-assisted-chat-for-whatsapp}

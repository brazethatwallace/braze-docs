...
page_order: 2
page_type: reference
description: "Cet article de référence couvre plusieurs options de notification Android et comment les utiliser au mieux dans les Campaigns Braze."
...
Commencez par créer votre Campaign push Android, puis regardez en haut de l'onglet **Rédiger** pour trouver le menu déroulant **Notification Channel**.

![Commencez par créer votre Campaign push Android, puis regardez en haut de l'onglet « Rédiger » pour trouver le menu déroulant « Notification Channel ».]({% image_buster /assets/img_archive/notification_channel_dropdown.png %}){: style="max-width:60%;"}
...
![Pour ajouter un ID de notification à votre canal de notification, cliquez sur « Manage Notification Channel » dans le menu déroulant « Notification Channel » et remplissez les champs requis. Les canaux de notification doivent être définis dans l'application avant de pouvoir être utilisés dans la plateforme Braze.]({% image_buster /assets/img_archive/notification_channels.png %}){: style="max-width:80%;" }
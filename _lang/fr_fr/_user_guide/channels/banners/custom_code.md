...
> Lorsque vous utilisez le bloc éditeur **de code personnalisé** dans le compositeur de bannières, vous devez appeler `brazeBridge.logClick()` depuis votre code HTML personnalisé pour enregistrer les clics. Les bannières utilisent le même pont JavaScript que les messages in-app HTML : les mêmes méthodes et modèles s'appliquent donc.

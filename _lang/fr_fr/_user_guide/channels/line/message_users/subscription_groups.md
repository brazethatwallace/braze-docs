...
## Configurer le groupe d'abonnement LINE d'un utilisateur {#set-a-users-line-subscription-group}
...
## Comportement lors de l'archivage {#archive-behavior}

- **Archivage standard :** Si vous archivez un groupe d'abonnement LINE et ne réintégrez pas le canal dans un autre espace de travail, vous pouvez désarchiver le groupe d'abonnement ultérieurement.
...
Pour les étapes de réintégration du canal, consultez [Configuration LINE]({{site.baseurl}}/user_guide/channels/line/line_setup#re-integrate-a-line-channel-in-another-workspace).
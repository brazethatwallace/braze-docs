...
## Recommandations pour le suivi des désinscriptions {#opt-out-monitoring-recommendations}

Se conformer aux demandes de désinscription des destinataires est une obligation légale. Le non-respect des demandes de désinscription des destinataires de SMS peut entraîner des sanctions, y compris des amendes, et peut donner lieu à des poursuites judiciaires. Braze dispose de fonctionnalités permettant une gestion robuste des abonnements et désinscriptions SMS et MMS, ainsi que des mécanismes pour s'assurer que les demandes sont correctement traitées.
...
Les clients sont responsables de la surveillance du trafic qu'ils envoient et seront facturés pour tous les SMS envoyés via leur compte. Entre Braze et le client, c'est le client qui est le mieux placé pour détecter et prévenir le traffic pumping.
...
## Envoi en grand volume {#high-volume-sending}

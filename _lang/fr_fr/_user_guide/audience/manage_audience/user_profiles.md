...
- **E-mail :** Braze enregistre un envoi lorsque le message est transmis à votre fournisseur de services d'e-mail marketing (fournisseur de services d'e-mailing). Après cette transmission, le message n'est pas annulé en raison de la logique Liquid, de la limitation du débit ou du marquage de l'utilisateur comme injoignable. Les événements suivants sont généralement une distribution ou un rebond.

...
glossaries:
  ...
  - name: Live Activities Push to Start Registered for App
    description: "Segmente vos utilisateurs selon qu'ils sont enregistrés pour démarrer une activité en direct or en ligne/en production/instantané via les notifications push iOS pour une application spécifique."
    tags:
      - Devices

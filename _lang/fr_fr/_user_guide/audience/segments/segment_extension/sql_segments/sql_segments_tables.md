...
[USER_DEFAULT_ATTRIBUTES_HISTORY_VIEW_SHARED](#USER_DEFAULT_ATTRIBUTES_HISTORY_VIEW_SHARED) | Attributs de profil par défaut historiques avec plages de dates d'effet
...
[USER_LATEST_STATE_DEFAULT_ATTRIBUTES_VIEW_SHARED](#USER_LATEST_STATE_DEFAULT_ATTRIBUTES_VIEW_SHARED) | Attributs de profil par défaut quasi temps réel par utilisateur
[USER_CUSTOM_ATTRIBUTES_HISTORY_VIEW_SHARED](#USER_CUSTOM_ATTRIBUTES_HISTORY_VIEW_SHARED) | Attributs personnalisés de profil historiques avec plages de dates d'effet (**Snowflake Data Sharing uniquement**)
[USER_LATEST_STATE_CUSTOM_ATTRIBUTE_VIEW_SHARED](#USER_LATEST_STATE_CUSTOM_ATTRIBUTE_VIEW_SHARED) | Attributs personnalisés de profil quasi temps réel par utilisateur (**Snowflake Data Sharing uniquement**)
[USER_DEFAULT_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED](#USER_DEFAULT_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED) | Attributs de profil par défaut historiques bruts sans date de fin (**Snowflake Data Sharing uniquement**)
[USER_CUSTOM_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED](#USER_CUSTOM_ATTRIBUTES_HISTORY_RAW_VIEW_SHARED) | Attributs personnalisés de profil historiques bruts sans date de fin (**Snowflake Data Sharing uniquement**)
...
[USERS_BEHAVIORS_INSTALLATTRIBUTION_SHARED](#USERS_BEHAVIORS_INSTALLATTRIBUTION_SHARED) | Lorsqu'un utilisateur installe une application et que celle-ci est attribuée à un partenaire
...
[USERS_CAMPAIGNS_CONVERSION_SHARED](#USERS_CAMPAIGNS_CONVERSION_SHARED) | Lorsqu'un utilisateur convertit pour une Campaign
...
[USERS_CAMPAIGNS_FREQUENCYCAP_SHARED](#USERS_CAMPAIGNS_FREQUENCYCAP_SHARED) | Lorsqu'un utilisateur atteint la limitation du débit pour une Campaign
...
[USERS_CANVASSTEP_PROGRESSION_SHARED](#USERS_CANVASSTEP_PROGRESSION_SHARED) | Lorsqu'un utilisateur progresse vers une étape Canvas
...
[USERS_CANVAS_FREQUENCYCAP_SHARED](#USERS_CANVAS_FREQUENCYCAP_SHARED) | Lorsqu'un utilisateur atteint la limitation du débit pour une étape Canvas
...
[USERS_CANVAS_COSTEP_CONVERSION_SHARED](#USERS_CANVAS_COSTEP_CONVERSION_SHARED) | Événements de conversion pour l'étape Canvas d'optimisation de contenu
[USERS_CANVAS_COSTEP_SEND_SHARED](#USERS_CANVAS_COSTEP_SEND_SHARED) | Envois Canvas pour l'étape Canvas d'optimisation de contenu
...
[USERS_MESSAGES_CONTENTCARD_ABORT_SHARED](#USERS_MESSAGES_CONTENTCARD_ABORT_SHARED) | Un message Content Card initialement planifié a été annulé pour une raison quelconque.
...
[USERS_MESSAGES_EMAIL_ABORT_SHARED](#USERS_MESSAGES_EMAIL_ABORT_SHARED) | Un e-mail initialement planifié a été annulé pour une raison quelconque.
[USERS_MESSAGES_EMAIL_BOUNCE_SHARED](#USERS_MESSAGES_EMAIL_BOUNCE_SHARED) | Un fournisseur de services d'e-mailing a renvoyé un échec d'envoi définitif. Un échec d'envoi définitif signifie un échec permanent de livrabilité.
...
[USERS_MESSAGES_EMAIL_RETRY_SHARED](#USERS_MESSAGES_EMAIL_RETRY_SHARED) | Lorsqu'un e-mail est retenté après avoir été dépriorisé ou soumis à la limitation du débit (**Snowflake Data Sharing uniquement**)
...
[USERS_MESSAGES_LINE_RETRY_SHARED](#USERS_MESSAGES_LINE_RETRY_SHARED) | Lorsqu'un message LINE est retenté après avoir été dépriorisé ou soumis à la limitation du débit (**Snowflake Data Sharing uniquement**)
...
[USERS_MESSAGES_NEWSFEEDCARD_ABORT_SHARED](#USERS_MESSAGES_NEWSFEEDCARD_ABORT_SHARED) | Un message de carte News Feed initialement planifié a été annulé pour une raison quelconque
...
[USERS_MESSAGES_PUSHNOTIFICATION_ABORT_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_ABORT_SHARED) | Un message de notification push initialement planifié a été annulé pour une raison quelconque.
[USERS_MESSAGES_PUSHNOTIFICATION_BOUNCE_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_BOUNCE_SHARED) | Lorsqu'une notification push est rejetée
...
[USERS_MESSAGES_PUSHNOTIFICATION_OPEN_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_OPEN_SHARED) | Lorsqu'un utilisateur ouvre une notification push ou clique sur un bouton de notification push (y compris un bouton FERMER qui N'ouvre PAS l'application). <br><br> Les actions de boutons push ont plusieurs résultats. Non, Refuser et Annuler sont des « clics », et Accepter est une « ouverture ». Les deux sont représentés dans cette table, mais ils peuvent être distingués dans la colonne **BUTTON_ACTION_TYPE**. Par exemple, une requête peut être utilisée pour regrouper par un `BUTTON_ACTION_TYPE` qui n'est pas Non, Refuser ou Annuler.
...
[USERS_MESSAGES_RCS_CLICK_SHARED](#USERS_MESSAGES_RCS_CLICK_SHARED) | Lorsque l'utilisateur final interagit avec un message RCS en tapant ou en cliquant sur un élément de l'interface
[USERS_MESSAGES_RCS_DELIVERY_SHARED](#USERS_MESSAGES_RCS_DELIVERY_SHARED) | Lorsqu'un message RCS est distribué avec succès sur l'appareil mobile d'un utilisateur final
...
[USERS_MESSAGES_SMS_DELIVERYFAILURE_SHARED](#USERS_MESSAGES_SMS_DELIVERYFAILURE_SHARED) | Lorsque Braze est incapable de distribuer le message SMS au fournisseur de services SMS
...
[USERS_MESSAGES_SMS_RETRY_SHARED](#USERS_MESSAGES_SMS_RETRY_SHARED) | Lorsqu'un message SMS est retenté après avoir été dépriorisé ou soumis à la limitation du débit (**Snowflake Data Sharing uniquement**)
...
[USERS_MESSAGES_WEBHOOK_RETRY_SHARED](#USERS_MESSAGES_WEBHOOK_RETRY_SHARED) | Lorsqu'un message webhook est retenté après avoir été dépriorisé ou soumis à la limitation du débit (**Snowflake Data Sharing uniquement**)
...
[USERS_MESSAGES_WHATSAPP_RETRY_SHARED](#USERS_MESSAGES_WHATSAPP_RETRY_SHARED) | Lorsqu'un message WhatsApp est retenté après avoir été dépriorisé ou soumis à la limitation du débit (**Snowflake Data Sharing uniquement**)
[USERS_MESSAGES_BANNER_DISMISS_SHARED](#USERS_MESSAGES_BANNER_DISMISS_SHARED) | Lorsqu'un utilisateur ferme une bannière.
[USERS_MESSAGES_LANDINGPAGE_CLICK_SHARED](#USERS_MESSAGES_LANDINGPAGE_CLICK_SHARED) | Cet événement se produit lorsqu'un utilisateur final clique sur certains éléments et champs de formulaire d'une page de destination
[USERS_MESSAGES_LANDINGPAGE_FORMSUBMISSION_SHARED](#USERS_MESSAGES_LANDINGPAGE_FORMSUBMISSION_SHARED) | Cet événement se produit lorsqu'un utilisateur final remplit un formulaire sur une page de destination et clique sur le bouton pour soumettre les informations
[USERS_MESSAGES_LANDINGPAGE_IMPRESSION_SHARED](#USERS_MESSAGES_LANDINGPAGE_IMPRESSION_SHARED) | Cet événement se produit lorsque le navigateur d'un utilisateur final charge et affiche une page de destination
[USERS_MESSAGES_PUSHNOTIFICATION_RETRY_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_RETRY_SHARED) | Cet événement se produit lorsqu'un message est dépriorisé ou soumis à la limitation du débit et sera retenté ultérieurement dans la fenêtre de nouvelle tentative configurée. Disponible uniquement pour les clients bêta de la priorisation des messages
[USERS_MESSAGES_SURVEY_RESPONSE_SHARED](#USERS_MESSAGES_SURVEY_RESPONSE_SHARED) | Réponses aux enquêtes soumises par les utilisateurs finaux
...
[USERS_PROFILE_UPDATE_SHARED](#USERS_PROFILE_UPDATE_SHARED) | Message représentant les mises à jour de profil d'un utilisateur
[SNAPSHOTS_APP_SHARED](#SNAPSHOTS_APP_SHARED) | Instantanés d'application (**Snowflake Data Sharing uniquement**)
[SNAPSHOTS_CAMPAIGN_MESSAGE_VARIATION_SHARED](#SNAPSHOTS_CAMPAIGN_MESSAGE_VARIATION_SHARED) | Instantanés de variantes de messages Campaign (**Snowflake Data Sharing uniquement**)
...
[CONTENTOPTIMIZER_COMPONENTSTORE_SHARED](#CONTENTOPTIMIZER_COMPONENTSTORE_SHARED) | Mises à jour du magasin de composants
...
`canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape Canvas
`error` | `string` | Nom de l'erreur
`thinking_level` | `string` | Niveau de réflexion/raisonnement utilisé pour la requête
...
`app_id` | `string` | ID BSON de l'application
`update_source` | `string` | Source de la mise à jour du profil
`time` | `int` | Horodatage UNIX en secondes de la mise à jour du profil
`archived` | `boolean` | Indique si le profil utilisateur est archivé
`sf_updated_at` | `timestamp` | Date à laquelle cette ligne a été mise à jour dans Snowflake
`first_name` | `string` | [PII] Prénom
`last_name` | `string` | [PII] Nom de famille
...
Champ | Type | Description
------|------|------------
`id` | `string` | ID globalement unique pour cet événement
...
`global_control_group` | `null, boolean` | Avec ce changement, le numéro de compartiment est inclus dans le groupe de contrôle global
`previous_global_control_group` | `null, boolean` | Avant ce changement, le numéro de compartiment était inclus dans le groupe de contrôle global, mais il ne l'est plus
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application sur laquelle cette action a eu lieu
...
`device_id` | `null,`&nbsp;`string` | ID de l'appareil sur lequel l'événement personnalisé a eu lieu
...
------|------|------------
`id` | `string` | ID globalement unique pour cet événement
`user_id` | `string` | ID Braze de l'utilisateur qui a effectué l'installation
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
...
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application sur laquelle cette localisation a été enregistrée
...
`sdk_version` | `null,`&nbsp;`string` | Version du SDK Braze utilisée lorsque la localisation a été enregistrée
`platform` | `null,`&nbsp;`string` | Plateforme de l'appareil
`os_version` | `null,`&nbsp;`string` | Version du système d'exploitation de l'appareil
`device_model` | `null,`&nbsp;`string` | Modèle de l'appareil
`ad_id` | `null,`&nbsp;`string` | [PII] Identifiant publicitaire
...
------|------|------------
`id` | `string` | ID globalement unique pour cet événement
`user_id` | `string` | ID Braze de l'utilisateur qui a désinstallé
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`device_id` | `null,`&nbsp;`string` | `device_id` lié à cet utilisateur si l'utilisateur est anonyme
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application qui a été désinstallée
`time` | `int` | Horodatage Unix auquel l'utilisateur a effectué la désinstallation
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application que l'utilisateur a mise à jour
...
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application sur laquelle cette session a eu lieu
`time` | `int` | Horodatage Unix auquel la session a démarré
...
------|------|------------
`id` | `string` | ID globalement unique pour cet événement
`user_id` | `string` | ID Braze de l'utilisateur qui a effectué cet événement
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`app_group_api_id` | `null,`&nbsp;`string` | ID API du groupe d'applications auquel cet utilisateur appartient
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application sur laquelle cet événement a eu lieu
`time` | `int` | Horodatage UNIX auquel l'événement a eu lieu
`device_id` | `null,`&nbsp;`string` | ID de l'appareil sur lequel l'événement a eu lieu
`sdk_version` | `null,`&nbsp;`string` | Version du SDK Braze utilisée lors de l'événement
`platform` | `null,`&nbsp;`string` | Plateforme de l'appareil
`os_version` | `null,`&nbsp;`string` | Version du système d'exploitation de l'appareil
`device_model` | `null,`&nbsp;`string` | Modèle de l'appareil
...
`location_set_id` | `string` | ID de l'ensemble d'emplacements du géorepérage déclenché
...
`id` | `string` | ID globalement unique pour cet événement
`time` | `int` | Horodatage UNIX auquel l'événement a eu lieu
`time_ms` | `int` | Heure en millisecondes à laquelle l'événement a eu lieu
`user_id` | `string` | ID Braze de l'utilisateur qui a effectué cet événement
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`sdk_version` | `null,`&nbsp;`string` | Version du SDK Braze utilisée lors de l'événement
`platform` | `null,`&nbsp;`string` | Plateforme de l'appareil
...
`push_token_foreground_push_disabled` | `null, boolean` | Indicateur de désactivation de la notification push au premier plan pour le jeton push
`push_token_device_id` | `null,`&nbsp;`string` | ID d'appareil du jeton push
...
`channel` | `null,`&nbsp;`string` | Canal de l'état d'abonnement global, par exemple l'e-mail
`time` | `int` | Horodatage Unix auquel l'état d'abonnement a changé
`timezone` | `null,`&nbsp;`string` | Fuseau horaire de l'utilisateur
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application à laquelle l'événement appartient
`campaign_id` | `null,`&nbsp;`string` | ID Braze interne de la Campaign à laquelle cet événement appartient
...
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`channel_identifier` | `null,`&nbsp;`string` | [PII] Identifiant de l'utilisateur sur le canal associé à l'événement
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`campaign_name` | `string` | Nom de la Campaign
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
`canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape Canvas
...
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel appartient ce message
...
`sf_created_at` | `timestamp`,&nbsp;`null` | Date et heure auxquelles cet événement a été capté par le Snowpipe
...
| `canvas_id`                            | `string`,&nbsp;`null`    | (Réservé à Braze) ID du Canvas auquel cet événement appartient                                                  |
| `canvas_api_id`                        | `string`,&nbsp;`null`    | ID API du Canvas auquel cet événement appartient                                                                |
| `canvas_variation_api_id`              | `string`,&nbsp;`null`    | ID API de la variante Canvas à laquelle cet événement appartient                                                |
...
| `is_canvas_entry`                      | `boolean`,&nbsp;`null`   | Indique s'il s'agit d'une entrée dans une première étape du Canvas                                              |
| `exit_reason`                          | `string`,&nbsp;`null`    | En cas de sortie, raison pour laquelle l'utilisateur a quitté le Canvas pendant l'étape                         |
...
| `sf_created_at`                        | `timestamp`,&nbsp;`null` | Date et heure à laquelle cet événement a été récupéré par le Snowpipe                                           |
| `canvas_name` | `string` | Nom du Canvas |
| `canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur |
| `canvas_step_name` | `string` | Nom de l'étape du Canvas |
...
| `canvas_variation_api_id`              | `string`,&nbsp;`null`    | ID API de la variante Canvas à laquelle cet événement appartient                                                |
| `canvas_step_api_id`                   | `string`,&nbsp;`null`    | ID API de l'étape du Canvas à laquelle cet événement appartient                                                 |
| `canvas_step_message_variation_api_id` | `string`,&nbsp;`null`    | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur                                 |
...
| `canvas_api_id`           | `string`,&nbsp;`null`    | ID API du Canvas auquel cet événement appartient                     |
| `canvas_variation_api_id` | `string`,&nbsp;`null`    | ID API de la variante Canvas à laquelle cet événement appartient     |
| `canvas_step_api_id`      | `string`,&nbsp;`null`    | [Déprécié] ID API de l'étape du Canvas à laquelle cet événement appartient |
| `gender`                  | `string`,&nbsp;`null`    | [PII] Genre de l'utilisateur                                         |
| `country`                 | `string`,&nbsp;`null`    | [PII] Pays de l'utilisateur                                          |
| `timezone`                | `string`,&nbsp;`null`    | Fuseau horaire de l'utilisateur                                       |
| `language`                | `string`,&nbsp;`null`    | [PII] Langue de l'utilisateur                                        |
| `in_control_group`        | `boolean`,&nbsp;`null`   | True si l'utilisateur a été inscrit dans le groupe de contrôle        |
| `sf_created_at`           | `timestamp`,&nbsp;`null` | Date et heure à laquelle cet événement a été récupéré par le Snowpipe |
| `canvas_name` | `string` | Nom du Canvas |
| `canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur |
| `canvas_step_name` | `string` | Nom de l'étape du Canvas |
...
| `canvas_variation_api_id`   | `string`,&nbsp;`null`    | ID API de la variante Canvas à laquelle cet événement appartient                                                |
| `canvas_step_api_id`        | `string`,&nbsp;`null`    | ID API de l'étape du Canvas à laquelle cet événement appartient                                                 |
| `experiment_step_api_id`    | `string`,&nbsp;`null`    | ID API de l'étape d'expérience à laquelle cet événement appartient                                              |
| `conversion_behavior_index` | `int`,&nbsp;`null`       | Type d'événement de conversion effectué par l'utilisateur, où « 0 » correspond à une conversion principale et « 1 » à une conversion secondaire |
| `sf_created_at`             | `timestamp`,&nbsp;`null` | Date et heure à laquelle cet événement a été récupéré par le Snowpipe                                           |
...
| `canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur |
| `canvas_step_name` | `string` | Nom de l'étape du Canvas |
| `experiment_split_name` | `string` | Nom de la branche d'expérience |
| `conversion_behavior` | `string` | Chaîne encodée en JSON décrivant le comportement de conversion |
...
| `in_control_group`        | `boolean`,&nbsp;`null`   | True si l'utilisateur a été inscrit dans le groupe de contrôle        |
| `sf_created_at`           | `timestamp`,&nbsp;`null` | Date et heure à laquelle cet événement a été récupéré par le Snowpipe |
| `experiment_split_api_id` | `string` | ID API de la branche d'expérience dans laquelle l'utilisateur a été inscrit |
| `canvas_name` | `string` | Nom du Canvas |
| `canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur |
| `canvas_step_name` | `string` | Nom de l'étape du Canvas |
| `experiment_split_name` | `string` | Nom de la branche d'expérience |
...
| `canvas_step_api_id`                   | `string`,&nbsp;`null`    | ID API de l'étape du Canvas à laquelle cet événement appartient      |
| `canvas_step_message_variation_api_id` | `string`,&nbsp;`null`    | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur |
| `channel`                              | `string`,&nbsp;`null`    | Canal de communication auquel cet événement appartient (e-mail, notification push, etc.) |
| `gender`                               | `string`,&nbsp;`null`    | [PII] Genre de l'utilisateur                                         |
| `country`                              | `string`,&nbsp;`null`    | [PII] Pays de l'utilisateur                                          |
| `timezone`                             | `string`,&nbsp;`null`    | Fuseau horaire de l'utilisateur                                       |
| `language`                             | `string`,&nbsp;`null`    | [PII] Langue de l'utilisateur                                        |
...
Champ | Type | Description
------|------|------------
`app_group_api_id` | `string` | ID API du groupe d'applications auquel cet utilisateur appartient
`app_group_id` | `string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`external_user_id` | `string` | [PII] ID externe de l'utilisateur
`id` | `string` | ID unique global de cet événement
`time` | `int` | Horodatage UNIX de l'événement
`user_id` | `string` | [PII] ID Braze de l'utilisateur qui a effectué cet événement
`dispatch_id` | `string` | ID de l'envoi auquel ce message appartient
`channel` | `string` | Canal auquel cet événement appartient
`conversion_type` | `string` | Type de conversion (ouverture ou clic)
`combination_token` | `string` | Combinaison de composants attribuée
`sf_created_at` | `timestamp` | Date et heure à laquelle cet événement a été récupéré par le Snowpipe
...
`dispatch_id` | `string` | ID de l'envoi auquel ce message appartient
`channel` | `string` | Canal auquel cet événement appartient
`canvas_id` | `string` | ID BSON du Canvas auquel cet événement appartient
`canvas_variation_api_id` | `string` | ID API de la variante Canvas à laquelle cet événement appartient
`content_optimizer_step_id` | `string` | ID interne de l'étape CO
`combination_token` | `string` | Combinaison de composants attribuée
`sf_created_at` | `timestamp` | Date et heure à laquelle cet événement a été récupéré par le Snowpipe
...
`browser` | `null,`&nbsp;`string` | Navigateur de l'appareil — extrait de user_agent — sur lequel l'ouverture a eu lieu
`ad_id` | `null,`&nbsp;`string` | [PII] Identifiant publicitaire
`ad_id_type` | `null,`&nbsp;`string` | Un parmi ['ios_idfa', 'google_ad_id', 'windows_ad_id', 'roku_ad_id']
`ad_tracking_enabled` | `null, boolean` | Indique si le suivi publicitaire est activé pour l'appareil
`abort_type` | `null,`&nbsp;`string` | Type d'abandon. Pour la liste des valeurs, voir [Types d'abandon](#abort-types).
`abort_log` | `null,`&nbsp;`string` | [PII] Message de journal décrivant les détails de l'abandon (jusqu'à 128 caractères)
`banner_placement_id` | `null,`&nbsp;`string` | ID d'emplacement de bannière spécifié par le client
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`campaign_name` | `string` | Nom de la Campaign
`message_variation_name` | `string` | Nom de la variante de message
`canvas_id` | `string` | ID BSON du Canvas auquel cet événement appartient
`canvas_name` | `string` | Nom du Canvas
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`canvas_variation_name` | `string` | Nom de la variante du Canvas reçue par cet utilisateur
`canvas_api_id` | `string` | ID API du Canvas auquel cet événement appartient
`canvas_step_api_id` | `string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `string` | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur
`canvas_variation_api_id` | `string` | ID API de la variante du Canvas à laquelle cet événement appartient
...
`canvas_variation_api_id` | `string` | ID API de la variante du Canvas à laquelle cet événement appartient
`canvas_variation_name` | `string` | Nom de la variante du Canvas reçue par cet utilisateur
`is_unique` | `boolean` | Indique si cet événement a été considéré comme unique sur 7 jours lors du traitement
...
`ip_pool` | `null,`&nbsp;`string` | Pool d'adresses IP depuis lequel l'e-mail a été envoyé
`abort_type` | `null,`&nbsp;`string` | Type d'abandon. Pour la liste des valeurs, voir [Types d'abandon](#abort-types).
`abort_log` | `null,`&nbsp;`string` | [PII] Message de journal décrivant les détails de l'abandon (2 000 caractères maximum)
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`canvas_variation_name` | `string` | Nom de la variante du Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`message_extras` | `string` | [PII] Chaîne JSON des paires clé-valeur étiquetées lors du rendu Liquid
...
`language` | `null,`&nbsp;`string` | [PII] Langue de l'utilisateur
`email_address` | `string` | [PII] Adresse e-mail de l'utilisateur
`sending_ip` | `null,`&nbsp;`string` | Adresse IP depuis laquelle l'e-mail a été envoyé
`ip_pool` | `null,`&nbsp;`string` | Pool d'adresses IP depuis lequel l'e-mail a été envoyé
`bounce_reason` | `null,`&nbsp;`string` | [PII] Code de raison SMTP et message lisible reçus pour cet événement de rebond
...
`canvas_variation_name` | `string` | Nom de la variante du Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`send_time` | `int` | Heure de l'événement d'envoi correspondant
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="USERSMESSAGESEMAILBOUNCESHARED #USERSMESSAGESEMAILBOUNCESHARED" }

{% alert note %}
Il est possible de voir plusieurs lignes pour le même utilisateur autour d'un même échec d'envoi définitif. Cela peut se produire lorsque les événements sont traités de manière asynchrone ou lorsque les envois associés ont des valeurs `dispatch_id` différentes. Lors de la déduplication ou de l'analyse des exports, tenez compte conjointement de `dispatch_id`, `time` et `id`.
{% endalert %}
...
`canvas_id` | `null,`&nbsp;`string` | ID Braze à usage interne du Canvas auquel cet événement appartient
`canvas_api_id` | `null,`&nbsp;`string` | ID API du Canvas auquel cet événement appartient
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de Canvas à laquelle cet événement appartient
`canvas_step_api_id` | `null,`&nbsp;`string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur
`gender` | `null,`&nbsp;`string` | [PII] Genre de l'utilisateur
`country` | `null,`&nbsp;`string` | [PII] Pays de l'utilisateur
...
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
`canvas_variation_name` | `string` | Nom de la variante de Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`send_time` | `int` | Heure de l'événement d'envoi correspondant
`has_url_parameters` | `boolean` | Indique si l'URL cliquée contenait des paramètres de requête
`link_aliasing_enabled` | `boolean` | Indique si l'aliasage de lien était activé pour l'espace de travail lorsque ce clic a été traité
...
`timezone` | `null,`&nbsp;`string` | Fuseau horaire de l'utilisateur
`deferral_reason` | `null,`&nbsp;`string` | [PII] Code de motif SMTP et message convivial reçus pour cet événement de report
...
`ip_pool` | `null,`&nbsp;`string` | Pool IP à partir duquel l'e-mail a été envoyé
`machine_open` | `null,`&nbsp;`string` | Renseigné à « true » si l'événement d'ouverture est déclenché sans interaction de l'utilisateur, par exemple par un appareil Apple avec la protection de la confidentialité dans Mail activée. La valeur peut changer au fil du temps pour offrir plus de granularité.
`esp` | `null,`&nbsp;`string` | Fournisseur de services d'e-mailing lié à l'événement (SparkPost, SendGrid ou Amazon SES)
`from_domain` | `null,`&nbsp;`string` | Domaine d'envoi de l'e-mail
`is_amp` | `null, boolean` | Indique qu'il s'agit d'un événement AMP
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
...
`sending_ip` | `null,`&nbsp;`string` | Adresse IP à partir de laquelle l'e-mail a été envoyé
`ip_pool` | `null,`&nbsp;`string` | Pool IP à partir duquel l'e-mail a été envoyé
`bounce_reason` | `null,`&nbsp;`string` | [PII] Code de motif SMTP et message convivial reçus pour cet événement d'échec provisoire d'envoi
`esp` | `null,`&nbsp;`string` | Fournisseur de services d'e-mailing lié à l'événement (SparkPost, SendGrid ou Amazon SES)
`from_domain` | `null,`&nbsp;`string` | Domaine d'envoi de l'e-mail
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`retry_log` | `null,`&nbsp;`string` | Message de journal décrivant les détails du réessai
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
`dispatch_id` | `null,`&nbsp;`string` | ID de la distribution à laquelle ce message appartient
`campaign_id` | `null,`&nbsp;`string` | ID BSON de la campagne à laquelle cet événement appartient
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la campagne à laquelle cet événement appartient
...
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de Canvas à laquelle cet événement appartient
`feature_flag_id_name` | `null,`&nbsp;`string` | Identifiant de déploiement du Feature Flag
`message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message reçue par cet utilisateur
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`device_id` | `null,`&nbsp;`string` | ID de l'appareil sur lequel l'événement s'est produit
`time` | `int` | Horodatage UNIX de l'événement
...
`ad_id` | `null,`&nbsp;`string` | [PII] Identifiant publicitaire
`ad_id_type` | `null,`&nbsp;`string` | `ios_idfa`, `google_ad_id`, `windows_ad_id` ou `roku_ad_id`
`ad_tracking_enabled` | `null, boolean` | Indique si le suivi publicitaire est activé pour l'appareil
...
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`dispatch_id` | `string` | ID de la distribution à laquelle ce message appartient
`campaign_name` | `string` | Nom de la campagne
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
`canvas_variation_name` | `string` | Nom de la variante de Canvas reçue par cet utilisateur
...
`time` | `int` | Horodatage UNIX de l'événement
`user_id` | `string` | ID utilisateur Braze de l'utilisateur ayant effectué cet événement
`abort_log` | `null,`&nbsp;`string` | [PII] Message de journal décrivant les détails de l'abandon (128 caractères maximum)
`abort_type` | `null,`&nbsp;`string` | Type d'abandon. Pour la liste des valeurs, consultez [Types d'abandon](#abort-types).
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la campagne à laquelle cet événement appartient
`canvas_step_api_id` | `null,`&nbsp;`string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur
`device_id` | `null,`&nbsp;`string` | ID de l'appareil sur lequel l'événement s'est produit
`dispatch_id` | `null,`&nbsp;`string` | ID de la distribution à laquelle ce message appartient
`line_channel_id` | `null,`&nbsp;`string` | ID du canal LINE vers lequel ou à partir duquel le message a été envoyé ou reçu
`line_channel_name` | `null,`&nbsp;`string` | Nom du canal LINE vers lequel ou à partir duquel le message a été envoyé ou reçu
`message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message reçue par cet utilisateur
...
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
`is_suspected_bot_click` | `null, boolean` | Indique si cet événement a été traité comme un événement de bot
`short_url` | `null,`&nbsp;`string` | URL raccourcie cliquée
`url` | `null,`&nbsp;`string` | URL sur laquelle l'utilisateur a cliqué
`user_agent` | `null,`&nbsp;`string` | Agent utilisateur sur lequel le signalement de courrier indésirable a eu lieu
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`retry_log` | `null,`&nbsp;`string` | Message de journal décrivant les détails du réessai
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
`dispatch_id` | `null,`&nbsp;`string` | ID de distribution auquel ce message appartient
`campaign_id` | `null,`&nbsp;`string` | ID BSON de la Campaign à laquelle cet événement appartient
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la Campaign à laquelle cet événement appartient
`message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message reçue par cet utilisateur
`canvas_id` | `null,`&nbsp;`string` | ID BSON du Canvas auquel cet événement appartient
`canvas_api_id` | `null,`&nbsp;`string` | ID API du Canvas auquel cet événement appartient
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID API de la variation du Canvas à laquelle cet événement appartient
`canvas_step_api_id` | `null,`&nbsp;`string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur
`device_id` | `null,`&nbsp;`string` | ID de l'appareil sur lequel l'événement s'est produit
`line_channel_id` | `null,`&nbsp;`string` | ID du canal LINE vers lequel le message a été envoyé ou depuis lequel il a été reçu
`line_channel_name` | `null,`&nbsp;`string` | Nom du canal LINE vers lequel le message a été envoyé ou depuis lequel il a été reçu
...
`update_token` | `null,`&nbsp;`string` | Jeton de mise à jour de la Live Activity
`live_activity_event_type` | `null,`&nbsp;`string` | Type d'événement de la Live Activity. L'un des suivants : ['start', 'update', 'end']
`live_activity_event_outcome` | `null,`&nbsp;`string` | Résultat de l'événement de la Live Activity
`app_group_api_id` | `null,`&nbsp;`string` | ID API du groupe d'applications auquel cet utilisateur appartient
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application sur laquelle cet événement s'est produit
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
`canvas_variation_name` | `string` | Nom de la variation du Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`message_extras` | `string` | [PII] Chaîne JSON des paires clé-valeur balisées lors du rendu Liquid
...
`user_id` | `string` | ID Braze de l'utilisateur qui a effectué cet événement
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`push_token` | `null,`&nbsp;`string` | Jeton push ayant fait l'objet d'un rebond
`device_id` | `null,`&nbsp;`string` | `device_id` vers lequel une tentative de distribution ayant entraîné un rebond a été effectuée
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`time` | `int` | Horodatage Unix auquel l'événement s'est produit
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application sur laquelle cet événement s'est produit
`dispatch_id` | `null,`&nbsp;`string` | ID de distribution auquel ce message appartient
...
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante du Canvas à laquelle cet événement appartient
`canvas_step_api_id` | `null,`&nbsp;`string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas que cet utilisateur a reçue
`gender` | `null,`&nbsp;`string` | [PII] Genre de l'utilisateur
`country` | `null,`&nbsp;`string` | [PII] Pays de l'utilisateur
`timezone` | `null,`&nbsp;`string` | Fuseau horaire de l'utilisateur
`language` | `null,`&nbsp;`string` | [PII] Langue de l'utilisateur
...
`carrier` | `null,`&nbsp;`string` | Opérateur de l'appareil
`browser` | `null,`&nbsp;`string` | Navigateur de l'appareil
`ad_id` | `null,`&nbsp;`string` | [PII] Identifiant publicitaire de l'appareil auquel nous avons tenté d'effectuer une livraison
`ad_id_type` | `null,`&nbsp;`string` | Type de l'identifiant publicitaire
`ad_tracking_enabled` | `null, boolean` | Indique si le suivi publicitaire est activé ou non
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
...
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
`canvas_variation_name` | `string` | Nom de la variante du Canvas que cet utilisateur a reçue
`canvas_step_name` | `string` | Nom de l'étape du Canvas
...
`button_action_type` | `null,`&nbsp;`string` | Type d'action du bouton de notification push. Un des suivants : [URI, DEEP_LINK, NONE, CLOSE]. Null si le clic ne provient pas d'un bouton
...
`user_id` | `string` | ID Braze de l'utilisateur ayant effectué cet événement
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`push_token` | `null,`&nbsp;`string` | Jeton push auquel nous avons tenté d'effectuer une livraison
`device_id` | `null,`&nbsp;`string` | `device_id` auquel nous avons tenté d'effectuer une livraison
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`time` | `int` | Horodatage Unix de l'événement
`app_api_id` | `null,`&nbsp;`string` | ID API de l'application sur laquelle cet événement s'est produit
`dispatch_id` | `null,`&nbsp;`string` | ID de l'envoi auquel ce message appartient
...
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`message_extras` | `null,`&nbsp;`string` | [PII] Chaîne JSON des paires clé-valeur étiquetées lors du rendu Liquid
`is_sampled` | `null,`&nbsp;`string` | Indique si l'envoi push a été échantillonné et si un événement de livraison était attendu
`locale_key` | `null,`&nbsp;`string` | [PII] Clé correspondant aux traductions (par exemple « en-us ») utilisées pour composer ce message (null par défaut).
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été capté par le Snowpipe
`campaign_name` | `string` | Nom de la campagne
`message_variation_name` | `string` | Nom de la variante de message
...
`time` | `int` | Horodatage UNIX de l'événement
`user_id` | `string` | ID Braze de l'utilisateur ayant effectué cet événement
`abort_log` | `null,`&nbsp;`string` | [PII] Message de journal décrivant les détails de l'abandon (128 caractères max.)
`abort_type` | `null,`&nbsp;`string` | Type d'abandon. Pour la liste des valeurs, consultez [Types d'abandon](#abort-types).
`campaign_name` | `null,`&nbsp;`string` | Nom de la campagne
`canvas_id` | `null,`&nbsp;`string` | ID BSON du Canvas auquel cet événement appartient
`canvas_name` | `null,`&nbsp;`string` | Nom du Canvas
`canvas_step_name` | `null,`&nbsp;`string` | Nom de l'étape du Canvas
`canvas_variation_name` | `null,`&nbsp;`string` | Nom de la variante du Canvas que cet utilisateur a reçue
...
`canvas_step_api_id` | `null,`&nbsp;`string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas que cet utilisateur a reçue
`interaction_type` | `null,`&nbsp;`string` | Type d'interaction ayant généré le clic. Exemples de valeurs : Text URL, Reply, OpenURL
`element_label` | `null,`&nbsp;`string` | Détails optionnels sur l'élément cliqué, tels que le texte d'une réponse suggérée ou d'un bouton
`element_type` | `null,`&nbsp;`string` | Précise si un interaction_type commun aux suggestions et aux boutons provient d'une suggestion ou d'un bouton. Exemples : Suggestion, Button
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la campagne à laquelle cet événement appartient
`url` | `null,`&nbsp;`string` | URL sur laquelle l'utilisateur a cliqué
`subscription_group_api_id` | `string` | ID API du groupe d'abonnement
`canvas_variation_name` | `null,`&nbsp;`string` | Nom de la variante du Canvas que cet utilisateur a reçue
...
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas que cet utilisateur a reçue
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la campagne à laquelle cet événement appartient
`from_rcs_sender` | `null,`&nbsp;`string` | ID de l'expéditeur RCS ou nom d'agent utilisé pour envoyer le message
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été capté par le Snowpipe
`canvas_api_id` | `string` | ID API du Canvas auquel cet événement appartient
...
`canvas_name` | `null,`&nbsp;`string` | Nom du Canvas
`canvas_step_name` | `null,`&nbsp;`string` | Nom de l'étape du Canvas
`media_urls` | `null,`&nbsp;`string` | URLs de médias envoyées par l'utilisateur
`message_variation_name` | `null,`&nbsp;`string` | Nom de la variante de message
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
`user_phone_number` | `null,`&nbsp;`string` | [PII] Numéro de téléphone de l'utilisateur à partir duquel le message a été reçu
`subscription_group_api_id` | `string` | ID API du groupe d'abonnement
`message_body` | `null,`&nbsp;`string` | Réponse saisie par l'utilisateur
`to_rcs_sender` | `null,`&nbsp;`string` | Expéditeur RCS entrant auquel le message a été envoyé
`message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message que cet utilisateur a reçue
`canvas_step_api_id` | `null,`&nbsp;`string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas que cet utilisateur a reçue
...
`from_rcs_sender` | `null,`&nbsp;`string` | ID de l'expéditeur RCS ou nom d'agent utilisé pour envoyer le message
`is_sms_fallback` | `null, boolean` | Indique si un repli SMS a été tenté pour ce message RCS rejeté. Il est lié/associé à l'événement de livraison SMS
`message_variation_name` | `null,`&nbsp;`string` | Nom de la variante de message
...
`dispatch_id` | `null,`&nbsp;`string` | ID de l'envoi auquel ce message appartient
`from_rcs_sender` | `null,`&nbsp;`string` | ID de l'expéditeur RCS ou nom d'agent utilisé pour envoyer le message
`message_extras` | `null,`&nbsp;`string` | Chaîne JSON des paires clé-valeur étiquetées lors du rendu Liquid
`message_variation_name` | `null,`&nbsp;`string` | Nom de la variante de message
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
`subscription_group_api_id` | `string` | ID API du groupe d'abonnement
`to_phone_number` | `null,`&nbsp;`string` | [PII] Numéro de téléphone de l'utilisateur recevant le message au format e.164 (par exemple +14155552671)
...
`app_api_id` | `string` | ID API de l'application sur laquelle cet événement s'est produit
`campaign_id` | `string` | ID BSON de la campagne à laquelle cet événement appartient
`campaign_api_id` | `string` | ID API de la campagne à laquelle cet événement appartient
`message_variation_api_id` | `string` | ID API de la variante de message que cet utilisateur a reçue
`gender` | `string` | [PII] Genre de l'utilisateur
`country` | `string` | [PII] Pays de l'utilisateur
`TIME_ZONE` | `string` | Fuseau horaire de l'utilisateur
`language` | `string` | [PII] Langue de l'utilisateur
`device_id` | `string` | ID de l'appareil sur lequel l'événement s'est produit
`sdk_version` | `string` | Version du SDK Braze utilisée lors de l'événement
`platform` | `string` | Plateforme de l'appareil
`os_version` | `string` | Version du système d'exploitation de l'appareil
`device_model` | `string` | Modèle de l'appareil
`resolution` | `string` | Résolution de l'appareil
`carrier` | `string` | Opérateur de l'appareil
`browser` | `string` | Navigateur de l'appareil – extrait du user_agent – sur lequel l'ouverture a eu lieu
`button_id` | `string` | ID du bouton cliqué, si ce clic correspond à un clic sur un bouton
`ad_id_type` | `string` | Un des suivants : ['ios_idfa', 'google_ad_id', 'windows_ad_id', 'roku_ad_id']
`ad_tracking_enabled` | `boolean` | Indique si le suivi publicitaire est activé pour l'appareil
`banner_placement_id` | `string` | ID d'emplacement de bannière défini par le client
`campaign_name` | `string` | Nom de la campagne
`message_variation_name` | `string` | Nom de la variante de message
`canvas_api_id` | `string` | ID API du Canvas auquel cet événement appartient
`canvas_step_api_id` | `string` | ID API de l'étape du Canvas à laquelle cet événement appartient
...
`canvas_name` | `string` | Nom du Canvas
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`canvas_step_message_variation_api_id` | `string` | ID API de la variante de message de l'étape du Canvas que cet utilisateur a reçue
`canvas_variation_api_id` | `string` | ID API de la variante du Canvas à laquelle cet événement appartient
`canvas_variation_name` | `string` | Nom de la variante du Canvas que cet utilisateur a reçue
`ad_id` | `string` | [PII] Identifiant publicitaire
`is_unique` | `boolean` | Indique si cet événement a été considéré comme unique sur 7 jours lors du traitement
`sf_created_at` | `timestamp` | Date à laquelle cet événement a été capté par le Snowpipe
...
`time` | `int` | Horodatage UNIX de l'événement
`user_id` | `string` | [PII] ID Braze de l'utilisateur ayant effectué cet événement
`target` | `string` | ID de suivi configuré pour l'élément qui a été cliqué
`landing_page_api_id` | `string` | ID API de la page de destination à laquelle cet événement appartient
`landing_page_name` | `string` | Nom de la page de destination
`sf_created_at` | `timestamp` | Date à laquelle cet événement a été capté par le Snowpipe
...
`user_id` | `string` | [PII] ID Braze de l'utilisateur ayant effectué cet événement
`landing_page_api_id` | `string` | ID API de la page de destination à laquelle cet événement appartient
`liquid_enabled` | `boolean` | Booléen indiquant si la page de destination contient du Liquid et a été traitée par le pipeline de rendu Liquid.
`landing_page_name` | `string` | Nom de la page de destination
`sf_created_at` | `timestamp` | Date à laquelle cet événement a été capté par le Snowpipe
...
`app_api_id` | `string` | ID API de l'application sur laquelle cet événement s'est produit
`dispatch_id` | `string` | ID de l'envoi auquel ce message appartient
`send_id` | `string` | ID d'envoi du message auquel ce message appartient
`campaign_id` | `string` | ID BSON de la campagne à laquelle cet événement appartient
`campaign_api_id` | `string` | ID API de la campagne à laquelle cet événement appartient
`message_variation_api_id` | `string` | ID API de la variante de message que cet utilisateur a reçue
`canvas_id` | `string` | ID BSON du Canvas auquel cet événement appartient
...
`language` | `string` | [PII] Langue de l'utilisateur
`platform` | `string` | Plateforme de l'appareil
`retry_type` | `string` | Type de nouvelle tentative
`retry_log` | `string` | Message de journal décrivant les détails de la nouvelle tentative
`campaign_name` | `string` | Nom de la campagne
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
`canvas_variation_name` | `string` | Nom de la variante du Canvas que cet utilisateur a reçue
...
`time` | `int` | Horodatage UNIX de l'événement
`user_id` | `string` | [PII] ID Braze de l'utilisateur ayant effectué cet événement
`survey_id` | `string` | UUID du sondage auquel cette réponse appartient.
`question_id` | `string` | UUID de la question à laquelle cette réponse appartient.
`message_extras` | `string` | [PII] Chaîne JSON des paires clé-valeur étiquetées lors du rendu Liquid
`gender` | `string` | [PII] Genre de l'utilisateur
`country` | `string` | [PII] Pays de l'utilisateur
`TIME_ZONE` | `string` | Fuseau horaire de l'utilisateur
`device_id` | `string` | [PII] ID de l'appareil sur lequel l'événement s'est produit
`sdk_version` | `string` | Version du SDK Braze utilisée lors de l'événement
`platform` | `string` | Plateforme de l'appareil
`os_version` | `string` | Version du système d'exploitation de l'appareil
`device_model` | `string` | Modèle de l'appareil
...
`ad_id_type` | `string` | Un des suivants : ['ios_idfa', 'google_ad_id', 'windows_ad_id', 'roku_ad_id']
`ad_tracking_enabled` | `boolean` | Indique si le suivi publicitaire est activé pour l'appareil
`answer_single_string` | `string` | [PII] Réponse brute lorsque le response_type est single_string
`answer_single_boolean` | `boolean` | [PII] Réponse brute lorsque le response_type est single_boolean
`answer_type` | `string` | Type de réponse de l'événement, un des suivants : ['single_int', 'single_string', 'single_boolean']
`answer_long_string` | `string` | [PII] Réponse brute lorsque le response_type est free_form_text
`survey_session_id` | `string` | Identifiant unique permettant de regrouper toutes les réponses d'une même session de sondage
`landing_page_api_id` | `string` | ID API de la page de destination à laquelle cet événement appartient
`campaign_api_id` | `string` | ID API de la campagne à laquelle cet événement appartient
`message_variation_api_id` | `string` | ID API de la variante de message que cet utilisateur a reçue
`canvas_api_id` | `string` | ID API du Canvas auquel cet événement appartient
...
`canvas_step_api_id` | `string` | ID API de l'étape du Canvas à laquelle cet événement appartient
`canvas_step_message_variation_api_id` | `string` | ID API de la variante de message de l'étape du Canvas que cet utilisateur a reçue
`answer_multiple_strings` | `string` | [PII] Réponse brute lorsque le answer_type est multiple_string.
`survey_completion_status` | `string` | Un des suivants : ['completed', 'incomplete']
`response_id` | `string` | Identifiant unique représentant la réponse
`campaign_name` | `string` | Nom de la campagne
`canvas_name` | `string` | Nom du Canvas
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`canvas_variation_name` | `string` | Nom de la variante du Canvas que cet utilisateur a reçue
`message_variation_name` | `string` | Nom de la variante de message
`app_api_id` | `string` | ID API de l'application sur laquelle cet événement s'est produit
`question_reporting_id` | `string` | Identifiant de reporting pour la question du sondage
`landing_page_name` | `string` | Nom de la page de destination
`answer_single_number` | `float` | [PII] Réponse brute lorsque le answer_type est single_number
`sf_created_at` | `timestamp` | Date à laquelle cet événement a été capté par le Snowpipe
...
`abort_type` | `null,`&nbsp;`string` | Type d'abandon. Pour la liste des valeurs, consultez [Types d'abandon](#abort-types).
`abort_log` | `null,`&nbsp;`string` | [PII] Message de log décrivant les détails de l'abandon (maximum 2 000 caractères)
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`campaign_name` | `string` | Nom de la campagne
`message_variation_name` | `string` | Nom de la variante de message
...
`canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape du Canvas
`message_extras` | `string` | [PII] Chaîne JSON des paires clé-valeur taguées lors du rendu Liquid
...
`user_id` | `string` | ID Braze de l'utilisateur ayant effectué cet événement
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur
`device_id` | `null,`&nbsp;`string` | `device_id` lié à cet utilisateur si celui-ci est anonyme
`app_group_api_id` | `null,`&nbsp;`string` | ID API de l'espace de travail auquel cet utilisateur appartient
`time` | `int` | Horodatage Unix de l'événement
`dispatch_id` | `null,`&nbsp;`string` | ID de l'envoi auquel ce message appartient
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
...
`from_phone_number` | `null,`&nbsp;`string` | Numéro de téléphone depuis lequel le message SMS a été envoyé
`subscription_group_api_id` | `null,`&nbsp;`string` | ID externe du groupe d'abonnement
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`campaign_name` | `string` | Nom de la campagne
...
`media_urls` | `null, {"type"=>"array", "items"=>["null", "string"]}` | URL des médias envoyés par l'utilisateur
`campaign_id` | `null,`&nbsp;`string` | ID Braze à usage interne de la campagne à laquelle cet événement appartient
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la campagne à laquelle cet événement appartient
`message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message à laquelle cet événement appartient
`canvas_id` | `null,`&nbsp;`string` | ID Braze à usage interne du Canvas auquel cet événement appartient
...
`to_phone_number` | `null,`&nbsp;`string` | [PII] Numéro de téléphone du destinataire
`subscription_group_api_id` | `null,`&nbsp;`string` | ID externe du groupe d'abonnement
`category` | `null,`&nbsp;`string` | Nom de la catégorie de mot-clé, renseigné uniquement pour les messages de réponse automatique : 'Opt-in', 'Opt-out', 'Help' ou valeur personnalisée
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`message_extras` | `null,`&nbsp;`string` | [PII] Chaîne JSON des paires clé-valeur taguées lors du rendu Liquid
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`campaign_name` | `string` | Nom de la campagne
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
...
------|------|------------
`id` | `string` | ID unique global de cet événement
`user_id` | `null,`&nbsp;`string` | ID Braze de l'utilisateur ciblé par short_url, null si short_url n'utilisait pas le suivi des clics utilisateur
`external_user_id` | `null,`&nbsp;`string` | [PII] ID externe de l'utilisateur ciblé par short_url s'il existe, null si short_url n'utilisait pas le suivi des clics utilisateur
...
`timezone` | `null,`&nbsp;`string` | Fuseau horaire de l'utilisateur
`campaign_id` | `null,`&nbsp;`string` | ID Braze de la campagne pour laquelle short_url a été généré, null si l'envoi ne provient pas d'une campagne
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la campagne pour laquelle short_url a été généré, null si l'envoi ne provient pas d'une campagne
`message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message pour laquelle short_url a été généré, null si l'envoi ne provient pas d'une campagne
`canvas_id` | `null,`&nbsp;`string` | ID Braze du Canvas pour lequel short_url a été généré, null si l'envoi ne provient pas d'un Canvas
`canvas_api_id` | `null,`&nbsp;`string` | ID API du Canvas pour lequel short_url a été généré, null si l'envoi ne provient pas d'un Canvas
`canvas_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante Canvas pour laquelle short_url a été généré, null si l'envoi ne provient pas d'un Canvas
`canvas_step_api_id` | `null,`&nbsp;`string` | ID API de l'étape du Canvas pour laquelle short_url a été généré, null si l'envoi ne provient pas d'un Canvas
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas pour laquelle short_url a été généré, null si l'envoi ne provient pas d'un Canvas
`url` | `string` | URL d'origine contenue dans le message, vers laquelle short_url redirige
`short_url` | `string` | URL raccourcie sur laquelle le clic a été effectué
`user_agent` | `null,`&nbsp;`string` | User agent ayant demandé short_url
...
Cet événement se produit lorsqu'un message est dépriorisé ou soumis à une limitation de fréquence, puis retenté ultérieurement dans la fenêtre de renvoi configurée.
...
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape du Canvas reçue par cet utilisateur
`subscription_group_api_id` | `null,`&nbsp;`string` | ID API du groupe d'abonnement
`retry_type` | `null,`&nbsp;`string` | Type de renvoi
`retry_log` | `null,`&nbsp;`string` | Message de log décrivant les détails du renvoi
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`campaign_name` | `string` | Nom de la campagne
`message_variation_name` | `string` | Nom de la variante de message
`canvas_name` | `string` | Nom du Canvas
...
`endpoint_url` | `null,`&nbsp;`string` | URL de l'endpoint sollicité
`app_group_api_id` | `null,`&nbsp;`string` | ID API du groupe d'applications auquel cet utilisateur appartient
`app_group_id` | `null,`&nbsp;`string` | ID BSON du groupe d'applications auquel cet utilisateur appartient
`campaign_api_id` | `null,`&nbsp;`string` | ID API de la campagne à laquelle cet événement appartient
`campaign_id` | `null,`&nbsp;`string` | ID BSON de la campagne à laquelle cet événement appartient
...
`retry_count` | `null, int` | Nombre de tentatives de renvoi effectuées
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
`time` | `int` | Horodatage UNIX de l'événement
`url_path` | `null,`&nbsp;`string` | Chemin de l'URL sollicitée
`user_id` | `string` | ID utilisateur Braze de l'utilisateur ayant effectué cet événement
`webhook_duration` | `null, int` | Durée totale de cette requête en millisecondes
`webhook_failure_source` | `null,`&nbsp;`string` | Indique si une erreur a été générée par Braze ou par l'endpoint lui-même. Le champ source peut être External Endpoint, Treat no status code to host unreachable
`is_terminal` | `null, boolean` | Indique si cet événement correspond à la dernière tentative d'un envoi
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`campaign_name` | `string` | Nom de la campagne
`canvas_name` | `string` | Nom du Canvas
`canvas_step_name` | `string` | Nom de l'étape du Canvas
...
`canvas_variation_name` | `string` | Nom de la variante Canvas reçue par cet utilisateur
`canvas_step_name` | `string` | Nom de l'étape Canvas
`bsuid` | `string` | L'ID utilisateur WhatsApp Business-Scoped de l'utilisateur à partir duquel le message a été reçu.
`message_extras` | `string` | [PII] Chaîne JSON des paires clé-valeur balisées lors du rendu Liquid
...
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
`send_id` | `null,`&nbsp;`string` | ID d'envoi du message auquel ce message appartient
`flow_id` | `null,`&nbsp;`string` | L'ID unique du Flow dans le WhatsApp Manager. Présent si l'utilisateur répond à un WhatsApp Flow.
`template_name` | `null,`&nbsp;`string` | [PII] Nom du modèle dans le WhatsApp Manager. Présent lors de l'envoi d'un message modèle
...
`canvas_step_message_variation_api_id` | `null,`&nbsp;`string` | ID API de la variante de message de l'étape Canvas reçue par cet utilisateur
`message_body` | `string` | Réponse de l'utilisateur
`quick_reply_text` | `string` | Texte du bouton sur lequel l'utilisateur a appuyé
`media_urls` | `null, {"type"=>"array", "items"=>["null", "string"]}` | URL des médias envoyés par l'utilisateur
`action` | `string` | Action effectuée en réponse à ce message. Par exemple, `Subscribed`, `Unsubscribed` ou `None`.
`sf_created_at` | `timestamp`,&nbsp;`null` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`flow_id` | `null,`&nbsp;`string` | L'ID unique du Flow dans le WhatsApp Manager. Présent si l'utilisateur répond à un WhatsApp Flow.
`flow_response_json` | `null,`&nbsp;`string` | [PII] Les valeurs de formulaire avec lesquelles l'utilisateur a répondu. Présent si l'utilisateur répond à un WhatsApp Flow.
`message_id` | `null,`&nbsp;`string` | L'ID unique généré par Meta pour ce message
...
| ------------------ | ------------------------ | --------------------------------------------------------------------------------------------------- |
| `id`               | `string`,&nbsp;`null`    | ID globalement unique pour cet événement                                                            |
| `user_id`          | `string`,&nbsp;`null`    | ID Braze de l'utilisateur qui a été orphelin                                                        |
| `external_user_id` | `string`,&nbsp;`null`    | [PII] ID externe de l'utilisateur                                                                   |
| `device_id`        | `string`,&nbsp;`null`    | ID de l'appareil lié à cet utilisateur, si l'utilisateur est anonyme                                |
| `app_group_id`     | `string`,&nbsp;`null`    | ID Braze de l'espace de travail auquel cet utilisateur appartient                                   |
| `app_group_api_id` | `string`,&nbsp;`null`    | ID API de l'espace de travail auquel cet utilisateur appartient                                     |
| `app_api_id`       | `string`,&nbsp;`null`    | ID API de l'application à laquelle l'utilisateur orphelin appartenait                               |
...
`user_id` | `string` | [PII] ID utilisateur Braze de l'utilisateur ayant effectué cet événement
`app_api_id` | `string` | ID API de l'application sur laquelle cet événement s'est produit
`update_source` | `string` | Source de cette mise à jour
`archived` | `boolean` | Lorsque la valeur est True, indique que cet utilisateur a été archivé dans Braze
`first_name` | `string` | [PII] Prénom de l'utilisateur
`last_name` | `string` | [PII] Nom de famille de l'utilisateur
`email_address` | `string` | [PII] Adresse e-mail de l'utilisateur
`gender` | `string` | [PII] Genre de l'utilisateur
`phone_number` | `string` | [PII] Numéro de téléphone de l'utilisateur au format e.164 (par exemple +14155552671)
`dob` | `string` | [PII] Date de naissance de l'utilisateur au format « AAAA-MM-JJ »
`TIME_ZONE` | `string` | Fuseau horaire de l'utilisateur
`home_city` | `string` | [PII] Ville de résidence de l'utilisateur
`country` | `string` | [PII] Pays de l'utilisateur
`language` | `string` | [PII] Langue de l'utilisateur
`custom_attributes` | `string` | Chaîne JSON valide des attributs personnalisés mis à jour
`sf_created_at` | `timestamp` | Date à laquelle cet événement a été récupéré par le Snowpipe
...
`content_optimizer_step_id` | `string` | ID interne de l'étape CO
`combination_token` | `string` | Combinaison de composants attribuée
`content` | `string` | Payload du contenu rendu au format JSON
`is_active` | `boolean` | Indique si le jeton de combinaison est activement utilisé pour la diffusion
`sf_created_at` | `timestamp` | Date à laquelle cet événement a été récupéré par le Snowpipe

...
Allez dans **Audience** > **Segment Extensions**.

Depuis le tableau des extensions de segments, sélectionnez **Create New Extension**, puis choisissez votre expérience de création d'extension de segments :
...
Après avoir créé une extension de segments, vous pouvez l'utiliser comme filtre lors de la création d'un segment ou de la définition d'une audience pour une campagne ou un Canvas. Commencez par choisir **Braze Segment Extension** dans la liste des filtres sous la section **User Attributes**.

![Section « Filters » avec un menu déroulant de filtres affichant « Braze Segment Extensions ».]({% image_buster /assets/img/segment/segment_extension7.png %})
...
### Comment Braze calcule-t-il la période pour une période relative de « derniers __ jours » ? {#how-does-braze-calculate-the-time-period-for-a-relative-time-period-of-last-days}

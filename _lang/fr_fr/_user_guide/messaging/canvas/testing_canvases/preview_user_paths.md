---
nav_title: Prévisualiser les parcours utilisateur
article_title: Prévisualiser les parcours utilisateur
page_order: 0.3
...
# Prévisualiser les parcours utilisateur dans Canvas

> Explorez le parcours Canvas que vous avez créé pour vos utilisateurs. Cela inclut la prévisualisation du timing et des messages que vos utilisateurs reçoivent. Ces tests servent de contrôle qualité pour vérifier que vos messages sont envoyés à la bonne audience, avant même d'envoyer votre Canvas.

## Créer un test

Suivez ces étapes pour prévisualiser votre parcours utilisateur :

1. Accédez à votre générateur Canvas. Enregistrez toutes les modifications non enregistrées et résolvez les erreurs éventuelles.
...
## Quand les utilisateurs entrent et sortent
...
Le contenu connecté est exécuté s'il est inclus dans le Canvas. Cela signifie que si vous testez un Canvas contenant des appels de contenu connecté ou des blocs de contenu qui contiennent du contenu connecté, le Canvas peut envoyer les appels de contenu connecté, ce qui modifierait les données référencées dans d'autres campagnes ou Canvas.

Lors de la prévisualisation des parcours utilisateur, envisagez de supprimer le contenu connecté qui modifie les profils utilisateur ou les données référencées dans d'autres Canvas ou campagnes.

## Webhooks

Les webhooks s'exécutent lorsque des messages test sont envoyés, mais pas pendant le test. Comme pour le contenu connecté, envisagez de supprimer les webhooks qui modifient les profils utilisateur ou les données référencées dans d'autres Canvas ou campagnes.

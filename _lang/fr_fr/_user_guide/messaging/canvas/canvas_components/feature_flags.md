...
Accédez à **Messagerie** > **Feature Flags** pour modifier, ajouter ou supprimer des propriétés supplémentaires.

## Différences entre Canvas et le déploiement

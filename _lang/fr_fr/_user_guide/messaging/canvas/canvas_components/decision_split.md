...
Pour créer un arbre décisionnel dans votre workflow, ajoutez une étape à votre Canvas. Ensuite, glissez-déposez le composant depuis la barre latérale, ou sélectionnez le bouton <i class="fas fa-plus-circle"></i> plus en bas d'une étape et sélectionnez **Arbre décisionnel**.

### Définir votre répartition

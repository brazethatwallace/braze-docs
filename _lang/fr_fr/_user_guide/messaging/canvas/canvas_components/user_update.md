...
Glissez-déposez le composant depuis la barre latérale, ou sélectionnez le bouton <i class="fas fa-plus-circle"></i> plus en bas de la variante ou de l'étape, puis sélectionnez **Mise à jour utilisateur**.
...
* [Blocs de contenu]({{site.baseurl}}/user_guide/messaging/design_and_edit/content_blocks/)

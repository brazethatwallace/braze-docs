...
## Créez des messages plus riches
...
- Intégrez des [Cartes de contenu]({{site.baseurl}}/user_guide/messaging/canvas/create_a_canvas/canvas_by_channel/content-cards_in_canvas/) dans un parcours Canvas pour des offres promotionnelles et des notifications push.

...
### Vérifier les filtres de l'audience d'entrée {#review-entry-audience-filters}
...
## Horaires de distribution {#delivery-times}
...
### Confirmer que les utilisateurs ont effectué l'événement personnalisé ou l'achat prérequis {#confirm-that-they-performed-the-prerequisite-custom-event-or-purchase}

...
## Éléments à vérifier avant le lancement
...
### Envisager l'utilisation d'expressions régulières pour les filtres d'audience
...
### Vérifier les propriétés d'entrée du Canvas et les propriétés d'événement
...
### Vérifier l'avancement des utilisateurs dans les étapes Message
...
## Éléments à vérifier après le lancement
...
### Baisse inattendue entre les étapes
...
### Volumes d'envoi suspects entre les parcours

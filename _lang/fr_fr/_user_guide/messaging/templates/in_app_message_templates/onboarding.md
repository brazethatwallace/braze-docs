...
# Flux d'onboarding {#onboarding-flow}

> Utilisez le modèle de message in-app **Flux d'onboarding** pour collecter les attributs, informations et préférences des utilisateurs qui alimentent votre stratégie de Campaign.

{% multi_lang_include drag_and_drop/templates.md section='SDK requirements' %}

## Créer un flux d'onboarding {#creating-an-onboarding-flow}

### Étape 1 : Choisir votre modèle {#step-1-choose-your-template}

Lors de la création d'un message in-app par glisser-déposer, sélectionnez **Onboarding flow** comme modèle, puis sélectionnez **Build message**. Ce modèle est pris en charge à la fois pour les applications mobiles et les navigateurs web.

...
# Inscription par e-mail avec offre spéciale {#email-sign-up-with-special-offer}

> Utilisez l'éditeur par glisser-déposer de messages in-app pour développer votre liste d'e-mails en proposant une remise spéciale à l'inscription.

{% multi_lang_include drag_and_drop/templates.md section='SDK requirements' %}

## Créer un formulaire d'inscription par e-mail avec une offre spéciale {#creating-an-email-sign-up-form-with-a-special-offer}

### Étape 1 : Choisir votre modèle {#step-1-choose-your-template}

Lors de la création d'un message in-app par glisser-déposer, sélectionnez **Email sign-up with special offer** comme modèle, puis sélectionnez **Build message**. Ce modèle est pris en charge pour les applications mobiles et les navigateurs web.

![L'éditeur de messages in-app avec le modèle pour un formulaire d'inscription par e-mail avec une offre spéciale.]({% image_buster /assets/img/drag_and_drop/templates/email_capture_offer.png %})
...
Personnalisez l'apparence de votre offre spéciale à l'aide des [composants de messages in-app]({{site.baseurl}}/user_guide/channels/in_app_messages/customize/style_settings#message-components) par glisser-déposer.

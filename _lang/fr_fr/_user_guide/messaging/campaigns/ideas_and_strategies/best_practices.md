...
Si votre objectif est d'attirer l'attention de vos utilisateurs sur une nouvelle fonctionnalité ou une nouvelle version de l'application, adoptez une stratégie multicanale axée sur les canaux in-app. Les [messages in-app]({{site.baseurl}}/in-app_messages/) et les [Cartes de contenu]({{site.baseurl}}/user_guide/channels/content_cards/) sont généralement moins intrusifs si l'utilisateur ne souhaite pas effectuer la mise à jour immédiatement.
...
### Cibler les utilisateurs les plus actifs

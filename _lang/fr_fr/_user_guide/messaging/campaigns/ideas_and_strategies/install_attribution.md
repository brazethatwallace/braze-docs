...
## Segmenter vos utilisateurs {#segment-your-users}
...
### Exploiter les données de la publicité {#reference-data-from-the-ad}
...
## Évaluer l'efficacité de vos efforts publicitaires {#evaluate-advertising-efforts}

...
## Configurer une campagne déclenchée
...
### Étape 5 : Sélectionner la plage horaire
...
### Évaluation des critères d'audience
...
Commencez par confirmer que l'événement personnalisé est bien transmis à Braze. Accédez à **Analytique** > **Rapport d'événements personnalisés**, puis sélectionnez l'événement personnalisé concerné et la plage de dates. Si l'événement ne s'affiche pas, vérifiez qu'il est correctement configuré et que l'utilisateur a bien effectué l'action correspondante.

...
guide_top_text: "Menez des expériences pour optimiser vos messages. Un test A/B compare les réponses des utilisateurs à plusieurs versions d'une même campagne, tandis qu'un test multivarié étend ce principe à deux variables ou plus. Dans Braze, les deux termes sont utilisés de manière interchangeable, car le processus de configuration est identique. Associez les tests A/B à la <a href='/docs/user_guide/brazeai/intelligence_suite/intelligent_selection'>Sélection intelligente</a> pour optimiser automatiquement vos résultats."
...
- **Ajoutez les tests avant le lancement.** Ajouter un test à une campagne déjà en cours produit des résultats inexacts. Clonez la campagne, arrêtez l'originale, puis ajoutez le test au clone.

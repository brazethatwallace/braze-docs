...
- Définir la fenêtre de calcul du chiffre d'affaires pour la campagne ou le Canvas.
...
Accédez à la page **Détails** pour voir les détails de chaque événement de conversion associé à la campagne que vous avez créée. Indépendamment des événements de conversion sélectionnés, vous pouvez également voir le chiffre d'affaires total attribué à cette campagne spécifique, ainsi qu'aux variantes spécifiques, pendant la fenêtre de l'événement de conversion principal.

...
Contrairement aux autres canaux (tels que les notifications push et les e-mails) où la rééligibilité est calculée à partir de l'horodatage de distribution du message, la rééligibilité des Content Cards est calculée en fonction de l'horodatage d'impression, c'est-à-dire le moment où l'utilisateur visualise réellement la carte. Cela signifie que s'il y a un décalage entre le moment où une carte est distribuée et celui où l'utilisateur ouvre sa session pour la consulter, il peut ne pas redevenir éligible comme prévu.

Par exemple, si une Campaign quotidienne de Content Cards a une fenêtre de rééligibilité de 24 heures et qu'un utilisateur consulte une carte plusieurs heures après sa distribution, il peut ne pas recevoir la carte du lendemain car 24 heures ne se sont pas écoulées depuis l'impression. Pour tenir compte de cela, envisagez de raccourcir légèrement votre fenêtre de rééligibilité pour les Campaigns récurrentes de Content Cards.

...
hidden: true
page_type: reference
description: "Cet article explique le fonctionnement de la projection de test A/B, comment lancer une projection et comment Braze utilise vos données."
---

# Projection de test A/B

> La projection de test A/B utilise des réseaux neuronaux pour prédire quelles lignes d'objet sont les plus performantes. Notre modèle extrait les caractéristiques linguistiques des tests A/B gagnants réalisés sur Braze et utilise ces schémas statistiques de langage pour apprendre à notre intelligence artificielle ce qui fait une meilleure ligne d'objet.

{% alert important %} 
Cette fonctionnalité est actuellement en accès anticipé. Contactez votre gestionnaire de satisfaction client ou votre gestionnaire de compte Braze si vous souhaitez participer à l'accès anticipé.
{% endalert %}

## Lancer une projection

Lors de la composition de la campagne, insérez vos variantes de message et leurs lignes d'objet dans l'éditeur. Lorsque vous êtes prêt, accédez à l'étape **Audience cible** du flux de création de campagne. Dans le panneau **Test A/B**, sélectionnez **Lancer la projection**.

<img width="518" alt="image" src="https://github.com/braze-inc/braze-docs/assets/17167198/8e74835c-76e4-4241-9763-c4f86a622c75">

Une fenêtre modale s'ouvrira avec les lignes d'objet de toutes les variantes de message que vous avez déjà créées. Vous pouvez également insérer des lignes d'objet supplémentaires (jusqu'à dix maximum) en en saisissant une manuellement dans le champ, puis en lançant la projection. Sélectionnez **Lancer la projection**.

...
# FAQ sur les tests multivariés et A/B
...
### Comment les résultats d'un test A/B sont-ils calculés ?
...
### Pourquoi la distribution des variantes n'est-elle pas uniforme ?
...
### Quand le test initial est-il terminé ?
...
### Comment Braze gère-t-il les utilisateurs qui ont reçu une variante de message dans une campagne récurrente ou une étape d'entrée de Canvas ?
...
#### Puis-je effectuer des actions pour redistribuer les utilisateurs dans les campagnes et les Canvas ?
...
### L'affectation aux groupes de contrôle et de test peut-elle introduire un biais dans les tests ?

...
page_type: reference
description: "Cet article de référence explique l'analyse de corrélation de conversion sur la page d'analytique de campagne."
tool: 
  - Reports
...
> L'analyse de corrélation de conversion sur la page **Analytique de campagne** vous permet de comprendre quels attributs et comportements des utilisateurs favorisent ou nuisent aux résultats que vous avez définis pour vos campagnes.
...
## Quand puis-je consulter cette analyse ?
...
## Comment Braze vérifie la significativité

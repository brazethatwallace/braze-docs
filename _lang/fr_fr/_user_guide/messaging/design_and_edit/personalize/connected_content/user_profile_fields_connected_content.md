...
## Le templating Liquid dans les appels au contenu connecté {#liquid-templating-in-connected-content-calls}
...
### Utiliser `json_escape` avec les étiquettes Liquid susceptibles de casser le format JSON {#use-jsonescape-with-liquid-tags-that-could-break-the-json-format}

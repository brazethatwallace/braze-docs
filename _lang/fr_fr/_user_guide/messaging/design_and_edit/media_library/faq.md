...
Pour copier l'URL d'une image téléchargée dans la bibliothèque multimédia, accédez à **Contenu** > **Bibliothèque multimédia**. Survolez l'image que vous souhaitez référencer, puis sélectionnez l'icône **Copier l'URL de l'image** pour copier l'URL de l'image dans votre presse-papiers.

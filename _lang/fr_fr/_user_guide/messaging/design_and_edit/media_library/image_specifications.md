...
![Notification push iOS avec le texte « Hi! This is an iOS Push with an image » et un emoji. Une petite image est affichée à côté du texte.]({% image_buster /assets/img_archive/braze_richpush1.png %}){: style="max-width:50%;"}

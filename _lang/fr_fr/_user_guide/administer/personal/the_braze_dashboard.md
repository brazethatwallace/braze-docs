...
Utilisez le tableau de bord de Braze pour planifier des Campaigns, lancer et gérer des messages, explorer les informations sur l'audience, ajuster la segmentation et consulter les indicateurs de performance et d'engagement en temps réel depuis une interface unique.
...
2. Sélectionnez **Manage your account** pour accéder à votre page de profil.
...
Vous souhaitez nous dire ce que vous en pensez ? Vous pouvez partager vos commentaires sur la navigation, l'accessibilité, l'ergonomie, le design visuel et bien plus encore. Ouvrez le menu **Support** dans l'en-tête global et sélectionnez **Share feedback**. Nous examinons tous les commentaires pour améliorer votre expérience avec Braze.
...
- **Créer des Campaigns** : [Créer une Campaign]({{site.baseurl}}/user_guide/messaging/campaigns/creating_campaign/)

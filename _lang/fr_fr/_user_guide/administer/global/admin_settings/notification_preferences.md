...
Pour accéder à cette page, allez dans **Paramètres** > **Paramètres d'administration** > **Préférences de notification**.
...
| Expiration des interactions de campagne | Informe les destinataires de toute campagne dont les données d'interaction arrivent à expiration, ainsi que de tout segment, campagne ou Canvas qui y fait référence dans un filtre de reciblage et qui a été utilisé pour envoyer un message au cours des 30 derniers jours. | E-mail |
| Campagne/Canvas mis à jour | Informe les destinataires lorsqu'une campagne ou un Canvas actif est mis à jour ou désactivé, ainsi que lorsqu'une campagne ou un Canvas inactif est réactivé ou que des brouillons sont lancés. | E-mail |
| Limite de volume de campagne/Canvas atteinte | Informe les destinataires lorsqu'une campagne ou un Canvas atteint sa limite de volume. | E-mail |
...
| Campagne planifiée envoyée | Informe les destinataires lorsqu'une campagne planifiée a terminé son envoi. | E-mail, Webhook |

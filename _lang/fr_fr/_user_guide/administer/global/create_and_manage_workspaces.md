...
1. Sélectionnez le menu déroulant des espaces de travail, puis sélectionnez <i class="fa-solid fa-square-plus" style="color: #0b8294;"></i> **Créer un espace de travail**.
...
### Étape 3 : Ajouter vos instances d'application
...
Ce champ apparaît après avoir intégré le SDK Braze à votre application ou site web. Si une version plus récente du SDK Braze est disponible pour votre plateforme, cela sera indiqué ici avec l'étiquette « Version plus récente disponible ».
...
### Renommer des espaces de travail
...
### Supprimer des espaces de travail et des instances d'application
...
### Dois-je créer un nouvel espace de travail lorsque je publie une mise à jour de mon application ?
...
1. Créez un segment avec un nom significatif. Chez Braze, nous utilisons le format « Tous les utilisateurs ({Nom} {Plateforme}) ». Par exemple, « Tous les utilisateurs (Upon Voyage iOS) ».
...
Pour les Campaigns, ajoutez votre segment à l'étape **Audiences cibles** du composeur.

...
2. Dans l'étape **Configuration de Braze**, sélectionnez une méthode de provisionnement et fournissez les paramètres d'accès.
...
{: start="3"}
3. Dans l'étape **Configuration de l'IdP**, suivez les étapes indiquées dans la plateforme pour la méthode de provisionnement que vous avez sélectionnée.
...
2. Renseignez les informations suivantes (disponibles dans l'étape [**Configuration de l'IdP**](#accessing-scim-provisioning-settings)) pour créer une application personnalisée :

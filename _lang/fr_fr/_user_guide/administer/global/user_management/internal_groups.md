...
Après avoir créé un groupe interne et l'avoir étiqueté pour être utilisé comme groupe initiateur, sélectionnez-le à l'étape **Audiences cibles** de l'éditeur de campagne, ou à l'étape **Paramètres d'envoi** dans un Canvas.

...
## Filtres de segmentation affectés par le filtrage des robots
...
## Champs dans les événements de clic d'e-mail pour Currents et Snowflake
...
### Le filtrage des robots empêchera-t-il les robots qui cliquent sur le lien de désabonnement Braze de se désabonner ?

Non. Toutes les demandes de désabonnement continueront d'être traitées.

### Les ouvertures automatiques sont-elles prises en compte dans le filtrage des clics de robots ?

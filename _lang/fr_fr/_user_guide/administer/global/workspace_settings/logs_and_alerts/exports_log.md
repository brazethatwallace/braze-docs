...
## Annulation d'une exportation en attente
...
![Le journal des exportations montre une exportation en attente et l'option « Annuler l'exportation ».]({% image_buster /assets/img/export_logs_cancel.png %})

## Partage d'un journal d'exportation spécifique

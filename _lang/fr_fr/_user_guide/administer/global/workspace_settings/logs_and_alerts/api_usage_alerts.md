  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <ul>
          <li><strong>Augmenté de</strong> ou <strong>Diminué de</strong> : compare les requêtes par rapport à la fenêtre temporelle précédente.</li>
          <li><strong>Augmenté en pourcentage</strong> ou <strong>Diminué en pourcentage</strong> : compare la variation en pourcentage des requêtes par rapport à la fenêtre temporelle précédente.</li>
          <li><strong>Supérieur ou égal à</strong> ou <strong>Inférieur ou égal à</strong> : compte les requêtes dans une fenêtre temporelle.</li>
        </ul>
      </td>
    </tr>
    <tr>
...
| --- | --- | --- | --- | --- | --- |
| Tous les endpoints | Toutes les clés API | `4XX` et `5XX` | Augmenté de 10 % | 10 | 1 heure |
...
Cette configuration d'alerte vous notifie lorsque des erreurs surviennent pour les campagnes et Canvas déclenchés par API, dont certains peuvent être hautement prioritaires.

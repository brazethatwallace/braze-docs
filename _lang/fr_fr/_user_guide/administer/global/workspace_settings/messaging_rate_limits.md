...
- Les messages envoyés via les [campagnes d'e-mail transactionnel]({{site.baseurl}}/user_guide/channels/transactional_email) ne sont pas inclus dans les limites de débit d'envoi de messages de l'espace de travail. Cela signifie qu'ils sont soumis à leur propre limite de débit et ne sont pas comptabilisés dans les limites de débit d'envoi de messages de l'espace de travail définies.

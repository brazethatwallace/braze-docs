...
![Une fenêtre intitulée « Ajouter un paramètre régional - Langue et pays par défaut » pour spécifier la langue et le pays.]({% image_buster /assets/img/multi-language_support/default_option.png %})
...
![Une fenêtre intitulée « Ajouter un paramètre régional - Attributs personnalisés » pour spécifier l'attribut personnalisé et la valeur.]({% image_buster /assets/img/multi-language_support/custom_attributes_option.png %})
...
#### Où les fichiers de traduction sont-ils stockés dans Braze ?
...
#### Le nom du paramètre régional doit-il suivre un format ou un modèle spécifique ?

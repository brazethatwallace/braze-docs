...
- [Équipes](#teams)
- [Autorisations des utilisateurs de l'entreprise](#company-user-permissions) (mais pas les utilisateurs de l'entreprise eux-mêmes)
...
### Mettre en place un espace de travail de test {#set-up-a-testing-workspace}

...
6. **Contenu connecté :** Appelez votre CMS ou votre API de traduction au moment de l'envoi. Testez minutieusement ; la prévisualisation peut ne pas refléter les réponses de l'API en direct. Consultez [Contenu connecté]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/connected_content).

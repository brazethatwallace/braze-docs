...
### Réinitialisation des attributs par défaut
...
Vous pouvez également utiliser l'API REST pour définir ou supprimer les attributs des utilisateurs. Pour plus d'informations, reportez-vous aux [endpoints de données utilisateur]({{site.baseurl}}/developer_guide/rest_api/user_data/#user-data).
...
### Définir les abonnements e-mail

...
## Qu'est-ce que BrazeAI Decisioning Studio™ ? {#what-is-brazeai-decisioning-studio}
...
- **Ouvrez la boîte noire :** découvrez comment les agents décisionnels basés sur l'IA personnalisent l'interaction afin d'obtenir des informations approfondies sur les facteurs du comportement des clients.
- **Assistance experte tout au long du processus :** Decisioning Studio Pro inclut l'assistance de notre équipe AI Decisioning Services, qui adaptera vos agents décisionnels aux besoins spécifiques de votre entreprise.

## À propos de Decisioning Studio {#about-decisioning-studio}
...
Pour configurer Decisioning Studio, vous devrez :
...
Dans ce guide, vous découvrirez tout d'abord ce que sont les agents décisionnels et comment ils fonctionnent. Ensuite, vous configurerez Decisioning Studio Go en libre-service, puis Decisioning Studio Pro en service complet. Enfin, vous examinerez les rapports et les informations pour évaluer les performances de vos agents décisionnels.

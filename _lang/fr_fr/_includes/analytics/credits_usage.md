...
Le graphique **Utilisation des crédits de messages sur la durée du contrat** affiche votre utilisation sur la période sélectionnée. La granularité de ce graphique dépend de la période que vous avez sélectionnée. Consultez les options d'exportation en sélectionnant le menu dans le menu du graphique.
...
![Utilisation des crédits Banners avec des tuiles pour les crédits et les impressions uniques, et un tableau d'utilisation par compte.]({% image_buster /assets/img/app_settings/credits_usage_banners.png %})
...
**Utilisation des crédits SMS/MMS/RCS** affiche la répartition de la consommation pour les canaux SMS, MMS et RCS. Les colonnes **Ratio de crédits** et **Crédits** indiquent respectivement le taux par pays et les crédits consommés. De plus, des tuiles de synthèse indiquent la consommation totale de SMS et, le cas échéant, de MMS sur la plage de dates sélectionnée.

Des filtres sont disponibles pour filtrer par **Pays** ou par type SMS et RCS.

![Utilisation des crédits SMS/MMS/RCS avec des tuiles de synthèse et une section de consommation par compte.]({% image_buster /assets/img/app_settings/sms_credit_consumption2.png %})
...
![Utilisation des crédits Agent Console avec des tuiles pour les crédits et les invocations, et un tableau d'utilisation par compte.]({% image_buster /assets/img/app_settings/credits_usage_agent_console.png %})
...
Le tableau de bord **Credits Usage** exclut la date de fin de la plage sélectionnée des résultats. Par exemple, si vous sélectionnez du 1er au 31 octobre, les statistiques d'utilisation du 31 octobre sont exclues. Pour inclure le dernier jour de la période souhaitée, prolongez la plage d'un jour. Par exemple, pour inclure tout le mois d'octobre, sélectionnez du 1er octobre au 1er novembre.

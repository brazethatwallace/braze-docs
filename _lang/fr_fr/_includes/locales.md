...
## Prévisualiser vos locales {#preview-your-locales}
...
#### Puis-je modifier la version traduite dans l'une de mes locales ? {#can-i-make-a-change-to-the-translated-copy-in-one-of-my-locales}
...
#### Puis-je ajouter du style HTML dans les étiquettes de traduction ? {#can-i-add-html-styling-in-the-translation-tags}

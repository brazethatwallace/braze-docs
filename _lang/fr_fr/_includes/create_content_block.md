...
1. Accédez à **Modèles** > **Content Blocks**. Sélectionnez <i class="fas fa-plus"></i> **Create Content Block**, puis sélectionnez **Drag-and-drop Content Block**.
...
1. Accédez à **Modèles** > **Content Blocks**. Sélectionnez <i class="fas fa-plus"></i> **Create Content Block**, puis sélectionnez **HTML code editor**.

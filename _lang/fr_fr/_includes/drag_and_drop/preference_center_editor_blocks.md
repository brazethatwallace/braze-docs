...
Avant de modifier les blocs, ajoutez des groupes d'abonnement et configurez le **smart block** d'abonnement (voir la section suivante). Pour le flux de configuration complet, consultez [Créer un centre de préférences e-mail par glisser-déposer]({{site.baseurl}}/user_guide/audience/subscription_preferences/preference_center/dnd_preference_center).
...
Ajoute un bloc modèle qui répertorie les groupes d'abonnement, des contrôles facultatifs **S'abonner à tout** / **Se désabonner de tout**, ainsi que des descriptions. Configurez-le après avoir ajouté des groupes dans le flux du centre de préférences.

Après avoir [ajouté des groupes d'abonnement]({{site.baseurl}}/user_guide/audience/subscription_preferences/preference_center/dnd_preference_center#step-3-add-subscription-groups-to-the-preference-center), sélectionnez le smart block dans le canevas pour :

- Réorganiser les groupes d'abonnement
- Ajouter ou supprimer des groupes
- Ajouter ou supprimer des descriptions
- Activer ou désactiver **S'abonner à tout** et **Se désabonner de tout** pour les groupes de ce bloc

Le contrôle **Se désabonner de tout** en bas du modèle par défaut est obligatoire et effectue un [désabonnement global]({{site.baseurl}}/user_guide/channels/email/subscriptions#subscription-states) des e-mails.
...
- **Page de confirmation :** passez à **Page de confirmation** en haut de l'éditeur pour mettre en forme l'expérience post-enregistrement en utilisant les mêmes types de blocs.
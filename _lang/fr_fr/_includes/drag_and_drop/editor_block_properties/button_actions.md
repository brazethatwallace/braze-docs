...
| Comportement au clic | Détermine l'action lorsque l'utilisateur clique sur le bouton, comme fermer le message, ouvrir une URL web, créer un lien profond vers une page spécifique de l'application, accéder à une autre page ou [demander l'autorisation push]({{site.baseurl}}/user_guide/channels/push/best_practices/push_primer_messages/). |

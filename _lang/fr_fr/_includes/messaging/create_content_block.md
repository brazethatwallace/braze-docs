...
1. Accédez à **Content** > **Content Block**. Sélectionnez <i class="fas fa-plus"></i> **Create Content Block**, puis sélectionnez **Drag-and-drop Content Block**.
2. Glissez-déposez les [blocs éditeur]({{site.baseurl}}/user_guide/channels/email/drag_and_drop/dnd_editor_blocks) pour créer un Content Block par glisser-déposer.
...
1. Accédez à **Content** > **Content Block**. Sélectionnez <i class="fas fa-plus"></i> **Create Content Block**, puis sélectionnez **HTML code editor**.

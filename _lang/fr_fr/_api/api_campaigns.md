...
2. Sélectionnez **Ajouter un message** et ajoutez les types de messages inclus dans votre campagne API. Cela vous permettra de générer un `campaign_id` et un ID de variante de message, qui diffère pour chaque canal que vous ajoutez.
...
4. Sélectionnez **Enregistrer la campagne** et vous êtes prêt à lancer votre campagne API !

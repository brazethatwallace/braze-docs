...
#### Importation de jetons de notification push {#push-token-import}
...
Pour plus d'informations, consultez [Migration des jetons de notification push](#migrate-push-tokens).

...
guide_top_text: "Utilisez les API REST des groupes d'abonnement pour gérer de manière programmatique les groupes d'abonnement que vous avez stockés dans le tableau de bord de Braze, sur la page **Groupe d'abonnement**. Ceci s'applique aux groupes d'abonnement SMS et e-mail.<br><br> Vous recherchez des conseils sur la création de groupes d'abonnement ? Consultez nos articles sur les <a href='/docs/user_guide/message_building_by_channel/sms/sms_subscription_group/'>groupes d'abonnement SMS</a> et les <a href='/docs/user_guide/message_building_by_channel/email/managing_user_subscriptions/'>groupes d'abonnement e-mail</a>."

...
{% alert note %}
Si vous souhaitez utiliser cet endpoint avec les [groupes d'abonnement LINE]({{site.baseurl}}/user_guide/channels/line/message_users/subscription_groups), contactez votre gestionnaire du succès des clients.
{% endalert %}

...
Pour utiliser cet endpoint, vous aurez besoin d'une [clé API]({{site.baseurl}}/api/basics#rest-api-key-permissions) avec l'autorisation `messages.schedule.update`.
...
| `messages` | Facultatif | Objet | Voir [les objets de communication disponibles]({{site.baseurl}}/api/objects_filters#messaging-objects). |

...
---
{% api %}
# Créer des ID d'envoi {#create-send-ids}
{% apimethod post %}
/sends/id/create
{% endapimethod %}
...
L'utilisation de l'identifiant d'envoi pour suivre et envoyer des messages est utile si vous prévoyez de générer et d'envoyer du contenu de manière programmatique.

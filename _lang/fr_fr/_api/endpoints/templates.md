...
search_tag: Endpoint
description: "Cette page explique et répertorie les endpoints de Braze pour les modèles d'e-mail et les Content Blocks."
page_type: landing

guide_top_header: "Endpoints des modèles"
guide_top_text: "Les endpoints des modèles vous permettent de créer et de gérer vos modèles d'e-mail et de Content Blocks. <br><br> Vous souhaitez obtenir davantage de conseils sur la création de modèles pour les e-mails et les Content Blocks ? Consultez notre <a href='/docs/user_guide/message_building_by_channel/email/templates'>section dédiée aux modèles d'e-mail</a> et notre <a href='/docs/user_guide/engagement_tools/templates_and_media/content_blocks'>article sur les Content Blocks</a>."

guide_featured_title: "Endpoints des modèles d'e-mail"
guide_featured_list:
...
guide_menu_title: "Endpoints des modèles de Content Blocks"
guide_menu_list:
  - name: "GET : Répertorier les Content Blocks disponibles"
    link: /docs/api/endpoints/templates/content_blocks_templates/get_list_email_content_blocks
    image: /assets/img/braze_icons/mail-01.svg
  - name: "GET : Voir les informations disponibles sur le Content Block"
    link: /docs/api/endpoints/templates/content_blocks_templates/get_see_email_content_blocks_information
    image: /assets/img/braze_icons/copy-04.svg
  - name: "POST : Créer des Content Blocks"
  ...
  - name: "POST : Mettre à jour le Content Block"

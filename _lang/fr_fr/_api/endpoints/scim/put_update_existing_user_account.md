---
nav_title: "PUT : Mettre à jour un compte utilisateur du tableau de bord"
article_title: "PUT : Mettre à jour un compte utilisateur du tableau de bord"
...
{% api %}
# Mettre à jour un compte utilisateur du tableau de bord {#update-dashboard-user-account}
{% apimethod put %}
/scim/v2/Users/{id}
{% endapimethod %}
...
Si aucun utilisateur avec cet ID n'existe dans Braze, l'endpoint répondra avec :

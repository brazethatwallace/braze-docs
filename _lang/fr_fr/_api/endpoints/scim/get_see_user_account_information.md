...
layout: api_page
page_type: reference
description: "Cet article présente les détails de l'endpoint Braze Rechercher un compte utilisateur de tableau de bord existant par ID de ressource."
---

{% api %}
# Rechercher un compte utilisateur du tableau de bord existant par ID de ressource {#look-up-an-existing-dashboard-user-account-by-resource-id}
{% apimethod get %}
/scim/v2/Users/{id}
{% endapimethod %}

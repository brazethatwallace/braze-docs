...
Pour utiliser cet endpoint, vous aurez besoin d'une [clé API]({{site.baseurl}}/api/basics#rest-api-key-permissions) avec l'autorisation `email.blacklist`.
...
| -----------|----------| --------|------- |
| `email` | Obligatoire | Chaîne de caractères ou tableau | Adresse e-mail sous forme de chaîne de caractères à ajouter à la liste de blocage, ou un tableau contenant jusqu'à 50 adresses e-mail à ajouter à la liste de blocage. |

...
---
{% api %}
# Exporter les utilisateurs actifs quotidiens par date {#export-daily-active-users-by-date}
{% apimethod get %}
/kpi/dau/data_series
{% endapimethod %}
...
Pour utiliser cet endpoint, vous aurez besoin d'une [clé API]({{site.baseurl}}/api/basics#rest-api-key-permissions) avec l'autorisation `kpi.dau.data_series`.

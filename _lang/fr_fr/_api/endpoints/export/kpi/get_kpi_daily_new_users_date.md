...
---
{% api %}
# Exporter les nouveaux utilisateurs quotidiens par date {#export-daily-new-users-by-date}
{% apimethod get %}
...
Pour utiliser cet endpoint, vous aurez besoin d'une [clé API]({{site.baseurl}}/api/basics#rest-api-key-permissions) avec l'autorisation `kpi.new_users.data_series`.

...
Il existe deux méthodes pour valider la prise en charge de la traduction à l'aide de l'API et du tableau de bord de Braze dans les Campaigns, les Canvas (y compris les étapes individuelles), les Content Blocks et les modèles d'e-mail :

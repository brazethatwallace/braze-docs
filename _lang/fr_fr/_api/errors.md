...
| `400 Apple Push Length Exceeded` | Le payload JSON est supérieur à 1 912 octets.|
| `400 Android Push Length Exceeded` | Le payload JSON est supérieur à 4 000 octets.|

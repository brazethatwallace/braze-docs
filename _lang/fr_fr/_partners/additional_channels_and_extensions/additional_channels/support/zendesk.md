...
3. Sélectionnez **Trigger** ou **Automation** et cliquez sur **Next**.<br>![]({% image_buster /assets/img_archive/zendesk2.png %}){: style="max-width:70%;"}<br><br>
...
4. Sélectionnez **Add condition** pour définir les conditions qui doivent déclencher le webhook. Par exemple, « Catégorie de statut modifiée en fermée » ou « Catégorie de statut modifiée en résolue ».![]({% image_buster /assets/img_archive/zendesk1.png %}){: style="max-width:70%;"}<br><br>

...
Avec B.Layer, les possibilités de création et d'expérimentation sont infinies : curseurs de recommandation produit, onboarding multi-écrans ou enquêtes, Net Promoter Score, capture d'e-mails, offres spéciales, et bien plus encore.
...
Dans B.Layer, dans le menu hamburger en haut de la page, cliquez sur **Brand assets > add your brand assets**. Vous pouvez y attribuer la couleur et les polices de caractères de votre marque.
...
Avec B.Layer, vous pouvez enregistrer les interactions avec les boutons ou la saisie de texte en tant qu'attribut Braze. Cela peut être fait directement dans l'éditeur. Un exemple courant est une enquête portant sur le Net Promoter Score.

B.Layer utilise le suivi des boutons Braze ajouté aux liens que vous saisissez (par exemple, `?button=0`). De cette façon, vous pouvez voir les clics sur les boutons dans la partie analyse de votre campagne.
...
5. Sélectionnez **Done** pour enregistrer votre Content Block.
6. Donnez à votre Content Block un nom descriptif, tel que « Contentful API », puis sélectionnez **Launch Content Block**.

### Étape 3 : Utiliser le Contenu connecté dans les campagnes et les Canvas {#step-3-use-connected-content-in-campaigns-and-canvasses}

1. Dans Braze, créez une nouvelle campagne ou modifiez-en une existante.
...
- [Contenu connecté de Braze]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/connected_content/)

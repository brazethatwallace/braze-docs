...
Dans votre Facebook Business Manager, allez dans **Integrations** > **Leads Access** dans le menu de navigation. Sélectionnez votre page Facebook, puis cliquez sur **CRMs**. Dans l'onglet CRM, sélectionnez **Assign CRMs** et ajoutez **Zapier**.

![Page d'accès aux prospects de Facebook Business Manager avec Zapier affecté en tant qu'intégration CRM.]({% image_buster /assets/img/fb_lead_ads_zapier/integration2.png %}){: style="max-width:80%;"}
...
![Étape de connexion du compte Facebook dans Zapier pour le déclencheur.]({% image_buster /assets/img/fb_lead_ads_zapier/create_zap3.png %}){: style="max-width:80%;"}

Sélectionnez votre page Facebook et le formulaire instantané que vous avez précédemment créé, puis **Continue**.

![Configuration du déclencheur Zapier avec sélection d'une page Facebook et d'un formulaire instantané.]({% image_buster /assets/img/fb_lead_ads_zapier/create_zap4.png %}){: style="max-width:80%;"}
...
![Exemple de mappage du payload webhook Zapier pour envoyer les champs de prospects Facebook vers Braze.]({% image_buster /assets/img/fb_lead_ads_zapier/configuration_example.png %}){: style="max-width:80%;"}

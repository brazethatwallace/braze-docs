...
1. Dans un Look dont une dimension `braze_id` est sélectionnée, cliquez sur l'icône d'engrenage (<i class="fas fa-cog"></i>) en haut à droite, puis sélectionnez **Send...**.

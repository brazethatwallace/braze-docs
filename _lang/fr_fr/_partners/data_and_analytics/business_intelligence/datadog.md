...
Une fois la connexion établie, Braze enverra les événements suivants à Datadog :

- `braze.messaging.sent` – Le nombre d'envois

Chacun de ces événements comportera des métadonnées sous forme de tags Datadog pour vous fournir des informations telles que :
...
![Metrics Explorer de Datadog affichant les indicateurs et tags d'événements Braze.]({% image_buster /assets/img/datadog.png %})
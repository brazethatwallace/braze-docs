...
description: "Cet article de référence présente le partenariat entre Braze et ThoughtSpot, une plateforme d'analyse de nouvelle génération qui permet aux utilisateurs d'effectuer des recherches illimitées dans leurs données d'interaction Braze et de découvrir des informations exploitables."
...
### Étape 1 : Connecter ThoughtSpot {#step-1-connect-thoughtspot}

...
4. Enfin, sélectionnez votre instance d'endpoint REST Braze dans la liste déroulante et enregistrez la destination. <br><br>![]({% image_buster /assets/img/zeotap/zeotap1.png %})

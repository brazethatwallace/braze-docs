...
### Étape 1 : Configurer la destination dans la console Snowplow {#step-1-configure-the-destination-in-snowplow-console}
...
3. Saisissez votre clé API Braze et l'endpoint de la REST API.
4. Enregistrez la connexion.

### Étape 2 : Configurer le transfert d'événements {#step-2-configure-the-event-forwarder}
...
### Étape 3 : Valider l'intégration {#step-3-validate-the-integration}

...
Après avoir installé votre déploiement Celebrus, utilisez les connecteurs Celebrus pour Braze afin d'intégrer les données Celebrus dans Braze. L'intégration de Celebrus pour Braze comporte deux éléments : le SDK Braze et les attributs personnalisés de Braze. Vous pouvez déployer l'un ou l'autre, ou les deux, selon la façon dont vous utilisez Braze et les cas d'usage dont vous avez besoin.

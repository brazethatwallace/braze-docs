...
1. Sélectionnez **Import data into BlueConic** dans le panneau de gauche pour ouvrir la page de configuration des données Braze.<br><br>
...
1. Sélectionnez **Export data to Braze** dans le panneau de gauche pour configurer votre exportation de données de BlueConic vers Braze.<br><br>
...
5. Enfin, cliquez sur **Run the connection** pour démarrer la connexion. Consultez [BlueConic](https://support.blueconic.com/hc/en-us/articles/205957522-Scheduling-Connections) pour en savoir plus sur la planification et l'exécution des connexions.
{% endtab %}
{% endtabs %}

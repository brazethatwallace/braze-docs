...
## Est-il possible d'obscurcir les données d'identification via le partage de données Snowflake ? {#is-it-possible-to-obfuscate-pii-data-via-snowflake-data-sharing}
...
- Votre compte Snowflake se trouve dans la région US-EAST-1 (AWS) et la région de votre tableau de bord de Braze se trouve aux États-Unis.
- Votre région Snowflake se trouve dans EU-CENTRAL-1 (AWS) et la région de votre tableau de bord de Braze se trouve dans l'UE.
- Votre région Snowflake se trouve dans AP-Northeast-1 (AWS) et la région de votre tableau de bord de Braze se trouve au Japon.
- Votre région Snowflake se trouve dans AP-Southeast-2 (AWS) et la région de votre tableau de bord de Braze se trouve en Australie.
- Votre région Snowflake se trouve dans AP-Southeast-3 (AWS) et la région de votre tableau de bord de Braze se trouve en Indonésie.
...
Le nombre de connecteurs dont vous avez besoin dépend de votre configuration spécifique et de vos droits. Contactez votre équipe de compte Braze pour en savoir plus sur les droits adaptés à votre cas d'usage.
...
- **Vues (recommandé) :** créez une vue pour chaque espace de travail filtrée par `app_group_id`. Cela évite de dupliquer les données tout en offrant à chaque équipe ou cas d'usage une vue propre et délimitée de ses données d'espace de travail.

...
Pour référence, voici tous les [champs Braze](/docs/assets/download_file/data-sharing-raw-table-schemas.txt) disponibles pour être incorporés dans l'analytique de Kubit. Les détails de cette étape sont très spécifiques au client et nécessitent des configurations particulières. Pour en savoir plus, adressez-vous à votre gestionnaire de compte Kubit ou à [support@kubit.ai](mailto:support@kubit.ai).
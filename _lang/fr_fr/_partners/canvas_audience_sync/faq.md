...
De plus, Braze hache toutes les données avant de synchroniser les utilisateurs avec nos partenaires Audience Sync, garantissant que toutes les données d'identification sont hachées en utilisant SHA256.

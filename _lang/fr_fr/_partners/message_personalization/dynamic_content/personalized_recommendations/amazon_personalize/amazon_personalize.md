...
description: "Cet article de référence décrit une architecture de référence et une intégration entre Braze et Amazon Personalize. Cet article de référence vous aidera à comprendre les cas d'usage proposés par Amazon Personalize, les données avec lesquelles il fonctionne, comment configurer le service et comment l'intégrer à Braze."
page_type: partner
search_tag: Partner
---
...
Cet article de référence vous aidera à comprendre les cas d'usage proposés par Amazon Personalize, les données avec lesquelles il fonctionne, comment configurer le service et comment l'intégrer à Braze.
...
| Cas d'usage définis | Avant de créer un modèle, vous devez déterminer votre cas d'usage pour cette intégration. Consultez la liste suivante pour les cas d'usage courants. |
...
Avant de créer un modèle, vous devez déterminer votre cas d'usage pour cette intégration. Parmi les cas d'usage courants, citons :
...
### Cas d'usage d'une campagne Content Cards {#content-card-campaign-use-case}

Lançons une campagne Content Cards avec le premier élément recommandé de la liste.<br><br>
...
Dans le tableau de bord de Braze, créez une nouvelle [campagne Content Cards]({{site.baseurl}}/user_guide/channels/content_cards/create_a_content_card). Dans le champ de texte du message, créez un bloc Liquid de contenu connecté pour interroger l'API et enregistrer la réponse dans la variable `recommendations` :

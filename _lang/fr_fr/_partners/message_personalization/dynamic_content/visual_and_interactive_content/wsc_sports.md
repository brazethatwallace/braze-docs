...
_Cette intégration est maintenue par WSC Sports._
...
| Clé API REST Braze | Une clé API REST Braze avec les autorisations **Messages**, **Segments**, **Campaigns** et **Canvas**. <br><br> Elle peut être créée dans le tableau de bord de Braze depuis **Paramètres** > **Clés API**. |
{: .reset-td-br_1 .reset-td-br_2 aria-label="Conditions préalables" }
...
### Étape 1 : Sélectionner les paramètres d'envoi {#step-1-select-send-settings}
...
### Étape 2 : Envoyer un test {#step-2-test-send}

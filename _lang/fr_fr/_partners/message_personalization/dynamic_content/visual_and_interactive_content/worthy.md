...
Créez une [Campaign de messages in-app]({{site.baseurl}}/user_guide/channels/in_app_messages/traditional/) dans Braze et définissez le **Message Type** sur **Custom Code**.

### Étape 3 : Copier votre message personnalisé dans Braze {#step-3-copy-your-personalized-message-into-braze}

Dans le créateur de messages Worthy, cliquez sur **Export** et sélectionnez **Braze** pour exporter votre message personnalisé afin de l'utiliser dans des Campaigns Braze. Copiez le contenu exporté dans la zone de texte HTML sous **HTML + Asset Zip** dans l'éditeur de Campaign Braze.

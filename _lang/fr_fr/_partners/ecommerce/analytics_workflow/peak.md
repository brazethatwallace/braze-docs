...
> [Peak](https://peak.ai/), une plateforme d'intelligence décisionnelle, est un système de bout en bout où l'intelligence décisionnelle est l'application commerciale de l'intelligence artificielle pour améliorer la prise de décision, augmenter le chiffre d'affaires et les bénéfices.
...
L'intégration est déclenchée par l'exécution du modèle d'intelligence artificielle et le recalcul des attributs prédictifs des clients. Ces résultats d'intelligence artificielle sont stockés dans Peak, y compris lorsqu'un attribut est mis à jour avec un nouveau statut ou une nouvelle valeur.

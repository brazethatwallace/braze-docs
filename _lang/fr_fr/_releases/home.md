...
#### Mise à jour du nom de l'indicateur pour les Content Cards et les bannières
...
#### Exclusions de points de données
...
#### Le Centre de livrabilité affiche les données Microsoft SNDS pour les clients Amazon SES
...
#### Assistants BrazeAI unifiés dans Operator
...
#### Prise en charge d'Operator pour la création et la modification de Campaigns
...
#### Prise en charge d'Operator pour les Content Blocks
...
#### Modèles de la Console des agents créés avec Operator
...
#### Améliorations de la Console des agents
...
#### Modifier une étape Optimiseur de contenu lancée
...
#### Fermeture par l'utilisateur pour les bannières
...
#### Suivi des clics personnalisé pour les bannières
...
#### Rééligibilité pour les bannières
...
#### Sélection de variante BrazeAI<sup>TM</sup>
...
#### Résultats d'envoi test WhatsApp
...
#### Convercus - Données et analyse - Fidélisation
...
#### Copy Pastd - Orchestration des messages - Modèles
...
#### Databricks Mosaic - Fournisseurs de modèles IA
...
#### DinMo - Données et analyse - Reverse ETL
...
#### EmailShepherd - Orchestration des messages - Modèles
...
#### Talkable - Personnalisation des messages - Recommandations
...
## Publication le 28 mai 2026

### Données et rapports

#### Tableau de bord des performances push
...
#### Champs de géolocalisation dans les sélections de catalogue
...
#### Banner et RCS pour le générateur de rapports
...
#### Actions de l'événement `ecommerce.cart_updated`
...
#### Optimiseur de contenu pour les messages SMS, MMS et RCS
...
#### États d'abonnement SMS orphelins
...
#### Chord - Plateforme de données client
...
## Publication le 30 avril 2026

### Données et rapports

#### Ajout rapide d'utilisateur pour la création de profils individuels
...
#### Synchronisations CDI sans copie pour les déclencheurs Canvas
...
#### Nouvelles mises à jour Currents pour les canaux Banner et WhatsApp
...
#### Composant Canvas Envoyer vers une destination
...
#### Comportement d'avancement de la validation de distribution pour les étapes Message
...
#### Limites de débit de messagerie de l'espace de travail
...
#### Étiquettes de produits, métachamps et collections Shopify
...
#### GRAVITY - Données et analyse - Fidélisation
...
#### Nouveaux champs du canal Banner dans les événements Currents et Datashare
...
#### Prise en charge des centres de données Mixpanel UE et Inde pour Currents
...
#### Sources et synchronisations réutilisables pour l'ingestion de données cloud (CDI)
...
#### Soumettre des tickets d'assistance depuis BrazeAI Operator<sup>TM</sup>
...
#### CataBoom - Personnalisation des messages - Contenu visuel et interactif
...
#### Denada - Orchestration des messages - Modèles
...
#### Poq - eCommerce - Plateforme d'applications mobiles
...
#### Connecter votre environnement de développement intégré (IDE) au Docs MCP
...
#### Sources d'ingestion de données cloud
...
#### Champs Campaign et Canvas pour Snowflake Data Share
...
#### Validation pré-importation CSV et rapport d'erreurs
...
#### Braze Agents dans la Console des agents
...
#### Autorisations granulaires des utilisateurs
...
#### Limitation de débit basée sur le canal
...
#### Traduire les locales dans les Content Blocks
...
#### Algolia - Recherche et recommandations
...
#### Anthropic - Fournisseur de modèles IA
...
#### Flybuy - Personnalisation des messages - Localisation
...
#### Google Gemini - Fournisseur de modèles IA
...
#### Open Loyalty - Données et analyse - Fidélisation
...
#### OpenAI - Fournisseur de modèles IA
...
#### Splio - Données et analyse - Importation de cohortes
...
#### Traduire les locales dans les bannières
...
#### Configurer la largeur des Content Blocks en glisser-déposer
...
#### Oracle Crowdtwist - Données et analyse
...
#### Open Loyalty - Données et analyse
...
#### Événements de la Console des agents pour les destinations de stockage et le Datashare
...
#### Envoyer un utilisateur anonyme vers les destinations Tealium
...
##### Envoyer un utilisateur anonyme vers des destinations CustomHTTP
...
#### Liste d'autorisation pour le contenu connecté

Vous pouvez autoriser des URL spécifiques à être utilisées pour le [contenu connecté]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/connected_content/making_an_api_call). Pour accéder à cette fonctionnalité, contactez votre gestionnaire du succès des clients.

...
- Non utilisée dans des Campaigns, Canvas ou segments actifs
- Non utilisée dans des Campaigns, Canvas ou segments inactifs (brouillon, arrêtés, archivés)
...
## Guides d'implémentation avancés Android {#android-advanced-implementation-guides}

### Content Cards

Ce [guide d'implémentation]({{site.baseurl}}/developer_guide/content_cards/) optionnel et avancé couvre les considérations de code des Content Cards, trois cas d'utilisation personnalisés créés par notre équipe, des extraits de code associés et des conseils sur l'enregistrement des impressions, des clics et des fermetures.

### Messages in-app {#in-app-messaging}

Ce [guide d'implémentation]({{site.baseurl}}/developer_guide/in_app_messages/customization/?sdktab=android) optionnel et avancé couvre les considérations de code pour les messages in-app, trois cas d'utilisation personnalisés créés par notre équipe et des extraits de code associés.

### Notifications push {#push-notifications}

Ce [guide d'implémentation]({{site.baseurl}}/developer_guide/push_notifications/examples/?sdktab=android) optionnel et avancé couvre les moyens de tirer parti d'une sous-classe personnalisée de `FirebaseMessagingService` pour exploiter au mieux vos messages push. Il comprend un cas d'utilisation personnalisé créé par notre équipe, des extraits de code associés et des conseils sur l'enregistrement des analyses.

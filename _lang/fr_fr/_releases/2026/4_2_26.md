...
- [Flutter SDK 18.0.0](https://pub.dev/packages/braze_plugin/changelog#1800)
    ...
    - Simplification du processus d'intégration iOS pour ne plus nécessiter l'écriture de code natif afin de transmettre les mises à jour de Content Cards, bannières, feature flags, messages in-app ou notifications push depuis le SDK natif.

...
[Open Loyalty]({{site.baseurl}}/partners/data_and_analytics/loyalty/openloyalty/) est une plateforme cloud de programmes de fidélité qui vous permet de créer et de gérer des programmes de fidélisation et de récompenses clients. L'intégration entre Braze et Open Loyalty synchronise les données de fidélité — telles que le solde de points, les changements de niveau et les alertes d'expiration — directement dans Braze en temps réel. Cela vous permet de déclencher des messages personnalisés (e-mail, push, SMS) lorsque le statut de fidélité d'un utilisateur change.
...
Les mises à jour suivantes du SDK ont été publiées. Les mises à jour majeures sont répertoriées ci-dessous ; toutes les autres mises à jour sont disponibles dans les journaux des modifications des SDK correspondants.

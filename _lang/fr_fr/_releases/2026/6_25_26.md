...
- Configurer des cas d'utilisation pré-définis avec Operator via le menu déroulant du bouton **Créer un agent**.
...
Les mises à jour SDK suivantes ont été publiées. Les mises à jour majeures sont répertoriées ci-dessous ; toutes les autres mises à jour sont disponibles dans les journaux de modifications des SDK correspondants.

...
* **Rows with errors :** télécharge un fichier contenant uniquement les lignes ayant un statut d'**erreur**.
* **All rows :** télécharge un fichier contenant toutes les lignes traitées au cours de l'exécution.

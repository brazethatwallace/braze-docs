...
- Envoyer une invitation de calendrier via la plateforme Braze pour « noter cette date » et étendre notre communication
- Mettre à jour une invitation existante si le contenu de l'événement change.

## Partenariat avec Passkit {#passkit-partnership}

...
En plus des corrections apportées à la section, un nouvel [événement d'abonnement]({{ site.baseurl}}/user_guide/data_and_analytics/braze_currents/message_engagement_events/#subscription-events) a été ajouté à la page des événements d'engagement liés aux messages.

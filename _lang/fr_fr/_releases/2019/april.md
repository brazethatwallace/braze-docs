...
En plus des corrections apportées à la section, un nouvel [événement d'abonnement]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events) a été ajouté à la page des événements d'engagement liés aux messages.
...
En outre, la propriété `canvas_step_id` a été ajoutée aux [événements de conversion]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events) disponibles.

...
Ajout de documentation et d'exemples sur le déploiement et la gestion du SDK Android de Braze à l'aide de [Google Tag Manager]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=android).

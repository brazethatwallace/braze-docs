...
L'intégration entre Braze et [Stripe]({{site.baseurl}}/partners/stripe) vous permet de déclencher des messages dans Braze sur la base d'événements Stripe tels que le démarrage d'un essai, l'activation d'un abonnement, l'annulation d'un abonnement, et plus encore.

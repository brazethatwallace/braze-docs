...
## Liquid 5
Pour les utilisateurs de l'entreprise existants, Liquid 5 est disponible de manière générale. Découvrez les [nouveautés de Liquid 5]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid/#whats-new-with-liquid-5).

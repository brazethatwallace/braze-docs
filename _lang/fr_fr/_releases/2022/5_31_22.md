...
L'intégration de Braze et [Hightouch]({{site.baseurl}}/partners/data_and_analytics/reverse_etl/hightouch/) vous permet d'importer des cohortes d'utilisateurs dans Braze, en envoyant des campagnes ciblées basées sur des données qui peuvent n'exister que dans votre entrepôt.

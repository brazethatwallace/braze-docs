...
You can't enable feature flags for users in your [Global Control Group]({{site.baseurl}}/user_guide/audience/global_control_group/). This means users in your Global Control Group also can't be part of Feature Flag experiments.

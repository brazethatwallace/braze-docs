...
For small icon artwork rules (alpha-only, no color), see [Android push notifications]({{site.baseurl}}/developer_guide/push_notifications/?sdktab=android), Step 2: Conform small icons to design guidelines.
{% endtab %}

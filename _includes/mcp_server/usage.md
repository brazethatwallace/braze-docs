...
{% tabs %}
{% tab Claude %}
!['Create an email template' being asked and answered in Claude.]({% image_buster /assets/img/mcp_server/claude/create_an_email_template.png %}){: style="max-width:85%;"}
{% endtab %}
...
{% tabs %}
{% tab Claude %}
!['Update a content block' being asked and answered in Claude.]({% image_buster /assets/img/mcp_server/claude/update_a_content_block.png %}){: style="max-width:85%;"}
{% endtab %}

...
**Totals:** **49** actionable rows (of 117).
...
**Epic BD-6308:** **66** additional rows would have appeared here but are listed in `_data/kb_epic_bd6308.txt` (Jira child issues under the epic); see `_data/kb_articles_skipped.md` for those rows.

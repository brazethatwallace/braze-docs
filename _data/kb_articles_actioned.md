...
**Reference-repo verification:** **85** row(s) have `conflict_resolution` = `inconclusive` — confirm behavior in reference repos (see `.github/skills/salesforce-migration/SKILL.md` Phase 2 Step 6) before drafting; do not copy Salesforce Knowledge text without source verification.
...
Within each vertical, rows are sorted by **tier ascending**, **score descending**, then title. Use [section 1](#1-phase-2-pr-batches-one-primary-_docs-file-per-pr) to choose the next PR.

### Vertical: `administer` — **8** articles

#### Team: `(empty team)` — 8 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000RdTVYA0` | 550 5.7.1 relaying denied email Error | `_docs/_user_guide/administer/global/workspace_settings/email_preferences.md` |
|  |  | `ka0VP000000TtCPYA0` | Dashboard Doesn't Load Correctly | `_docs/_user_guide/administer/personal/braze_support.md` |
|  |  | `ka0VP0000003O7RYAU` | Dashboard error when previewing email campaigns | `_docs/_user_guide/administer/global/user_management/permissions.md` |
|  |  | `ka0VP000000NgHtYAK` | Enabling Google SSO in Braze | `_docs/_user_guide/administer/global/saml_single_sign_on/saml_sso_setup.md` |
|  |  | `ka0VP000000RvTdYAK` | Error When Adding New Dashboard User: "Email is already taken" | `_docs/_user_guide/administer/global/user_management/manage_company_users.md` |
|  |  | `ka0VP000000Qh1JYAS` | How to Get the View PII Limited Role User Permission Enabled? | `_docs/_user_guide/administer/global/user_management/permissions.md` |
|  |  | `ka0VP000000QPnZYAW` | What if Dashboard Users need to Register with Multiple Companies in Braze? | `_docs/_user_guide/administer/global/user_management/manage_company_users.md` |
|  |  | `ka0VP000000S9zdYAC` | Why can't I fully Access my Braze Dashboard as a user. | `_docs/_user_guide/administer/global/user_management/permissions.md` |

### Vertical: `analytics` — **4** articles

#### Team: `(empty team)` — 4 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP0000004hG5YAI` | Custom Attribute methods for an Array value | `_docs/_user_guide/analytics/reports/custom_events_report.md` |
|  |  | `ka0VP0000002K13YAE` | Engagement Report - Broken Link Solution | `_docs/_user_guide/analytics/reports/engagement_reports.md` |
|  |  | `ka0VP000000S9I5YAK` | My Engagement Report/Report Builder Download link has expired. | `_docs/_user_guide/analytics/reports/report_builder.md` |
|  |  | `ka0VP000000LJfZYAW` | Onboarding Campaigns -  1st Session Based on "Session Start" | `_docs/_user_guide/analytics/dashboards/home.md` |

### Vertical: `api` — **6** articles

#### Team: `(empty team)` — 6 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000RY5dYAG` | Can we see delivery failures from API campaigns or API triggered campaigns? | `_docs/_api/endpoints/export/campaigns/get_campaign_analytics.md` |
|  |  | `ka0VP000000RiUnYAK` | Does a user need to be part of the selected SMS Subscription Group to receive SMS test messages? | `_docs/_api/endpoints/subscription_groups.md` |
|  |  | `ka0VP000000RXRJYA4` | How to Avoid Duplicate User Creation via Email Capture Forms | `_docs/_api/endpoints/subscription_groups.md` |
|  |  | `ka0VP000000RgnxYAC` | Snowflake Log for USERS_MESSAGES_EMAIL_UNSUBSCRIBE | `_docs/_api/endpoints/subscription_groups.md` |
|  |  | `ka0VP000000RGALYA4` | Understanding the Subscription Group Timeseries | `_docs/_api/endpoints/subscription_groups.md` |
|  |  | `ka0VP000000MIW9YAO` | What is the API Payload Limit for Braze APIs? | `_docs/_api/api_limits.md` |

### Vertical: `audience` — **14** articles

#### Team: `(empty team)` — 14 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000OmgDYAS` | Custom Event Properties Regex | `_docs/_user_guide/audience/segments/regex.md` |
|  |  | `ka0VP0000003WeTYAU` | Email Preference Center: "We are unable to process this request at this time, please try again later."  | `_docs/_user_guide/audience/subscription_preferences/preference_center/dnd_preference_center.md` |
|  |  | `ka0VP000000Pc8XYAS` | Find Segments That Reference Another Segment | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP0000009nPhYAI` | Has Received Message filter from Content Card Campaign | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka03o000001dRgrAAE` | How Many Campaigns/Canvases are Checked When Segmenting by Campaign/Canvas Tags? | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP000000942nYAA` | I can't find a purchase value in a segmentation filter | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP000000Pe8jYAC` | Is there a way to check if a user was part of a segment at a particular time/date? | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP000000RWTdYAO` | Successful Response From /users/delete or users/merge Endpoint But The User Is Not Deleted In Braze | `_docs/_user_guide/audience/manage_audience/import_users/csv_import.md` |
|  |  | `ka0VP000000R2AbYAK` | Total reachable users' count goes up after adding a filter | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP000000PKBdYAO` | User Profile Not Appearing in the Segment | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP000000RsNhYAK` | What clicks does 'Clicked in-app message' refer to in Clicked/Opened Campaign Segmentation Filter? | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP000000TIZRYA4` | What does the "Calculate Exact Statistics" Feature do? | `_docs/_user_guide/audience/segments/segmentation_filters.md` |
|  |  | `ka0VP000000RaLxYAK` | Why are multiple User Profiles associated with the Same Email Address? | `_docs/_user_guide/audience/manage_audience/merge_duplicate_users.md` |
|  |  | `ka0VP000000REjdYAG` | Why Users Don't Match Segment Criteria Despite Meeting Filter Conditions | `_docs/_user_guide/audience/segments/segmentation_filters.md` |

### Vertical: `channels` — **35** articles

#### Team: `(empty team)` — 35 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000Pzl3YAC` | "Campaign is already in delay window, so not enqueueing another" outcome with no delay on campaign | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000S5UbYAK` | *INTERNAL* High Total Clicks for Email | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000S59dYAC` | 550 5.7.1 Our system has detected that this message is likely unsolicited mail | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000OyHZYA0` | Can Data be Migrated Between App Groups and Braze Dashboards Environments | `_docs/_user_guide/channels/push/troubleshooting.md` |
|  |  | `ka0VP000000CrgTYAS` | Changes to Custom Unsubscribe Page in Email Settings are not Reflecting in Sent Emails | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000RQb7YAG` | Click Tracking Only Available for Links Directed to a HTTP or HTTPS Site (Can you click track phone numbers? etc.) | `_docs/_user_guide/channels/email/email_setup/open_pixel_and_click_tracking.md` |
|  |  | `ka0VP000000RIldYAG` | Content Block Does Not Render in Email Preview | `_docs/_user_guide/channels/email/drag_and_drop/dnd_editor_blocks.md` |
|  |  | `ka0VP000000MpiDYAS` | Content Cards not Refreshing at openSession() (Web SDK) | `_docs/_user_guide/channels/content_cards/create_a_content_card.md` |
|  |  | `ka0VP000000MOtJYAW` | Content Cards Pinning/Unpinning Behavior | `_docs/_user_guide/channels/content_cards/create_a_content_card.md` |
|  |  | `ka0VP000000MAS9YAO` | Does Braze Offer the "View this email in a browser" Feature? | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000Ju05YAC` | Does Email Unsubscribe Count Towards Unique Clicks | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000QgejYAC` | Does the content card ID change or remain the same when sent to a recipient more than once in a campaign? | `_docs/_user_guide/channels/content_cards/reporting.md` |
|  |  | `ka0VP000000ThO9YAK` | Drag and drop content block loses set mobile styling and alignment | `_docs/_user_guide/channels/email/drag_and_drop/faq.md` |
|  |  | `ka0VP000000NjIzYAK` | Email text is not displaying in Dark Mode | `_docs/_user_guide/channels/email/drag_and_drop/faq.md` |
|  |  | `ka0VP0000005OHpYAM` | Hidden Link Appearing In Heatmap. | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000TiQfYAK` | How to check SPF, DKIM and DMARC records | `_docs/_user_guide/channels/email/email_setup/authentication.md` |
|  |  | `ka0VP000000GCbVYAW` | How to Configure a Web Content Card to Open a Link in a New Tab? | `_docs/_user_guide/channels/content_cards/reporting.md` |
|  |  | `ka0VP000000S5nxYAC` | Interpreting Email Open Likelihood Test Results | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000D19ZYAS` | Max Devices Rule | `_docs/_user_guide/channels/push/troubleshooting.md` |
|  |  | `ka0VP000000RdzlYAC` | Metric counts are different in Email Performance Dashboard vs Engagement Report | `_docs/_user_guide/channels/email/reporting.md` |
|  |  | `ka0VP000000LSkTYAW` | Over Quota Email address | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000SGUrYAO` | SMS Subscribes are not accurately reflected in SMS/MMS/RCS Channel Engagement | `_docs/_user_guide/channels/sms_mms_and_rcs/faqs.md` |
|  |  | `ka0VP000000AgCTYA0` | SPF/DKIM Alignment | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000ANubYAG` | Timestamp of Email Subscription | `_docs/_user_guide/channels/email/subscriptions.md` |
|  |  | `ka0VP000000TkInYAK` | What are the possible sources for subscription state updates? | `_docs/_user_guide/channels/email/subscriptions.md` |
|  |  | `ka0VP000000TCnNYAW` | What does Braze need to do to help set up BIMI(Brand Indicators for Messaging Identification)? | `_docs/_user_guide/channels/email/email_setup/deliverability_pitfalls_and_spam_traps.md` |
|  |  | `ka0VP000000QlrJYAS` | What FCM Responses are treated as uninstall push? | `_docs/_user_guide/channels/push/troubleshooting.md` |
|  |  | `ka0VP000000RbGPYA0` | What is defined as a 'Good'  Email Deliverability Rate? | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000MTeTYAW` | What is the Difference Between a Full Sync and a Partial Sync for Content Cards? | `_docs/_user_guide/channels/content_cards/create_a_content_card.md` |
|  |  | `ka0VP000000P8TpYAK` | What is the Impact of Stopping Content Cards Campaigns? | `_docs/_user_guide/channels/content_cards/create_a_content_card.md` |
|  |  | `ka0VP000000QZBpYAO` | Whatsapp template has been falsely flagged - content against Whatsapp's Commerce Policy | `_docs/_user_guide/channels/whatsapp/faq.md` |
|  |  | `ka0VP000000OndtYAC` | When does Braze Log Push Open for a User? | `_docs/_user_guide/channels/push/troubleshooting.md` |
|  |  | `ka0VP000000RWWrYAO` | When does the recalculation of estimated real opens stop? | `_docs/_user_guide/channels/email/reporting/analytics_glossary.md` |
|  |  | `ka0VP000000RL8PYAW` | Why is Drag And Drop Editor Ignoring The Alignment Settings of Some Elements? | `_docs/_user_guide/channels/email/drag_and_drop/dnd_editor_blocks.md` |
|  |  | `ka0VP000000N4AzYAK` | Why is the custom font not displaying when previewing in email DND Templates? | `_docs/_user_guide/channels/email/drag_and_drop/faq.md` |

### Vertical: `data` — **12** articles

#### Team: `(empty team)` — 12 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000LtntYAC` | Can I pull tag information of campaigns and canvases from Currents? | `_docs/_user_guide/data/distribution/braze_currents/faq.md` |
|  |  | `ka03o000000tU17AAE` | Currents Timestamps / Epoch Time | `_docs/_user_guide/data/distribution/braze_currents/faq.md` |
|  |  | `ka0VP000000EtkbYAC` | Does the Amplitude Destination Support the Send of Anonymous User Data via Braze Currents? | `_docs/_user_guide/data/distribution/braze_currents/faq.md` |
|  |  | `ka0VP000000Pc6vYAC` | How Are Content Card/In-App message Control Group Impressions Being Logged in Currents? | `_docs/_user_guide/data/distribution/braze_currents/faq.md` |
|  |  | `ka0VP000000Lt9ZYAS` | How to Identify and Export Users Who Performed a Specific Custom Event? | `_docs/_user_guide/data/distribution/export_braze_data/segment_data_to_csv.md` |
|  |  | `ka0VP000000FquLYAS` | Missing Fields_To_Export In /Users/Export/Segment Export File | `_docs/_user_guide/data/distribution/export_braze_data.md` |
|  |  | `ka0VP000000TlYDYA0` | Setting Custom Attribute as "" (blank) vs. null | `_docs/_user_guide/data/activation/attributes/custom_attributes.md` |
|  |  | `ka0VP0000009TFhYAM` | Subscriptions & Usage - How Often is the Data Refreshed for Data Points? | `_docs/_user_guide/data/infrastructure/data_points.md` |
|  |  | `ka0VP000000RFuDYAW` | Targeting a Non-Existent User via API | `_docs/_user_guide/data/distribution/braze_currents/faq.md` |
|  |  | `ka0VP000000Q6D3YAK` | Testing Nested Custom Attributes and Nested Objects for Custom Event Properties | `_docs/_user_guide/data/activation/attributes/nested_custom_attribute_support.md` |
|  |  | `ka0VP0000007YD3YAM` | What to expect when using Engagement Reports in S3 | `_docs/_user_guide/data/distribution/braze_currents/faq.md` |
|  |  | `ka0VP0000006bcnYAA` | Why Conversionbehaviours event from Currents has a different time than the canvas? | `_docs/_user_guide/data/distribution/braze_currents/faq.md` |

### Vertical: `developer_guide` — **5** articles

#### Team: `(empty team)` — 5 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000OgZBYA0` | 3rd Party Web cookie tracking | `_docs/_developer_guide/platforms/web/content_security_policy.md` |
|  |  | `ka0VP000000NlavYAC` | Are there known React and React Native versions needed to work with Braze's React SDK? | `_docs/_developer_guide/sdk_integration.md` |
|  |  | `ka0VP00000087sLYAQ` | Data Not Getting to Braze | `_docs/_developer_guide/sdk_integration/reading_verbose_logs.md` |
|  |  | `ka0VP0000005gD7YAI` | User Data Discrepancies when performing tasks via SDK/REST API simultaneously or in close succession. | `_docs/_developer_guide/sdk_integration/reading_verbose_logs.md` |
|  |  | `ka0VP000000Q6szYAC` | When might a user have 0 sessions recorded against their profile? | `_docs/_developer_guide/sdk_integration/reading_verbose_logs.md` |

### Vertical: `messaging` — **41** articles

#### Team: `(empty team)` — 41 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000RNOjYAO` | *INTERNAL* Liquid Parse Error Aborts Message | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/using_liquid.md` |
|  |  | `ka0VP000000L5ntYAC` | Aborted Message Error "Invalid from email address for recipient:" | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000RgHhYAK` | Action Path error when selecting link alias. | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000Tt4LYAS` | Are There Size Limits of Canvas Entry Properties Object? | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000RKFZYA4` | Button Click Analytics Not Showing For Drag-and-Drop IAMs | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000MPSnYAO` | Campaign Last Sent Metric Does Not Match Last Message Send Timestamp | `_docs/_user_guide/messaging/campaigns/test_campaigns/campaign_analytics.md` |
|  |  | `ka0VP000000FvpBYAS` | Can I supply liquid inside the abort_message tag? | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000JWDtYAO` | Canvas won't save after making changes (No error message displayed) | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP0000003XAjYAM` | Connected Content Call is not returning a response | `_docs/_user_guide/messaging/design_and_edit/personalize/connected_content.md` |
|  |  | `ka0VP000000RIAXYA4` | Delay Step Auto Advancement Behavior When a Canvas is Stopped | `_docs/_user_guide/messaging/canvas/canvas_components/delay_step.md` |
|  |  | `ka03o000001dVxBAAU` | Delayed Delivery Behavior in Branching IAM Canvas Step's | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000TfNxYAK` | DnD content block preview different from compose view | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000Pal3YAC` | Do we support an array of arrays in Liquid? | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000P5kTYAS` | Email and SMS - unique recipients greater than sends | `_docs/_user_guide/messaging/campaigns/test_campaigns/campaign_analytics.md` |
|  |  | `ka0VP000000GHmTYAW` | Generate An Image Using AI | `_docs/_user_guide/messaging/design_and_edit/media_library.md` |
|  |  | `ka0VP000000TJX7YAO` | Help! I accidentally uploaded the wrong CSV to import some promo codes, and I clicked "Save List" | `_docs/_user_guide/messaging/design_and_edit/personalize/sources/promotion_codes.md` |
|  |  | `ka0VP000000S3hJYAS` | How Do I Create A Dynamic 'Reply-To' Email Address? | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP00000070o5YAA` | I received the error: "Canvas Entry Properties may not be used in In-App Messages." | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000LhrZYAS` | IAM Campaign Error: Warning: Use of the {% connected_content %} tag with retry is not available for this message type. | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000NMZJYA4` | Is it possible to create vanity URLs for Media Library image assets, and if so, how? | `_docs/_user_guide/messaging/design_and_edit/media_library.md` |
|  |  | `ka0VP000000GxqXYAS` | Is Random Variant Assignment Based on a User's Random Bucket number? | `_docs/_user_guide/messaging/canvas/create_a_canvas.md` |
|  |  | `ka0VP000000RanNYAS` | Liquid / Content Block changes position when switching from HTML > Classic Editor | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/using_liquid.md` |
|  |  | `ka0VP000000JENRYA4` | Liquid Error Occurs On The Dashboard When Previewing Some Data Types | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000P5nhYAC` | Liquid: Event Property Values in Message Composer Preview Mode | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000HPoPYAW` | Re-Launching an Archived Campaign or Canvas | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000S1h7YAC` | Schedule Campaign Sent A Day Before The Schedule Time | `_docs/_user_guide/messaging/campaigns/schedule_your_campaign/scheduled_delivery.md` |
|  |  | `ka0VP000000GD2vYAG` | Scheduled Delay For Campaign Delivery | `_docs/_user_guide/messaging/campaigns/schedule_your_campaign/scheduled_delivery.md` |
|  |  | `ka0VP000000Rt21YAC` | Scheduled Email Campaign Did Not Send to the Entire Estimated Audience | `_docs/_user_guide/messaging/campaigns/schedule_your_campaign/scheduled_delivery.md` |
|  |  | `ka0VP000000SFovYAG` | Triggering Action-Based Campaign/Canvas Custom Event Dated in the Past | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000Ji3lYAC` | Users in the Canvas are bigger than the Estimated Audience | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP0000008BhRYAU` | When are Users "Kicked" Out of a Canvas via Exception Event? | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000GmwjYAC` | When is a Canvas Step Logged to a User's Profile? | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000HoEvYAK` | Why am I facing an error Unexpected end token when working with Liquid? | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000MwgTYAS` | Why does my historical campaign no longer show any metrics on the Analytics page? | `_docs/_user_guide/messaging/campaigns/test_campaigns/campaign_analytics.md` |
|  |  | `ka0VP000000N7yTYAS` | Why is a Tag No Longer Appended to a Campaign or Canvas? | `_docs/_user_guide/messaging/canvas/faqs.md` |
|  |  | `ka0VP000000Mh4jYAC` | Why is my content block not appearing under 'Row' in the DnD search tool? | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000Eiu1YAC` | Why is my Liquid snippet containing Catalog items returning an abort message? | `_docs/_user_guide/messaging/design_and_edit/personalize/liquid/faq.md` |
|  |  | `ka0VP000000RL3ZYAW` | Why Is Segment Size Smaller Than Canvas Analytics | `_docs/_user_guide/messaging/canvas/testing_canvases/measuring_and_testing_with_canvas_analytics.md` |
|  |  | `ka0VP000000OOE5YAO` | Why the Canvas Steps Conversion Rate does not equal the Canvas Variant Total Conversion Rate? | `_docs/_user_guide/messaging/messaging_fundamentals/conversion_events.md` |
|  |  | `ka0VP0000007fJNYAY` | Will Receiving a Seed Email Update My User Profile / Analytics? | `_docs/_user_guide/messaging/messaging_fundamentals/sending_test_messages.md` |
|  |  | `ka0VP000000JYHJYA4` | Would User Exit Canvas If Message is Aborted? | `_docs/_user_guide/messaging/messaging_fundamentals/frequency_capping.md` |

### Vertical: `partners` — **1** articles

#### Team: `(empty team)` — 1 articles

| Tier | Score | article_id | Title | Primary `_docs` target |
| --- | --- | --- | --- | --- |
|  |  | `ka0VP000000EX7NYAW` | Is there a set of IPs specifically for storage that can be provided to customers for whitelisting for Azure? | `_docs/_partners/data_and_analytics/cloud_storage/microsoft_azure_blob_storage_for_currents.md` |

...
# Braze Web SDK [![latest](https://img.shields.io/github/v/tag/braze-inc/braze-web-sdk?label=latest%20release&color=300266)](https://github.com/braze-inc/braze-web-sdk/releases) [![Static Badge](https://img.shields.io/badge/TSDoc-801ed7)](https://js.appboycdn.com/web-sdk/6.6/doc/modules/braze.html) ![lighthouse score](https://raw.githubusercontent.com/braze-inc/braze-web-sdk/master/.github/assets/lighthouse-score.svg)
...
| ---- | ----------- | --- | -------
| Full | Full SDK with UI. When using the npm version, Javascript bundlers will remove any unused code including the UI. | `@braze/web-sdk` | https://js.appboycdn.com/web-sdk/6.6/braze.min.js
| Core | Contains the SDK without UI. You will need to implement your own UI for In-App Messaging and Content Cards when using this version of the SDK. Our UI elements are fully customizable via css, so we generally recommend integration of the full library instead. | N/A | https://js.appboycdn.com/web-sdk/6.6/braze.core.min.js
| No-AMD | Contains the full SDK without AMD support. This is useful if your site uses RequireJS or another AMD module-loader, but you prefer to load the SDK through the CDN. | N/A | https://js.appboycdn.com/web-sdk/6.6/braze.no-amd.min.js
...
so remove this option or [provide an alternate logger](https://js.appboycdn.com/web-sdk/6.6/doc/modules/braze.html#setlogger) before you release your page to production.

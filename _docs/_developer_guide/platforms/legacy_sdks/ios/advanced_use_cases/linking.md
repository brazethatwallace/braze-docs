...
For introductory information on deep links, refer to our [User Guide article]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/actions_and_media_urls#what-is-deep-linking). If you're looking to implement deep links for the first time in your Braze app, the following steps will get you started.

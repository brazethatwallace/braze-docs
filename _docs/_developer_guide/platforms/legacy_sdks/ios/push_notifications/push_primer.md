...
Refer to [link handling customization]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/advanced_use_cases/linking#linking-handling-customization) for more information on deep linking.

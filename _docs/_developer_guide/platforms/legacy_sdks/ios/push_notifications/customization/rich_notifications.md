...
![Xcode target picker creating a Notification Service Extension for rich notifications.]({% image_buster /assets/img_archive/ios10_se_at.png %}){: style="max-width:90%"}

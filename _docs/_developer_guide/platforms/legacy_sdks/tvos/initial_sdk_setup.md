...
{% alert note %}
Our tvOS SDK currently supports analytics functionality. To add a tvOS app in your dashboard, open a [support ticket]({{site.baseurl}}/user_guide/administer/personal/braze_support).
{% endalert %}

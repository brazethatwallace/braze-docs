...
For HTML in-app messages, use the [`Javascript Bridge`]({{site.baseurl}}/user_guide/channels/in_app_messages/message_types/custom_html#javascript-bridge) instead, as deeplinks are not supported in HTML message types.

...
Adding pages to your in-app message lets you guide users through a sequential flow, like an onboarding flow or welcome journey. To learn more, see [Creating an in-app message with drag-and-drop]({{site.baseurl}}/user_guide/channels/in_app_messages/drag_and_drop#multi-page).
...
To get started, see [AI Liquid assistant]({{site.baseurl}}/user_guide/brazeai/operator/capabilities/#generate-liquid).

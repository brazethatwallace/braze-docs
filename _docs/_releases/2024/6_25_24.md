...
Migrate your WhatsApp phone number between WhatsApp Business Accounts by using Meta's Embedded Signup. Read more about [migrating between WhatsApp Business Accounts]({{site.baseurl}}/user_guide/channels/whatsapp/whatsapp_setup/whatsapp_phone_numbers/migrate_a_phone_number#migrate-between-whatsapp-business-accounts).
...
![Liquid syntax highlighting with color-coded labels for attribute names, custom attributes, abort messages, Connected Content tags, and tag values.]({% image_buster /assets/img/liquid_color_code.png %})

...
[WhatsApp video files]({{site.baseurl}}/user_guide/channels/whatsapp/create_a_whatsapp_message#outbound-messages) can now be hosted through either a URL or in the Braze media library.

### WhatsApp list messages

[List messages]({{site.baseurl}}/user_guide/channels/whatsapp/message_processing/messaging_users#list-messages) appear as a body message with a list of clickable options. Each list can have multiple sections, and each list can have up to 10 rows.

...
You can [add tags to a custom attribute]({{site.baseurl}}/user_guide/data/activation/attributes/custom_attributes#add-tags) after it's created if you have the "Manage Events, Attributes, Purchases" permission. The tags can then be used to filter the list of attributes.

...
The Braze and [SalesWings]({{site.baseurl}}/partners/data_and_analytics/analytics/saleswings) integration allows you to sync data across the two platforms in a flexible way to qualify leads with lead scoring and lead grading capabilities.

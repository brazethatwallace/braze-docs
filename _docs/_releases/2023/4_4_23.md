...
Two new events were added to the Currents glossary: [Canvas abort message events]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events) and [campaign abort message events]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events).

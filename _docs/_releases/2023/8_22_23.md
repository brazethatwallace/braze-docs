...
You can now [merge users by email]({{site.baseurl}}/api/endpoints/user_data/post_users_merge#merging-users-by-email-or-phone-number) using the `/users/merge` endpoint. 
...
In the Deliverability Center, you can now view and monitor your [domain reputation]({{site.baseurl}}/user_guide/analytics/dashboards/deliverability_center#domain-reputation) to help avoid being filtered into a spam folder.

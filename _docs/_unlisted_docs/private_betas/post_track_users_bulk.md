...
{% alert note %}
As of May 26, 2025, this endpoint can be used to track conversion metrics, as well as trigger exception events, or action-based campaigns and Canvases. This behavior is similar to any other Braze data ingestion method.
{% endalert %}
...
Yes. You can construct your request with any amount of attributes, events, and purchase objects up to 10,000 objects per request.

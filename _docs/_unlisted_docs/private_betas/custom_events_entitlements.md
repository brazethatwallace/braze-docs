...
Custom events require additional setup. Refer to the following list for documentation about each platform, where you'll find information about the methods used to log custom events and how to add properties and quantities to your custom events.

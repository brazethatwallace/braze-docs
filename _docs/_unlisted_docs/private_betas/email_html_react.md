...
Benefits also include improved Liquid syntax support and [multi-language settings support]({{site.baseurl}}/user_guide/administer/global/workspace_settings/multi_language_settings).

Link management is also supported in the updated HTML editor, even if you don't have [link aliasing]({{site.baseurl}}/user_guide/messaging/templates/email_templates/link_aliasing) turned on.
...
{% alert tip %}
Check out our dedicated [HTML editor for email]({{site.baseurl}}/user_guide/channels/email/html_editor) section for additional resources.
{% endalert %}
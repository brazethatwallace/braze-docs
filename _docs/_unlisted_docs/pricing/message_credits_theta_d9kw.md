...
|---------|-------------------------------------------------|
| **Destination** | Specific final region, country, or type of action being sent through the Braze platform |
| **Credits per 1 Send** | Exact number of Message Credits to perform one send<br> (credits per send = credit ratio x destination multiplier) |
...
<table class="credits-table" aria-label="Credit ratio table for Message Credits - Theta">
    <colgroup>
        <col span="3">
...
Braze will charge Message Credits on any LINE messages sent from the Braze platform.

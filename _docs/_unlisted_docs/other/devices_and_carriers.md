...
The **Device & Carriers** page, located under **Data**, shows a breakdown of user operating systems, screen resolutions, wireless carriers, device models, and browsers across different workspaces. This tool can be used to help with targeting decisions in your messages.

...
Before implementation, be sure to review examples of the segmentation options afforded by custom events, custom attributes, and purchase events in our [Best practices]({{site.baseurl}}/developer_guide/analytics/#best-practices) article. We also recommend familiarizing yourself with our [event naming conventions]({{site.baseurl}}/user_guide/data/activation/events/event_naming_conventions/).
...
You can also use our REST API to record purchases. Refer to the [users API]({{site.baseurl}}/api/endpoints/user_data) documentation for details.

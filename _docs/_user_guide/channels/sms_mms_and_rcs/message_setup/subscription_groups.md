...
- **REST API:** Use the [`/subscription/status/set` endpoint]({{ site.baseurl}}/api/endpoints/subscription_groups/post_update_user_subscription_group_status/) to programmatically set user profiles with the Braze REST API. Each request can include between 1 and 25 subscription groups.

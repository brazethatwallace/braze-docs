...
Your [Credits Usage dashboard]({{site.baseurl}}/user_guide/administer/global/billing/credits_usage) reflects these billing types and provides the number of segments used for US messages, giving you a transparent view of your message credit consumption.

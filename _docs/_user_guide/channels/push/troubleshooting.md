...
3. In the **Cloud Messaging** tab, check that the Sender ID in the following section the API keys matches the one in Braze (in **Settings** > **App Settings** > **Cloud Messaging API Key**).

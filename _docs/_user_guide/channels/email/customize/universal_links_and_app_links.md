...
![App Services section]({% image_buster /assets/img_archive/universal_links_1b.png %}){: style="max-width:75%;"}
...
![Associated Domains section]({% image_buster /assets/img_archive/universal_links_1d.png %})

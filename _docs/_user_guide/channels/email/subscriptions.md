...
For more information about creating groups, segmenting, archiving, and channel-specific behavior, see [Subscription groups]({{site.baseurl}}/user_guide/audience/subscription_preferences/subscription_groups#email-subscription-groups).

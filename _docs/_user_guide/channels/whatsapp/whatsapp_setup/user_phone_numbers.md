...
You can import phone numbers by [uploading a CSV]({{site.baseurl}}/user_guide/audience/manage_audience/import_users#constructing-your-csv) or [via API]({{site.baseurl}}/api/endpoints/user_data/post_user_track) to create a user.

...
![Recommendation audience metrics showing precision (25.3%), coverage (54.3%), and personalization rate split between personalized and most popular items.]({% image_buster /assets/img/item_recs_analytics_1.png %})

...
Following [Connect your data]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/prepare_data/connect_data_sources), Poppy ensures rich first-party signals (including purchase history, category affinity, browse behavior, and engagement) feed the agent so each decision is grounded in real behavior. 

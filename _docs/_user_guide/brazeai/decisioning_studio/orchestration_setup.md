...
For detailed steps to configure the SFMC integration, see [SFMC data requirements]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/decisioning_studio_go/connect_data_sources/#sfmc-data-requirements) in the Decisioning Studio Go documentation.

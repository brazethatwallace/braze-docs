...
user_menu_list:
  - name: Manage company users
    ...
    description: Add Braze users and manage related company user settings
  - name: Access your account
    ...
    description: Sign in with SSO or your Braze URL and troubleshoot issues
  - name: Create a Canvas
    ...
    description: Create and launch a Canvas, from beginning to end

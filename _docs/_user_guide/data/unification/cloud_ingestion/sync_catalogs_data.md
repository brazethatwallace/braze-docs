...
- Upload a [CSV]({{site.baseurl}}/user_guide/data/activation/catalogs/create)
- Create a catalog in the [Braze dashboard]({{site.baseurl}}/user_guide/data/activation/catalogs/create) or during CDI setup.

...
Braze generates calculated metrics from three inputs: [SDK-tracked data](#minimum-integration) (for example, [session start and session end]({{site.baseurl}}/developer_guide/analytics/tracking_sessions)), [message interaction data for non-SDK channels]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events), and [Braze-derived reporting fields]({{site.baseurl}}/user_guide/analytics/metrics_glossary). These values are generated by Braze services, so a user profile can include both SDK-tracked and Braze-generated data.

Calculated metrics include channel-based metrics (listed in the [Report metrics glossary]({{site.baseurl}}/user_guide/analytics/metrics_glossary)) and the following attributes.
...
Minimum integration means you only collect the required data listed in [Minimum integration](#minimum-integration) and opt out of [optional data collected by default](#optional-data-collected-by-default) by [blocking optional SDK data collection]({{site.baseurl}}/developer_guide/getting_started/sdk_overview).
...
In addition to the minimum integration data, the following attributes are automatically captured by Braze when you initialize the SDK integration. You can [opt-out]({{site.baseurl}}/developer_guide/getting_started/sdk_overview) of collecting these attributes to allow for a minimum integration.
...
To make the most out of Braze, our SDK integrators often implement the Braze SDKs and log [custom attributes]({{site.baseurl}}/user_guide/data/activation/attributes/custom_attributes#set-custom-attributes), [custom events]({{site.baseurl}}/user_guide/data/activation/events/custom_events#logging-custom-events) and [purchase events]({{site.baseurl}}/user_guide/data/activation/events/purchase_events#log-purchase-events) that are pertinent to their business on top of the automatically collected data.

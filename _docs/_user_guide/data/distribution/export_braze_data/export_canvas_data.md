...
- **Build a user list in the dashboard:** Create a segment with an **Entered Canvas Variation** filter, then export the segment to CSV. See [Canvas troubleshooting]({{site.baseurl}}/user_guide/messaging/canvas/troubleshooting#user-didnt-enter-a-canvas).

...
- If you need date-aligned exports for dashboard-style reporting outside standard API windows, {% multi_lang_include product_feedback_cta.md context="gap" feature="date-aligned campaign or Canvas exports" %}

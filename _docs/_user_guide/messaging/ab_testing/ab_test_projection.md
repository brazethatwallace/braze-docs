...
{% alert note %}
For [multiple platform push campaigns]({{site.baseurl}}/user_guide/channels/push/create_a_push_message/multiple_platform_push/), A/B testing is supported when you select multiple platforms.
{% endalert %}

...
However, if conversion rates across variants and the control **converge** (get closer together) as more messages are sent, confidence can **decrease**, because the measured gap you care about is shrinking even as sample size grows.

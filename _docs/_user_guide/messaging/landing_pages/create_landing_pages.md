...
| Manage Subscriptions | A checklist of email or SMS subscription groups. Users select which groups they want to join when they submit the form. Each block is for one channel. For more information, see [Manage Subscriptions block]({{site.baseurl}}/user_guide/messaging/landing_pages/manage_subscriptions/). |

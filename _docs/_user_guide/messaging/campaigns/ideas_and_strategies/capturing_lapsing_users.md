...
![Screenshot related to step 1: segment users.]({% image_buster /assets/img_archive/2weeklapse1.png %}){: style="max-width:70%;"}
...
![Next, click Create Campaign and choose the type of campaign we will be sending to this segment. in this example, we'll create a new push campaign.]({% image_buster /assets/img_archive/2weeklapse2.png %}){: style="max-width:70%;"}

...
- Ask Operator to help draft your campaign from a brief, or refine targeting and delivery choices. For details, see [Campaigns and audiences]({{site.baseurl}}/user_guide/brazeai/operator/capabilities#campaigns-and-audiences).

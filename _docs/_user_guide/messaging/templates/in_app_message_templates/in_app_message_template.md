---
nav_title: Create an in-app message template
article_title: Create an in-app message template
page_order: 0
description: "This reference article covers how to create, save, and manage in-app message templates from the Templates section of the Braze dashboard, including color profiles and CSS templates for the traditional editor."
tool:
  - Templates
channel:
  - in-app messages
...
On **Content** > **In-App Message**, filter, search, or open a template to edit. You can [duplicate]({{site.baseurl}}/user_guide/messaging/templates/managing_templates#duplicating-templates) and [archive]({{site.baseurl}}/user_guide/messaging/templates/managing_templates#archiving-templates) templates like other template types. For an overview of template and media workflows, see [Templates]({{site.baseurl}}/user_guide/messaging/templates).
...
![The in-app message color profile template editor.]({% image_buster /assets/img/drag_and_drop/templates/color_profile_template.png %})

...
This is a great place to get a high-level overview to check how your Canvas is performing against your goal. To get notified proactively if a Canvas's performance drops outside your expected range, refer to [Canvas threshold alerts]({{site.baseurl}}/user_guide/messaging/canvas/managing_canvases/canvas_threshold_alerts).

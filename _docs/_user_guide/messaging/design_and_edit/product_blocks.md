...
{: .reset-td-br-1 .reset-td-br-2 role=“presentation” aria-label="Requirements" }
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 role=”presentation” aria-label="Types of drag-and-drop product blocks" }
...
{: .reset-td-br-1 .reset-td-br-2 role=“presentation” aria-label="Dynamic product block" }
...
| Button for product URL | Catalogs |
| Price | Catalogs |
{: .reset-td-br-1 .reset-td-br-2 role=“presentation” aria-label="Static product block" }
...
{: .reset-td-br-1 .reset-td-br-2 role=“presentation” aria-label="Layout options" }

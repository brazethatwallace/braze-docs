---
nav_title: "Use case: Nested custom attributes"
article_title: "Use case: Segment with nested custom attributes"
page_order: 10
page_type: tutorial
tool: Segments
...
![A list of custom attributes with an option to generate the schema for the accounts attribute.]({% image_buster /assets/img_archive/nca_generate_schema.png %})
...
![Schema for the accounts object array with three nested values: active, balance, and type.]({% image_buster /assets/img_archive/nca_schema.png %}){: style="max-width:70%" }
...
![Nested custom attribute filtering for the accounts object array.]({% image_buster /assets/img_archive/nca_segment_schema.png %})
...
![Accounts schema with searchable list of paths.]({% image_buster /assets/img_archive/nca_segment_schema2.png %}){: style="max-width:70%" }

Select **less than** as the comparator, then enter "100" as the balance value.

![A filter for users with an account balance less than 100.]({% image_buster /assets/img_archive/nca_segment_schema_3.png %})

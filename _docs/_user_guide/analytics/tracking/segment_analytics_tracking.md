...
{% alert note %}
After enabling analytics tracking, expect a delay before the segment data populates in your reports. If the data doesn't populate within 24 hours, [contact Support]({{site.baseurl}}/braze_support).
{% endalert %}

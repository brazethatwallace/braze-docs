...
These are aborts that don’t fall into existing dashboard categories. If you still notice a large proportion of aborts with "Other", contact [Braze Support]({{site.baseurl}}/user_guide/administer/personal/braze_support) for further assistance.

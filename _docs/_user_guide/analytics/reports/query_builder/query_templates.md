...
| Query name | Description | 
| --- | --- | 
| Email bounces per domain | The number of bounces per email domain, broken down into total bounces, hard bounces, and soft bounces. <br> ![Screenshot related to email templates.]({% image_buster /assets/img_archive/query_builder_q4.png %}){: style="max-width:60%;"} |
...
| Email performance by country | This report shows the following metrics for each country: sends, indirect open rate, and direct open rate. Country is the country of the user at the time of push send. <br><br> ![Screenshot related to email templates.]({% image_buster /assets/img_archive/query_builder_q3.png %}) |
...
| Query name | Description | 
| --- | --- | 
| Device carriers | The number of users per device carrier, such as Verizon and T-Mobile. <br><br> ![Screenshot related to mobile templates.]({% image_buster /assets/img_archive/device_carriers.png %}){: style="max-width:50%;"} |
| Device models | The number of users per device model, such as iPhone 15 Pro and Pixel 7. <br><br> ![Screenshot related to mobile templates.]({% image_buster /assets/img_archive/device_models.png %}){: style="max-width:50%;"} |
| Device operating systems | The number of users per operating system, such as 17.4 and Android 14. <br><br> ![Screenshot related to mobile templates.]({% image_buster /assets/img_archive/os_version.png %}){: style="max-width:50%;"} |
| Device screen resolutions | The number of users per device screen resolution, such as 1179x2556 and 750x1334. <br><br> ![Screenshot related to mobile templates.]({% image_buster /assets/img_archive/device_screen_resolutions.png %}){: style="max-width:40%;"} |
| SMS Error Codes | This report shows the error type and number of errors for each SMS error code. <br><br>![Screenshot related to mobile templates.]({% image_buster /assets/img_archive/sms_errors.png %}){: style="max-width:50%;"} |
...
| Query name | Description | 
| --- | --- | 
| Push performance by country | This report shows the following metrics for each country: deliveries, open rate, and click rate. Country is the country of the user at the time of email send. <br><br> ![Screenshot related to push templates.]({% image_buster /assets/img_archive/query_builder_q7.png %}){: style="max-width:70%;"} |

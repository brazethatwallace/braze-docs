...
- **Units**: You can adjust the units between the percentage of users and the number of users in the top area-hand corner of the chart, specific units may prove to be more significant when judging the impact of a campaign or Canvas.

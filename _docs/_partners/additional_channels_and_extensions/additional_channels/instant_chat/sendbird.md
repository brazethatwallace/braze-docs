...
![Diagram of marketing and transactional Sendbird notification use cases with Braze.]({% image_buster /assets/img/sendbird/use-cases.png %})
...
![Sendbird dashboard page for creating a notification template.]({% image_buster /assets/img/sendbird/sendbird-dashboard-template.png %})
...
![Sendbird Notification Builder browser extension in the Chrome toolbar.]({% image_buster /assets/img/sendbird/sendbird-notification-builder.png %})
...
2. Select the webhook template you created in the previous step. It's highly recommended you use the Batch endpoint for campaigns.
...
3. Select the webhook template you created in the previous step. It's highly recommended you use the Real-time endpoint for Canvases.

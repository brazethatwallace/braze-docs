...
| [LinkedIn]({{site.baseurl}}/partners/canvas_audience_sync/linkedin_audience_sync/) | Up to 48 hours | Braze batches up to 2,000 users per request with an auto-retry of up to ~13 hours. | AI predictive audiences | {::nomarkdown}<ul><li>The minimum audience size is 300 members with location targeting taken into consideration.</li><li>LinkedIn shows match rate in the Braze dashboard.</li></ul>{:/} |

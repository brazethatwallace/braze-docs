...
At this time, value-based custom audiences aren't supported by Braze. {% multi_lang_include product_feedback_cta.md context="gap" feature="value-based custom audience sync" %}

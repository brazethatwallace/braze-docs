...
![B.Layer dashboard overview for creating branded in-app message templates.]({% image_buster /assets/img/blayer/blayer2.png %})
...
![B.Layer brand assets menu with color and font configuration options.]({% image_buster /assets/img/blayer/blayer4.png %})
...
![B.Layer message editor with customizable in-app components.]({% image_buster /assets/img/blayer/blayer5.png %})
...
In Braze, create a custom code in-app message. If you have a ZIP file, drag and drop it into the box in the previous step the code section. If you have an inline HTML file, paste the inline HTML into the HTML section.

![Braze custom code in-app message editor with B.Layer HTML or ZIP upload area.]({% image_buster /assets/img/blayer/blayer6.png %})

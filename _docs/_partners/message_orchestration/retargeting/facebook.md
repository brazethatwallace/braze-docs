...
- The exact users that were successfully added to a Custom Audience. [Learn more about how Facebook reports users added to custom audiences.](https://www.facebook.com/business/help/112061095610075)
- The size of the Custom Audience. [Learn more about Facebook custom audience reach estimate changes.](https://marketingland.com/exclusive-facebook-will-no-longer-show-audience-reach-estimates-for-custom-audiences-after-vulnerability-detected-236923)
{% endalert %}
...
![Canvas entry audience filter set to Ads Tracking Enabled for audience export eligibility.]({% image_buster /assets/img/tiktok/tiktok16.png %}){: style="max-width:75%;"}
...
- **Check that you're an admin of the ad account:** Go to [business.facebook.com](https://business.facebook.com/) then select **Business Settings** from the Business Settings dropdown dropdown. Next, go to **Accounts** > **Ad accounts**, and select the ad account. Confirm your access and that you have the permissions needed to create Custom Audiences.

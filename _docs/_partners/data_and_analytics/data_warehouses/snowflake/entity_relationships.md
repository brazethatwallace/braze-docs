...
{% alert important %}
The entity relationship diagrams highlight shared fields and relationships across tables and are not full table schemas. For a complete list of fields, refer to the [individual table schemas](/docs/assets/download_file/data-sharing-raw-table-schemas.txt).
{% endalert %}

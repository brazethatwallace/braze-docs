...
![Zapier Apps search results showing Facebook Lead Ads connection options.]({% image_buster /assets/img/fb_lead_ads_zapier/integration1.png %}){: style="max-width:80%;"}
...
![Facebook Business Manager Leads Access page with Zapier assigned as a CRM.]({% image_buster /assets/img/fb_lead_ads_zapier/integration2.png %}){: style="max-width:80%;"}
...
![Zapier trigger setup with Facebook Lead Ads selected.]({% image_buster /assets/img/fb_lead_ads_zapier/create_zap1.png %}){: style="max-width:80%;"}
...
![Zapier step to connect a Facebook account for the lead ads trigger.]({% image_buster /assets/img/fb_lead_ads_zapier/create_zap3.png %}){: style="max-width:80%;"}

Select your Facebook Page and instant form you previously created, then **Continue**.

![Zapier trigger configuration with Facebook Page and instant form selected.]({% image_buster /assets/img/fb_lead_ads_zapier/create_zap4.png %}){: style="max-width:80%;"}
...
![Zapier action setup showing Webhooks by Zapier with Custom Request selected.]({% image_buster /assets/img/fb_lead_ads_zapier/create_zap5.png %}){: style="max-width:80%;"}
...
![Zapier custom webhook request example populated with Braze users.track payload fields.]({% image_buster /assets/img/fb_lead_ads_zapier/configuration_example.png %}){: style="max-width:80%;"}

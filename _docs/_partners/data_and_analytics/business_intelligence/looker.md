...
- Standard attributes can also be set as long as they match the [standard user profile]({{site.baseurl}}/api/objects_filters/user_attributes_object#braze-user-profile-fields) names exactly.

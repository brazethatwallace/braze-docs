...
![Segment destination setup selecting Braze Actions in device mode for web.]({% image_buster /assets/img/segment/website.png %})
...
You can turn on batching for an action by navigating to your Braze Destination > **Mappings**. From there, click the 3-dot icon in the action menu of the mapping and select **Edit Mapping**. Scroll to the bottom of the **Select mappings** section and make sure that **Batch Data to Braze** is set to **Yes**.
...
In the [Web Mode Actions](https://segment.com/docs/connections/destinations/catalog/braze-web-device-mode-actions/#track-event) and [Cloud Mode Actions](https://segment.com/docs/connections/destinations/catalog/braze-cloud-mode-actions/#track-event) destinations, the in the previous step mappings can be set using the Track Event Action.

...
The following table lists and describes the path parameters for the `/custom_objects/types/{type_name}/object_relationship_types` endpoint.
...
The following table lists and describes the query parameters for the `/custom_objects/types/{type_name}/object_relationship_types` endpoint.
...
| `items[].from_type_name` | Required | String | Source custom object type name |
| `items[].to_type_name` | Required | String | Target custom object type name |

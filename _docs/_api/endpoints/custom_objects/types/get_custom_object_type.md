---
nav_title: "GET: Get custom object type"
article_title: "GET: Get Custom Object Type"
search_tag: Endpoint
page_order: 2
layout: api_page
page_type: reference
description: "This article outlines details about the Get custom object type endpoint."
---
{% api %}
...
> Use this endpoint to return one custom object type and its schema definition.
...
The following table lists and describes the path parameters for the `/custom_objects/types/{type_name}` endpoint.

| Parameter | Required | Data Type | Description |
|---|---|---|---|
| `type_name` | Required | String | Custom object type machine name |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Get custom object type path parameters" }
...
This example retrieves the definition of the `account` custom object type.
...
| Parameter | Required | Data Type | Description |
|---|---|---|---|
| `custom_object_type` | Required | Object | Returned custom object type record |
| `custom_object_type.type_name` | Required | String | Custom object type machine name |
| `custom_object_type.metadata` | Required | Object | Type metadata object |
| `custom_object_type.schema_def` | Required | Object | JSON schema definition for object attributes |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Get custom object type response parameters" }
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 aria-label="Get custom object type errors" }
{% endapi %}

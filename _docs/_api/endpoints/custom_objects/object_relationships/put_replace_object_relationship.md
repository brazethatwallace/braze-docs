...
| `404` | Relationship or endpoint objects not found (`custom-object-relationship-not-found`) | Confirm both objects and related type names exist in the workspace. |

...
| `permissions` | Optional | JSON object | Permissions object as described in the [permissions object documentation]({{site.baseurl}}/api/objects_filters/scim_api_appendix). |

...
- **Heavy workflows:** Invoke from chat once (for example `/redirect-management`, `/support-analyzer`, `/salesforce-migration`, `/docs-discrepancies`, `/image-pruner`, `/screenshot-pii-audit`, `/create-pr`).

...
Use these guides when writing or reviewing customer-facing documentation in this repository:

- **[Writing style guide](style_guide/writing_style_guide.md)** — voice, tone, grammar, punctuation, formatting
- **[Image style guide](style_guide/image_style_guide.md)** — screenshots, cropping, alt text

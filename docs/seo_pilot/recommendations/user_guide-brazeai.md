# SEO/AEO recommendation: BrazeAI

**Page:** `/docs/user_guide/brazeai`
**Source:** `_docs/_user_guide/brazeai.md`
...
> *Current intro is ~1 words. Target 80–120 words that directly answer the primary question before the first `##` section.*

> Learn about BrazeAI in Braze.

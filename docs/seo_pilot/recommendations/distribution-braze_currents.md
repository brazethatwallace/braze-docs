# SEO/AEO recommendation: Currents

**Page:** `/docs/user_guide/data/distribution/braze_currents`
**Source:** `_docs/_user_guide/data/distribution/braze_currents.md`

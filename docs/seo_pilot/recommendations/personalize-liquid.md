# SEO/AEO recommendation: Liquid reference

**Page:** `/docs/user_guide/messaging/design_and_edit/personalize/liquid`
**Source:** `_docs/_user_guide/messaging/design_and_edit/personalize/liquid.md`
...
> Learn about Liquid reference in Braze.

...
**Archived pages** — skip all audit/apply steps for paths containing `/archive_docs/` or `/archived_layouts/` (unpublished hidden archive content). Skip **`_docs/_hidden/other/support_contact.md`** and **`feedback.md`** (protected functional pages; do not auto-edit).

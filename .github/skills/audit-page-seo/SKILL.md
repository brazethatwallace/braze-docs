...
**Archived pages** — skip all audit/apply steps for paths containing `/archive_docs/` or `/archived_layouts/` (unpublished hidden archive content). Skip **`_docs/_hidden/other/support_contact.md`** (protected functional page; do not auto-edit).

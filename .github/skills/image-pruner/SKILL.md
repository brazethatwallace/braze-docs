...
**Related:** [`image-curator`](../image-curator/SKILL.md) removes **referenced but redundant** images from English docs (Save buttons, home pages, full dashboards) and updates prose before binaries become unreferenced. Run image-curator before or between image-pruner batches when cleaning screenshot debt.
